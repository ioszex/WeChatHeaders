...
@class NSMutableArray, NSMutableDictionary, NSString, POIFlutterAPI, POIFlutterDataReport, POIInfo, WCFinderPOIRelatedStreamViewModel;
...
@interface FinderPOIPlugin : NSObject
{
    ...
    NSMutableArray *_tabMpPoiArray;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *tabMpPoiArray; // @synthesize tabMpPoiArray=_tabMpPoiArray;
@property(retain, nonatomic) NSString *currentPoiId; // @synthesize currentPoiId=_currentPoiId;
...
- (void)onWaServiceTapWeAppId:(id)arg1 weAppUrl:(id)arg2 error:(id *)arg3;
