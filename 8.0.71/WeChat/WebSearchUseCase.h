...
@class MISSING_TYPE, WCSearchUIConfig, WebSearchContext;
...
- (void)__startOnPage:(id)arg1 tansitionType:(unsigned long long)arg2 fromSearchBar:(id)arg3 animated:(_Bool)arg4;
- (void)startOnPage:(id)arg1 tansitionType:(unsigned long long)arg2 fromSearchBar:(id)arg3 animated:(_Bool)arg4;
- (void)startOnPage:(id)arg1 tansitionType:(unsigned long long)arg2 fromSearchBar:(id)arg3;
- (void)startOnPage:(id)arg1 tansitionType:(unsigned long long)arg2 animated:(_Bool)arg3;
- (void)startOnPage:(id)arg1 tansitionType:(unsigned long long)arg2;
- (void)startWithMoveTabOnPage:(id)arg1 tansitionType:(unsigned long long)arg2;
