...
@class MMFinderHandOffItem, NSMutableArray, NSString, UIImage, UILabel, UITableView, UIView, UIViewController, WCFinderAnimationLoadingView, WCFinderBulletGroupView, WCFinderExtStatsReporter, WCFinderFeedContentVM, WCFinderFeedFriendsLikeListBaseViewController, WCFinderLandScapeReporter, WCFinderLandScapeVCParams, WCFinderLandScapeVideoDisplayView, WCFinderRefreshTableFooterView, WCFinderScrollActionSheet, WCFinderVideoDragProgressReporter;
...
@property(retain, nonatomic) WCFinderFeedContentVM *currentPlayingContentVM; // @synthesize currentPlayingContentVM=_currentPlayingContentVM;
...
- (void)updateBulletAnimationViewWithText:(id)arg1 bulletTimestamp:(double)arg2;
