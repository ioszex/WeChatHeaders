...
- (void)downloadFromCdnAsync:(unsigned long long)arg1 session:(id)arg2 fileId:(id)arg3 fileType:(int)arg4 savePath:(id)arg5 aesKey:(id)arg6 isAppend:(_Bool)arg7;
