...
@class BizScanTabBarInfo, CameraOpButtonWrapView, CameraScanEnergyTracker, CameraScanService, CameraScanTabView, CameraScanTipsView, CameraScanViewControllerOpenParams, CameraScannerView, CameraScannerViewWrapper, MMUIButton, MMUIViewController, NSMutableDictionary, NSString, OCRTransReport, RecentPhotoBubbleView, UIImageView, UILabel, UISwipeGestureRecognizer, UITapGestureRecognizer, UIView, WCPayF2fHBHalfPageSheet;
