...
@class EditImageAttr, EditVideoAttr, MISSING_TYPE, MMImageExifLogInfo, NSArray, NSData, NSDictionary, NSMutableArray, NSString, VideoUploadStatInfo, WCMediaEcsInfo, WCMomentFinderInfo, WCMomentsBizInfo, WCUrl;
...
@interface WCUploadMedia : NSObject
{
    ...
    MISSING_TYPE *twitterOAuthTokenSecret;
    NSString *userData;
    _Bool isSingleMedia;
    NSString *md5;
    NSString *videoMD5;
