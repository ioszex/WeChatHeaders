...
@class MISSING_TYPE, NSArray, NSMutableArray, NSMutableAttributedString, NSString, UIColor, WCFinderHighlightedInfoModel;
...
@interface WCFinderFilterTextView
{
    ...
    MISSING_TYPE *_shouldMoveCursor;
...
- (struct _NSRange)getConflictMentionRangeFromSelectRange:(struct _NSRange)arg1;
