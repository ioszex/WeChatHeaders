...
@class MISSING_TYPE, NSArray, NSString, TPVideoFrameBuffer, UIScrollView, UITapGestureRecognizer, UIView, WCFinderFeedContentVM, WCFinderFeedLiveCellRouterModel, WCFinderFeedMediaWrap, WCFinderFriendLikeToolbarView, WCFinderJumpInfoPanelView, WCFinderMediaInfo, WCFinderPlayerReport, WCFinderSimplePlayerView, WCPlayerPlaybackInfo;
...
- (MISSING_TYPE *)onLiveFeedClickRotateButton;
