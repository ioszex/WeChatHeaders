...
@interface MMDiskUsageScanStat : NSObject
{
    ...
    unsigned int _m_midImgWxamFileCount;
    unsigned int _m_midImgTotalFileCount;
...
@property(nonatomic) unsigned int m_midImgTotalFileCount; // @synthesize m_midImgTotalFileCount=_m_midImgTotalFileCount;
@property(nonatomic) unsigned int m_midImgWxamFileCount; // @synthesize m_midImgWxamFileCount=_m_midImgWxamFileCount;
