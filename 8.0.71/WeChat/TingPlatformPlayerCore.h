...
@class NSMutableArray, NSMutableSet, NSString, TingBizPlayer, TingItem, TingPlayingInfo, TingTPResourceLoader, UnitRCWeakPtr;
...
@interface TingPlatformPlayerCore : NSObject
{
    ...
    UnitRCWeakPtr *_postProcessCallback;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UnitRCWeakPtr *postProcessCallback; // @synthesize postProcessCallback=_postProcessCallback;
...
- (void)tingBizPlayerGetAudioMetaInfo:(id)arg1 listenId:(id)arg2;
- (void)tingBizPlayerAudioFrameOut:(id)arg1 metaInfo:(id)arg2;
...
- (void)setAudioProcessFrameOutCallback:(id)arg1;
