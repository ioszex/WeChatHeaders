...
@interface CAppBrandInfo : NSObject
{
    ...
    _Bool _prefetchDataWithLocation;
...
@property(retain, nonatomic) NSArray *parallelDownloadInfo; // @synthesize parallelDownloadInfo=_parallelDownloadInfo;
...
@property(nonatomic) _Bool prefetchDataWithLocation; // @synthesize prefetchDataWithLocation=_prefetchDataWithLocation;
...
@property(retain, nonatomic) NSArray *launchFallbackMinVersionBlackScenes; // @synthesize launchFallbackMinVersionBlackScenes=_launchFallbackMinVersionBlackScenes;
...
@property(retain, nonatomic) NSArray *bizDomain; // @synthesize bizDomain=_bizDomain;
@property(retain, nonatomic) NSArray *preconnectRequestDomain; // @synthesize preconnectRequestDomain=_preconnectRequestDomain;
