...
@class FinderBaseMediaInfo, FinderCoverScalingInfo, FinderHalfRect, FinderHdrMediaSpecList, FinderHlsMediaSpecList, FinderLiveMediaSpec, FinderLivePhotoMediaInfo, FinderLocation, FinderMediaCdnInfo, FinderMediaCodecInfo, FinderMediaDebug, FinderObjectScalingInfo, FinderProgressPreviewInfo, MISSING_TYPE, NSData, NSMutableArray, NSString;
