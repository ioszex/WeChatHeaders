...
@interface DBContactOther : NSObject
{
    ...
    NSString *_contactVersionJson;
}

+ (unsigned long long)columnType;
+ (id)unarchiveWithWCTValue:(id)arg1;
+ (void)initialize;
+ (void)PBArrayAdd_contactVersionJson;
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *contactVersionJson; // @synthesize contactVersionJson=_contactVersionJson;
