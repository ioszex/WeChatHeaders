...
@class MISSING_TYPE, NSArray, NSMutableArray, NSString, NoticeItem, RecvAccountInfo, RecvCustomerInfoModule, WCPayAddressInfo, WCPayExposureInfo, WCPayLimitInfo, WCPayOrderDetailActivityInfo, WCPayOrderDetailRemarksInfo, WCPayOrderDetailSubscribeBrandInfo, WCPayOrderDetailTinyAppInfo, WCPayPaidDetailFinderInfoViewData, WCPayPaidDetailLeadTailViewData, WCPayTextInfo, WCPayTransferResendInfo;
...
@interface WCPayOrderDetail : NSObject
{
    ...
    WCPayLimitInfo *_m_limit_info;
    NoticeItem *_noticeItem;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NoticeItem *noticeItem; // @synthesize noticeItem=_noticeItem;
@property(nonatomic) _Bool m_is_quota_exceeded; // @synthesize m_is_quota_exceeded=_m_is_quota_exceeded;
@property(retain, nonatomic) WCPayLimitInfo *m_limit_info; // @synthesize m_limit_info=_m_limit_info;
...
@property(retain, nonatomic) NSString *tail_info; // @synthesize tail_info=_tail_info;
