...
@class MMDictationEduView, MMGrowDictationIconView, MMGrowTextViewExtConfig, MMTextView, NSAttributedString, NSMutableArray, NSString, UIFont, UIImageView, UIResponder, VoiceTransEduView;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: textViewMinHeight
