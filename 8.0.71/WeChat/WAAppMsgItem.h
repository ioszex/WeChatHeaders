...
@interface WAAppMsgItem
{
    ...
    unsigned int _certificationImageType;
    unsigned int _scene;
    unsigned int _secFlagForSinglePageMode;
    unsigned int _pcSharedLaunchScene;
    NSString *_username;
    NSString *_appid;
    NSString *_pagepath;
    ...
    NSString *_pagepathForRoute;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *pagepathForRoute; // @synthesize pagepathForRoute=_pagepathForRoute;
@property(retain, nonatomic) NSString *agentSessionId; // @synthesize agentSessionId=_agentSessionId;
@property(nonatomic) unsigned int pcSharedLaunchScene; // @synthesize pcSharedLaunchScene=_pcSharedLaunchScene;
...
@property(retain, nonatomic) NSString *registerBody; // @synthesize registerBody=_registerBody;
@property(nonatomic) unsigned int certificationImageType; // @synthesize certificationImageType=_certificationImageType;
