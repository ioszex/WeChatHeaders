...
@interface CMMDB : NSObject
{
    ...
    WCTDatabase *_m_chatbotMsgDB;
    WCTDatabase *_m_gamelifeMsgDB;
    WCTDatabase *_m_brandFansMsgDB;
    WCTDatabase *_m_photoAccountFansMsgDB;
    WCTDatabase *_m_w1wPersonalMsgDB;
...
@property(retain) WCTDatabase *m_w1wPersonalMsgDB; // @synthesize m_w1wPersonalMsgDB=_m_w1wPersonalMsgDB;
@property(retain) WCTDatabase *m_photoAccountFansMsgDB; // @synthesize m_photoAccountFansMsgDB=_m_photoAccountFansMsgDB;
@property(retain) WCTDatabase *m_brandFansMsgDB; // @synthesize m_brandFansMsgDB=_m_brandFansMsgDB;
@property(retain) WCTDatabase *m_gamelifeMsgDB; // @synthesize m_gamelifeMsgDB=_m_gamelifeMsgDB;
@property(retain) WCTDatabase *m_chatbotMsgDB; // @synthesize m_chatbotMsgDB=_m_chatbotMsgDB;
...
- (id)getTargetingDatabaseWithUserName:(id)arg1 excludingMMDB:(_Bool)arg2;
