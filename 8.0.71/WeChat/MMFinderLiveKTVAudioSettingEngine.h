...
@class KTVAudioRouteUsageRecord, MISSING_TYPE, MMFinderLiveTask, MMLiveTaskId;
...
+ (MISSING_TYPE *)preferVolumeVoiceRatio;
+ (MISSING_TYPE *)checkVoiceEarUsabled: /* Error: Ran out of types for this method. */;
+ (MISSING_TYPE *)transferAudioRouteToAudioType: /* Error: Ran out of types for this method. */;
+ (MISSING_TYPE *)notifyAudioRouteChanged:fromRoute: /* Error: Ran out of types for this method. */;
+ (MISSING_TYPE *)setVoiceEarMonitorEnabled: /* Error: Ran out of types for this method. */;
- (void).cxx_destruct;
