...
// Error: Property attributes should begin with the type ('T') attribute, property name: minimizeSrcFrame
...
- (id)initWithTaskId:(id)arg1 controlView:(id)arg2 url:(id)arg3 shouldLoop:(_Bool)arg4 initialPlayTime:(unsigned int)arg5 autoplay:(_Bool)arg6;
