...
@class CMessageWrap, CrossfadeAnimationController, MMMsgMenuReporter, MMScrollView, MMTextFloatBottomToolView, NSString, TextFloatReferButton, UIButton, UIFont, UIView;
@protocol ILinkEventExt, TextFloatPreviewDelegate;

@interface TextFloatBaseViewController
{
    UIView *m_oBackView;
    UIButton *m_view;
