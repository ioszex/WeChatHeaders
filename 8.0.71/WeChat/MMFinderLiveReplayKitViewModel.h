...
@class CIContext, MISSING_TYPE, MMFinderLiveAnchorRecordShowView, MMFinderLiveGameUserInfo, MMFinderLiveReplayKitManager, MMFinderRecordVideoFrame, MMFinderReplayKitVideoEncoder, MMFinderScreenRecordGuideView, MMTimer, MMUILabel, NSFileHandle, NSLock, NSMutableArray, NSString, RPSystemBroadcastPickerView;
...
@interface MMFinderLiveReplayKitViewModel : NSObject
{
    ...
    _Bool _isPrivacy;
    unsigned short _fps;
    MISSING_TYPE *_enableDatalimitsRC;
...
@property(nonatomic) unsigned short enableDatalimitsRC; // @synthesize enableDatalimitsRC=_enableDatalimitsRC;
...
@property(retain) MMFinderRecordVideoFrame *videoFrame; // @synthesize videoFrame=_videoFrame;
...
- (void)checkEncodeImage:(id)arg1 isLandscape:(_Bool)arg2 isPrivacy:(_Bool)arg3;
- (void)updatePrivacy:(_Bool)arg1;
