...
- (void)insertMpPoiStreamMpPoiProfileData:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showShareMpEntryWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)reloadHeadWithServiceInfoPoiServiceInfoPBData:(id)arg1 completion:(CDUnknownBlockType)arg2;
