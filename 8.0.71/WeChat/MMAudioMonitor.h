...
@class MMAudioCriticalEventDetector, MMAudioMonitorConfig, MMMetricsRecordDB, MMStackReportConnection, NSMutableArray, NSRecursiveLock;
...
@interface MMAudioMonitor : NSObject
{
    ...
    long long m_cachedSessionRoute;
}
