...
@class AnimateEmojiConfig, DSMMatcher, NSArray, NSDictionary, NSMutableDictionary, NSRecursiveLock, NSString;
...
- (id)getImagePathByExpression:(id)arg1;
- (id)getImageByExpression:(id)arg1;
- (id)getKeyByExpression:(id)arg1;
