...
- (void)tpSetInterruptedWhenBackgroundPlayerId:(long long)arg1 interruptedWhenBackground:(_Bool)arg2 error:(id *)arg3;
- (void)tpUpdateExtraInfoPlayerId:(long long)arg1 extraInfo:(NSDictionary *)arg2 error:(id *)arg3;
