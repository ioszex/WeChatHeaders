...
@class NSData, NSDictionary, NSString, TXLivePusherContainerView;
...
- (id)initLivePusherWithId:(unsigned int)arg1 configs:(NSDictionary *)arg2 preview:(TXLivePusherContainerView *)arg3 appId:(NSString *)arg4 useSkyline:(_Bool)arg5 delegate:(id <TXLivePushJSAdapterDelegate>)arg6;
@end
