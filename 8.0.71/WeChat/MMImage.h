...
@class EditImageAttr, MMAsset, MMImageExifLogInfo, MMImageLocation, NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, WCMediaEcsInfo;
...
@interface MMImage : UIImage
{
    ...
    NSString *_publicPhotoAccountFeedId;
    NSString *_publicPhotoAccountFeedIndex;
    NSString *_fortunePicId;
...
+ (void)PBArrayAdd_springFestivalSourceType;
...
@property(retain, nonatomic) NSString *fortunePicId; // @synthesize fortunePicId=_fortunePicId;
@property(retain, nonatomic) NSString *publicPhotoAccountFeedIndex; // @synthesize publicPhotoAccountFeedIndex=_publicPhotoAccountFeedIndex;
@property(retain, nonatomic) NSString *publicPhotoAccountFeedId; // @synthesize publicPhotoAccountFeedId=_publicPhotoAccountFeedId;
...
@property(nonatomic) int springFestivalSourceType; // @synthesize springFestivalSourceType=_springFestivalSourceType;
...
@property(retain, nonatomic) WCMediaEcsInfo *ecsInfo; // @synthesize ecsInfo=_ecsInfo;
