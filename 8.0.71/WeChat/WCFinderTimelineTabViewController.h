...
@class MMBarItemCustomView, MMScrollView, MMUIButton, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSTimer, UIButton, UIImageView, UIView, WCFinderAppendTabDatasModel, WCFinderCreateCoordinator, WCFinderFeedAudioHelper, WCFinderLeadToMachineCellState, WCFinderNavTeenagerView, WCFinderOpenTimelineParams, WCFinderPlaybackSpeedView, WCFinderPostMgr, WCFinderTLUnreadModel, WCFinderTimelineCityViewController, WCFinderTimelineNaviTabsView, WCFinderTimelineTabBubbleController, WCFinderTimelineViewModel;
...
@interface WCFinderTimelineTabViewController
{
    ...
    MMBarItemCustomView *_personalMenuButton;
...
@property(nonatomic) __weak MMBarItemCustomView *personalMenuButton; // @synthesize personalMenuButton=_personalMenuButton;
