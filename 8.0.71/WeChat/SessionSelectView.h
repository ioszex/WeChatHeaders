...
@class FTSTopHitMgr, MISSING_TYPE, MMTableView, MMUILabel, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, OrderedDictionary, RecentForwardScrollView, SessionSelectSectionFoldView, UIColor, WCDataSearcher, WCSearchBar;
...
@interface SessionSelectView : UIView
{
    ...
    MISSING_TYPE *_isFoldTopSession;
...
- (void)handleForwardToYuanbao:(id)arg1;
- (void)onClickForwardToYuanbao;
...
- (id)getForwardButtonDisplayName;
