...
- (void)onConvertPartialRecordingId:(id)arg1 segments:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)onConvertFailedRecordingId:(id)arg1 errorMessage:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)onConvertSuccessRecordingId:(id)arg1 segments:(id)arg2 completion:(CDUnknownBlockType)arg3;
