...
@class BoxBTLNotifyBarReportItem, BoxBTLTopBarReportItem, BrandReportMainSessionInfo, BrandTLExptConfig, KvReportItem29480, NSMutableArray, NSMutableDictionary, NSMutableSet;
@protocol BrandTimelineReportLogicDelegate;

@interface BoxBrandTimelineReportLogic
{
    ...
    BoxBTLTopBarReportItem *m_channelExposingItem;
    NSMutableArray *m_arrChannelExposedItem;
    NSMutableArray *m_arrChannelClickItem;
    BoxBTLNotifyBarReportItem *m_notifyBarReportItem;
...
+ (id)getReddotReportInfoWithNotifyCount:(long long)arg1 isMassSend:(_Bool)arg2 isNotification:(_Bool)arg3 toBNotifyCount:(long long)arg4;
