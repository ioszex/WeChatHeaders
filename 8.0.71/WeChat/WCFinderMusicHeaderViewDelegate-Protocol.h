...
@class FinderJumpInfo, FinderMusicInfo, FinderMusicTopicInfo, MMMusicInfo, MusicRelatedRecommendInfo_RecommendMusic, NSMutableArray, NSString, WCFinderContact;
...
@optional
- (void)onMusicEventHeaderClickListenWholeByMusicInfo:(MMMusicInfo *)arg1 jumpInfo:(FinderJumpInfo *)arg2;
