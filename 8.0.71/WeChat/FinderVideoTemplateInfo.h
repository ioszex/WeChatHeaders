...
@class FinderVideoTemplateInfo_EffectEditInfo, FinderVideoTemplateInfo_LayerRenderInfos, FinderVideoTemplateInfo_MD5Info, FinderVideoTemplateInfo_MusicInfo, FinderVideoTemplateInfo_SecurityAuditInfo, FinderVideoTemplateInfo_TraitsInfo, FinderVideoTemplateInfo_VersionInfo, NSString;
...
@property(retain, nonatomic) FinderVideoTemplateInfo_EffectEditInfo *effectEditInfo; // @dynamic effectEditInfo;
