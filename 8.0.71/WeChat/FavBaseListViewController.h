...
@class FavAddressDataController, FavBaseTableDataController, FavBrowseCollectionView, FavSearchBar, FavSearchExtendFilterPanel, FavSearchTopFilterView, MMTableView, MMUIActivityIndicatorView, MMUIButton, MMUILabel, MMUIView, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIColor, UILabel, UIView, WCFinderBusinessCustomListDetailViewController, WCFinderFeedFlowView;
