...
@interface BizMeTabNativeToFlutterApi : NSObject
{
...
- (void)clearRedDotInfoWithCompletion:(CDUnknownBlockType)arg1;
- (void)requestAcctWithCompletion:(CDUnknownBlockType)arg1;
