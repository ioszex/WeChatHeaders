...
@class CBaseContact, LiveSEIData, LiveSdkInfo, MISSING_TYPE, MMFinderLiveConnectMicUsersInfo, MMFinderLivePIPHandler, MMLiveAnchorSEIInfo, MMLiveAnchorStatusItem, MMLiveAudioRoomSEIConnectMicMsg, MMLiveBaseTask, MMLiveCDNPlayerItem, MMLiveSEIConnectMicMsg, MMLiveTask, MMLiveTaskId, MMMetricsInfo, NSArray, NSDictionary, NSError, NSString, TRTCQualityInfo, TRTCStatistics;
...
- (MISSING_TYPE *)onLiveTask:netStatus:p2pStatus: /* Error: Ran out of types for this method. */;
