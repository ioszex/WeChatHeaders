...
@class MISSING_TYPE, MMScrollView, MMUIActivityIndicatorView, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UITextField, UIView, WCUIAlertView;
...
@interface RadarCreateRoomViewController
{
    ...
    MISSING_TYPE *m_bWaitingForClearAll;
    _Bool m_bDonotQuit;
    _Bool m_bRetry;
    _Bool m_bEntering;
