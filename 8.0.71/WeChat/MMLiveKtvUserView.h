...
@class FinderLiveContact, MISSING_TYPE, MMFinderLiveAudioRoomMicAudioAnimationView, MMFinderLiveConnectMicUser, MMFinderLiveRedPacketView, MMFinderLiveTaskId, MMLiveRewardGiftNotificationContainerView, MMUIButton, NSString, UIColor, UILabel, UIView, WCFinderContact, WCFinderHeadImageView;
...
@interface MMLiveKtvUserView
{
    ...
    MISSING_TYPE *_audioAnimationView;
