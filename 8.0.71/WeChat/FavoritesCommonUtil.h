...
+ (void)OpenBizProfile:(id)arg1 favData:(id)arg2 fromViewController:(id)arg3;
+ (void)OpenWeApp:(id)arg1 pagePath:(id)arg2 debugMode:(unsigned long long)arg3 originalMsgSender:(id)arg4 messageExtraData:(id)arg5 fromViewController:(id)arg6;
+ (void)SelectWeAppMsg:(id)arg1 FromViewController:(id)arg2;
...
+ (void)SelectFavDataItemWrap:(id)arg1 FromViewController:(id)arg2 thumbImageView:(id)arg3 soundable:(_Bool)arg4 Delegate:(id)arg5;
...
+ (_Bool)SelectFavItem:(id)arg1 FromViewController:(id)arg2 Delegate:(id)arg3 FromScene:(unsigned int)arg4 FavIndex:(unsigned int)arg5 SearchText:(id)arg6 thumbView:(id)arg7 TimeIntervalToOpen:(unsigned int)arg8 SearchTagScene:(unsigned int)arg9 IsSearchResult:(_Bool)arg10 SearchListIndex:(unsigned int)arg11 FavListIndex:(unsigned int)arg12;
