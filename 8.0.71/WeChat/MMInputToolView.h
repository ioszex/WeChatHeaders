...
@class CADisplayLink, CBaseContact, CMessageWrap, EmoticonBoardView, EmoticonSearchInMessagePanelReporter, MMDictationGuideBubbleView, MMEmoticonView, MMGrowTextView, MMHeadImageView, MMInputMsgReferView, MMLiteAppViewController, MMQuickInputView, MMQuickSendEmoticonView, MMReferPartialInfo, MMTransparentButton, MMUIButton, MsgFullScreenInputAnimationController, MsgFullScreenInputViewController, MsgSendOpEntry, NSArray, NSSet, NSString, NewEmoticonSearchViewController, RecommendPanelEmojiCtxs, RecordAdapterView, RelatedEmoticonHalfScreenViewController, SelectAttachmentView, SelectAttachmentViewController, SolitaireTipsView, TranslateToolView, UIButton, UIImpactFeedbackGenerator, UIView, UIViewPropertyAnimator, VoiceTransView, WASendSessionMsgView, WCGroupUndoneActionBar, WWKFCustomToolBar;
...
@interface MMInputToolView
{
    ...
    MMDictationGuideBubbleView *_dictationGuideBubbleView;
    ...
    MMQuickInputView *_quickInputView;
    NSString *_currentSessionId;
    NSString *_currentConfirmedText;
    NSArray *_currentTextItems;
    NSArray *_currentImageItems;
...
@property(retain, nonatomic) NSArray *currentImageItems; // @synthesize currentImageItems=_currentImageItems;
@property(retain, nonatomic) NSArray *currentTextItems; // @synthesize currentTextItems=_currentTextItems;
@property(copy, nonatomic) NSString *currentConfirmedText; // @synthesize currentConfirmedText=_currentConfirmedText;
@property(copy, nonatomic) NSString *currentSessionId; // @synthesize currentSessionId=_currentSessionId;
@property(retain, nonatomic) MMQuickInputView *quickInputView; // @synthesize quickInputView=_quickInputView;
...
@property(nonatomic) _Bool enableQuickInputConfig; // @synthesize enableQuickInputConfig=_enableQuickInputConfig;
...
@property(retain, nonatomic) MMDictationGuideBubbleView *dictationGuideBubbleView; // @synthesize dictationGuideBubbleView=_dictationGuideBubbleView;
...
- (void)onDictationIconClick;
- (void)onDictationGuideBubbleClosed;
- (void)hideDictationGuideBubbleWithReason:(long long)arg1;
- (_Bool)isDictationIconActuallyVisible:(id)arg1;
- (void)showDictationGuideBubbleIfNeeded;
...
- (void)checkDictationIconCoveredAndHideBubbleIfNeeded;
- (void)layoutSubviews;
- (void)initSubView;
...
- (void)cleanupQuickInputResources;
- (void)handleSearchTimeout;
- (void)cancelSearchTimeoutTimer;
- (void)startSearchTimeoutTimer;
- (void)updateMergedItems;
- (void)initQuickInputView;
- (void)sendImage:(id)arg1;
- (void)handleImageItemClick:(id)arg1;
- (void)handleTextItemClick:(id)arg1;
- (void)onMMQuickInputViewClickItem:(id)arg1;
- (void)onMMQuickInputViewClickSearchMoreWithItem:(id)arg1 index:(unsigned long long)arg2;
- (void)onMMQuickInputViewClickItem:(id)arg1 index:(unsigned long long)arg2;
- (id)deduplicateItems:(id)arg1 existingItems:(id)arg2;
- (id)internalDeduplicateItems:(id)arg1;
...
- (void)onQuickInputImageSearchResult:(id)arg1 query:(id)arg2 sessionId:(id)arg3;
- (void)onQuickInputRecommendResult:(id)arg1 query:(id)arg2 sessionId:(id)arg3;
- (void)performQuickInputSearch:(id)arg1;
- (void)cancelDebounceTimer;
- (void)executeDebouncedSearch:(id)arg1;
- (void)tryQuickInputRecommendOnTextChange:(id)arg1;
- (void)setCurrentUpdateId:(long long)arg1;
- (long long)currentUpdateId;
- (id)quickInputUpdateQueue;
- (void)setCurrentSearchQuery:(id)arg1;
- (id)currentSearchQuery;
- (void)setDebounceTimer:(id)arg1;
- (id)debounceTimer;
- (void)setSearchTimeoutTimer:(id)arg1;
- (id)searchTimeoutTimer;
- (void)setMergedItems:(id)arg1;
- (id)mergedItems;
- (void)setImageSearchCompleted:(_Bool)arg1;
- (_Bool)imageSearchCompleted;
- (void)setImageSearchCompletedCount:(long long)arg1;
- (long long)imageSearchCompletedCount;
- (void)setImageSearchSourceCount:(long long)arg1;
- (long long)imageSearchSourceCount;
- (void)setTextSearchCompleted:(_Bool)arg1;
- (_Bool)textSearchCompleted;
- (void)setTextSearchCompletedCount:(long long)arg1;
- (long long)textSearchCompletedCount;
- (void)setTextSearchSourceCount:(long long)arg1;
- (long long)textSearchSourceCount;
