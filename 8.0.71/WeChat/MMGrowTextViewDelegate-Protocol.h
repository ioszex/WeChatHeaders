...
@class MMGrowTextView, MMTextView, NSArray, NSNotification, NSSet, NSString, UIEvent, UIImage, UITextView, UIView;

@protocol MMGrowTextViewDelegate <NSObject>

@optional
- (void)MMGrowTextView_touchesCancelled:(NSSet *)arg1 withEvent:(UIEvent *)arg2;
- (void)MMGrowTextView_touchesEnded:(NSSet *)arg1 withEvent:(UIEvent *)arg2;
- (void)MMGrowTextView_touchesMoved:(NSSet *)arg1 withEvent:(UIEvent *)arg2;
...
- (void)MMGrowTextViewDidStopVoiceInput:(MMGrowTextView *)arg1;
- (void)MMGrowTextViewDidStartVoiceInput:(MMGrowTextView *)arg1;
...
- (_Bool)MMGrowTextViewForbidEditing:(MMGrowTextView *)arg1;
- (void)MMGrowTextViewPasteMultiMediaContent:(MMGrowTextView *)arg1;
