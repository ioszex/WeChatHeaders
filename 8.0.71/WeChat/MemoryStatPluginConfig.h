...
@class MISSING_TYPE, NSDictionary, NSMutableDictionary, NSString;
...
+ (void)initialize;
+ (void)PBArrayAdd_deviceSatisfied;
+ (void)PBArrayAdd_classStrongLayoutProtect;
...
@property(nonatomic) int mallocGuardGuardSize; // @synthesize mallocGuardGuardSize=_mallocGuardGuardSize;
...
@property(nonatomic) _Bool mallocGuardIgnoreDisableTime; // @synthesize mallocGuardIgnoreDisableTime=_mallocGuardIgnoreDisableTime;
...
@property(nonatomic) _Bool deviceSatisfied; // @synthesize deviceSatisfied=_deviceSatisfied;
@property(nonatomic) _Bool classStrongLayoutProtect; // @synthesize classStrongLayoutProtect=_classStrongLayoutProtect;
@property(nonatomic) _Bool objectTraceEnabled; // @synthesize objectTraceEnabled=_objectTraceEnabled;
@property(nonatomic) _Bool webkitLoggerDumpStack; // @synthesize webkitLoggerDumpStack=_webkitLoggerDumpStack;
@property(nonatomic) _Bool webkitLoggerEnabled; // @synthesize webkitLoggerEnabled=_webkitLoggerEnabled;
