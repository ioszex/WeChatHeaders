...
@class FavoritesAndNoteViewController, MMCPLabel, MMHeadImageView, MMTimer, MMUIButton, MMUIView, MoreViewControllerReporter, MyFavoritesViewController, NSString, TextStateFriendTopicButton, TextStatePrivacyMgr, TextStateProfileCardContentView, TextStateProfileDragAnimateHelper, TextStatePublishEntryButton, TextStateSquareButton, TextStateTopicModel, UITableView, UIView, UpdateWechatRedDotConfig, WCBizLoadingView, WCFinderCreateCoordinator, WCTableViewManager;
