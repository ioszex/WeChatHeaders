...
- (void)exitShowLiveNoticeDetailIfNeeded;
- (void)showLiveNoticeDetail:(id)arg1 anchorContact:(id)arg2 showToastViewController:(id)arg3 scene:(long long)arg4 showInView:(id)arg5 showHideButton:(_Bool)arg6 showColumnView:(_Bool)arg7 reportScene:(int)arg8 actionBlock:(CDUnknownBlockType)arg9 unLikeBlock:(CDUnknownBlockType)arg10;
- (void)showLiveNoticeDetail:(id)arg1 anchorContact:(id)arg2 showToastViewController:(id)arg3 scene:(long long)arg4 showInView:(id)arg5 showHideButton:(_Bool)arg6 reportScene:(int)arg7 actionBlock:(CDUnknownBlockType)arg8 unLikeBlock:(CDUnknownBlockType)arg9;
- (void)showLiveNoticeDetail:(id)arg1 anchorContact:(id)arg2 showToastViewController:(id)arg3 scene:(long long)arg4 showInView:(id)arg5 actionBlock:(CDUnknownBlockType)arg6 unLikeBlock:(CDUnknownBlockType)arg7;
