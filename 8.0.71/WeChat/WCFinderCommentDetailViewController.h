...
@interface WCFinderCommentDetailViewController
{
    ...
    WCFinderGradientView *_commentImageBtnGradient;
...
- (void)setEducateDoubleIdentityLabel:(id)arg1;
- (id)educateDoubleIdentityLabel;
...
@property(retain, nonatomic) WCFinderGradientView *commentImageBtnGradient; // @synthesize commentImageBtnGradient=_commentImageBtnGradient;
