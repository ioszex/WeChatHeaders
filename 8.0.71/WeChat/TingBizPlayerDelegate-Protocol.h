...
@class AudioFrameMetaInfo, AudioPostProcessInitParams, NSData, NSError, NSString, TPVideoFrameBuffer, TingBizPlayer, TingPlayerDisplayElement;

@protocol TingBizPlayerDelegate <NSObject>

@optional
- (void)tingBizPlayerGetAudioMetaInfo:(AudioPostProcessInitParams *)arg1 listenId:(NSString *)arg2;
