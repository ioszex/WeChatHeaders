...
@class MJAlbumTemplateInfo, MJCameraTemplateInfo, MJCommonTemplateInfo, MJFaceIDGuideInfo, MJMultiMaterialInfo, MJTemplateDynamicInfo, MJTemplateFinderEventTopicInfo, MJTemplateFinderUserInfo, MJTemplateVersionInfo, NSData, NSString, OMJTemplateInfo;
