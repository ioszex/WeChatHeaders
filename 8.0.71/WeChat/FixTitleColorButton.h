...
@interface FixTitleColorButton
{
    ...
    UIView *_blurEffectContainerView;
}

+ (CDUnknownBlockType)zz_create;
- (void).cxx_destruct;
@property(retain, nonatomic) UIView *blurEffectContainerView; // @synthesize blurEffectContainerView=_blurEffectContainerView;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: mediumStyle
