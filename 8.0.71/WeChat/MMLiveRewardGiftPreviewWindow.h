...
@class MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMLiveAIGCGiftProgressView, MMUIButton, MMUILabel, MMUIView, NSString, PAGView, UIImageView, UILongPressGestureRecognizer, WCFinderAnimationLoadingView;
