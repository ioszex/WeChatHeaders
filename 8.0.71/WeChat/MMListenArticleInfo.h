...
@property(nonatomic) unsigned long long articleFlag; // @dynamic articleFlag;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: cover
