...
- (void)internalSwitchToUser:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2 isVirtual:(_Bool)arg3;
- (void)virtualSwitchToUser:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
