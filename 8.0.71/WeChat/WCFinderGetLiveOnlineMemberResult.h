...
@class FinderJumpInfo, LiveOnlineInfo, MMFinderLiveUserStateItem, NSData, NSMutableArray, NSString;
...
@interface WCFinderGetLiveOnlineMemberResult : NSObject
{
    ...
    unsigned int _micAudienceLikeCount;
    ...
    FinderJumpInfo *_promotionPage;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned int micAudienceLikeCount; // @synthesize micAudienceLikeCount=_micAudienceLikeCount;
@property(retain, nonatomic) FinderJumpInfo *promotionPage; // @synthesize promotionPage=_promotionPage;
