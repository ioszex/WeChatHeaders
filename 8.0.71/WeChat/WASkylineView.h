...
@class CADisplayLink, FlutterEngine, FlutterMethodChannel, NSMutableArray, NSString, NSURLRequest, UIColor, UIImageView, UIScrollView, WADebugSkylineOptions, WAFlutterViewController, WANativeViewPlugin, WARootScrollViewInfo, WASkyLineRuntime, WASkylinePageCfg, WATexturePlugin;
...
@interface WASkylineView : UIView
{
    ...
    NSMutableArray *_curInputWidgetIdQueue;
    UIView *_coverRoot;
    UIView *_coverColorView;
    UIView *_keyboardAnimView;
    CADisplayLink *_keyboardAnimDisplayLink;
    NSString *_contentsGravityOld;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *contentsGravityOld; // @synthesize contentsGravityOld=_contentsGravityOld;
@property(retain, nonatomic) CADisplayLink *keyboardAnimDisplayLink; // @synthesize keyboardAnimDisplayLink=_keyboardAnimDisplayLink;
@property(retain, nonatomic) UIView *keyboardAnimView; // @synthesize keyboardAnimView=_keyboardAnimView;
...
@property(retain, nonatomic) NSMutableArray *curInputWidgetIdQueue; // @synthesize curInputWidgetIdQueue=_curInputWidgetIdQueue;
...
- (void)updateKeyboardEndFrame:(struct CGRect)arg1 duration:(double)arg2;
- (void)refreshDisplay;
- (void)setKeyboardAnimDisplayLinkEnable:(_Bool)arg1;
- (void)stopKeyboardAnim:(id)arg1;
- (void)startKeyboardAnim:(id)arg1;
