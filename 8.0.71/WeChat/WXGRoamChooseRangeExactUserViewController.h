...
@class MISSING_TYPE, MMLoadingView, MMUINavigationBar, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NewContactsSearchPanelView, SearchHelpDataItem, UIButton, UIImageView, UILabel, UINavigationItem, UITableView, UIView, WCFilterView;
...
- (id)getFilterSection;
- (void)reinitSessionDataWith:(function_fe0298f3)arg1 needReverse:(_Bool)arg2;
