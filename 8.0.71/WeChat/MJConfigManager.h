...
+ (_Bool)shouldShowMusicCapsuleViewWhenMusicPickerVCIsShowing;
...
+ (_Bool)shouldEnableMovieBGMAdjustment;
+ (_Bool)shouldEnableMusicPanelBGMRecentAndFav;
+ (_Bool)shouldEnableShootBGMAdjustment;
