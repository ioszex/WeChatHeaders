...
@class CContact, ContactsItemView, MISSING_TYPE, MMTableView, MMUIButton, MMUISearchBar, MultiSelectContactsInChatRoomReport, NSMutableArray, NSMutableDictionary, NSString, NewContactsSearchPanelView, OrderedDictionary, SearchHelpDataItem, UIView, WCSearchBar, _TtC6WeChat13DNDReportItem;
...
@interface RoomContactSelectForHalfScreenViewController
{
    ...
    MISSING_TYPE *m_searchResultHeaderView;
