...
@interface WCFinderRefreshTableFooterView : UIView
{
    ...
    unsigned long long _bottomOffset;
    UILabel *_linkLabel;
    UILabel *_label;
    WCFinderNoMoreView *_noMoreView;
    UITapGestureRecognizer *_singleGestureRecognizer;
    UITapGestureRecognizer *_linkGestureRecognizer;
...
@property(retain, nonatomic) UITapGestureRecognizer *linkGestureRecognizer; // @synthesize linkGestureRecognizer=_linkGestureRecognizer;
...
@property(nonatomic) unsigned long long bottomOffset; // @synthesize bottomOffset=_bottomOffset;
...
- (void)onClick;
- (void)onClickErrorLink;
- (void)onClickRetry;
- (void)onStateOfError:(id)arg1 linkTitle:(id)arg2;
