...
@class CADisplayLink, CAGradientLayer, DynamicBackgroundSystemConfig, MFTitleView, MMUIViewController, MainFrameLeftBarView, NSMutableArray, NSString, NewMainFrameRightTopMenuBtn, UIBarButtonItem, UIButton, UICollectionView, UIImageView, UILabel, UISearchBar, WAAppContainerSearchBar, WADynamicBackgroundGLViewController, WAMainFrameAudioCenterBaseView, WAMainFrameChatBotVoIPView, WAMainFrameDesktopContainerView, WAMainFrameTaskBarCloseArea, WAMainFrameTaskBarDotLoadingView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarSearchCustomView, WAMainFrameTaskBarSectionOtherView, WAMainFrameTaskBarSectionWeAppContainerView, WATaskBarCollectionViewLayout;
