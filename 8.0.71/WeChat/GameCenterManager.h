...
@class EntranceRedDot, GameLifeFindMoreFriendEntranceInfo, GameReddotSyncLogic, GameSearchRecommendList, GetGameCenterGlobalSettingResponse, GetGameIndex4Response, GetGameIndex4TabNavResponse, JumpInfo, MISSING_TYPE, MMLiteAppViewController, MMWebViewController, MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WAAppIdToUsernameTransfer;
...
@interface GameCenterManager
{
    ...
    MMLiteAppViewController *_m_gameCenterViewController;
    GameReddotSyncLogic *_gameReddotSyncLogic;
}

- (void).cxx_destruct;
@property(retain, nonatomic) GameReddotSyncLogic *gameReddotSyncLogic; // @synthesize gameReddotSyncLogic=_gameReddotSyncLogic;
@property(retain, nonatomic) MMLiteAppViewController *m_gameCenterViewController; // @synthesize m_gameCenterViewController=_m_gameCenterViewController;
@property(nonatomic) _Bool isGamePluginLiteAppOpen; // @synthesize isGamePluginLiteAppOpen=_isGamePluginLiteAppOpen;
...
- (id)gameReddotSyncLogicEnabled;
- (_Bool)shouldEnableGameNewSync;
- (void)OnAddMsg:(id)arg1 MsgWrap:(id)arg2;
- (void)onSessionTotalUnreadCountChange:(unsigned int)arg1;
- (void)localeChanged:(id)arg1;
- (_Bool)isGamePluginLiteOpen;
- (void)setGamePluginLiteApp:(_Bool)arg1;
...
- (id)getHomeUrlParams;
- (_Bool)startLiteAppViewController:(id)arg1 EntranceRedDot:(id)arg2 Extra:(id)arg3;
...
- (id)tryJumpLiteAppWithUrl:(id)arg1 NavigationController:(id)arg2 liteVcPtr:(id *)arg3 openInfo:(id)arg4 animated:(_Bool)arg5;
- (id)tryJumpLiteAppWithUrl:(id)arg1 NavigationController:(id)arg2 liteVcPtr:(id *)arg3 openInfo:(id)arg4;
- (void)jumpLiteAppWithUrl:(id)arg1 navigationController:(id)arg2 openInfo:(id)arg3;
...
- (id)popHomeViewController:(id)arg1 sourceScene:(unsigned int)arg2 EntranceRedDot:(id)arg3 Extra:(id)arg4;
