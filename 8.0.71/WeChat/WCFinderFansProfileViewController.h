...
@class CContact, FinderContactExtRelationInfo, FinderGetContactListReq, MMUIButton, NSData, NSString, RichTextView, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCFinderComment, WCFinderContact, WCFinderHalfProfileInfoView, WCFinderHalfProfileInteractionInfoView, WCFinderHeadImageView, WCFinderMention, WCFinderRichTextView;
