...
@class AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, CameraScanCombineService, CameraScanPressureOptimize, CameraScanService, CameraScannerViewBlackOpt, CameraScannerViewFocusOpt, CameraScannerViewSwitchOpt, MMTimer, NSMutableString, NSObject, NSRecursiveLock, NSString;
