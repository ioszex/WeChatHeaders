...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, MarkReadStat, NSData, NSMutableArray, NSString, NewLifeConnectTagStream, NewLifeTabItem, NewLifeTabTipsInfo;
...
@property(retain, nonatomic) NewLifeConnectTagStream *tagStreamInfo; // @dynamic tagStreamInfo;
@property(nonatomic) unsigned int tagStreamState; // @dynamic tagStreamState;
