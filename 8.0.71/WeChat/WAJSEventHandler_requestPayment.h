...
@class NSDictionary, NSMutableDictionary, NSString, WAAppIdToUsernameTransfer;
...
@interface WAJSEventHandler_requestPayment
{
    ...
    NSDictionary *_resultForAppBack;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *resultForAppBack; // @synthesize resultForAppBack=_resultForAppBack;
...
- (_Bool)checkWaitAppBack:(id)arg1;
...
- (id)getCustomAppIdFromDic:(id)arg1;
- (id)getTinyappPath;
