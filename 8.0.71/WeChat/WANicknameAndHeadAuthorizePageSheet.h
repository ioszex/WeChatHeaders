...
@class MISSING_TYPE, NSString, WAAuthorizeResultInfo, WANickNameAndHeaderAuthViewModel, WANicknameAndHeadAuthorizeSheetInfo;
...
@interface WANicknameAndHeadAuthorizePageSheet
{
    ...
    NSString *_appId;
    MISSING_TYPE *_authorizeAddAvatarProxyService;
}
