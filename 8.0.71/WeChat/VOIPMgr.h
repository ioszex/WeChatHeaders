...
@class AUAudioDevice, AVVideoDevice, CMMotionManager, MISSING_TYPE, MMTimer, NSArray, NSMutableArray, NSRecursiveLock, NSString, VOIPComponent, VOIPDialData, VOIPKernelLog, VOIPVideoRender, XImageContext, XImageViewRenderer;
...
@interface VOIPMgr
{
    ...
    MISSING_TYPE *iAudioEnableXnoiseSup;
...
- (void)SendNewStatReport:(unsigned long long)arg1 memberId:(unsigned int)arg2 dialReport:(id)arg3 channelReport:(id)arg4 engineReport:(id)arg5 engineExtReport:(id)arg6 directConnReport:(vector_a3211293)arg7 relayConnReport:(vector_a3211293)arg8 engineMPReport:(vector_a3211293)arg9 natReport:(list_224034fa)arg10;
...
- (int)encodeWithFrameIndex:(unsigned long long)arg1 data:(char *)arg2 type:(int)arg3 width:(unsigned int)arg4 height:(unsigned int)arg5 hasNoneInterruption:(_Bool *)arg6 auxiliaryInfo:(id)arg7;
