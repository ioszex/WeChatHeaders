...
@class FinderJumpInfo, FinderMusicInfo, FinderMusicTopicTagInfo, MusicRelatedRecommendInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) FinderJumpInfo *listenWholeMusicJumpInfo; // @dynamic listenWholeMusicJumpInfo;
