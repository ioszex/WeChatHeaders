...
@class BTResortPerformanceItem, BoxBTOftenReadBizCache, BoxBrandTimelineMsgDB, BoxFlutterBrandNavigator, BrandMsgResortContext, BrandResortConfig, BrandSessionCache, BrandTLExptConfig, BrandTLMainSessionExposeItem, MMBaseSessionStorage, MMFlutterInstance, MMTimer, MemoryMappedKV, NSData, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString;
@protocol OS_dispatch_queue;

@interface BoxBrandTimelineMsgMgr
{
    ...
    BoxBrandTimelineMsgDB *_brandMsgDB;
    ...
    BoxBTOftenReadBizCache *_oftenReadBizCache;
    ...
    BoxFlutterBrandNavigator *_flutterNavigator;
...
@property(retain, nonatomic) BoxFlutterBrandNavigator *flutterNavigator; // @synthesize flutterNavigator=_flutterNavigator;
...
@property(retain, nonatomic) BoxBTOftenReadBizCache *oftenReadBizCache; // @synthesize oftenReadBizCache=_oftenReadBizCache;
...
@property(retain, nonatomic) BoxBrandTimelineMsgDB *brandMsgDB; // @synthesize brandMsgDB=_brandMsgDB;
