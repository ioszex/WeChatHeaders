...
@class MISSING_TYPE, MMFinderLiveAudioRoomMicAudioAnimationView, MMFinderLiveCommonOnlineMemberSheet, MMFinderLiveConnectMicSeatInfo, MMFinderLiveConnectMicUser, MMFinderLiveRedPacketView, MMFinderLiveTaskId, MMLiveRewardGiftNotificationContainerView, MMUIButton, NSString, PAGView, UIColor, UIImageView, UILabel, WCFinderHeadImageView;
