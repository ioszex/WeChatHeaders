...
@class GiftNewCustomizationMagicRewardResource, MISSING_TYPE, MMFinderLiveNewCustomGiftItemResourceURL, MMFinderLiveNewCustomGiftText, NSArray, NSString;
...
@interface MMFinderLiveGiftNewCustomizationModel : NSObject
{
    ...
    MISSING_TYPE *_currCombinationIdentifier;
