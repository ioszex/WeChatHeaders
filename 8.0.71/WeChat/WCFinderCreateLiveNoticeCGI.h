...
@class FinderCreateLiveNoticeRequest_AttachInfo, FinderLiveNoticeInfo, FinderLivePaymentSetting, NSString;
...
- (void)createRequest;
- (id)initWithFinderUserName:(id)arg1 liveNoticeInfo:(id)arg2 optype:(unsigned int)arg3 paymentSetting:(id)arg4 attachInfo:(id)arg5 delReason:(id)arg6 modifyReason:(id)arg7 modifyFieldFlag:(unsigned long long)arg8 reportingSourceScene:(unsigned long long)arg9 successBlock:(CDUnknownBlockType)arg10 failureBlock:(CDUnknownBlockType)arg11;
