...
- (void)onMoreBulletComment:(WCFinderBulletItem *)arg1 isInBlackList:(_Bool)arg2 isAuthorScene:(_Bool)arg3 contentVM:(WCFinderFeedContentVM *)arg4;
...
- (void)onFeedCellTriggerBulletCommentWithReplyItem:(WCFinderBulletItem *)arg1;
