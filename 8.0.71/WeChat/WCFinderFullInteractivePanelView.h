...
@interface WCFinderFullInteractivePanelView : UIView
{
    ...
    _TtC6WeChat26FinderBulletFollowPostView *_currentBulletInteractionView;
...
@property(retain, nonatomic) UILabel *netOffTipsLabel; // @synthesize netOffTipsLabel=_netOffTipsLabel;
...
@property(retain, nonatomic) _TtC6WeChat26FinderBulletFollowPostView *currentBulletInteractionView; // @synthesize currentBulletInteractionView=_currentBulletInteractionView;
...
- (long long)interactionViewCurrentBulletLineCount:(id)arg1;
- (void)interactionViewDidEndInteraction:(id)arg1 context:(id)arg2;
- (void)interactionViewDidRequestInsertBullet:(id)arg1;
- (void)interactionViewDidBeginInteraction:(id)arg1;
- (void)layoutBulletInteractionView;
- (void)updateBulletInteractionViewAtTime:(double)arg1 withFollowData:(id)arg2;
- (void)dismissBulletInteractionView;
...
- (void)clearToastView;
- (void)showToastViewWithText:(id)arg1 duration:(double)arg2;
