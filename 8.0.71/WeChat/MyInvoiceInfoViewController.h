...
@class InvoiceFooterView, MISSING_TYPE, MMUIButton, MyInvoiceData, NSIndexPath, NSMutableArray, NSString, UIImageView, UIView, WCBankNumberTextFieldItem, WCBaseKeyboardToolBar, WCBaseTextFieldItem, WCClearModeTextViewItem;
@protocol MyInvoiceInfoViewControllerDelegate;

@interface MyInvoiceInfoViewController
{
    MISSING_TYPE *m_textFieldCompanyTitleItem;
