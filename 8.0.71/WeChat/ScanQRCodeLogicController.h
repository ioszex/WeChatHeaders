...
- (void)handleOcrReport:(id)arg1 codeType:(id)arg2 getA8KeyScene:(int)arg3 getA8KeyRequestId:(unsigned int)arg4 reportType:(unsigned long long)arg5;
- (void)handleOcrReport:(id)arg1 codeType:(id)arg2 getA8KeyScene:(int)arg3 getA8KeyRequestId:(unsigned int)arg4;
