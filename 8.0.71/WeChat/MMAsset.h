...
@class MessageGroupInfo, NSString;
...
@interface MMAsset
{
    ...
    double _livePhotoDuration;
    long long _livePhotoVideoSize;
...
@property(nonatomic) long long livePhotoVideoSize; // @synthesize livePhotoVideoSize=_livePhotoVideoSize;
@property(nonatomic) double livePhotoDuration; // @synthesize livePhotoDuration=_livePhotoDuration;
...
- (void)asyncImageOriginData:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 errorBlock:(CDUnknownBlockType)arg3;
