...
@class AVMutableComposition, AVMutableVideoComposition, AVPictureInPictureController, AVPlayer, AVPlayerItem, AVPlayerLayer, MISSING_TYPE, NSMutableDictionary, NSString, TXPIPRenderView, WCPIPCustomHandleLogic;
...
- (id)actual_createVideoCompositionWithAsset:(id)arg1 renderSize:(struct CGSize)arg2;
- (id)createVideoCompositionWithAsset:(id)arg1 renderSize:(struct CGSize)arg2;
- (void)initTemplateVideoSrcAsync:(_Bool)arg1 duration:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)initTemplateVideoSrc:(int)arg1;
