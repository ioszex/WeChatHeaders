...
@interface WCFinderTLCityViewModel
{
    ...
    _Bool _isByFindPage;
    _Bool _lastForegoundGPSAuthorizeState;
    _Bool _hasFetchAuthority;
    _Bool _pullEnterIsEmpty;
    _Bool _needCleanData;
    _Bool _hasFetchPrefetchData;
    ...
    unsigned long long _lastFetchLbsTimeStamp;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long lastFetchLbsTimeStamp; // @synthesize lastFetchLbsTimeStamp=_lastFetchLbsTimeStamp;
...
@property(nonatomic) _Bool hasFetchPrefetchData; // @synthesize hasFetchPrefetchData=_hasFetchPrefetchData;
...
@property(nonatomic) _Bool hasFetchAuthority; // @synthesize hasFetchAuthority=_hasFetchAuthority;
@property(nonatomic) _Bool lastForegoundGPSAuthorizeState; // @synthesize lastForegoundGPSAuthorizeState=_lastForegoundGPSAuthorizeState;
...
@property(nonatomic) __weak id <WCFinderTLCityViewModelDelegate> delegate;
