...
@class MMLiveBeautyLegacySlider, UIImageView, UILabel;
...
@interface MMLiveBeautyStyleSlider : UIView
{
    ...
    SEL _touchUpAction;
    id _touchUpTarget;
    MMLiveBeautyLegacySlider *_sliderView;
...
@property(retain, nonatomic) MMLiveBeautyLegacySlider *sliderView; // @synthesize sliderView=_sliderView;
