...
@class MJTemplatePlayerView, NSString, WCImageFullScreenTagView, WCMediaItem, WCMediaItemWrap, WCMomentsPlayerSourceController, WCMomentsPlayerViewContainer, WCPhotoMutipleImageHeadView, WCPlayerConfigControlView, WCPlayerPlayArgs, WCPlayerView, WCWidgetPlayer, WXFullScreenGestureRecognizer;
