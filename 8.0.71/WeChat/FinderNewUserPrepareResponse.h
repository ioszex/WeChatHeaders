...
@class BaseResponse, FinderJumpInfo, FinderLivePersonalCenterPrepareInfo, FinderPrivacySetting, FinderWxUserSettingInfo, GameRankSwitchInfo, InteractionMistouchSettings, JoinLiveInvisiableSwitchInfo, NSMutableArray, NSString, PlayHistorySettings, PostActionWording, PrepareFinder, PrepareFinderRealNameInfo, RecommendPersonalizedConfig, RelatedWxAcctInfo;
...
@property(retain, nonatomic) InteractionMistouchSettings *interactionMistouchSettings; // @dynamic interactionMistouchSettings;
...
@property(retain, nonatomic) RecommendPersonalizedConfig *recommendPersonalizedConfig; // @dynamic recommendPersonalizedConfig;
