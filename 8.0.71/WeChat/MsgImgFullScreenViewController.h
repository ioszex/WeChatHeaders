...
@class BrandMpVideoReporter, CAGradientLayer, CMessageWrap, CameraScanCodesMarkDotView, EditImageForwardAndEditLogicController, ForwardMessageLogicController, GetQRCodeInfoLogic, HDImageExpireReporter, MMScrollActionSheet, MMTimer, MMUIActivityIndicatorView, MPCustomInteractiveHandler, MPDragDownGestureHandler, MiniRecTransitionController, MiniTaskTransitionContext, MsgImgDataLogic, MsgImgDelayEntryReporter, MsgImgFullScreenContainer, MsgImgLoaderLogic, MsgImgMinimizeHandler, MsgImgPreviewData, MsgImgSearchPhashMemCache, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UILabel, UIView, WCActionSheet, WCImageTranslateLogic;
