...
@class CEmoticonWrap, FinderJumpInfo, FinderLiveAppMsgAudienceSubmitProductOrderInfo, FinderLiveAppMsgPlatformReminderNotificationJumpInfo, FinderLiveAppMsgProductHotSaleNotificationInfo, FinderLiveAppMsgRecommendNotificationInfo, FinderLiveBoxId, FinderLiveContact, FinderLocation, FinderWindowProductInfo, GameLiveJumpInfo, MMFinderLiveCommentLikeNotifyInfo, MMFinderLiveRewardGiftItem, MMLiveBigEmoticonCommentStyleInfo, MMLiveCommentDataActionObj, NSData, NSDictionary, NSLock, NSString;
...
+ (id)createKtvOperateSongNotifyForTaskId:(id)arg1 updateInfo:(id)arg2;
+ (id)createNewAnchorTaskNotifyForTaskId:(id)arg1 onTop:(_Bool)arg2 updateInfo:(id)arg3;
+ (id)createFinderLiveAsyncCheckMsg:(_Bool)arg1 forTaskId:(id)arg2;
...
- (_Bool)checkIsSameToLoadedComment:(id)arg1;
...
- (id)processUserMsgOrdinaryName:(id)arg1 selfNeedSpecial:(_Bool)arg2 colonIfNeeded:(id)arg3 largeFont:(_Bool)arg4;
- (id)processUserMsgSpacialHandledNameForUnFinderRole:(id)arg1 selfNeedSpecial:(_Bool)arg2 colonIfNeeded:(id)arg3 largeFont:(_Bool)arg4;
- (id)processUserMsgSpacialHandledNameForFinderRole:(id)arg1 hideNickBySpam:(_Bool)arg2 selfNeedSpecial:(_Bool)arg3 colonIfNeeded:(id)arg4 largeFont:(_Bool)arg5 taskId:(id)arg6;
- (void)extractDisplayName:(id *)arg1 content:(id *)arg2;
