...
@class NSArray, NSMutableArray, NSString, WCMediaDownloadStat, WCMediaEcsInfo, WCMomentFinderInfo, WCMomentsBizInfo, WCSightVideoCompositeTask, WCUrl;
...
@property(nonatomic) double livePhotoVideoScale; // @synthesize livePhotoVideoScale=_livePhotoVideoScale;
...
@property(retain, nonatomic) NSString *ctxInfo; // @synthesize ctxInfo=_ctxInfo;
@property(retain, nonatomic) NSString *ctxVersion; // @synthesize ctxVersion=_ctxVersion;
...
- (_Bool)saveSightDataFromSourcePath:(id)arg1;
...
- (_Bool)hasSight;
- (_Bool)hasTypedData:(long long)arg1;
- (_Bool)hasData;
- (_Bool)hasUhdData;
- (_Bool)hasHdData;
