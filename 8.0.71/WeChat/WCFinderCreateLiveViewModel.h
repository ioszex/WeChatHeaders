...
- (void)createStandardLiveNoticeWithStartTime:(id)arg1 topic:(id)arg2 introduction:(id)arg3 paymentSetting:(id)arg4 bindItemModel:(id)arg5 aggregateType:(int)arg6 triggerType:(int)arg7 reportingSourceScene:(unsigned long long)arg8 completionHandler:(CDUnknownBlockType)arg9;
