...
@class CIContext, ConfAVMemberList, IConfSDKRegisterableCallbackHolder, MMConfSDKAudioMgr, MMConfSDKCGIImp, MMConfSDKMemberMgr, MMConfSDKNetworkMgr, MMConfSDKVideoHWenc, MMTimer, NSMutableArray, NSMutableData, NSMutableDictionary, NSObject, NSString, VoIPConfSDKNativeCallbackMgr;
