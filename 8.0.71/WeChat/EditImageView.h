...
@class CALayer, EditImageCropOverlayView, EditImageDeleteBarView, EditImageMusicLyricsWidgetTool, EditImagePOITool, EditImageScrollView, EditImageTextTool, EditImageWidgetTool, MISSING_TYPE, MMTimer, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WCEditEraserCurserView, WCEditImageOperationMgr, WCEditImagePenTraceMgr, WCEditPanGestureFilter, WCEditViewControllerUIConfig;
...
@interface EditImageView : UIImageView
{
    ...
    NSArray *_viewSeq;
    MISSING_TYPE *_checkEventTimerLimit;
    ...
    _Bool _isFinishEdited;
    int _toolType;
    unsigned int _fromEntrance;
    unsigned int _initialEmoctionWidgetCount;
    unsigned int _initialTextWidgetCount;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int initialTextWidgetCount; // @synthesize initialTextWidgetCount=_initialTextWidgetCount;
@property(nonatomic) unsigned int initialEmoctionWidgetCount; // @synthesize initialEmoctionWidgetCount=_initialEmoctionWidgetCount;
@property(nonatomic) _Bool isFinishEdited; // @synthesize isFinishEdited=_isFinishEdited;
...
- (id)getEditImageAttr:(_Bool)arg1;
- (id)getEditImageAttr;
...
- (_Bool)checkWhetherEditedForReport;
...
- (struct CGRect)genCropFrame:(double)arg1;
...
- (_Bool)canZoom;
- (void)reportEditImageLoadOriginalImageWithImageSize:(unsigned int)arg1 withFitSize:(unsigned int)arg2 withImageHeight:(unsigned int)arg3 withImageWidth:(unsigned int)arg4 withFitScale:(float)arg5;
...
- (unsigned int)calcInitialWidgetCount:(int)arg1;
- (void)dealloc;
