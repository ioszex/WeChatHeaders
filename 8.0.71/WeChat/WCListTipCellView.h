...
@protocol WCListTipCellViewDelegate;

@interface WCListTipCellView
{
    id <WCListTipCellViewDelegate> _delegate;
...
@property(nonatomic) __weak id <WCListTipCellViewDelegate> delegate; // @synthesize delegate=_delegate;
