...
@class MISSING_TYPE, MMFinderLiveFeedPreviewLogic, MMFinderLiveSnsAdStreamInfo, MMLiveCDNPlayerView, MMTimer, MMUIView, NSString, SightIconView, WCAdFinderLiveStreamInfo, WCAdURLImageView, WCDataItem;

@interface WCAdFinderLivePlayerView
{
    _Bool _bTimelineScene;
    _Bool _intentToPlay;
    MISSING_TYPE *_playerPlayBeginFlag;
