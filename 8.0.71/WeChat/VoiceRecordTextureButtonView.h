...
@class CAGradientLayer, CALayer, CAShapeLayer, MISSING_TYPE, NSArray, NSString, UIColor;

@interface VoiceRecordTextureButtonView
{
    _Bool _hideVoiceIcon;
    _Bool _fixedVoiceIconPosition;
    long long _state;
...
@property(nonatomic) _Bool fixedVoiceIconPosition; // @synthesize fixedVoiceIconPosition=_fixedVoiceIconPosition;
