...
+ (id)finderAnonymousAttributedString;
+ (id)genFinderLotteryPanelDateTimeStringByTimestamp:(long long)arg1;
...
+ (id)genFinderDateTimeStringByTimestamp:(long long)arg1 format:(id)arg2;
...
- (id)formatServiceTimeStamp:(unsigned long long)arg1;
- (id)getDisplayNameWithMaxCount:(unsigned long long)arg1;
- (id)getDisplayName;
