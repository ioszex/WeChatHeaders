...
@class MMFinderLiveSharePubbleTipView, MMUIButton, NSString;
...
@interface WCFinderLiveEditImageLayoutView
{
    ...
    MMFinderLiveSharePubbleTipView *_editCoverEnhanceGuideView;
    struct CGSize _ratio;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveSharePubbleTipView *editCoverEnhanceGuideView; // @synthesize editCoverEnhanceGuideView=_editCoverEnhanceGuideView;
