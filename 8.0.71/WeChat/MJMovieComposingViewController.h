...
@class MJActionPanelViewController, MJAnalysisGuidanceManager, MJClippingPanel, MJComposingBGMAdjustHalfScreenViewController, MJExportProgressMaskView, MJGradientView, MJMovieComposingBottomBar, MJMovieComposingRecognitionGuideView, MJMovieComposingRedditBubbleView, MJMovieComposingSession, MJMovieComposingTitleGuideView, MJMovieComposingViewModel, MJMovieTextEditInspector, MJMovieTextSuggestionContext, MJMovieTextSuggestionProcessor, MJMovieTextSuggestionSnapshotGenerator, MJMusicPickingViewModel, MJNarrationRecordingControlView, MJPassthroughButton, MJPassthroughView, MJPlaybackViewModel, MJPublisherPlaybackProgressSlider, MJSegmentCropBoxView, MJSegmentCropGestureCaptureView, MJSegmentViewModel, MJTimelineViewController, MJTimelineViewModel, MJToolbarButton, MJVideoSafeAreaTipsView, MMBGMSelectHalfScreenViewController, MMTimer, MMUIButton, MMUILabel, NSMapTable, NSMutableArray, NSString, OMJHandleBoxBorderStyle, OMJPlaybackOverlayView, UIImageView, UIView;
...
@interface MJMovieComposingViewController
{
    ...
    MJComposingBGMAdjustHalfScreenViewController *_bgmAdjustPanelVC;
...
@property(retain, nonatomic) MJComposingBGMAdjustHalfScreenViewController *bgmAdjustPanelVC; // @synthesize bgmAdjustPanelVC=_bgmAdjustPanelVC;
