...
@class FinderLiveGetBoardEventEntryResp_BoardEventEntry, FinderLiveGiftWallInfo, InteractionWishConfig, MISSING_TYPE, MMFinderLiveInteractionWishProgressView, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveHalfScreenTitleBarView, MMUIButton, MMUILabel, MMWebImageView, NSArray, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView, UIScrollView, UIView;
...
@interface MMFinderLiveWishListDetailForAnchorPanel
{
    ...
    UIView *_contentView;
    MISSING_TYPE *_scrollContentView;
