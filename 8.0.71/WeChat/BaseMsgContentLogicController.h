...
- (void)processInsertOriginFilePath:(id)arg1 thumbnail:(id)arg2 deleteAfterSend:(_Bool)arg3;
...
- (void)shareWithOtherAppMultiMsg:(id)arg1 params:(id)arg2;
- (void)sendMultiMsgToYuanbao:(id)arg1 params:(id)arg2;
