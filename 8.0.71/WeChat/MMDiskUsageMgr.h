...
@class MISSING_TYPE, MMDiskCommonUsageScanner, MMDiskUsageConfigHandler, MMDiskUsageReporter, MMDiskUsageScaner, MMDiskUsageStatus, MMFolderWrapCacheData, MMTimer, NSObject, NSString;
...
- (_Bool)checkRawMediaCleanServiceRunTooFrequently;
...
- (void)wholeWechatReport:(_Bool)arg1;
