...
@interface WCBaseTimelineViewController
{
    ...
    MISSING_TYPE *_cellShowItemCache;
...
- (void)onShowMenuItemsForDataItem:(id)arg1 richTextView:(id)arg2 cellView:(id)arg3 menuItems:(id)arg4 isTranslatedText:(_Bool)arg5;
