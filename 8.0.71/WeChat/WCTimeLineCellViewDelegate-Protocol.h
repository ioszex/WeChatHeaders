...
@class CContact, NSArray, NSDictionary, NSString, RichTextView, UIView, WCBaseTimelineViewController, WCContentItemBaseView, WCDataItem, WCMomentsJumpData, WCTimeLineCellView;

@protocol WCTimeLineCellViewDelegate <NSObject>

@optional
- (void)onCopyFinishWithString:(NSString *)arg1;
- (void)onShowMenuItemsForDataItem:(WCDataItem *)arg1 richTextView:(RichTextView *)arg2 cellView:(WCTimeLineCellView *)arg3 menuItems:(NSArray *)arg4 isTranslatedText:(_Bool)arg5;
