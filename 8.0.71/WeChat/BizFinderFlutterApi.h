...
@interface BizFinderFlutterApi : NSObject
{
...
- (void)clearFinderRedDotWithCompletion:(CDUnknownBlockType)arg1;
- (void)updateFinderDataFinderParamsBuffer:(id)arg1 completion:(CDUnknownBlockType)arg2;
