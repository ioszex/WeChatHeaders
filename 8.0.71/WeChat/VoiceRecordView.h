...
@class CAGradientLayer, CAShapeLayer, MMNewVoiceInputReportObj, NSSet, NSString, RecordInfoContentView, SightIconView, TranslateButton, TranslateFunctionButton, UIButton, UILabel, VoiceRecordArcLabel, VoiceRecordTextureButtonView;
