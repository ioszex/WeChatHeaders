...
@class ContactsSelectorController, EmoticonBoardView, ImageSelectorController, MMAsset, MMGrowTextView, MMLoadingView, MMTimer, MMTipsViewController, MMUIButton, MMUILabel, NSArray, NSString, SightDraft, SightIconView, SightView, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UILabel, UIView, WCCommitPrivacySetting, WCDataItem, WCDragDeleteBarView, WCDragTipView, WCEcsLogoNameView, WCInputController, WCLocationInfo, WCMomentsAnimatedFireworksView, WCMomentsPageContext, WCMomentsPostReportSession, WCMomentsSpringTextContainerView, WCMusicInfo, WCPOIStarView, WCPasteTextLengthLogic, WCSelectorView, WCTableViewManager, WCTimelineEnhanceDraftController, WCTimelineExtBean, WCTimelinePOIPickerViewController, WCTimelineTrashReportData;
