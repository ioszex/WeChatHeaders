...
@interface AmoebaSubstitutePage : NSObject
{
    ...
    NSString *_title;
    NSString *_currEnterMethod;
    NSString *_origEnterMethod;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *origEnterMethod; // @synthesize origEnterMethod=_origEnterMethod;
@property(copy, nonatomic) NSString *currEnterMethod; // @synthesize currEnterMethod=_currEnterMethod;
...
@property(copy, nonatomic) NSString *pageHashStr; // @synthesize pageHashStr=_pageHashStr;
