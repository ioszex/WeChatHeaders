...
@class MMUIViewController, NSString, WCFinderFeedFlowView, WCFinderLiveHomePageAggregationTabLiveStreamVM, WCFinderLiveTabInfo, WCFinderMoreLiveTagListHeaderView;
...
- (void)stopPlayAtIndexPath:(id)arg1;
- (void)startPlayAtIndexPath:(id)arg1;
- (_Bool)isCellExposedAtIndexPath:(id)arg1 exposeRatio:(double)arg2 outerFeedFlowView:(id)arg3 outerCollectionInsetTop:(double)arg4 outerTopHeaderViewHeight:(double)arg5 outerCollectionHeight:(double)arg6;
- (id)calculateVisibleAutoPlayIndexPaths:(_Bool)arg1 exposeRatio:(double)arg2 secondRowExposeRatio:(double)arg3 outerFeedFlowView:(id)arg4 outerCollectionInsetTop:(double)arg5 outerTopHeaderViewHeight:(double)arg6 outerCollectionHeight:(double)arg7;
- (void)stopAutoPlay;
- (void)scrollToTop;
