...
@class CContactVerifyLogic, CVerifyContactWrap, MISSING_TYPE, NSArray, NSDictionary, NSString;
...
- (MISSING_TYPE *)onContactVerifyLimitFail: /* Error: Ran out of types for this method. */;
