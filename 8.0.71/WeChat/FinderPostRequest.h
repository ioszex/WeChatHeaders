...
@property(retain, nonatomic) NSString *clipbundleJson; // @dynamic clipbundleJson;
@property(retain, nonatomic) NSData *clipbundleTimeline; // @dynamic clipbundleTimeline;
...
@property(nonatomic) unsigned int noNeedResponseInfo; // @dynamic noNeedResponseInfo;
