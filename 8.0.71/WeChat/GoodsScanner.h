...
@class CameraScanGoodsAdInfo, CameraScanGoodsJSAPIInfo, CameraScannerViewWrapper, NSMutableSet, NSObject, NSRecursiveLock, NSString;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: albumFrameID
