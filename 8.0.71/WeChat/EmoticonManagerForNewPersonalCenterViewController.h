...
@class EmoticonManageDataLogic, MISSING_TYPE, MMTableView, NSMutableArray, NSString, StoreEmotionReplaceMyPanelListCgi;

@interface EmoticonManagerForNewPersonalCenterViewController
{
    _Bool _isDeleteMode;
    _Bool _isFromStore;
    NSMutableArray *_sectionInfoArray;
    MISSING_TYPE *_dataLogic;
