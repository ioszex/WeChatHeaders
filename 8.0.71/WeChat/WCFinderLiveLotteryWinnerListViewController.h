...
- (void)setShowDownLoad:(_Bool)arg1;
- (_Bool)showDownLoad;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithLiveId:(unsigned long long)arg1 objectId:(unsigned long long)arg2 nonceId:(id)arg3 finderUserName:(id)arg4 prizeRecord:(id)arg5 inLive:(_Bool)arg6 isAssistant:(_Bool)arg7 currentLiveTaskId:(id)arg8;
- (id);
