...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSThread, NSTimer, NSURL, QBASIDataDecompressor;
...
@interface QBASIHTTPRequest : NSOperation
{
    ...
    MISSING_TYPE *didCreateTemporaryPostDataFile;
