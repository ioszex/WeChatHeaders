...
@class CAGradientLayer, CALayer, CAShapeLayer, FanClubPanelInfo, FinderLiveRewardGiftExtInfo, MMCPLabel, MMFinderLiveGlobalRankSignView, MMFinderLiveRewardGiftItem, MMFinderLiveSharePubbleTipView, MMFinderLiveTaskId, MMHeadImageView, MMLiveHalfScreenTitleBarView, MMLiveRewardGiftAIGCOperationPanel, MMLiveRewardGiftAttackContactBubbleView, MMLiveRewardGiftCoinButton, MMLiveRewardGiftCustomizationTipView, MMLiveRewardGiftLayout, MMLiveRewardGiftNewCustomizationSettingPanel, MMLiveRewardGiftNewCustomizationTipView, MMLiveRewardGiftPreviewWindow, MMLiveRewardGiftSendingCountMenuBar, MMNormalTipsView, MMScrollView, MMUILabel, MMUIView, NSArray, NSIndexPath, NSMutableArray, NSMutableSet, NSString, UICollectionView, UIImageView, UILabel, UIPageControl, UIScrollView, UIView;
...
@interface MMLiveRewardGiftSelectionView
{
    ...
    MMFinderLiveSharePubbleTipView *_previewDesignerTipView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveSharePubbleTipView *previewDesignerTipView; // @synthesize previewDesignerTipView=_previewDesignerTipView;
