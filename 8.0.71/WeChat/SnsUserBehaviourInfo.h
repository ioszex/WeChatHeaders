...
@property(retain, nonatomic) NSString *snsFeedList; // @synthesize snsFeedList=_snsFeedList;
...
- (unsigned int)getStayTime:(int)arg1;
- (unsigned int)getExposedFeedCnt;
- (id)logStr;
- (void)doReport;
...
- (void)incAlbumExplodeFeed:(id)arg1 type:(long long)arg2;
- (id)init;
