...
@class MMListenCategoryItemJumpInfo, MMListenCategoryItem_FriendSharedRadioInfo, MMListenCategoryItem_InterestRadioInfo, MMListenClassicMusicAlbumInfo, MMListenCoverInfo, MMListenJumpInfo, MMListenMpCategoryinfo, MMListenMusicStory, MMListenRecommendInfo, MMListenSimplePlaylistInfo, MMListenSingerInfo, MMListenUserInfo, NSMutableArray, NSString;
