...
@class ChatLogDataStat, ChatLogMiddleImageCache, NSMutableArray, NSMutableDictionary, NSObject, NSOperationQueue, NSRecursiveLock, NSString;
...
@interface ChatLogDataMgr
{
    ...
    _Bool _bIgnoreHardLink;
    _Bool _bUseMultiThreadOpt;
    _Bool _bLowPerformance;
    _Bool _filteringData;
    _Bool _filterDataEnd;
    _Bool _noCacheEnabled;
    _Bool _slimPathEnabled;
    unsigned int _msgOldestTime;
    unsigned int _msgNewestTime;
    unsigned int _sessionDetailQueueThreadCount;
    ...
    unsigned long long _perMsgSize;
    ...
    NSOperationQueue *_detailSessionQueue;
    ...
    NSMutableDictionary *_reportSavedMediaDict;
    NSMutableDictionary *_reportSendedMediaDict;
    ChatLogMiddleImageCache *_chatLogMiddleImageCache;
    NSString *_usrDir;
    map_543a967b _sizeOfFileType;
}
...
+ (void)recalculateHardlinkSizeForSessionItem:(void *)arg1 IgnoreHardLink:(_Bool)arg2;
+ (void)calculateTrueCount:(void *)arg1 retCount:(unsigned long long *)arg2 retSize:(unsigned long long *)arg3 IgnoreHardLink:(_Bool)arg4;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool slimPathEnabled; // @synthesize slimPathEnabled=_slimPathEnabled;
@property(nonatomic) _Bool noCacheEnabled; // @synthesize noCacheEnabled=_noCacheEnabled;
@property(retain, nonatomic) NSString *usrDir; // @synthesize usrDir=_usrDir;
@property(retain, nonatomic) ChatLogMiddleImageCache *chatLogMiddleImageCache; // @synthesize chatLogMiddleImageCache=_chatLogMiddleImageCache;
@property(nonatomic) unsigned int sessionDetailQueueThreadCount; // @synthesize sessionDetailQueueThreadCount=_sessionDetailQueueThreadCount;
@property(retain, nonatomic) NSMutableDictionary *reportSendedMediaDict; // @synthesize reportSendedMediaDict=_reportSendedMediaDict;
@property(retain, nonatomic) NSMutableDictionary *reportSavedMediaDict; // @synthesize reportSavedMediaDict=_reportSavedMediaDict;
...
@property(retain, nonatomic) NSOperationQueue *detailSessionQueue; // @synthesize detailSessionQueue=_detailSessionQueue;
@property(nonatomic) _Bool bLowPerformance; // @synthesize bLowPerformance=_bLowPerformance;
@property(nonatomic) _Bool bUseMultiThreadOpt; // @synthesize bUseMultiThreadOpt=_bUseMultiThreadOpt;
@property(nonatomic) _Bool bIgnoreHardLink; // @synthesize bIgnoreHardLink=_bIgnoreHardLink;
...
@property(nonatomic) map_543a967b sizeOfFileType; // @synthesize sizeOfFileType=_sizeOfFileType;
@property(nonatomic) unsigned long long perMsgSize; // @synthesize perMsgSize=_perMsgSize;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: allImgThumbSize
...
- (vector_128f4046)getAllRawReceiveItems;
- (vector_128f4046)getAllRawSendDataItems;
- (vector_128f4046)getAllFilterDataItems;
- (vector_128f4046)getAllDataItems;
- (long long)GetFileSize:(id)arg1;
- (_Bool)needFullDiffByTimeStamp:(id)arg1 BackupTime:(unsigned int)arg2 MsgTime:(unsigned int)arg3;
- (void)asyncGetChatLogSizeOfSessionByTimeStamp:(id)arg1 afterTime:(unsigned int)arg2 endTime:(unsigned int)arg3 backupTime:(unsigned int)arg4;
- (void)asyncGetChatLogSizeOfSession:(id)arg1 afterTime:(unsigned int)arg2 endTime:(unsigned int)arg3 backupTime:(unsigned int)arg4 oneMsgSize:(unsigned long long)arg5;
- (void)asyncGetChatLogSizeOfSession:(id)arg1 afterTime:(unsigned int)arg2 endTime:(unsigned int)arg3 backupTime:(unsigned int)arg4;
- (void)asyncGetBackupChatLogSize;
- (id)getAllBackupSessionItem;
- (unsigned int)getMsgNewestTime;
- (unsigned int)getMsgOldestTime;
- (_Bool)getFilterInfo:(shared_ptr_5102c92c)arg1 oneMsgSize:(unsigned long long)arg2 startTime:(unsigned int)arg3 endTime:(unsigned int)arg4 backupTime:(unsigned int)arg5 source:(unsigned long long)arg6 onlyInSys:(_Bool)arg7;
- (void)reloadDataStartTime:(unsigned int)arg1 endTime:(unsigned int)arg2 source:(unsigned long long)arg3 onlyInSys:(_Bool)arg4;
...
- (_Bool)removeAllRecordFilesForItem:(void *)arg1 path:(id)arg2;
...
- (id)expandFullPathFromCacheKey:(id)arg1 cacheKey:(id)arg2;
- (id)expandFullPathFromCacheKey:(const void *)arg1;
- (id)getCacheKeyFromFullPath:(id)arg1 sessionPart:(id)arg2;
- (void)setCacheKeyFromFullPath:(id)arg1 sessionPart:(id)arg2 toString:(void *)arg3;
- (void)analyseReportOneMedia:(shared_ptr_09342520)arg1 messageWrap:(id)arg2;
- (void)analyseRawMediaInfo:(void *)arg1 progress:(unsigned long long *)arg2 totalProgress:(unsigned long long)arg3;
- (void)analyseMiddleMediaInfo:(void *)arg1;
- (void)analyseResDir:(id)arg1 dataType:(int)arg2 msgType:(int)arg3 sessionItem:(void *)arg4 sessionPart:(id)arg5;
- (void)getDetailForDataItem:(void *)arg1;
- (void)getFileSizeAndTimeForDataItem:(void *)arg1 with:(id)arg2 with:(unsigned long long)arg3;
- (void)setChatLogRecordDataForFolder:(id)arg1 sessionItem:(void *)arg2 sessionPart:(id)arg3;
- (void)getRecordMsgInnerFileInfo:(id)arg1 localID:(unsigned int)arg2 forFiles:(id)arg3 inSessionItem:(void *)arg4 innerIndex:(id)arg5 isSent:(_Bool)arg6 sessionPart:(id)arg7;
- (void)resetChatLogData:(int)arg1 msgType:(int)arg2 withFilePath:(id)arg3 withLocalID:(unsigned int)arg4 dataItem:(void *)arg5 sessionItem:(void *)arg6 sessionPart:(id)arg7;
- (void)setChatLogData:(int)arg1 msgType:(int)arg2 withFilePath:(id)arg3 withLocalID:(unsigned int)arg4 dataItem:(void *)arg5 sessionItem:(void *)arg6 sessionPart:(id)arg7;
...
- (void)stopLoadData;
- (void)startLoadDataWithUsernamesInternal:(id)arg1;
