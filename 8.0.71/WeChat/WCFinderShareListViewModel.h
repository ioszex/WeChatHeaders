...
@class MMTimer, NSData, NSMutableDictionary, NSMutableSet, NSString, WCFinderDataItem, WCFinderEnhanceTriggerRecordManager, WCFinderFeedArray, WCFinderPushFeedViewParams, WCFinderSearchStatReportShim, WCFinderShareFeedDataProvider, WCFinderShareListReportModel;
...
- (_Bool)checkShareRemindFeedCache;
...
- (void)thankForShareWithStatus:(_Bool)arg1;
