...
@class ForwardMessageLogicController, MISSING_TYPE, NSMutableDictionary, NSString, WCFinderAnimationLoadingView, WCFinderPOIRelatedStreamViewModel, WCFinderTabPageView;
