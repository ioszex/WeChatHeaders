...
@class MMUIButton, NSMutableArray, NSString, UILabel, WCFinderAuthInfoIconView, WCFinderCommentHeatUpTipsView, WCFinderCommentTranslateView, WCFinderContentHeaderExpandButton, WCFinderFeedContentTouchExpandTextView, WCFinderFeedContentVM, WCFinderHeadImageView, WCFinderJumpInfoPanelView, WCFinderMaskButton;
