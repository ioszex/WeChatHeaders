...
@property(copy, nonatomic) CDUnknownBlockType getContentFadeCallback; // @synthesize getContentFadeCallback=_getContentFadeCallback;
...
@property(nonatomic) double commentTableBottomInset; // @synthesize commentTableBottomInset=_commentTableBottomInset;
