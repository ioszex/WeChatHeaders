...
+ (void)openChatRoomCategoryItem:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
+ (id)router;
+ (void)openAppFromTaskBar:(id)arg1;
...
+ (void)reportOpen3rdClick:(id)arg1 tingItem:(id)arg2 scene:(int)arg3;
+ (void)open3rdMusicApp:(id)arg1 musicAppId:(id)arg2 scene:(int)arg3 fromSource:(id)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)open3rdMusicApp:(id)arg1 musicAppId:(id)arg2 scene:(int)arg3 fromSource:(id)arg4;
