...
@class MISSING_TYPE, NSDictionary, NSString, WCFinderAnimationLoadingView, WCFinderFeedArray, WCFinderFeedListView, WCFinderStreamLoadingState;
...
@interface WCFinderFeedListViewController
{
    ...
    MISSING_TYPE *_feedListBackBlock;
