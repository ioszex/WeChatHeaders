...
@class AudioFrameMetaInfo, MMTimer, NSString, TingSafeWeakProxy, TingTPAudioMixTtsImpl, TingTPAuditoryEnhImpl, TingTPHearingAidImpl, TingTPResourceLoader, WCAudioInfo;
@protocol ITPPlayer;
...
@interface TingTPPlayer
{
    ...
    AudioFrameMetaInfo *_metaInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) AudioFrameMetaInfo *metaInfo; // @synthesize metaInfo=_metaInfo;
