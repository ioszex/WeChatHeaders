...
// Error: Property attributes should begin with the type ('T') attribute, property name: wxaPathWithQuery
...
@property(nonatomic) _Bool isFromEcs; // @synthesize isFromEcs=_isFromEcs;
...
- (void)startCircleToSearch:(unsigned long long)arg1 andEntityBlock:(CDUnknownBlockType)arg2;
...
- (_Bool)shouldAddWatermark;
- (id)getWatermarkImage:(id)arg1 data:(id)arg2;
- (void)addToFavorites;
- (void)forwardMessage;
...
- (void)processWatermarkImageInBackgroundWithCompletion:(CDUnknownBlockType)arg1;
...
- (id)tryGetWebKitCachedImageDataForUrl:(id)arg1;
- (id)tryGetResource:(id)arg1 localOnly:(_Bool)arg2;
- (id)tryGetResource:(id)arg1;
- (void)updateIndex:(unsigned int)arg1;
- (int)totalCount;
- (int)currentIndex;
