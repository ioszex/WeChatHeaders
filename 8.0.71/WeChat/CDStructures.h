...
struct AudioListen3aProcessorInterface {
    CDUnknownFunctionPointerType *_field1;
};
...
struct BizMsgReSortV2ReqContext {
    CDUnknownFunctionPointerType *_field1;
    int _field2;
    int _field3[3];
    void *_field4;
...
struct C2CDownloadRequest {
    ...
    basic_string_911c138e transfer_config_pb;
};
...
struct C2CDownloadResult {
    ...
    basic_string_911c138e cdn_task_state_info2_pb;
};
...
struct ChatbotDeviceCPP2NativeCallerDispatcherBridgeObjcImpl {
    CDUnknownFunctionPointerType *_field1;
    struct ChatbotDeviceCPP2NativeCallerDispatcherCallback *_field2;
    id _field3;
};

struct ChatbotDeviceCPP2NativeCallerDispatcherCallback;
...
struct IWaveAuditoryEnhInterface {
    CDUnknownFunctionPointerType *_field1;
};
...
struct WxVideoTransParaABA {
    ...
    int _field30;
    int _field31;
    struct WXColorProperties _field32;
    _Bool _field33;
    int _field34;
    int _field35;
};
...
struct YTFullPack {
    ...
    struct YTCAPTCHA CP;
    vector_ce5fcef0 SingleImg_buffer;
};
...
struct shared_ptr<std::vector<int>> {
    void *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct tagAVQualityReportInfo {
    ...
    struct tagVCodec2HWEngineReport _field545;
    ...
    unsigned short _field720[256];
    unsigned short _field721[256];
    ...
    unsigned int _field1017[10];
    int _field1018;
    int _field1019;
    unsigned int _field1020;
    unsigned int _field1021;
    unsigned long long _field1022;
};
