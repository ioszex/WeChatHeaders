...
@class BlueManager, MISSING_TYPE, NSMutableArray, NSMutableDictionary, NSObject, NSString, WCDeviceAuthLogic, WCDeviceM7Logic, WCDeviceNetworkLogicMgr, WCDeviceSendDataToManufacturSvrLogic, WCDeviceWifiStateLogic, WCHKActivitySummaryLogic, WCHKWorkoutLogic;
...
@interface WCDeviceBrandMgr
{
    ...
    MISSING_TYPE *_mActivitySummaryLogic;
}
