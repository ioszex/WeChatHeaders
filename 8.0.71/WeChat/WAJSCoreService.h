...
- (void)addDelayToAgentCallUserJSAPI:(CDUnknownBlockType)arg1 jsapiName:(id)arg2;
...
- (void)invokeThirdJSApiCallbackWithEventName:(id)arg1 eventParams:(id)arg2 callbackId:(unsigned int)arg3 contextId:(unsigned int)arg4;
