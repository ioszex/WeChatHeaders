...
- (void)forceInsertAdMsgWithContent:(id)arg1 atPos:(unsigned int)arg2;
...
- (void)debug_modifyAdCardExposedCount:(unsigned int)arg1;
- (_Bool)debug_setAdCardExposeQuotaFromServerConfig:(unsigned int)arg1;
...
- (_Bool)isDebugForceInsertAdFirstPos;
