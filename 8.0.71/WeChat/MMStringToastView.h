...
@class MISSING_TYPE, MMTimer, NSMutableArray, NSObject, UIImageView, UILabel, UIView, VoIPToast;
...
- (void)initViewIfIsUsingMPUI:(_Bool)arg1;
- (id)initWithFrameAndBackground:(struct CGRect)arg1 isUsingMPUI:(_Bool)arg2;
