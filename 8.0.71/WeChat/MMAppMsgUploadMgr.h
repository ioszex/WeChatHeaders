...
@interface MMAppMsgUploadMgr
{
    ...
    NSMutableDictionary *_thumbTasks;
...
@property(retain, nonatomic) NSMutableDictionary *thumbTasks; // @synthesize thumbTasks=_thumbTasks;
...
- (void)checkUploadThumbForMessage:(id)arg1;
- (void)calcMd5ForMessage:(id)arg1;
- (_Bool)checkAppMsgIsAutoDelete:(id)arg1;
