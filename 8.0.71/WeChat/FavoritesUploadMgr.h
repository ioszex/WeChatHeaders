...
+ (_Bool)useCheckCdnNewCgi;
+ (_Bool)fixFavRes;
- (void).cxx_destruct;
@property(nonatomic) __weak id <FavoritesUploadMgrDelegate> delegate; // @synthesize delegate=_delegate;
- (void)reportFavoritesUploadResult:(id)arg1 proccessType:(unsigned long long)arg2 errCode:(int)arg3;
...
- (_Bool)isItemInFailQueue:(id)arg1;
...
- (_Bool)canAddItemToFailedQueue:(id)arg1;
