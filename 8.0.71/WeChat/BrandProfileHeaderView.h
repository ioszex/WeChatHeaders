...
@class BTRichTextTagView, BizProfileV2Resp, BrandLiveStatusButton, BrandProfileFinderLiveInfoView, BrandProfileReserveFinderLiveCardView, BrandProfileRichTextTagView, BrandProfileShopEntranceView, BrandShopWindowButton, CContact, MMBrandHeadImageView, MMUIButton, MMUIImageView, MMUILabel, NSString, UIImageView, UILabel, WCFinderMaskButton, _TtC6WeChat25BrandProfileMenuViewModel, _TtC6WeChat36BrandProfileRecommendFollowViewModel;
...
@interface BrandProfileHeaderView : UIView
{
    ...
    WCFinderMaskButton *_publishArticleButton;
