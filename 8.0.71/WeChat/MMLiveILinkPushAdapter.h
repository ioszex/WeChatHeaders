...
@class ILinkPusher, MISSING_TYPE, MMLiveRemoteTrtcCustomRenderComposeManagerV2, NSMutableData, NSMutableDictionary, NSObject, NSString, TRTCTranscodingConfig, UIImage;
...
@interface MMLiveILinkPushAdapter
{
    ...
    MISSING_TYPE *_hasWaitConnectMicAudience;
