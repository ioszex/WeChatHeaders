...
@interface SettingModifyAliasInputViewController
{
    ...
    MMUILabel *m_aliasRuleTipView;
    UIFont *m_titleFont;
    UIFont *m_contentFont;
    UIFont *m_aliasFont;
    _Bool _aliasModifyOptEnable;
...
@property(nonatomic) _Bool aliasModifyOptEnable; // @synthesize aliasModifyOptEnable=_aliasModifyOptEnable;
...
- (void)showModifyAliasMakeSureViewController;
- (_Bool)handleErrorAction:(id)arg1 completion:(CDUnknownBlockType)arg2;
