...
@property(nonatomic) unsigned long long coldLaunchFinishTimeInMs; // @synthesize coldLaunchFinishTimeInMs=_coldLaunchFinishTimeInMs;
...
- (void)directSwitchInMainTabWebView:(id)arg1 withPagePath:(id)arg2 routeId:(id)arg3;
- (void)switchInMainTabWebView:(id)arg1 pagePath:(id)arg2 currentWebView:(id)arg3 routeId:(id)arg4;
...
- (id)popWebViewCount:(int)arg1 fromWebView:(id)arg2 skipIntermediate:(_Bool)arg3 animated:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
