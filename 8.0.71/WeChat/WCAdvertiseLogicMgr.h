...
@class MISSING_TYPE, MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCAdDB, WCAdDynamicCanvasLogic, WCAdDynamicUpdateLogic, WCAdGamePlayablePrerenderInfo, WCAdInfoProxyLogic, WCAdLoadCanvasLogic, WCAdQrCodeScanLogic, WCAdStatePublishReportData, WCCanvasDynamicDataLoader, WWKFContactOpLogic;
...
@interface WCAdvertiseLogicMgr
{
    ...
    MISSING_TYPE *_weAppPkgLoadedSet;
