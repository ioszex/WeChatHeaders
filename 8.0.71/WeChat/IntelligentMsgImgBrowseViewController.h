...
@class CMessageWrap, IntelligentCategoryDisplayView, IntelligentMsgBrowseView, IntelligentMsgImgLabelListView, MMDropableTitleView, MMScrollActionSheet, MMTableView, MMTableViewInfo, MMUIView, MMUIViewController, MsgDataSaveLogic, MsgImgFullScreenWindow, MsgNewImgDataLogic, MultiSelectController, NSMutableSet, NSString, UIButton, UIView, ViewAppMsgController, WCDataSearcher;
