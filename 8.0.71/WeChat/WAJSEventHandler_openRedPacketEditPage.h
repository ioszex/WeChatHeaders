...
@class NSString, WCFinderRedPacketVideoEditResponseParams;
...
@interface WAJSEventHandler_openRedPacketEditPage
{
    ...
    WCFinderRedPacketVideoEditResponseParams *_responseParams;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderRedPacketVideoEditResponseParams *responseParams; // @synthesize responseParams=_responseParams;
