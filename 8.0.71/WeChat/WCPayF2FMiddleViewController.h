...
@class CgiF2FDynamicCodeResp, MISSING_TYPE, MMHeadImageView, MMTimer, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UIView, WCPayF2FDynamicCodeCgi, WCPayWebImageView;
...
@interface WCPayF2FMiddleViewController
{
    ...
    UIView *_m_panelView;
    MISSING_TYPE *_m_headWordingBackView;
