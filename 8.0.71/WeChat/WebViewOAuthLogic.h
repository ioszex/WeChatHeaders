...
@class JSApiScopeAuthorizeInfo, JSApiScopeAuthorizePageSheet, JSApiScopeConfirmWindow, MISSING_TYPE, MMUIViewController, NSMutableArray, NSString, WOAPPrivacyConfirmLogic;
