...
- (void)downloadFromCdnAsync:(unsigned long long)arg1 fileId:(NSString *)arg2 fileType:(int)arg3 savePath:(NSString *)arg4 aesKey:(NSString *)arg5 isAppend:(_Bool)arg6;
