...
@property(nonatomic) _Bool isOpenAntiMisoperation; // @synthesize isOpenAntiMisoperation=_isOpenAntiMisoperation;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: m_uiSyncAddressBookLocalMode
