...
@class MISSING_TYPE, MMUIView, UISwitch, WCTableViewCellManager;
...
+ (MISSING_TYPE *)getCellAttributeDetailTextHightlightedColor;
+ (MISSING_TYPE *)getCellAttributeTextHightlightedColor;
+ (MISSING_TYPE *)getCellTextHightlightedColor;
- (void).cxx_destruct;
