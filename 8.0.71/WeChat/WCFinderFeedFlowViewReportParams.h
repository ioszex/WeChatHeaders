...
{
    _Bool _forbidReport;
    _Bool _enableSession3ExposeReport;
    NSString *_pageTag;
    NSString *_groudId;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool enableSession3ExposeReport; // @synthesize enableSession3ExposeReport=_enableSession3ExposeReport;
