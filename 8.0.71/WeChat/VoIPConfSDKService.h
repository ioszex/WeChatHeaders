...
- (void)releaseDevice;
- (void)svrReport;
- (void)RecvNotifyImp:(id)arg1 datalen:(int)arg2 groupId:(id)arg3 sdkGroupId:(id)arg4 displayUserList:(id)arg5 username:(id)arg6 receiveMsgTime:(unsigned int)arg7 roomID:(unsigned long long)arg8 notifyFrom:(int)arg9;
- (void)recvNotify:(id)arg1 datalen:(int)arg2 groupId:(id)arg3 sdkGroupId:(id)arg4 displayUserList:(id)arg5 username:(id)arg6 receiveMsgTime:(unsigned int)arg7 roomID:(unsigned long long)arg8 isCancelMsg:(_Bool)arg9 notifyFrom:(int)arg10;
