...
@class AudioRecorderUserData, CBaseContact, CContact, CEmoticonWrap, CMessageWrap, ChatRoomPanelDynamicWeAppItem, ChatRoomToolMessageEventInfo, ChatTimeNodeRightButtonInfo, LinkWeAppJumpWrap, MISSING_TYPE, MMGrowTextView, MMInputToolView, MMLiveInfoItem, MMMsgContentTipsItem, MMMusicInfo, MMWebViewController, MsgSendOpEntry, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSURL, ReaderMessageFolderViewModel, ReaderMessageTemplateMsgFolderViewModel, ServiceAppData, SolitaireObj, TemplateMsgFoldReportItem, TemplateReaderMessageFolderViewModel, TranslateInfo, UIBarButtonItem, UIColor, UIImage, UIImageView, UIScrollView, UIView;
...
- (void)shareWithOtherAppMultiMsg:(NSMutableArray *)arg1 params:(NSMutableDictionary *)arg2;
- (void)sendMultiMsgToYuanbao:(NSMutableArray *)arg1 params:(NSMutableDictionary *)arg2;
