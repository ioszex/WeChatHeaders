...
@class ContactInfoWrap, FlutterStandardTypedData, NSArray, NSDictionary, NSNumber, NSString, OpenWebPageInfo, SelectLocalPhotoResult, ThirdAppInfo, TingAudioRecordConfiguration, TingBrandContactInfo, TingFinderContactInfo, TingPoiInfo, TingSelectContactsConfig, TingShareConfig, TingShareDataWrap, TingStarSnapInfo, TingUserContactInfo;
