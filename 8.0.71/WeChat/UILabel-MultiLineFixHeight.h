...
- (void)setTextWithFadeEffect:(id)arg1 duration:(double)arg2;
- (void)setText:(id)arg1 highlightKeyWord:(id)arg2 range:(struct _NSRange)arg3 highlightFont:(id)arg4 highlightColor:(id)arg5 showWemoji:(_Bool)arg6 startWemojiSequence:(long long)arg7;
