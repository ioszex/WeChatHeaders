...
- (void)preloadRedDotAvatarImages:(WCFinderRedDotCtrlInfo *)arg1;
- (void)preloadAllRedDotAvatarImages;
- (void)useAbortUnusedRedDotAtPath:(NSString *)arg1;
- (_Bool)hasAbortUnusedRedDotAtPath:(NSString *)arg1;
...
- (_Bool)clearSameRevokeIdCtrlInfo:(NSString *)arg1;
