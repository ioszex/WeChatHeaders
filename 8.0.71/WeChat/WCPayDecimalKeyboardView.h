...
@class MISSING_TYPE, NSMutableArray, NSString, NSTimer, UIButton, UITextField;
...
@interface WCPayDecimalKeyboardView : UIView
{
    ...
    MISSING_TYPE *_bIskeyboardHiding;
    ...
    NSTimer *_clearTimer;
    double _initBtnWidth;
}

- (void).cxx_destruct;
@property(nonatomic) double initBtnWidth; // @synthesize initBtnWidth=_initBtnWidth;
