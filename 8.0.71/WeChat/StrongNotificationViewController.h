...
@class AVAudioPlayer, FakeStrongNotificationViewController, MISSING_TYPE, MMTimer, MMUIButton, MMUILabel, MMUIView, NSArray, NSMutableArray, NSMutableDictionary, NSString, StrongNotificationContentView, UIImageView;
@protocol StrongNotificationViewControllerDelegate;

@interface StrongNotificationViewController
{
    MISSING_TYPE *m_tableView;
