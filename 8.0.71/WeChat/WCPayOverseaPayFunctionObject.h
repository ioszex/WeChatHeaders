...
@interface WCPayOverseaPayFunctionObject : NSObject
{
    ...
    NSString *_m_functionHDIconUrlDark;
    NSString *_m_functionForegroundIconUrlDark;
...
+ (void)initialize;
+ (void)PBArrayAdd_m_functionForegroundIconUrlDark;
+ (void)PBArrayAdd_m_functionHDIconUrlDark;
...
@property(retain, nonatomic) NSString *m_functionForegroundIconUrlDark; // @synthesize m_functionForegroundIconUrlDark=_m_functionForegroundIconUrlDark;
@property(retain, nonatomic) NSString *m_functionHDIconUrlDark; // @synthesize m_functionHDIconUrlDark=_m_functionHDIconUrlDark;
