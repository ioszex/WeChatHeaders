...
@class AVSampleBufferDisplayLayer, CAGradientLayer, CContact, MISSING_TYPE, MMHDHeadImageView, MMTimerLabel, MMUIButton, NSString, SmallCameraView, UIImageView, UILabel, UITapGestureRecognizer, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VideoHintTopView, VoIPHeadImageBlurView, VoIPLockScreenButton, VoIPLockScreenTip, VoIPMPUIv2ScreenView, VoipDescriptionButton, VoipRecentStatusCardView, VoipRecentStatusUnFoldButton, XImageViewRenderer, _TtC6WeChat23VoIPExtOperatePanelView;
...
@interface VoIPTalkingView
{
    ...
    MISSING_TYPE *m_smallCameraView;
    UIView *m_blurView;
    ...
    _TtC6WeChat23VoIPExtOperatePanelView *_extOperatePanel;
    ...
    MMUIButton *_lockMenuButton;
    VoIPLockScreenButton *_lockButton;
    VoIPLockScreenTip *_lockScreenTip;
    UITapGestureRecognizer *_gestureWhenLockScreen;
    struct CGRect _storeSmallCameraViewFrame;
}

+ (double)smallCameraAlphaAnmationTime;
- (void).cxx_destruct;
@property(retain, nonatomic) UITapGestureRecognizer *gestureWhenLockScreen; // @synthesize gestureWhenLockScreen=_gestureWhenLockScreen;
...
@property(retain, nonatomic) MMUIButton *lockMenuButton; // @synthesize lockMenuButton=_lockMenuButton;
...
@property(retain, nonatomic) _TtC6WeChat23VoIPExtOperatePanelView *extOperatePanel; // @synthesize extOperatePanel=_extOperatePanel;
...
- (void)beforeButtonEnterAnimation;
- (_Bool)canExitShakeAnimation;
- (void)onLockScreenMenuButtonClick;
- (void)unLockScreen;
- (void)lockScreen;
- (void)layoutLockButtonIfNeeded;
- (void)layoutLockScreenMenuButton;
- (void)handleUserInteractionWhenLockScreen:(id)arg1;
- (struct CGPoint)safeCenterPointMakeWithX:(double)arg1 Y:(double)arg2;
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;
- (_Bool)isWhitelistWithView:(id)arg1;
