...
@class AVAsset, EVVideoPreviewBrowserView, EditImageEmotionToolAttrView, EditImagePenToolAttrView, EditImageScrollView, EditStoryImageAttr, EditVideoBGMView, EditVideoCropView, EditVideoMusicController, MISSING_TYPE, MMLoadingView, MMUIButton, MMUIImageView, MMUIView, NSMutableArray, NSString, UIImageView, UIView, WCEditLoadingModeButton, WCEditViewControllerUIConfig, WCStoryPublishReportObj;
