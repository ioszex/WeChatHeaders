...
@class FinderCollectioPlayHistory, FinderNextObjectInfo, NSData, NSString;
...
@property(retain, nonatomic) NSData *collectionTopicBuffer; // @dynamic collectionTopicBuffer;
@property(nonatomic) unsigned long long collectionTopicId; // @dynamic collectionTopicId;
@property(retain, nonatomic) NSString *collectionTopicIdStr; // @dynamic collectionTopicIdStr;
@property(nonatomic) unsigned int collectionTopicType; // @dynamic collectionTopicType;
...
@property(retain, nonatomic) FinderCollectioPlayHistory *playHistory; // @dynamic playHistory;
