...
- (void).cxx_destruct;
@property(nonatomic) _Bool hasRetryWithOriginImg; // @synthesize hasRetryWithOriginImg=_hasRetryWithOriginImg;
@property(retain, nonatomic) NSData *uploadToken; // @synthesize uploadToken=_uploadToken;
