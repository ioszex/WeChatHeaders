...
- (id)draftExcludeLabelsNameForPrivacy;
- (_Bool)setDraftExcludeLabelsNameForPrivacy:(id)arg1;
- (id)draftExcludeContactsForPrivacy;
- (_Bool)setDraftExcludeContactsForPrivacy:(id)arg1;
- (id)draftInteractContactsForPrivacy;
- (_Bool)setDraftInteractContactsForPrivacy:(id)arg1;
