...
@class MISSING_TYPE, MMBankCardType, MMKBankCardTypePickerViewOnSelectCallback, MMKViewOnClickCallback, NSArray, NSMutableArray, NSMutableDictionary, NSString, WCBizPickerView;

@interface KindaBankCardTypePickerView
{
    WCBizPickerView *m_pickerView;
    MISSING_TYPE *m_textField;
