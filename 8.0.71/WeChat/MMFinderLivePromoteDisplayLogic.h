...
@interface MMFinderLivePromoteDisplayLogic : NSObject
{
    ...
    CDUnknownBlockType _getEnablePubbleShowAnimationCallback;
    ...
    struct CGAffineTransform _displayLeaseViewTransform;
}
...
@property(nonatomic) struct CGAffineTransform displayLeaseViewTransform; // @synthesize displayLeaseViewTransform=_displayLeaseViewTransform;
...
@property(copy, nonatomic) CDUnknownBlockType getEnablePubbleShowAnimationCallback; // @synthesize getEnablePubbleShowAnimationCallback=_getEnablePubbleShowAnimationCallback;
...
@property(readonly, nonatomic) _Bool isUsingLeasePubbleView;
- (void)updateDisplayLeaseViewTransform:(struct CGAffineTransform)arg1;
...
- (double)getNewProductPubbleAnimationMiddleCenterY:(id)arg1;
...
- (void)updateInfo:(id)arg1 partiallyWithECInfo:(id)arg2;
- (void)onECPromoteUpdatePartiallyWithTaskID:(id)arg1 info:(id)arg2;
