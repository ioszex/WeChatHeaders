...
- (_Bool)requestForSnsTimeLineRequest:(unsigned long long)arg1 minId:(unsigned long long)arg2 lastRequestTime:(unsigned int)arg3 pageType:(long long)arg4 isUnReadJump:(_Bool)arg5;
...
- (_Bool)updateNextPage:(unsigned long long)arg1 bottomId:(unsigned long long)arg2 minChangedTime:(unsigned int)arg3 isUnReadJump:(_Bool)arg4;
...
- (void)reportTimelinePullCommonInfoWithRequest:(id)arg1;
...
- (void)reportAdOperationSwap:(id)arg1 type:(unsigned long long)arg2 timelineSessionId:(id)arg3;
- (void)processAdOperationSwapNoticeNewItemsWith:(id)arg1 adReplacedList:(id)arg2 adList:(id)arg3;
- (void)processAdOperationSwapReplacedList:(id)arg1;
- (id)processAdOperationSwapManageAdList:(id)arg1 sortedAdDataItems:(id)arg2 originAds:(id)arg3;
- (id)processAdOperationSwapDataItems:(id)arg1 sortedAds:(id)arg2;
- (void)processAdOperationSwap:(id)arg1 feedList:(id)arg2 adList:(id)arg3;
...
- (void)changeAdTimeForPosition:(id)arg1 retList:(id)arg2 isFirstPage:(_Bool)arg3;
