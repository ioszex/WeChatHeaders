...
@interface CNetworkStatus
{
    ...
    NSObject<OS_nw_path_monitor> *_expensiveMonitor;
...
@property(retain, nonatomic) NSObject<OS_nw_path_monitor> *expensiveMonitor; // @synthesize expensiveMonitor=_expensiveMonitor;
...
- (void)Start:(id)arg1;
- (void)PingReach;
- (_Bool)isNetworkExpensive;
- (void)initExpensiveMonitor;
