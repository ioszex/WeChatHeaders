...
@class EmoticonCustomCreateLogic, EmoticonCustomManageAddLogic, EmoticonCustomManageCollectionLayout, EmoticonCustomManageCollectionView, EmoticonCustomManageDataLogic, EmoticonCustomManagePopInteractiveTransition, EmoticonCustomManageSwipeSelectGestureRecognizer, EmoticonCustomSortBGView, EmoticonCustomSortInsertBrickView, EmoticonLoadMoreFooterView, NSArray, NSString, UIButton, UILabel, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView;
...
- (void)onAddEmoticonFinishedWithWrap:(_Bool)arg1 md5:(id)arg2;
