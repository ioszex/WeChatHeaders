...
@property(nonatomic) _Bool dialectFeedbackShowing; // @synthesize dialectFeedbackShowing=_dialectFeedbackShowing;
...
- (void)tryShowVoiceEnhanceTipsAfterPlayEnd;
