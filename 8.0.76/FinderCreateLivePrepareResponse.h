...
@property(retain, nonatomic) FinderLiveNetworkIdentityAuthParams *networkIdentityAuthParams; // @dynamic networkIdentityAuthParams;
...
@property(retain, nonatomic) NSMutableArray *noticeAttachAvailableItems; // @dynamic noticeAttachAvailableItems;
