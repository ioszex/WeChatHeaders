...
@class CAttach, CMail, CMessageWrap, MISSING_TYPE, MMLoadingView, MMTableView, NSMutableArray, NSString, NSURLRequest, PushMailWrap, UIButton, UILabel, UIView, WebViewJSLogicImpl, YYWKWebView;
...
- (void)SetCookie;
- (void)deleteMail;
- (void)cancelDeleteMail;
- (void)updateCells;
- (void)FormCells;
- (void)updateAttachView:(id)arg1 arrAttachs:(id)arg2;
- (void)FormAttachView:(id)arg1;
- (void)FormWebView;
- (void)updateLoadFailView;
...
- (void)updateWebViewMarginTopAnimated:(_Bool)arg1 needKeepContentOffsetX:(_Bool)arg2;
