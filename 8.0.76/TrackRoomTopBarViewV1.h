...
@class MMUIButton, NSMutableArray, NSMutableDictionary, NSString, TrackRoomHeadListItemV1, UILabel, UIScrollView, UIView;
@protocol TrackRoomTopBarViewV1Delegate;

@interface TrackRoomTopBarViewV1
{
    id <TrackRoomTopBarViewV1Delegate> _delegate;
    ...
    TrackRoomHeadListItemV1 *_selectedHeadListItem;
    _Bool _getMicSuccess;
    NSMutableDictionary *_tipsArray;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <TrackRoomTopBarViewV1Delegate> delegate; // @synthesize delegate=_delegate;
