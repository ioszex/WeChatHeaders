...
+ (unsigned int)webviewUseGlobalFontLevel;
...
+ (double)dynamicScaleForChatLevel:(int)arg1;
+ (double)dynamicScaleForGlobalLevel:(int)arg1;
...
+ (double)dynamicFontSize:(double)arg1 maxScale:(double)arg2;
+ (double)dynamicLength:(double)arg1 maxScale:(double)arg2;
