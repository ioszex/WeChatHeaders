...
@class CContact, ChatBotUploadCDNMgr, ForwardToThirdAppZipHandler, MISSING_TYPE, NSArray, NSData, NSDictionary, NSMutableArray, NSString, SessionSelectController, SharePreConfirmSheetView, UIView, WWKMsgForwarder;
...
@interface ForwardMessageLogicController
{
    ...
    NSMutableArray *m_msgListBeforeConvertBackup;
    NSArray *m_msgRecordOriginListBeforeConvertBackup;
    ...
    _Bool _onlyShareCardForwardToContact;
    ...
    NSString *_title;
    unsigned long long _m_uiIDKeyScene;
    ...
    MISSING_TYPE *_weappChatBotAttach;
    ...
    ChatBotUploadCDNMgr *_chatbotUploadCDNMgr;
    ForwardToThirdAppZipHandler *_forwardToThirdAppZipHandler;
}

+ (_Bool)newTypeForwardConfirmBar;
- (void).cxx_destruct;
@property(retain, nonatomic) ForwardToThirdAppZipHandler *forwardToThirdAppZipHandler; // @synthesize forwardToThirdAppZipHandler=_forwardToThirdAppZipHandler;
@property(retain, nonatomic) ChatBotUploadCDNMgr *chatbotUploadCDNMgr; // @synthesize chatbotUploadCDNMgr=_chatbotUploadCDNMgr;
...
@property(nonatomic) _Bool onlyShareCardForwardToContact; // @synthesize onlyShareCardForwardToContact=_onlyShareCardForwardToContact;
...
@property(retain, nonatomic) NSString *weappChatBotAttach; // @synthesize weappChatBotAttach=_weappChatBotAttach;
...
@property(nonatomic) unsigned long long m_uiIDKeyScene; // @synthesize m_uiIDKeyScene=_m_uiIDKeyScene;
...
- (void)checkAndFilterMsgForForwardToWeWorkWithUndownloadFallback:(_Bool)arg1;
- (void)checkAndFilterMsgForForwardToWeWork;
- (id)weWorkFallbackTextMsgForUndownloadMsg:(id)arg1;
- (id)weWorkFallbackContentForUndownloadMsg:(id)arg1;
- (_Bool)canConvertUndownloadMsgToWeWorkText:(id)arg1;
...
- (void)showBotForwardAlertWithContacts:(id)arg1;
- (_Bool)needShowBotForwardZipAlertForContacts:(id)arg1;
- (_Bool)isYuanBaoBotForwardSwitchOn;
- (void)forwardMsgToClawBot:(id)arg1;
- (void)forwardMsgToWorkBuddy:(id)arg1;
- (void)forwardMsgToQQMail:(id)arg1;
- (void)forwardMsgToQQ:(id)arg1;
- (void)forwardMsgToYuanbao:(id)arg1;
- (void)forwardMsgToWeWork:(long long)arg1 params:(id)arg2;
- (void)reportForwardSystemShare:(id)arg1 completed:(_Bool)arg2 params:(id)arg3;
- (void)showForwardSystemShare:(id)arg1 params:(id)arg2 zipPath:(id)arg3;
- (void)forwardMsgToSystemShare:(id)arg1;
- (void)OnSelectController:(id)arg1 forwardOtherAppType:(long long)arg2 params:(id)arg3;
- (void)OnSelectControllerForwardOtherAppPageSheetDidCloseWithoutSelection:(id)arg1;
- (void)forwardToThirdAppZipHandlerDidFinish:(id)arg1;
- (void)OnSelectControllerForwardOtherAppPageSheetDidShow:(id)arg1;
...
- (void)processAndForwardToBotContacts:(id)arg1;
- (void)restoreMsgListsFromConvertBackupIfNeeded;
- (void)finishForwardToThirdAppZipLaunchSuccess;
- (_Bool)isForwardToThirdAppMergedForward;
- (id)forwardToThirdAppMsgList;
...
- (void)setForwardScreenFromScene:(int)arg1;
- (void)forwardMsgList:(id)arg1 msgOriginList:(id)arg2 toContacts:(id)arg3 ignoreTips:(_Bool)arg4 showConfirmView:(_Bool)arg5 batchRevokeScene:(unsigned long long)arg6;
...
- (void)forwardNoConfirmForMsgList:(id)arg1 toContacts:(id)arg2 withBatchSendScene:(unsigned long long)arg3;
