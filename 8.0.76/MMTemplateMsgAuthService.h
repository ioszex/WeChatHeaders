...
@class MMTemplateMsgNotifyInfoBatchFetcher, MMTemplateMsgNotifyInfoSyncer, NSMutableArray, NSMutableDictionary, NSString;

@interface MMTemplateMsgAuthService
{
    _Bool _isScopeItemWrapFetching;
    NSMutableArray *_pendingScopeItemWrapQueue;
    _Bool _isNotifyEnabled;
    MMTemplateMsgNotifyInfoBatchFetcher *_notifyInfoBatchFetcher;
    MMTemplateMsgNotifyInfoSyncer *_notifyInfoSyncer;
    NSMutableDictionary *_contactFlagMap;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *contactFlagMap; // @synthesize contactFlagMap=_contactFlagMap;
@property(retain, nonatomic) MMTemplateMsgNotifyInfoSyncer *notifyInfoSyncer; // @synthesize notifyInfoSyncer=_notifyInfoSyncer;
@property(retain, nonatomic) MMTemplateMsgNotifyInfoBatchFetcher *notifyInfoBatchFetcher; // @synthesize notifyInfoBatchFetcher=_notifyInfoBatchFetcher;
@property(readonly, nonatomic) _Bool isNotifyEnabled; // @synthesize isNotifyEnabled=_isNotifyEnabled;
...
- (void)notifyInfoSyncer:(id)arg1 didUpdateGlobalAutoNotify:(_Bool)arg2;
- (void)notifyInfoBatchFetcher:(id)arg1 didUpdateNotifySwitchInfo:(id)arg2;
- (void)notifyInfoBatchFetcher:(id)arg1 didUpdateGlobalAutoNotify:(_Bool)arg2;
...
- (void)fetchScopeGlobalStatusForUser:(id)arg1;
- (void)fetchScopeListForUser:(id)arg1;
- (_Bool)updateAccountGlobalAutoNotify:(_Bool)arg1;
- (void)fetchAccountGlobalAutoNotify;
...
- (void)recalculateImportantNotifyNumForUser:(id)arg1;
- (void)setImportantNotifyNum:(unsigned int)arg1 forUser:(id)arg2;
...
- (void)setAccountGlobalAutoNotify:(_Bool)arg1;
- (void)setAccountGlobalNotify:(_Bool)arg1;
- (id)getAccountCacheCopy;
@property(readonly, nonatomic) _Bool isAutoNotifyEnabled;
@property(readonly, nonatomic) _Bool hasReceivedAutoNotifyTemplateMsg;
- (void)markAutoNotifyTemplateMsgAsReceived;
