...
@class BrandMpVideoReporter, CAGradientLayer, CBTImageAiPReportContext, CMessageWrap, CameraScanCodesMarkDotView, EditImageForwardAndEditLogicController, ForwardMessageLogicController, GetQRCodeInfoLogic, HDImageExpireReporter, MMImageBrowserIntentPredictor, MMScrollActionSheet, MMTimer, MMUIActivityIndicatorView, MPCustomInteractiveHandler, MPDragDownGestureHandler, MiniRecTransitionController, MiniTaskTransitionContext, MsgImgDataLogic, MsgImgFullScreenContainer, MsgImgLoaderLogic, MsgImgMinimizeHandler, MsgImgPreviewData, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UILabel, UIView, WCActionSheet, WCImageTranslateLogic;
...
@interface MsgImgFullScreenViewController
{
    ...
    CDUnknownBlockType m_bAnimateCompleteBlock;
    ...
    MsgImgLoaderLogic *m_loaderLogic;
    NSMutableSet *m_revokedMsgIDSet;
    NSMutableArray *m_pendingRevokeEvents;
    ...
    _Bool _forbidSetNavigationBarShowInDisappear;
    ...
    MMImageBrowserIntentPredictor *_askXiaoWeiImageIntentPredictor;
    NSMutableDictionary *_askXiaoWeiImageIntentResultDict;
    NSMutableSet *_askXiaoWeiDetectingImageIds;
    NSMutableDictionary *_askXiaoWeiLatestRequestIdDict;
    unsigned long long _askXiaoWeiNextRequestId;
    ...
    MiniTaskTransitionContext *_minimizeTransitionContext;
    struct UIEdgeInsets _currentPageContentInset;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MiniTaskTransitionContext *minimizeTransitionContext; // @synthesize minimizeTransitionContext=_minimizeTransitionContext;
...
@property(nonatomic) unsigned long long askXiaoWeiNextRequestId; // @synthesize askXiaoWeiNextRequestId=_askXiaoWeiNextRequestId;
@property(retain, nonatomic) NSMutableDictionary *askXiaoWeiLatestRequestIdDict; // @synthesize askXiaoWeiLatestRequestIdDict=_askXiaoWeiLatestRequestIdDict;
@property(retain, nonatomic) NSMutableSet *askXiaoWeiDetectingImageIds; // @synthesize askXiaoWeiDetectingImageIds=_askXiaoWeiDetectingImageIds;
@property(retain, nonatomic) NSMutableDictionary *askXiaoWeiImageIntentResultDict; // @synthesize askXiaoWeiImageIntentResultDict=_askXiaoWeiImageIntentResultDict;
@property(retain, nonatomic) MMImageBrowserIntentPredictor *askXiaoWeiImageIntentPredictor; // @synthesize askXiaoWeiImageIntentPredictor=_askXiaoWeiImageIntentPredictor;
...
@property(retain, nonatomic) NSMutableDictionary *m_expireViewDic; // @synthesize m_expireViewDic=_m_expireViewDic;
...
@property(retain, nonatomic) CMessageWrap *lastMsgWrap; // @synthesize lastMsgWrap=_lastMsgWrap;
...
@property(nonatomic) _Bool forbidSetNavigationBarShowInDisappear; // @synthesize forbidSetNavigationBarShowInDisappear=_forbidSetNavigationBarShowInDisappear;
...
- (id)firstAvailableVideoPathForMsgWrap:(id)arg1;
- (void)clickOnOpenOtherApp;
- (void)onFullScreenClose;
- (void)onFullScreenLongPress;
- (_Bool)canShowLocateButton;
- (_Bool)canShowCloseButton;
- (_Bool)canShowMoreButton;
- (_Bool)canShowAskXiaoWeiButtonForMessage:(id)arg1;
- (_Bool)canShowImgFastBrowseButton;
- (_Bool)canShowShareButton;
- (void)onAskXiaoWeiButtonExposedForMessage:(id)arg1;
- (void)onClickAskXiaoWeiButton:(id)arg1 forMessage:(id)arg2;
...
- (void)reloadCurrentActionSheetForDetectWord;
...
- (id)genDetectWordActionSheetItemList:(_Bool)arg1;
...
- (void)stopPlayVideo;
- (void)startPlayVideo;
- (void)onWCC2CVideoPlayerViewLongPress:(id)arg1;
- (void)statLevelFullScreenSight;
- (void)onFullScreenSingleTap;
- (void)onWCC2CVideoPlayerViewDragToClose:(id)arg1;
- (void)onWCC2CVideoPlayerViewSingleTap:(id)arg1;
...
- (void)onWCC2CVideoPlayerViewClickDetail:(id)arg1;
- (void)onClickPlayAttachVideo:(id)arg1;
- (void)onGetA8KeyFail;
...
- (id)liveVideoPathAtPage:(unsigned int)arg1;
...
- (void)startDownloadImg:(_Bool)arg1 forMsg:(id)arg2;
...
- (void)preLoad:(id)arg1 complete:(CDUnknownBlockType)arg2;
...
- (void)showActionSheetViewForAppMsg:(id)arg1;
...
- (void)addUseOtherApp;
- (_Bool)addWAOpenWxMaterialButton:(id)arg1 openType:(unsigned int)arg2;
...
- (_Bool)syncVideoAllDataWithPlayerByOperateMode:(unsigned int)arg1 messageWrap:(id)arg2;
...
- (id)addActionSheetItem:(unsigned int)arg1 iconImage:(id)arg2 title:(id)arg3 toArray:(id)arg4;
- (void)detectAskXiaoWeiImageIntentIfNeededForMessage:(id)arg1;
- (void)insertAskXiaoWeiActionSheetItemIfNeededForImageId:(id)arg1;
- (id)addAskXiaoWeiActionSheetItemForMessage:(id)arg1 toArray:(id)arg2;
- (_Bool)shouldPresentAskXiaoWeiActionSheetItemForMessage:(id)arg1;
- (_Bool)canDetectAskXiaoWeiImageIntentForMessage:(id)arg1;
- (_Bool)canShowAskXiaoWeiActionSheetItemForMessage:(id)arg1;
- (id)imageAiPReportContextForMessage:(id)arg1;
- (void)beginImageAiPReportVisitForMessage:(id)arg1;
- (long long)askXiaoWeiImageIntentTypeForMessage:(id)arg1;
- (id)askXiaoWeiImagePathForMessage:(id)arg1;
- (id)askXiaoWeiImageIntentIdForMessage:(id)arg1;
- (void)closeVC;
- (void)onFullScreenItemDragToClose;
- (void)onSingleTap:(id)arg1;
- (void)setBrightMode:(_Bool)arg1;
- (id)tagForActivePage;
- (void)adjustViewAndNavBarRect;
- (_Bool)shouldHideNavigationBar;
- (_Bool)useCustomNavibar;
- (_Bool)isCoveredByOtherViewController;
- (void)flushPendingRevokeEventsIfNeeded;
...
- (void)viewDidLoad;
- (void)unregisterMediaExt;
- (void)registerMediaExt;
...
@property(readonly, nonatomic) _Bool mmUsesMsgStyleTransition;
- (void)updateToolbar;
...
- (id)minimizeSnapshotForMsg:(id)arg1;
- (id)contentMinimizeTaskData;
- (void)doAddToMultiFloatingFromTaskData:(id)arg1;
- (void)handleClickAddToMultiFloating;
- (void)doShowXiaoWeiFromImageBrowserPresentIntentSelection:(_Bool)arg1 anchorView:(id)arg2;
- (void)doShowXiaoWeiFromImageBrowserWithAnchorView:(id)arg1;
- (void)doShowOriginalXiaoWeiFromImageBrowser;
