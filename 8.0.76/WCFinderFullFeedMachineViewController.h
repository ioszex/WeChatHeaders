...
@class NSString, WCFinderFeedCacheSettingViewController, WCFinderFeedMachineVM;
...
@interface WCFinderFullFeedMachineViewController
{
    ...
    WCFinderFeedCacheSettingViewController *_feedCacheVC;
}

- (void).cxx_destruct;
@property(nonatomic) __weak WCFinderFeedCacheSettingViewController *feedCacheVC; // @synthesize feedCacheVC=_feedCacheVC;
...
- (void)performDislikeWithContentVM:(id)arg1;
...
- (void)addNetOffEduVCStack;
- (void)onFeedNetOffCellSettingButtonClicked:(id)arg1;
- (void)onFeedNetOffCellCancelButtonClicked:(id)arg1;
- (void)onFeedNetOffCellIncreaseButtonClicked:(id)arg1;
...
- (void)insertNetOffFeedIfNeeded:(id)arg1;
...
- (void)didClickFooterErrorLink:(id)arg1;
