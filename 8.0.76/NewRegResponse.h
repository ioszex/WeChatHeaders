...
@class AxAuthSecRespList, BaseResponse, BuiltinIPList, CDNDnsInfo, HostList, NSString, NetworkControl, PluginKeyList, SKBuiltinBuffer_t, SecAuthRegKeySect, ShowStyleKey, XAgreementDmSetting, XAgreementWordingSetting;
...
@property(nonatomic) unsigned int languageBrandId; // @dynamic languageBrandId;
