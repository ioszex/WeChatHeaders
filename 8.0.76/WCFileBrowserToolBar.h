...
@class MMUIButton, MMUILabel, MsgBigFileDeleteSelectView, NSString, UIButton, UITableView, WCFileBrowserToolBarViewModel;
...
@interface WCFileBrowserToolBar : UIView
{
    ...
    MsgBigFileDeleteSelectView *_deleteAfterSendView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MsgBigFileDeleteSelectView *deleteAfterSendView; // @synthesize deleteAfterSendView=_deleteAfterSendView;
