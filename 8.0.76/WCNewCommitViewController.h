...
@class ContactsSelectorController, EmoticonBoardView, ImageSelectorController, MMAsset, MMGrowTextView, MMLoadingView, MMTimer, MMTipsViewController, MMUIButton, MMUILabel, NSArray, NSString, SightDraft, SightIconView, SightView, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UILabel, UIView, WCCommitAskXiaoWeiHandler, WCCommitPrivacySetting, WCDataItem, WCDragDeleteBarView, WCDragTipView, WCEcsLogoNameView, WCInputController, WCLocationInfo, WCMomentsAnimatedFireworksView, WCMomentsPageContext, WCMomentsPostReportSession, WCMomentsSpringTextContainerView, WCMusicInfo, WCPOIStarView, WCPasteTextLengthLogic, WCSelectorView, WCTableViewManager, WCTimelineEnhanceDraftController, WCTimelineExtBean, WCTimelinePOIPickerViewController, WCTimelineTrashReportData;
...
@interface WCNewCommitViewController
{
    ...
    NSArray *_interactSelectContacts;
    NSArray *_excludeSelectContacts;
    ...
    id <WCBaseCommitViewResultDelegate> _baseResultDelegate;
    UIView *_askXiaoWeiEntryView;
    WCCommitAskXiaoWeiHandler *_askXiaoWeiHandler;
    NSString *_lastClkXiaoWeiId;
    NSString *_xiaoWeiOriginalText;
...
@property(nonatomic) _Bool askXiaoWeiPendingPost; // @synthesize askXiaoWeiPendingPost=_askXiaoWeiPendingPost;
@property(copy, nonatomic) NSString *xiaoWeiOriginalText; // @synthesize xiaoWeiOriginalText=_xiaoWeiOriginalText;
@property(copy, nonatomic) NSString *lastClkXiaoWeiId; // @synthesize lastClkXiaoWeiId=_lastClkXiaoWeiId;
@property(retain, nonatomic) WCCommitAskXiaoWeiHandler *askXiaoWeiHandler; // @synthesize askXiaoWeiHandler=_askXiaoWeiHandler;
@property(retain, nonatomic) UIView *askXiaoWeiEntryView; // @synthesize askXiaoWeiEntryView=_askXiaoWeiEntryView;
@property(nonatomic) __weak id <WCBaseCommitViewResultDelegate> baseResultDelegate; // @synthesize baseResultDelegate=_baseResultDelegate;
...
@property(retain, nonatomic) NSArray *excludeSelectContacts; // @synthesize excludeSelectContacts=_excludeSelectContacts;
@property(retain, nonatomic) NSArray *interactSelectContacts; // @synthesize interactSelectContacts=_interactSelectContacts;
...
- (void)commonUpdateWCUploadTask:(id)arg1;
- (void)commonRelayoutEcsView:(id)arg1;
...
- (void)privacySettingDataCallback:(long long)arg1 contacts:(id)arg2 labelNames:(id)arg3 interactContacts:(id)arg4 excludeContacts:(id)arg5 excludeLabelNames:(id)arg6;
...
- (void)_privacySettingChanged:(long long)arg1 label:(id)arg2 contacts:(id)arg3 interactContacts:(id)arg4 excludeContacts:(id)arg5 excludeLabels:(id)arg6;
...
- (void)configLivePhotoReportForAlertView:(id)arg1 errorTips:(long long)arg2;
...
- (_Bool)processImage;
- (void)reportYuanBaoTemplateInfo:(id)arg1;
- (void)doExit;
...
- (void)configDataReportForPostBtn:(id)arg1;
- (void)initView;
- (void)reloadType;
...
- (void)reloadData;
- (id)createPrefixedContentLabelWithText:(id)arg1 numberOfLines:(long long)arg2;
- (id)createContentLabelForPrivacyCellWithTitle:(id)arg1 numberOfLines:(long long)arg2;
- (id)createTitleLabelForPrivacyCellWithTitle:(id)arg1 color:(id)arg2;
- (void)makePrivacyForComplex:(id)arg1 andNormalCellManger:(id)arg2;
- (void)makePrivacyCell:(id)arg1 andNormalCellManger:(id)arg2;
- (id)getInvisiblePrivacyTitle;
- (id)getVisiblePrivacyTitle;
...
- (void)addMediaView;
- (void)reportXiaoWeiTextFillWithContent:(id)arg1;
- (id)_snsXiaoWeiCommonParams;
- (id)_xiaoWeiReporterExtraParams;
- (int)_xiaoWeiEnterScene;
- (unsigned long long)_currentPublisherType;
- (void)_layoutAskXiaoWeiEntryView;
- (void)setupAskXiaoWeiEntryView;
- (_Bool)_isAskXiaoWeiEntryEnabled;
- (void)_submitAskXiaoWeiUploadTask:(id)arg1;
- (id)askXiaoWeiContentSnapshotSuffix;
- (void)_performAskXiaoWeiUpload;
- (void)onAskXiaoWeiTappedImpl;
- (void)onAskXiaoWeiEntryTapped;
- (void)onAskXiaoWeiFromTextMenu;
