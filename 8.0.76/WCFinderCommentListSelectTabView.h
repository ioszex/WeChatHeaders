...
@property(retain, nonatomic) MMUIButton *xiaoweiButton; // @synthesize xiaoweiButton=_xiaoweiButton;
...
- (void)clickXiaoweiAction;
- (void)updateRightBarView:(id)arg1;
- (void)updateRightContainerLayout;
- (void)layoutSubviews;
- (void)_doLayout;
- (void)updateCommentStr:(id)arg1 shopCommentStr:(id)arg2 linkText:(id)arg3 showArrow:(_Bool)arg4 xiaoweiInfo:(id)arg5;
- (void)reloadLayout;
...
- (void)bindXiaoweiReportWithCommentScene:(int)arg1;
- (void)setupXiaoweiView;
