...
@class EditImageTextToolV2, MJClipBundleCoverPreviewView, MJClipBundleThumbnailSliderView, MMUIButton, MMUIView, NSString, NSURL, UIButton, UIImageView, UILabel, WCEditImageSafeAreaScrollView, WCFinderContact, WCFinderCoverBackGroundView, WCFinderCoverEditOptionModel, WCFinderCoverPhotoPreviewView, WCFinderCoverSelectAlbumView, WCFinderCoverVideoPreviewView, WCFinderCropRectModel, WCFinderEditTextWidgetStateArray, WCFinderPreviewEditVideoCompositionTask, WCFinderUnifiedCoverSliderView, WCFinderVideoSliderView;
@protocol WCFinderCoverEditViewControllerDelegate;

@interface WCFinderCoverEditViewController
{
    _Bool _hasManualSelectVideoCover;
    ...
    WCFinderUnifiedCoverSliderView *_unifiedSliderView;
...
@property(retain, nonatomic) WCFinderUnifiedCoverSliderView *unifiedSliderView; // @synthesize unifiedSliderView=_unifiedSliderView;
...
@property(nonatomic) _Bool hasManualSelectVideoCover; // @synthesize hasManualSelectVideoCover=_hasManualSelectVideoCover;
...
- (void)setupUIElementsHiddenWithSliderInteracting:(_Bool)arg1;
- (void)setupUnifiedCoverSliderViewIfNeeded;
- (int)getModeCardShowStyle;
- (void)onClickCancelAction;
- (void)onClickFinishAction;
- (int)getFinishCoverSourceType;
...
- (void)loadCoverInfoByVideoURL:(id)arg1 specialImage:(id)arg2 photoCoverUrl:(id)arg3 coverTimeStamp:(double)arg4 compositionTask:(id)arg5 modeStyle:(int)arg6 cropRectModel:(id)arg7 initialSourceType:(int)arg8 chooseBlock:(CDUnknownBlockType)arg9;
