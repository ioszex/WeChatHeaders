...
@interface MMALbumForPHAssetFramework
{
    ...
    _Bool _m_isLivePhotoDefaultUseOff;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_isLivePhotoDefaultUseOff; // @synthesize m_isLivePhotoDefaultUseOff=_m_isLivePhotoDefaultUseOff;
