...
@class CAGradientLayer, CALayer, CAShapeLayer, FanClubPanelInfo, FinderLiveRewardGiftExtInfo, MISSING_TYPE, MMCPLabel, MMFinderLiveGlobalRankSignView, MMFinderLiveGuidePubbleTipView, MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMHeadImageView, MMLiveHalfScreenTitleBarView, MMLiveRewardGiftAIGCOperationPanel, MMLiveRewardGiftAttackContactBubbleView, MMLiveRewardGiftCoinButton, MMLiveRewardGiftCustomizationTipView, MMLiveRewardGiftLayout, MMLiveRewardGiftNewCustomizationSettingPanel, MMLiveRewardGiftNewCustomizationTipView, MMLiveRewardGiftPreviewWindow, MMLiveRewardGiftSendingCountMenuBar, MMNormalTipsView, MMScrollView, MMUILabel, MMUIView, NSArray, NSIndexPath, NSMutableArray, NSMutableSet, NSString, UICollectionView, UIImageView, UILabel, UIPageControl, UIScrollView, UITapGestureRecognizer, UIView, WCFinderHeadImageView;
...
@interface MMLiveRewardGiftSelectionView
{
    ...
    unsigned int _preferredGiftUnlockType;
    ...
    UITapGestureRecognizer *_switchRewardUserGestureRecognizer;
    UIPageControl *_giftPageControl;
    MISSING_TYPE *_giftCollectionView;
    ...
    WCFinderHeadImageView *_identityHeadImageView;
    UIImageView *_identitySwitchIconView;
    MMUILabel *_identityNicknameLabel;
    ...
    NSMutableSet *_loadingGroupSet;
    MMFinderLiveRewardGiftItem *_packageSelectGiftItem;
    MMLiveRewardGiftAIGCOperationPanel *_aigcPanel;
    MMFinderLiveGuidePubbleTipView *_previewDesignerTipView;
    NSMutableSet *_exposedGiftKeys;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableSet *exposedGiftKeys; // @synthesize exposedGiftKeys=_exposedGiftKeys;
@property(retain, nonatomic) MMFinderLiveGuidePubbleTipView *previewDesignerTipView; // @synthesize previewDesignerTipView=_previewDesignerTipView;
@property(retain, nonatomic) MMLiveRewardGiftAIGCOperationPanel *aigcPanel; // @synthesize aigcPanel=_aigcPanel;
...
@property(retain, nonatomic) NSMutableSet *loadingGroupSet; // @synthesize loadingGroupSet=_loadingGroupSet;
@property(retain, nonatomic) NSIndexPath *preferredGiftIndexPath; // @synthesize preferredGiftIndexPath=_preferredGiftIndexPath;
@property(nonatomic) unsigned int preferredGiftUnlockType; // @synthesize preferredGiftUnlockType=_preferredGiftUnlockType;
...
@property(retain, nonatomic) MMUILabel *identityNicknameLabel; // @synthesize identityNicknameLabel=_identityNicknameLabel;
@property(retain, nonatomic) UIImageView *identitySwitchIconView; // @synthesize identitySwitchIconView=_identitySwitchIconView;
@property(retain, nonatomic) WCFinderHeadImageView *identityHeadImageView; // @synthesize identityHeadImageView=_identityHeadImageView;
...
@property(retain, nonatomic) UITapGestureRecognizer *switchRewardUserGestureRecognizer; // @synthesize switchRewardUserGestureRecognizer=_switchRewardUserGestureRecognizer;
...
- (void)reloadCurrentGroupCollectionView;
- (void)loadMoreGiftItemsForCurrentGroup;
- (_Bool)isLoadingMoreForGroup:(id)arg1;
- (void)onAIGCGiftGenerationShowPanelReddot:(id)arg1 generateSuccess:(_Bool)arg2;
- (void)onAIGCGiftStatusUpdated:(id)arg1 status:(unsigned long long)arg2;
- (void)onLiveRewardAIGCGiftOperationPageViewShouldReturnToGiftPanel;
- (void)onLiveRewardAIGCGiftOperationPageViewWillClose;
- (void)_showAIGCOperationPanel:(id)arg1;
- (void)showAIGCOperationPanel:(id)arg1;
- (id)audienceLogReporter;
- (void)commitCustomizationForModel:(id)arg1 blocking:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (_Bool)doesGiftItem:(id)arg1 matchUnlockType:(unsigned int)arg2;
...
- (void)onClickAIGCGiftJumpAction:(id)arg1 giftItem:(id)arg2;
...
- (void)bindYReportSdk:(id)arg1 andViewId:(id)arg2 indexPath:(id)arg3 andProductId:(id)arg4 tabName:(id)arg5;
...
- (void)showDesignerTipViewForPreviewWindow:(id)arg1;
...
- (void)checkScrollToBottomForPagination:(id)arg1;
...
- (void)onIdentityHeadImageTapped;
- (void)updateIdentityHeadImageAndNickname;
...
- (id)liveTask;
- (_Bool)shouldSkipFetchGiftListOnReopen;
- (_Bool)isTabEligibleForPositionRestore:(id)arg1;
...
- (id)initWithTaskId:(id)arg1 preferredGiftId:(id)arg2 preferredGiftUnlockType:(unsigned int)arg3;
