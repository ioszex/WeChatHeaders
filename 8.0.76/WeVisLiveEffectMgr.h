...
@class EAGLContext, MISSING_TYPE, MMGPUClarityFilter, MMGPUClarityPreProcess, MMGPUSpatiotemporalDenosing, NSArray, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, SpatiotemporalDenosingPreProcess, WCLoopMetricsCollector, WeVisByPassFS, WeVisGLCompose2RGBA, WeVisGLCompose2RGBAV2, WeVisGLFrameBuffer, WeVisGLRGBA2YUVTwoPassFS, WeVisGLTexture, WeVisGLYUV2RGBA, WeVisPixelBuffer;
...
@interface WeVisLiveEffectMgr : NSObject
{
    ...
    basic_string_911c138e filterStrPath;
    long long filterID;
    ...
    int oldOutputWidth;
    int oldOutputHeight;
    vector_d9962bf5 faceTrackInputRGB;
    ...
    long long contourId;
    MISSING_TYPE *enableHostDenoise;
    ...
    struct Settings {
        int Version;
        basic_string_911c138e AssetsDir;
        ...
        int FaceBeautyUseGanSmooth;
        int FaceSlim;
        vector_a3211293 StickerGroupOrder;
...
- (void)processFrames:(id)arg1 composeOutputSize:(struct CGSize)arg2 effectOutputSize:(struct CGSize)arg3 isBeginRenderEffect:(_Bool)arg4;
- (struct __CVBuffer *)processFrames:(id)arg1 composeOutputSize:(struct CGSize)arg2 outputComposeTexture:(int *)arg3 effectOutputSize:(struct CGSize)arg4 outputEffectTexture:(int *)arg5 isBeginRenderEffect:(_Bool)arg6;
- (void)updateComposeOutputSize:(struct CGSize)arg1 effectOutputSize:(struct CGSize)arg2;
...
- (void)setSkinSmooth:(float)arg1 bypassQueueing:(_Bool)arg2;
