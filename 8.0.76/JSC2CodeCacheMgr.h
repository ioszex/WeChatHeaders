...
- (void)modifyCodeCacheAccessTime:(id)arg1 time:(id)arg2;
...
- (void)createOrValidateCodeCacheWithUsingCodeCache:(_Bool)arg1 script:(id)arg2;
- (void)batchCreateCodeCacheIfNeededForScripts:(id)arg1 withoutDelay:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)validationCodeCacheForScriptWrap:(id)arg1 completion:(CDUnknownBlockType)arg2;
