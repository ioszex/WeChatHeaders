...
@class FlutterEventChannel, LiteAppVideoPlayerFrameUpdater, MAVEffectRenderer, NSString, TXLivePlayer, WCPlayerPlayArgs, WCPlayerPlaybackInfo, WCPlayerView;
...
@interface LiteAppVideoPlayer : NSObject
{
    ...
    NSString *_cacheKey;
    long long _rotate;
    unsigned long long _liveVideoInitialCurrentTime;
...
@property(nonatomic) unsigned long long liveVideoInitialCurrentTime; // @synthesize liveVideoInitialCurrentTime=_liveVideoInitialCurrentTime;
...
- (void)stopPlayer;
- (void)startPlayer;
- (_Bool)checkIsHDR:(id)arg1;
- (id)generatePreviewArgsWrap;
- (id)generateDownloadArgsWrap;
- (id)createPlayArgs:(_Bool)arg1 isHDR:(_Bool)arg2;
- (void)dispose;
- (void)disposePlayer;
- (void)createPlayer:(_Bool)arg1 isLive:(_Bool)arg2 isHDR:(_Bool)arg3;
