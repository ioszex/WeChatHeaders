...
@class CContact, CMessageWrap, HistoryMsgsInfo, MISSING_TYPE, MMFinderLiveRedPacketMessage, NSMutableArray, NSMutableDictionary, NSMutableString, NSString, RevokeWrap, WCFinderClubSystemMessage;
...
@interface CExtendInfoOfSysNewXmlForBiz : NSObject
{
    ...
    MISSING_TYPE *_m_revokedAtUserList;
}
