...
@class MISSING_TYPE, MMFinderLiveTaskId, MMLiveVoteViewModel, MMTimer, MMUIActivityIndicatorView, MMUIButton, MMUILabel, MMUIView, NSMutableArray, NSString, RichTextView, UICollectionView, UIView;
...
@interface MMLiveVotePopupView
{
    ...
    MISSING_TYPE *_choiceCollectionView;
