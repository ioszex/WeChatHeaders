...
@interface MMLiveMoreFunctionBaseManager : NSObject
{
    ...
    long long _fromSrc;
    unsigned long long _coLiveAnchorPermissionFlags;
...
@property(nonatomic) unsigned long long coLiveAnchorPermissionFlags; // @synthesize coLiveAnchorPermissionFlags=_coLiveAnchorPermissionFlags;
...
- (_Bool)canShowHeader:(long long)arg1;
...
- (void)scrollToAndHighLightItemWithItemType:(unsigned long long)arg1;
