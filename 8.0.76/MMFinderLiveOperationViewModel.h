...
@interface MMFinderLiveOperationViewModel : NSObject
{
    ...
    _Bool _isKtvPlayerCountExposed;
    ...
    MISSING_TYPE *_isMusicSettingButtonEnabled;
    ...
    _Bool _isLiveLotteryEnabled;
    _Bool _isLivePrizeButtonEnabled;
    ...
    InteractionWishConfig *_currentInteractionWishinfo;
    FinderLiveBoardEventSubTitle *_boardEventSubTitle;
    ...
    NSData *_lastRecommendGameNotifyLastBuffer;
    NSData *_lastReplaySubscriptionLastBuffer;
    ...
    NSString *_forwardCntString;
    NSString *_likeCntString;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *likeCntString; // @synthesize likeCntString=_likeCntString;
@property(retain, nonatomic) NSString *forwardCntString; // @synthesize forwardCntString=_forwardCntString;
@property(nonatomic) _Bool hasEventLiveUpdateNotify; // @synthesize hasEventLiveUpdateNotify=_hasEventLiveUpdateNotify;
...
@property(retain, nonatomic) NSData *lastReplaySubscriptionLastBuffer; // @synthesize lastReplaySubscriptionLastBuffer=_lastReplaySubscriptionLastBuffer;
@property(retain, nonatomic) NSData *lastRecommendGameNotifyLastBuffer; // @synthesize lastRecommendGameNotifyLastBuffer=_lastRecommendGameNotifyLastBuffer;
...
@property(nonatomic) double bottomDescFont; // @synthesize bottomDescFont=_bottomDescFont;
...
@property(nonatomic) double bottomButtonOffsetY; // @synthesize bottomButtonOffsetY=_bottomButtonOffsetY;
@property(nonatomic) _Bool isBottomButtonFontStyleSmall; // @synthesize isBottomButtonFontStyleSmall=_isBottomButtonFontStyleSmall;
...
@property(nonatomic) _Bool isShowAdsIconLiveTimeout; // @synthesize isShowAdsIconLiveTimeout=_isShowAdsIconLiveTimeout;
...
@property(nonatomic) unsigned int ktvContentId; // @synthesize ktvContentId=_ktvContentId;
...
@property(retain, nonatomic) FinderLiveBoardEventSubTitle *boardEventSubTitle; // @synthesize boardEventSubTitle=_boardEventSubTitle;
@property(retain, nonatomic) InteractionWishConfig *currentInteractionWishinfo; // @synthesize currentInteractionWishinfo=_currentInteractionWishinfo;
...
@property(nonatomic) _Bool isLivePrizeButtonEnabled; // @synthesize isLivePrizeButtonEnabled=_isLivePrizeButtonEnabled;
@property(nonatomic) _Bool isLiveLotteryEnabled; // @synthesize isLiveLotteryEnabled=_isLiveLotteryEnabled;
...
@property(nonatomic) _Bool isKtvPlayerCountExposed; // @synthesize isKtvPlayerCountExposed=_isKtvPlayerCountExposed;
...
- (void)bottomButtonEnhanceAnimationTriggered:(id)arg1;
...
@property(readonly, nonatomic) _Bool isBoardEventBannerEnabled;
@property(readonly, nonatomic) _Bool isGiftWallEnabled;
@property(readonly, nonatomic) _Bool isInteractionWishBannerEnabled;
@property(readonly, nonatomic) _Bool isWishBannerEnabled;
- (void)onLikeButtonFontChanged:(_Bool)arg1 offsetY:(double)arg2 bottomLabelHeight:(double)arg3;
- (double)getFontThatFit:(id)arg1;
- (void)adjustBottomDescLabelFont;
- (void)onAudienceLikeCntUpdated:(id)arg1;
- (void)innerUpdateShareCount:(unsigned long long)arg1 source:(long long)arg2;
...
- (void)onLiveMessageReceived:(id)arg1 isFullLiveInfo:(_Bool)arg2 onlineCount:(unsigned int)arg3 onlineViewCount:(unsigned int)arg4 ktvPlayerCount:(unsigned int)arg5 isNeverJoinFanclub:(_Bool)arg6 playTogetherIconJumpInfo:(id)arg7;
- (void)onExitLive;
- (void)onEnterLiveWithError:(id)arg1;
- (void)onJoinLiveRoom:(id)arg1 finderDataItem:(id)arg2;
- (void)updateTestLiveModeWithLiveInfo:(id)arg1;
- (void)updateCheerInfo:(id)arg1 fromGetLiveMsg:(_Bool)arg2;
@property(readonly, nonatomic) unsigned int adsIconShowDuration;
@property(readonly, nonatomic) _Bool showAdsIconLive;
