...
@class MISSING_TYPE, MMContext, NSRecursiveLock;
...
@interface SimpleRecordState : NSObject
{
    _Bool _m_running;
    _Bool _m_hasStart;
    _Bool _m_hasPrePared;
    MISSING_TYPE *_m_bufferByteSize;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_hasPrePared; // @synthesize m_hasPrePared=_m_hasPrePared;
