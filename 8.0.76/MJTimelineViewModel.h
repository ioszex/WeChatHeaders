...
@class MJElementSegmentViewModel, MJSegmentEditingStateViewModel, MJSegmentViewModel, MJStorylineViewModel, MJTimelineViewConfiguration, MJVisualClipSegmentViewModel, NSIndexPath, NSMutableDictionary, NSOrderedSet, NSString, OMCTimeline, OMJAspectRatio, OMJDecorPackageDesc, UBDictionarySignal, UBEmptySignal, UBValueSignal;
...
@interface MJTimelineViewModel : NSObject
{
    ...
    _Bool _hasManuallyAdjustedMusicDuration;
    ...
    OMJDecorPackageDesc *_decorPackageDesc;
    ...
    CDStruct_1b6d18a9 _expectedMusicDurationBeforeImplicitMoveClipping;
}

+ (void)disableAllImagesDigiZoomIfNeededWithTimeline:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool hasManuallyAdjustedMusicDuration; // @synthesize hasManuallyAdjustedMusicDuration=_hasManuallyAdjustedMusicDuration;
@property(nonatomic) float narrationSegmentsVolume; // @synthesize narrationSegmentsVolume=_narrationSegmentsVolume;
@property(nonatomic) CDStruct_1b6d18a9 expectedMusicDurationBeforeImplicitMoveClipping; // @synthesize expectedMusicDurationBeforeImplicitMoveClipping=_expectedMusicDurationBeforeImplicitMoveClipping;
...
@property(retain, nonatomic) OMJDecorPackageDesc *decorPackageDesc; // @synthesize decorPackageDesc=_decorPackageDesc;
...
- (void)resetExpectedMusicDurationBeforeImplicitMoveClipping;
- (void)recordExpectedMusicDurationBeforeImplicitMoveClippingIfNeededWithSegmentVM:(id)arg1;
...
- (_Bool)updateMusicSegmentWithMusicInfo:(id)arg1;
...
- (id)anchorVisualEffectSegmentAtTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2 normalizedContentSize:(struct CGSize)arg3 blurIntensity:(double)arg4 shouldAutoFocus:(_Bool)arg5 targetEditingState:(unsigned long long)arg6;
...
- (_Bool)trimMusicDurationAfterRemovingStorySegmentIfNeeded;
- (void)autoFillMusicDurationAfterInsertingStorySegmentIfNeeded:(_Bool)arg1;
- (_Bool)shouldAutoFillMusicDurationAfterInsertingStorySegment;
...
- (CDStruct_1b6d18a9)minimumMusicTimelineIntersectionDurationForMoving;
- (CDStruct_1b6d18a9)regulatedMovingStartTimeForTime:(CDStruct_1b6d18a9)arg1;
...
@property(readonly, nonatomic) _Bool isDigiZoomEnabled;
...
- (_Bool)canMoveMusicSegmentAtIndexPath:(id)arg1;
