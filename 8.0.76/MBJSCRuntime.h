...
@interface MBJSCRuntime
{
    ...
    NSMutableDictionary *_offScreenCanvasCallbackDict;
    NSMutableDictionary *_mapArrayBuffer;
    NSMutableDictionary *_timerDict;
    NSString *_bizName;
    NSString *_codeCacheDirPath;
    NSString *_baseLibCodeCacheExtra;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *baseLibCodeCacheExtra; // @synthesize baseLibCodeCacheExtra=_baseLibCodeCacheExtra;
@property(copy, nonatomic) NSString *codeCacheDirPath; // @synthesize codeCacheDirPath=_codeCacheDirPath;
...
@property(retain, nonatomic) NSMutableDictionary *offScreenCanvasCallbackDict; // @synthesize offScreenCanvasCallbackDict=_offScreenCanvasCallbackDict;
...
@property(nonatomic) _Bool codeCacheEnabled; // @synthesize codeCacheEnabled=_codeCacheEnabled;
...
- (id)consumeBaseLibCodeCacheExtra;
- (void)injectLibs;
- (void)notifyOnLoad;
