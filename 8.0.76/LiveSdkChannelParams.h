...
@class ChorusBgmUsrInfo, NSMutableArray, NSString, NewCfgMeta, QualityTagInfo, TRTCAiBotUsrInfo;
...
@property(retain, nonatomic) ChorusBgmUsrInfo *chorusBgmUsrInfo; // @dynamic chorusBgmUsrInfo;
...
@property(nonatomic) unsigned int flvGopCache; // @dynamic flvGopCache;
@property(nonatomic) unsigned int flvIpv6First; // @dynamic flvIpv6First;
...
@property(nonatomic) unsigned int keepmix; // @dynamic keepmix;
@property(nonatomic) unsigned int keepmixIdleTime; // @dynamic keepmixIdleTime;
...
@property(retain, nonatomic) NewCfgMeta *newCfgMeta; // @dynamic newCfgMeta;
...
@property(retain, nonatomic) NSString *p2PDomain; // @dynamic p2PDomain;
...
@property(nonatomic) unsigned int p2PUpdateVideoCacheSwitch; // @dynamic p2PUpdateVideoCacheSwitch;
...
@property(retain, nonatomic) TRTCAiBotUsrInfo *trtcAiBotUsrInfo; // @dynamic trtcAiBotUsrInfo;
