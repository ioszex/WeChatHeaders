...
@property(nonatomic) _Bool darkBubbleStyleEnabled; // @synthesize darkBubbleStyleEnabled=_darkBubbleStyleEnabled;
- (id)darkBubbleOverrideColorForName:(id)arg1 originalDark:(id)arg2;
- (_Bool)isDarkBubbleOverrideColor:(id)arg1;
