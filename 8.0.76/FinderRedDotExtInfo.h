...
@class DelayBubble, FinderJumpConfig, FinderJumpInfo, FinderLiveDiscoverPreloadConfig, FinderLiveReddotFeature, FinderReddotContainer, FinderSyncTipsShowInfo, NSData, NSString;
...
@property(retain, nonatomic) FinderReddotContainer *finderReddotContainer; // @dynamic finderReddotContainer;
...
@property(retain, nonatomic) NSData *lvMentionRedDotByPassInfo; // @dynamic lvMentionRedDotByPassInfo;
