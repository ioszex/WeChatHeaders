...
@property(nonatomic) unsigned int allowGuideToDiscover; // @dynamic allowGuideToDiscover;
...
@property(retain, nonatomic) NextLiveNotificationButton *nextLiveNotificationButton; // @dynamic nextLiveNotificationButton;
