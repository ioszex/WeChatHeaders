...
@class MMListenFeedIdListResponse, MMListenMusicChatRoomInfo, MMListenRecommendInfo, MMListenSurveyInfo, NSData, NSMutableArray, NSString, TingItem, TingListFliterCondiction, TingRecommendCategoryInfo;
...
@property(retain, nonatomic) MMListenSurveyInfo *surveyInfo; // @dynamic surveyInfo;
