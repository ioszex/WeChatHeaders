...
@class BusiF2FFavorCommResp, ExtraBuyInfo, MISSING_TYPE, NSArray, NSString, WCPayWarningNotice;
...
@property(retain, nonatomic) NSString *jump_route_info; // @synthesize jump_route_info=_jump_route_info;
