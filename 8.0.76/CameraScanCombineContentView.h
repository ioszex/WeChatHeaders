...
@interface CameraScanCombineContentView
{
    ...
    _Bool _hasReportedFirstDetectItemCost;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool hasReportedFirstDetectItemCost; // @synthesize hasReportedFirstDetectItemCost=_hasReportedFirstDetectItemCost;
