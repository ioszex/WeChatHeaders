...
@class EditImageAttr, EditVideoAttr, MMAsset, MMAssetInfo, MMAssetPickerInterceptor, MMImagePickerReportInfo, MMImagePreviewBrowserController, MMImagePreviewControllerActionFlow, NSArray, NSError, NSString, SightDraft, UIButton, UIView, WCFinderPostSessionModel;
...
- (void)onInsertSelectedInfo:(MMAssetInfo *)arg1 atIndex:(unsigned long long)arg2 browserController:(MMImagePreviewBrowserController *)arg3;
...
- (MMImagePickerReportInfo *)getReportInfo;
