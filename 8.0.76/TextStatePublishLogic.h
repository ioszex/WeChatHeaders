...
- (void)processAffDBEventWithType:(int)arg1 eventSub:(int)arg2 eventData:(id)arg3;
- (void)unsubscribeAffDBStatusInfoChangeEvent;
- (void)subscribeAffDBStatusInfoChangeEvent;
