...
@class AUAudioDevice, AVVideoDevice, CContact, CMMotionManager, MISSING_TYPE, MMTimer, NSArray, NSData, NSRecursiveLock, NSString, VOIPComponent, VOIPDialData, VOIPVideoRender;
...
@interface VOIPCSMgr
{
    ...
    MISSING_TYPE *m_usingFrontCameraLastFrame;
