...
- (void)cancelFromAgentCardWithReason:(id)arg1;
- (void)sendSubscribeRequestFromAgentCardWithViewModel:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)sendSubscribeRequestFromAgentCardWithViewModel:(id)arg1;
