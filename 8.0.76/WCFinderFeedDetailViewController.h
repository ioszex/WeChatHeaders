...
@interface WCFinderFeedDetailViewController
{
    ...
    WCFinderHeadInfoEasyView *_headInfoView;
...
@property(retain, nonatomic) WCFinderHeadInfoEasyView *headInfoView; // @synthesize headInfoView=_headInfoView;
