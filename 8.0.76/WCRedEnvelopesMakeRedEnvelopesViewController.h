...
@class CEmoticonWrap, EmoticonBoardView, EmoticonCustomAddLogicController, GetDefaultRedpacketResponse, GetRecommendedCoverResponse, MMBadgeView, MMEmoticonView, MMTextView, MMUIButton, MMUILabel, NSArray, NSMutableDictionary, NSNumber, NSString, RichTextView, SequenceAnimationObject, UIButton, UIImageView, UILabel, UIView, WCBaseKeyboardToolBar, WCPayDecimalKeyboardView, WCPayNoticeItemView, WCPayWebImageView, WCPayWebPagView, WCRedEnvelopesMakeRedEnvelopesViewLayout, WCRedEnvelopesRedSkinIndicatorView, WCRedEnvelopesSelectSkinRedDotInfo, WCRedEnvelopesSkinPreviewView, WCRedEnvelopesSpringFestivalActivtyEntryView, WCRedEnvelopesWishingRecommendSkinViewNew, WCUITextField;
...
@interface WCRedEnvelopesMakeRedEnvelopesViewController
{
    ...
    _Bool _needRecoverRecommendView;
    _Bool _isNeedRefreshMakeVC;
    _Bool _isNeedRecoverNewFunctionView;
    ...
    _Bool _isShowingRecommendSkin;
    _Bool _isCleaningRecommendSkinAnimate;
    _Bool _hasShowNewFuncEntry;
    ...
    WCRedEnvelopesRedSkinIndicatorView *_redSkinIndicatorView;
    UILabel *_redDotWordingLabel;
    WCPayWebImageView *_redDotIconView;
    WCRedEnvelopesSkinPreviewView *_chooseSkinPreviewView;
    UIImageView *_chooseSkinArrowView;
    MMUILabel *_chooseSkinTitleLabel;
    GetDefaultRedpacketResponse *_promotionFuncParams;
    NSArray *_recommendSkinList;
    NSString *_requestWishing;
    double _chooseRedSkinViewGrowHeight;
    WCRedEnvelopesWishingRecommendSkinViewNew *_wishingRecommendSkinView;
    UIView *_oWishingView;
    UIView *_m_bottomView;
    double _bottomViewInitialY;
    UIImageView *_m_bgMaskImageView;
    UIButton *_tailInfoButton;
    NSMutableDictionary *_wishingTextRecommendStatusDict;
    GetRecommendedCoverResponse *_recommendedCoverResponse;
    UIImageView *_m_bottomGradientView;
    NSNumber *_pendingInitialMoneyFen;
    NSString *;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *pendingInitialWishing; // @synthesize pendingInitialWishing=_pendingInitialWishing;
@property(retain, nonatomic) NSNumber *pendingInitialMoneyFen; // @synthesize pendingInitialMoneyFen=_pendingInitialMoneyFen;
@property(retain, nonatomic) UIImageView *m_bottomGradientView; // @synthesize m_bottomGradientView=_m_bottomGradientView;
@property(nonatomic) _Bool hasShowNewFuncEntry; // @synthesize hasShowNewFuncEntry=_hasShowNewFuncEntry;
@property(retain, nonatomic) GetRecommendedCoverResponse *recommendedCoverResponse; // @synthesize recommendedCoverResponse=_recommendedCoverResponse;
@property(retain, nonatomic) NSMutableDictionary *wishingTextRecommendStatusDict; // @synthesize wishingTextRecommendStatusDict=_wishingTextRecommendStatusDict;
@property(retain, nonatomic) UIButton *tailInfoButton; // @synthesize tailInfoButton=_tailInfoButton;
@property(retain, nonatomic) UIImageView *m_bgMaskImageView; // @synthesize m_bgMaskImageView=_m_bgMaskImageView;
- (void);
@property(nonatomic) double bottomViewInitialY; // @synthesize bottomViewInitialY=_bottomViewInitialY;
@property(retain, nonatomic) UIView *m_bottomView; // @synthesize m_bottomView=_m_bottomView;
@property(retain, nonatomic) UIView *oWishingView; // @synthesize oWishingView=_oWishingView;
@property(retain, nonatomic) WCRedEnvelopesWishingRecommendSkinViewNew *wishingRecommendSkinView; // @synthesize wishingRecommendSkinView=_wishingRecommendSkinView;
@property(nonatomic) double chooseRedSkinViewGrowHeight; // @synthesize chooseRedSkinViewGrowHeight=_chooseRedSkinViewGrowHeight;
@property(nonatomic) _Bool isCleaningRecommendSkinAnimate; // @synthesize isCleaningRecommendSkinAnimate=_isCleaningRecommendSkinAnimate;
@property(nonatomic) _Bool isShowingRecommendSkin; // @synthesize isShowingRecommendSkin=_isShowingRecommendSkin;
@property(retain, nonatomic) NSString *requestWishing; // @synthesize requestWishing=_requestWishing;
...
@property(retain, nonatomic) MMUILabel *chooseSkinTitleLabel; // @synthesize chooseSkinTitleLabel=_chooseSkinTitleLabel;
@property(retain, nonatomic) UIImageView *chooseSkinArrowView; // @synthesize chooseSkinArrowView=_chooseSkinArrowView;
@property(retain, nonatomic) WCRedEnvelopesSkinPreviewView *chooseSkinPreviewView; // @synthesize chooseSkinPreviewView=_chooseSkinPreviewView;
...
@property(retain, nonatomic) WCRedEnvelopesRedSkinIndicatorView *redSkinIndicatorView; // @synthesize redSkinIndicatorView=_redSkinIndicatorView;
...
@property(nonatomic) _Bool isNeedRecoverNewFunctionView; // @synthesize isNeedRecoverNewFunctionView=_isNeedRecoverNewFunctionView;
@property(nonatomic) _Bool isNeedRefreshMakeVC; // @synthesize isNeedRefreshMakeVC=_isNeedRefreshMakeVC;
@property(nonatomic) _Bool needRecoverRecommendView; // @synthesize needRecoverRecommendView=_needRecoverRecommendView;
@property(nonatomic) int m_enMakeRedEnvelopesScene; // @synthesize m_enMakeRedEnvelopesScene;
- (void)applyPendingInitialValuesIfNeeded;
- (void)setInitialWishing:(id)arg1;
- (void)setInitialMoneyInFen:(unsigned long long)arg1;
- (id)getCurrentWishing;
- (id)getClickedCoverID;
- (double)cellGap;
- (double)getChooseSkinCellHeight;
- (_Bool)isCurrentWishingTextHasRecommendedCovers;
- (void)onClickWCRedEnvelopesWishingRecommendSkinView:(id)arg1;
- (void)onClickNewFuncPromotion:(id)arg1;
- (void)onWCRedEnvelopesWishingRecommendSkinViewClickRightArea:(id)arg1;
- (void)onWCRedEnvelopesWishingRecommendSkinViewClickLeftArea:(id)arg1;
...
- (_Bool)isRecommendSkinSwitchOn;
- (void)cleanWishingRecommendSkin;
- (void)reportRedSkinEmoticonDataFor18890:(unsigned int)arg1;
- (void)cleanWishingRecommendSkin:(_Bool)arg1;
- (void)showWishingRecommendSkinList:(_Bool)arg1;
- (id)reportWishingText;
- (unsigned int)getWishingSkinRecommendType;
- (void)internalShowNewFuncPromotionEntry:(id)arg1 animated:(_Bool)arg2;
- (void)showOrCleanSkinList:(id)arg1;
- (void)showWishingRecommendSkin:(id)arg1 withWishingText:(id)arg2 requestTimestamp:(unsigned long long)arg3 scene:(unsigned int)arg4;
- (void)showNewFuncPromotionEntry:(id)arg1 animated:(_Bool)arg2;
- (_Bool)hasChoseNonDefaultRedSkin;
...
- (void)tableViewHandleTap:(id)arg1;
...
- (void)triggerRecommendSkinCgi:(id)arg1;
...
- (double)setupChooseSkinCellWithHeaderViewNew:(id)arg1 nextViewY:(double)arg2;
