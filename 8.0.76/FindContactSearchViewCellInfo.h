...
@class AISearchContactDataProvider, MMLoadingView, MMUILabel, MMUIViewController, NSArray, NSString, SearchContactDataProvider, UITextField, UIView, WCDataSearcher;
...
@interface FindContactSearchViewCellInfo
{
    ...
    _Bool _lastSearchIncludeIntelligence;
    ...
    AISearchContactDataProvider *_aiSearchContactDataProvider;
...
@property(nonatomic) _Bool lastSearchIncludeIntelligence; // @synthesize lastSearchIncludeIntelligence=_lastSearchIncludeIntelligence;
@property(retain, nonatomic) AISearchContactDataProvider *aiSearchContactDataProvider; // @synthesize aiSearchContactDataProvider=_aiSearchContactDataProvider;
...
- (void)showBizConfig;
- (void)doExit;
- (void)onTestCrashResort:(id)arg1;
- (void)onTestMainThreadLockTrace;
- (void)onFoom;
- (void)onTestCrashStackOverflow;
...
- (id)getLocalSearchResult;
- (id)getCurrSearchText;
- (void)onSearchResultViewNeedStartWebSearchWithQuery:(id)arg1;
...
- (void)doSearchWithIntelligence:(_Bool)arg1;
- (void)doSearch;
