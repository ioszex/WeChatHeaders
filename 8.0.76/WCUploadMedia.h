...
@class EditImageAttr, EditVideoAttr, MMImageExifLogInfo, NSArray, NSData, NSDictionary, NSMutableArray, NSString, VideoUploadStatInfo, WCMediaEcsInfo, WCMomentFinderInfo, WCMomentsBizInfo, WCUrl;
...
@interface WCUploadMedia : NSObject
{
    ...
    WCMomentFinderInfo *_finderInfo;
    NSString *_yuanBaoTemplate;
    ...
    NSString *_metaDataJsonArray;
    NSString *_fileFingerprint;
...
@property(retain, nonatomic) NSString *fileFingerprint; // @synthesize fileFingerprint=_fileFingerprint;
@property(retain, nonatomic) NSString *metaDataJsonArray; // @synthesize metaDataJsonArray=_metaDataJsonArray;
@property(nonatomic) _Bool isMultiSpec; // @synthesize isMultiSpec=_isMultiSpec;
...
@property(retain, nonatomic) NSString *yuanBaoTemplate; // @synthesize yuanBaoTemplate=_yuanBaoTemplate;
@property(retain, nonatomic) WCMomentFinderInfo *finderInfo; // @synthesize finderInfo=_finderInfo;
...
@property(retain, nonatomic) WCUrl *hdUrl; // @synthesize hdUrl=_hdUrl;
@property(retain, nonatomic) WCUrl *uhdUrl; // @synthesize uhdUrl=_uhdUrl;
@property(retain, nonatomic) NSString *mediaSourcePath; // @synthesize mediaSourcePath=_mediaSourcePath;
...
- (_Bool)saveMediaFromSourcePath:(id)arg1;
