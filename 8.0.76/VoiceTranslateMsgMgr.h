...
- (void)onVoiceTransNoTextRecognized:(id)arg1;
...
- (_Bool)isExistDialectRecord:(id)arg1 msgWrap:(id)arg2;
- (void)removeDialectRecord:(id)arg1 msgWrap:(id)arg2;
- (void)addDialectRecord:(id)arg1 msgWrap:(id)arg2;
- (id)_getDialectSet:(id)arg1;
...
- (id)getLocalTranslateTextForFTS:(id)arg1;
- (void)cleanAllResult;
- (void)onServiceInit;
