...
@property(nonatomic) _Bool supportRecoverSelect; // @synthesize supportRecoverSelect=_supportRecoverSelect;
@property(nonatomic) _Bool showAddEmoticon; // @synthesize showAddEmoticon=_showAddEmoticon;
@property(retain, nonatomic) NSArray *displayMd5List; // @synthesize displayMd5List=_displayMd5List;
...
- (_Bool)commitInsertPlaceImmediately;
...
- (id)originEmoticonManageWrapAtIndex:(unsigned long long)arg1;
