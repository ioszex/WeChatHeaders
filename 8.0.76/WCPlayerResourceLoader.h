...
@class M3U8Parser, NSMutableDictionary, NSRecursiveLock, NSString, WCAssetDataLoaderProxy, WCBaseScheduler, WCDownloadArgsWrap, WCPlayerDownloader, WCPlayerLoadingRequestTaskInfo, WCPlayerPlayArgs, WCPlayerPlaybackInfo, WCPlayerReporter;
...
@interface WCPlayerResourceLoader
{
    ...
    WCPlayerLoadingRequestTaskInfo *_currentTask;
...
- (void)internalStart;
- (void)start;
- (void)asyncQueryRecallCountFromStartDownloadToReady;
