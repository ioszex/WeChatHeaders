...
{
    _Bool _previousFrameIsLockSpeedTriggered;
...
@property(nonatomic) _Bool previousFrameIsLockSpeedTriggered; // @synthesize previousFrameIsLockSpeedTriggered=_previousFrameIsLockSpeedTriggered;
