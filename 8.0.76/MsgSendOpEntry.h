...
@property(nonatomic) _Bool xiaowei; // @synthesize xiaowei=_xiaowei;
...
@property(nonatomic) _Bool hideAttachBtn; // @synthesize hideAttachBtn=_hideAttachBtn;
@property(nonatomic) _Bool dictation; // @synthesize dictation=_dictation;
