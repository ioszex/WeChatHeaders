...
@class MemoryMappedKV, StatusDBCache;

@interface StatusDBImpl
{
    _Bool _useDbCache;
    MemoryMappedKV *_mmkv;
    StatusDBCache *_dbCache;
}

+ (id)checkTextStateForAddOrModify:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) StatusDBCache *dbCache; // @synthesize dbCache=_dbCache;
@property(retain, nonatomic) MemoryMappedKV *mmkv; // @synthesize mmkv=_mmkv;
@property _Bool useDbCache; // @synthesize useDbCache=_useDbCache;
- (_Bool)isCacheReady;
...
- (_Bool)addStatusReadRecord:(id)arg1 statusId:(id)arg2 username:(id)arg3;
