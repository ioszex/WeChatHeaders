...
@interface WAContact : NSObject
{
    ...
    unsigned int _m_uiBasicInfoVersion;
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *debugModeChecksum; // @synthesize debugModeChecksum=_debugModeChecksum;
...
@property(nonatomic) unsigned int m_uiBasicInfoVersion; // @synthesize m_uiBasicInfoVersion=_m_uiBasicInfoVersion;
@property(copy, nonatomic) NSString *m_nsHeadImgUrl; // @synthesize m_nsHeadImgUrl=_m_nsHeadImgUrl;
- (void)setM_nsHeadHDImgUrl:(id)arg1;
- (id)m_nsHeadHDImgUrl;
