...
- (_Bool)deepLinkVideoFileWithCDNTask:(id)arg1 isTempPath:(_Bool)arg2;
...
- (id)livePhotoDownloadArgsWrapWithMediaWrap:(id)arg1;
...
- (_Bool)_checkMediaWrapCanCancel:(id)arg1 groupID:(id)arg2;
- (_Bool)stopDownloadTaskWithGroupID:(id)arg1;
