...
@interface BaseMessageViewModel
{
    ...
    double _customHeadImageCornerRadius;
}

+ (id)getChatRoomDisplayNameWithContact:(id)arg1 chatContact:(id)arg2;
+ (_Bool)canCreateViewModelInBackground;
+ (_Bool)canCreateMessageViewModelWhilePreload;
+ (_Bool)canCreateMessageViewModelWhilePreloadWithMessageWrap:(id)arg1;
...
@property(nonatomic) double customHeadImageCornerRadius; // @synthesize customHeadImageCornerRadius=_customHeadImageCornerRadius;
