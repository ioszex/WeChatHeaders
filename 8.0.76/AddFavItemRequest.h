...
@property(retain, nonatomic) NSString *starBizKey; // @dynamic starBizKey;
@property(nonatomic) unsigned int starCeateTime; // @dynamic starCeateTime;
@property(nonatomic) unsigned int starFlag; // @dynamic starFlag;
