...
@interface KvReportItem18218
{
    ...
    unsigned int _reddotNotifyOptions_50;
    unsigned int _ActType_51;
    unsigned int _ShowTimestampType_55;
    ...
    NSString *_reddotWording_49;
    unsigned long long _ActiveID_52;
    unsigned long long _MsgRecordID_53;
    unsigned long long _ShowTimestamp_54;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned int ShowTimestampType_55; // @synthesize ShowTimestampType_55=_ShowTimestampType_55;
@property(nonatomic) unsigned long long ShowTimestamp_54; // @synthesize ShowTimestamp_54=_ShowTimestamp_54;
@property(nonatomic) unsigned long long MsgRecordID_53; // @synthesize MsgRecordID_53=_MsgRecordID_53;
@property(nonatomic) unsigned long long ActiveID_52; // @synthesize ActiveID_52=_ActiveID_52;
@property(nonatomic) unsigned int ActType_51; // @synthesize ActType_51=_ActType_51;
@property(nonatomic) unsigned int reddotNotifyOptions_50; // @synthesize reddotNotifyOptions_50=_reddotNotifyOptions_50;
@property(copy, nonatomic) NSString *reddotWording_49; // @synthesize reddotWording_49=_reddotWording_49;
