...
@interface MMLiveRewardGiftNotificationView
{
    ...
    CDUnknownBlockType _didGitfCountUpdatedCallback;
    ...
    unsigned long long _lastShowGiftCount;
...
@property(nonatomic) unsigned long long lastShowGiftCount; // @synthesize lastShowGiftCount=_lastShowGiftCount;
...
@property(copy, nonatomic) CDUnknownBlockType didGitfCountUpdatedCallback; // @synthesize didGitfCountUpdatedCallback=_didGitfCountUpdatedCallback;
