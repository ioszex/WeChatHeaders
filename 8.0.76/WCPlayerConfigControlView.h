...
@interface WCPlayerConfigControlView
{
    ...
    CDUnknownBlockType _onVideoPlayErrorBlock;
    UIView *_toolPanView;
...
@property(copy, nonatomic) CDUnknownBlockType onVideoPlayErrorBlock; // @synthesize onVideoPlayErrorBlock=_onVideoPlayErrorBlock;
