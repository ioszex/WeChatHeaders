...
@interface WCAdConventionalHalfScreenScrollView : UIScrollView
{
    ...
    double _webViewNarrowWidth;
    struct CGPoint _beginDraggingOffset;
}

- (void).cxx_destruct;
@property(nonatomic) double webViewNarrowWidth; // @synthesize webViewNarrowWidth=_webViewNarrowWidth;
@property(nonatomic) _Bool isResettingLayout; // @synthesize isResettingLayout=_isResettingLayout;
...
- (double)calcCeilingTopPercentForContentOffsetY:(double)arg1;
...
- (id)appendParamsToUrl:(id)arg1 withAdvertiseInfo:(id)arg2 notAppendParamsToActionLink:(_Bool)arg3;
- (id)appendParamsToUrl:(id)arg1 andUpdateExtraInfo:(inout id)arg2 withDataItem:(id)arg3 notAppendParamsToActionLink:(_Bool)arg4;
- (void)initialWebView;
