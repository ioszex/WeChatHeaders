...
@class NSArray, NSDictionary, NSMutableArray, NSObject, NSString, UIEvent, UIPanGestureRecognizer, UIScrollView, UIViewController, WAAppTaskExtInfo, WAGameExtraInfo, WAJSEventHandler_BaseEvent, WAPermissionResult, WATransferJSAPIRuntimeModel, WAWebViewController, _TtC9WeAppCore15WACallUserEvent;
...
@optional
- (void)handleSwipeLeft:(UIPanGestureRecognizer *)arg1;
- (NSString *)getNavAlertTitleForWebview:(WAWebViewController *)arg1;
- (long long)currentMenuMutationTypeForWebView:(WAWebViewController *)arg1;
...
- (void)prepareSiderbarSnapshotBeforeExitWithCompletion:(void (^)(void))arg1;
- (void)exitToBackgroundFromWebView:(WAWebViewController *)arg1 action:(long long)arg2 extraDataIfHave:(id)arg3 privateExtraDataIfHave:(id)arg4 fromNavigateBackWeApp:(_Bool)arg5;
...
- (WAWebViewController *)popWebViewCountMixedStack:(int)arg1 fromWebView:(WAWebViewController *)arg2 skipIntermediate:(_Bool)arg3 completion:(void (^)(void))arg4;
- (WAWebViewController *)popWebViewCount:(int)arg1 fromWebView:(WAWebViewController *)arg2 skipIntermediate:(_Bool)arg3 completion:(void (^)(void))arg4;
- (void)popToWebView:(WAWebViewController *)arg1 fromWebView:(WAWebViewController *)arg2 skipIntermediate:(_Bool)arg3 completion:(void (^)(void))arg4;
...
- (WAWebViewController *)getTabChildWebViewWithRelativeURL:(NSString *)arg1 extraInfo:(NSDictionary *)arg2 fromWebView:(WAWebViewController *)arg3;
...
- (void)webView:(WAWebViewController *)arg1 receiveHitTest:(UIEvent *)arg2;
...
- (void)webView:(WAWebViewController *)arg1 pageRouteDownloadedInfoDatas:(NSArray *)arg2 beginTime:(unsigned long long)arg3 endTime:(unsigned long long)arg4;
...
- (void)webViewWillDisappear:(WAWebViewController *)arg1;
