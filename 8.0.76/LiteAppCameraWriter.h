...
@class AQAudioRecorder, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, GPUImageFramebuffer, MISSING_TYPE, NSObject, NSString, NSURL;
...
@property(copy, nonatomic) NSString *outputMode; // @synthesize outputMode=_outputMode;
