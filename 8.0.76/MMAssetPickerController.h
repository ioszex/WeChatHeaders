...
@class EditImageAttr, MMAlbum, MMAlbumAccessAuthView, MMAlbumAuthorizationReportObject, MMAlbumDropPickerController, MMAlbumDropableTitleWithMultipleSectionView, MMAsset, MMAssetDragSelectHelper, MMAssetPickerActionBottomView, MMAssetPickerControllerProxyObjectForAllAsset, MMAssetPickerControllerState, MMAssetPickerSlider, MMAssetUserActionTipsView, MMImagePickerVideoCompressQueue, MMScrollView, MMSightCameraViewController, MMTableView, MMUIButton, MMUIImageView, MMUILabel, MsgMediaGroupCombineSendView, NSDateFormatter, NSHashTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIButton, UIImageView, UILabel, UIView, VideoEncodeTask, WCFinderFeedPickerSelectedInfo, WCFinderFeedPickerViewController, WCFinderPreviewEditVideoCompositionTask, WCFinderSyncComposeResModel;
@protocol MMAssetPickerControllerDelegate, MMDropableTitleViewAbility, MMImagePickerControlCenter, UIViewControllerPreviewing;
...
@interface MMAssetPickerController
{
    ...
    _Bool _isShowSwipeDismissConfirm;
    _Bool _isDragged;
    ...
    WCFinderFeedPickerSelectedInfo *_selectedFinderDataInfo;
    MMAssetDragSelectHelper *_dragSelectHelper;
    MMAlbumDropPickerController *_dropController;
    CDUnknownBlockType _pageSheetSliderActiveChangedBlock;
    EditImageAttr *_editingInfo;
    ...
    UIView<MMDropableTitleViewAbility> *_defaultTitleView;
    MMAssetUserActionTipsView *_userActionTipsView;
    MsgMediaGroupCombineSendView *_combineSendView;
    struct UIEdgeInsets _additionalTableViewInsets;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MsgMediaGroupCombineSendView *combineSendView; // @synthesize combineSendView=_combineSendView;
...
@property(retain, nonatomic) UIView<MMDropableTitleViewAbility> *defaultTitleView; // @synthesize defaultTitleView=_defaultTitleView;
...
@property(nonatomic) _Bool isShowSwipeDismissConfirm; // @synthesize isShowSwipeDismissConfirm=_isShowSwipeDismissConfirm;
...
@property(retain, nonatomic) UILabel *originAssetTips; // @synthesize originAssetTips=_originAssetTips;
...
@property(nonatomic) long long systemAssetCount; // @synthesize systemAssetCount=_systemAssetCount;
...
@property(retain, nonatomic) EditImageAttr *editingInfo; // @synthesize editingInfo=_editingInfo;
@property(nonatomic) _Bool isSupportHeif; // @synthesize isSupportHeif=_isSupportHeif;
@property(copy, nonatomic) CDUnknownBlockType pageSheetSliderActiveChangedBlock; // @synthesize pageSheetSliderActiveChangedBlock=_pageSheetSliderActiveChangedBlock;
...
@property(retain, nonatomic) WCFinderFeedPickerSelectedInfo *selectedFinderDataInfo; // @synthesize selectedFinderDataInfo=_selectedFinderDataInfo;
...
- (void)sendVideoWithURL:(id)arg1 aigcContent:(id)arg2;
...
- (void)onInsertSelectedInfo:(id)arg1 atIndex:(unsigned long long)arg2 browserController:(id)arg3;
...
- (void)onAssetView:(id)arg1 liveButtonSelectChange:(_Bool)arg2;
...
- (void)finderFeedPickerViewControllerShowWarning:(id)arg1;
- (void)finderFeedPickerViewControllerRemoveSelected;
- (void)finderFeedPickerViewControllerAddSelected:(id)arg1;
...
- (void)albumDropPicker:(id)arg1 onAlbumListStateChanged:(_Bool)arg2;
...
- (void)recordSelectedAsset:(id)arg1 browserController:(id)arg2;
...
- (void)showSwipeDismissConfirmationAlert;
...
- (void)saveEditedVideo:(CDUnknownBlockType)arg1;
...
- (id)prepareImagePreviewControllerWithStartAssetInfo:(id)arg1 justPreviewSelected:(_Bool)arg2;
...
- (_Bool)isAccessAuthViewShowing;
- (_Bool)useNewAlbumNavStyle;
- (void)switchAlbumExpandStatus;
...
- (void)initBottomBar;
- (void)scrollToRevealLastSelectedAssetIfNeeded;
- (void)onCombineSendCheckChanged;
- (void)setCombineSendHidden:(_Bool)arg1 animated:(_Bool)arg2;
- (_Bool)isCombineSendHidden;
...
- (void)assetUnselectableToast:(id)arg1;
...
- (void)onPreviewEmoticonImageWithAssets:(id)arg1 fromScene:(unsigned long long)arg2 entranceScene:(unsigned long long)arg3;
...
- (void)onEditTimelineHeaderVideoWithAssetInfo:(id)arg1;
...
- (id)pageSheetAdapter;
- (void)updateLayoutForPageSheetMode;
@property(nonatomic) _Bool isInPageSheetModeFullScreen;
