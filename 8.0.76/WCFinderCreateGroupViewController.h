...
@class CContact, FinderNicknameVerifyInfo, MISSING_TYPE, MMGrowTextView, MMUIButton, NSString, RichTextView, UIButton, UIImage, UILabel, UIScrollView, UIView, WCFinderBannerView, WCFinderContact, WCFinderCreateUserVerifyPhoneLogic, WCFinderCreateUserViewModel, WCFinderGetWechatHDHeadFetcher;
...
@interface WCFinderCreateGroupViewController
{
    ...
    MISSING_TYPE *_signatureTextView;
