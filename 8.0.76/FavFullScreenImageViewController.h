...
@class CBTImageAiPReportContext, EditImageForwardAndEditLogicController, FavFullScreenImageButtonsContainerView, FavShowOriginLogic, MMFullScreenItemView, MMImageActionSheet, MMImageBrowserIntentPredictor, MMScrollActionSheet, MMScrollView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, ScanQRCodeLogicController, ScanQRCodeLogicParams, SimpleImgInfo, UIView, WCActionSheetWithScanWXCode;
...
+ (id)convertWxamFilePathIfNeeded:(id)arg1;
+ (id)animationShowWithRecordData:(id)arg1 originView:(id)arg2 index:(unsigned int)arg3 fromViewController:(id)arg4 settingBlock:(CDUnknownBlockType)arg5;
...
@property(nonatomic) unsigned long long circleToSearchScene; // @synthesize circleToSearchScene=_circleToSearchScene;
@property(nonatomic) _Bool disableAskXiaoWeiEntry; // @synthesize disableAskXiaoWeiEntry=_disableAskXiaoWeiEntry;
@property(nonatomic) _Bool isOpenFromFlutterWeNote; // @synthesize isOpenFromFlutterWeNote=_isOpenFromFlutterWeNote;
...
@property(nonatomic) _Bool m_videoMuted; // @synthesize m_videoMuted=_m_videoMuted;
...
- (void)updateLivePhotoWhenDownloadOK:(id)arg1 DataId:(id)arg2;
...
- (id)getMessageUUID;
- (void)onSaveToAlbum;
- (void)recordAlbumBookkeepingIfNeeded:(id)arg1 srcPath:(id)arg2 isVideo:(_Bool)arg3 assetID:(id)arg4;
- (_Bool)tryShowRepeatSaveConfirmForRecordAsset:(id)arg1 srcPath:(id)arg2 isVideo:(_Bool)arg3 onConfirm:(CDUnknownBlockType)arg4;
- (id)tryOperateCurrentVideo:(_Bool)arg1 block:(CDUnknownBlockType)arg2;
- (void)onFavorites;
- (void)editImage;
...
- (void)setupShowOriginFooterIfNeeded;
...
- (void)viewDidLoad;
- (_Bool)showRecommendedAskXiaoWeiForCurrentRecordImage;
- (void)showAskXiaoWeiForCurrentImageWithAnchorView:(id)arg1;
- (void)detectAskXiaoWeiImageIntentIfNeededForImageInfo:(id)arg1;
- (id)imageAiPReportContextForImageInfo:(id)arg1;
- (void)beginImageAiPReportVisitForImageInfo:(id)arg1;
- (id)imageAiPVisitIdentifierForImageInfo:(id)arg1;
- (long long)askXiaoWeiImageIntentTypeForImageInfo:(id)arg1;
- (_Bool)canDetectAskXiaoWeiImageIntentForImageInfo:(id)arg1;
- (_Bool)canUseAskXiaoWeiForImageInfo:(id)arg1;
- (id)askXiaoWeiImageIdForImageInfo:(id)arg1;
- (void)prepareImageActionSheet;
- (void)setupImageActionSheetForAIProcess:(_Bool)arg1;
- (id)askXiaoWeiActionSheetTitleForAIProcess:(_Bool)arg1;
- (_Bool)shouldUseAIProcessInImageActionSheet;
- (id)init;
