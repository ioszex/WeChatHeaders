...
@class NSArray, NSMutableDictionary, UIViewController, WAShareAppMessageCommonParamsModel, WAShareAppMessageContextModel, WaReportMessageVideoActionItem;
...
@interface WAShareAppMessageInnerTemporaryModel : NSObject
{
    ...
    CDUnknownBlockType _customCallback;
}

+ (id)model;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType customCallback; // @synthesize customCallback=_customCallback;
