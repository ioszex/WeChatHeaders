...
@class BTRichTextTagView, CALayer, ForwardMessageLogicController, MMWebImageView, NSArray, NSMutableArray, NSString, ReaderMessageViewModel, RichTextView, UIView;
...
@interface ReaderMessageCellView
{
    ...
    UIView *_footerView;
    ForwardMessageLogicController *_payReceiptForwardLogic;
}

+ (id)itemValueLabelWithTitle:(id)arg1 width:(double)arg2 font:(id)arg3;
- (void).cxx_destruct;
@property(retain, nonatomic) ForwardMessageLogicController *payReceiptForwardLogic; // @synthesize payReceiptForwardLogic=_payReceiptForwardLogic;
...
- (void)onForwardPayReceipt:(id)arg1;
- (id)forwardPayReceiptMenuItem;
- (_Bool)canShowForwardPayReceiptMenuItem;
- (id)headImageUrlOfChatContact;
- (void)addFavorite;
- (void)forwardMessage;
- (_Bool)shouldGoToEmoticonDetail:(id)arg1;
- (void)jumpFinderAIGCOnTaskFailed:(id)arg1;
- (void)jumpFinderAIGCOnTaskSucceed:(id)arg1;
- (void)jumpFinderAIGCTask:(id)arg1;
