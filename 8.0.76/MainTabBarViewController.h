...
- (void)checkDBCorrupt;
- (void)preloadRedDotLogic:(_Bool)arg1 selectedIndex:(unsigned long long)arg2 findFriendPageIndex:(long long)arg3;
...
- (void)moveFromToTabIndex:(unsigned long long)arg1 lastSelectedIsFindPage:(_Bool)arg2;
