...
@class MMDictationEduView, MMGrowDictationIconView, MMGrowTextViewExtConfig, MMGrowTextViewFadeTypingAnimator, MMTextView, NSAttributedString, NSMutableArray, NSString, UIFont, UIImageView, UIResponder, VoiceTransEduView;
...
@interface MMGrowTextView
{
    ...
    _Bool _isDictationActive;
    _Bool _tmpHideDictationIcon;
    _Bool _dictationPendingSetText;
    _Bool _isDictationActivatedBefore;
    _Bool _dictationRunning;
    _Bool _lockedForWaitEndFlag;
    _Bool _pendingSendForWaitEndFlag;
    ...
    double _bgExtraHeight;
    MMGrowTextViewExtConfig *_extConfig;
    NSMutableArray *_arrTopicMenuItem;
    NSAttributedString *_lastAttributedContent;
    MMGrowDictationIconView *_dictationIcon;
    NSString *_lastDidChangeText;
    MMDictationEduView *_dictationEducationView;
    VoiceTransEduView *_voiceTransEduView;
    MMGrowTextViewFadeTypingAnimator *_inkFadeTypingAnimator;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MMGrowTextViewFadeTypingAnimator *inkFadeTypingAnimator; // @synthesize inkFadeTypingAnimator=_inkFadeTypingAnimator;
@property(nonatomic) _Bool pendingSendForWaitEndFlag; // @synthesize pendingSendForWaitEndFlag=_pendingSendForWaitEndFlag;
@property(nonatomic) _Bool lockedForWaitEndFlag; // @synthesize lockedForWaitEndFlag=_lockedForWaitEndFlag;
@property(nonatomic) _Bool dictationRunning; // @synthesize dictationRunning=_dictationRunning;
@property(nonatomic) _Bool isDictationActivatedBefore; // @synthesize isDictationActivatedBefore=_isDictationActivatedBefore;
@property(retain, nonatomic) VoiceTransEduView *voiceTransEduView; // @synthesize voiceTransEduView=_voiceTransEduView;
@property(retain, nonatomic) MMDictationEduView *dictationEducationView; // @synthesize dictationEducationView=_dictationEducationView;
...
@property(nonatomic) _Bool tmpHideDictationIcon; // @synthesize tmpHideDictationIcon=_tmpHideDictationIcon;
@property(retain, nonatomic) MMGrowDictationIconView *dictationIcon; // @synthesize dictationIcon=_dictationIcon;
@property(nonatomic) _Bool isDictationActive; // @synthesize isDictationActive=_isDictationActive;
@property(nonatomic) _Bool isResigningFirstResponder; // @synthesize isResigningFirstResponder=_isResigningFirstResponder;
...
@property(nonatomic) double bgExtraHeight; // @synthesize bgExtraHeight=_bgExtraHeight;
...
- (void)setBCenterPlaceHolder:(_Bool)arg1;
...
- (void)removeEducationViews;
- (void)setTextColor:(id)arg1;
- (void)setTextFont:(id)arg1;
- (void)resetTextWidth;
- (struct CGSize)adjustSizeWithOuterWidth:(double)arg1;
- (void)setTextWidth:(double)arg1;
- (void)cancelAllAnimators;
- (void)applyText:(id)arg1;
- (void)setAttributedText:(id)arg1 plainText:(id)arg2 withAnimation:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)setAttributedText:(id)arg1 withAnimation:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setAttributedText:(id)arg1 withAnimation:(unsigned long long)arg2;
- (void)setText:(id)arg1 withAnimation:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setText:(id)arg1 withAnimation:(unsigned long long)arg2;
- (void)cancelTextDiffAnimationFinishingToTarget:(_Bool)arg1;
- (void)setAttributedText:(id)arg1 withDiffAnimation:(CDStruct_37709789)arg2 layoutUpdate:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
- (id)textDiffAnimator;
...
- (void)inputAddTagStr;
- (id)getExtMenuItems;
- (void)onKeyboardMonitorDidChangeFrame:(id)arg1;
- (void)onKeyboardMonitorWillChangeFrame:(id)arg1;
...
- (id)selectedTextExtMenuItems;
- (void)textViewDidChangeSelection:(id)arg1;
- (void)textViewMovingCursorEnded:(id)arg1;
...
- (void)touchesCancelled_TextView:(id)arg1 withEvent:(id)arg2;
- (void)touchesEnded_TextView:(id)arg1 withEvent:(id)arg2;
- (void)touchesMoved_TextView:(id)arg1 withEvent:(id)arg2;
- (void)touchesBegan_TextView:(id)arg1 withEvent:(id)arg2;
- (void)textView:(id)arg1 willPastedText:(id)arg2;
- (void)textViewPasteMultiMediaContent:(id)arg1;
...
- (void)resetTextViewOriginHeight:(double)arg1;
...
- (_Bool)textView:(id)arg1 shouldChangeCursorOnTap:(struct _NSRange)arg2;
...
- (id)init;
- (void)layoutSubviews;
- (void)postTextChangeNotification:(id)arg1;
...
- (id)MMDictationLogicIcon_getFullText;
- (id)MMDictationLogicIcon_getChatName;
- (id)MMDictationLogicIcon_getContent;
- (id)MMDictationLogicIcon_getSuffixContent;
- (id)MMDictationLogicIcon_getPrefixContent;
...
- (void)MMDictation_touchesCancelled:(id)arg1 withEvent:(id)arg2;
- (void)MMDictation_touchesEnded:(id)arg1 withEvent:(id)arg2;
- (void)MMDictation_touchesMoved:(id)arg1 withEvent:(id)arg2;
...
- (void)hideDictationIconTemporary:(_Bool)arg1;
- (void)hideDictationIconTemporary;
- (void)checkSelectionIntersectionWithDictationIcon;
- (void)hideVoiceTransEduView;
- (void)hideDictationIcon;
- (void)showDictationIcon:(_Bool)arg1 animated:(_Bool)arg2;
- (void)showDictationIcon;
- (void)initDictationIconIfNeeded;
- (void)refreshDictationIconPosition;
- (double)dictationIconHeight;
- (_Bool)isDictationIconEnabled;
- (void)_onWaitEndFlagTimeout;
- (void)_leaveWaitEndFlagStateAndFirePendingSend:(_Bool)arg1;
- (void)_enterWaitEndFlagState;
- (void)stopDictationForReason:(long long)arg1 waitEndFlag:(_Bool)arg2;
- (void)stopDictationForReason:(long long)arg1;
- (void)startDictation:(unsigned long long)arg1;
- (_Bool)isDictationWorking;
- (id)getDictationIcon;
- (void)recoverDictationIconFromDraft;
- (_Bool)hasDictationIcon;
