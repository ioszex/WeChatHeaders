...
@class BaseResponse, NSMutableArray, NSString, SnsDragon2024Info, SnsServerConfig, SnsUserInfo, SnsUserPageConfig;
...
@property(nonatomic) unsigned int memorializedAccount; // @dynamic memorializedAccount;
...
@property(retain, nonatomic) SnsUserPageConfig *userPageConfig; // @dynamic userPageConfig;
