...
@interface FTSContactSearchTask : NSObject
{
    ...
    NSMutableArray *m_arrBrandStickerContact;
    ...
    NSString *_pinyinSearchText;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *pinyinSearchText; // @synthesize pinyinSearchText=_pinyinSearchText;
@property(copy, nonatomic) NSString *originalSearchText; // @synthesize originalSearchText=_originalSearchText;
@property(nonatomic) _Bool useMixedSearchStrategy; // @synthesize useMixedSearchStrategy=_useMixedSearchStrategy;
...
- (unsigned int)getBrandStickerContactsCount;
- (id)getBrandStickerContacts;
- (unsigned int)getBrandMergeContactsCount;
- (id)getBrandMergeContacts;
