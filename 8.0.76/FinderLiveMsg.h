...
@class FinderLiveContact, FinderLiveTopCommentInfo, NSData, NSString;
...
@property(nonatomic) _Bool isShortcutWording; // @dynamic isShortcutWording;
...
@property(nonatomic) unsigned int shortcutWordingType; // @dynamic shortcutWordingType;
...
@property(retain, nonatomic) FinderLiveTopCommentInfo *topCommentInfo; // @dynamic topCommentInfo;
