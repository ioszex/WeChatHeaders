...
+ (id)generateAttributedWemojiStringWithName:(id)arg1 fromImage:(id)arg2 font:(id)arg3 sequence:(long long)arg4;
...
- (long long)processAndConvertWemojiStringUsingFont:(id)arg1 startSequence:(long long)arg2;
...
- (void)amb_safeSetAttributedString:(id)arg1;
- (void)amb_safeAppendAttributedString:(id)arg1;
- (void)amb_safeInsertAttributedString:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)amb_safeReplaceCharactersInRange:(struct _NSRange)arg1 withString:(id)arg2;
- (void)amb_safeReplaceCharactersInRange:(struct _NSRange)arg1 withAttributedString:(id)arg2;
- (void)amb_safeRemoveAttribute:(id)arg1 range:(struct _NSRange)arg2;
- (void)amb_safeAddAttributes:(id)arg1 range:(struct _NSRange)arg2;
- (void)amb_safeAddAttribute:(id)arg1 value:(id)arg2 range:(struct _NSRange)arg3;
