...
@class MMTimer, MMWebViewController, MemoryMappedKV, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, OrderedDictionary;
...
@interface MMWebViewKeepHolderMgr
{
    ...
    MemoryMappedKV *_webBackgroundAblumSlotMMKV;
    MMTimer *_fetchBackgroundAudioStateTimmer;
    double _previousTingAudioUpdateTime;
    OrderedDictionary *_dictTaskMiniWindowMgr;
...
+ (id)webDataFromWebVC:(id)arg1;
+ (id)dataFromWebViewViewController:(id)arg1 minimizeType:(unsigned int)arg2;
+ (id)passiveStateDataFromWebViewController:(id)arg1 minimizeType:(unsigned int)arg2;
+ (id)multiContentDataFromWebViewViewController:(id)arg1 minimizeType:(unsigned int)arg2;
+ (_Bool)canWindowWebViewController:(id)arg1;
...
@property(retain, nonatomic) OrderedDictionary *dictTaskMiniWindowMgr; // @synthesize dictTaskMiniWindowMgr=_dictTaskMiniWindowMgr;
...
@property(retain, nonatomic) MemoryMappedKV *webBackgroundAblumSlotMMKV; // @synthesize webBackgroundAblumSlotMMKV=_webBackgroundAblumSlotMMKV;
- (void)onPreQuit;
...
- (void)onServiceInit;
- (id)init;
- (void)playApp:(id)arg1 tingItem:(id)arg2 updateCurrentTime:(double)arg3 duration:(double)arg4;
...
- (id)getCachedPassiveStateTaskMgrWithWebVC:(id)arg1;
- (id)getCachedMultiContentWindowTaskMgrWithWebVC:(id)arg1;
- (_Bool)isPassiveStateMinimizeTask:(id)arg1;
- (_Bool)isMultiContentWindowTask:(id)arg1;
...
- (void)removePassiveTaskByWebVC:(id)arg1;
- (void)onCloseWebMultiContentTask:(id)arg1;
- (void)onOpenWebMultiContentTask:(id)arg1 openContext:(id)arg2 taskEnterScene:(unsigned int)arg3 handler:(id)arg4;
- (void)onMinimizedTaskItemExposed:(id)arg1;
- (_Bool)onRetryAddPendingTaskAfterUserDeleteOneTask:(id)arg1;
- (void)prepareSnapshotForFavoriteDualWriteIfNeeded:(id)arg1;
- (void)removeBrandTimelineCacheWithTaskKey:(id)arg1;
...
- (_Bool)isViewControllerWindowMinimized:(id)arg1;
...
- (id)genRecoverWindowMgrWithTaskData:(id)arg1 handler:(id)arg2;
- (void)checkAndDeletePassiveMinimizeTaskOnPlayPauseIfNeededWithWebVC:(id)arg1;
- (void)removeAllPassiveMinimizeTask;
- (_Bool)addPassiveMinizeTaskIfNeeded:(id)arg1 animated:(_Bool)arg2;
- (void)appendMiniWindowMgrToCache:(id)arg1 animated:(_Bool)arg2;
- (void)addToFloatingWindow:(id)arg1 animated:(_Bool)arg2;
