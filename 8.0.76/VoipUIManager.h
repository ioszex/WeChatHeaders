...
@interface VoipUIManager
{
    ...
    _Bool _isOrientationChangeTipsScrolled;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isOrientationChangeTipsScrolled; // @synthesize isOrientationChangeTipsScrolled=_isOrientationChangeTipsScrolled;
...
@property(retain, nonatomic) CContact *currentRemoteContact; // @synthesize currentRemoteContact=_currentRemoteContact;
...
- (void)__changeAudioToPort:(id)arg1 hasChanged:(_Bool)arg2 shouldIgnoreToast:(_Bool)arg3;
- (void)changeAudioToPort:(id)arg1 hasChanged:(_Bool)arg2 shouldIgnoreToast:(_Bool)arg3;
...
- (void)openVideoWindowWithContext:(id)arg1;
- (void)openAudioWindowWithContext:(id)arg1;
- (id)getVoIPWindow;
- (_Bool)openWindowWithContext:(id)arg1;
- (_Bool)checkIfDuplicateContact:(id)arg1;
- (_Bool)checkIfCouldChangeDevice:(id)arg1 from:(unsigned long long)arg2;
...
- (void)acceptCallUseCallkit:(unsigned long long)arg1 roomKey:(long long)arg2 isVideo:(_Bool)arg3 userName:(id)arg4 isilink:(_Bool)arg5;
- (void)onPreQuit;
...
- (void)HangupWithRoomID:(unsigned long long)arg1 reason:(long long)arg2;
- (void)HangupWithReason:(int)arg1 ifIsConnect:(_Bool)arg2;
- (void)HangupWithReason:(int)arg1;
- (void)Reject:(id)arg1 withRoomId:(unsigned long long)arg2 andKey:(long long)arg3 isilink:(_Bool)arg4;
