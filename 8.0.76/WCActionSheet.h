...
@interface WCActionSheet
{
    ...
    CDUnknownBlockType _dismissActionSheetBlock;
...
@property(copy, nonatomic) CDUnknownBlockType dismissActionSheetBlock; // @synthesize dismissActionSheetBlock=_dismissActionSheetBlock;
