...
@protocol WCFinderNotifyCenterUnitVCDelegate;

@interface WCFinderNotifyCenterUnitVC
{
    _Bool _shouldRefetchDataAfterPopOrDismiss;
    _Bool _showMentionSwitchEntry;
    _Bool _hasRequestedFirstPage;
    id <WCFinderNotifyCenterUnitVCDelegate> _delegate;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool hasRequestedFirstPage; // @synthesize hasRequestedFirstPage=_hasRequestedFirstPage;
...
@property(nonatomic) __weak UIView *magicContainerView; // @synthesize magicContainerView=_magicContainerView;
@property(nonatomic) __weak id <WCFinderNotifyCenterUnitVCDelegate> delegate; // @synthesize delegate=_delegate;
- (void)registerYReportSdk;
- (unsigned long long)feedViewerScene;
- (int)feedViewControllerScene;
- (void)onListLoadingStateModified;
- (void)onNotifyCenterListDataChangedFromSource:(unsigned long long)arg1;
- (void)onNotifyCenterRedDotUnreadCountUpdated:(unsigned long long)arg1;
...
- (void)showYuanBaoConfirmSheetWithHandler:(CDUnknownBlockType)arg1;
...
- (void)bindMessageStripReportForCell:(id)arg1 viewModel:(id)arg2;
...
- (void)viewDidLoad;
- (void)fetchFirstPageDataIfNeeded;
