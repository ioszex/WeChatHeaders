...
@interface SessionSelectController
{
    ...
    CreateChatLogic *m_searchCreateChatLogic;
    ...
    _Bool m_isSupportMultipleWordsSearchCreateGroup;
...
@property(nonatomic) int forwardState; // @synthesize forwardState=_forwardState;
...
@property(nonatomic) _Bool m_enableConfirmAfterModify; // @synthesize m_enableConfirmAfterModify=_m_enableConfirmAfterModify;
...
@property(nonatomic) _Bool m_ignoresChatBot; // @synthesize m_ignoresChatBot=_m_ignoresChatBot;
...
@property(copy, nonatomic) NSString *m_rightBarButtonTitle; // @synthesize m_rightBarButtonTitle=_m_rightBarButtonTitle;
...
@property(nonatomic) _Bool m_isSupportMultipleWordsSearchCreateGroup; // @synthesize m_isSupportMultipleWordsSearchCreateGroup;
...
- (void)OnSelectViewForwardOtherAppPageSheetDidCloseWithoutSelection:(id)arg1;
- (void)OnSelectViewForwardOtherAppPageSheetDidShow:(id)arg1;
- (void)OnSelectView:(id)arg1 forwardOtherAppType:(long long)arg2 params:(id)arg3;
...
- (id)getForwardMessageShowInViewController;
- (id)getPanelView;
...
- (void)dealloc;
- (void)initData;
- (id)initWithSelectedContacts:(id)arg1 requiredContacts:(id)arg2;
- (id)initWithSelectedContacts:(id)arg1;
- (id)init;
- (void)handleCloaseContactCreateChatRoom;
- (void)openContactPickerView;
- (void)handleContactCreateChatRoomViewWithCell:(id)arg1;
- (_Bool)checkIsCreateChatRoomViewContactWithIndex:(id)arg1;
- (_Bool)checkIsCreateChatRoomViewContact:(id)arg1;
