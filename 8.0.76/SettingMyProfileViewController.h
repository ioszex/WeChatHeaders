...
@interface SettingMyProfileViewController
{
    ...
    SettingMyProfileViewController *_retainSelfForInvoiceRequest;
}

- (void).cxx_destruct;
@property(retain, nonatomic) SettingMyProfileViewController *retainSelfForInvoiceRequest; // @synthesize retainSelfForInvoiceRequest=_retainSelfForInvoiceRequest;
