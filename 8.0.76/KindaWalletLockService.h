...
- (_Bool)addNewBioAuthFid:(id)arg1;
- (void)requestWalletLockBioAuthImpl:(int)arg1 challenge:(id)arg2 subTitle:(id)arg3 pwd:(id)arg4 needChangeAuthKey:(int)arg5 callback:(id)arg6;
- (id)getOhosSortUid;
- (id)getOhosSortCpuid;
