...
@interface WCPlayerConfigFullScreenProgressBarWithShrink
{
    ...
    _Bool _isAnimatingWithFixedContent;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isAnimatingWithFixedContent; // @synthesize isAnimatingWithFixedContent=_isAnimatingWithFixedContent;
...
- (void)updatePlayButtonForPlaying:(_Bool)arg1;
- (void)initSubviews;
