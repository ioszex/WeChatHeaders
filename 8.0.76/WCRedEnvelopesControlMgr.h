...
- (unsigned int)startOverseaReceiveRedEnvelopesLogic:(id)arg1 Data:(id)arg2 Scene:(unsigned int)arg3 overseaTransfer:(_Bool)arg4;
...
- (unsigned int)startOverseaReceiveRedEnvelopesLogicFromSysmsg:(id)arg1 url:(id)arg2 routeInfo:(id)arg3;
