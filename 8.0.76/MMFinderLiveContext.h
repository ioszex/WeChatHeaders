...
@class FinderBizUserInfo, FinderLiveAbnormalClosedPageInfo, FinderLiveAppMsgPlatformReminderNotificationJumpInfo_FinderLiveFunctionMenuWordingInfo, FinderLiveContact, FinderLiveErrorPage, FinderLiveExtFlag, FinderLiveSyncAnchorCloseLiveGuideInfoResp, MMFinderLiveTaskId, NSData, NSString, WCFinderGetLiveMsgCGI, WCFinderPostLiveLikeCGI;
...
@interface MMFinderLiveContext : NSObject
{
    ...
    FinderLiveAppMsgPlatformReminderNotificationJumpInfo_FinderLiveFunctionMenuWordingInfo *_notificationJumpMenuInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) FinderLiveAppMsgPlatformReminderNotificationJumpInfo_FinderLiveFunctionMenuWordingInfo *notificationJumpMenuInfo; // @synthesize notificationJumpMenuInfo=_notificationJumpMenuInfo;
...
- (_Bool)isDisplayLiveroomOnlineInfoEnabled;
- (_Bool)isAudienceWatchTimeBoardEnable;
