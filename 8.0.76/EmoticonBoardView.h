...
@class CADisplayLink, CAShapeLayer, EmoticonBoardCrossCollectionController, EmoticonBoardDynamicTabBar, EmoticonBoardViewConfig, EmoticonCustomAddLogicController, EmoticonCustomCreateLogic, EmoticonPreviewWindowViewController, NSString, QQEmojiPreview, UIImageView, UIView;
...
@interface EmoticonBoardView
{
    ...
    _Bool _newRefresh;
    _Bool _newResortEntrance;
    _Bool _showingXiaoweiSearch;
    int _viewType;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool showingXiaoweiSearch; // @synthesize showingXiaoweiSearch=_showingXiaoweiSearch;
@property(nonatomic) _Bool newResortEntrance; // @synthesize newResortEntrance=_newResortEntrance;
@property(retain, nonatomic) EmoticonCustomCreateLogic *customCreateLogic; // @synthesize customCreateLogic=_customCreateLogic;
@property(nonatomic) _Bool newRefresh; // @synthesize newRefresh=_newRefresh;
...
- (_Bool)isHeaderAdjustmentScene;
- (_Bool)isExpandEnabled;
- (_Bool)isFullShowInChat;
- (void)reportEvent35262:(id)arg1 eventId:(id)arg2 params:(id)arg3;
- (void)doNewReport:(id)arg1 eventId:(id)arg2 params:(id)arg3;
...
- (void)onTapRightQuarterOfExpandBar;
...
- (void)onAddEmoticonFinishedWithSuccessObj:(id)arg1 sucNum:(long long)arg2 failNum:(long long)arg3;
...
- (void)onRecommendRequest:(unsigned long long)arg1 query:(id)arg2 fromRefresh:(_Bool)arg3;
- (unsigned long long)getBoardShowTime;
- (void)openTapSearchHalfScreen;
- (id)getRecommendPanelEmojiCtxs:(_Bool)arg1;
- (void)onTapJumpToCustomManager;
...
- (void)manageAllEmoticonPackages:(id)arg1;
- (void)doDeleteEmoticonPackage:(id)arg1;
- (void)actionSheet:(id)arg1 clickedButtonAtIndex:(long long)arg2;
- (void)actionSheetViewLoaded:(id)arg1;
- (void)onEmoticonBoardDynamicTabBarLongPressItem:(id)arg1 atIndex:(long long)arg2;
- (void)onEmoticonBoardDynamicTabBarClickFloatingFoldButton;
- (_Bool)isShowingXiaoweiSearch;
- (void)showXiaoweiSearchViewController;
- (void)onEmoticonBoardDynamicTabBarClickAIRecommendItem;
- (void)onEmoticonBoardDynamicTabBarClickSearchItem;
- (_Bool)shouldOpenXiaoweiSearchViewController;
- (void)openEmoticonSearchPage;
- (void)onEmoticonBoardDynamicTabBarClickSettingItem;
- (void)onEmoticonBoardDynamicTabBarClickStorePlusItem;
- (void)openEmotionStoreWithSourceViewController:(id)arg1;
...
- (id)cameraPackageId;
- (id)customPackageId;
- (id)xiaoweiChatIdWithCurrentViewController:(id)arg1;
...
- (void)emoticonBoradViewPageHide;
- (void)emoticonBoradViewPageExposeReport:(_Bool)arg1;
...
- (void)insertCustomBackground:(id)arg1;
