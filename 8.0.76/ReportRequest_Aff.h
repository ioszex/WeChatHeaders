...
@interface ReportRequest_Aff : WXPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *boxId; // @dynamic boxId;
...
@property(retain, nonatomic) NSString *clickContent; // @dynamic clickContent;
...
@property(retain, nonatomic) NSString *parentSearchId; // @dynamic parentSearchId;
