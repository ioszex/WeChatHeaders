...
@class MMFinderLiveMusicSettingOperationPanel, MMFinderLiveReplayKitManager, MMFinderLiveSongSettingOperationPanel, MMFinderScreenRecordGuideView, MMGrowTextView, MMLiveCountdownTipsView, MMLiveTaskId, NSDictionary, NSString, RPSystemBroadcastPickerView, WCFinderHeadImageView, WCFinderLiveStarterChooseGamePanelView, WCFinderLiveStarterReporter, WCFinderStarterLiveViewModel;
