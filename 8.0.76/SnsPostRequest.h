...
@property(nonatomic) unsigned int recentInteractUserCount; // @dynamic recentInteractUserCount;
@property(retain, nonatomic) NSMutableArray *recentInteractUserList; // @dynamic recentInteractUserList;
...
@property(retain, nonatomic) NSString *shareFromInfo; // @dynamic shareFromInfo;
...
@property(nonatomic) unsigned int useComplexVisibility; // @dynamic useComplexVisibility;
@property(nonatomic) unsigned int visibilityType; // @dynamic visibilityType;
