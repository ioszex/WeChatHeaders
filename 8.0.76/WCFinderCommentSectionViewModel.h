...
- (unsigned long long)getSubCommentExpandTypeWithCellType:(unsigned long long)arg1;
- (unsigned long long)getSubCommentMoreTypeWithCellType:(unsigned long long)arg1;
