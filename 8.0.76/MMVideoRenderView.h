...
@interface MMVideoRenderView : UIView
{
    ...
    struct __CVOpenGLESTextureCache *_pixelBufferTextureCache;
    _Bool _mirror;
    _Bool _renderable;
    _Bool _focusable;
...
@property int pixelBufferBusyCount; // @synthesize pixelBufferBusyCount=_pixelBufferBusyCount;
...
- (void)drawPixelBufferWithYTexture:(struct __CVBuffer *)arg1 uvTexture:(struct __CVBuffer *)arg2 vTexture:(struct __CVBuffer *)arg3 yuvType:(int)arg4 isVideoRange:(_Bool)arg5;
- (void)updatePixelBufferRenderTarget;
- (_Bool)createTexturesFromPixelBuffer:(struct __CVBuffer *)arg1 yTexture:(struct __CVBuffer **)arg2 uvTexture:(struct __CVBuffer **)arg3 vTexture:(struct __CVBuffer **)arg4 yuvType:(int *)arg5 isVideoRange:(_Bool *)arg6;
- (_Bool)ensurePixelBufferTextureCacheCreated;
- (_Bool)ensureOpenGLInitializedForPixelBuffer;
...
- (_Bool)compileShadersNew;
- (unsigned int)compileShaderNew:(id)arg1 withType:(unsigned int)arg2;
- (void)compileShaders;
