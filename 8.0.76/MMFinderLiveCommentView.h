...
@interface MMFinderLiveCommentView
{
    ...
    MMFinderLiveQuickCommentLogic *_quickCommentLogic;
}
...
- (void)onFinderLiveSFBarrageInvokeClickContentLink:(id)arg1;
...
- (void)clearPublicCommentDataForBanComment;
...
- (void)syncLikeStatusToOriginalCommentInListWithSeq:(unsigned long long)arg1 like:(_Bool)arg2 likeCount:(unsigned int)arg3;
...
- (void)setLiveInputViewReplyPlaceHolderWithSelectedComment:(id)arg1;
- (id)createReplyPlaceHoldeprFromCurrentRoleWithSelectedComment:(id)arg1;
- (void)setLiveInputViewPlaceHolderFromCurrentRole;
...
- (void)autoInsertAtMentionForReplyComment:(id)arg1;
