...
@class MMFinderLiveConnectMicAudienceTableViewDataModel, MMFinderLiveConnectMicLayoutBaseModeContainerView, MMFinderLiveMicInviteAudienceViewModel, MMFinderLivePaidConnectMicAnchorOperationPanelInfo, MMTableView, NSArray, NSString, UIView;
...
@interface MMFinderLiveConnectMicAudienceContainerView
{
    ...
    MMFinderLiveConnectMicLayoutBaseModeContainerView *_layoutBaseModeContainerView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveConnectMicLayoutBaseModeContainerView *layoutBaseModeContainerView; // @synthesize layoutBaseModeContainerView=_layoutBaseModeContainerView;
...
- (void)onMicBaseModeDidChange;
- (unsigned long long)currentMicBaseModeRawValue;
- (_Bool)canShowMicTopicForLayoutBaseMode;
- (_Bool)canShowLayoutBaseModeSection;
