...
- (void)bgmSelectedContentView:(id)arg1 didTapLocalImportMore:(id)arg2;
- (void)bgmSelectedContentViewDidTapLocalImport:(id)arg1;
...
- (void)onBGMSelectedBottomView:(id)arg1 didClickVolumeBtn:(id)arg2;
