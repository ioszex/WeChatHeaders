...
@class DownloadImageCDNMgr, EnterpriseSendMsgMgr, EnterpriseVoiceMsgMgr, ImageUploadUnifyBaseMgr, MessagePatternCacheMgr, NSMutableDictionary, NSObject, NSString, OpenDownloadCDNMgr, OpenUploadCDNMgr, OpenUploadMgr, RecordBaseUploadCDNMgr, ThumbDownloadMgr;
...
- (void)ModMsg:(id)arg1 BitSet:(unsigned int)arg2;
...
- (void)AddLocalMsg:(id)arg1 MsgWrap:(id)arg2 Brand:(id)arg3;
