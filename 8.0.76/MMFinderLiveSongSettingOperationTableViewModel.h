...
@interface MMFinderLiveSongSettingOperationTableViewModel : NSObject
{
    ...
    _Bool _isInLive;
    _Bool _isAudience;
    _Bool _shouldPrepareFirstSongCellToSing;
...
@property(nonatomic) _Bool shouldPrepareFirstSongCellToSing; // @synthesize shouldPrepareFirstSongCellToSing=_shouldPrepareFirstSongCellToSing;
