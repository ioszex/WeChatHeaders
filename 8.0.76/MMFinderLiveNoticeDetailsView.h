...
@class FinderLiveNoticeInfo, MMFinderLiveNoticeDetailsProductsView, MMFinderLiveNoticePosterModel, NSDateFormatter, NSString, UIButton, UIImage, UIImageView, UILabel, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView;
...
@interface MMFinderLiveNoticeDetailsView : UIView
{
    ...
    MMFinderLiveNoticeDetailsProductsView *_productsView;
    UIView *_qrCodeContainer;
    UIImageView *_qrCodeImageView;
    UILabel *_reserveHintLabel;
    UILabel *_bindItemTipsLabel;
...
@property(retain, nonatomic) UILabel *bindItemTipsLabel; // @synthesize bindItemTipsLabel=_bindItemTipsLabel;
...
@property(retain, nonatomic) MMFinderLiveNoticeDetailsProductsView *productsView; // @synthesize productsView=_productsView;
...
- (void)advanceToPreviewStyle:(unsigned long long)arg1;
