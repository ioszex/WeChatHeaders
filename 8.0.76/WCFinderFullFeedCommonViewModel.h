...
@class FinderCommByPass, MMTimer, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderEnhanceTriggerRecordManager;
...
@interface WCFinderFullFeedCommonViewModel : NSObject
{
    ...
    WCFinderEnhanceTriggerRecordManager *_enhanceTriggerRecordManager;
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSData *enhanceLastBuffer; // @synthesize enhanceLastBuffer=_enhanceLastBuffer;
...
@property(retain, nonatomic) WCFinderEnhanceTriggerRecordManager *enhanceTriggerRecordManager; // @synthesize enhanceTriggerRecordManager=_enhanceTriggerRecordManager;
...
- (void)handleRefreshInfo:(id)arg1 feedID:(id)arg2;
...
- (_Bool)_dataItemArray:(id)arg1 containsTid:(id)arg2;
- (id)_replaceContentVMArray:(id)arg1 tid:(id)arg2 withContentVM:(id)arg3;
- (id)_replaceDataItemArray:(id)arg1 tid:(id)arg2 withDataItem:(id)arg3;
- (void)_replaceCacheArrayTid:(id)arg1 withContentVM:(id)arg2;
- (id)takeBottomLocalUnreadCacheContentVMExcludingTid:(id)arg1;
- (id)_nextLocalBackupContentVMExcludingTidList:(id)arg1 currentTid:(id)arg2 pullType:(unsigned long long)arg3;
- (unsigned long long)_localBackupPullTypeForReplacingContentVM:(id)arg1;
- (_Bool)_isLocalCacheContentVM:(id)arg1;
- (_Bool)_tryReplaceCurrentCacheFeedWithLocalBackupForDeletedTidList:(id)arg1 needHitDeletedTid:(_Bool)arg2;
- (_Bool)tryReplaceCurrentCacheFeedWithLocalBackupForCacheClean;
- (_Bool)tryReplaceCurrentCacheFeedWithLocalBackupForDeletedTidList:(id)arg1;
...
- (_Bool)shouldIgnoreSessionFilterWithTid:(id)arg1;
