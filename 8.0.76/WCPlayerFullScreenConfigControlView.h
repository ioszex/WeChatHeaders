...
@interface WCPlayerFullScreenConfigControlView
{
    _Bool _fullScreen;
    _Bool _shrink;
    _Bool _shouldResumeVideoAfterSliderScrubbing;
    _Bool _isPausingVideoForSliderScrubbing;
    float _progressSliderStartTime;
    float _progressBarAutoShrinkTime;
...
@property(nonatomic) _Bool isPausingVideoForSliderScrubbing; // @synthesize isPausingVideoForSliderScrubbing=_isPausingVideoForSliderScrubbing;
@property(nonatomic) _Bool shouldResumeVideoAfterSliderScrubbing; // @synthesize shouldResumeVideoAfterSliderScrubbing=_shouldResumeVideoAfterSliderScrubbing;
@property(nonatomic) float progressBarAutoShrinkTime; // @synthesize progressBarAutoShrinkTime=_progressBarAutoShrinkTime;
...
- (void)layoutSubviews;
- (_Bool)isVideoProgressBarWithShrink;
- (_Bool)isVideoProgressBarWithMultiSpeed;
- (void)addSubviews;
