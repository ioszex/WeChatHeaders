...
@class MMUIButton, MultiPathCellularTipsView, UIImageView, UILabel, VoipDescriptionButton;
...
@interface MultiTalkBottomOperatePanel : UIView
{
    ...
    MultiPathCellularTipsView *_multiPathCellularTipsView;
...
@property(retain, nonatomic) MultiPathCellularTipsView *multiPathCellularTipsView; // @synthesize multiPathCellularTipsView=_multiPathCellularTipsView;
