...
@property(readonly, nonatomic) NSData *m_dtServerIndexBuffer;
...
- (void)setloginTypeCfg:(unsigned long long)arg1;
@property(nonatomic) unsigned long long loginTypeCfg; // @dynamic loginTypeCfg;
- (void)setnoPwdOpenStatus:(_Bool)arg1;
@property(nonatomic) _Bool noPwdOpenStatus; // @dynamic noPwdOpenStatus;
- (void)sethearingAidModeRemote:(unsigned long long)arg1;
@property(nonatomic) unsigned long long hearingAidModeRemote; // @dynamic hearingAidModeRemote;
- (void)sethearingAidModeOld:(unsigned long long)arg1;
@property(nonatomic) unsigned long long hearingAidModeOld; // @dynamic hearingAidModeOld;
- (void)sethearingAidModeLocal:(unsigned long long)arg1;
@property(nonatomic) unsigned long long hearingAidModeLocal; // @dynamic hearingAidModeLocal;
- (void)setclientGrayFlag:(unsigned long long)arg1;
@property(nonatomic) unsigned long long clientGrayFlag; // @dynamic clientGrayFlag;
- (void)setapnsBannerDisplayContentSetting:(unsigned int)arg1;
@property(nonatomic) unsigned int apnsBannerDisplayContentSetting; // @dynamic apnsBannerDisplayContentSetting;
- (void)setsavedHelloMsgAesKey:(id)arg1;
@property(retain, nonatomic) NSString *savedHelloMsgAesKey; // @dynamic savedHelloMsgAesKey;
- (void)setsavedHelloMsgImageUrl:(id)arg1;
@property(retain, nonatomic) NSString *savedHelloMsgImageUrl; // @dynamic savedHelloMsgImageUrl;
- (void)setserviceAgreementInfo:(id)arg1;
@property(retain, nonatomic) NSData *serviceAgreementInfo; // @dynamic serviceAgreementInfo;
