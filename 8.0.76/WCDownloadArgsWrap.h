...
@interface WCDownloadArgsWrap : NSObject
{
    ...
    basic_string_911c138e _bizReqPayload;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool isSlientTask; // @synthesize isSlientTask=_isSlientTask;
@property(nonatomic) struct basic_string<char, std::char_traits<char>, std::allocator<char>> bizReqPayload; // @synthesize bizReqPayload=_bizReqPayload;
@property(nonatomic) _Bool isTreatAsVideoFile; // @synthesize isTreatAsVideoFile=_isTreatAsVideoFile;
...
@property(retain) NSString *formatPath; // @synthesize formatPath=_formatPath;
