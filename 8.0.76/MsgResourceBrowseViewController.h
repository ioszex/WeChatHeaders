...
@interface MsgResourceBrowseViewController
{
    ...
    vector_128f4046 _arrSelectedData;
...
+ (void)PreviewAppNode:(id)arg1 msgWrap:(id)arg2 inNavigationController:(id)arg3 withClickFrame:(struct CGRect)arg4 msgLocateForFile:(_Bool)arg5 userInfo:(id)arg6 animated:(_Bool)arg7;
...
+ (void)PreviewAppNode:(id)arg1 msgWrap:(id)arg2 inNavigationController:(id)arg3 withClickFrame:(struct CGRect)arg4 userInfo:(id)arg5 animated:(_Bool)arg6;
+ (void)PreviewAppNode:(id)arg1 msgWrap:(id)arg2 inNavigationController:(id)arg3 withClickFrame:(struct CGRect)arg4;
+ (_Bool)previewLiteAppLocalFileWithRecordDataWrap:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
+ (_Bool)previewLiteAppLocalFileWithMsgWrap:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
+ (_Bool)previewLiteAppLocalFile:(int)arg1 queryInfo:(id)arg2 inNavigationController:(id)arg3 animated:(_Bool)arg4;
+ (_Bool)previewMsgRecordFile:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
- (id).cxx_construct;
- (void).cxx_destruct;
