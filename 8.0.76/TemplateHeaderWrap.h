...
@class EcsJumpInfo, EcsKfProductCardInfo, EcsKfTempleteMsgOrderInfo, NSDate, NSString, UIColor;
...
@interface TemplateHeaderWrap : NSObject
{
    ...
    EcsKfProductCardInfo *_ecsKfProductCardInfo;
    EcsJumpInfo *_ecsJumpInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) EcsJumpInfo *ecsJumpInfo; // @synthesize ecsJumpInfo=_ecsJumpInfo;
@property(retain, nonatomic) EcsKfProductCardInfo *ecsKfProductCardInfo; // @synthesize ecsKfProductCardInfo=_ecsKfProductCardInfo;
...
@property(nonatomic) unsigned long long titleAlignment; // @synthesize titleAlignment=_titleAlignment;
