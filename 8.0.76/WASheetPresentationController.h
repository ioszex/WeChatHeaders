...
@class CAShapeLayer, NSString, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WAAppTaskCapsuleMenu, WASheetHeaderTipsView;
...
@interface WASheetPresentationController : UIPresentationController
{
    ...
    _Bool _isShowingActionSheetMenu;
    ...
    UIView *_blurView;
    WAAppTaskCapsuleMenu *_agentFakeCapsule;
...
@property(nonatomic) _Bool isShowingActionSheetMenu; // @synthesize isShowingActionSheetMenu=_isShowingActionSheetMenu;
...
@property(retain, nonatomic) WAAppTaskCapsuleMenu *agentFakeCapsule; // @synthesize agentFakeCapsule=_agentFakeCapsule;
...
- (_Bool)isDraggingBarHeaderBackgroundColorFollowNavBarColor;
- (id)draggingBarHeader;
- (id)sheetModeParameter;
- (_Bool)isLaunchModeEmbed;
- (id)genStatusBarColorForVC:(id)arg1;
...
- (void)onWebViewDidLayout:(id)arg1;
...
- (void)reportExpandActionWithReason:(unsigned long long)arg1;
...
- (void)detachAgentFakeCapsule;
- (void)disconnectAgentFakeCapsule;
- (void)dismissalTransitionDidEnd:(_Bool)arg1;
- (void)dismissalTransitionWillBegin;
- (void)presentationTransitionDidEnd:(_Bool)arg1;
- (void)sheetFrameDidChange:(struct CGRect)arg1;
- (void)tryAttachAgentFakeCapsule;
