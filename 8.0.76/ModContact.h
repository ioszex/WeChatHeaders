...
@class AdditionalContactList, ChatRoomMemberData, CustomizedInfo, FieldUpdateCtrlInfoList, NSMutableArray, NSString, PhoneNumListInfo, RingBackSetting, SKBuiltinBuffer_t, SKBuiltinString_t, SnsUserInfo;
...
@property(nonatomic) unsigned int chatRoomQrcodeAccessType; // @dynamic chatRoomQrcodeAccessType;
@property(nonatomic) unsigned int chatroomAccessType; // @dynamic chatroomAccessType;
@property(nonatomic) unsigned long long chatroomExtStatus; // @dynamic chatroomExtStatus;
...
@property(retain, nonatomic) FieldUpdateCtrlInfoList *fieldUpdateCtrlInfoList; // @dynamic fieldUpdateCtrlInfoList;
