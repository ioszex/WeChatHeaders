...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderPromotionStreamNativeDramaContext, NSData;
...
@property(retain, nonatomic) FinderPromotionStreamNativeDramaContext *finderNativeDramaContext; // @dynamic finderNativeDramaContext;
...
@property(nonatomic) unsigned long long refCommentscene; // @dynamic refCommentscene;
