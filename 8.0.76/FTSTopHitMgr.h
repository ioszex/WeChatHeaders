...
@interface FTSTopHitMgr : NSObject
{
    ...
    id <FTSTopHitDelegate> _delegateForWeShopSearch;
    id <FTSTopHitDelegate> _delegateForSettingSearch;
    NSSet *_ignoreSpecTypes;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSSet *ignoreSpecTypes; // @synthesize ignoreSpecTypes=_ignoreSpecTypes;
@property(nonatomic) __weak id <FTSTopHitDelegate> delegateForSettingSearch; // @synthesize delegateForSettingSearch=_delegateForSettingSearch;
@property(nonatomic) __weak id <FTSTopHitDelegate> delegateForWeShopSearch; // @synthesize delegateForWeShopSearch=_delegateForWeShopSearch;
...
- (_Bool)removeTopHitValuesIn:(id)arg1 logPrefix:(id)arg2 where:(CDUnknownBlockType)arg3;
...
- (id)convertSettingItemKeyFromTopHitKey:(id)arg1;
- (unsigned int)convertFeatureIDFromItemKey:(id)arg1;
- (id)convertTopHitKeyFromType:(unsigned int)arg1;
- (_Bool)shouldHideTopHitValueDuringSearch:(id)arg1 forKey:(id)arg2 aggregationOn:(_Bool)arg3;
- (id)featureItemForTopHitValue:(id)arg1;
- (_Bool)shouldHideTopHitItem:(id)arg1 typeKey:(id)arg2 aggregationOn:(_Bool)arg3;
- (id)subjectDedupKeyForFeatureItem:(id)arg1;
- (id)crossStorageDedupKeyForItem:(id)arg1 typeKey:(id)arg2;
