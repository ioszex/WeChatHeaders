...
@interface WAUINavigationController
{
    ...
    NSMutableArray *_arrDidBeDismissedAction;
...
@property(retain, nonatomic) NSMutableArray *arrDidBeDismissedAction; // @synthesize arrDidBeDismissedAction=_arrDidBeDismissedAction;
...
- (void)addDidBeDismissedAction:(CDUnknownBlockType)arg1;
...
- (void)setOverrideUserInterfaceStyleIfNeeded:(id)arg1;
