...
@class FinderJumpInfo_Style, NSDictionary, NSString, WAAppTaskHandlerWrapper, WCFinderContact, WCFinderFeedContentVM, WCFinderLiteAppExtraParams, WCFinderPostSourceInfo, WCFinderShareEntranceMessageInfo;
@protocol MMLiveMorphDismissTarget, WCAdFinderDialogViewControllerDelegate, WCCanvasHalfScreenViewControllerDelegate, WCFinderCardWebViewControllerDelegate, WCFinderCollectionHalfScreenViewControllerDelegate, WCFinderFeedHighlightsPanelDelegate;
...
@interface WCFinderJumpInfoParams : NSObject
{
    ...
    id <WCFinderFeedHighlightsPanelDelegate> _highlightsPanelDelegate;
    NSDictionary *_searchTemplateParams;
    unsigned long long _searchEditState;
    CDUnknownBlockType _targetDeallocBlock;
...
@property(copy, nonatomic) CDUnknownBlockType targetDeallocBlock; // @synthesize targetDeallocBlock=_targetDeallocBlock;
@property(nonatomic) unsigned long long searchEditState; // @synthesize searchEditState=_searchEditState;
@property(retain, nonatomic) NSDictionary *searchTemplateParams; // @synthesize searchTemplateParams=_searchTemplateParams;
@property(nonatomic) __weak id <WCFinderFeedHighlightsPanelDelegate> highlightsPanelDelegate; // @synthesize highlightsPanelDelegate=_highlightsPanelDelegate;
...
@property(nonatomic) _Bool preferNoRelaunch; // @synthesize preferNoRelaunch=_preferNoRelaunch;
...
@property(copy, nonatomic) NSString *clickTraceId; // @synthesize clickTraceId=_clickTraceId;
