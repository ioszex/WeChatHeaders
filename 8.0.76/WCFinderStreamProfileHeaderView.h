...
@class MISSING_TYPE, NSMutableDictionary, NSString, UIButton, UIColor, WCFinderHeadImageView, WCFinderImageRedDotBaseView, WCFinderLinearView, WCFinderProfileReporter, WCFinderProfileWarningView, WCFinderSizingRichTextLayout, WCFinderSteamProfileHeaderTheme, WCFinderStreamProfileHeadData, WCFinderStreamProfileHeaderViewMeasure;
...
@interface WCFinderStreamProfileHeaderView : UIView
{
    ...
    WCFinderProfileWarningView *_warningView;
    ...
    WCFinderSizingRichTextLayout *_signatureLayout;
...
+ (id)parseJumpInfoTailIcon:(id)arg1 key:(id)arg2 size:(struct CGSize *)arg3 padding:(double *)arg4;
+ (id)makeSignatureTextView:(int)arg1;
...
@property(retain, nonatomic) WCFinderSizingRichTextLayout *signatureLayout; // @synthesize signatureLayout=_signatureLayout;
...
@property(retain, nonatomic) WCFinderProfileWarningView *warningView; // @synthesize warningView=_warningView;
...
- (void)onCopyNickname;
- (void)onLongPressNickname:(id)arg1;
...
- (void)setupInspirationSquareHeaderView;
...
- (void)setupPOIView;
- (void)setupAuthorLikeCount;
- (void)setupFans;
- (void)setupShowInWXProfile;
- (void)setupFriendFollowCount;
- (id)userAccountInfo;
- (void)setupMomentsCount;
- (void)setupOriginalStatement;
- (void)setupIPMCN;
- (id)signatureDisplayText;
- (void)onExpandableRichTextViewExpandChanged:(id)arg1;
- (void)onExpandableRichTextViewSizeChanged:(id)arg1;
- (void)onExpandableRichTextView:(id)arg1 clickURL:(id)arg2;
- (void)onExpandableRichTextViewClickSuffixText:(id)arg1;
- (void)setupSignature;
- (void)setupSignatureGuide;
- (void)setupGameAchievement;
- (id)createTagLabel;
- (_Bool)setupPostButton:(id)arg1;
- (_Bool)shouldShowPostButton;
- (_Bool)setupMoreMoreButton:(id)arg1;
- (_Bool)setupSearchButton:(id)arg1;
- (void)setupHeaderRightButtons;
- (void)setupFollowWarningView;
- (void)setupPrivateTips;
- (void)setupThirdLines;
- (id)displayAuthInfoText:(id)arg1;
- (void)setupAuthViews;
- (void)_onShowNameCopyMenu:(id)arg1;
- (void)setupNameLineViews;
- (void)setupHeaderView;
- (void)_configGuardNowView;
- (void)_configWarningView:(id)arg1;
