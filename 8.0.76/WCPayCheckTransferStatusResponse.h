...
@class NSArray, NSMutableArray, NSString, NoticeItem, RecvAccountInfo, RecvCustomerInfoModule, WCPayAddressInfo, WCPayExposureInfo, WCPayLimitInfo, WCPayTextInfo, WCPayTransferResendInfo;
...
@interface WCPayCheckTransferStatusResponse : NSObject
{
    ...
    WCPayLimitInfo *_limit_info;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool is_quota_exceeded; // @synthesize is_quota_exceeded=_is_quota_exceeded;
@property(retain, nonatomic) WCPayLimitInfo *limit_info; // @synthesize limit_info=_limit_info;
