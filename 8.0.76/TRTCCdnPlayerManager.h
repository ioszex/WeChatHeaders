...
@class CdnRenderViewBase, CustomPlayerConfig, MISSING_TYPE, MMLivePixelBuffer, MMLiveTask, MMWeEffectManager, NSMutableArray, NSString, TRTCCdnPlayerConfig, TXLivePlayer, UIView;
...
- (void)setPreferLocalIPStackV6:(_Bool)arg1;
...
- (void)updateEnableRci:(_Bool)arg1;
- (void)configSuperResolution:(_Bool)arg1;
- (void)configAdaptiveVolumeEQ:(int)arg1 baseLevel:(int)arg2;
...
- (id)initWithContainerView:(id)arg1 delegate:(id)arg2 liveVrType:(int)arg3 enableRci:(_Bool)arg4;
