...
@class MMHorizontalTableView, MMShowWeixinCustomerHelper, NSMutableArray, NSString, UIButton, UIView;
...
@interface CustomMenuToolView
{
    ...
    UIView *_bgView;
    MMShowWeixinCustomerHelper *_customerHelperShower;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMShowWeixinCustomerHelper *customerHelperShower; // @synthesize customerHelperShower=_customerHelperShower;
...
- (void)tryReportCustomerHelperViewExp;
