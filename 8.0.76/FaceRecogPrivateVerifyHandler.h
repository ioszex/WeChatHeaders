...
@interface FaceRecogPrivateVerifyHandler
{
    ...
    _Bool _isLivenessDetectionOnly;
    _Bool _isAgentMode;
    _Bool _needVideo;
    _Bool _isDismissed;
    ...
    NSString *_funcName;
    CDUnknownBlockType _onConfirmInfoReady;
...
@property(copy, nonatomic) CDUnknownBlockType onConfirmInfoReady; // @synthesize onConfirmInfoReady=_onConfirmInfoReady;
...
@property(nonatomic) _Bool isLivenessDetectionOnly; // @synthesize isLivenessDetectionOnly=_isLivenessDetectionOnly;
...
- (void)notifyVerifyFailResult:(int)arg1;
...
- (void)cancelForAuthCard;
- (void)continueAfterAuthCardAccepted;
- (void)start;
- (void)stopLoading;
- (void)startLoading;
