...
@class EcsJumpInfo, FinderLiveGetShopShelfResponse_ShopVipInfo, FinderLiveShopCustomerServiceInfo, FinderReplayRecordSetting, FinderShopShelfOrderSetting, FinderWxAppInfo, LivePresenterInfo, MMFinderLiveECHotSaleLikeAnimationCenter, MMFinderLiveGoodsItem, MMFinderLiveShopContext_AddProductsModel, MMFinderLiveShopContext_AnchorFlashSaleConfig, MMFinderLiveShopContext_HintModel, MMFinderLiveTask, MMFinderLiveTaskId, NSString, OperatorEntityInfo;
...
@interface MMFinderLiveShopContext : NSObject
{
    ...
    LivePresenterInfo *_livePresenterInfo;
    OperatorEntityInfo *_operatorEntityInfo;
    EcsJumpInfo *_addProductJumpInfo;
    NSString *_liveRoomBuffer;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *liveRoomBuffer; // @synthesize liveRoomBuffer=_liveRoomBuffer;
@property(retain, nonatomic) EcsJumpInfo *addProductJumpInfo; // @synthesize addProductJumpInfo=_addProductJumpInfo;
@property(retain, nonatomic) OperatorEntityInfo *operatorEntityInfo; // @synthesize operatorEntityInfo=_operatorEntityInfo;
@property(retain, nonatomic) LivePresenterInfo *livePresenterInfo; // @synthesize livePresenterInfo=_livePresenterInfo;
