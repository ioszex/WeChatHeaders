...
@interface EcsMediaPreviewItem : NSObject
{
    _Bool _pauseWhenInit;
    _Bool _isMute;
    _Bool _initialPlayHandled;
    _Bool _firstSeekAfterReady;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool firstSeekAfterReady; // @synthesize firstSeekAfterReady=_firstSeekAfterReady;
@property(nonatomic) _Bool initialPlayHandled; // @synthesize initialPlayHandled=_initialPlayHandled;
@property(nonatomic) _Bool isMute; // @synthesize isMute=_isMute;
@property(nonatomic) _Bool pauseWhenInit; // @synthesize pauseWhenInit=_pauseWhenInit;
