...
- (void)onReplaceFileIdCdnHitCheckComplete:(id)arg1 response:(id)arg2 fileInfo:(id)arg3;
- (void)startReplaceFileIdCdnHitCheck:(id)arg1;
- (_Bool)tryStartReplaceFileIdCdnHitCheck:(id)arg1;
- (void)CheckQueue;
