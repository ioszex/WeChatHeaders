...
+ (_Bool)isOfflinePayShortcutURL:(id)arg1;
+ (void)reportNFCJSAPI:(id)arg1 errorCode:(int)arg2 errorMessage:(id)arg3;
+ (long long)parseAmountTextFromString:(id)arg1;
+ (id)getRedEnvelopesDefaultSkinInfoPath;
+ (_Bool)isWCPayThirdC2CV3Message:(unsigned int)arg1;
+ (_Bool)isWCPayThirdC2CMessage:(unsigned int)arg1;
+ (unsigned int)genServerCurrentTime;
+ (id)getWPHKUrlConfigData;
+ (void)saveWPHKUrlConfigData:(id)arg1;
...
+ (id)getRedEnvelopesCoverWidgetPlusLocalImage:(unsigned int)arg1;
