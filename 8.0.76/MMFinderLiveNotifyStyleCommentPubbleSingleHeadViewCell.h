...
@class CAGradientLayer, CALayer, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveMemberSignView, MMFinderLiveNormalTextSignView, MMUIImageView, MMUILabel, MMUIView, MMWebImageView, NSArray, NSMutableArray, NSString, RichTextView, UIImageView, UIView;
...
@interface MMFinderLiveNotifyStyleCommentPubbleSingleHeadViewCell
{
    ...
    MMWebImageView *_identityHeadImageView;
    RichTextView *_identityPrefixLabel;
    RichTextView *_identitySuffixLabel;
...
@property(retain, nonatomic) RichTextView *identitySuffixLabel; // @synthesize identitySuffixLabel=_identitySuffixLabel;
@property(retain, nonatomic) RichTextView *identityPrefixLabel; // @synthesize identityPrefixLabel=_identityPrefixLabel;
@property(retain, nonatomic) MMWebImageView *identityHeadImageView; // @synthesize identityHeadImageView=_identityHeadImageView;
...
- (void)updateIdentityHeadImageViewOrigin;
- (void)layoutIdentityHeadImageView;
- (_Bool)shouldShowSelfJoinIdentityHeadImage;
