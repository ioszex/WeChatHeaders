...
@class FinderLiveGameData, FinderLiveGameInfo, GameLiveJumpInfo, GameTeamUpPaymentSetting, GeneralGameLiveInfo, MMFinderLiveGameTeamInfo, MMFinderLiveGameTeamWAGameJumpInfo, MMFinderLiveGameUserInfo, MMFinderLiveMiniGamePkInfo, NSString, OrderedDictionary;
...
@interface MMFinderLiveGameContext : NSObject
{
    ...
    MMFinderLiveMiniGamePkInfo *_miniGamePkInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveMiniGamePkInfo *miniGamePkInfo; // @synthesize miniGamePkInfo=_miniGamePkInfo;
