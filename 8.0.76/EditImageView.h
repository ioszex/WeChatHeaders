...
@property(nonatomic) _Bool hasAiImage; // @synthesize hasAiImage=_hasAiImage;
...
- (void)_clearEditLayers;
- (void)applyAiImageAsUndoableOperation:(id)arg1;
- (id)getEditImageAttrSnapshot;
...
- (void)setColorPointMap:(id)arg1 fromLoadImage:(_Bool)arg2;
...
- (void)replaceSourceImage:(id)arg1;
...
- (void)genCacheImageFromLoadImage:(_Bool)arg1;
- (void)genCacheImage;
