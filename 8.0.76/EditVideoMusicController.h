...
@interface EditVideoMusicController
{
    ...
    CDUnknownBlockType _playerPlaybackFailedBlock;
}

+ (unsigned long long)musicBussidWithEntranceType:(unsigned long long)arg1;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType playerPlaybackFailedBlock; // @synthesize playerPlaybackFailedBlock=_playerPlaybackFailedBlock;
...
- (void)onEditVideoBGMPlayerPlaybackFailed:(id)arg1;
...
- (void)replayMusic;
- (void)updatePlayerVolume:(float)arg1;
