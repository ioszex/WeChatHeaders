...
- (void)translate;
- (void)web_view_setBizDomainList:(id)arg1;
- (id)web_backNavigationGesture;
- (void)web_view_captureLongSnapshotWithCompletion:(CDUnknownBlockType)arg1;
- (void)web_view_getElementFrameWithXPath:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)web_view_runCDPCommand:(id)arg1;
