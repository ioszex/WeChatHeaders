...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, NSURL, UIColor, UIScreenEdgePanGestureRecognizer, UIView, WKWebView;
...
- (WKWebView<YYWebViewInterface> *)web_view_WKWebView;
...
- (_Bool)web_view_isBottomBarShowing;
