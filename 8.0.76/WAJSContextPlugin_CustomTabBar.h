...
@class NSMutableArray, NSMutableDictionary, NSString, UIColor, UIView, WeAppCustomTabSwitchParams, WeAppCustomTabbar;
...
@interface WAJSContextPlugin_CustomTabBar
{
    ...
    WeAppCustomTabSwitchParams *_delaySwitchParams;
...
@property(retain, nonatomic) WeAppCustomTabSwitchParams *delaySwitchParams; // @synthesize delaySwitchParams=_delaySwitchParams;
...
- (long long)findTabIndexWithPageUrl:(id)arg1;
- (_Bool)rewriteRouteForTabPage:(id)arg1 toTabPageUrl:(id)arg2 fromLaunchScene:(_Bool)arg3 error:(id *)arg4;
- (void)removeTabPage:(id)arg1;
...
- (void)doSwitchTabItemWithParams:(id)arg1;
- (void)cancelPerformDelaySwitchTabItem;
- (void)performDelaySwitchTabItemWithWebVC:(id)arg1 index:(long long)arg2 isFromRewriteRouteReuse:(_Bool)arg3;
- (void)loadTabWebViewWithIndex:(long long)arg1 routeId:(id)arg2;
- (void)frameChanged;
- (void)switchTabItemToVC:(id)arg1 toIndex:(long long)arg2 fromVC:(id)arg3 navigationController:(id)arg4;
- (void)switchToTabItemByReusingTabVC:(id)arg1 toIndex:(long long)arg2;
...
- (id)init;
- (_Bool)isLoadingTab;
- (long long)findIndexByTabWebView:(id)arg1;
...
- (void)selectTabWithPagePath:(id)arg1 routeId:(id)arg2;
- (_Bool)selectTabWithIndex:(long long)arg1 routeId:(id)arg2;
- (void)selectMainTab;
