...
@class CAGradientLayer, MMTimer, NSHashTable, NSString, PicStats, UIColor, WCFinderBGMPlayer, WCFinderDataItem, WCFinderFeedBottomRedPacketView, WCFinderFeedContentVM, WCFinderFullMultiMediaCollectionView, WCFinderPageControl, WCFinderPhotoFeedReporter, WCFinderPinchLogicScrollView, WCFinderProgressBarStatusInfo;
...
@interface WCFinderFullNewMultiMediaView : UIView
{
    ...
    _Bool _reloadingCollectionData;
    _Bool _photoFeedManualDragging;
    _Bool _shouldResumePhotoAfterManualDragging;
    ...
    double _liveBottomLineOffset;
    unsigned long long _currentCollectionPage;
    unsigned long long _photoFeedManualDragStartPage;
    unsigned long long _photoPinchPlaybackState;
    ...
    PicStats *_picStats;
    WCFinderPhotoFeedReporter *_photoFeedReporter;
    WCFinderPinchLogicScrollView *_contentPinchScrollView;
    UIView *_contentPinchContainer;
...
+ (struct CGRect)mediaFrameInWindowForContentVM:(id)arg1;
...
- (void).cxx_destruct;
@property(retain, nonatomic) UIView *contentPinchContainer; // @synthesize contentPinchContainer=_contentPinchContainer;
...
@property(retain, nonatomic) WCFinderPhotoFeedReporter *photoFeedReporter; // @synthesize photoFeedReporter=_photoFeedReporter;
...
@property(nonatomic) unsigned long long photoPinchPlaybackState; // @synthesize photoPinchPlaybackState=_photoPinchPlaybackState;
@property(nonatomic) unsigned long long photoFeedManualDragStartPage; // @synthesize photoFeedManualDragStartPage=_photoFeedManualDragStartPage;
@property(nonatomic) _Bool shouldResumePhotoAfterManualDragging; // @synthesize shouldResumePhotoAfterManualDragging=_shouldResumePhotoAfterManualDragging;
@property(nonatomic) _Bool photoFeedManualDragging; // @synthesize photoFeedManualDragging=_photoFeedManualDragging;
@property(nonatomic) _Bool reloadingCollectionData; // @synthesize reloadingCollectionData=_reloadingCollectionData;
@property(nonatomic) unsigned long long currentCollectionPage; // @synthesize currentCollectionPage=_currentCollectionPage;
@property(nonatomic) double liveBottomLineOffset; // @synthesize liveBottomLineOffset=_liveBottomLineOffset;
...
- (void)onBGMPlayerAudioModuleInterruptionEnd:(id)arg1;
- (void)onBGMPlayerAudioModuleInterruptionBegin:(id)arg1;
...
- (void)onPhotoCell:(id)arg1 playToEndWithMediaInfo:(id)arg2 index:(unsigned long long)arg3;
...
- (void)startScroll;
- (void)finishPhotoFeedManualDraggingIfNeeded;
...
- (void)_performActionInVideoCollectionViewCell:(CDUnknownBlockType)arg1;
...
- (struct CGPoint)getMediaAreaCenter;
- (struct CGRect)getMediaAreaRectConvertToView:(id)arg1;
- (struct CGRect)getMediaAreaBounds;
- (struct CGRect)getMediaAreaRect;
...
- (void)pauseVideoIfSupport:(_Bool)arg1 pauseType:(long long)arg2 passivePauseReason:(long long)arg3;
- (void)pauseVideoIfSupport:(_Bool)arg1;
- (void)pauseVideoByLockScreenCommand;
...
- (void)reportPhotoFeedItemIfNeeded;
- (void)startPhotoFeedReportIfNeeded;
- (void)didEndDisplay:(long long)arg1;
- (void)didBeginDisplay;
- (void)willBeginDisplay:(long long)arg1;
- (_Bool)shouldRedirectHitToMediaCollectionViewForView:(id)arg1 event:(id)arg2;
...
- (void)normalizeCircularCollectionPositionIfNeeded;
- (id)currentCollectionIndexPath;
- (unsigned long long)collectionIndexForMediaIndex:(unsigned long long)arg1;
- (unsigned long long)mediaIndexForCollectionIndex:(unsigned long long)arg1;
- (unsigned long long)collectionItemCount;
- (_Bool)isCircularSentinelCollectionIndex:(unsigned long long)arg1;
- (_Bool)enablePhotoCircularPaging;
@property(readonly, nonatomic) WCFinderDataItem *dataItem;
- (void)updateBottomRedPacket;
- (_Bool)_canShowRedPackageJumpInfoBanner;
- (void)setCanPinchIfNeeded:(_Bool)arg1;
- (_Bool)_checkCanPinch;
- (void)changeDataWithContentVM:(id)arg1 currentSelectIndex:(unsigned long long)arg2 isSubScene:(_Bool)arg3;
