...
@interface FileDetailLogicController
{
    ...
    CDUnknownBlockType _checkWeAppCompletion;
}

+ (_Bool)isDebugZipFile:(id)arg1;
+ (id)debugActionTitleForTemplateConfigDev:(id)arg1;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType checkWeAppCompletion; // @synthesize checkWeAppCompletion=_checkWeAppCompletion;
...
- (void)jsApiCommandOpenByWeApp;
- (void)refreshWAWxMaterialAppInfo:(id)arg1;
- (void)jsApiCommandCheckHasSupportWeApp:(CDUnknownBlockType)arg1;
