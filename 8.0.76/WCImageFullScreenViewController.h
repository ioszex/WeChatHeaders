...
@interface WCImageFullScreenViewController
{
    ...
    NSArray *_flutterAlbumMediaIds;
    unsigned long long _flutterAlbumIndex;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long flutterAlbumIndex; // @synthesize flutterAlbumIndex=_flutterAlbumIndex;
@property(copy, nonatomic) NSArray *flutterAlbumMediaIds; // @synthesize flutterAlbumMediaIds=_flutterAlbumMediaIds;
...
- (void)wc_handleFlutterAlbumPageChangeFromIndex:(unsigned int)arg1 toIndex:(unsigned int)arg2;
- (void)beginFlutterAlbumCoordinationWithMediaIds:(id)arg1 currentIndex:(unsigned long long)arg2;
- (id)wc_currentFlutterAlbumMediaId;
