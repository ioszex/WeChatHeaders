...
@interface MMFinderLiveKTVManageLogic : NSObject
{
    ...
    MMFinderLiveKTVConnectMicGuideLogic *_connectMicGuideLogic;
...
@property(retain, nonatomic) MMFinderLiveKTVConnectMicGuideLogic *connectMicGuideLogic; // @synthesize connectMicGuideLogic=_connectMicGuideLogic;
...
- (void)unDisplayKTVInPIPIfNeed;
- (void)displayKTVInPIPIfNeed;
...
- (void)unSetChorusBgmPlayoutVolume:(long long)arg1;
- (void)setChorusBgmPlayoutVolume:(long long)arg1 business:(long long)arg2;
