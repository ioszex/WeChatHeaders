...
@class AVAudioPlayer, CEmoticonWrap, CMessageWrap, ContactUpdateHelper, EmoticonBoardView, EmoticonCustomAddLogicController, MMEmoticonView, MMTableView, MMUILabel, NSString, RichTextView, SharePreConfirmSheetView, UIButton, UIImageView, UILabel, UIView, WCActionSheet, WCRedEnvelopesCommentInputToolView, WCRedEnvelopesStoryDargUtil, WCRedEnvelopesStoryViewController, WCUITextField;
...
@interface WCRedEnvelopesRedEnvelopesDetailViewController
{
    ...
    _Bool _hasReportNormalExposure;
    _Bool _isPreviewMode;
    _Bool _isAnimationMode;
    _Bool _isPanBegin;
    _Bool _hasReportSelfMadeRedPakcetEntry;
    ...
    UILabel *_descLabel;
    UILabel *_personalWaterMarkLabel;
...
@property(retain, nonatomic) UILabel *personalWaterMarkLabel; // @synthesize personalWaterMarkLabel=_personalWaterMarkLabel;
...
@property(retain, nonatomic) UILabel *m_receivedInfoLable; // @synthesize m_receivedInfoLable=_m_receivedInfoLable;
...
@property(nonatomic) _Bool hasReportSelfMadeRedPakcetEntry; // @synthesize hasReportSelfMadeRedPakcetEntry=_hasReportSelfMadeRedPakcetEntry;
...
@property(nonatomic) _Bool hasReportNormalExposure; // @synthesize hasReportNormalExposure=_hasReportNormalExposure;
...
- (void)initTableView;
- (_Bool)hasStoryInfo;
- (_Bool)isUseTinyAppCreateCustomHongbaoSkin;
- (_Bool)hasPersonalMakeRedSkinEntry;
- (_Bool)isPersonalMakeRedSkin;
- (_Bool)hasRedSkin;
- (id)getExposeButton;
- (id)getTailButton;
- (id)getNoMoreBottomView;
- (id)getBottomView;
- (void)reportNormalExposure:(_Bool)arg1;
