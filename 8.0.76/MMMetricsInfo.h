...
@class MMBatteryInfo, MMNetworkStatistics, MatrixGPUUtilization, NSString;
...
@interface MMMetricsInfo : NSObject
{
    ...
    MatrixGPUUtilization *_deviceGPUUtilization;
    MatrixGPUUtilization *_deviceAverageGPUUtilization;
    double _hangTime;
    double _hitchRate;
    double _scrollScore;
...
@property(nonatomic, getter=isCameraActive) _Bool cameraActive; // @synthesize cameraActive=_cameraActive;
@property(nonatomic) float brightness; // @synthesize brightness=_brightness;
@property(nonatomic) float audioOutputVolume; // @synthesize audioOutputVolume=_audioOutputVolume;
@property(nonatomic) long long audioSessionRoute; // @synthesize audioSessionRoute=_audioSessionRoute;
...
@property(nonatomic) double scrollScore; // @synthesize scrollScore=_scrollScore;
...
@property(retain, nonatomic) MatrixGPUUtilization *deviceAverageGPUUtilization; // @synthesize deviceAverageGPUUtilization=_deviceAverageGPUUtilization;
@property(retain, nonatomic) MatrixGPUUtilization *deviceGPUUtilization; // @synthesize deviceGPUUtilization=_deviceGPUUtilization;
