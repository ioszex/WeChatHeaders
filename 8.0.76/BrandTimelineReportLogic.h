...
+ (void)reportGeneralException:(long long)arg1 data:(id)arg2;
...
+ (unsigned int)summaryTypeFromLatestDigestType:(unsigned int)arg1;
+ (id)getNotifyWordingWithTotalNotifyCount:(long long)arg1;
+ (id)getReddotReportInfoWithNotifyCount:(long long)arg1 isMassSend:(_Bool)arg2 isNotification:(_Bool)arg3 toBNotifyCount:(long long)arg4 cEndNotifyCount:(long long)arg5;
+ (id)generateReddotReportItem:(id)arg1;
+ (_Bool)fillReddotItemInfoByRecNativeExtraData:(id)arg1 bizuin:(unsigned int *)arg2 appmsgid:(unsigned int *)arg3 itemidx:(unsigned int *)arg4;
+ (unsigned int)reddotUInt32ValueFromJSONObject:(id)arg1;
