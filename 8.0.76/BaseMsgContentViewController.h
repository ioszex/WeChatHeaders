...
@class BadRoomLogicController, BaseChatViewModel, BaseMsgContentViewMultiSelectLogic, CADisplayLink, CMessageWrap, ChatRoomHistoryShareStat, DialectFeedbackHelper, LiteAppMessageHistoryTypeFilter, MMDropManager, MMEdgeTipsView, MMInputMsgReferView, MMInputToolView, MMLoadingView, MMMsgContentNavBar, MMMsgMenuReporter, MMMultiSelectToolView, MMNewMsgContentNavBar, MMPageSheetAdapter, MMRichTextCoverView, MMScrollActionSheet, MMSpecialMsgSearchHelper, MMTableView, MMTimer, MMUIActivityIndicatorView, MMUIWindow, MessagePageSheetAdapter, MiniRecTransitionController, MsgDataSaveLogic, MsgImgFullScreenWindow, MsgMediaGroupChatAgent, MsgSearchHelper, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PasteboardMsgProvider, ReaderReporter, RichTextView, ShareMessageConfirmLogicHelper, SpeakTextLogicController, SpeakTextTipsView, StreamVoiceInputViewController, TranslateSpeakReporter, UIColor, UIImageView, UIView, VoiceTransTipsHelper, WAAgentCardRecycleManager, WAAgentSceneInstanceHandle;
...
@interface BaseMsgContentViewController
{
    ...
    DialectFeedbackHelper *m_dialectFeedbackHelper;
    _Bool m_bIsLocating;
    ...
    NSMutableSet *m_customerHelperDeeplinkExposedSet;
    ...
    LiteAppMessageHistoryTypeFilter *_messageHistoryTypeFilter;
    ...
    MsgDataSaveLogic *_msgDataSaveLogic;
    double _chatTableViewYOffset;
    WAAgentCardRecycleManager *_chatBotCardRecycleManager;
    WAAgentSceneInstanceHandle *_chatBotCardSceneHandle;
}

+ (void)reload:(id)arg1 sections:(id)arg2 withRowAnimation:(long long)arg3;
- (void).cxx_destruct;
@property(retain, nonatomic) WAAgentSceneInstanceHandle *chatBotCardSceneHandle; // @synthesize chatBotCardSceneHandle=_chatBotCardSceneHandle;
@property(nonatomic) _Bool chatBotCardRuntimeActivated; // @synthesize chatBotCardRuntimeActivated=_chatBotCardRuntimeActivated;
@property(retain, nonatomic) WAAgentCardRecycleManager *chatBotCardRecycleManager; // @synthesize chatBotCardRecycleManager=_chatBotCardRecycleManager;
@property(nonatomic) double chatTableViewYOffset; // @synthesize chatTableViewYOffset=_chatTableViewYOffset;
@property(retain, nonatomic) MsgDataSaveLogic *msgDataSaveLogic; // @synthesize msgDataSaveLogic=_msgDataSaveLogic;
...
@property(nonatomic) _Bool bSuppressVoiceTransSendScroll; // @synthesize bSuppressVoiceTransSendScroll=_bSuppressVoiceTransSendScroll;
...
@property(nonatomic) unsigned int liteAppMaxSelectCount; // @synthesize liteAppMaxSelectCount=_liteAppMaxSelectCount;
@property(retain, nonatomic) LiteAppMessageHistoryTypeFilter *messageHistoryTypeFilter; // @synthesize messageHistoryTypeFilter=_messageHistoryTypeFilter;
...
- (void)onMMImgFullScreenExitAnimateDidEnd:(id)arg1;
- (void)onMMImgFullScreenDraggingCancel:(id)arg1;
- (void)onMMImgFullScreenWillBeginDragging:(id)arg1;
...
- (void)onMultiHeadCardView:(id)arg1 didChangeVisibility:(_Bool)arg2;
...
- (double)voiceTransSendExtraContentHeightBeforeMsg:(id)arg1 fromOffsetY:(double)arg2;
- (void)voiceTransSetTableContentOffsetY:(double)arg1;
- (void)voiceTransLayoutTableAtContentOffsetY:(double)arg1;
- (double)voiceTransSendMaxContentOffsetY;
- (double)voiceTransCurrentContentOffsetY;
- (void)voiceTransSuppressNextSendScroll;
- (double)voiceRecordPopUpHeight;
...
- (void)tagBizSchemeLink:(id)arg1 messageWrap:(id)arg2;
...
- (_Bool)shouldKeepBottomAfterMediaGroupFold;
...
- (void)_onMediaGroupRevokeAll:(id)arg1 actionInterval:(double)arg2;
- (void)onMediaGroupRevokeAll:(id)arg1;
- (void)onMediaGroupFavAll:(id)arg1;
- (void)_onMediaGroupDeleteAll:(id)arg1;
- (void)onMediaGroupDeleteAll:(id)arg1;
- (void)_onMediaGroupSaveAll:(id)arg1 isOriginal:(_Bool)arg2;
- (void)_onMediaGroupReSaveAll:(CDUnknownBlockType)arg1;
- (void)onMediaGroupSaveAll:(id)arg1;
...
- (long long)currentBottomDistMsgCnt;
...
- (void)bizArticlePendingSendBarDidClickSend:(id)arg1;
- (void)brand_handleViewWillDisappear;
- (void)brand_handleTextBeginEditing;
- (void)brand_layoutPendingSendBarIfNeeded;
- (void)brand_handleViewDidAppear;
- (void)brand_clearPendingSendState;
- (void)brand_resetPendingSendUI;
- (_Bool)brand_takePendingSendReservationWithIdentifier:(id)arg1;
- (void)brand_trackPendingSendReservationWithIdentifier:(id)arg1 releaseBlock:(CDUnknownBlockType)arg2;
- (void)brand_cancelPendingSendReservation;
- (_Bool)brand_isPendingSendBarVisible;
- (void)brand_hidePendingSendBar;
- (_Bool)brand_showPendingSendBarWithTitle:(id)arg1 contentType:(unsigned long long)arg2 imageUrl:(id)arg3 pendingWrap:(id)arg4;
- (void)brand_handlePendingSendOutsideTap:(id)arg1;
- (void)brand_autoDismissPendingSendBar;
- (_Bool)brand_pointInsidePendingSendBar:(struct CGPoint)arg1;
- (void)brand_uninstallPendingSendDismissTap;
- (void)brand_installPendingSendDismissTapIfNeeded;
- (void)brand_schedulePendingSendAutoDismiss;
- (void)brand_cancelPendingSendAutoDismiss;
- (id)brand_pendingSendDismissTapGesture;
- (id)brand_pendingSendViewStateCreatingIfNeeded;
- (id)brand_pendingSendViewState;
- (_Bool)brand_canHandlePendingSendForCurrentContact;
- (id)magicBrushViewModelFromChatBotCardViewModel:(id)arg1;
- (id)chatBotCardMessageViewModelForContainerId:(unsigned int)arg1;
...
- (void)chatBotCardRecycleScrollViewDidScroll;
- (void)chatBotCardRecycleDidEndDisplayViewModel:(id)arg1 indexPath:(id)arg2;
- (void)chatBotCardRecycleWillDisplayViewModel:(id)arg1;
- (void)chatBotCardRecycleDeactivateRuntimeIfNeeded;
- (void)chatBotCardRecycleSetRuntimeVisible:(_Bool)arg1;
- (id)chatBotCardRuntimeHandle;
- (void)onNeedMagicBrushCardEnv;
- (void)ensureChatBotCardRuntimeActivated;
- (id)ensureChatBotCardRecycleManager;
- (_Bool)isTargetViewModel:(id)arg1;
- (void)ensureMsgLoaded:(long long)arg1;
- (id)cmd_getChatContext;
...
- (_Bool)collAssistSearchEntranceAllow;
