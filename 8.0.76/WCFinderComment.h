...
@class CommentContentInfo, FinderCommentInfo, FinderContactMsgInfo, NSArray, NSData, NSDictionary, NSMutableArray, NSNumber, NSString, WCFinderCommentFinderMentionArray, WCFinderCommentMentionArray, WCFinderCommentPastedArray, WCFinderContact, WCFinderIpRegionInfo, WCFinderKeywordComponent;
...
+ (id)overtTextColorWithType:(unsigned long long)arg1 defaultColor:(id)arg2;
...
@property(nonatomic) __weak WCFinderComment *rootComment; // @synthesize rootComment=_rootComment;
...
- (_Bool)isContentFromAI;
- (_Bool)isSelfWechatComment;
@property(readonly, nonatomic) _Bool canShowRecommendAction;
- (id)recommendCommentFriendList;
- (id)interactionLabelsWithPosition:(unsigned long long)arg1 filterAuthIcon:(_Bool)arg2;
...
- (id)getLocalImage;
- (_Bool)hasLocalImage;
- (struct CGSize)commentCellDisplaySize;
- (struct CGSize)commentImgSize;
- (id)getImageInfo;
- (_Bool)hasBigImage;
- (id)overtTextColorWithDefaultColor:(id)arg1;
- (_Bool)isOvertArrowIcon;
- (id)overtIconName;
- (id)overtText;
