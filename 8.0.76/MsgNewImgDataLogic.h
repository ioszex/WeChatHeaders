...
- (void)loadAllRemainingWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)loadPre:(_Bool)arg1 loadNext:(_Bool)arg2 isVerticalSearch:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)loadPre:(_Bool)arg1 loadNext:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)loadPre:(_Bool)arg1 loadNext:(_Bool)arg2 isVerticalSearch:(_Bool)arg3;
- (void)loadPre:(_Bool)arg1 loadNext:(_Bool)arg2;
- (id)asyncLoadImg:(_Bool)arg1 isVerticalSearch:(_Bool)arg2;
...
- (void)updateMsgArray;
- (void)verticalSearchResetWithCurrentMsg:(id)arg1;
