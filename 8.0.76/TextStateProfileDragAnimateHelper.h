...
@class CContact, MMTimer, MMUIButton, MultipleTextStateCardView, NSHashTable, NSString, TextStateFullScreenCardContentView, TextStateMediaContainerView, TextStateProfileCardContentView, UIButton, UIView;
...
- (_Bool)shouldAutoMarkReadOnMultipleTextStateCardView:(id)arg1;
