...
@class MMLimitedModeConfigListView, MMLimitedModeGuardianEntryView, MMLimitedModeMaskViewView, MMUILabel, NSData, NSString, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCAgreementCheckBox;
...
@interface MMLimitedModeEntryViewController
{
    ...
    UIView *_deadlineTipsView;
    UILabel *_deadlineTipsLabel;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UILabel *deadlineTipsLabel; // @synthesize deadlineTipsLabel=_deadlineTipsLabel;
@property(retain, nonatomic) UIView *deadlineTipsView; // @synthesize deadlineTipsView=_deadlineTipsView;
...
- (void)pushSetIndependentPasswordViewController;
- (void)openGuardianInfoLiteAppBeforeSetPassword;
...
- (void)tryPopPreviousIndependentPasswordViewControllerInNavBar;
