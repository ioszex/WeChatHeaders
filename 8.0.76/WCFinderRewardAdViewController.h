...
@class NSString, NSTimer, UIView, WCFinderAdPromotionButton, WCFinderFeedFriendsLikeListBaseViewController, WCFinderFeedListView, WCFinderFeedbackView, WCFinderNearByDescriptionTableViewCell, WCFinderRewardAdViewModel, WCFinderShareCustomTransition, WCFinderShareListReportModel;
...
@interface WCFinderRewardAdViewController
{
    ...
    WCFinderAdPromotionButton *_adPromotionButton;
    long long _adFeedsCountdownCount;
    long long _totalWatchCount;
    NSTimer *_adCountdownTimer;
    WCFinderFeedbackView *_adFeedbackView;
}

- (void).cxx_destruct;
@property(nonatomic) int commentScene; // @synthesize commentScene=_commentScene;
@property(retain, nonatomic) WCFinderFeedbackView *adFeedbackView; // @synthesize adFeedbackView=_adFeedbackView;
@property(retain, nonatomic) NSTimer *adCountdownTimer; // @synthesize adCountdownTimer=_adCountdownTimer;
...
@property(retain, nonatomic) WCFinderAdPromotionButton *adPromotionButton; // @synthesize adPromotionButton=_adPromotionButton;
...
- (void)onFinderFeedbackView:(id)arg1 didClickReason:(id)arg2;
...
- (void)openAdFeedbackUrl;
- (id)adFeedbackReasonWithActionType:(long long)arg1 title:(id)arg2;
- (id)adFeedbackReasonList;
- (void)closeAdFeedbackView;
...
- (_Bool)adHasPlayOver;
- (void)updateAdCountdownDisplay;
- (void)adCountdownTimerCallBack;
- (void)stopAdCountdownTimer;
- (void)startAdCountdownTimer;
- (void)configAdFeedbackView:(id)arg1;
- (struct CGRect)adFeedbackAnchorRect;
- (void)layoutAdPanelViews;
- (void)layoutAdPromotionButton;
- (void)configAdPromotionBtnForCommentScene;
...
- (id)initWithEncrytedObjectidTid:(id)arg1 nonceId:(id)arg2 commentScene:(int)arg3 requestScene:(unsigned long long)arg4 reportModel:(id)arg5 functionalParams:(id)arg6;
