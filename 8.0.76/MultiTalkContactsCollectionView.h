...
@class MMTimer, MMUIButton, MultiTalkScreenSharingAudienceBackgroundView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIButton, UIScrollView;
...
@property(retain, nonatomic) MMUIButton *userNameButton; // @synthesize userNameButton=_userNameButton;
...
- (void)onClickMultiTalkContactCellBeforeTalkingWithContact:(id)arg1;
...
- (id)memberStatusMapBeforeTalking;
...
- (void)reloadOtherMemberBeforeTalkingWithStatusMap:(id)arg1;
- (void)reloadViewInviteMeBeforeTalkingWithStatusMap:(id)arg1;
