...
@class FTSBrowseReportHelper, FTSMsgFallbackSearch, NSMutableSet, WCSearchCTRInfo;

@interface FTSReportMgr : NSObject
{
    WCSearchCTRInfo *_ctrInfo;
    WCSearchCTRInfo *_detailCtrInfo;
    NSMutableSet *_resultHittedKeywordSet;
    FTSBrowseReportHelper *_mainBrowseHelper;
    FTSBrowseReportHelper *_subBrowseHelper;
    FTSMsgFallbackSearch *_fallbackSearch;
}

+ (_Bool)isFallbackSearchEnabled;
- (void).cxx_destruct;
@property(retain, nonatomic) FTSMsgFallbackSearch *fallbackSearch; // @synthesize fallbackSearch=_fallbackSearch;
...
@property(retain, nonatomic) WCSearchCTRInfo *detailCtrInfo; // @synthesize detailCtrInfo=_detailCtrInfo;
@property(retain, nonatomic) WCSearchCTRInfo *ctrInfo; // @synthesize ctrInfo=_ctrInfo;
- (void)reportMsgIndexRecoverWithErrorCode:(unsigned int)arg1;
- (void)reportMsgIndexPauseWithErrorCode:(unsigned int)arg1;
- (void)reportSessionMsgIndexProgress:(id)arg1 searchText:(id)arg2 resultCount:(unsigned int)arg3 query:(id)arg4;
...
- (void)aiHistoryCTREndSearch;
- (void)aiHistoryCTRBeginSearch:(id)arg1;
- (void)weshopCTREndSearch;
- (void)weshopCTRBeginSearch:(id)arg1;
- (void)newCTREndSearch:(id)arg1 force:(_Bool)arg2;
- (void)initCtrInfoWithSessionId:(id)arg1;
