...
+ (id)getStaticImgData:(id)arg1 isFuzzyAlphaCheck:(_Bool)arg2;
+ (id)getStaticImgData:(id)arg1;
...
+ (_Bool)showEmoticonXiaoWeiForSearch;
+ (id)AESGCMDecryptWithKeyString:(id)arg1 andData:(id)arg2;
...
+ (_Bool)trySaveExternalEmoticonThumbForMd5:(id)arg1 data:(id)arg2;
...
+ (id)thumbPathOfExternalEmoticonForMd5:(id)arg1 url:(id)arg2;
+ (id)thumbPathOfExternalEmoticonForMd5:(id)arg1;
+ (id)thumbPathOfCustomEmoticonForMd5:(id)arg1;
+ (_Bool)isEmoticonManagePageShowSelfPosted;
+ (_Bool)isEditedEmoticonUploadAddBufferForPosting;
...
+ (id)extInfoForAppid:(id)arg1 DesignerId:(id)arg2 activityId:(id)arg3 thumbImgUrl:(id)arg4 attachedText:(id)arg5 attachedTextColor:(id)arg6 lensId:(id)arg7 linkId:(id)arg8 storeUnique:(unsigned int)arg9;
...
+ (id)GetCachePathOfEmoticonSearchKeywordRecordListFile;
+ (id)GetPathOfEmoticonSearchKeywordRecordListFile;
...
+ (id)psdkCreateGifFromWxAMData:(id)arg1;
...
+ (id)psdkCreateWxAMForImages:(id)arg1 duration:(double)arg2 qp:(int)arg3 useWXAM3:(_Bool)arg4;
...
+ (id)mergeLocalList:(id)arg1 withSvrList:(id)arg2 shuffleEnable:(_Bool)arg3 svrOrderEnable:(_Bool)arg4 recentUse:(id)arg5 query:(id)arg6;
+ (_Bool)imageContainsAlpha:(id)arg1;
+ (_Bool)realHasAlphaForImage:(id)arg1;
+ (id)dataRepresentationForImage:(id)arg1 isFuzzyAlphaCheck:(_Bool)arg2;
+ (id)dataRepresentationForImage:(id)arg1;
+ (_Bool)isEmoticonNewCustomManagerResortEnable;
+ (_Bool)isEmoticonManagePrivacyDefaultOpen;
+ (_Bool)isEmoticonEditRemoveBackground;
+ (_Bool)isEmoticonMsgDeleteReportEnable;
+ (_Bool)isCustomEmoticonMultiEdit;
+ (_Bool)isEmoticonBoardRecommendTabEnabled;
+ (_Bool)isEmoticonShowOriginalAllowed;
+ (_Bool)isEmoticonIPMergeEnabled;
+ (_Bool)isEmoticonLimitedReduced;
+ (_Bool)isEmoticonHomePageLiteAppExttransfer;
+ (_Bool)isEmoticonBoardAndRecommendReportEnable;
...
+ (struct CGSize)imageSizeOfEmoticonWrap:(id)arg1;
+ (id)loadingPlaceHolder;
+ (id)thumbPlaceHolder;
+ (id)drawDynamicImage:(id)arg1 withBgColor:(id)arg2 rotation:(double)arg3;
