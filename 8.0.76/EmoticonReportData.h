...
+ (void)ReportEmoticonCreateResult:(unsigned long long)arg1 fileSource:(unsigned long long)arg2 fileType:(unsigned long long)arg3 sessionID:(id)arg4 scene:(unsigned long long)arg5 extraInfo:(id)arg6;
+ (void)ReportEmoticonCreateResult:(unsigned long long)arg1 fileSource:(unsigned long long)arg2 fileType:(unsigned long long)arg3 sessionID:(id)arg4 scene:(unsigned long long)arg5;
...
+ (void)ReportEmoticonManageOperation:(unsigned long long)arg1 result:(unsigned long long)arg2 emojiCnt:(unsigned long long)arg3 location:(unsigned long long)arg4 ifTop:(_Bool)arg5 fromScene:(int)arg6 md5List:(id)arg7 orderType:(int)arg8;
...
+ (void)ReportEmoticonManageDelResult:(unsigned long long)arg1 emojiCnt:(unsigned long long)arg2 fromScene:(int)arg3 md5List:(id)arg4 orderType:(int)arg5;
...
+ (void)ReportRedotExposeActionWithEnterPid:(id)arg1 index:(int)arg2 newPage:(int)arg3;
+ (void)ReportRedotAction:(int)arg1 isRed:(int)arg2 enterPid:(id)arg3 index:(int)arg4 pid:(id)arg5 newPage:(int)arg6;
...
+ (void)ReportEmoticonAction:(unsigned long long)arg1 newScene:(int)arg2 emojiInfoObj:(id)arg3;
+ (void)ReportEmoticonAction:(unsigned long long)arg1 newScene:(int)arg2 searchEmotWrap:(id)arg3;
+ (void)ReportEmoticonAction:(unsigned long long)arg1 emoticonWrap:(id)arg2 newScene:(int)arg3 sessionID:(id)arg4 fromUsr:(id)arg5 feedId:(id)arg6 finderUserName:(id)arg7;
