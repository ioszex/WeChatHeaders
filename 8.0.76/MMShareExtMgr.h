...
@class ForwardMessageLogicController, MMTimer, MMWormhole, NSMutableDictionary, NSMutableSet, NSObject, NSString;
...
+ (void)showActivityViewControllerWithActivityItems:(id)arg1 excludedActivityTypes:(id)arg2 fromViewController:(id)arg3 sourceRect:(struct CGRect)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)showActivityViewControllerWithActivityItems:(id)arg1 fromViewController:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)shareMessageToTimelinePublish:(long long)arg1;
- (void)shareVideoToTimelinePublish:(id)arg1;
- (void)animationDidEndRemainView:(id)arg1 hintDataItem:(id)arg2;
- (void)openTimelinePublishWithSightDraft:(id)arg1;
- (void)prepareTimelineSightDraftWithVideoPath:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (id)validTimelineCompressedInputPathForTransmitVideoData:(id)arg1;
- (void)shareMessageToBizPhotoAccount:(long long)arg1;
- (void)shareMessageToFriend:(long long)arg1 scene:(int)arg2;
- (id)genMsgByTransmitVideoDataV2:(id)arg1;
