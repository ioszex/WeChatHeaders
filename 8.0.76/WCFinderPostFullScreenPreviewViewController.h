...
- (void).cxx_destruct;
@property(nonatomic) _Bool showDeleteEntry; // @synthesize showDeleteEntry=_showDeleteEntry;
...
- (void)viewDidLoad;
- (id)initWithDismissBlock:(CDUnknownBlockType)arg1 toolbarDisableConfig:(unsigned long long)arg2 isAuthorPerspective:(_Bool)arg3 showDeleteEntry:(_Bool)arg4;
