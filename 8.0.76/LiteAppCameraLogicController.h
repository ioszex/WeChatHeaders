...
- (id)processAndSaveImage:(id)arg1 withError:(id)arg2 shouldRestoreState:(_Bool)arg3 originalState:(int)arg4;
...
- (void)onMovieSeparateOutputCompleted:(int)arg1 videoPath:(id)arg2 audioPath:(id)arg3 withThumb:(id)arg4;
...
- (void)movieWriter:(id)arg1 onSeparateOutputCompleted:(id)arg2;
...
- (unsigned int)startRecording:(struct CGSize)arg1 selfieMirror:(_Bool)arg2 maxVideoDuration:(float)arg3 compressAudio:(_Bool)arg4 audioBitrate:(float)arg5 outputMode:(id)arg6 audioCodec:(id)arg7;
