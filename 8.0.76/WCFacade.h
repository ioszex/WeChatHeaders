...
@class MemoryMappedKV, MyWCDB, NSMutableArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, WCAccessSecurityVerificationSessionMgr, WCAdDynamicCanvasDeeplinkUtil, WCAdvertiseCommentUploadMgr, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCBGImgLogic, WCBGRecommendMgr, WCBrowseInfo, WCCanvasCommonFileLoader, WCCanvasTypeMgr, WCCommentUploadMgr, WCDataItem, WCDownloadMgr, WCFacadeDynamicConfig, WCGroupMgr, WCInputTextCacheMgr, WCLogicMgr, WCMicroMerchantFoldMgr, WCMomentsContentDiscoverer, WCMomentsFinderRecommendationManager, WCMomentsFinderShareManager, WCMomentsForwardMgr, WCMomentsPostStateMgr, WCMomentsStarManager, WCNotificationCenterMgr, WCOperationSetting, WCPatternCacheMgr, WCPreloadLogicMgr, WCRealFeedExposureItem, WCSnsABTestMgr, WCSnsLocalCacheMgr, WCStrangerCommentMgr, WCTimelineEmoticonManager, WCTimelineMgr, WCUploadMgr;
...
@interface WCFacade
{
    ...
    WCAdDynamicCanvasDeeplinkUtil *_adCanvasDeeplinkUtil;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) WCAdDynamicCanvasDeeplinkUtil *adCanvasDeeplinkUtil; // @synthesize adCanvasDeeplinkUtil=_adCanvasDeeplinkUtil;
...
- (id)genSightViewCacheKeyWithDataItem:(id)arg1 mediaItem:(id)arg2 scene:(unsigned long long)arg3;
...
- (long long)fetchNormalFeedPositionInTimeline:(id)arg1;
...
- (void)onModifyDataItemShareScopeFinishedForFlutterChange:(long long)arg1 dataItem:(id)arg2;
...
- (void)deleteAdvertiseList:(id)arg1 extInfo:(id)arg2;
...
- (void)likeObjectBack:(id)arg1 ofUser:(id)arg2 source:(long long)arg3 ref:(id)arg4 extraInfo:(id)arg5;
...
- (void)setTmpImageCoverInfoForFlutter:(id)arg1 ImgData:(id)arg2 CoverOffset:(double)arg3;
- (void)setCoverWithFinderDataItem:(id)arg1 image:(id)arg2 options:(id)arg3;
- (void)SetBGBySightDraft:(id)arg1;
- (void)SetBGImgByImg:(id)arg1 Offset:(double)arg2;
...
- (_Bool)checkTypeValid:(long long)arg1;
- (long long)getWcDownloadType:(long long)arg1;
- (long long)getCdnDownloadType:(long long)arg1;
...
- (void)cacheText:(id)arg1 image:(id)arg2 emoji:(id)arg3 refDataItem:(id)arg4 refCommentItem:(id)arg5 PasteLogic:(id)arg6 ExtBean:(id)arg7;
- (void)uncacheText:(id)arg1 refCommentItem:(id)arg2;
- (void)setUploadTaskProgressBlockWithDataItem:(id)arg1 progressBlock:(CDUnknownBlockType)arg2 postTipsViewType:(double)arg3;
...
- (void)tryLogBigImageLoadedEfficency:(id)arg1 mediaItem:(id)arg2 loadedResult:(unsigned int)arg3 costTime:(unsigned int)arg4 loadReason:(int)arg5 type:(long long)arg6;
...
- (void)setLayoutStylesOfContent:(id)arg1 withUserComment:(id)arg2 width:(double)arg3 isTiger:(_Bool)arg4 inDataItem:(id)arg5 isSpringIcon:(_Bool)arg6 isShowDetail:(_Bool)arg7;
- (id)layoutStylesOfContentWithUserComment:(id)arg1 width:(double)arg2 isTiger:(_Bool)arg3 inDataItem:(id)arg4 isSpringIcon:(_Bool)arg5 isShowDetail:(_Bool)arg6;
- (void)removeContentHeightForWidth:(double)arg1 withDataItem:(id)arg2 isTiger:(_Bool)arg3 inDataItem:(id)arg4 isSpringIcon:(_Bool)arg5 isShowDetail:(_Bool)arg6;
- (void)setContentHeight:(double)arg1 withUserComment:(id)arg2 width:(double)arg3 isTiger:(_Bool)arg4 inDataItem:(id)arg5 isSpringIcon:(_Bool)arg6 isShowDetail:(_Bool)arg7;
- (double)contentHeightWithUserComment:(id)arg1 width:(double)arg2 isTiger:(_Bool)arg3 inDataItem:(id)arg4 isSpringIcon:(_Bool)arg5 isShowDetail:(_Bool)arg6;
- (_Bool)isAdSpecialCommentStyles:(id)arg1 inDataItem:(id)arg2;
- (id)getUserCommentsUICacheFor:(id)arg1 addIfNotHave:(_Bool)arg2;
- (id)genUserCommentKey:(id)arg1 showDetail:(_Bool)arg2;
...
- (void)setComment:(id)arg1 inDataItem:(id)arg2 showDetail:(_Bool)arg3;
- (_Bool)isCommentShowDetail:(id)arg1 inDataItem:(id)arg2;
