...
@class NSObject, NSString, UIImage, UIView, WCDataItem, WCMomentsPlayerViewContainer, WCPlayerFullScreenConfigControlView, WCPlayerPlayArgs, WCPlayerView, WCSNSPlayerPanelOperationReporter, WCWidgetPlayer, WXFullScreenGestureRecognizer;
...
@interface WCPlayerConfigFullScreenViewController
{
    ...
    NSString *_flutterAlbumMediaId;
    struct CGRect _originRect;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *flutterAlbumMediaId; // @synthesize flutterAlbumMediaId=_flutterAlbumMediaId;
...
- (void)showPausedProgressBarIfNeeded;
- (void)onVideoPause;
- (void)onVideoPlay;
...
- (struct CGRect)adjustShowAreaWithShrinkForDisplayFrame:(struct CGRect)arg1 viewHeight:(double)arg2;
...
- (void)beginFlutterAlbumCoordinationWithMediaId:(id)arg1;
- (void)viewDidBePopedOrDismissed:(_Bool)arg1;
- (void)viewWillBePushOrPresent:(_Bool)arg1;
- (void)pauseVideoForAudioRouteChangeIfNeeded;
- (void)onAVAudioSessionRouteChange:(id)arg1;
