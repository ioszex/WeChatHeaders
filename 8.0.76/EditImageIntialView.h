...
@class CContact, EditImageCropGridView, EditImageCropOverlayView, EditImageCropToolBarView, EditImageEmotionToolAttrView, EditImageMosaicToolAttrView, EditImagePenToolAttrView, EditImageSNSBorderView, EditImageScrollView, EditImageXiaoWeiEntryController, MMHeadImageView, MMMusicFadeOutLayer, MMTimer, MMUIButton, MMUIImageView, NSMutableArray, NSString, TLProfileModel, TLProfileNicknameContainerView, UIButton, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UIView, WCEditViewControllerUIConfig;
...
@interface EditImageIntialView
{
    ...
    _Bool _hasCropFrameBeforeAutoCenter;
    _Bool _isBgInitialized;
    ...
    EditImageXiaoWeiEntryController *_xiaoWeiEntry;
    ...
    UIView *_bgBlurView;
    EditImageCropOverlayView *_bgOverlayView;
    ...
    UIView *_snsNavBar;
    MMUIImageView *_snsNavBackgroundView;
    MMUIButton *_snsNavBackBtn;
    UILabel *_snsNavTitleLabel;
    ...
    struct CGRect _cropFrameBeforeAutoCenter;
    struct CGRect _bgInitialFrame;
    struct CGRect _positionRectOfContent;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UILabel *snsNavTitleLabel; // @synthesize snsNavTitleLabel=_snsNavTitleLabel;
@property(retain, nonatomic) MMUIButton *snsNavBackBtn; // @synthesize snsNavBackBtn=_snsNavBackBtn;
@property(retain, nonatomic) MMUIImageView *snsNavBackgroundView; // @synthesize snsNavBackgroundView=_snsNavBackgroundView;
@property(retain, nonatomic) UIView *snsNavBar; // @synthesize snsNavBar=_snsNavBar;
@property(nonatomic) struct CGRect positionRectOfContent; // @synthesize positionRectOfContent=_positionRectOfContent;
...
@property(nonatomic) double imageInitialScale; // @synthesize imageInitialScale=_imageInitialScale;
@property(nonatomic) _Bool isBgInitialized; // @synthesize isBgInitialized=_isBgInitialized;
@property(retain, nonatomic) EditImageCropOverlayView *bgOverlayView; // @synthesize bgOverlayView=_bgOverlayView;
@property(nonatomic) struct CGRect bgInitialFrame; // @synthesize bgInitialFrame=_bgInitialFrame;
@property(retain, nonatomic) UIView *bgBlurView; // @synthesize bgBlurView=_bgBlurView;
@property(retain, nonatomic) UIImageView *bgImageView; // @synthesize bgImageView=_bgImageView;
@property(nonatomic) _Bool hasCropFrameBeforeAutoCenter; // @synthesize hasCropFrameBeforeAutoCenter=_hasCropFrameBeforeAutoCenter;
@property(nonatomic) struct CGRect cropFrameBeforeAutoCenter; // @synthesize cropFrameBeforeAutoCenter=_cropFrameBeforeAutoCenter;
...
@property(retain, nonatomic) EditImageXiaoWeiEntryController *xiaoWeiEntry; // @synthesize xiaoWeiEntry=_xiaoWeiEntry;
...
@property(nonatomic) _Bool _isShowDoubleMoveToast; // @synthesize _isShowDoubleMoveToast;
...
- (void)layoutBottomGradientShadow;
- (void)layoutXiaoWeiBtn;
- (void)reloadBottomEditImageBar;
- (void)layoutNextBtnWithMargin:(double)arg1;
- (void)applyAiImageAsUndoableOperation:(id)arg1;
- (void)reloadViews;
...
- (_Bool)isLargeVerticalImage;
- (void)checkShowDoubleMoveTips;
- (void)onEmotionEditImage:(id)arg1;
- (void)setClsDebugInfo:(id)arg1;
- (_Bool)isSNSCoverNewVersion;
- (_Bool)hasActionBar;
- (_Bool)isXiaoWeiEntryEnabled;
- (void)onXiaoWeiEntryButtonClicked;
...
- (struct UIEdgeInsets)snsCoverContentInsetForCropFrame:(struct CGRect)arg1;
- (double)snsCoverTopBarHeight;
- (void)bringCustomNavBarToFront;
- (void)reloadCustomNavigationBar;
- (void)initCustomNavigationBarIfNeeded;
- (double)effectiveBottomBarHeightWithSafeArea;
- (double)actionBarAreaHeight;
- (double)toolbarAreaHeight;
- (double)bottomBarLayoutHeight;
- (_Bool)shouldFillActionBarAvailableSpace;
- (_Bool)canActionBarFitAtBottom;
- (double)toolbarContentHeight;
- (double)effectiveBottomBarHeight;
- (double)actionBarTopY;
...
- (void)clearOperation;
- (void)savePropertiesWithCropFrame:(struct CGRect)arg1;
- (void)saveProperties;
...
- (void)syncFrameDimensionsForRotation;
...
- (void)animateHeadAndNicknameWithAlpha:(double)arg1;
...
- (struct CGRect)limitCurrentCropFrameInContentScope:(struct CGRect)arg1 aspectRatio:(double)arg2;
...
- (struct CGRect)cropAdjustmentContentFrame;
- (_Bool)isCropped;
- (_Bool)isRotated;
