...
@interface WCPayMainViewControllerV2
{
    ...
    WCPayComplianceHalfPage *_complianceRealNameHalfPage;
...
@property(retain, nonatomic) WCPayComplianceHalfPage *complianceRealNameHalfPage; // @synthesize complianceRealNameHalfPage=_complianceRealNameHalfPage;
...
- (void)onOfflinePayLogicShouldDropServiceHome;
