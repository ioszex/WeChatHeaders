...
- (id)peekAllSearchResultIncludingUnloadedFor:(id)arg1 taskKey:(id)arg2;
...
- (void)syncSearch:(id)arg1 byType:(long long)arg2 andTags:(id)arg3 starredOnly:(_Bool)arg4 recentUsedLocalIds:(id)arg5 taskKey:(id)arg6;
- (void)syncSearch:(id)arg1 byType:(long long)arg2 andTags:(id)arg3 taskKey:(id)arg4;
- (void)asyncSearch:(id)arg1 byType:(long long)arg2 andTags:(id)arg3 starredOnly:(_Bool)arg4 recentUsedLocalIds:(id)arg5 taskKey:(id)arg6;
