...
@class EditImageIntialView, EditVideoLogicItem, MMAsset, MMAssetSelectCheckButton, MMAssetSelectedCollectionView, MMUIActivityIndicatorView, MMUIButton, MMUILabel, MsgMediaGroupCombineSendView, MultiImageScrollView, NSMutableDictionary, NSMutableSet, NSString, UIButton, UIImageView, UILabel, UIView, VideoEncodeTask, WCFinderCreateCoordinator, WCFinderPreviewEditVideoCompositionTask, WCFinderSyncComposeResModel;
...
@interface MMImagePreviewBrowserController
{
    ...
    NSMutableSet *_livePhotoShowSet;
    UIView *_redDotView;
...
@property(retain, nonatomic) NSMutableSet *livePhotoShowSet; // @synthesize livePhotoShowSet=_livePhotoShowSet;
...
@property(nonatomic) _Bool justPreviewSelected; // @synthesize justPreviewSelected=_justPreviewSelected;
...
- (void)reportLivePhotoPlayData:(long long)arg1 index:(long long)arg2;
...
- (_Bool)isOriginSelected:(id)arg1;
...
- (void)ImageScrollViewDidEndDecelerating:(id)arg1;
- (void)ImageScrollViewWillBeginDragging:(id)arg1;
...
- (void)showSelectedCollectionViewIfNeed;
...
- (void)OnEdit:(id)arg1;
- (void)OnSend:(id)arg1;
- (void)updateSendButtonSelectedAssetCount;
