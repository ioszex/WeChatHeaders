...
@interface MMTextView
{
    ...
    CDUnknownBlockType _customCaretRectBlock;
    CDUnknownBlockType _customDefaultTextAttributesBlock;
...
@property(nonatomic) _Bool pasteFromExternalApp; // @synthesize pasteFromExternalApp=_pasteFromExternalApp;
...
@property(nonatomic) _Bool bCenterPlaceHolder; // @synthesize bCenterPlaceHolder=_bCenterPlaceHolder;
...
@property(copy, nonatomic) CDUnknownBlockType customDefaultTextAttributesBlock; // @synthesize customDefaultTextAttributesBlock=_customDefaultTextAttributesBlock;
@property(copy, nonatomic) CDUnknownBlockType customCaretRectBlock; // @synthesize customCaretRectBlock=_customCaretRectBlock;
...
- (void)callSuperWithAction:(SEL)arg1 sender:(id)arg2;
...
- (id)normalizedAttributedTextByEncodingEmoticons:(id)arg1;
