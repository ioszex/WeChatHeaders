...
@class MMFinderLiveRouterParams, MMScrollActionSheet, MMScrollActionSheetItem, MMUIViewController, NSArray, NSDictionary, NSIndexPath, NSString, UIScrollView, UITableViewCell, WCFinderCommonBottomBannerView, WCFinderFeedContentVM, WCFinderFeedListView, WCFinderPlayerReport, WCFinderTableViewParamModel;
...
@optional
- (NSDictionary *)finderFeedlistView:(WCFinderFeedListView *)arg1 feedbackCustomDictWithContentVM:(WCFinderFeedContentVM *)arg2;
- (_Bool)finderFeedListView:(WCFinderFeedListView *)arg1 disableSetRate:(WCFinderFeedContentVM *)arg2;
- (void)finderFeedListView:(WCFinderFeedListView *)arg1 playRateDidChanged:(double)arg2;
- (_Bool)canShowSwipEdu;
- (void)finderFeedListViewDeleteDataItem:(WCFinderFeedListView *)arg1 deleteTid:(NSString *)arg2;
- (void)finderFeedListView:(WCFinderFeedListView *)arg1 configureUpcomingLiveNavigationWithRouterParameters:(MMFinderLiveRouterParams *)arg2;
...
- (void)finderFeedListView:(WCFinderFeedListView *)arg1 didFollowContentVM:(WCFinderFeedContentVM *)arg2;
- (void)finderFeedListView:(WCFinderFeedListView *)arg1 didInsertPostCommentWithContentVM:(WCFinderFeedContentVM *)arg2 commentVC:(MMUIViewController *)arg3;
- (void)finderFeedListView:(WCFinderFeedListView *)arg1 dislikeConfirmedContentVM:(WCFinderFeedContentVM *)arg2;
