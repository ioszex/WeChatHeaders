...
@interface FlutterDartProject : NSObject
{
    struct Settings {
        ...
        _Bool impeller_use_sdfs;
        _Bool impeller_use_skia_raster_snapshot;
        ...
        basic_string_911c138e allowed_fontmgr_vendors;
        _Bool leak_vm;
        ...
        basic_string_911c138e vulkan_android_surface_control_driver_black_list;
        ...
        _Bool enable_egl_context_retry;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool enablePreRenderMetalLayer; // @synthesize enablePreRenderMetalLayer=_enablePreRenderMetalLayer;
