...
@class FavoritesAndNoteViewController, MMCPLabel, MMFlutterInstance, MMHeadImageView, MMTimer, MMUIButton, MMUIView, MoreViewControllerReporter, MyFavoritesViewController, NSString, TextStateFriendTopicButton, TextStatePrivacyMgr, TextStateProfileCardContentView, TextStateProfileDragAnimateHelper, TextStatePublishEntryButton, TextStateSquareButton, TextStateTopicModel, UITableView, UIView, UpdateWechatRedDotConfig, WCBizLoadingView, WCFinderCreateCoordinator, WCTableViewManager;

@interface MoreViewController
{
    UpdateWechatRedDotConfig *m_oUpdateWechatRedDotConfig;
    MyFavoritesViewController *m_favViewController;
    FavoritesAndNoteViewController *m_favoritesAndNoteViewController;
    MMTimer *m_favCacheTimer;
    UIView *m_footerView;
    WCTableViewManager *m_tableViewMgr;
    MMUIButton *m_textStateErrorBtn;
    MMFlutterInstance *m_favListFlutterInstance;
    _Bool _bIsEnterShareCardListFromOuterJump;
    _Bool _hasReportedPayReddotOnMe;
    _Bool _hasReportedPayReddotOnWCPay;
    _Bool _vcAppear;
    _Bool _ecsCardExpose;
    _Bool _enterBackground;
    _Bool _hasReportedPhotoWorkExposure;
    ...
    MoreViewControllerReporter *_reporter;
    long long _curTabPageSource;
}

- (void).cxx_destruct;
@property(nonatomic) long long curTabPageSource; // @synthesize curTabPageSource=_curTabPageSource;
@property(nonatomic) _Bool hasReportedPhotoWorkExposure; // @synthesize hasReportedPhotoWorkExposure=_hasReportedPhotoWorkExposure;
@property(retain, nonatomic) MoreViewControllerReporter *reporter; // @synthesize reporter=_reporter;
@property(nonatomic) _Bool enterBackground; // @synthesize enterBackground=_enterBackground;
@property(nonatomic) _Bool ecsCardExpose; // @synthesize ecsCardExpose=_ecsCardExpose;
@property(nonatomic) _Bool vcAppear; // @synthesize vcAppear=_vcAppear;
...
- (void)reportExposeAtRedDot:(id)arg1 withPath:(id)arg2;
- (void)handleMyTabRedDotReplace:(id)arg1;
...
- (void)favoritesAndNoteViewControllerDidClose:(id)arg1;
...
- (void)showEmoticonStoreView:(id)arg1;
- (void)tryPreloadEmoticonLiteApp;
- (void)showShareCardView;
- (void)showOldShareCardViewInternal;
- (void)showShareCardViewInternalWithClickSessionId:(id)arg1;
...
- (_Bool)shouldUseFavoritesAndNoteViewController;
- (void)showFinderProfile:(id)arg1;
- (void)reportFinderExpose;
- (void)showMyWCView;
- (void)showMyPatSuffixInProfileView;
- (void)showMyQRCodeInProfileViewWithEntryScene:(unsigned int)arg1;
- (void)showMyQRCodeInProfileViewFromAppSearch;
- (void)onShowMyQrCode;
...
- (void)setupFinderEntranceIcon:(id *)arg1 title:(id *)arg2 iconSize:(struct CGSize)arg3 showFinder:(_Bool)arg4 showBrand:(_Bool)arg5 mixStyle:(_Bool)arg6 showBizPhoto:(_Bool)arg7 colorful:(_Bool)arg8;
- (_Bool)setupFinderEntranceRedDot:(_Bool *)arg1 rightText:(id *)arg2 badge:(id *)arg3 useRedDotRenderTool:(_Bool *)arg4;
...
- (void)beforeDidSelectRowAtIndexPath:(id)arg1 andCell:(id)arg2 andSection:(id)arg3;
- (void)afterCellForRowAtIndexPath:(id)arg1 TableView:(id)arg2 Cell:(id)arg3 CellInfo:(id)arg4;
- (struct CGRect)getCellAvailableRect:(id)arg1 TableView:(id)arg2 CellManager:(id)arg3;
...
- (void)reportEcRedDotExpose:(id)arg1;
