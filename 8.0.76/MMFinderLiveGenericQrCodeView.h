...
@class FinderLiveShareLiveQRCodeInfo, MMFinderLiveNoticePosterModel, MMFinderLiveTask, MMLiveTaskId, NSString, UIImage, UIImageView, UILabel, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView;
...
- (void)updateWithAnchorContact:(id)arg1 qrCodeInfo:(id)arg2 posterModel:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
