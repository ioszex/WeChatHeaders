...
@class MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMLiveAIGCGiftProgressView, MMUIButton, MMUILabel, MMUIView, NSString, PAGView, RfxPagView, UIImageView, UILongPressGestureRecognizer, WCFinderAnimationLoadingView;
...
@interface MMLiveRewardGiftPreviewWindow
{
    ...
    PAGView *_fullAnimationView;
    RfxPagView *_previewRfxAnimationView;
    RfxPagView *_fullRfxAnimationView;
    NSString *_currentResourceId;
    NSString *_currentFullPagMd5;
    NSString *_currentFullPagUrl;
    unsigned long long _currentMemoryCacheOptions;
    MMUIView *_fullPagGradientMaskView;
    ...
    MMLiveAIGCGiftProgressView *_aigcGeneratingProgressView;
    struct CGRect _previewAnimationViewFrame;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMLiveAIGCGiftProgressView *aigcGeneratingProgressView; // @synthesize aigcGeneratingProgressView=_aigcGeneratingProgressView;
...
@property(retain, nonatomic) MMUIView *fullPagGradientMaskView; // @synthesize fullPagGradientMaskView=_fullPagGradientMaskView;
@property(nonatomic) struct CGRect previewAnimationViewFrame; // @synthesize previewAnimationViewFrame=_previewAnimationViewFrame;
@property(nonatomic) unsigned long long currentMemoryCacheOptions; // @synthesize currentMemoryCacheOptions=_currentMemoryCacheOptions;
@property(retain, nonatomic) NSString *currentFullPagUrl; // @synthesize currentFullPagUrl=_currentFullPagUrl;
@property(retain, nonatomic) NSString *currentFullPagMd5; // @synthesize currentFullPagMd5=_currentFullPagMd5;
@property(retain, nonatomic) NSString *currentResourceId; // @synthesize currentResourceId=_currentResourceId;
@property(nonatomic) _Bool isPlayingFullPag; // @synthesize isPlayingFullPag=_isPlayingFullPag;
@property(nonatomic) _Bool isUseRfxPagView; // @synthesize isUseRfxPagView=_isUseRfxPagView;
@property(retain, nonatomic) RfxPagView *fullRfxAnimationView; // @synthesize fullRfxAnimationView=_fullRfxAnimationView;
@property(retain, nonatomic) RfxPagView *previewRfxAnimationView; // @synthesize previewRfxAnimationView=_previewRfxAnimationView;
@property(retain, nonatomic) PAGView *fullAnimationView; // @synthesize fullAnimationView=_fullAnimationView;
...
- (void)switchToPreviewPag;
- (void)switchToFullPag;
- (_Bool)shouldPlayFullPag;
- (void)preloadFullPagResource;
- (void)onActionJumpActivityItem:(id)arg1;
- (void)onAIGCPreviewItem:(id)arg1;
- (void)showMenuItemsForAudience:(id)arg1;
- (void)hideMenuItemsForAudience:(id)arg1;
- (id)shouldShowMenuItemForAudience:(id)arg1;
- (void)onLongpressSendButton:(id)arg1;
- (void)updatePreviewAnimationViewHidden;
- (void)ensureFullPagGradientMaskCreated;
- (double)currentAnimationViewBottom;
- (void)centerAllAnimationViews;
- (void)updateFullPagGradientMaskForHostBounds:(struct CGRect)arg1;
- (void)updateFullAnimationViewFrameForComposition;
- (void)updateAllAnimationViewFrames:(struct CGRect)arg1;
- (void)ensureAnimationViewsCreated;
...
- (void)layoutAIGCProgressView;
- (void)initUI;
- (id)sendButtonGiftTitle;
- (_Bool)needDisplayAIGCProgressRing;
