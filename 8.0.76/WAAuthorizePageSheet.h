...
@interface WAAuthorizePageSheet
{
    ...
    double _agentBorrowedContentWidth;
...
@property(nonatomic) double agentBorrowedContentWidth; // @synthesize agentBorrowedContentWidth=_agentBorrowedContentWidth;
@property(nonatomic) _Bool agentMode; // @synthesize agentMode=_agentMode;
...
- (double)contentWidth;
- (void)relayoutBorrowedContentForWidth:(double)arg1;
- (void)layoutSubViews;
- (void)reloadData;
- (void)setupUI;
