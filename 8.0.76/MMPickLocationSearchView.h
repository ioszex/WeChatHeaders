...
@interface MMPickLocationSearchView
{
    ...
    _Bool _isSearchFooterClearState;
    _Bool _hasPendingSearchWithoutMoreEvent;
    _Bool _hasReportedSearchWithoutMoreEvent;
    ...
    NSString *_pendingSearchWithoutMoreKeyword;
    unsigned long long _pendingSearchWithoutMoreCount;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long pendingSearchWithoutMoreCount; // @synthesize pendingSearchWithoutMoreCount=_pendingSearchWithoutMoreCount;
@property(copy, nonatomic) NSString *pendingSearchWithoutMoreKeyword; // @synthesize pendingSearchWithoutMoreKeyword=_pendingSearchWithoutMoreKeyword;
@property(nonatomic) _Bool hasReportedSearchWithoutMoreEvent; // @synthesize hasReportedSearchWithoutMoreEvent=_hasReportedSearchWithoutMoreEvent;
@property(nonatomic) _Bool hasPendingSearchWithoutMoreEvent; // @synthesize hasPendingSearchWithoutMoreEvent=_hasPendingSearchWithoutMoreEvent;
@property(nonatomic) _Bool isSearchFooterClearState; // @synthesize isSearchFooterClearState=_isSearchFooterClearState;
...
- (void)tryReportSearchWithoutMoreEventIfNeeded;
- (_Bool)isSearchFooterViewExposed;
- (void)prepareSearchWithoutMoreEventReportWithCount:(unsigned long long)arg1;
- (void)resetSearchWithoutMoreEventReportState;
