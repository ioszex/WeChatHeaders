...
@class FinderCreateLiveNoticeRequest_AttachInfo, FinderLiveNoticeInfo, FinderLivePaymentSetting, LiveMicTopicInfo, NSString;
...
@interface WCFinderCreateLiveNoticeCGI
{
    ...
    FinderCreateLiveNoticeRequest_AttachInfo *_attachInfo;
...
@property(retain, nonatomic) FinderCreateLiveNoticeRequest_AttachInfo *attachInfo; // @synthesize attachInfo=_attachInfo;
...
- (void)createRequest;
- (id)initWithFinderUserName:(id)arg1 liveNoticeInfo:(id)arg2 optype:(unsigned int)arg3 paymentSetting:(id)arg4 attachInfo:(id)arg5 delReason:(id)arg6 modifyReason:(id)arg7 modifyFieldFlag:(unsigned long long)arg8 reportingSourceScene:(unsigned long long)arg9 micTopicInfo:(id)arg10 successBlock:(CDUnknownBlockType)arg11 failureBlock:(CDUnknownBlockType)arg12;
