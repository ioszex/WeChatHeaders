...
@class C2CReportController, ChatUnavailableTipsView, MMBottomToolView, MMInputToolView, MMShowWeixinCustomerHelper, NSString, OpenIMSucceedContactLogic, WCScheduleLogicController, WCTopicSearchViewController, XMailBindMailControlLogic;
...
@interface WeixinContentLogicController
{
    ...
    MMShowWeixinCustomerHelper *_showWeixinCustomerHelper;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMShowWeixinCustomerHelper *showWeixinCustomerHelper; // @synthesize showWeixinCustomerHelper=_showWeixinCustomerHelper;
