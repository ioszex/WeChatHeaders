...
@class FavDataItemWrap, NSData, NSString, UIImage;
...
@property(retain, nonatomic) UIImage *previewThumbImage; // @synthesize previewThumbImage=_previewThumbImage;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: favMsgLocalID
...
- (void)loadThumbImage:(CDUnknownBlockType)arg1;
