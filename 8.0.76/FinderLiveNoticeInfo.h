...
@class FinderLiveGiftMethod, FinderLiveNoticeInfo_ConcertInfo, FinderLiveNoticeInfo_MembershipInfo, FinderLiveNoticeInfo_PayInfo, FinderLiveNoticeInfo_PersonalColumnInfo, LiveNoticePendingSaleProductList, MMFinderLiveCouponItem, NSArray, NSMutableArray, NSString;
...
@property(nonatomic) unsigned int maxSetTime; // @dynamic maxSetTime;
