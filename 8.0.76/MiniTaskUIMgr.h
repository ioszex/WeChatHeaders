...
- (_Bool)isMiniTaskViewControllerShowing;
...
- (void)setHasEducateStarEntry:(_Bool)arg1;
- (_Bool)shouldEducateStarEntry;
- (void)setCanEducateStarEntry:(_Bool)arg1;
- (_Bool)canEducateStarEntry;
...
- (void)forceNotifyMiniTaskEntryShowStateChanged;
