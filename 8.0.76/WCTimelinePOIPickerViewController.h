...
@class CLLocation, LbsLife, LocationRetriever, MISSING_TYPE, MMAutoSearchLogic, MMLocationAccuracyAuthorizationTipView, MMTableView, NSIndexPath, NSMutableArray, NSString, UIColor, UILabel, UIView, WCDataSearcher, WCTimeLineFooterView, WCUIAlertView;
