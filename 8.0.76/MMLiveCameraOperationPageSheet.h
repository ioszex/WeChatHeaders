...
{
    _Bool _isUsingNewStartController;
    ...
    CDUnknownBlockType _switchCameraCompletion;
    MMUIButton *;
...
@property(copy, nonatomic) CDUnknownBlockType switchCameraCompletion; // @synthesize switchCameraCompletion=_switchCameraCompletion;
...
@property(nonatomic) _Bool isUsingNewStartController; // @synthesize isUsingNewStartController=_isUsingNewStartController;
...
- (void)fireSwitchCameraCompletionWithSuccess:(_Bool)arg1 isFront:(_Bool)arg2 extraInfo:(id)arg3;
- (void)handleSwitchCameraItemActionWithSource:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
- (void)handleSwitchCameraItemActionForAiAssistantWithCompletion:(CDUnknownBlockType)arg1;
- (void)handleSwitchCameraItemActionWithSource:(unsigned long long)arg1;
