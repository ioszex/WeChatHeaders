...
@class MMBGMSelectedContentView, MMBGMSelectedLocalImportData, NSIndexPath, NSString;
@protocol MMBGMSelectedMusicDataProtocol;

@protocol MMBGMSelectedContentViewDelegate <NSObject>

@optional
- (void)bgmSelectedContentView:(MMBGMSelectedContentView *)arg1 didTapLocalImportMore:(MMBGMSelectedLocalImportData *)arg2;
- (void)bgmSelectedContentViewDidTapLocalImport:(MMBGMSelectedContentView *)arg1;
