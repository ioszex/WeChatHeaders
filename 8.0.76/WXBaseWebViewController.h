...
@class MMJSApiVerifyMgr, MMURLHandler, MMWebViewUniversalLinkMinitorLogic, NSMutableDictionary, NSMutableSet, NSString, NSURL, NSURLRequest, UIButton, UILongPressGestureRecognizer, WCDeepLinkHandler, WKWebView, WebViewA8KeyLogicImpl, WebViewJSLogicImpl;
...
@interface WXBaseWebViewController
{
    ...
    NSMutableSet *_forceSyncForNonBizDomainUrlHashCache;
...
- (void)onFinishedHandleJSApi:(id)arg1 result:(id)arg2;
...
- (_Bool)shouldRejectOverlyLongUrl:(id)arg1 reason:(int)arg2;
