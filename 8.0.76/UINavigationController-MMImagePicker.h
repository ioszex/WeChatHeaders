...
- (_Bool)tryInterceptWalletReentrantPopForTopVC:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)shouldIgnoreReentrantPopForViewController:(id)arg1;
