...
{
    struct shared_ptr<youtu::YTFaceCheckLivePose> faceCheckLivePose;
    vector_926a3350 bestImgShape;
    struct Mat eyeImg;
    struct Mat mouthImg;
    vector_926a3350 eyeShape;
    vector_926a3350 mouthShape;
    vector_73b6e87b currentFrameList;
...
- (int)poseDetect:(struct vector<float, std::allocator<float>>)arg1 visVec:(struct vector<float, std::allocator<float>>)arg2 poseType:(int)arg3 matRgb:(struct Mat)arg4 pitch:(float)arg5 yaw:(float)arg6 roll:(float)arg7;
...
- (vector_73b6e87b)convertMatList:(void *)arg1;
