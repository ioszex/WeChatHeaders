...
@interface MMPageSheetProviderView : UIView
{
    ...
    UIView *_transitonTargetContainerView;
...
- (void).cxx_destruct;
@property(retain, nonatomic) UIView *transitonTargetContainerView; // @synthesize transitonTargetContainerView=_transitonTargetContainerView;
...
@property(nonatomic) double resizeMaxHeight; // @synthesize resizeMaxHeight=_resizeMaxHeight;
@property(nonatomic) double resizeStartHeight; // @synthesize resizeStartHeight=_resizeStartHeight;
...
@property(nonatomic) _Bool startPanOnNavBar; // @synthesize startPanOnNavBar=_startPanOnNavBar;
...
- (void)handleInteractiveResizeEnd:(double)arg1;
- (double)resolveDragResizeMaxContentHeight;
- (void)shareDragNotCloseHalfScreen:(double)arg1;
...
- (double)detailViewWidthFor:(id)arg1;
...
- (id)setupFooterView:(id)arg1 pageSheet:(id)arg2 firstPage:(_Bool)arg3;
- (id)setupNavigationBarView:(id)arg1 pageSheet:(id)arg2 firstPage:(_Bool)arg3;
