...
@class BaseChatCellView, CBaseContact, CContact, CEmoticonWrap, CMessageWrap, ChatRoomPanelDynamicWeAppItem, ChatRoomToolMessageEventInfo, MMGrowTextView, MMInputToolView, MMReferPartialInfo, MMUIViewController, MsgSendOpEntry, NSArray, NSData, NSDictionary, NSString, NSURL, ServiceAppData, SolitaireObj, UIImage, UITableView, VoiceTransLogic;
