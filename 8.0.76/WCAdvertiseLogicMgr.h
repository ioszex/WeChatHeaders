...
@class MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCAdDB, WCAdDynamicCanvasLogic, WCAdDynamicUpdateLogic, WCAdGamePlayablePrerenderInfo, WCAdInfoProxyLogic, WCAdLoadCanvasLogic, WCAdQrCodeScanLogic, WCAdStatePublishReportData, WCCanvasDynamicDataLoader, WWKFContactOpLogic;
...
@interface WCAdvertiseLogicMgr
{
    ...
    MemoryMappedKV *_expirableMMKV;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MemoryMappedKV *expirableMMKV; // @synthesize expirableMMKV=_expirableMMKV;
...
@property(retain, nonatomic) MemoryMappedKV *finderEncryptedIdCache; // @synthesize finderEncryptedIdCache=_finderEncryptedIdCache;
...
@property(retain, nonatomic) WCAdGamePlayablePrerenderInfo *lastPrerenderedGamePlayableInfo; // @synthesize lastPrerenderedGamePlayableInfo=_lastPrerenderedGamePlayableInfo;
...
@property(retain, nonatomic) WCAdInfoProxyLogic *adInfoProxyLogic; // @synthesize adInfoProxyLogic=_adInfoProxyLogic;
...
- (void)updateAdvertiseDataWithClickTimestampForSnsId:(id)arg1;
- (void)onWCAdvertiseStatClickEventSent:(id)arg1;
...
- (void)jumpStatePublish:(id)arg1 adInfo:(id)arg2 snsId:(id)arg3 scene:(int)arg4 customEmoticonInfo:(id)arg5;
- (void)jumpStatePublish:(id)arg1 adInfo:(id)arg2 snsId:(id)arg3 scene:(int)arg4;
- (void)cleanAdDatabase;
- (void)reportAdGap:(int)arg1;
- (void)setupSubAdListIfNeed:(id)arg1 timelineAdInfo:(id)arg2;
- (id)fetchLocalTimelineTopAdInfoList:(unsigned int)arg1;
...
- (void)loadCanvas:(id)arg1 uxInfo:(id)arg2 canvasScene:(unsigned int)arg3 canvasDynamicInfo:(id)arg4 canvasDynamicLoadExtInfo:(id)arg5 compatibleMode:(_Bool)arg6 completeBlock:(CDUnknownBlockType)arg7;
...
- (void)startWeappPrerender:(id)arg1 dataItem:(id)arg2;
- (_Bool)shouldStartWeappPrerender:(id)arg1 dataItem:(id)arg2;
- (void)tryToPrerenderGamePlayableInfo:(id)arg1;
...
- (void)updateAdContactForItems:(id)arg1;
- (id)fetchAsyncAvatarImageForUsername:(id)arg1;
- (id)fetchAsyncAvatarUrlForUsername:(id)arg1;
- (void)updateAsyncAvatarInfoWithItem:(id)arg1;
- (void)resetDynamicUpdateIntervalForItem:(id)arg1 actionType:(unsigned int)arg2;
- (void)clearLogicCacheForItem:(id)arg1;
- (void)updateDynamicFeedUpdateInfoWithItem:(id)arg1 forceUpdate:(_Bool)arg2;
- (void)forceUpdateRandomSelectCardInfoWithItem:(id)arg1;
- (void)updateRockPaperScissorsInfoWithItem:(id)arg1 forceUpdate:(_Bool)arg2;
- (void)forceUpdateRandomPickCardInfoWithItem:(id)arg1;
...
- (void)deleteAdOperationLogic:(id)arg1 type:(long long)arg2;
