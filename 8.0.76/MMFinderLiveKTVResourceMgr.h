...
@class MMLiveKtvThemeRepository, MMLiveResourceFetcherFanoutFlowAction, NSMutableArray, NSMutableDictionary, NSObject, NSString, OrderedDictionary;
...
@interface MMFinderLiveKTVResourceMgr
{
    ...
    NSMutableDictionary *_realTaskDict;
    NSMutableArray *_indexUsed;
}

+ (id)createTaskKeyWithSong:(id)arg1 songResourceTypes:(unsigned long long)arg2 taskId:(id)arg3;
+ (unsigned long long)checkSongResourceTypes:(id)arg1 liveTask:(id)arg2;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *indexUsed; // @synthesize indexUsed=_indexUsed;
@property(retain, nonatomic) NSMutableDictionary *realTaskDict; // @synthesize realTaskDict=_realTaskDict;
...
- (void)onFetcherTaskDoneWithSongId:(id)arg1;
- (void)onFetcherTaskCreateWithSongId:(id)arg1 tasks:(id)arg2;
- (void)assignPriorityWithSongId:(id)arg1 onTop:(_Bool)arg2;
...
- (void)loadKsBasicInfo:(id)arg1 taskId:(id)arg2 forceUpdate:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)loadKsResource:(id)arg1 requireSongResTypes:(unsigned long long)arg2 taskId:(id)arg3;
- (id)getLiveTask:(id)arg1;
- (id)createResLoadTaskWithTaskKey:(id)arg1;
- (_Bool)outQueueLoadTaskWithTaskKey:(id)arg1;
- (_Bool)outQueueLoadTaskWithSong:(id)arg1 songResourceTypes:(unsigned long long)arg2 taskId:(id)arg3;
- (_Bool)tryEnqueueLoadTaskWithSong:(id)arg1 songResourceTypes:(unsigned long long)arg2 taskId:(id)arg3;
...
- (id)getSongBasicInfoWithUId:(id)arg1;
- (void)cacheSongBasicInfo:(id)arg1 uniqueId:(id)arg2;
...
- (void)fetchResourceInfo:(id)arg1 requireSongResTypes:(unsigned long long)arg2 taskId:(id)arg3 completeBlock:(CDUnknownBlockType)arg4;
- (void)loadResourceInfoIfNeed:(id)arg1;
- (void)checkResourceInfo:(id)arg1 requireSongResTypes:(unsigned long long)arg2 taskId:(id)arg3 completeBlock:(CDUnknownBlockType)arg4;
- (id)createDownloadTaskForSongItem:(id)arg1 songResourceTypes:(unsigned long long)arg2;
...
- (_Bool)isResTypeNecessary:(unsigned int)arg1 songResourceTypes:(unsigned long long)arg2;
- (_Bool)checkSongLyricNoteResExist:(id)arg1 requireSongResTypes:(unsigned long long)arg2;
