...
+ (_Bool)canShowCountdownWordLabel:(id)arg1 withConfig:(id)arg2 inWidth:(double)arg3;
+ (double)widthForCountdownWordLabel:(id)arg1 withConfig:(id)arg2;
...
+ (id)filterItems:(id)arg1 withConfig:(id)arg2;
