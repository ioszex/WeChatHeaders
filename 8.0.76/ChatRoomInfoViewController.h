...
@class AddMemLogic, CContact, ChangeOwnerLogic, DelMemLogic, DelaySwitchSettingLogic, MMTableViewInfo, MMUIView, MsgSearchHelper, NSArray, NSIndexPath, NSString, RichTextView, UIButton, UITableViewCell, UIView, ViewMemLogic, WCTableViewSectionManager;
...
@interface ChatRoomInfoViewController
{
    ...
    _Bool _forbidReloadTableData;
    _Bool _isFirstExpandMoreMember;
    unsigned long long _m_searchScene;
    long long _m_bottomDistMsgCnt;
    NSString *_m_searchChatSessionId;
    WCTableViewSectionManager *_memListSection;
    NSString *_reportSessionId;
    struct CGPoint _expandMoreMemberBeginPoint;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *reportSessionId; // @synthesize reportSessionId=_reportSessionId;
@property(nonatomic) struct CGPoint expandMoreMemberBeginPoint; // @synthesize expandMoreMemberBeginPoint=_expandMoreMemberBeginPoint;
@property(nonatomic) _Bool isFirstExpandMoreMember; // @synthesize isFirstExpandMoreMember=_isFirstExpandMoreMember;
@property(nonatomic) _Bool forbidReloadTableData; // @synthesize forbidReloadTableData=_forbidReloadTableData;
@property(retain, nonatomic) WCTableViewSectionManager *memListSection; // @synthesize memListSection=_memListSection;
@property(nonatomic) _Bool isShowChatRooJoinInfoSwitch; // @synthesize isShowChatRooJoinInfoSwitch=_isShowChatRooJoinInfoSwitch;
@property(copy, nonatomic) NSString *m_searchChatSessionId; // @synthesize m_searchChatSessionId=_m_searchChatSessionId;
@property(nonatomic) long long m_bottomDistMsgCnt; // @synthesize m_bottomDistMsgCnt=_m_bottomDistMsgCnt;
...
- (id)searchChatSessionIdForReport;
...
- (id)getDisplayName;
- (void)showStillNotification:(id)arg1;
...
- (void)handleModifyViewMemLogic:(id)arg1;
- (void)handleScrollViewDidScroll:(id)arg1;
- (id)getMoreBtnTitle;
- (void)handleViewMoreBtnCellInProfileOptimize:(id)arg1 CellInfo:(id)arg2;
