...
@class NSMutableArray, NSString, WACacheVersionCheckerContext, WACacheVersionCheckerMetrics, WACacheVersionPreChecker, WAInfoData, WAPackageConfig;
...
@interface WACacheVersionChecker : NSObject
{
    ...
    WACacheVersionCheckerMetrics *_metrics;
    CDUnknownBlockType _metricsHandler;
}
...
+ (id)getErrMsgFromErrorCode:(long long)arg1 debugType:(unsigned long long)arg2 isSimulatedNativeWeApp:(_Bool)arg3;
+ (id)getErrMsgFromErrorCode:(long long)arg1 debugType:(unsigned long long)arg2;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType metricsHandler; // @synthesize metricsHandler=_metricsHandler;
@property(retain, nonatomic) WACacheVersionCheckerMetrics *metrics; // @synthesize metrics=_metrics;
...
- (void)checkCacheReadyWithCheckerContext:(id)arg1 completeHandler:(CDUnknownBlockType)arg2 progressHandler:(CDUnknownBlockType)arg3 metricsHandler:(CDUnknownBlockType)arg4;
