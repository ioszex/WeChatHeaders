...
@class MISSING_TYPE, MMFinderLiveFansGroupIntroView, MMFinderLiveRewardGiftItem, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveHalfScreenTitleBarView, MMUIButton, MMUILabel, MMUIMaskContainerView, NSArray, NSString, UIScrollView, UIView, WCFinderAnimationLoadingView;

@interface MMFinderLiveNewFansGroupJoinPanel
{
    MISSING_TYPE *_needPurchase;
