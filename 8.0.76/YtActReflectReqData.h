...
@interface YtActReflectReqData : NSObject
{
    ...
    NSString *_actionStr;
    NSString *_config;
    vector_926a3350 _bestShape;
    vector_926a3350 _eyeShape;
    vector_926a3350 _mouthShape;
    struct Mat _bestImg;
    struct Mat _eyeImg;
...
@property struct vector<float, std::allocator<float>> mouthShape; // @synthesize mouthShape=_mouthShape;
@property struct Mat mouthImg; // @synthesize mouthImg=_mouthImg;
@property struct vector<float, std::allocator<float>> eyeShape; // @synthesize eyeShape=_eyeShape;
@property struct Mat eyeImg; // @synthesize eyeImg=_eyeImg;
@property struct vector<float, std::allocator<float>> bestShape; // @synthesize bestShape=_bestShape;
