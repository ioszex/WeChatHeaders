...
- (void)onContactAddedUsername:(id)arg1 serviceType:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)onNewMsgMsg:(id)arg1 serviceType:(long long)arg2 completion:(CDUnknownBlockType)arg3;
