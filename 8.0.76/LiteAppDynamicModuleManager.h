...
- (void)paramCallback:(unsigned int)arg1 appId:(id)arg2 pageId:(unsigned long long)arg3 callbackId:(int)arg4 data:(id)arg5 keepAlive:(_Bool)arg6 sourceType:(int)arg7;
- (struct basic_string<char, std::char_traits<char>, std::allocator<char>>)callDynamicModule:(unsigned int)arg1 appId:(id)arg2 pageId:(unsigned long long)arg3 module:(id)arg4 method:(id)arg5 param:(id)arg6 callbackId:(long long)arg7 sourceType:(int)arg8 viewController:(id)arg9;
