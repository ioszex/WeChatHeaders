...
@class FinderLiveAppMsgLiveRewardInfo, FinderLiveGuideFollowAdInfo, FinderObjectAdvertisementInfo, ForwardMessageLogicController, MMFinderLiveNotifyBannerReportInfo, MMFinderRefSessionBufferKey, MMLiveEnterRoomActionModel, NSArray, NSData, NSMutableArray, NSString, SessionForwardRecordLogic, SharePreConfirmSheetView, WCFinderContact, WCFinderDataItem, WCFinderFeedLiveCellRouterModel, WCFinderFullShareListTemplatePlugin, WCFinderPushFeedViewLiveParams, WCFinderShareEntranceMessageInfo;
...
@interface MMFinderLiveContentVM : NSObject
{
    ...
    WCFinderFeedLiveCellRouterModel *_feedModel;
    NSString *_instantDiscountActivityKey;
    NSArray *_backupFeeds;
    NSString *_enterTid;
    NSData *_openLiveH5Buffer;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: temporaryObjectId
...
@property(nonatomic) _Bool isAlternativeSource; // @synthesize isAlternativeSource=_isAlternativeSource;
@property(retain, nonatomic) NSData *openLiveH5Buffer; // @synthesize openLiveH5Buffer=_openLiveH5Buffer;
@property(retain, nonatomic) NSString *enterTid; // @synthesize enterTid=_enterTid;
@property(nonatomic) int mixedFlowType; // @synthesize mixedFlowType=_mixedFlowType;
...
@property(retain, nonatomic) WCFinderFeedLiveCellRouterModel *feedModel; // @synthesize feedModel=_feedModel;
