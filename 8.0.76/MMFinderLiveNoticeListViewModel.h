...
@class FinderLiveNextLiveNotificationInfo, FinderLiveNoticeListInfo, MMFinderLiveNoticeMoreViewItem, MMFinderLiveNoticeNextLiveNoticeViewItem, NSArray, NSData, NSMutableSet, NSString, WCFinderContact, WCFinderLiveAudienceNoticeReporter;
...
@interface MMFinderLiveNoticeListViewModel : NSObject
{
    ...
    long long _noticeListReportSourceType;
    NSString *_contextFeedId;
...
@property(copy, nonatomic) NSString *contextFeedId; // @synthesize contextFeedId=_contextFeedId;
@property(nonatomic) long long noticeListReportSourceType; // @synthesize noticeListReportSourceType=_noticeListReportSourceType;
...
- (id)reportCommentSceneString;
- (long long)noticeScene;
