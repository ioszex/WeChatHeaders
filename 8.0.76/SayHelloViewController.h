...
@class CPushContact, FindContactSearchViewCellInfo, MMNearByHeaderView, MMTableView, MMTableViewInfo, MMUIButton, NSMutableSet, NSString, SayHelloDataLogic, SeePeopleNearByLogicController, SendVerifyMsgLogicController, UILabel, UIView;
...
@property(nonatomic) unsigned long long maxExposeCellIndex; // @synthesize maxExposeCellIndex=_maxExposeCellIndex;
...
- (void)willAppear;
- (void)dealloc;
- (void)updateMaxExposeCellIndexFromVisibleCells;
...
- (_Bool)isNewFriendsReportPageVisible;
- (void)unregisterNewFriendsReportLifecycle;
- (void)registerNewFriendsReportLifecycle;
