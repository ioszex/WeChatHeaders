...
+ (id)snapshotForUIView:(id)arg1 opaque:(_Bool)arg2 checkCustomImpl:(_Bool)arg3 renderWithLayer:(_Bool)arg4;
...
+ (id)fixMesOriginVideoAssetPath:(id)arg1;
+ (_Bool)isMesOriginVideoAssetPath:(id)arg1;
+ (id)GetPathOfMesOriginVideoAsset:(id)arg1 LocalID:(unsigned int)arg2 DocPath:(id)arg3;
...
+ (unsigned long long)GetDeviceBirthTime;
...
+ (id)getIconNameByFileType:(int)arg1 iconType:(unsigned long long)arg2;
+ (id)getIconNameByFileType:(int)arg1;
+ (id)getIconNameByFileExt:(id)arg1 iconType:(unsigned long long)arg2;
+ (id)getIconNameByFileExt:(id)arg1;
+ (int)getFileTypeByFileExt:(id)arg1;
+ (id)getIconImageByFileType:(int)arg1 iconSize:(int)arg2 iconType:(unsigned long long)arg3;
+ (id)getIconImageByFileType:(int)arg1 iconSize:(int)arg2;
+ (id)getIconImageByFileExt:(id)arg1 iconSize:(int)arg2 iconType:(unsigned long long)arg3;
+ (id)getIconImageByFileExt:(id)arg1 iconSize:(int)arg2;
+ (_Bool)isGrayIconByFileExt:(id)arg1;
+ (id)DebugBuildInfo;
+ (id)DebugFeatureId;
