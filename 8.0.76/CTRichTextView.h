...
@interface CTRichTextView
{
    ...
    NSString *_touchBeganUrl;
    unsigned long long _touchBeganType;
    _Bool _bLinkClickDispatched;
...
- (_Bool)isClickableLinkAtPoint:(struct CGPoint)arg1;
...
- (_Bool)flushPendingLinkClickIfNeeded;
- (_Bool)dispatchClickForUrl:(id)arg1 type:(unsigned long long)arg2 touchRect:(struct CGRect)arg3;
