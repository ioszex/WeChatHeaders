...
@interface BaseMsgContentLogicController
{
    ...
    _Bool m_bHadShowFirstWillAppear;
...
@property(retain, nonatomic) NSDictionary *chatRoomWillEnterReportCtx; // @synthesize chatRoomWillEnterReportCtx=_chatRoomWillEnterReportCtx;
...
@property(retain, nonatomic) NSString *toolViewLastText; // @synthesize toolViewLastText=_toolViewLastText;
...
- (_Bool)isChatroom;
- (void)processInsertedGifData:(id)arg1 withRevokeBatchId:(id)arg2;
...
- (void)processInsertOriginFilePath:(id)arg1 thumbnail:(id)arg2 deleteAfterSend:(_Bool)arg3 largeFileDuration:(double)arg4;
...
- (id)onMultiMsgDelete:(id)arg1;
- (void)onMultiSelectCancel;
- (void)downloadMultiMsg:(id)arg1 scene:(long long)arg2 params:(id)arg3;
- (void)sendMultiMsgToThirdPartyService:(id)arg1;
...
- (void)sendMultiMsgToFriend:(id)arg1 params:(id)arg2;
- (void)sendMultiMsgToFriend:(id)arg1;
- (void)copyMultiMsg:(id)arg1 params:(id)arg2;
...
- (void)StartPlaying:(id)arg1 fromTime:(unsigned int)arg2;
- (_Bool)IsRecording;
...
- (void)onChangeReferMsgId:(long long)arg1 referPartXML:(id)arg2;
- (void)onGrowTextViewDidStopVoiceInput:(id)arg1;
- (void)onGrowTextViewDidStartVoiceInput:(id)arg1;
...
- (void)QuicklySaveDraft:(id)arg1 referMsgSvrId:(long long)arg2 draftStatus:(unsigned int)arg3 referPartXML:(id)arg4;
...
- (void)ViewWillInit;
- (void)dataWillInit;
- (id)createSingleChatTopTextStateItemView:(id)arg1;
- (void)configTextStateViewReportWithContact:(id)arg1 View:(id)arg2;
...
- (void)OnTagBizSchemeLink:(id)arg1 messageWrap:(id)arg2;
- (_Bool)shouldBlockWebViewNavigationWithUrl:(id)arg1 extraInfo:(id)arg2 messageWrap:(id)arg3;
...
- (void)dumpCustomInfoForVoIPReportWithContact:(id)arg1;
- (void)ShareCard;
...
- (void)OnSharePreConfirmSendMsgList:(id)arg1;
...
- (void)checkOpenWithThirdPartyService:(id)arg1 selected:(_Bool)arg2;
- (void)onMultiSelectChanged:(id)arg1 selected:(_Bool)arg2;
- (void)onMoreOperateWithMsg:(id)arg1;
- (void)onShareMsgToThirdPartyServiceFinished;
- (void)shareMsgListToThirdPartyService:(id)arg1 sheetScene:(unsigned long long)arg2;
- (void)shareMsgListToThirdPartyService:(id)arg1;
- (void)shareMsgToThirdPartyService:(id)arg1;
- (void)shareMsgToDevice:(id)arg1;
- (void)BatchRevokeMsg:(id)arg1 withReportInterval:(unsigned long long)arg2;
...
- (void)onScheduleUrl:(id)arg1 content:(id)arg2;
- (void)setSpeakingHighlight:(_Bool)arg1 forMsg:(id)arg2;
- (void)locateToMsg:(id)arg1;
- (id)onSpeakMsgGetMessageNodeArray;
