...
@class CEmoticonWrap, EmoticonBoardView, MMGrowTextView, MMUIButton, MMUILabel, NSArray, NSDictionary, NSString, PrivateInfo, TextStateIcon, TextStatePublishConfiguration, TextStatePublishContentBuilder, TextStatePublishEmoticonView, TextStatePublishGuideView, TextStatePublishIconButton, TextStatePublishIconList, TextStatePublishInputBar, TextStatePublishMediaSwitchView, TextStatePublishReport33629, TextStatePublishReportObject, TextStatePublishSourceInfo, TextStatePublishSourceView, TextStatePublishTitleView, TextStateTopicGuideBubbleView, UIBarButtonItem, UIScreenEdgePanGestureRecognizer, UIScrollView, UITapGestureRecognizer, UIView, UIViewPropertyAnimator, WCInputController, WCLocationInfo, WCMomentsPrivacyParams, WCStatusPrivacySetting;
...
@interface TextStatePublishViewController
{
    ...
    TextStatePublishReport33629 *_report33629;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool markUserChangeMediaSuccess; // @synthesize markUserChangeMediaSuccess=_markUserChangeMediaSuccess;
@property(nonatomic) unsigned int originMediaSwitchValue; // @synthesize originMediaSwitchValue=_originMediaSwitchValue;
...
@property(retain, nonatomic) TextStatePublishReport33629 *report33629; // @synthesize report33629=_report33629;
...
- (void)reportSdkExitPageEvent:(id)arg1 exitType:(id)arg2 routeRule:(long long)arg3;
- (void)reportSdkEnterPageEvent:(id)arg1 routeRule:(long long)arg2;
- (void)reportSdkCustomViewEvent:(id)arg1 viewId:(id)arg2 params:(id)arg3 routeRule:(long long)arg4;
- (id)getReportPageNameByPageId:(id)arg1;
- (id)getReportPageIdByCheckIconPickerShowing;
- (id)getReportPageIdByCheckNewPost;
- (id)getSdkPublishEventReportParams:(id)arg1;
...
- (_Bool);
- (_Bool)compareModifyBackground;
- (_Bool)compareModifyVisibility:(id)arg1;
- (_Bool)compareModifyEmoticon:(id)arg1 origiEmoticon:(id)arg2;
- (_Bool)compareModifyText:(id)arg1 originText:(id)arg2;
- (_Bool)compareModifyStatusIcon:(id)arg1 originIconId:(id)arg2;
- (_Bool)compareModifyPositionInfo:(id)arg1 originPositionInfo:(id)arg2;
- (_Bool)isPublishContentKeepDefault;
