...
@protocol WCFinderFeedListTransitionHelperBehavior, WCFinderFeedListTransitionHelperDelegate, WCFinderFeedListTransitionHorizontalGestureBehavior, WCFinderFeedListTransitionVerticalGestureBehavior;

@interface WCFinderFeedListTransitionHelper : NSObject
{
    _Bool _hasConfiguredVerticalGesture;
    ...
    id <WCFinderFeedListTransitionVerticalGestureBehavior> _verticalBehavior;
    id <WCFinderFeedListTransitionHorizontalGestureBehavior> _horizontalBehavior;
}

+ (void)PresentVCWithSystemPushPopAnimation:(id)arg1 rootVC:(id)arg2;
+ (void)NotifyVCWillExpandFromVC:(id)arg1 toVC:(id)arg2;
+ (_Bool)transitionPassPlayerManual:(id)arg1 forTid:(id)arg2;
+ (_Bool)keepPlayGestureRunning:(id)arg1;
+ (void)addToVC:(id)arg1 willDismissHookBlock:(CDUnknownBlockType)arg2 endDismissBlock:(CDUnknownBlockType)arg3;
+ (void)configScrollViewHorizontalGesture:(id)arg1 viewController:(id)arg2 horizontalBehavior:(id)arg3;
+ (void)configScrollViewVerticalGesture:(id)arg1 viewController:(id)arg2 verticalBehavior:(id)arg3;
+ (_Bool)isViewControllerSwipeGestureTransitionPushing:(id)arg1;
...
+ (_Bool)hasTrailingAnimatorForVC:(id)arg1;
...
- (void).cxx_destruct;
@property(nonatomic) __weak id <WCFinderFeedListTransitionHorizontalGestureBehavior> horizontalBehavior; // @synthesize horizontalBehavior=_horizontalBehavior;
@property(nonatomic) __weak id <WCFinderFeedListTransitionVerticalGestureBehavior> verticalBehavior; // @synthesize verticalBehavior=_verticalBehavior;
@property(nonatomic) _Bool hasConfiguredVerticalGesture; // @synthesize hasConfiguredVerticalGesture=_hasConfiguredVerticalGesture;
...
- (id)_fetchCurrentMediaPlayer:(id)arg1;
- (id)onAnimatorRequestTransferCurrentPlayer:(id)arg1;
...
- (void)_onTransitionFinishDoCleanup:(_Bool)arg1;
...
- (_Bool)_transitionPassPlayerManual:(id)arg1 forTid:(id)arg2;
...
- (void)startDragGesture:(id)arg1 direction:(long long)arg2 offsetToLock:(double)arg3;
...
- (void)hookInteractionController:(Class)arg1;
- (id)pushAnimatorWithProvider:(id)arg1 fromVC:(id)arg2 toVC:(id)arg3;
- (id)popAnimatorWithProvider:(id)arg1 fromVC:(id)arg2 toVC:(id)arg3;
- (id)animationControllerForOperation:(long long)arg1 fromVC:(id)arg2 toVC:(id)arg3;
- (void)hookAnimationController:(Class)arg1;
- (void)hookViewDidAppear:(Class)arg1;
