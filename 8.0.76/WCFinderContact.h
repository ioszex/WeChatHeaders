...
@class AchievementInfo, FinderBizInfo, FinderContact, FinderContactClubInfo, FinderContactLiveInfo, FinderContactMsgInfo, FinderGuestInfo, FinderIdentityInfo, FinderLiveNoticeInfo, FinderSticker, NSString, WCFinderAuthInfo, WCFinderBindInfoList, WCFinderContactExtInfo, WCFinderContactInnerModel, WCFinderContactServiceMenuMutableArray, WCFinderDataItem, WCFinderJumpInfo;
...
@property(copy, nonatomic) NSString *relationTag; // @synthesize relationTag=_relationTag;
...
- (void)updateContactForbiddenMiniAppReference:(_Bool)arg1;
