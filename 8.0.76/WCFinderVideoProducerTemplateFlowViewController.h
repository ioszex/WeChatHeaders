...
@class MJVideoTemplate, NSIndexPath, NSMutableSet, NSString, UIButton, UICollectionView, UIPanGestureRecognizer, UIView, WCFinderVideoProducerDataSource, WCFinderVideoProducerLoadMoreView, WCUnhittableView;
@protocol WCFinderVideoProducerTemplateFlowDelegate;

@interface WCFinderVideoProducerTemplateFlowViewController
{
    _Bool _isHangingStyleEnabled;
    _Bool _canRecreateWhileLoading;
    _Bool _isNewAITemplateComposingEnabled;
    _Bool _isMJAppLauncherEnabled;
    _Bool _isRequesting;
    _Bool _isScrolling;
    _Bool _isScrolledByCode;
    id <WCFinderVideoProducerTemplateFlowDelegate>;
    ...
    WCFinderVideoProducerLoadMoreView *_loadMoreView;
...
@property(retain, nonatomic) WCFinderVideoProducerLoadMoreView *loadMoreView; // @synthesize loadMoreView=_loadMoreView;
...
@property(nonatomic) _Bool isNewAITemplateComposingEnabled; // @synthesize isNewAITemplateComposingEnabled=_isNewAITemplateComposingEnabled;
...
@property(nonatomic) __weak id <WCFinderVideoProducerTemplateFlowDelegate> delegate; // @synthesize delegate=_delegate;
