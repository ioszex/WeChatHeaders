...
@interface MMAssetDragSelectHelper : NSObject
{
    ...
    long long _maxCount;
    long long _numberOfViewInCell;
    double _autoScrollUpEdge;
    double _autoScrollDownEdge;
...
@property(nonatomic) double autoScrollDownEdge; // @synthesize autoScrollDownEdge=_autoScrollDownEdge;
@property(nonatomic) double autoScrollUpEdge; // @synthesize autoScrollUpEdge=_autoScrollUpEdge;
@property(nonatomic) long long numberOfViewInCell; // @synthesize numberOfViewInCell=_numberOfViewInCell;
