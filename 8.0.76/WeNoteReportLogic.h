...
- (void).cxx_destruct;
- (void)reportNotePageOut32903:(id)arg1 isEdit:(_Bool)arg2 hasContent:(_Bool)arg3 stayDuration:(id)arg4 plusSessionId:(id)arg5;
...
- (void)reportToolViewOperation:(int)arg1 isSmallImageMode:(_Bool)arg2 MediaType:(unsigned long long)arg3 favDetail:(id)arg4 count:(unsigned int)arg5 operationDetail:(id)arg6 logVersion:(unsigned int)arg7;
