...
@interface WAMapView
{
    ...
    NSMutableDictionary *_markerAlongAnimations;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *markerAlongAnimations; // @synthesize markerAlongAnimations=_markerAlongAnimations;
...
- (void)unregisterMarkerAlongAnimation:(long long)arg1;
- (void)registerMarkerAlongAnimation:(long long)arg1 context:(id)arg2;
...
- (void)resumeMarkerAlongAnimations;
- (void)pauseMarkerAlongAnimations;
