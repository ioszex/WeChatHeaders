...
+ (id)generateVideoSubItemWithVideoSubType:(unsigned long long)arg1 disableSubTypes:(id)arg2;
+ (id)generateVideoSubItemWithVideoSubType:(unsigned long long)arg1;
+ (id)generateAudioSubItemWithAudioSubType:(unsigned long long)arg1 disableSubTypes:(id)arg2;
+ (id)generateAudioSubItemWithAudioSubType:(unsigned long long)arg1;
+ (id)generateSubItemWithLiveModeInfo:(id)arg1 disableSubTypes:(id)arg2;
+ (id)generateDataItemListWithLiveMode:(unsigned long long)arg1 hideLandscpe:(_Bool)arg2 disableVideoLandscape:(_Bool)arg3 hideKTVLiveMode:(_Bool)arg4 isChatRoomModeAvailable:(_Bool)arg5 isFromNewStartController:(_Bool)arg6 redDotQueryBlock:(CDUnknownBlockType)arg7 redDotExposeBlock:(CDUnknownBlockType)arg8 redDotClickBlock:(CDUnknownBlockType)arg9;
+ (long long)totalSubModeCountWithLiveMode:(unsigned long long)arg1 hideLandscpe:(_Bool)arg2 hideKTVLiveMode:(_Bool)arg3;
- (void).cxx_destruct;
