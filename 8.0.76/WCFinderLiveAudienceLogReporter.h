...
- (void)reportNowPlayingControl:(unsigned long long)arg1 extraParams:(id)arg2;
- (void)reportAudienceOuterQuickCommentAction:(unsigned long long)arg1 quickCommentId:(id)arg2;
- (void)reportAudienceLeaveMic:(unsigned long long)arg1 style:(unsigned long long)arg2;
- (void)reportAudienceKtvSongOperation:(unsigned int)arg1;
- (void)reportAudienceKtvSongBtn:(_Bool)arg1 selfWaitSongCount:(unsigned int)arg2;
- (void)reportAudienceKtvCurrentSong:(_Bool)arg1 uniqueId:(id)arg2;
- (void)reportAudienceKtvSongComment:(_Bool)arg1 uniqueId:(id)arg2;
- (void)reportAudienceKtvSongPanel:(unsigned long long)arg1;
- (void)reportAudienceKTVSingerBoardUserAction:(unsigned long long)arg1 rankUserName:(id)arg2;
- (void)reportAudienceKTVSingerBoardExpose;
- (void)reportAudienceKTVRelatedLiveAction:(unsigned long long)arg1;
- (void)reportAudienceKTVSingerBoardEntranceAction:(unsigned long long)arg1;
- (void)reportAudienceKTVExposedGiftBatchRewardOperation:(unsigned long long)arg1 giftId:(id)arg2 withGiftCount:(unsigned int)arg3;
- (void)reportAudienceKTVExposedGiftQuideOperation:(unsigned long long)arg1 giftId:(id)arg2;
- (void)reportAudienceKTVGiftButtonOperation:(unsigned long long)arg1 giftId:(id)arg2 withConditionId:(unsigned int)arg3;
- (void)reportAudienceCatalogedMerchandiseLotteryAction:(unsigned long long)arg1 withLotteryActivityId:(id)arg2 merchandiseOrderId:(id)arg3;
- (void)reportAudienceFullScreenDoubleClickLikeEducationAction:(unsigned long long)arg1;
- (void)reportAudienceFullScreenSlideEducationAction:(unsigned long long)arg1;
...
- (void)onReportShopInfoEcShopAction:(unsigned long long)arg1 iconType:(id)arg2 state:(id)arg3 productId:(id)arg4;
...
- (void)reportWatchMilestoneAction:(unsigned long long)arg1 milestoneType:(unsigned long long)arg2 milestoneNum:(unsigned long long)arg3;
...
- (void)reportAudienceCommonPIPAndMinimizeWindowAction:(id)arg1 windowType:(unsigned long long)arg2;
...
- (void)reportAudienceCommentPanelAction:(unsigned long long)arg1 elementId:(unsigned long long)arg2 extraActionResult:(id)arg3;
...
- (void)reportKtvConnectMicReplayActionWithType:(unsigned long long)arg1 element:(unsigned long long)arg2 subType:(unsigned long long)arg3 subElement:(unsigned long long)arg4;
- (void)reportAudienceConnectMicSessionWithType:(unsigned long long)arg1 liveMode:(unsigned int)arg2 liveSubMode:(unsigned int)arg3 subSessionId:(id)arg4 connectMicScene:(unsigned int)arg5;
- (void)reportAudienceFreeMicAction:(unsigned long long)arg1 duration:(unsigned long long)arg2;
- (void)reportMicAction:(unsigned long long)arg1 userIdentity:(unsigned long long)arg2;
...
- (void)reportCommentPOIComponentAction:(id)arg1;
...
- (void)reportEnterProfileWithType:(unsigned long long)arg1;
...
- (void)reportFinderLiveLike:(unsigned long long)arg1 isClipMode:(_Bool)arg2 doubleClickCount:(unsigned long long)arg3;
- (void)reportFinderLiveReply:(id)arg1;
- (void)reportFinderLiveCommentBoxAction:(id)arg1;
- (void)reportAudienceStartLiveGuideAction:(id)arg1;
- (void)reportAudienceReplaySubscriptionComment:(unsigned long long)arg1;
- (void)reportAudienceReplaySubscriptionBanner:(unsigned long long)arg1 source:(unsigned long long)arg2;
- (void)reportAudienceReserveNextLiveNotification:(unsigned long long)arg1 noticeCnt:(unsigned int)arg2 noticeId:(id)arg3;
- (void)reportAudienceNoticeBanner:(unsigned long long)arg1 noticeCnt:(unsigned int)arg2 noticeId:(id)arg3;
- (void)reportAudienceAudioEffectEntry:(_Bool)arg1 pos:(unsigned long long)arg2;
- (void)reportAudienceMainFrameRequestedSongPanel:(_Bool)arg1 isMicConnected:(_Bool)arg2;
- (void)reportAudienceUltraHDWatchDuration:(unsigned long long)arg1 durationInMs:(unsigned long long)arg2;
- (void)reportAudienceSwitchStreamGuideAction:(unsigned long long)arg1;
...
- (void)onAudienceFriendLikeAction:(unsigned long long)arg1 sendReason:(unsigned long long)arg2 friendUserNames:(id)arg3;
- (void)onReportMiniGamePkActionType:(unsigned long long)arg1 gameId:(id)arg2 sessionId:(id)arg3;
...
- (void)reportFloatBarrageAction:(unsigned long long)arg1 messageType:(unsigned int)arg2;
...
- (void)reportAudienceSongAction:(unsigned long long)arg1 songName:(id)arg2 giftID:(id)arg3 giftCount:(id)arg4 isNewSong:(_Bool)arg5;
- (void)reportAudienceSongAction:(unsigned long long)arg1 songName:(id)arg2 isNewSong:(_Bool)arg3;
...
- (void)onAudienceCommentAction:(unsigned long long)arg1 jsonDict:(id)arg2;
...
- (void)onMicAction:(unsigned long long)arg1 userIdentity:(unsigned long long)arg2;
...
- (void)onQuitRoom:(unsigned long long)arg1 withLiveTask:(id)arg2;
...
- (void)onClickLike:(unsigned long long)arg1 isClipMode:(_Bool)arg2 doubleClickCount:(unsigned long long)arg3;
...
- (void)reportCommonAction:(unsigned long long)arg1 actionResultDict:(id)arg2;
