...
@interface WCEditImageLayoutView
{
    ...
    _Bool _keepImageWhenBack;
    _Bool _useInitialCropRect;
    ...
    MMAssetSelectCheckButton *_selectBtn;
    MMUIButton *_undoBtn;
    MMUIButton *_redoBtn;
    UIButton *_filterBtn;
    MMUIButton *_penBtn;
    ...
    MMUIButton *_cropBtn;
    MMUIButton *_aiBtn;
    MMUIButton *_removeBgBtn;
    MMUIButton *_nextBtn;
    EditImagePenToolAttrView *_penAttrBar;
    EditImageAiToolAttrView *_aiAttrBar;
    ...
    NSString *_cropSourceImgRef;
    NSMutableArray *_hasEmoticonCropEdit;
    ...
    struct CGRect _initialCropRectInImage;
...
@property(nonatomic) _Bool useInitialCropRect; // @synthesize useInitialCropRect=_useInitialCropRect;
@property(nonatomic) struct CGRect initialCropRectInImage; // @synthesize initialCropRectInImage=_initialCropRectInImage;
@property(nonatomic) _Bool keepImageWhenBack; // @synthesize keepImageWhenBack=_keepImageWhenBack;
@property(retain, nonatomic) NSMutableArray *hasEmoticonCropEdit; // @synthesize hasEmoticonCropEdit=_hasEmoticonCropEdit;
@property(retain, nonatomic) NSString *cropSourceImgRef; // @synthesize cropSourceImgRef=_cropSourceImgRef;
@property(retain, nonatomic) NSString *doneBtnTitleStr; // @synthesize doneBtnTitleStr=_doneBtnTitleStr;
...
@property(retain, nonatomic) UILabel *notEditLabel; // @synthesize notEditLabel=_notEditLabel;
...
@property(nonatomic) _Bool isLiteApp; // @synthesize isLiteApp=_isLiteApp;
...
@property(retain, nonatomic) EditImageAiToolAttrView *aiAttrBar; // @synthesize aiAttrBar=_aiAttrBar;
...
@property(retain, nonatomic) MMUIButton *removeBgBtn; // @synthesize removeBgBtn=_removeBgBtn;
@property(retain, nonatomic) MMUIButton *aiBtn; // @synthesize aiBtn=_aiBtn;
...
@property(retain, nonatomic) MMAssetSelectCheckButton *selectBtn; // @synthesize selectBtn=_selectBtn;
...
- (void)onReplaceEditPhotoPath:(id)arg1 videoPath:(id)arg2 templateId:(id)arg3;
...
- (struct CGRect)clampCropRectToImage:(struct CGRect)arg1;
