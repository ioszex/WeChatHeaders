...
@class FinderLiveDiscoverPreloadConfig, FinderNavLiveStreamPreloadControlConfig, NSData, NSMutableDictionary, _TtC6WeChat24WCFinderLiveHomePageKara, _TtC6WeChat27WCFinderLiveSessionFlowKara;
...
- (void)setLastDiscoverStyleInfo:(id)arg1;
- (id)lastDiscoverStyleInfo;
@property(nonatomic) _Bool lastIsColumnFollow;
