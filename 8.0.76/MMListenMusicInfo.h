...
@class MMListenMusicInfo_AIMusicMVInfo, MMListenMusicInfo_AINarrationInfo, MMListenMusicInfo_DescByAuthor, MMListenMusicInfo_GenerateMusicInfo, MMListenMusicInfo_GenreInfo, MMListenMusicInfo_UserShare, MMListenSingerInfo_JumpInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) MMListenMusicInfo_AIMusicMVInfo *aiMusicMvInfo; // @dynamic aiMusicMvInfo;
@property(retain, nonatomic) MMListenMusicInfo_AINarrationInfo *aiNarrationInfo; // @dynamic aiNarrationInfo;
...
@property(retain, nonatomic) MMListenMusicInfo_GenerateMusicInfo *generateMusicInfo; // @dynamic generateMusicInfo;
...
@property(nonatomic) _Bool isAiMusicMvGenerationEnabled; // @dynamic isAiMusicMvGenerationEnabled;
@property(nonatomic) _Bool isFromAi; // @dynamic isFromAi;
@property(nonatomic) _Bool isFromWechat; // @dynamic isFromWechat;
@property(nonatomic) _Bool isGenerateMusicInfo; // @dynamic isGenerateMusicInfo;
