...
- (void).cxx_destruct;
- (void)reportAnchorReplaySubscriptionComment:(unsigned long long)arg1;
- (void)reportAnchorReplaySubscriptionBanner:(unsigned long long)arg1 source:(unsigned long long)arg2;
- (void)reportAnchorReserveNextLiveNotification:(unsigned long long)arg1;
- (void)reportLiveAnchorOperationWithActionType:(unsigned long long)arg1 dict:(id)arg2 andTask:(id)arg3;
- (void)reportAnchorAiAssistantVoiceAction:(unsigned long long)arg1 msgId:(id)arg2 sessionId:(id)arg3 extra:(id)arg4;
- (void)reportAnchorAiAssistantVoiceAction:(unsigned long long)arg1 info:(id)arg2 extra:(id)arg3;
- (void)reportAnchorAiAssistantInfoReceive:(id)arg1 receiveTime:(unsigned long long)arg2 channelType:(unsigned long long)arg3;
...
- (void)onReportClaritySettingActionWithSource:(unsigned long long)arg1 definition:(unsigned long long)arg2;
...
- (void)onAnchorModifyLiveModeAction:(unsigned long long)arg1 extraInfo:(id)arg2;
...
- (void)reportExchangCameraIsFront:(_Bool)arg1 source:(unsigned long long)arg2;
...
- (void)onAnchorExchangeCameraIsFront:(_Bool)arg1 source:(unsigned long long)arg2;
