...
+ (long long)maxImageCountForScene:(unsigned long long)arg1;
- (void).cxx_destruct;
...
- (void)handleSendAssetWithInfos:(id)arg1 picker:(id)arg2;
- (void)checkBigFileTransferWithInfos:(id)arg1 picker:(id)arg2;
