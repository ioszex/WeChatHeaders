...
- (void)prepareSnapshotForFavoriteDualWriteIfNeeded:(MinimizeTaskData *)arg1;
...
- (void)onMinimizedTaskItemDisappear:(MinimizeTaskData *)arg1;
- (void)onMinimizedTaskItemExposed:(MinimizeTaskData *)arg1;
- (_Bool)shouldInterceptRemoveByCloseButton:(MinimizeTaskData *)arg1;
