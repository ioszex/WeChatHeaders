...
+ (void)notifyChatBotAmoebaMiniAppTakeOverWinEvent:(NSString *)arg1 eventId:(NSString *)arg2 sessionId:(NSString *)arg3 appId:(NSString *)arg4 winExitType:(long long)arg5;
+ (void)notifyChatBotAmoebaMiniAppInterruptWithType:(long long)arg1 sessionId:(NSString *)arg2 appId:(NSString *)arg3;
