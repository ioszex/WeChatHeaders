...
- (void)report24656CheckValidFavWithFavId:(unsigned int)arg1 ret:(int)arg2 message:(id)arg3;
- (void)report34070NoteErrorWithNoteId:(id)arg1 ErrCode:(int)arg2 ErrMsg:(id)arg3 SessionId:(id)arg4 IsEditable:(_Bool)arg5 SubErrCode:(int)arg6 HtmlPathInfo:(id)arg7;
- (void)report34070FlutterNoteErrorNoteId:(id)arg1 ErrCode:(int)arg2 ErrMsg:(id)arg3 SessionId:(id)arg4 IsEditable:(_Bool)arg5;
- (void)reportViewClick:(int)arg1 item:(id)arg2;
...
- (void)reportWeNote32080:(unsigned int)arg1 editable:(_Bool)arg2 favId:(unsigned int)arg3 paragraphCount:(unsigned long long)arg4;
...
- (void)reportSearchResultClick:(id)arg1 favItem:(id)arg2 queryId:(id)arg3 queryWord:(id)arg4 resMethod:(long long)arg5 originIndex:(long long)arg6 filteredIndex:(long long)arg7;
- (void)reportSearchReturn:(id)arg1 resultCount:(long long)arg2 queryId:(id)arg3 queryWord:(id)arg4 resMethod:(long long)arg5;
- (void)reportSearchInputAction:(_Bool)arg1 sessionId:(id)arg2;
- (void)reportTotalFilterAction:(_Bool)arg1 tabType:(long long)arg2 tabName:(id)arg3 sessionId:(id)arg4;
- (void)reportQuickFilterAction:(_Bool)arg1 tabType:(long long)arg2 tabName:(id)arg3 sessionId:(id)arg4;
- (void)reportFilterUnfoldAction:(_Bool)arg1 sessionId:(id)arg2;
- (void)reportFavSuccTips:(_Bool)arg1 favItem:(id)arg2;
- (long long)getGeneralMsgTypeInFavoritesItem:(id)arg1 dataField:(id)arg2;
...
- (void)report17105:(id)arg1 DeletType:(int)arg2 PageType:(int)arg3 ContainRecord:(_Bool)arg4 ShowContext:(_Bool)arg5 IsSearchResult:(_Bool)arg6 SearchListIndex:(unsigned int)arg7 FavListIndex:(unsigned int)arg8 dataChildField:(id)arg9;
- (void)report17105:(id)arg1 DeletType:(int)arg2 PageType:(int)arg3 ContainRecord:(_Bool)arg4 ShowContext:(_Bool)arg5 IsSearchResult:(_Bool)arg6 SearchListIndex:(unsigned int)arg7 FavListIndex:(unsigned int)arg8;
- (void)report17105:(id)arg1 DeletType:(int)arg2 PageType:(int)arg3 ContainRecord:(_Bool)arg4 ShowContext:(_Bool)arg5;
- (void)report10651WithFavItem:(id)arg1 DataWrap:(id)arg2 toContact:(id)arg3 toFriend:(_Bool)arg4 isFromSession:(_Bool)arg5 IsSearchResult:(_Bool)arg6 SearchListIndex:(unsigned int)arg7 FavListIndex:(unsigned int)arg8;
...
- (void)report14103:(unsigned long long)arg1 favTopCount:(unsigned long long)arg2 favFoldStatus:(unsigned long long)arg3;
