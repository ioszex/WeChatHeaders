...
- (id)getAppId;
- (void)succes:(id)arg1;
- (void)fail:(id)arg1 data:(id)arg2;
- (void)fail:(id)arg1;
- (void)succes:(id)arg1 keepAlive:(_Bool)arg2;
- (void)fail:(id)arg1 data:(id)arg2 keepAlive:(_Bool)arg3;
- (void)fail:(id)arg1 keepAlive:(_Bool)arg2;
- (void)jsApiCallback:(const void *)arg1 keepAlive:(_Bool)arg2;
- (id)initWithParam:(id)arg1 appPtr:(unsigned long long)arg2 pageId:(unsigned long long)arg3 appUuid:(unsigned int)arg4 apiName:(id)arg5 callbackId:(long long)arg6 localId:(unsigned int)arg7 sourceType:(int)arg8;
