...
@class BaseMessageViewModel, BrandPluginTemplateMsgReportModel, BrandTemplateMsgAuthMessageBubbleModel, CBaseContact, CContact, CEmoticonWrap, CMessageWrap, ChatTimeNodeRightButtonInfo, LinkBizSchemeWrap, LinkWeAppJumpWrap, MMMusicInfo, MMRichTextCoverView, MMUIViewController, MsgMediaGroupCellModel, MsgMediaGroupView, NSArray, NSDictionary, NSMutableDictionary, NSString, PatWrap, PushMailWrap, ReaderMessageFolderViewModel, ReaderMessageTemplateMsgFolderViewModel, RevokeWrap, TemplateMsgFoldReportItem, TemplateReaderMessageFolderViewModel, TranslateInfo, WAAgentSceneInstanceHandle;

@protocol MessageNodeViewDelegate <NSObject>

@optional
- (void)onMediaGroupRevokeAll:(MsgMediaGroupCellModel *)arg1;
- (void)onMediaGroupFavAll:(MsgMediaGroupCellModel *)arg1;
- (void)onMediaGroupDeleteAll:(MsgMediaGroupCellModel *)arg1;
- (void)onMediaGroupSaveAll:(MsgMediaGroupCellModel *)arg1;
- (void)onMediaGroupSelectAll:(CMessageWrap *)arg1;
- (void)onMediaGroupFold:(CMessageWrap *)arg1;
- (void)onMediaGroupExpand:(MsgMediaGroupCellModel *)arg1 mediaGroupView:(MsgMediaGroupView *)arg2;
- (void)onMediaGroupCheck:(CMessageWrap *)arg1 videoBeginTime:(double)arg2;
- (void)reportBrandPluginTemplateMsg:(BaseMessageViewModel *)arg1 reportModel:(BrandPluginTemplateMsgReportModel *)arg2;
...
- (_Bool)isSpeakingTranslateText:(CMessageWrap *)arg1;
- (void)onStopSpeakTranslateTextWithEndType:(long long)arg1;
- (void)onStopSpeakTranslateText;
- (void)onSpeakTranslateText:(CMessageWrap *)arg1 text:(NSString *)arg2 language:(NSString *)arg3;
- (unsigned int)currentSpeakIndex;
- (_Bool)isSpeakingText:(CMessageWrap *)arg1;
- (unsigned int)getSessionId;
- (void)reloadMessages;
- (void)onClickFoldHistoryMsgBtn;
- (void)onYuanBaoSummary:(CMessageWrap *)arg1 itemType:(long long)arg2 reportParams:(NSMutableDictionary *)arg3;
...
- (void)onClickTransferDetailSystemMsg:(NSString *)arg1 nativeUrl:(NSString *)arg2;
...
- (void)onReaderTemplateMsgFolderCellReport:(CMessageWrap *)arg1 reportItem:(TemplateMsgFoldReportItem *)arg2;
- (void)onReaderTemplateMsgFolderCellDidClick:(ReaderMessageTemplateMsgFolderViewModel *)arg1;
...
- (void)onAddNote:(CMessageWrap *)arg1;
...
- (void)onSpeakMsg:(CMessageWrap *)arg1;
- (void)onMinimizePlay:(CMessageWrap *)arg1;
...
- (void)onClickForwardMenu:(CMessageWrap *)arg1;
...
- (void)scheduleOnUrl:(NSString *)arg1 content:(NSString *)arg2;
- (void)scheduleOnMsg:(CMessageWrap *)arg1;
- (void)clickNewAASysMsg:(NSString *)arg1 withMsgLocalID:(unsigned int)arg2;
- (void)shareMsgToThirdPartyServiceByNodeView:(CMessageWrap *)arg1;
...
- (void)willShowMenuController:(id)arg1 inMsgWrap:(CMessageWrap *)arg2 menuSourceType:(int)arg3 buttonList:(NSString *)arg4;
...
- (void)onClickUnFoldRevokeWrap:(CMessageWrap *)arg1;
- (void)onClickRevokeWrapLink:(RevokeWrap *)arg1;
- (_Bool)isMsgCanRevoke:(CMessageWrap *)arg1;
- (void)batchRevokeMsgByNodeView:(CMessageWrap *)arg1 withReportInterval:(unsigned long long)arg2;
- (void)revokeMsgByNodeView:(CMessageWrap *)arg1;
- (void)scrollToMessage:(CMessageWrap *)arg1 highlight:(_Bool)arg2 marginTop:(double)arg3 animated:(_Bool)arg4;
- (void)locateToMsg:(CMessageWrap *)arg1;
- (void)switchEarMode:(CMessageWrap *)arg1;
- (void)jumpToUserProfile:(NSString *)arg1 Displayname:(NSString *)arg2 Scence:(unsigned int)arg3;
- (void)onHideKeyboard;
- (void)onMoreOperateWithMsg:(CMessageWrap *)arg1;
...
- (void)tagBizSchemeLink:(LinkBizSchemeWrap *)arg1 messageWrap:(CMessageWrap *)arg2;
...
- (void)BeginPlaying:(CMessageWrap *)arg1 fromTime:(unsigned int)arg2;
