...
@interface WCFImageManager
{
    ...
    NSObject<OS_dispatch_queue> *_queue1;
}

+ (id)globalIOQueue;
- (void).cxx_destruct;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *queue1; // @synthesize queue1=_queue1;
...
- (id)downloadImageWithMedia:(id)arg1 type:(long long)arg2 targetPath:(id)arg3 completion:(CDUnknownBlockType)arg4;
