...
+ (id)showBulletCommentViewControllerFromVC:(id)arg1 shouldShowSwitchButton:(_Bool)arg2 replyCommentInfo:(id)arg3 contentVM:(id)arg4;
...
+ (void)pushFinderAdPageViewControllerWithEncrytedObjectidTid:(id)arg1 nonceId:(id)arg2 currentNavController:(id)arg3 enterScene:(unsigned long long)arg4 customParam:(id)arg5 reportModel:(id)arg6 cardType:(int)arg7 commentScene:(int)arg8 requestScene:(unsigned long long)arg9 functionalParams:(id)arg10;
...
+ (void)presentPostFullScreenPreviewVCWithPostSession:(id)arg1 fromVC:(id)arg2 toolbarDisableConfig:(unsigned long long)arg3 isAuthorPerspective:(_Bool)arg4 commentScene:(int)arg5 showDeleteEntry:(_Bool)arg6;
...
+ (void)presentFriendLikeListVC:(id)arg1 fromVC:(id)arg2 highlightUsernames:(id)arg3 friendsLikeListDelegate:(id)arg4 showBackgroundMask:(_Bool)arg5;
...
+ (void)checkErrMsgModelFromErrorInfo:(id)arg1 errResponse:(id)arg2 withViewController:(id)arg3 targetErrorCode:(int)arg4;
+ (void)checkErrMsgModelFromErrorInfo:(id)arg1 errResponse:(id)arg2 targetErrorCode:(int)arg3;
...
+ (void)showFinderDiscoverEntranceInteractionGuideIfNeedFromVC:(id)arg1 scene:(unsigned long long)arg2 commentScene:(int)arg3 authorFinderUsername:(id)arg4 profileScreenType:(unsigned long long)arg5;
+ (void)showFinderDiscoverEntranceInteractionGuideIfNeedFromVC:(id)arg1 scene:(unsigned long long)arg2 commentScene:(int)arg3;
+ (void)_showFinderDiscoverEntranceInteractionGuideSnackBarFromVC:(id)arg1 reportParams:(id)arg2 reportCommentScene:(int)arg3;
+ (id)_discoverEntranceInteractionGuideReportParamsWithAuthorFinderUsername:(id)arg1 profileScreenType:(unsigned long long)arg2 scene:(unsigned long long)arg3 reportCommentScene:(int)arg4;
+ (void)_pushDiscoverEntranceSettingFromVC:(id)arg1;
+ (void)_openFinderDiscoverEntranceByInteractionGuide;
+ (_Bool)_canShowFinderDiscoverEntranceInteractionGuide;
+ (void)openAuthorProfileWithUsername:(id)arg1 navigationController:(id)arg2 fromViewController:(id)arg3;
