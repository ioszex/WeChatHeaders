...
@class FTSAiHistoryMgr, FTSContactMgr, FTSDB, FTSFavMgr, FTSFinderLocalSearchMgr, FTSGlobalStat, FTSIndexEngine, FTSIntelligentMessageMgr, FTSKFContactLocalSearchMgr, FTSMemorySearchMgr, FTSMessageMgr, FTSMinimizeTaskLocalSearchMgr, FTSReportMgr, FTSSettingSearchMgr, FTSTopHitMgr, FTSWeShopMgr, FTSWebSearchMgr, LocalSearchDynamicConfig, MCSBrandContactMgr, NSMutableSet, NSString, WALocalSearchMgr, WCSearchGroupTrainingMgr, WebSearchRedotMgr;
...
@interface FTSFacade
{
    ...
    FTSMinimizeTaskLocalSearchMgr *_minimizeTaskLocalSearchMgr;
    NSMutableSet *_imageCacheUrlSet;
    _Bool _isOpenWeAppSearch;
    _Bool _isOpenWeShopSearch;
    _Bool _isOpenSettingSearch;
    _Bool _hasReportNoRedotExposeForSearch;
    _Bool _useAPITestLocalH5;
    _Bool _isOpenAiHistorySearchVar;
    ...
    FTSWeShopMgr *_ftsWeShopMgr;
    FTSSettingSearchMgr *_ftsSettingSearchMgr;
    FTSAiHistoryMgr *_ftsAiHistoryMgr;
    FTSIndexEngine *_ftsIndexEngine;
    NSString *_localSearchId;
    long long _i64LocalSessionId;
    long long _i64LocalSearchId;
    long long _i64LocalDetailSearchId;
    long long _i64LocalSubSearchId;
    LocalSearchDynamicConfig *_dynConfig;
}

+ (_Bool)isVoiceTransMsgSearchEnabled;
- (void).cxx_destruct;
@property(nonatomic) _Bool isOpenAiHistorySearchVar; // @synthesize isOpenAiHistorySearchVar=_isOpenAiHistorySearchVar;
...
@property(readonly, nonatomic) long long i64LocalDetailSearchId; // @synthesize i64LocalDetailSearchId=_i64LocalDetailSearchId;
...
@property(retain, nonatomic) FTSAiHistoryMgr *ftsAiHistoryMgr; // @synthesize ftsAiHistoryMgr=_ftsAiHistoryMgr;
@property(retain, nonatomic) FTSSettingSearchMgr *ftsSettingSearchMgr; // @synthesize ftsSettingSearchMgr=_ftsSettingSearchMgr;
@property(retain, nonatomic) FTSWeShopMgr *ftsWeShopMgr; // @synthesize ftsWeShopMgr=_ftsWeShopMgr;
@property(retain, nonatomic) FTSMinimizeTaskLocalSearchMgr *minimizeTaskLocalSearchMgr; // @synthesize minimizeTaskLocalSearchMgr=_minimizeTaskLocalSearchMgr;
...
- (void)onEndFtsSearch;
- (void)onViewPop;
- (void)onRecoverAiHistoryDB;
- (void)onRecoverWeShopDB;
- (void)onRecoverContactDB;
- (void)onRecoverFavDB;
- (void)debugTryRecoverMsgIndex;
- (void)clearIntelligentMsgIndex;
- (void)onRecoverMsgIndex;
- (void)onRecoverMsgDB;
- (void)onRecoverFTSDB;
- (void)OnDelMsg:(id)arg1 DelAll:(_Bool)arg2;
- (_Bool)isOpenAiHistorySearch;
- (_Bool)isOpenSettingSearch;
- (_Bool)isOpenWeShopSearch;
