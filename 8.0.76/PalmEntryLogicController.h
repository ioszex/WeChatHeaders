...
@property(retain, nonatomic) NSMutableArray *successAvRecorders; // @synthesize successAvRecorders=_successAvRecorders;
...
- (_Bool)setupPalmRegister:(id)arg1;
- (_Bool)checkPalmModel;
- (_Bool)initPalmRegister:(id)arg1;
- (id)init;
