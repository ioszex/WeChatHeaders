...
@property(copy, nonatomic) NSString *audioSessionMode; // @synthesize audioSessionMode=_audioSessionMode;
...
- (void)notifyFrameRecordData:(id)arg1 isLastFrame:(_Bool)arg2;
- (void)notifyStateChange:(unsigned long long)arg1 error:(id)arg2;
