...
@class NSArray, NSNumber, NSString, WCFinderContact, WCFinderRedDotCtrlInfo, WCFinderRedDotTipsShowInfo;

@interface WCFinderNotifyCenterTabPageVC
{
    _Bool _showMentionSwitchEntry;
    WCFinderRedDotTipsShowInfo *_rightEntryRedDotShowInfo;
    NSNumber *_selectTabType;
...
@property(retain, nonatomic) NSNumber *selectTabType; // @synthesize selectTabType=_selectTabType;
...
- (void)notifyCenterUnitVC:(id)arg1 didUpdateRedDotUnreadCount:(unsigned long long)arg2 forTabType:(unsigned long long)arg3;
