...
@class MMFinderLiveAnchorHeaderEcInfoView, MMFinderLiveAnniversaryDecorationViewModel, MMFinderLiveClarityHeaderButton, MMFinderLiveFansGroupSignView, MMFinderLiveHeaderFollowButton, MMFinderLiveMusicHeaderButton, MMFinderLiveTask, MMLiveSyndicateMembers, MMUIButton, MMUIImageView, MMUILabel, MMWebImageView, NSString, PAGView, UIView, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView, WCLiveBlurButton;
...
@interface MMFinderLiveHeaderView
{
    ...
    MMFinderLiveAnchorHeaderEcInfoView *_anchorHeaderEcInfoView;
    CDUnknownBlockType _shopInfoSheetInvoker;
    UIView *_identityViewsContainerView;
    UIView *_actionViewsContainerView;
...
@property(retain, nonatomic) UIView *actionViewsContainerView; // @synthesize actionViewsContainerView=_actionViewsContainerView;
@property(retain, nonatomic) UIView *identityViewsContainerView; // @synthesize identityViewsContainerView=_identityViewsContainerView;
@property(copy, nonatomic) CDUnknownBlockType shopInfoSheetInvoker; // @synthesize shopInfoSheetInvoker=_shopInfoSheetInvoker;
@property(retain, nonatomic) MMFinderLiveAnchorHeaderEcInfoView *anchorHeaderEcInfoView; // @synthesize anchorHeaderEcInfoView=_anchorHeaderEcInfoView;
...
- (void)onLiveSyndicateMembersUpdated:(id)arg1;
...
- (void)configureComponentsForOperationUiMode:(unsigned long long)arg1;
...
- (_Bool)hasSubtitles;
- (id)subtitle;
- (struct CGSize)anchorNameLabelWidthWithText:(id)arg1;
...
- (void)layoutAnchorHeaderEcInfoView;
- (void)updateAnchorHeaderEcMarquee:(id)arg1;
- (void)updateAnchorHeaderEcInfo:(id)arg1;
