...
@class AVVideoDevice, CContact, CMessageWrap, NSMutableArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, VOIPVideoRender, VoIPInviteMemberReportStruct, VoIPNotificationContentInfo, VoIPRenderData, XImageContext, XImageViewRenderer;
...
@interface VoIPilinkMgr
{
    ...
    _Bool _joinToRoom;
    _Bool _isSpeakerOn;
    _Bool _remoteSupportLandscapeMode;
    _Bool _remoteSupportNewScreenProject;
    _Bool _isRemoteLandscapeMode;
    _Bool _acceptNewCall;
    _Bool _isLocalCaptureSuspended;
    _Bool _remoteSupportAdaptiveRotate;
    ...
    _Bool _isCallKit;
    _Bool _isLocalRendered;
    _Bool _isRemoteRendered;
    ...
    int _netSpeed;
    unsigned int _mRaisrCapacity;
    unsigned int _mRaisrStrength;
    int _mRaisrIPhoneVersion;
    int _mRaisrIPadVersion;
    unsigned int _nextEnableTimeForCreateRoom;
    int _notificationPushType;
    ...
    unsigned long long _modeActionStatus;
    ...
    unsigned long long _mStartAcceptTime;
    ...
    VoIPNotificationContentInfo *_notificationContentInfo;
    ...
    unsigned long long _localCaptureUnactiveCount;
    unsigned long long _localFrameDiscardCount;
    NSMutableSet *_localViewRendererSet;
    VoIPRenderData *_lastRenderData;
    VoIPRenderData *_lastRemoteRenderData;
    VoIPInviteMemberReportStruct *_inviteMemberReportStruct;
    struct CGSize _lastLocalImageSize;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) VoIPInviteMemberReportStruct *inviteMemberReportStruct; // @synthesize inviteMemberReportStruct=_inviteMemberReportStruct;
@property(retain) VoIPRenderData *lastRemoteRenderData; // @synthesize lastRemoteRenderData=_lastRemoteRenderData;
@property(retain) VoIPRenderData *lastRenderData; // @synthesize lastRenderData=_lastRenderData;
@property(retain) NSMutableSet *localViewRendererSet; // @synthesize localViewRendererSet=_localViewRendererSet;
@property(nonatomic) unsigned long long localFrameDiscardCount; // @synthesize localFrameDiscardCount=_localFrameDiscardCount;
@property(nonatomic) struct CGSize lastLocalImageSize; // @synthesize lastLocalImageSize=_lastLocalImageSize;
@property(nonatomic) unsigned long long localCaptureUnactiveCount; // @synthesize localCaptureUnactiveCount=_localCaptureUnactiveCount;
@property(nonatomic) _Bool isJoinedRoom; // @synthesize isJoinedRoom=_isJoinedRoom;
@property(nonatomic) _Bool hangupByCall; // @synthesize hangupByCall=_hangupByCall;
@property(nonatomic) _Bool startedSecondPart; // @synthesize startedSecondPart=_startedSecondPart;
...
@property(nonatomic) _Bool isRemoteRendered; // @synthesize isRemoteRendered=_isRemoteRendered;
@property(nonatomic) _Bool isLocalRendered; // @synthesize isLocalRendered=_isLocalRendered;
@property(nonatomic) _Bool isCallKit; // @synthesize isCallKit=_isCallKit;
@property(nonatomic) int notificationPushType; // @synthesize notificationPushType=_notificationPushType;
@property(retain, nonatomic) VoIPNotificationContentInfo *notificationContentInfo; // @synthesize notificationContentInfo=_notificationContentInfo;
...
@property(nonatomic) int mRaisrIPadVersion; // @synthesize mRaisrIPadVersion=_mRaisrIPadVersion;
@property(nonatomic) int mRaisrIPhoneVersion; // @synthesize mRaisrIPhoneVersion=_mRaisrIPhoneVersion;
@property(nonatomic) unsigned int mRaisrStrength; // @synthesize mRaisrStrength=_mRaisrStrength;
@property(nonatomic) unsigned int mRaisrCapacity; // @synthesize mRaisrCapacity=_mRaisrCapacity;
...
@property(nonatomic) unsigned long long mStartAcceptTime; // @synthesize mStartAcceptTime=_mStartAcceptTime;
@property(nonatomic) unsigned long long mStartTalkingTime; // @synthesize mStartTalkingTime=_mStartTalkingTime;
@property(nonatomic) _Bool remoteSupportAdaptiveRotate; // @synthesize remoteSupportAdaptiveRotate=_remoteSupportAdaptiveRotate;
@property(retain) NSString *remoteSourceDevice; // @synthesize remoteSourceDevice=_remoteSourceDevice;
...
@property(nonatomic) unsigned long long modeActionStatus; // @synthesize modeActionStatus=_modeActionStatus;
@property(nonatomic) __weak id <IlinkMultiTalkDelegate> multiTalkDelegate; // @synthesize multiTalkDelegate=_multiTalkDelegate;
@property(nonatomic) _Bool isRemoteLandscapeMode; // @synthesize isRemoteLandscapeMode=_isRemoteLandscapeMode;
...
@property(nonatomic) _Bool remoteSupportLandscapeMode; // @synthesize remoteSupportLandscapeMode=_remoteSupportLandscapeMode;
...
- (void)reportClickInviteMemberConfirmBtnWithMemberList:(id)arg1;
- (void)reportClickInviteMemberNextBtnWithMemberList:(id)arg1;
- (void)reportInviteMemberPageIn;
- (void)reportClickInviteMemberfailWithType:(int)arg1;
- (void)reportClickInviteMemberWithReportStruct:(id)arg1;
...
- (void)notifyReceiverCanStart:(_Bool)arg1;
...
- (void)onStartRecvInvite:(id)arg1 inviteMsg:(id)arg2;
- (void)onStartRecvInvite:(id)arg1 muteNotification:(_Bool)arg2;
...
- (void)onAcceptSubCallMultiTalk:(id)arg1;
...
- (void)sendIfCanSupportAddMembers:(_Bool)arg1 sendToMemberId:(int)arg2;
- (void)sendRemoteClientInfo:(int)arg1;
- (void)sendRemoteSourceDevice:(int)arg1;
- (void)sendWxVersion:(int)arg1;
- (void)joinRoomWithRoomID:(unsigned long long)arg1 contact:(id)arg2;
- (void)accept:(unsigned long long)arg1;
- (void)rejectWithRoomID:(unsigned long long)arg1;
- (void)hangupWithRoomID:(unsigned long long)arg1;
- (void)hangup;
- (void)hangupWithVoIPShutdownReason:(int)arg1 ifIsConnect:(_Bool)arg2;
- (void)hangupWithVoIPCancelType:(int)arg1;
- (void)receiveVoIPMTCancelInviteForIlink:(id)arg1 username:(id)arg2 groupId:(id)arg3 receiveMsgTime:(unsigned int)arg4 roomID:(unsigned long long)arg5 notifyFrom:(int)arg6;
...
- (void)receiveVoIPMTMessageForIlink:(id)arg1 username:(id)arg2 MsgWrap:(id)arg3 notifyFrom:(int)arg4;
- (void)receiveVoIPMTMessageForIlink:(id)arg1 username:(id)arg2 receiveMsgTime:(unsigned int)arg3 notifyFrom:(int)arg4;
- (void)RealCall:(id)arg1 isAudioMode:(_Bool)arg2 withCallType:(unsigned int)arg3;
- (_Bool)ilinkOpenWindowWithContact:(id)arg1 msgWrap:(id)arg2 isCaller:(_Bool)arg3 from:(unsigned long long)arg4 startInApp:(_Bool)arg5 isEarMode:(_Bool)arg6 isAudioMode:(_Bool)arg7;
...
- (void)onMultiTalkVCHangupWithGroup:(id)arg1 isClickHangup:(_Bool)arg2 isMeExitLatest:(_Bool)arg3;
- (void)onIlinkChangeToMultiTalk:(id)arg1;
- (void)onDidSelectNormalContact:(id)arg1;
- (void)tryAddMembersForIlink:(id)arg1;
- (void)makeMonoMsg:(unsigned long long)arg1 usrName:(id)arg2 msgType:(unsigned int)arg3;
...
- (void)setupInviteId;
- (void)renderLastFrameToRemoteRenderer:(id)arg1;
- (void)renderLastFrameToLocalRenderer:(id)arg1;
- (void)unregisterLocalViewRenderer:(id)arg1;
- (void)registerLocalViewRenderer:(id)arg1;
- (id)localViewRendererArray;
- (void)resetRemoteViewRenderers;
- (void)resetLocalViewRenderers;
