...
@interface MMFinderLiveTableStyleCommentPubbleUserCell
{
    ...
    MMHeadImageView *_chatRoomHeadImageView;
...
@property(retain, nonatomic) MMHeadImageView *chatRoomHeadImageView; // @synthesize chatRoomHeadImageView=_chatRoomHeadImageView;
...
- (_Bool)isPubbleCellTapActionNeedShowKtvSongPanel:(id)arg1;
...
- (void)updateChatRoomHeadImageOrigin;
...
- (void)layoutChatRoomHeadImageView;
