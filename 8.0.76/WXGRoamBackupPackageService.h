...
@interface WXGRoamBackupPackageService
{
    ...
    NSMutableDictionary *_bindCallbackDict;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *bindCallbackDict; // @synthesize bindCallbackDict=_bindCallbackDict;
...
- (void)compressMedia;
- (void)downloadFromCdnSync:(id)arg1 fileId:(id)arg2 fileType:(int)arg3 savePath:(id)arg4 aesKey:(id)arg5;
...
- (void)jumpWeAppDeviceDetailFromCurrentDetail:(id)arg1;
- (_Bool)useDebugWeApp;
