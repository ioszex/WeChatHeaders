...
@interface MMLanguageCache : NSObject
{
    ...
    NSString *_brandLemmaTableMd5;
}

+ (id)getLanguageCache;
+ (void)initialize;
+ (void)PBArrayAdd_brandLemmaTableMd5;
...
- (void).cxx_destruct;
@property(copy, nonatomic) NSString *brandLemmaTableMd5; // @synthesize brandLemmaTableMd5=_brandLemmaTableMd5;
