...
@property(nonatomic) unsigned long long forwardCnt; // @dynamic forwardCnt;
...
@property(retain, nonatomic) FinderLiveHighlightSummaryInfo *highlightSummaryInfo; // @dynamic highlightSummaryInfo;
...
@property(nonatomic) _Bool liveCardDisableAutoPlay; // @dynamic liveCardDisableAutoPlay;
...
@property(retain, nonatomic) FinderLiveMicRecommendInfo *micRecommendInfo; // @dynamic micRecommendInfo;
...
@property(retain, nonatomic) FinderLiveAnchorCloseLiveThankGuide *thankGuide; // @dynamic thankGuide;
