...
@interface WeixinContactInfoAssist
{
    ...
    UIImageView *m_blackListTipsIconView;
...
- (void)doSendVerifyOrAddContact;
- (_Bool)tryAddContactByPreFetchVerifyTicket;
- (void)onAddToContacts;
- (id)navigationBarItemColor;
- (void)showRightButton;
- (void)updateFooterViewHeightForContentIfNeeded;
...
- (void)getContactFromServerWithTicket:(id)arg1 errCode:(int)arg2 fromScene:(unsigned int)arg3;
- (void)tryFetchContactWithVerifyTicket:(CDUnknownBlockType)arg1;
