...
@property(retain, nonatomic) NSString *expectAnchorFinderUsername; // @dynamic expectAnchorFinderUsername;
...
@property(nonatomic) unsigned int isKeepAliveReq; // @dynamic isKeepAliveReq;
@property(nonatomic) _Bool isUserGpsAuthorized; // @dynamic isUserGpsAuthorized;
...
@property(nonatomic) unsigned int mixedFlow; // @dynamic mixedFlow;
...
@property(retain, nonatomic) NSData *outRoomRealnameLikeInfo; // @dynamic outRoomRealnameLikeInfo;
