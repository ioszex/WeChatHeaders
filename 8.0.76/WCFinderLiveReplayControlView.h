...
@class MISSING_TYPE, MMFinderLiveReplaySeekTimeView, MMFinderLiveReplayTask, MMFinderLiveTaskId, MMUIButton, NSDictionary, NSString, UIView, WCFinderLiveReplayPreviewContainer, WCFinderLiveReplayProgressBar;
...
@interface WCFinderLiveReplayControlView
{
    ...
    MISSING_TYPE *_previewContainer;
