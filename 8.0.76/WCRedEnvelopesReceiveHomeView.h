...
@class ContactUpdateHelper, HongbaoReceiveHomeViewAbtestObject, MMEmoticonView, MMWebImageView, NSDictionary, NSString, UIButton, UIImageView, UIView, WCPayWebImageView, WCPayWebPagView, WCRedEnvelopesControlData, WCRedEnvelopesReceiveHomePromotionView;
...
@interface WCRedEnvelopesReceiveHomeView
{
    ...
    HongbaoReceiveHomeViewAbtestObject *_abtestObject;
    WCPayWebPagView *_fullScreenAtmospherePagView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCPayWebPagView *fullScreenAtmospherePagView; // @synthesize fullScreenAtmospherePagView=_fullScreenAtmospherePagView;
@property(nonatomic) unsigned int enterTimestamp; // @synthesize enterTimestamp=_enterTimestamp;
@property(retain, nonatomic) HongbaoReceiveHomeViewAbtestObject *abtestObject; // @synthesize abtestObject=_abtestObject;
...
- (_Bool)shouldShowFullScreentAtmospherePagView;
- (double)getTopCurveBottomY;
- (void)onLoadWCPayWebPagOK:(id)arg1;
- (id)createCoverWidgetPlusImageViewWithData:(id)arg1;
- (void)setupCoverWidgetPlusViewInBackgroundWithData:(id)arg1;
- (_Bool)hasPagSkinWidget;
- (_Bool)hasSkinWidget;
- (_Bool)hasCoverWidgetPlus;
