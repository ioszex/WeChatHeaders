...
+ (void)reportNextLiveNoticeOperation:(long long)arg1 username:(id)arg2 withCommentScene:(id)arg3;
...
+ (void)reportNoticeOperationWithSourceScene:(long long)arg1 username:(id)arg2 action:(long long)arg3 commentScene:(id)arg4;
...
+ (void)reportNoticeOperation:(long long)arg1 withUsername:(id)arg2 withLiveId:(unsigned long long)arg3 withLiveStatus:(unsigned int)arg4 withCommentScene:(id)arg5 withForceNoticeInfo:(id)arg6 withNoticeContent:(id)arg7 chnlExtraDic:(id)arg8;
- (void).cxx_destruct;
