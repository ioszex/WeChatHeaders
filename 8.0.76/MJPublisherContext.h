...
@property(retain, nonatomic) NSData *selectedEffectSessionBuffer; // @synthesize selectedEffectSessionBuffer=_selectedEffectSessionBuffer;
...
@property(retain, nonatomic) NSString *fromFeedSessionBuffer; // @synthesize fromFeedSessionBuffer=_fromFeedSessionBuffer;
@property(retain, nonatomic) NSString *clickTemplateTaskID; // @synthesize clickTemplateTaskID=_clickTemplateTaskID;
