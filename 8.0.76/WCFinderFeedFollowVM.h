...
@class FinderRelatedRecommendTips, FinderStreamLayoutInfo, NSArray, NSData, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderAbstractTask, WCFinderFeedLayoutContentVM, WCFinderFollowLiveOftenReadVM, WCFinderRedDotCtrlInfo;
...
@interface WCFinderFeedFollowVM
{
    ...
    WCFinderFollowLiveOftenReadVM *_liveOftenReadVM;
...
@property(retain, nonatomic) WCFinderFollowLiveOftenReadVM *liveOftenReadVM; // @synthesize liveOftenReadVM=_liveOftenReadVM;
...
- (void)dealloc;
- (void)applyOftenReadBarFromStream:(id)arg1;
- (id)init;
