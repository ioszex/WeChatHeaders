...
{
    _Bool _useDefaultFont;
    NSString *_systemDefaultFontName;
    NSString *_fontName;
...
- (struct TMSize)calcTextSize:(unsigned short *)arg1 count:(int)arg2 fontSize:(int)arg3 weight:(int)arg4;
- (id)drawStringImage:(id)arg1 fontSize:(double)arg2 color:(id)arg3 strokeColor:(id)arg4 strokeWidth:(double)arg5;
- (void)drawString:(struct TMBitmapContext *)arg1 text:(unsigned short *)arg2 count:(int)arg3 fontSize:(int)arg4 weight:(int)arg5 density:(float)arg6;
- (id)getFontNameFromWeight:(int)arg1;
