...
@property(nonatomic) _Bool isServiceInit; // @synthesize isServiceInit=_isServiceInit;
...
- (void)checkServiceKeepRunning:(_Bool)arg1;
- (void)onBoxEnableFinderBoxChanged:(_Bool)arg1;
...
- (void)updateFinderBoxConfig:(id)arg1;
