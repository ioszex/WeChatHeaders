...
@property(nonatomic) _Bool isHardLinked; // @synthesize isHardLinked=_isHardLinked;
@property(nonatomic) _Bool isTmpHardLinked; // @synthesize isTmpHardLinked=_isTmpHardLinked;
