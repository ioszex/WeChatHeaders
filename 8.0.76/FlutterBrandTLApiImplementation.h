...
- (void)reportXiaoweiEntryEventEventId:(id)arg1 error:(id *)arg2;
...
- (void)onInitPersonalCenterWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)reportPersonalCenterAction:(long long)arg1 scene:(long long)arg2 redPointNum:(long long)arg3 biz:(id)arg4 hasSmallPoint:(_Bool)arg5 wording:(id)arg6 error:(id *)arg7;
...
- (void)gotoBizMeTabPageWithCompletion:(CDUnknownBlockType)arg1;
- (void)gotoBizPublishPageWithCompletion:(CDUnknownBlockType)arg1;
- (void)gotoBizAudioPageRecommendListBuffer:(id)arg1 sameAsLast:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)openXiaoweiSummaryHalfScreenSessionId:(id)arg1 error:(id *)arg2;
- (id)xiaowei_debugDescriptionForAskMsg:(id)arg1;
- (id)xiaowei_buildBizTimelineAskMsgWithMsgList:(const void *)arg1;
- (void)xiaowei_appendBizTimelineMsgItem:(const struct BizTimelineMsgItem *)arg1 toAskMsg:(id)arg2;
- (int)xiaowei_bizTimelineAskMsgTypeFromBizMsgType:(int)arg1;
