...
@class CAGradientLayer, MMFinderLiveActivityView, MMFinderLiveFeedHighlightTagView, MMLiveCDNPlayerView, MMUILabel, NSString, RichTextView, UIImageView, UILabel, UIScrollView, UIView, WCFinderAuthInfoIconView, WCFinderCoLiveAuthor, WCFinderDiscoveryNearbyLiveCollectionViewCellConfig, WCFinderFeedContentVM, WCFinderHeadImageView, WCFinderMoreLiveFriendLikeRecommendReasonView;
...
- (_Bool)isPlaying;
- (_Bool)showFriendLikeRecommendReason;
