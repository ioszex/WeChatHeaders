...
@class MMUIButton, MMUILabel, MiniTaskCollectioViewMaskLayer, MiniTaskCollectionSectionModel, MiniTaskCollectionViewLayout, MiniTaskDurantionCounter, MiniTaskDynamicBgView, MiniTaskPanGestureHandler, MiniTaskViewControllerContext, MinimizeTaskData, MultiTaskPageActionInfo, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIButton, UICollectionView, UIImageView, UIView, WCScheduleLogicController;
...
@interface MiniTaskViewController
{
    ...
    _Bool _isFinishLoad;
    _Bool _showingStarMigrationEducation;
    unsigned int _firstEntryMiniTaskTime;
    ...
    long long _loadDataOffset;
    NSMutableSet *_currTaskDataSet;
    UIView *_starMigrationEducationView;
...
@property(nonatomic) _Bool showingStarMigrationEducation; // @synthesize showingStarMigrationEducation=_showingStarMigrationEducation;
@property(retain, nonatomic) UIView *starMigrationEducationView; // @synthesize starMigrationEducationView=_starMigrationEducationView;
@property(retain, nonatomic) NSMutableSet *currTaskDataSet; // @synthesize currTaskDataSet=_currTaskDataSet;
@property(nonatomic) unsigned int firstEntryMiniTaskTime; // @synthesize firstEntryMiniTaskTime=_firstEntryMiniTaskTime;
@property(nonatomic) long long loadDataOffset; // @synthesize loadDataOffset=_loadDataOffset;
...
- (_Bool)removeTaskDataAtIndexPath:(id)arg1;
...
- (void)onUpdateMinimizedTaskDataOrder:(id)arg1;
- (void)onUpdateMinimizedTaskData:(id)arg1;
- (void)appendMinimizedTaskData:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)onStarMigrationDismissClicked;
- (void)onStarMigrationBrowseClicked;
- (void)setupStarMigrationEducationIfNeeded;
...
- (void)initMainUI;
- (void)appendDataWithArrTaskData:(id)arg1;
- (void)initData;
- (void)dealloc;
