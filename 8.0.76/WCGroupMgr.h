...
- (void)onSnsNotInterestBatchReturn:(id)arg1;
- (void)notifySnsNotInterestMemberOp:(unsigned int)arg1 success:(_Bool)arg2 group:(id)arg3;
- (id)updateLocalSnsNotInterestGroupWithMembers:(id)arg1 add:(_Bool)arg2;
- (_Bool)sendNextSnsNotInterestBatchWithContext:(id)arg1;
- (unsigned long long)snsNotInterestBatchLimit;
- (void)doSnsNotInterestMemberOp:(unsigned int)arg1 withMemberList:(id)arg2;
- (_Bool)shouldUseSnsNotInterestContactTypeForMembers:(id)arg1 groupID:(id)arg2;
