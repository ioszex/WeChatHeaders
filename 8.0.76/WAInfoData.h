...
@interface WAInfoData
{
    ...
    unsigned int _resourceDownloadFormat;
    unsigned int _resourceDownloadTransport;
    NSString *_appID;
    NSString *_username;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int resourceDownloadTransport; // @synthesize resourceDownloadTransport=_resourceDownloadTransport;
...
@property(nonatomic) unsigned int resourceDownloadFormat; // @synthesize resourceDownloadFormat=_resourceDownloadFormat;
...
@property(nonatomic) unsigned int packageCrc32; // @synthesize packageCrc32=_packageCrc32;
