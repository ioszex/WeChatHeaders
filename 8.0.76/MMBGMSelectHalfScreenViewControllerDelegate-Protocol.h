...
@class MMBGMSelectHalfScreenViewController, MMUIButton, NSIndexPath, NSString;
...
- (void)bgmSelectedViewControllerDidDismissLocalImportInteractedVideoPicker:(MMBGMSelectHalfScreenViewController *)arg1;
- (void)bgmSelectedViewController:(MMBGMSelectHalfScreenViewController *)arg1 prepareToPresentLocalImportInteractedVideoPickerWithCompletion:(void (^)(_Bool))arg2;
- (void)bgmSelectedViewControllerDidRequestLocalImportAlbumVideo:(MMBGMSelectHalfScreenViewController *)arg1;
- (unsigned long long)bgmSelectedViewControllerGetMaterialDuration:(MMBGMSelectHalfScreenViewController *)arg1;
...
- (void)bgmSelectedViewControllerWillStopPlayingVideo:(MMBGMSelectHalfScreenViewController *)arg1;
- (void)bgmSelectedViewControllerWillStartPlayingVideo:(MMBGMSelectHalfScreenViewController *)arg1;
...
- (void)bgmSelectedViewController:(MMBGMSelectHalfScreenViewController *)arg1 didClickVolumeBtn:(MMUIButton *)arg2;
...
- (void)bgmSelectedViewController:(MMBGMSelectHalfScreenViewController *)arg1 didEditMusic:(id <MMBGMSelectedMusicDataProtocol>)arg2 atTabIndex:(unsigned long long)arg3 index:(unsigned long long)arg4;
