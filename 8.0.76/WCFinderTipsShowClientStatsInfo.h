...
- (void).cxx_destruct;
@property(nonatomic) unsigned int showLine; // @synthesize showLine=_showLine;
...
- (long long)getLastExposeTimeIntervalBy:(unsigned long long)arg1;
