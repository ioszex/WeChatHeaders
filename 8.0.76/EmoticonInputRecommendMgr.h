...
@interface EmoticonInputRecommendMgr
{
    ...
    _Bool _enableSvrOrderStragy;
    _Bool _enableWordListUpdate;
    _Bool _shouldPauseBackgroundTask;
    _Bool _localEmojiRecommendSwitchValue;
...
@property(nonatomic) _Bool localEmojiRecommendSwitchValue; // @synthesize localEmojiRecommendSwitchValue=_localEmojiRecommendSwitchValue;
...
@property(nonatomic) _Bool enableSvrOrderStragy; // @synthesize enableSvrOrderStragy=_enableSvrOrderStragy;
...
- (id)getStoreEmotionPidList;
- (id)getSwitchStatus;
- (void)reportMeanings:(id)arg1 meanings:(id)arg2;
- (_Bool)shouldReportMeanings;
...
- (void)switchShowEmojiChatRecommendPrivacy:(_Bool)arg1 hasShown:(_Bool)arg2;
- (void)switchChatContextRecommendWithIsOpen:(_Bool)arg1;
- (void)switchPersonalizedRecommendWithIsOpen:(_Bool)arg1;
- (void)switchRemoteRecommendWithIsOpen:(_Bool)arg1;
- (_Bool)needShowEmojiChatRecommendPrivacy;
- (_Bool)needShowEmojiPrivacyPageSheet;
- (_Bool)hasShowEmojiChatRecommendPrivacy;
- (_Bool)hasShowEmojiPrivacyPageSheet;
- (_Bool)isChatContextRecommendSwithOpened;
- (_Bool)isRemoteRecommendSwithOpened;
- (_Bool)isRemoteRecommendSwithOpened:(_Bool)arg1;
