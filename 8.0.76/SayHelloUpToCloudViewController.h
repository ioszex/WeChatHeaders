...
@class MMUIButton, NSMutableSet, NSString, SayHelloUpToCloudDataLogic, SendVerifyMsgLogicController, WCTimeLineFooterView;
...
- (void)updateTableFooterFrame;
- (_Bool)canPerformTableViewHeightUpdate;
