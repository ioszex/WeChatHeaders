...
@interface WCAlbumPickViewModel : NSObject
{
    ...
    CDUnknownBlockType _didTapConfirmItemBlock;
...
@property(copy, nonatomic) CDUnknownBlockType didTapConfirmItemBlock; // @synthesize didTapConfirmItemBlock=_didTapConfirmItemBlock;
