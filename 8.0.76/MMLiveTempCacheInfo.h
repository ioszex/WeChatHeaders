...
@interface MMLiveTempCacheInfo : NSObject
{
    ...
    unsigned long long _createLivePrepareTimestamp;
...
@property(nonatomic) unsigned long long createLivePrepareTimestamp; // @synthesize createLivePrepareTimestamp=_createLivePrepareTimestamp;
