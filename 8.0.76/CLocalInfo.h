...
@interface CLocalInfo : NSObject
{
    ...
    NSData *_m_nsLastServerIndexBuffer;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_isNoPwdStatusDisable; // @synthesize m_isNoPwdStatusDisable=_m_isNoPwdStatusDisable;
...
@property(retain, nonatomic) NSData *m_nsLastServerIndexBuffer; // @synthesize m_nsLastServerIndexBuffer=_m_nsLastServerIndexBuffer;
