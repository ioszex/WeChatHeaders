...
@class CAGradientLayer, MMAudienceLiveLikePlayUtil, MMFinderLiveClockCountdownView, MMFinderLiveCommonOnlineMemberSheet, MMFinderLiveConnectMicAudioUserInfoView, MMFinderLiveConnectMicSeatNameLabel, MMFinderLiveConnectMicUser, MMFinderLiveConnectMicUserAnchorPkNotificationView, MMFinderLiveConnectMicUserPkHeatView, MMFinderLiveConnectMicVideoUserInfoView, MMFinderLiveLikeAudienceDataMgr, MMFinderLiveLotteryPacketDisplayLogic, MMFinderLiveRedPacketView, MMFinderLiveTaskId, MMLiveConnectMicHitTestAdjustView, MMLiveLikeAnimationUtil, MMLiveLikeButton, MMLiveMultipleTapGestureRecognizer, MMLiveRewardGiftNotificationContainerView, MMLiveStrokeLabel, MMLiveViewHiddenStatusContainer, MMUIButton, NSString, PAGView, UIImageView, UILabel, UITapGestureRecognizer;
...
@interface MMFinderLiveConnectMicVideoOperationView : UIView
{
    ...
    unsigned long long _currentMicLayoutMode;
    MMLiveConnectMicHitTestAdjustView *_bottomContainerView;
    CAGradientLayer *_bottomContainerBackgroundLayer;
    MMFinderLiveRedPacketView *_redPacketAnimationView;
    MMLiveConnectMicHitTestAdjustView *_audioUserContainerView;
...
@property(retain, nonatomic) MMLiveConnectMicHitTestAdjustView *audioUserContainerView; // @synthesize audioUserContainerView=_audioUserContainerView;
...
@property(retain, nonatomic) MMLiveConnectMicHitTestAdjustView *bottomContainerView; // @synthesize bottomContainerView=_bottomContainerView;
@property(nonatomic) unsigned long long currentMicLayoutMode; // @synthesize currentMicLayoutMode=_currentMicLayoutMode;
...
- (void)setGiftNotificationContainerView:(id)arg1;
- (id)giftNotificationContainerView;
...
- (double)currentLikeButtonSideLength;
- (long long)currentLikeButtonBusinessType;
- (void)layoutLikeRelatedUI;
- (double)likeButtonCenterY;
- (void)updateLikeButtonUserInteractionEnabled;
- (void)updateConnectMicDoubleClickLikeEnabled:(_Bool)arg1;
- (void)configLikeAnimationUtils;
- (void)realConfigLikeRelatedUtilsWithLiveFeedStreamTask:(id)arg1;
- (void)realConfigLikeRelatedUtilsWithLiveTask:(id)arg1;
