...
@interface WCClassifyMembersViewController
{
    ...
    _Bool m_useSnsNotInterestContactTypeResults;
    _Bool m_allMemberOperationsSuccess;
    WCGroup *m_latestMemberOperationGroup;
...
- (void)handleGroupMemberOperationReturnIfReady:(_Bool)arg1 group:(id)arg2;
- (_Bool)shouldUseSnsNotInterestContactTypeResults;
