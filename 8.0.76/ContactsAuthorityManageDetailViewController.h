...
@interface ContactsAuthorityManageDetailViewController
{
    ...
    CDUnknownBlockType _customReportPageInPageOutEvent;
    CDUnknownBlockType _afterClickAddBtn;
...
@property(copy, nonatomic) CDUnknownBlockType afterClickAddBtn; // @synthesize afterClickAddBtn=_afterClickAddBtn;
@property(copy, nonatomic) CDUnknownBlockType customReportPageInPageOutEvent; // @synthesize customReportPageInPageOutEvent=_customReportPageInPageOutEvent;
