...
@interface WCPayBizF2FTransferControlLogic
{
    ...
    _Bool _needCloseLoadingAfterJumpHKCashier;
    unsigned int;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool needCloseLoadingAfterJumpHKCashier; // @synthesize needCloseLoadingAfterJumpHKCashier=_needCloseLoadingAfterJumpHKCashier;
...
@property(retain, nonatomic) NSString *a8keyUrl; // @synthesize a8keyUrl=_a8keyUrl;
