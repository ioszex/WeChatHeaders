...
@interface WCEditVideoLayoutView
{
    ...
    _Bool _showTopAndBottomBarWithoutAnimate;
    _Bool _isCropOver;
    ...
    NSMutableDictionary *_snsSceneReportDict;
...
@property(retain, nonatomic) NSString *currentMusicId; // @synthesize currentMusicId=_currentMusicId;
@property(retain, nonatomic) NSMutableDictionary *snsSceneReportDict; // @synthesize snsSceneReportDict=_snsSceneReportDict;
@property(nonatomic) _Bool showTopAndBottomBarWithoutAnimate; // @synthesize showTopAndBottomBarWithoutAnimate=_showTopAndBottomBarWithoutAnimate;
...
- (void)showTopAndBottomBar:(_Bool)arg1;
...
- (void)setCancelBtnIcon:(id)arg1 length:(double)arg2;
...
- (void)layoutSubviews;
- (void)addBlurView;
- (void)layoutBottomBarButtonVertically:(id)arg1 inView:(id)arg2;
- (double)bottomBarEditToolListLeft;
- (double)bottomBarBottomMargin;
...
- (double)snsHeaderPreviewContentTop;
- (void)updateTopBarVisibilityForNavigationStyle;
- (_Bool)shouldIgnoreToolbarToggleForSNSHeaderPreviewTap;
