...
@class BrandProfileEnterInfo, CBaseContactInfoAssist, CContact, CContactVerifyLogic, CMessageWrap, ForwardMessageLogicController, MMPageSheetAdapter, MMTimer, MMUIButton, MMUIView, NSData, NSDictionary, NSMutableDictionary, NSString, SendVerifyMsgLogicController, TextStatePrivacyMgr, TextStateProfileCardContentView, TextStateProfileDragAnimateHelper, UIButton, UITableView, WCMomentsJumpData, WCStoryDragAnimationUtil;
...
@interface ContactInfoViewController
{
    ...
    NSData *_verifyUserTicketBusinessBuffer;
...
@property(retain, nonatomic) NSData *verifyUserTicketBusinessBuffer; // @synthesize verifyUserTicketBusinessBuffer=_verifyUserTicketBusinessBuffer;
...
- (void)showWeClawBotAgreement:(id)arg1;
- (id)getWeClawBotFooterView;
...
- (void)onSharePhotoAccountNameCard:(id)arg1;
