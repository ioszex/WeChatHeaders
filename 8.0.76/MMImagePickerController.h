...
@class EditImageLogicController, EditVideoLogicController, MMAssetPickerController, MMFinderLiveImagePickerParams, MMImagePickerControllerPreviewReportObject, NSArray, NSMutableDictionary, NSNumber, NSString, UIColor, WCFinderEditOptionModel, WCFinderPickerTemplateParams;
...
@interface MMImagePickerController
{
    ...
    _Bool _shouldHideEditBtnInPreview;
    ...
    _Bool _shouldShowPickerBottomFloatViewInitialized;
    ...
    _Bool _canShowMultiSelectAndInfo;
    int _maxImageCount;
    int _compressType;
    ...
    unsigned long long _clickToEnterPickerTime;
...
// Original attribute string: Tq,?,N,V_selectionConfirmMode

@property(nonatomic) unsigned long long clickToEnterPickerTime; // @synthesize clickToEnterPickerTime=_clickToEnterPickerTime;
@property(nonatomic) _Bool canShowMultiSelectAndInfo; // @synthesize canShowMultiSelectAndInfo=_canShowMultiSelectAndInfo;
...
@property(nonatomic) _Bool shouldShowPickerBottomFloatViewInitialized; // @synthesize shouldShowPickerBottomFloatViewInitialized=_shouldShowPickerBottomFloatViewInitialized;
// Preceding property had unknown attributes: ?
// Original attribute string: TB,?,N,V_shouldShowPickerBottomFloatViewInitialized
...
// Preceding property had unknown attributes: ?
// Original attribute string: TB,?,N,V_shouldHidePickerBottomFloatIcon
...
// Preceding property had unknown attributes: ?
// Original attribute string: T@"UIColor",?,&,N,V_pickerBottomIconTintColor
...
@property(nonatomic) _Bool isCombineSend; // @synthesize isCombineSend=_isCombineSend;
...
@property(nonatomic) _Bool shouldHideEditBtnInPreview; // @synthesize shouldHideEditBtnInPreview=_shouldHideEditBtnInPreview;
// Preceding property had unknown attributes: ?
// Original attribute string: TB,?,N,V_shouldHideEditBtnInPreview
...
@property(nonatomic) _Bool hideOriginButton; // @synthesize hideOriginButton=_hideOriginButton;
...
- (void)cancelImagePickerWithInfo:(id)arg1 finderData:(id)arg2;
- (void)didUnselected:(id)arg1;
- (void)onSendSelectAssets:(id)arg1;
- (void)selectWarning:(id)arg1 fromFinder:(_Bool)arg2;
- (void)didCancelEditVideoWithInfo:(id)arg1;
- (void)didCancelEditImages:(id)arg1;
...
@property(nonatomic) _Bool inPageSheetMode;
