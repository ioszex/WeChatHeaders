...
@class BotContactMgr, CContactCacheOptimizeMgr, CContactConfigMgr, CContactDB, CContactOPLog, CContactUpdateMgr, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, NewContactDB, OpenImContactMgr;
...
- (_Bool)canDeleteContactInNewSyn:(id)arg1;
...
- (_Bool)setContact:(id)arg1 foldSingleChat:(_Bool)arg2 sync:(_Bool)arg3 localSet:(_Bool)arg4;
- (_Bool)setContact:(id)arg1 foldSingleChat:(_Bool)arg2 sync:(_Bool)arg3;
- (void)batchUpdateContactBasicInfo:(id)arg1;
- (_Bool)setContact:(id)arg1 typeExtBit:(unsigned int)arg2 set:(_Bool)arg3 sync:(_Bool)arg4;
- (_Bool)setContact:(id)arg1 typeExtBit:(unsigned int)arg2 set:(_Bool)arg3 sync:(_Bool)arg4 localSet:(_Bool)arg5;
...
- (_Bool)getContactsFromServer:(id)arg1 chatContact:(id)arg2 withScene:(unsigned int)arg3 withTicket:(id)arg4;
- (_Bool)getInviteeContactsFromServer:(id)arg1 withTicket:(id)arg2;
- (_Bool)getContactsFromServer:(id)arg1 withScene:(unsigned int)arg2;
- (_Bool)getContactsFromServer:(id)arg1 chatContact:(id)arg2 withScene:(unsigned int)arg3;
- (_Bool)getContactsFromSvrForTempChat:(id)arg1;
- (_Bool)internalGetContactsFromSvr:(id)arg1 chatContact:(id)arg2 withScene:(int)arg3 usrData:(id)arg4;
...
- (id)getAllPhotoAndServiceContacts;
- (id)getAllPhotoBrandContacts;
- (id)getAllSubscriptionBrandContacts;
- (id)getAllBrandContacts;
- (id)getAllEnterpriseMainBrandContacts;
- (id)getContactListByTypeExt:(unsigned long long)arg1 listType:(unsigned int)arg2;
- (id)getCustAsstContactList;
...
- (_Bool)thread_onPushModifyContact:(id)arg1 isInit:(_Bool)arg2 arrNewContact:(id)arg3;
...
- (_Bool)getAllContactNoExtInfoList:(id)arg1 listType:(unsigned int)arg2 typeExt:(unsigned long long)arg3;
...
- (_Bool)getVerifyRecordSyncSuccessFlag;
- (void)setVerifyRecordSyncSuccessFlag:(_Bool)arg1;
- (id)getContactVerifyRecordWithUserName:(id)arg1;
- (id)getContactVerifyRecordListWithlastVersion:(unsigned long long)arg1 limit:(long long)arg2;
- (_Bool)deleteContactVerifyRecordWithUserName:(id)arg1;
- (_Bool)batchInsertOrUpdateContactVerifyRecord:(id)arg1;
- (_Bool)fullUpdateAllContactVerifyRecord:(id)arg1;
- (void)handleSynStrangerContactProperty:(id)arg1;
- (void)copyValueToContact:(id)arg1 fromContactProperty:(id)arg2;
- (void)rollbackContact:(id)arg1 dbContact:(id)arg2 svrFieldUpdateCtrlInfo:(id)arg3;
- (void)updateContactInSequence:(id)arg1 fieldUpdateCtrlInfoList:(id)arg2;
- (void)updateContactInSequence:(id)arg1 modContact:(id)arg2;
...
- (_Bool)setContact:(id)arg1 localAddContactTime:(unsigned int)arg2;
...
- (_Bool)setContact:(id)arg1 chatRoomAccessType:(unsigned int)arg2 qrCodeAccessType:(unsigned int)arg3;
...
- (_Bool)setContact:(id)arg1 cardDesc:(id)arg2 isLocal:(_Bool)arg3;
- (_Bool)setContact:(id)arg1 cardDesc:(id)arg2;
- (_Bool)setPhone:(id)arg1 Contact:(id)arg2 isLocal:(_Bool)arg3;
- (_Bool)setPhone:(id)arg1 Contact:(id)arg2;
- (void)startModifyContactUserName:(id)arg1 remark:(id)arg2 isChangeRemark:(_Bool)arg3 arrPhone:(id)arg4 isChangePhone:(_Bool)arg5 contactDesc:(id)arg6 isChangecontactDesc:(_Bool)arg7 callbackBlock:(CDUnknownBlockType)arg8;
...
- (_Bool)setChatRoomHeadImageUrlInLocal:(id)arg1 Url:(id)arg2;
...
- (id)getArrContactTagWithUserName:(id)arg1 arrIgnoreContactTagID:(id)arg2;
- (id)getRecommendTag:(id)arg1 arrHadTagID:(id)arg2;
- (void)saveArrSelectRecommTagForStrangerContact:(id)arg1 arrSelectRecommTagName:(id)arg2;
- (id)getArrContactTagIDWithUserName:(id)arg1;
- (_Bool)batchInsertContactTagRelationWithUserName:(id)arg1 arrContactTagID:(id)arg2;
- (_Bool)batchDeleteContactTagWithArrTagId:(id)arg1;
- (_Bool)batchUpdateContactTagOrder:(id)arg1;
- (_Bool)batchUpdateContactTagName:(id)arg1;
- (_Bool)batchInsertContactTag:(id)arg1;
