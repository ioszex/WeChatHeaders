...
@class AVAudioPlayer, AVAudioRouteManager, AVVideoDevice, CMessageWrap, MMTimer, MMViewCapture, MMVoIPToastAdapter, MinimizeTaskData, MultiTalkMainViewController, MultiTalkWindowV2, MultitalkMiniInAppView, NSArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, RingBackSoundCoordinator, SafeMutableDictionary, VoIPInviteMemberReportStruct, VoipCheckAudioDeviceObj;

@interface MultiTalkMgr
{
    char *cameraBuf;
    int cameraBufSize;
    int localPreviewRotation;
    _Bool _isMicrophoneOn;
    _Bool _isSpeakerEnabled;
    _Bool _isSpeakerOn;
    _Bool _isCameraEnabled;
    _Bool _isCameraOn;
    _Bool _isScreenManagedByCrossPlatform;
    _Bool _ilinkTalkReady;
    _Bool _m_videoDeviceRunning;
    _Bool _m_multiTalkReady;
    _Bool _m_isCalling;
    _Bool _m_deviceLaunchSuccess;
    _Bool _m_sdkCallEnded;
    ...
    _Bool _isSpeakerOnBeforeAudioInterruption;
    ...
    unsigned long long _audioUnitReceivedCallbackCount;
    unsigned long long _waitForAcceptedRoomID;
    unsigned long long _multitalkRoomID;
    CMessageWrap *_multiTalkLocalMsg;
    NSString *_sendLocalMsgRemoteName;
    unsigned long long _mAcceptCallTime;
    VoIPInviteMemberReportStruct *_inviteMemberReportStruct;
}

+ (unsigned long long)DefMaxMultiTalkMemberCount;
+ (id)queryGroupNickNameIfInGroupWithGrounId:(id)arg1;
+ (_Bool)shouldPlayPromptSound;
- (void).cxx_destruct;
...
@property(nonatomic) unsigned long long mAcceptCallTime; // @synthesize mAcceptCallTime=_mAcceptCallTime;
@property(copy, nonatomic) NSString *sendLocalMsgRemoteName; // @synthesize sendLocalMsgRemoteName=_sendLocalMsgRemoteName;
@property(retain, nonatomic) CMessageWrap *multiTalkLocalMsg; // @synthesize multiTalkLocalMsg=_multiTalkLocalMsg;
...
@property(nonatomic) unsigned long long multitalkRoomID; // @synthesize multitalkRoomID=_multitalkRoomID;
@property(nonatomic) unsigned long long waitForAcceptedRoomID; // @synthesize waitForAcceptedRoomID=_waitForAcceptedRoomID;
@property(nonatomic) _Bool isSpeakerOnBeforeAudioInterruption; // @synthesize isSpeakerOnBeforeAudioInterruption=_isSpeakerOnBeforeAudioInterruption;
@property(nonatomic) _Bool isInAudioInterruption; // @synthesize isInAudioInterruption=_isInAudioInterruption;
@property(nonatomic) unsigned long long audioUnitReceivedCallbackCount; // @synthesize audioUnitReceivedCallbackCount=_audioUnitReceivedCallbackCount;
...
@property(retain, nonatomic) MultiTalkMainViewController *mainViewController; // @synthesize mainViewController=_mainViewController;
...
@property(retain, nonatomic) NSMutableSet *m_endedRoomIds; // @synthesize m_endedRoomIds=_m_endedRoomIds;
...
@property(nonatomic) _Bool m_sdkCallEnded; // @synthesize m_sdkCallEnded=_m_sdkCallEnded;
...
@property(retain, nonatomic) MMVoIPToastAdapter *voipToastAdapter; // @synthesize voipToastAdapter=_voipToastAdapter;
...
@property(nonatomic) _Bool isScreenManagedByCrossPlatform; // @synthesize isScreenManagedByCrossPlatform=_isScreenManagedByCrossPlatform;
...
@property(retain, nonatomic) MultiTalkWindowV2 *m_mainWindow; // @synthesize m_mainWindow;
- (void)reportClickInviteMemberConfirmBtnWithMemberList:(id)arg1 withChatroomUserName:(id)arg2 withIsSelfOutsideChatroom:(_Bool)arg3;
- (void)reportClickInviteMemberNextBtnWithMemberList:(id)arg1 withChatroomUserName:(id)arg2 withIsSelfOutsideChatroom:(_Bool)arg3;
- (id)buildInvitedUserInfoArrayWithMemberList:(id)arg1 chatroomUserName:(id)arg2 isSelfOutsideChatroom:(_Bool)arg3;
- (void)reportInviteMemberPageWithChatRoomReportCtx:(id)arg1 entranceType:(unsigned long long)arg2 chatUsername:(id)arg3;
- (void)reportInviteMemberPageIsFromMsgChatroom:(_Bool)arg1 ChatRoomReportCtx:(id)arg2 chatUsername:(id)arg3;
- (void)reportClickInviteMemberfailWithType:(int)arg1;
- (void)reportClickInviteMemberWithReportStruct:(id)arg1;
- (_Bool)checkIsInWxGroupWithUserName:(id)arg1 withChatroomUserName:(id)arg2;
...
- (void)onMultiTalkMainViewControllerVideoSelected:(_Bool)arg1 forceBackCamera:(_Bool)arg2;
...
- (void)acceptWithRoomID:(unsigned long long)arg1;
- (void)onMultiTalkMainViewControllerAcceptWithGroup:(id)arg1;
- (id)getCurrentRoomRealMembers;
- (long long)getCurrentRoomRealMember:(id)arg1;
- (void)genLocalMessageOnMultiTalkEndWithGroup:(id)arg1 isClickHangup:(_Bool)arg2 contactInviteMe:(id)arg3 isMeExitLatest:(_Bool)arg4 isVoipRoomWithOutsideContacts:(_Bool)arg5 isSelfOutsideChatRoom:(_Bool)arg6;
- (_Bool)checkIfMeExitLatestWithGroup:(id)arg1;
- (void)onMultiTalkMainViewControllerHangupWithGroup:(id)arg1 isClickHangup:(_Bool)arg2 isNewIlink:(_Bool)arg3 isVoipRoomWithOutsideContacts:(_Bool)arg4 contactInviteMe:(id)arg5 isSelfOutsideChatRoom:(_Bool)arg6;
...
- (void)MultiTalkReject:(unsigned long long)arg1;
...
- (void)restoreMultiTalkWindowForScreenProject;
- (void)hideMultiTalkWindowForScreenProject;
- (id)getMultiTalkWindow;
- (void)doCreateMultiTalkWithContacts:(id)arg1 withChatroomUsername:(id)arg2;
- (void)initVoipCheckAudioDeviceObjWithIsSpeaker:(_Bool)arg1;
- (void)initVoipCheckAudioDeviceObj;
- (void)createMultiTalkSubCallWithGroup:(id)arg1;
- (void)_joinMultiTalkWithGroup:(id)arg1 roomId:(unsigned long long)arg2 roomKey:(unsigned long long)arg3 joinSuccessHandler:(CDUnknownBlockType)arg4;
- (void)joinMultiTalkWithGroup:(id)arg1 roomId:(unsigned long long)arg2 roomKey:(unsigned long long)arg3 joinSuccessHandler:(CDUnknownBlockType)arg4;
...
- (int)currentScreenProjectingMemberId;
- (_Bool)canAutoEnterCrossPlatformRemoteViewing;
- (_Bool)isMultiTalkConnected;
- (_Bool)isMultiTalkCalling;
- (_Bool)isMultiTalkLocalCameraActive;
- (_Bool)checkIfDuplicateGroup:(id)arg1;
...
- (id)defaultVoIPToastAdapterParam;
- (void)initVoIPToastAdapter;
