...
@class MMLiteAppViewController, MMUILabel, NSMutableDictionary, NSString, PAGView, UIButton, UILabel, UIView, WCFinderFeedDetailStatusView, WCFinderFeedFriendsLikeListBaseViewController, WCFinderFeedListView, WCFinderFeedSideColumnView, WCFinderNearByDescriptionTableViewCell, WCFinderRedDotButton, WCFinderShareCustomTransition, WCFinderShareListReportModel, WCFinderShareListViewModel, WCFinderShareSpanState, WCFinderWebviewDelegateObject, WCStoryTouchToDismissView, WXFullScreenGestureRecognizer;
@protocol WCFinderFullShareListViewControllerDelegate;

@interface WCFinderFullShareListViewController
{
    _Bool _doAnimation;
    _Bool _needHideNavigationBarWhenDisapper;
    ...
    _Bool _pendingPushCommentDetail;
    ...
    NSString *_pendingDiscoverEntranceGuideFollowTid;
    ...
    WCFinderRedDotButton *_personCenterRedDotBtn;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool pendingPushCommentDetail; // @synthesize pendingPushCommentDetail=_pendingPushCommentDetail;
...
@property(retain, nonatomic) WCFinderRedDotButton *personCenterRedDotBtn; // @synthesize personCenterRedDotBtn=_personCenterRedDotBtn;
...
@property(copy, nonatomic) NSString *pendingDiscoverEntranceGuideFollowTid; // @synthesize pendingDiscoverEntranceGuideFollowTid=_pendingDiscoverEntranceGuideFollowTid;
@property(nonatomic) _Bool needHideNavigationBarWhenDisapper; // @synthesize needHideNavigationBarWhenDisapper=_needHideNavigationBarWhenDisapper;
...
- (_Bool)possibleRecommendThankItemForTid:(id)arg1;
- (id)getSharerUsernameForTid:(id)arg1;
- (id)thankInfoForTid:(id)arg1;
...
- (void)openFindEntryAndJumpToTimeline:(id)arg1 indexPath:(id)arg2 placeholder:(id)arg3 placeholderCell:(id)arg4;
...
- (void)finderFeedListViewClickThankForShareButtonWithThank:(_Bool)arg1;
- (_Bool)openSearchCollectionJumpInfoClick:(id)arg1 withContentVM:(id)arg2;
...
- (double)bottomOffset;
- (double)topOffset;
- (_Bool)isVerticalCloseAllowedByDataState;
...
- (_Bool)finderFeedListView:(id)arg1 shouldQuickMinimizeWithUserInfo:(id)arg2;
...
- (void)finderFeedListView:(id)arg1 configureUpcomingLiveNavigationWithRouterParameters:(id)arg2;
...
- (void)finderFeedListView:(id)arg1 didFollowContentVM:(id)arg2;
...
- (_Bool)shouldShowWatchFinderBottomTips;
...
- (void)finderFeedListView:(id)arg1 dislikeConfirmedContentVM:(id)arg2;
...
- (void)_hideShareListOpenFinderEntryGuideCardsIfNeeded;
- (_Bool)_isShareListOpenFinderEntryGuideCard:(id)arg1;
...
- (void)viewModel:(id)arg1 didRecivedCgiErrorMessage:(id)arg2;
...
- (void)setupSearchRightBarItem:(id)arg1;
- (_Bool)showSearchRightBarItem;
- (void)setUpPersonCenterRightBarItem:(id)arg1;
- (_Bool)shouldHideProfileOrSearchRightBarItemsForFeedAbnormalState;
- (_Bool)showPersonCenterRightBarItem;
- (_Bool)isUniqueFullShareListInNavigationStack;
- (void)updateNavigationAppearanceForShareListState;
...
- (void)reportFinderSnsStyleFeedDetailPageSlideWithEventID:(id)arg1;
- (id)finderSnsStyleFeedDetailReportParams;
- (void)setUpFinderSnsStyleFeedDetailDataReport;
- (id)customPageName;
- (_Bool)isFinderSnsStyleFeedDetailPage;
- (void)_setupPageReport;
- (void)onPersonalCenterButtonClicked:(id)arg1;
- (void)viewDidLoad;
- (void)didMoveToNewScene:(id)arg1;
- (_Bool)shouldUseCurrentOffsetForVerticalCloseGesture;
- (long long)transitionHelperVerticalCloseItemCount;
- (_Bool)shouldHideFooterView;
- (_Bool)shouldUseTransitionHelperVerticalCloseGesture;
- (_Bool)useBlackStatusbar;
- (_Bool)useTransparentNavibar;
@property(readonly, nonatomic) _Bool canShowFinder;
