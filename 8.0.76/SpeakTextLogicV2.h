...
@interface SpeakTextLogicV2 : NSObject
{
    _Bool m_forceStop;
    _Bool _useNewTTS;
    _Bool _suppressToast;
    _Bool _lastSpeakFinished;
...
+ (id)convertSelectedLanguageToVoiceLanguage:(id)arg1;
...
@property(nonatomic) _Bool lastSpeakFinished; // @synthesize lastSpeakFinished=_lastSpeakFinished;
@property(nonatomic) _Bool suppressToast; // @synthesize suppressToast=_suppressToast;
