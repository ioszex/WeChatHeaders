...
- (void)showMJAIGCAsyncDraftOpenFailedToast;
- (void)presentMJAIGCAsyncNewTimelineIfSupportedWithDraftID:(id)arg1 draft:(id)arg2;
- (void)handleMJAIGCAsyncDraftQueryWithDraftID:(id)arg1 succeed:(_Bool)arg2 draft:(id)arg3;
- (void)tryPresentMJAIGCAsyncNewTimelineWithDraftID:(id)arg1;
- (void)presentMJAIGCAsyncShootDraftWithDraftID:(id)arg1;
