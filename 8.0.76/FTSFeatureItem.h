...
@interface FTSFeatureItem : NSObject
{
    ...
    unsigned long long _subjectKind;
    id _subjectModel;
    NSString *_candidateTitle;
    NSString *_secoundCandidateTitle;
    NSString *_thirdCandidateTitle;
    NSString *_weClawUserName;
    CContact *_associatedContact;
    Class _customizeFeatureItemClass;
}

- (void).cxx_destruct;
@property(retain, nonatomic) Class customizeFeatureItemClass; // @synthesize customizeFeatureItemClass=_customizeFeatureItemClass;
@property(retain, nonatomic) CContact *associatedContact; // @synthesize associatedContact=_associatedContact;
@property(retain, nonatomic) NSString *weClawUserName; // @synthesize weClawUserName=_weClawUserName;
...
@property(retain, nonatomic) id subjectModel; // @synthesize subjectModel=_subjectModel;
@property(nonatomic) unsigned long long subjectKind; // @synthesize subjectKind=_subjectKind;
