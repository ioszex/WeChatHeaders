...
@class FinderGetRelatedEntranceInfo, FinderNativeSourceInfo, FinderShareUserInfo, JsApiSourceInfo, MISSING_TYPE, NSData, NSNumber, NSString, OftenReadAuthorInfo, StreamTabTipsInfo, WCFinderCategoryInfo, WCFinderLocationInfo, WCFinderSectionInfo, WCFinderShareListReportModel;
...
@property(retain, nonatomic) NSString *lastReadFeedId; // @synthesize lastReadFeedId=_lastReadFeedId;
