...
@class BaseResponse, EcsJumpInfo, FinderDirectAddPreviousLiveProductsPageInfo, FinderFlashSaleOrderSetting, FinderFlashSaleSetting, FinderJumpInfo, FinderLiveGetShopShelfResponse_ShopVipInfo, FinderLiveGetShopShelfResponse_ShopWindowCouponInfo, FinderLiveGetShopShelfResponse_ShopWindowProfileInfo, FinderLiveShopCustomerServiceInfo, FinderLiveWxaPreloadInfo, FinderReplayRecordSetting, FinderShopLiteAppJumpInfo, FinderShopShelfAnchorMoneyOffCouponListInfo, FinderShopShelfAskForPromoteSetting, FinderShopShelfEntranceButton, FinderShopShelfFeatureSwitch, FinderShopShelfHintInfo, FinderShopShelfOrderSetting, FinderShopShelfPlatformDiscountCouponListInfo, FinderShopShelfTopGuideBar, FinderWxAppInfo, LivePresenterInfo, NSData, NSMutableArray, NSString, OperatorEntityInfo, ShelfCouponBannerInfo, ShelfMessageEntranceInfo;
...
@property(retain, nonatomic) EcsJumpInfo *addProductJumpInfo; // @dynamic addProductJumpInfo;
...
@property(retain, nonatomic) FinderJumpInfo *clickProductManagementOpenPage; // @dynamic clickProductManagementOpenPage;
...
@property(retain, nonatomic) FinderShopShelfFeatureSwitch *featureSwitch; // @dynamic featureSwitch;
...
@property(retain, nonatomic) NSMutableArray *headerButtons; // @dynamic headerButtons;
...
@property(retain, nonatomic) OperatorEntityInfo *operatorEntityInfo; // @dynamic operatorEntityInfo;
...
@property(retain, nonatomic) FinderShopShelfEntranceButton *productFavoritesButton; // @dynamic productFavoritesButton;
@property(retain, nonatomic) FinderShopShelfEntranceButton *productLikeButton; // @dynamic productLikeButton;
...
@property(retain, nonatomic) ShelfCouponBannerInfo *shelfCouponBannerInfo; // @dynamic shelfCouponBannerInfo;
@property(retain, nonatomic) ShelfMessageEntranceInfo *shelfMessageEntranceInfo; // @dynamic shelfMessageEntranceInfo;
@property(retain, nonatomic) LivePresenterInfo *shelfPresentInfo; // @dynamic shelfPresentInfo;
@property(retain, nonatomic) EcsJumpInfo *shopBagJumpInfo; // @dynamic shopBagJumpInfo;
@property(retain, nonatomic) NSString *shopBagTopPagUrl; // @dynamic shopBagTopPagUrl;
...
@property(retain, nonatomic) FinderShopShelfTopGuideBar *topGuideBar; // @dynamic topGuideBar;
