...
- (void)cancelPreDownloadVideoResourceWithSrc:(id)arg1 retBlock:(CDUnknownBlockType)arg2;
- (void)preDownloadVideoResourceWithSrc:(id)arg1 downloadRatio:(long long)arg2 reportInfo:(id)arg3 retBlock:(CDUnknownBlockType)arg4;
- (void)eventWithType:(id)arg1 textureId:(long long)arg2 reportInfo:(id)arg3 retBlock:(CDUnknownBlockType)arg4;
- (void)prepareResourceWithType:(id)arg1 textureId:(long long)arg2 extraData:(id)arg3 retBlock:(CDUnknownBlockType)arg4;
- (void)operateExternalTextureWithType:(id)arg1 textureId:(long long)arg2 action:(id)arg3 extraData:(id)arg4 retBlock:(CDUnknownBlockType)arg5;
