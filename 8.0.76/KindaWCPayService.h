...
+ (void)reportShortcutCreateSuccess;
+ (void)markShortcutCreated;
- (void).cxx_destruct;
...
- (void)addOfflinePayShortcutWithName:(id)arg1;
- (void)addOfflinePayShortcut;
- (void)refreshHongbaoDetailUIPage:(id)arg1;
- (void)openHongbaoDetailUIPageImpl:(id)arg1 quitCallback:(id)arg2;
...
- (void)openHongbaoSelectExclusiveMemberPageImpl:(id)arg1 confirm:(id)arg2;
- (void)checkWalletLockOpenStatusImpl:(id)arg1;
