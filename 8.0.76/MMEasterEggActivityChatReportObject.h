...
- (void)reportEggLuckyBagNotShowBecauseOfRequestFailed:(id)arg1;
- (void)reportEggLuckyBagNotShowBecauseOfServerLimit:(id)arg1;
- (void)reportEggLuckyBagNotShowBecauseOfFreqLimit:(id)arg1;
- (void)reportEggLuckyBagNotShowBecauseOfLimit:(id)arg1 reason:(int)arg2;
- (void)reportEggIsCanceledBecauseOfAnyOtherPlaying:(id)arg1;
- (void)reportEggJoinActionWithKeyword:(id)arg1;
- (void)reportTriggerWithAllKeyWords:(id)arg1;
- (void)reportChatActionWithReason:(unsigned long long)arg1 keyword:(id)arg2 extendString:(id)arg3 allKeyWords:(id)arg4 reason:(int)arg5;
