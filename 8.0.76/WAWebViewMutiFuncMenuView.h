...
+ (double)getMenuOriginX:(double)arg1 MenuWidth:(double)arg2 forWebVC:(id)arg3;
+ (double)getMenuOriginX:(double)arg1 MenuWidth:(double)arg2;
+ (double)getMenuOriginYForWebVC:(id)arg1;
+ (double)getMenuOriginYIncludeStatusBar:(_Bool)arg1;
+ (double)getMenuOriginY;
+ (double)menuViewHeightForOri:(long long)arg1;
+ (_Bool)shouldUseSmallMenuForOri:(long long)arg1;
