...
+ (id)addSessionBufferFromBrandFinderLiveInfo:(id)arg1 commentScene:(int)arg2;
+ (id)coAuthorDisplaySuffixWithCount:(unsigned long long)arg1;
+ (id)coAuthorNicknameContentWithCoAuthorInfo:(id)arg1;
+ (id)coAuthorNicknameContentWithNicknames:(id)arg1;
+ (id)coAuthorDisplayNicknameWithNicknames:(id)arg1 maxWidth:(double)arg2 font:(id)arg3;
+ (_Bool)judgeSwitchStream:(id)arg1 toUrl:(id)arg2;
+ (void)parseStreamUrl:(id)arg1 protocol:(long long *)arg2 originalStreamId:(id *)arg3 watchStreamId:(id *)arg4 transcodeTemplate:(id *)arg5;
+ (void)openFindTabAndGoSquareWithParams:(id)arg1 navigateToFindTab:(_Bool)arg2 viewDidAppearBlock:(CDUnknownBlockType)arg3;
+ (void)openLiveDiscoverEntrance;
+ (_Bool)isLiveDiscoverEntranceSwitchEnabled;
+ (_Bool)isLiveDiscoverEntranceOpen;
+ (id)genKeyValueDictFromUrl:(id)arg1 prefix:(id)arg2;
+ (struct CGSize)calcAdjustedSizeForEmoticon:(id)arg1 styleInfo:(id)arg2 isBarrageMode:(_Bool)arg3;
+ (id)getValueForUrlParameter:(id)arg1 inURLString:(id)arg2;
+ (_Bool)shouldUseExtendAndScrollConflictResolvingForCommentScene:(int)arg1;
+ (id)getInheritedVCDescFromVC:(id)arg1;
...
+ (unsigned long long)transferVideoLiveSubModeToVideoSubType:(unsigned long long)arg1;
+ (unsigned long long)transferAudioLiveSubModeToAudioSubType:(unsigned long long)arg1;
...
+ (_Bool)isRect:(struct CGRect)arg1 intersectWithRect:(struct CGRect)arg2;
...
+ (CDStruct_1b4a36b4)convertTimeToDisplayResult:(unsigned long long)arg1 format:(long long)arg2;
...
+ (id)getAdaptedDisplayStr:(id)arg1 font:(id)arg2 inMaxWidth:(double)arg3 tagAdaptive:(_Bool)arg4;
+ (id)_truncateDisplayStr:(id)arg1 font:(id)arg2 inMaxWidth:(double)arg3;
...
+ (_Bool)isSelfLiveContact:(id)arg1;
+ (_Bool)isSelfContact:(id)arg1;
...
+ (id)getFinderLiveCdnUrlWithLiveInfo:(id)arg1 clarityCacheInfo:(id)arg2 withoutLogin:(_Bool)arg3 liveTask:(id)arg4;
+ (id)getFinderLiveCdnUrlWithLiveInfo:(id)arg1 clarityCacheInfo:(id)arg2 withoutLogin:(_Bool)arg3;
+ (id)getFinderLiveCdnUrlWithLiveTask:(id)arg1;
+ (id)getCdnTransInfoWithStreamUrl:(id)arg1 liveTask:(id)arg2;
...
+ (id)getShopMemberBadgeInfoFromBadgeInfos:(id)arg1;
...
+ (id)getMemberBadgeInfoFromBadgeInfos:(id)arg1;
...
+ (_Bool)isNewVersionRiskAccountWithUserFlag:(unsigned int)arg1 checkBeforeEnterStartPage:(_Bool)arg2;
...
+ (CDStruct_a6fa95e6)defaultConnectMicUnfocusedUserFrameLayoutInfo;
...
+ (_Bool)checkContentContainsEmoji:(id)arg1;
...
+ (id)priceStringIgnoreUnnecessaryZerosWithCent:(unsigned long long)arg1;
+ (id)localizedPriceStringWithIntegerNumber:(unsigned long long)arg1;
+ (id)localizedNumberStringWithIntegerNumberAnd100KMax:(unsigned long long)arg1;
+ (id)localizedNumberStringWithIntegerNumber:(unsigned long long)arg1;
+ (id)formattedWatchTimeDurationWithSeconds:(unsigned int)arg1;
...
+ (id)getFinderLiveCoverUrl:(id)arg1;
...
+ (_Bool)isLiveRealSafeAreaInsetsInvalid:(struct UIEdgeInsets)arg1;
