...
+ (id)beautyPackageInLocalDirectory:(id)arg1 withConfigurationPath:(id)arg2 capabilities:(id)arg3;
+ (id)beautyPackageInResourcePackage:(id)arg1 capabilities:(id)arg2;
- (void).cxx_destruct;
