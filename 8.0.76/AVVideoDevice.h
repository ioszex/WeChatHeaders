...
@class AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoDataOutput, CMMotionManager, NSObject, NSRecursiveLock, NSString, WeVisVoipEffectMgr, XImageContext;
...
@interface AVVideoDevice
{
    ...
    _Bool _enableRci;
    _Bool _useInputPriorityMode;
    _Bool _enableUltraWideAngleCamera;
    _Bool _isRunning;
...
+ (void)kvReportEffect:(id)arg1 roomID:(unsigned long long)arg2 roomKey:(long long)arg3 scene:(unsigned long long)arg4;
+ (id)bestFormatForDevice:(id)arg1 targetWidth:(int)arg2 targetFps:(int)arg3 preferDynamicAspectRatio:(_Bool)arg4;
- (void).cxx_destruct;
...
@property(nonatomic) _Bool enableUltraWideAngleCamera; // @synthesize enableUltraWideAngleCamera=_enableUltraWideAngleCamera;
@property(nonatomic) _Bool useInputPriorityMode; // @synthesize useInputPriorityMode=_useInputPriorityMode;
...
@property(retain) AVCaptureDeviceInput *videoInput; // @synthesize videoInput;
...
- (void)startSession;
- (void)_startSession;
- (void)_changeToHighCapturePreset:(int)arg1;
- (void)_changeToHighCaptureInputPriority:(int)arg1;
...
- (_Bool)_applyBestFormatForInputPriorityWithTargetWidth:(int)arg1 targetFps:(int)arg2 preferDynamicAspectRatio:(_Bool)arg3;
- (_Bool)_configureSessionInputPriorityWithFront:(_Bool)arg1;
- (void)_configureSessionPreset;
- (void)setupSessionWithCameraFront:(_Bool)arg1;
- (void)createCaptureSessionWithCameraFront:(_Bool)arg1;
...
- (void)newVideoPixel:(struct __CVBuffer *)arg1 withFrameIndex:(unsigned long long)arg2 rgbaTexture:(id)arg3 auxiliaryInfo:(id)arg4;
