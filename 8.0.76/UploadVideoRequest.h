...
@property(retain, nonatomic) NSString *md5CdnvideoUrl; // @dynamic md5CdnvideoUrl;
@property(retain, nonatomic) NSString *md5RawVideoFileId; // @dynamic md5RawVideoFileId;
