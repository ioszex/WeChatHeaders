...
@interface WCPayNewPwdViewController
{
    ...
    _Bool _shouldRestorePasswordFocus;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool shouldRestorePasswordFocus; // @synthesize shouldRestorePasswordFocus=_shouldRestorePasswordFocus;
...
- (void)prepareForPasswordReset;
- (void)clearPwdInputAndRestoreFocus;
- (void)clearPwdInput;
- (void)WCBaseInfoItemEditChanged:(id)arg1;
- (void)showVerifyBiotricCtrl;
- (void)showVerifyPwdCtrl;
- (void)layoutVerifyPwdCtrl;
