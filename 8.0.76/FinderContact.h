...
@class AchievementInfo, FinderAuthInfo, FinderContactClubInfo, FinderContactExtInfo, FinderContactLiveInfo, FinderContactMsgInfo, FinderContactPrivacyInfo, FinderGuestInfo, FinderIdentityInfo, FinderLiveNoticeInfo, FinderOriginalInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSMutableArray *referenceInfo; // @dynamic referenceInfo;
@property(retain, nonatomic) NSString *relationTag; // @dynamic relationTag;
...
@property(retain, nonatomic) FinderIdentityInfo *wxuserFinderIdentityInfo; // @dynamic wxuserFinderIdentityInfo;
