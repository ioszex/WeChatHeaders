...
+ (_Bool)isVoipMtInviteData:(id)arg1;
- (void).cxx_destruct;
...
- (void)RecvNotifyImp:(id)arg1 datalen:(int)arg2 groupId:(id)arg3 sdkGroupId:(id)arg4 displayUserList:(id)arg5 muteNotification:(_Bool)arg6 notifyFrom:(int)arg7;
- (void)recvSubcallInviteData:(id)arg1 groupId:(id)arg2 sdkGroupId:(id)arg3 displayUserList:(id)arg4;
...
- (void)joinimp:(id)arg1 wxGroupId:(id)arg2 joinSuccessHandler:(CDUnknownBlockType)arg3;
- (void)joinSync:(id)arg1 wxGroupId:(id)arg2 joinSuccessHandler:(CDUnknownBlockType)arg3;
- (int)joinroom:(id)arg1 wxGroupId:(id)arg2 joinSuccessHandler:(CDUnknownBlockType)arg3;
- (void)inviteImp:(id)arg1 inviteCallback:(CDUnknownBlockType)arg2 inviteId:(unsigned long long)arg3;
- (void)inviteSync:(id)arg1 inviteId:(unsigned long long)arg2;
