...
+ (_Bool)setAVCategroy:(id)arg1 mode:(id)arg2 options:(unsigned long long)arg3 optionsForbidModify:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5 error:(id *)arg6 withBlockType:(unsigned long long)arg7;
+ (_Bool)setAVCategroy:(id)arg1 mode:(id)arg2 defaultToSpeaker:(_Bool)arg3 mixWithOthers:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5;
...
+ (_Bool)StartSnsVideoStreamingDownload:(id)arg1 httpUrl:(id)arg2 fileType:(int)arg3 appType:(short)arg4 filePath:(id)arg5 preloadPercent:(int)arg6 Timeout:(unsigned int)arg7 referer:(id)arg8 blockSize:(unsigned int)arg9;
...
+ (int)QueryOriginPullRecord:(id)arg1 recentSeconds:(unsigned int)arg2 records:(void *)arg3;
...
- (_Bool)isStarSwitchOpen;
- (_Bool)getDisableWxamP3Decode;
- (_Bool)getPsdkReportFail;
- (_Bool)getPsdkReportSuccess;
- (_Bool)getUsePsdkStreamDec;
- (_Bool)getUsePsdkStreamEnc;
- (_Bool)getUsePsdkClientDec;
- (_Bool)getUsePsdkClientEnc;
- (_Bool)getUseWxamCrashProtect;
- (_Bool)getUseWxamDecReport;
- (_Bool)getUseWxamEncReport;
- (_Bool)getUseWxamFasthb;
- (_Bool)getUseWxamRoiOther;
- (_Bool)getUseWxamRoiC2C;
