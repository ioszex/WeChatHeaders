...
@property(retain, nonatomic) UILabel *emojiOriginalLabel; // @synthesize emojiOriginalLabel=_emojiOriginalLabel;
...
- (void)report30474:(unsigned long long)arg1;
- (id)sdkReportParams;
...
- (struct CGSize)getScaledEmojiSize;
- (void)layoutSubviews;
