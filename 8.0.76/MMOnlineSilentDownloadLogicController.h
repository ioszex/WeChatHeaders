...
@interface MMOnlineSilentDownloadLogicController : NSObject
{
    ...
    NSMutableArray *_sentFileMarkList;
...
@property(retain, nonatomic) NSMutableArray *sentFileMarkList; // @synthesize sentFileMarkList=_sentFileMarkList;
...
- (void)sendStatusNotifyToBackDevice:(id)arg1 isForPc:(_Bool)arg2;
- (void)sendSilentDownloadFileToBackDevice:(id)arg1 isNormalImg:(_Bool)arg2;
