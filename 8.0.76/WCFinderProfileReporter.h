...
@interface WCFinderProfileReporter : NSObject
{
    ...
    unsigned long long _leaveInteractionType;
...
@property(nonatomic) _Bool isStoreButtonExpose; // @synthesize isStoreButtonExpose=_isStoreButtonExpose;
@property(nonatomic) unsigned long long leaveInteractionType; // @synthesize leaveInteractionType=_leaveInteractionType;
...
- (void)reportKFButton:(_Bool)arg1;
- (void)reportWechatKF:(_Bool)arg1;
- (void)reportBrandEvent:(_Bool)arg1;
...
- (void)reportProfileExposed:(id)arg1;
- (void)exposeElementAgain:(id)arg1;
- (void)cleanAll;
