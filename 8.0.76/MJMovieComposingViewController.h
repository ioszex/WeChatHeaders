...
@class MJActionPanelViewController, MJAnalysisGuidanceManager, MJClippingPanel, MJComposingMusicClipViewController, MJComposingMusicVolumeViewController, MJComposingTextPageSheetViewController, MJExportProgressMaskView, MJGradientView, MJMCPickerEditingMediator, MJMovieComposingBottomBar, MJMovieComposingRecognitionGuideView, MJMovieComposingRedditBubbleView, MJMovieComposingSession, MJMovieComposingShootTemplateCoordinator, MJMovieComposingShootTemplatePreviewViewController, MJMovieComposingTitleGuideView, MJMovieComposingViewModel, MJMovieTextEditInspector, MJMovieTextSuggestionContext, MJMovieTextSuggestionProcessor, MJMovieTextSuggestionSnapshotGenerator, MJMusicPickingViewModel, MJNarrationRecordingControlView, MJPassthroughButton, MJPassthroughView, MJPlaybackViewModel, MJPublisherPlaybackProgressSlider, MJSegmentCropBoxView, MJSegmentCropGestureCaptureView, MJSegmentViewModel, MJShootComposingTemplatePanelHalfScreenViewController, MJTimelineViewController, MJTimelineViewModel, MJToolbarButton, MJVideoSafeAreaTipsView, MMBGMSelectHalfScreenViewController, MMTimer, MMUIButton, MMUILabel, NSArray, NSMapTable, NSMutableArray, NSString, OMJHandleBoxBorderStyle, OMJPlaybackOverlayView, UIImageView, UIView;
@protocol MJMovieComposingViewControllerDelegate, MJMusicCapsuleViewProtocol;
...
@interface MJMovieComposingViewController
{
    ...
    _Bool _shouldResumeShootTemplatePreviewAfterDetail;
    _Bool _isShowingHandleBoxBubbleMenu;
    _Bool _shouldPresentBubbleMenuAfterHandleBoxUpdate;
    ...
    MJPassthroughButton *_confirmButton;
    MJToolbarButton *_feedbackButton;
    MMUIButton *_debugShowTimeLineButton;
    MMUIButton *_playButton;
    MMUIButton *_backToStartButton;
    MJMovieComposingBottomBar *_bottomBar;
    MJGradientView *_bottomGradientView;
    MMUILabel *_bottomAIGCTipsLabel;
    ...
    MJMCPickerEditingMediator *_pickerEditingMediator;
    ...
    MJComposingTextPageSheetViewController *_textPageSheetVC;
    ...
    MJComposingMusicVolumeViewController *_musicVolumePanelVC;
    MJComposingMusicClipViewController *_musicClipVC;
    MMTimer *_musicDownloadDetectTimer;
    MJExportProgressMaskView *_progressView;
    MJMovieComposingRedditBubbleView *_aigcReeditBubbleView;
    MJMovieComposingShootTemplateCoordinator *_shootTemplateCoordinator;
    MJMovieComposingShootTemplatePreviewViewController *_shootTemplatePreviewVC;
    MJShootComposingTemplatePanelHalfScreenViewController *_shootTemplatePanelHalfScreenVC;
    NSArray *_templatePreviewHiddenViews;
...
+ (id)sanitizedUserInfoForLogging:(id)arg1;
...
@property(nonatomic) _Bool shouldPresentBubbleMenuAfterHandleBoxUpdate; // @synthesize shouldPresentBubbleMenuAfterHandleBoxUpdate=_shouldPresentBubbleMenuAfterHandleBoxUpdate;
@property(nonatomic) _Bool isShowingHandleBoxBubbleMenu; // @synthesize isShowingHandleBoxBubbleMenu=_isShowingHandleBoxBubbleMenu;
...
@property(nonatomic) _Bool shouldResumeShootTemplatePreviewAfterDetail; // @synthesize shouldResumeShootTemplatePreviewAfterDetail=_shouldResumeShootTemplatePreviewAfterDetail;
@property(retain, nonatomic) NSArray *templatePreviewHiddenViews; // @synthesize templatePreviewHiddenViews=_templatePreviewHiddenViews;
@property(retain, nonatomic) MJShootComposingTemplatePanelHalfScreenViewController *shootTemplatePanelHalfScreenVC; // @synthesize shootTemplatePanelHalfScreenVC=_shootTemplatePanelHalfScreenVC;
@property(retain, nonatomic) MJMovieComposingShootTemplatePreviewViewController *shootTemplatePreviewVC; // @synthesize shootTemplatePreviewVC=_shootTemplatePreviewVC;
@property(retain, nonatomic) MJMovieComposingShootTemplateCoordinator *shootTemplateCoordinator; // @synthesize shootTemplateCoordinator=_shootTemplateCoordinator;
@property(retain, nonatomic) MJMovieComposingRedditBubbleView *aigcReeditBubbleView; // @synthesize aigcReeditBubbleView=_aigcReeditBubbleView;
@property(retain, nonatomic) MJExportProgressMaskView *progressView; // @synthesize progressView=_progressView;
@property(retain, nonatomic) MMTimer *musicDownloadDetectTimer; // @synthesize musicDownloadDetectTimer=_musicDownloadDetectTimer;
...
@property(retain, nonatomic) MJComposingTextPageSheetViewController *textPageSheetVC; // @synthesize textPageSheetVC=_textPageSheetVC;
...
@property(retain, nonatomic) MJMCPickerEditingMediator *pickerEditingMediator; // @synthesize pickerEditingMediator=_pickerEditingMediator;
...
@property(retain, nonatomic) MMUILabel *bottomAIGCTipsLabel; // @synthesize bottomAIGCTipsLabel=_bottomAIGCTipsLabel;
...
@property(retain, nonatomic) MMUIButton *backToStartButton; // @synthesize backToStartButton=_backToStartButton;
@property(retain, nonatomic) MMUIButton *playButton; // @synthesize playButton=_playButton;
@property(retain, nonatomic) MMUIButton *debugShowTimeLineButton; // @synthesize debugShowTimeLineButton=_debugShowTimeLineButton;
@property(retain, nonatomic) MJToolbarButton *feedbackButton; // @synthesize feedbackButton=_feedbackButton;
@property(retain, nonatomic) MJPassthroughButton *confirmButton; // @synthesize confirmButton=_confirmButton;
...
- (void)updateConfirmButtonVisibilityAnimated:(_Bool)arg1;
- (void)showConfirmButtonAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)hideConfirmButtonAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showMainPageViewsAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)hideMainPageViewsAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (id)mainPageViews;
- (void)reloadShootTemplateEntryVisibility;
...
- (void)backToStartButtonTouchUpInside:(id)arg1;
- (void)backToStartAnimated:(_Bool)arg1;
- (void)playButtonTouchUpInside:(id)arg1;
- (void)skipMovieTilteInputGuideButtonTouchUpInside:(id)arg1;
- (void)onClickShowTimelineButton:(id)arg1;
...
- (void)closeForReeditWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)teardownAIGCReedit;
- (void)bubbleEntryViewDidTapEditButton:(id)arg1;
- (void)showAIGCReeditBubbleWithEntryParams:(id)arg1;
- (void)setupAIGCReeditBubbleIfNeeded;
- (void)layoutRenderViewOnAspectRatioDidChange;
- (void)animateRenderViewExpandWithCompletion:(CDUnknownBlockType)arg1;
- (double)textPageSheetRenderViewTopOffsetWithMaxRenderHeight:(double)arg1 renderViewSize:(struct CGSize)arg2;
- (void)animateRenderViewShrinkForTextPageSheetWithHeight:(double)arg1;
- (void)animateRenderViewShrinkWithHeight:(double)arg1 containsSlider:(_Bool)arg2;
- (void)renderViewShrinkForTextPageSheetNoAnimationWithHeight:(double)arg1;
- (void)renderViewShrinkNoAnimationWithHeight:(double)arg1;
- (double)backToStartTranslateWithPanelHeight:(double)arg1 containsSlider:(_Bool)arg2;
...
- (void)mediatorNotifyDidFinishPickAssetInfos:(id)arg1;
...
- (void)actionPanelViewControllerDidSelectDigiZoom:(id)arg1;
...
- (void)insertPhotoVideoSegmentWithAssetInfos:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (_Bool)isCurrentVideoComposingMatchToSave;
- (void)showVideoSaveTipVC;
- (_Bool)shouldShowVideoSaveTipVC;
- (id)completeExportUserInfoIfNeeded:(id)arg1;
- (void)completeTemplateCreationInfoToUserInfoIfNeeded:(id)arg1;
- (_Bool)shouldInterruptExportForFinderRedPackageEntry;
...
- (void)repositionHandleBoxBubbleMenuIfNeeded;
- (void)temporarilyHideHandleBoxBubbleMenuIfNeeded;
- (void)dismissHandleBoxBubbleMenu;
- (struct CGRect)handleBoxBubbleMenuAnchorRectInWindowForHandleBox:(id)arg1 window:(id)arg2;
- (void)presentHandleBoxBubbleMenuWithItems:(id)arg1;
- (void)updateHandleBoxBubbleMenuForSegmentVM:(id)arg1 options:(unsigned long long)arg2;
- (id)handleBoxBubbleMenuItemsForOptions:(unsigned long long)arg1;
- (_Bool)shouldUseBubbleMenuForSegmentVM:(id)arg1;
- (id)handleBoxStrokeColor;
...
- (void)mp_musicDownloadDetectTimerDidUpdate;
- (void)resetMusicDownloadDetectTime;
- (void)startMusicDownloadDetectTime;
- (void)reportMusicPanelExperimentKeys;
- (void)reportMusicPanelExitWithResult:(id)arg1;
- (id)genMusicPanelReportDictForPanel;
- (void)switchMusicPanelCapsuleViewToMusicUnSelectedState;
- (void)mp_updateMusicEntranceViewWithResultMusic:(id)arg1;
- (void)ensureMusicFileLocalWithResult:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)updateMusicReportInfoWithMusicData:(id)arg1 atTabIndex:(unsigned long long)arg2 index:(unsigned long long)arg3;
- (void)applySelectedMusicData:(id)arg1 filePath:(id)arg2 isMusicOn:(_Bool)arg3;
- (void)updateMusicPanelCurrentSelectedMusicPlaying:(_Bool)arg1;
- (void)refreshMusicPanelVolumeButtonIfNeeded;
- (void)downloadAndApplyMusicData:(id)arg1 isMusicOn:(_Bool)arg2;
- (void)ensureMusicFileAvailableAndApply:(id)arg1 isMusicOn:(_Bool)arg2;
- (void)applySceneVolumeStateToTimelineWithCompletion:(CDUnknownBlockType)arg1;
- (void)applySceneVolumeStateToTimeline;
- (void)syncSceneVolumeStateFromTimeline;
- (void)toggleLyricDisplay:(_Bool)arg1;
- (void)presentMusicPanelWithIsFirstPresent:(_Bool)arg1;
- (void)syncMusicStateForExistingPanel;
- (_Bool)setupMusicPickingVCIfNeeded;
- (void)startPlaybackFromBeginning;
- (void)anchorMusicSegmentInternal:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)mp_anchorMusicSegment:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)mp_anchorMusicSegment:(id)arg1;
- (void)mp_anchorMusicSegmentIfNeeded:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)mp_anchorMusicSegmentIfNeeded:(id)arg1;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didEditMusic:(id)arg2 atTabIndex:(unsigned long long)arg3 index:(unsigned long long)arg4;
- (unsigned long long)musicPanel_bgmSelectedViewControllerGetMaterialDuration:(id)arg1;
- (void)musicPanel_bgmSelectedViewControllerDidClose:(id)arg1;
- (void)musicPanel_bgmSelectedViewControllerWillClose:(id)arg1;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didClickVolumeBtn:(id)arg2;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didClickOSTOnBtn:(_Bool)arg2;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didClickLyricOnBtn:(_Bool)arg2;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didClickMusicOnBtn:(_Bool)arg2;
- (void)musicPanel_bgmSelectedViewController:(id)arg1 didSelectedMusic:(id)arg2 atTabIndex:(unsigned long long)arg3 index:(unsigned long long)arg4 isTriggerByTap:(_Bool)arg5;
- (void)musicPanel_disableMusicInCapsuleView:(id)arg1;
- (void)musicPanel_musicCapsuleViewDidClick:(id)arg1;
- (_Bool)hasExistingMusicTrack;
- (void)updateMusicPanelCapsuleTitle;
- (void)mp_removeMusicIfNeeded;
- (void)enterMusicPanelWithChangeComposingState:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)setupMusicPanelCapsuleView;
...
- (void)mediatorNotifyDidFinishPickLocalBGMAssetInfos:(id)arg1 picker:(id)arg2;
...
- (unsigned long long)bgmSelectedViewControllerGetMaterialDuration:(id)arg1;
...
- (void)showMainUIAfterMusicTrimDismiss;
- (_Bool)applyMusicTrimWithStartTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2;
- (id)buildTrimmedMusicInfoWithStartTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2;
- (void)updateMusicTrimWaveformPlayingState:(_Bool)arg1;
- (void)updateMusicTrimWaveformWithPlaybackTime:(CDStruct_1b6d18a9)arg1;
...
- (void)syncOSTVolume:(float)arg1;
- (void)resumePlaybackAfterVolumeAdjustmentIfNeeded;
- (void)preparePlaybackForVolumeAdjustment;
...
- (void)shootTemplatePreviewViewControllerFetchDataDidFail:(id)arg1;
- (void)shootTemplatePreviewViewControllerDidTapConfirm:(id)arg1;
- (void)shootTemplatePreviewViewControllerDidTapCancel:(id)arg1;
- (void)updateSelectedEffectReportInfoAfterShootTemplateConfirm;
- (void)applySelectedShootTemplateItem:(id)arg1 atIndex:(unsigned long long)arg2 panelType:(unsigned long long)arg3 viewController:(id)arg4;
- (void)shootTemplatePreviewViewController:(id)arg1 didSelectTemplateItem:(id)arg2 atIndex:(unsigned long long)arg3;
- (void)shootTemplatePreviewViewController:(id)arg1 didTapTitleEntry:(id)arg2 atIndex:(unsigned long long)arg3;
- (void)shootTemplatePreviewViewController:(id)arg1 didTapMoreEntry:(id)arg2 atIndex:(unsigned long long)arg3;
- (void)shootTemplatePreviewViewControllerDidTapBackground:(id)arg1;
...
- (void)layoutShootTemplatePreviewContainerWithPanelContentHeight:(double)arg1 animated:(_Bool)arg2;
- (void)showShootTemplatePanelHalfScreenViewController;
- (void)resumeShootTemplatePreviewAfterDetailIfNeeded;
- (void)pushShootTemplateTemplateDetailWithItem:(id)arg1 templatePanelViewModel:(id)arg2;
- (void)openShootTemplateDetailViewControllerWithItem:(id)arg1 templatePanelViewModel:(id)arg2;
- (void)clearShootTemplatePreviewObjects;
- (void)dismissShootTemplatePreviewControllerAnimated:(_Bool)arg1;
- (void)dismissShootTemplatePreviewController;
- (id)validatedShootTemplateTransitionSnapshotImage:(id)arg1 source:(id)arg2;
- (id)shootTemplateSnapshotImageFromRenderViewContainer;
- (void)shootTemplateTransitionSnapshotImageAtTime:(CDStruct_1b6d18a9)arg1 completion:(CDUnknownBlockType)arg2;
- (void)applySelectedShootTemplateIfNeededAndDismissTransitionWithViewController:(id)arg1;
- (void)showShootTemplatePreviewRenderViewAndDismissTransition;
- (void)showShootTemplatePreviewViewControllerWithTransitionSnapshotImage:(id)arg1;
- (void)prepareShootTemplatePreviewDependenciesWithCompletion:(CDUnknownBlockType)arg1;
- (void)handleShootTemplateApplicationWillResignActive;
- (void)exitShootTemplatePreviewingMode;
- (void)cancelShootTemplatePreviewingMode;
- (void)showCancelShootTemplatePreviewAlert;
- (void)enterShootTemplatePreviewingMode;
- (id)prepareShootTemplatePreviewViewControllerWithTransitionSnapshotImage:(id)arg1;
- (id)prepareShootTemplatePreviewViewControllerIfNeeded;
- (void)showShootTemplateAppliedToastIfNeeded;
- (void)updateShootTemplateEntryVisibility;
...
- (void)updateTextPanelFancyTextWithPicker:(id)arg1 segmentID:(id)arg2;
- (void)handleTextPanelFancyTextPicker:(id)arg1 didChangeSelection:(id)arg2;
- (void)finalizeFancyTextEditingForSegmentVM:(id)arg1 leaveEditing:(_Bool)arg2;
- (void)stickerPicker:(id)arg1 didUpdateInputText:(id)arg2;
...
- (void)updateMaterialCacheWithSegmentVM:(id)arg1;
- (void)onTextEditInspectorDidFinish:(id)arg1 updateMaterialCacheWithSegmentVM:(id)arg2;
- (void)onTextEditInspectorDidFinish:(id)arg1 updateHandleBoxWithSegmentVM:(id)arg2;
...
- (void)updateTextPageSheetKeyboardAvoidanceOffset:(double)arg1 animationDuration:(double)arg2 curve:(long long)arg3;
- (void)stickerPicker:(id)arg1 keyboardWillHideWithAnimationDuration:(double)arg2 curve:(long long)arg3;
- (void)stickerPicker:(id)arg1 keyboardWillShowWithInputBottomOffset:(double)arg2 animationDuration:(double)arg3 curve:(long long)arg4;
...
- (id)mj_currentTextPagePanelViewModel;
...
- (id)setupTextPagePanelViewModelWithSegmentVM:(id)arg1 editContentType:(unsigned long long)arg2 useFancyTextNewUI:(_Bool)arg3;
...
- (void)enterTextEditingPageSheetWithSegmentVM:(id)arg1 editContentType:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
