...
@interface MMDiskUsageConfigHandler : NSObject
{
    ...
    unsigned int _m_timeIntervalWholeScan;
    unsigned int _m_timeIntervalWholeScanReport;
    unsigned int _m_timeIntervalScanCacheAndOtherDataFast;
}

@property(nonatomic) unsigned int m_timeIntervalScanCacheAndOtherDataFast; // @synthesize m_timeIntervalScanCacheAndOtherDataFast=_m_timeIntervalScanCacheAndOtherDataFast;
@property(nonatomic) unsigned int m_timeIntervalWholeScanReport; // @synthesize m_timeIntervalWholeScanReport=_m_timeIntervalWholeScanReport;
@property(nonatomic) unsigned int m_timeIntervalWholeScan; // @synthesize m_timeIntervalWholeScan=_m_timeIntervalWholeScan;
