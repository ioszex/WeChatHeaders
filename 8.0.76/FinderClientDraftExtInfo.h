...
@class EffectCreateContextInfo, FinderCropRectModel, FinderDraftInspirationSquareInfo, FinderEventInfo, FinderMJPublisherInfo, FinderMemberData, FinderMusicReportInfo, FinderTemplateCreationInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSString *clickTemplateTaskId; // @dynamic clickTemplateTaskId;
...
@property(retain, nonatomic) EffectCreateContextInfo *effectCreateContextInfo; // @dynamic effectCreateContextInfo;
...
@property(retain, nonatomic) FinderDraftInspirationSquareInfo *inspirationSquareInfo; // @dynamic inspirationSquareInfo;
...
@property(retain, nonatomic) NSString *oneClickTemplatePostId; // @dynamic oneClickTemplatePostId;
...
@property(retain, nonatomic) NSString *sourceFeedSessionBuffer; // @dynamic sourceFeedSessionBuffer;
@property(retain, nonatomic) FinderTemplateCreationInfo *templateCreationInfo; // @dynamic templateCreationInfo;
