...
@class MMFinderLiveFeedExtraInfoFetchLogic, NSArray, NSMutableArray, WCFinderLiveHomePageCtx, WCFinderLiveHomePageReportSession, WCFinderLiveHomePageViewController, WCFinderLiveStreamContainerModel;
...
- (id)feedVMAtCardIndex:(unsigned long long)arg1;
- (unsigned long long)indexOfFeed:(id)arg1;
- (unsigned long long)indexOfTid:(id)arg1;
- (_Bool)removeDataWithFeed:(id)arg1;
