...
@class MMUILabel, MMWebImageView, NSDate, NSString, UIImageView, WAAppPageSystemMsgView, WAAppPageViewModel, YYAsyncImageView;
...
@interface WAAppPageCellView
{
    ...
    MMUILabel *_appTagLabel;
    MMWebImageView *_xmaskView;
...
@property(retain, nonatomic) MMWebImageView *xmaskView; // @synthesize xmaskView=_xmaskView;
@property(retain, nonatomic) MMUILabel *appTagLabel; // @synthesize appTagLabel=_appTagLabel;
