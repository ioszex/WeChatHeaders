...
- (void)reportFeedNoticeBar:(id)arg1;
- (void)openNoticeListWithNoticeList:(id)arg1 anchorContact:(id)arg2 fromVC:(id)arg3;
- (void)fetchAndOpenNoticeListForAnchorUsername:(id)arg1 fromVC:(id)arg2;
- (void)showMoreNoticeSnackBarForAnchorUsername:(id)arg1 noticeId:(id)arg2;
- (unsigned int)currentTotalNoticeCount;
- (void)showReserveSuccessToastForAnchorUsername:(id)arg1 noticeId:(id)arg2;
