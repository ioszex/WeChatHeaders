...
@interface WCPayThirdInfoV3 : NSObject
{
    int _m_templateID;
    int _m_sceneID;
    NSString *_m_iconUrl;
    ...
    NSString *_senderrouteinfo;
    NSString *_receiverrouteinfo;
    ThirdC2CRouteInfo *_routeInfo;
    ThirdC2CRouteInfo *_senderRouteInfo;
    ThirdC2CRouteInfo *_receiverRouteInfo;
...
@property(retain, nonatomic) ThirdC2CRouteInfo *receiverRouteInfo; // @synthesize receiverRouteInfo=_receiverRouteInfo;
@property(retain, nonatomic) ThirdC2CRouteInfo *senderRouteInfo; // @synthesize senderRouteInfo=_senderRouteInfo;
@property(retain, nonatomic) ThirdC2CRouteInfo *routeInfo; // @synthesize routeInfo=_routeInfo;
@property(retain, nonatomic) NSString *receiverrouteinfo; // @synthesize receiverrouteinfo=_receiverrouteinfo;
@property(retain, nonatomic) NSString *senderrouteinfo; // @synthesize senderrouteinfo=_senderrouteinfo;
