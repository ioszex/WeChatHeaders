...
@protocol YtRawImgData_OC, YtRefBigFrame_OC;
...
@interface YtDataPack_OC
{
    ...
    NSArray<YtRefBigFrame_OC> *_big_images_data;
...
@property(retain, nonatomic) NSArray<YtRefBigFrame_OC> *big_images_data; // @synthesize big_images_data=_big_images_data;
