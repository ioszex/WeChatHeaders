...
@interface SearchResultFinderVideoPlayersCallbackApi : NSObject
{
...
- (void)onPlayProgressPlayerId:(long long)arg1 offsetSec:(long long)arg2 totalSec:(long long)arg3 completion:(CDUnknownBlockType)arg4;
