...
- (void)setMediaText:(id)arg1 imageArray:(id)arg2 sightDraft:(id)arg3 poiInfo:(id)arg4 tempSelectContacts:(id)arg5 remindContactUsernames:(id)arg6 pasteLength:(unsigned long long)arg7 withExtBean:(id)arg8 isDynamicTagEnabled:(_Bool)arg9 postCycleId:(id)arg10 internactContacts:(id)arg11 excludeSelectContacts:(id)arg12 excludeLabelNames:(id)arg13;
- (void)setText:(id)arg1 poiInfo:(id)arg2 tempSelectContacts:(id)arg3 remindContactUsernames:(id)arg4 pasteLength:(unsigned long long)arg5 withExtBean:(id)arg6 isDynamicTagEnabled:(_Bool)arg7 postCycleId:(id)arg8 internactContacts:(id)arg9 excludeSelectContacts:(id)arg10 excludeLabelNames:(id)arg11;
