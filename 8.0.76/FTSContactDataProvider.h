...
@interface FTSContactDataProvider
{
    ...
    NSMutableSet *_setSingleBlackFriendContactUserName;
    ...
    NSMutableArray *_arrBrandStickerContact;
    NSMutableArray *_arrBotContact;
...
- (id)getOpenImContact;
- (id)getGroupContact;
- (id)getBrandStickerContact;
- (id)getBrandServiceContact;
- (id)getBrandContact;
- (id)getMMSingleBlackFriendContactUserName;
- (_Bool)hasBotContactLoaded;
- (id)getMMBotContact;
