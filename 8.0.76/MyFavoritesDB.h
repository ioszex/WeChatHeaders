...
@class NSMutableSet, WCTDatabase, WCTTable;
...
@interface MyFavoritesDB : NSObject
{
    ...
    NSMutableSet *_disableBatchGetFavIdSet;
}

+ (_Bool)fixSourcePath;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableSet *disableBatchGetFavIdSet; // @synthesize disableBatchGetFavIdSet=_disableBatchGetFavIdSet;
...
- (id)getAllNoteFavIdsByTabMode:(long long)arg1 currentUserName:(id)arg2;
...
- (void)addDisableBatchGetFavId:(unsigned int)arg1;
- (id)getNeedBatchGetFavoritesItemListByType:(int)arg1 andMinUpdateTime:(unsigned int)arg2 byTabMode:(long long)arg3 currentUserName:(id)arg4;
- (id)getNextPageFavoritesItemListByType:(int)arg1 byTabMode:(long long)arg2 currentUserName:(id)arg3 andCurMinUpdateTime:(unsigned int)arg4 andPinTopFirst:(_Bool)arg5 byCurMinPinTopTime:(unsigned int)arg6;
- (id)getFirstPageFavoritesItemListByType:(int)arg1 byTabMode:(long long)arg2 currentUserName:(id)arg3 andPinTopFirst:(_Bool)arg4;
- (struct Expression)buildTabModeWhereExpression:(long long)arg1 currentUserName:(id)arg2;
- (void)dumpAllFavoritesItemsForStarTypeDebug;
- (_Bool)hasAnyStarredFavorites;
- (id)getAllStarredLocalIdToStarTypeMap;
- (id)getFavoritesItemsByUpdateSeqGreaterThan:(unsigned int)arg1;
...
- (id)getAllFavoritesItemListByType:(int)arg1;
...
- (struct Expression)applyStarTypeFilterIfNeeded:(const void *)arg1;
- (_Bool)shouldExcludeStarType;
...
- (void)attemptFixSourcePathForCdnInfo:(id)arg1;
