...
@class ContactUpdateHelper, InterceptWin, MISSING_TYPE, NSDictionary, NSString, WCPayComplianceHalfPage, WCPayInterceptWinLogic, WCPayJumpRemindControlLogic, WCPayUnionTransferConfirmCgi, WCPayUnionTransferQueryCgi;
...
@interface WCPayReveiverControlTransferControlLogic
{
    ...
    MISSING_TYPE *_recvChannelSubTitleClickInfo;
    ContactUpdateHelper *_senderNickNameHelper;
}

- (void).cxx_destruct;
@property(retain, nonatomic) ContactUpdateHelper *senderNickNameHelper; // @synthesize senderNickNameHelper=_senderNickNameHelper;
...
- (void)insertNotInGroupSystemMsg:(id)arg1;
