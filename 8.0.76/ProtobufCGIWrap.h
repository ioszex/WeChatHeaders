...
@interface ProtobufCGIWrap : NSObject
{
    ...
    struct Uin64Adapter _m_uiCandidateUin;
    double _totalTimeOut;
    unsigned long long _m_bindCellular;
...
@property(nonatomic) unsigned long long m_bindCellular; // @synthesize m_bindCellular=_m_bindCellular;
...
@property(nonatomic) struct Uin64Adapter m_uiCandidateUin; // @synthesize m_uiCandidateUin=_m_uiCandidateUin;
