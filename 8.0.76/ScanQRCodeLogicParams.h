...
@interface ScanQRCodeLogicParams : NSObject
{
    ...
    _Bool _bEnableAskAI;
    _Bool _bEnableOperatorReporter;
...
@property(nonatomic) _Bool bEnableOperatorReporter; // @synthesize bEnableOperatorReporter=_bEnableOperatorReporter;
@property(nonatomic) unsigned long long mixedSwitchValue; // @synthesize mixedSwitchValue=_mixedSwitchValue;
@property(nonatomic) _Bool bEnableAskAI; // @synthesize bEnableAskAI=_bEnableAskAI;
