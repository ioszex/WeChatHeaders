...
@class NSArray, NSData, NSMutableArray, NSMutableDictionary, NSString, SnsWeAppInfo, WCActionInfo, WCAdvertiseInfo, WCAppInfo, WCBgmInfo, WCContentItem, WCFoldSnsAdvertiseInfo, WCGameShareCardInfo, WCLiteAppInfo, WCLocationInfo, WCMicroMerchantFeedsGroup, WCMomentsFinderRecommendationInfo, WCMomentsFinderRecommendationPlaceholderContext, WCMomentsTemplateInfo, WCMusicInfo, WCObjectOperation, WCRecommendInfo, WCRedEnvelopesInfo, WCRedEnvelopesRewardInfo, WCStreamVideoInfo, WCTimelineExtBean, WCVideoFlowInfo, WCWeAppInfo;
...
@interface WCDataItem : NSObject
{
    ...
    _Bool _isWeiShang;
    _Bool _isWsPlaceHolder;
    _Bool _isFromFav;
    _Bool _isStarred;
    _Bool _hasUpdateCommentUsers;
    _Bool _isPrivate;
    ...
    WCFoldSnsAdvertiseInfo *_foldAdvertiseInfo;
...
+ (id)fromServerObject:(id)arg1 adDynamicXml:(id)arg2 dropInvalidMedia:(_Bool)arg3;
+ (id)fromServerObject:(id)arg1 adDynamicXml:(id)arg2;
+ (_Bool)tagInvalidMediaItemsIfNeeded:(id)arg1;
+ (id)fromServerObjectAllowInvalid:(id)arg1;
...
+ (void)initialize;
+ (void)PBArrayAdd_publicPhotoAccountNickName;
+ (void)PBArrayAdd_publicPhotoAccountUserName;
+ (void)PBArrayAdd_visibiltyType;
+ (void)PBArrayAdd_bgmInfo;
...
@property(nonatomic) _Bool hasUpdateCommentUsers; // @synthesize hasUpdateCommentUsers=_hasUpdateCommentUsers;
...
@property(nonatomic) long long postTipsViewType; // @synthesize postTipsViewType=_postTipsViewType;
...
@property(nonatomic) _Bool isWsPlaceHolder; // @synthesize isWsPlaceHolder=_isWsPlaceHolder;
...
@property(retain, nonatomic) WCFoldSnsAdvertiseInfo *foldAdvertiseInfo; // @synthesize foldAdvertiseInfo=_foldAdvertiseInfo;
...
@property(nonatomic) unsigned int visibiltyType; // @synthesize visibiltyType=_visibiltyType;
...
- (_Bool)saveSightDataFromSourcePath:(id)arg1 forMediaItemAtIndex:(long long)arg2;
...
- (_Bool)isWXPublicBrand;
- (unsigned long long)publicBrandFinderNewLife:(id *)arg1 outputSourceUrl:(id *)arg2;
- (_Bool)isWXPublicBrandFinderNewLife;
- (_Bool)isFold;
...
- (unsigned long long)getDispalySourceContent:(id *)arg1 outputSourceUrl:(id *)arg2 outputSourceBackupUrl:(id *)arg3 withMaxWidth:(double)arg4 withFont:(id)arg5;
- (unsigned long long)getDispalySourceContent:(id *)arg1 outputSourceUrl:(id *)arg2 outputSourceBackupUrl:(id *)arg3 withMaxWidth:(double)arg4;
...
- (_Bool)hasComplexGroup;
- (long long)getPrivacy;
- (_Bool)shouldLoadContactData;
- (_Bool)hasInteractContactList;
