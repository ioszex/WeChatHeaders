...
@property(nonatomic) _Bool disableReturn; // @synthesize disableReturn=_disableReturn;
...
- (void)getShareInfoWithContactsIfNeeded:(id)arg1;
- (void)getChatbotAttachWithContactsIfNeeded:(id)arg1;
