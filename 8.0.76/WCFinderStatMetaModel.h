...
@class NSMutableArray, NSMutableSet, NSString, OfflineModeStrategy, OriginCommentInfo, PicStats, SessionReportAdExtraInfo;
...
@interface WCFinderStatMetaModel : NSObject
{
    ...
    OfflineModeStrategy *_offlineData;
    ...
    PicStats *_picStat;
    OriginCommentInfo *_commentInfo;
...
@property(retain, nonatomic) OriginCommentInfo *commentInfo; // @synthesize commentInfo=_commentInfo;
...
@property(retain, nonatomic) OfflineModeStrategy *offlineData; // @synthesize offlineData=_offlineData;
...
@property(nonatomic) int exposeEndType; // @synthesize exposeEndType=_exposeEndType;
