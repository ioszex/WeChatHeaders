...
- (void)downloadTaskDidFinishWithMediaWrap:(id)arg1;
...
- (void)_addTaskInfoWithTidArray:(id)arg1 commentScene:(int)arg2 priority:(unsigned long long)arg3 groupID:(id)arg4 preserveOldTask:(_Bool)arg5 customMediaWrap:(CDUnknownBlockType)arg6;
- (void)addTaskInfoWithTidArray:(id)arg1 commentScene:(int)arg2 priority:(unsigned long long)arg3 groupID:(id)arg4 preserveOldTask:(_Bool)arg5 customMediaWrap:(CDUnknownBlockType)arg6;
- (void)addTaskInfoWithTidArray:(id)arg1 commentScene:(int)arg2 priority:(unsigned long long)arg3 groupID:(id)arg4 preserveOldTask:(_Bool)arg5 taskInfoType:(unsigned long long)arg6;
