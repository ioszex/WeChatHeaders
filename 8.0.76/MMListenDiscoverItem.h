...
@class MMListenCategoryItem, MMListenDiscoverItemInteractInfo, MMListenDiscoverItem_BannerInfo, MMListenDiscoverItem_NewItemMsg, MMListenDiscoverRefreshStrategy, MMListenItem, MMListenJumpInfo, MMListenRecommendInfo, MMListenSubCategoryItem, MMListenUserInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) MMListenDiscoverItem_BannerInfo *bannerInfo; // @dynamic bannerInfo;
...
@property(retain, nonatomic) MMListenDiscoverItem_NewItemMsg *newItemMsg; // @dynamic newItemMsg;
