...
@class CMessageWrap, EmoticonBoardView, MMGrowTextView, MMTipsViewController, MMUILabel, NSMutableArray, NSMutableDictionary, NSString, ReportVoiceResultMgr, StreamVoiceInputControlView, StreamVoiceInputLogic, StreamVoiceInputPrepareView, UIButton, UIImageView, UILabel, UIView, WCInputController, WXKeyBoardEduBannerView;
...
@interface StreamVoiceInputViewController
{
    ...
    WXKeyBoardEduBannerView *_keyboardTipsView;
    UILabel *_voiceInputTitleLabel;
...
@property(retain, nonatomic) UILabel *voiceInputTitleLabel; // @synthesize voiceInputTitleLabel=_voiceInputTitleLabel;
@property(retain, nonatomic) WXKeyBoardEduBannerView *keyboardTipsView; // @synthesize keyboardTipsView=_keyboardTipsView;
...
- (void)reportKeyboardPromoteEvent:(id)arg1;
- (void)jumpToPlugin;
