...
@class CMMotionManager, MMObject, MMWindowController, MemoryMappedKV, NSArray, NSDictionary, NSLock, NSMutableArray, NSMutableDictionary, NSString, SightDraftMgr, UIImage, WCSightCameraBeautyConfig, WXSourceColorProperties;
...
@interface SightFacade
{
    ...
    NSMutableDictionary *_reportDataOfCameraException;
...
+ (id)stringFromSubType:(long long)arg1;
+ (id)stringFromMainType:(long long)arg1;
...
@property(retain, nonatomic) NSMutableDictionary *reportDataOfCameraException; // @synthesize reportDataOfCameraException=_reportDataOfCameraException;
...
- (void)setFrameByFramePhotographyForWideAngle:(_Bool)arg1;
- (_Bool)exptOfAutoMacroSwitchFunctionEnabled;
...
- (_Bool)checkSWTranscodingChange:(id)arg1 InputViodeoPrams:(struct WxVideoTransParaABA)arg2 OutViodeoPrams:(struct WxVideoTransParaABA)arg3 scene:(unsigned long long)arg4 controlParams:(struct ABAControlParams)arg5;
...
- (void)exportVideoWithCompressArgs:(id)arg1;
...
- (_Bool)isVideoShouldExportWithoutCompressByAsset:(id)arg1 assetURL:(id)arg2 scene:(unsigned long long)arg3 encodeJson:(id)arg4;
- (_Bool)isVideoShouldExportWithoutCompressByAsset:(id)arg1 assetURL:(id)arg2 scene:(unsigned long long)arg3;
...
- (unsigned long long)sceneOfSightCamera;
...
- (_Bool)isEnableHardHEVCEncode:(unsigned long long)arg1;
...
- (id)addressOfObject;
- (unsigned int)continousCaptureID;
...
@property(nonatomic) _Bool isTakingPhoto; // @synthesize isTakingPhoto=m_isTakingPhoto;
...
- (_Bool)isC2CScene:(unsigned long long)arg1;
...
- (void)reportCameraExceptionWithMainType:(long long)arg1 subType:(long long)arg2 extraData:(id)arg3;
- (void)reportCameraExceptionWithMainType:(long long)arg1 subType:(long long)arg2;
- (void)reportCompressSuccess:(_Bool)arg1 scene:(unsigned long long)arg2 encodeType:(long long)arg3 isUsingMAV:(_Bool)arg4 isSWRetry:(_Bool)arg5 isHWRetry:(_Bool)arg6 isEnableHEVC:(_Bool)arg7 isSoftEncHEVC:(_Bool)arg8 videoDuration:(unsigned long long)arg9 compressCost:(unsigned long long)arg10;
