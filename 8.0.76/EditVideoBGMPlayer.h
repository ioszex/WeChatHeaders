...
@interface EditVideoBGMPlayer : NSObject
{
    ...
    _Bool _asyncSessionCategroy;
    _Bool _hasReadyToPlayObserver;
    _Bool _hasStartedPlaying;
    id <EditVideoBGMPlayerDelegate> _delegate;
    AVPlayer *_player;
    NSString *_currentLocalFilePath;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *currentLocalFilePath; // @synthesize currentLocalFilePath=_currentLocalFilePath;
...
@property(nonatomic) _Bool asyncSessionCategroy; // @synthesize asyncSessionCategroy=_asyncSessionCategroy;
