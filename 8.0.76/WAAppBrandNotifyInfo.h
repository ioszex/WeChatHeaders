...
@interface WAAppBrandNotifyInfo : NSObject
{
    ...
    _Bool _syncCheckDemoInfo;
    unsigned int _type;
    unsigned int _debugStartTime;
    unsigned int _debugEndTime;
    unsigned int _from;
    unsigned int _debugDevKey;
    unsigned int _withoutToast;
    unsigned int _checkDemoBasicInfoVersion;
    NSString *_appid;
    NSString *_username;
    NSString *_debugURL;
    NSString *_checkSum;
    ...
    NSString *_checkDemoNickName;
}

+ (void)initialize;
+ (void)PBArrayAdd_checkDemoBasicInfoVersion;
+ (void)PBArrayAdd_checkDemoNickName;
+ (void)PBArrayAdd_syncCheckDemoInfo;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int checkDemoBasicInfoVersion; // @synthesize checkDemoBasicInfoVersion=_checkDemoBasicInfoVersion;
@property(copy, nonatomic) NSString *checkDemoNickName; // @synthesize checkDemoNickName=_checkDemoNickName;
@property(nonatomic) _Bool syncCheckDemoInfo; // @synthesize syncCheckDemoInfo=_syncCheckDemoInfo;
@property(nonatomic) unsigned int withoutToast; // @synthesize withoutToast=_withoutToast;
