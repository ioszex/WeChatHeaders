...
@class MMFinderLiveKTVBeginContentView, MMFinderLiveKTVEmptyContentView, MMFinderLiveKTVEndContentView, MMFinderLiveKTVSingingContentView, MMFinderLiveTask, MMLiveKtvUserView, NSString, WCFinderLiveAnchorLogReporter;
...
@interface MMFinderLiveKTVMusicContainerView
{
    ...
    CDUnknownBlockType _userDoubleTappedBlock;
    CDUnknownBlockType _userLongPressBeganBlock;
    CDUnknownBlockType _userLongPressEndedBlock;
    CDUnknownBlockType _userMicMutedBtnTappedBlock;
    CDUnknownBlockType _userContactUpdateBlock;
    CDUnknownBlockType _userHeadMovedCallback;
...
@property(copy, nonatomic) CDUnknownBlockType userHeadMovedCallback; // @synthesize userHeadMovedCallback=_userHeadMovedCallback;
@property(copy, nonatomic) CDUnknownBlockType userContactUpdateBlock; // @synthesize userContactUpdateBlock=_userContactUpdateBlock;
...
@property(copy, nonatomic) CDUnknownBlockType userLongPressEndedBlock; // @synthesize userLongPressEndedBlock=_userLongPressEndedBlock;
@property(copy, nonatomic) CDUnknownBlockType userLongPressBeganBlock; // @synthesize userLongPressBeganBlock=_userLongPressBeganBlock;
@property(copy, nonatomic) CDUnknownBlockType userDoubleTappedBlock; // @synthesize userDoubleTappedBlock=_userDoubleTappedBlock;
...
- (void)onLiveKTVUserView:(id)arg1 contactUpdate:(id)arg2;
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;
- (void)onLiveKTVUserView:(id)arg1 micMutedButtonTappedWithUserInfo:(id)arg2;
- (void)onLiveKtvUserViewAvatarLongPressEnded:(id)arg1 targetView:(id)arg2;
- (void)onLiveKtvUserViewAvatarLongPressBegan:(id)arg1 targetView:(id)arg2 micUserInfo:(id)arg3;
- (void)onLiveKtvUserViewAvatarDoubleTapped:(id)arg1 touchPoint:(struct CGPoint)arg2 targetView:(id)arg3 micUserInfo:(id)arg4;
...
- (void)onLiveTaskId:(id)arg1 ktvState:(id)arg2 nextSongUniqueIdUpdated:(id)arg3;
...
- (void)onLiveTaskId:(id)arg1 ktvState:(id)arg2 onlySingSegment:(_Bool)arg3;
