...
@interface WCFinderRedDotTipsShowInfo : NSObject
{
    ...
    _Bool _ignoreSameAvatarAvoidance;
    _Bool _ignoreTwoLinesAvoidance;
    ...
    NSString *_avatarInfoHash;
}

+ (unsigned long long)getTargetEntrySceneFromPath:(id)arg1;
+ (id)showInfoWith:(id)arg1 tipsUuid:(id)arg2;
+ (void)initialize;
+ (void)PBArrayAdd_avatarInfoHash;
+ (void)PBArrayAdd_ignoreTwoLinesAvoidance;
+ (void)PBArrayAdd_ignoreSameAvatarAvoidance;
...
- (void).cxx_destruct;
@property(copy, nonatomic) NSString *avatarInfoHash; // @synthesize avatarInfoHash=_avatarInfoHash;
@property(nonatomic) _Bool ignoreTwoLinesAvoidance; // @synthesize ignoreTwoLinesAvoidance=_ignoreTwoLinesAvoidance;
@property(nonatomic) _Bool ignoreSameAvatarAvoidance; // @synthesize ignoreSameAvatarAvoidance=_ignoreSameAvatarAvoidance;
...
- (void)bindNonDSLRedDotModel:(id)arg1 entryAvailableWidth:(double)arg2 entryScene:(unsigned long long)arg3 avoidanceConfigTag:(id)arg4;
- (void)bindDSLRedDotModel:(id)arg1 entryAvailableWidth:(double)arg2 entryScene:(unsigned long long)arg3 avoidanceConfigTag:(id)arg4;
- (id)getEntranceReportRedDotExtInfo;
- (id)getReportRedDotExt;
- (id)checkToReturnRedDotExtReportInfo;
- (id)redDotReportExtInfoByObjectId:(unsigned long long)arg1 objectNonceId:(id)arg2 displayTabType:(int)arg3 userName:(id)arg4 ctrlExtInfo:(id)arg5;
- (id)redDotReportExtInfoByObjectId:(unsigned long long)arg1 ctrlExtInfo:(id)arg2;
...
- (id)tipsLiveRecentWatchAndSubscriptionExtInfo;
