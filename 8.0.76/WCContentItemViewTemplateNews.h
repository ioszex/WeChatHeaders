...
@class MMImageGridView, NSString, RichTextView, SightIconView, UIImageView, UILabel, WCBizAppReaderMessageBigPicView, WCBizAppReaderMessageBigPicViewModel, WCImageView;
...
@interface WCContentItemViewTemplateNews
{
    ...
    double _targetWidth;
    _Bool _cardStyleOptimization;
    SightIconView *_videoIconView;
    WCImageView *_chatBotFallbackImageView;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool cardStyleOptimization; // @synthesize cardStyleOptimization=_cardStyleOptimization;
...
@property(retain, nonatomic) WCImageView *chatBotFallbackImageView; // @synthesize chatBotFallbackImageView=_chatBotFallbackImageView;
