...
@interface MMFinderLiveCDNPlayerMicLogic : NSObject
{
    ...
    unsigned long long _cdnPlayerViewScene;
    NSString *_micTopic;
    unsigned long long _micTopicVersion;
    NSString *_micTopicTitle;
    MMFinderLiveConnectMicUsersInfo *_lastMicUsersInfoBeforeMinimize;
...
@property(retain, nonatomic) MMFinderLiveConnectMicUsersInfo *lastMicUsersInfoBeforeMinimize; // @synthesize lastMicUsersInfoBeforeMinimize=_lastMicUsersInfoBeforeMinimize;
...
@property(nonatomic) unsigned long long cdnPlayerViewScene; // @synthesize cdnPlayerViewScene=_cdnPlayerViewScene;
...
- (_Bool)updateMicTopicTitle:(id)arg1;
- (void)updateWithLastMicUsersInfoBeforeMinimize:(id)arg1 isVideoLandscapeMode:(_Bool)arg2;
...
- (void)checkLiveStatusOnDisconnect;
