...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderPoiStreamFromMpItem, MISSING_TYPE, NSData, NSString;
...
@property(retain, nonatomic) FinderPoiStreamFromMpItem *fromMpItem; // @dynamic fromMpItem;
