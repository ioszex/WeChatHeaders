...
@interface MMMsgContentTipsItem : NSObject
{
    ...
    _Bool _showBorder;
    _Bool _enableRoomTipsBarDynamicOrder;
    _Bool _joinedRoomTipsBar;
...
@property(nonatomic) _Bool joinedRoomTipsBar; // @synthesize joinedRoomTipsBar=_joinedRoomTipsBar;
@property(nonatomic) _Bool enableRoomTipsBarDynamicOrder; // @synthesize enableRoomTipsBarDynamicOrder=_enableRoomTipsBarDynamicOrder;
...
- (long long)compareTipsBarDisplayPriorityWithItem:(id)arg1;
- (id)description;
- (id)init;
