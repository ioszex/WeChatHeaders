...
@interface CdnComMgr
{
    ...
    struct Config {
        ...
        basic_string_911c138e video_private_protocol_approved_hostlist;
...
+ (id)GetDebugIP:(id)arg1;
+ (id)getMediaDownloadReportInfo:(id)arg1;
...
- (_Bool)StartUploadDeviceRankCheckInImage:(id)arg1;
- (_Bool)StartUploadDeviceRankCover:(id)arg1;
- (_Bool)startUploadDeviceRankStoreMedia:(id)arg1 appType:(int)arg2 fileType:(int)arg3;
...
- (_Bool)StartUploadFinderVideoWithTaskInfo:(id)arg1 cdnHeaderParamType:(unsigned long long)arg2 preUploadAction:(_Bool)arg3;
...
- (_Bool)StartUploadFinderImageWithTaskInfo:(id)arg1 cdnHeaderParamType:(unsigned long long)arg2 preUploadAction:(_Bool)arg3;
...
- (_Bool)StartUploadAppAttach:(id)arg1 IsLargeFile:(_Bool)arg2 FileMd5:(id)arg3 enableHitCheck:(_Bool)arg4 filekey:(id)arg5;
...
- (list_223aff82)getCGIAndCDNConnectSpeedInfoWithRecentSeconds:(int)arg1 limitCount:(int)arg2;
