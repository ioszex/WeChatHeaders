...
+ (id)fromList:(id)arg1;
+ (id)makeWithUserName:(id)arg1 addContactScene:(id)arg2 openArticleFromScene:(id)arg3 enterTarget:(id)arg4 bizFinderExtraData:(id)arg5 articleUrl:(id)arg6 bizFromScene:(id)arg7 traceParent:(id)arg8;
- (void).cxx_destruct;
@property(copy, nonatomic) NSString *traceParent; // @synthesize traceParent=_traceParent;
