...
@class NSArray, NSString, WAAuthPageSheetViewModel;
...
@interface WASubscriptionMessagePageSheetMessageItem
{
    ...
    WAAuthPageSheetViewModel *_parentViewModel;
}

- (void).cxx_destruct;
@property(nonatomic) int templateType; // @synthesize templateType=_templateType;
@property(nonatomic) __weak WAAuthPageSheetViewModel *parentViewModel; // @synthesize parentViewModel=_parentViewModel;
...
- (id)initWithSnapshotDict:(id)arg1;
- (id)initWith:(id)arg1;
