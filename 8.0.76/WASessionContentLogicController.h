...
@interface WASessionContentLogicController
{
    ...
    NSString *_miniGameKFPaymentTraceId;
    unsigned long long _miniGameKFPaymentReportedMessageCount;
...
@property(nonatomic) unsigned long long miniGameKFPaymentReportedMessageCount; // @synthesize miniGameKFPaymentReportedMessageCount=_miniGameKFPaymentReportedMessageCount;
@property(copy, nonatomic) NSString *miniGameKFPaymentTraceId; // @synthesize miniGameKFPaymentTraceId=_miniGameKFPaymentTraceId;
...
- (void)configureMiniGameCustomerServicePaymentTraceWithScene:(unsigned int)arg1 appId:(id)arg2 username:(id)arg3;
- (void)pushNotSupportedPage;
...
- (void)reportMiniGameCustomerServicePaymentTraceStep2IfNeeded:(id)arg1;
