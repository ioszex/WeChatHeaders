...
+ (id)getDataSizeDescription:(unsigned long long)arg1;
...
+ (id)chatBotCardWrapFromMsgWrap:(id)arg1;
...
+ (void)fixAppMsgFileSource:(id)arg1 scene:(unsigned int)arg2 forwardType:(unsigned int)arg3;
...
+ (id)dumpData:(id)arg1 localID:(unsigned int)arg2 fileExtension:(id)arg3 logTag:(id)arg4;
+ (id)dumpBaseDirectory;
+ (id)dumpLegacyBaseDirectory;
+ (id)dumpForwardContentData:(id)arg1 fileExtension:(id)arg2 localID:(unsigned int)arg3;
