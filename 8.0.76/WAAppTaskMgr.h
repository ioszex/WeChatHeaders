...
@class MMTimer, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSString, TencentLBSLocation, WAMemoryPressureRecord, WAThreadSafeMutableDictionary;
...
@interface WAAppTaskMgr
{
    ...
    NSMutableDictionary *_dicWindowTaskData;
    NSMutableDictionary *_dicPreloaderContext;
    WAThreadSafeMutableDictionary *_dicAppID2Task;
    NSString *_currentMatrixScene;
    TencentLBSLocation *_locationCache;
}

+ (_Bool)isWindowTaskKey:(id)arg1;
+ (id)getWindowTaskKeyWithAppId:(id)arg1 username:(id)arg2 debbugMode:(unsigned int)arg3;
+ (id)genTitleTailWithDebugMode:(unsigned int)arg1;
+ (id)createManuallyMinimizeTaskData:(id)arg1 completion:(CDUnknownBlockType)arg2;
+ (id)createStatusMinimizeTaskData:(id)arg1;
+ (_Bool)isManuallyTaskKey:(id)arg1;
+ (_Bool)isStatusMinimizedTaskKey:(id)arg1;
+ (id)getManuallyMinimizedTaskKeyWithAppID:(id)arg1 debugMode:(unsigned int)arg2;
+ (id)getStatusMinimizedTaskKeyWithAppID:(id)arg1 debugMode:(unsigned int)arg2;
...
@property(retain, nonatomic) NSMutableDictionary *dicPreloaderContext; // @synthesize dicPreloaderContext=_dicPreloaderContext;
@property(retain, nonatomic) NSMutableDictionary *dicWindowTaskData; // @synthesize dicWindowTaskData=_dicWindowTaskData;
...
- (id)__rawImageForUsername:(id)arg1 debugModeType:(unsigned long long)arg2;
- (id)__decodedImageForUsername:(id)arg1 debugModeType:(unsigned long long)arg2;
- (id)getSnapShotImageForUsername:(id)arg1 debugModeType:(unsigned long long)arg2;
- (void)deleteTaskSnaphotImageForUsername:(id)arg1 debugModeType:(unsigned long long)arg2;
- (void)evictOldSnapshotFiles;
- (void)asyncSaveSnapShotImage:(id)arg1 forUsername:(id)arg2 debugModeType:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)closeGameTaskOnNavigationController:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)closeSilentOpenTaskIfNeededWithUsername:(id)arg1 appid:(id)arg2;
...
- (void)maximizeWindowTask:(id)arg1;
- (void)maximizeStatusTask:(id)arg1;
- (void)handleRegularMinimizationForTask:(id)arg1;
- (void)handleWindowMinimizedModeForTask:(id)arg1;
- (_Bool)checkNeedToMaximizeTask:(id)arg1 openInfo:(id)arg2;
- (void)inner_openAppTaskWithContact:(id)arg1 openInfo:(id)arg2 extInfo:(id)arg3 handlerWrapper:(id)arg4;
...
- (void)dealloc;
- (id)init;
- (void)scheduleToPopupMinimizeEduWithAppTask:(id)arg1;
...
- (void)openWeAppInManuallyMode:(id)arg1 openContext:(id)arg2 weappNav:(id)arg3;
- (void)openWeAppWithOpenData:(id)arg1 minimizedMode:(unsigned long long)arg2 transitionContext:(id)arg3 taskExtInfo:(id)arg4;
- (void)openWeAppWithOpenData:(id)arg1 minimizedMode:(unsigned long long)arg2;
- (_Bool)onEnterMinimizedTask:(id)arg1 openContext:(id)arg2 taskEnterScene:(unsigned int)arg3;
- (_Bool)handleEnterWindowMinimizedTask:(id)arg1 openContext:(id)arg2 taskEnterScene:(unsigned int)arg3;
- (id)windowMinimizeTaskDataFromAppTask:(id)arg1;
- (void)removeWindowAppTaskForTaskBizKey:(id)arg1;
- (void)removeWindowAppTask:(id)arg1;
- (_Bool)maximizeWindowAppTask:(id)arg1 preloaderContext:(id)arg2;
- (_Bool)maximizeWindowAppTask:(id)arg1;
- (void)windowMinimizeAppTask:(id)arg1 generateType:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)windowMinimizeAppTask:(id)arg1 generateType:(unsigned long long)arg2;
...
- (_Bool)maximizeStatusMinimizedTask:(id)arg1;
- (void)removeManuallyMinimizedTask:(id)arg1;
- (void)removeStatusMinimizedTask:(id)arg1;
- (_Bool)updateSnapShotImg:(id)arg1 appTask:(id)arg2 snapshotImage:(id)arg3;
- (_Bool)updateSnapShotImg:(id)arg1 appTask:(id)arg2;
- (_Bool)updateManuallyMinimizeSnapShotImg:(id)arg1;
- (void)doFakeMinimizeAnimationWithTask:(id)arg1;
- (void)manuallyMinimizeAppTask:(id)arg1 generateType:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)statusMinimizeAppTask:(id)arg1 generateType:(unsigned long long)arg2;
- (_Bool)isAppTaskUpdatingBackgroundLocation:(id)arg1;
- (_Bool)isAppTaskHasBackgroundResourceActivity:(id)arg1;
- (_Bool)isTaskBizKeyWindowMinimized:(id)arg1;
- (_Bool)isAppTaskWindowMinimized:(id)arg1;
- (_Bool)isAppTaskManuallyMinimized:(id)arg1;
- (_Bool)isAppTaskStatusMinimized:(id)arg1;
- (_Bool)isAppTaskMinimized:(id)arg1;
- (void)checkCanAddWindowMinimizeAppTask:(id)arg1 confirmedBlock:(CDUnknownBlockType)arg2;
- (_Bool)canManuallyMinimizeAppTaskOrShowTips:(id)arg1;
