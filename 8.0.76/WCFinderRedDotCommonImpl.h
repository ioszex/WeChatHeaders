...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderBaseCgi;
...
@interface WCFinderRedDotCommonImpl : NSObject
{
    ...
    NSDictionary *_cachedFindPage20411FinalExtInfo;
...
+ (long long)getDiscoveryRedDotBusinessTypeMask;
...
@property(retain, nonatomic) NSDictionary *cachedFindPage20411FinalExtInfo; // @synthesize cachedFindPage20411FinalExtInfo=_cachedFindPage20411FinalExtInfo;
