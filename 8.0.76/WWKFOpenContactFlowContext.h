...
@interface WWKFOpenContactFlowContext : NSObject
{
    ...
    _Bool _skipContactUpdateOnWillPush;
    int _scene;
...
@property(nonatomic) _Bool skipContactUpdateOnWillPush; // @synthesize skipContactUpdateOnWillPush=_skipContactUpdateOnWillPush;
