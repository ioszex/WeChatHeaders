...
@interface BrandTimelineMsgDB : NSObject
{
    ...
    WCTTable *m_tableBizPhotoNotification;
...
- (_Bool)handleMergeNotification:(id)arg1 dbMsgWrap:(id)arg2 serviceType:(long long)arg3;
- (_Bool)handleMergeNotification:(id)arg1 dbMsgWrap:(id)arg2;
- (_Bool)updateDBMsgWrap:(id)arg1 serviceType:(long long)arg2;
- (_Bool)insertDBMsgWrap:(id)arg1 isMerged:(_Bool)arg2 serviceType:(long long)arg3;
- (_Bool)insertDBMsgWrap:(id)arg1 isMerged:(_Bool)arg2;
...
- (_Bool)updateMainSessionNotificationMsgWrapShouldShowPriorityNotification:(_Bool)arg1 byMsgSvrId:(unsigned long long)arg2 serviceType:(long long)arg3;
- (_Bool)updateMainSessionNotificationMsgWrapShouldShowPriorityNotification:(_Bool)arg1 byMsgSvrId:(unsigned long long)arg2;
- (_Bool)updateMainSessionNotificationMsgWrapIsClickPriorityNotificationInTL:(_Bool)arg1 byMsgSvrId:(unsigned long long)arg2 serviceType:(long long)arg3;
- (_Bool)updateMainSessionNotificationMsgWrapIsClickPriorityNotificationInTL:(_Bool)arg1 byMsgSvrId:(unsigned long long)arg2;
- (_Bool)updateMainSessionMsgWrapOnDisappear:(id)arg1 exposeTimeMs:(unsigned int)arg2 serviceType:(long long)arg3;
- (_Bool)updateMainSessionMsgWrapOnDisappear:(id)arg1 exposeTimeMs:(unsigned int)arg2;
- (_Bool)updateMainSessionMsgWrapOnExpose:(id)arg1 serviceType:(long long)arg2;
...
- (_Bool)setNotificationDelFlagForUsername:(id)arg1 serviceType:(long long)arg2;
...
- (_Bool)insertNotification:(id)arg1 serviceType:(long long)arg2;
- (_Bool)insertNotification:(id)arg1;
- (id)getNotificationByMsgSvrId:(unsigned long long)arg1 serviceType:(long long)arg2;
- (id)getNotificationByMsgSvrId:(unsigned long long)arg1;
- (id)getNotificationByMsgSvrId:(unsigned long long)arg1 userName:(id)arg2 serviceType:(long long)arg3;
- (id)getNotificationByMsgSvrId:(unsigned long long)arg1 userName:(id)arg2;
- (id)getLastSameNotifyMsgIdUnreadNotification:(id)arg1;
...
- (id)getNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3 serviceType:(long long)arg4;
- (id)getNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3 needFoldMessage:(_Bool)arg4 serviceType:(long long)arg5;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3 needFoldMessage:(_Bool)arg4;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3 serviceType:(long long)arg4;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 leftCount:(unsigned int *)arg3;
- (unsigned int)getNotificationUnreadCountByUserName:(id)arg1 serviceType:(long long)arg2;
...
- (id)getTableForServiceType:(long long)arg1;
