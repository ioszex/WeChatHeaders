...
@interface WCFinderFullInteractivePanelView : UIView
{
    ...
    _Bool _feedTopRightJumpInfoHiddenForSpeed;
    ...
    UIView *_profileAdToastView;
    UIView *_feedTopRightCustomPromptView;
    unsigned long long _feedTopRightCustomPromptSource;
    double _feedTopRightCustomPromptDesiredWidth;
    unsigned long long _profileAdToastState;
    ...
    WCFinderCommonBottomSuspendView *_postSuspendJumpInfoBubbleView;
...
@property(nonatomic) __weak WCFinderCommonBottomSuspendView *postSuspendJumpInfoBubbleView; // @synthesize postSuspendJumpInfoBubbleView=_postSuspendJumpInfoBubbleView;
...
@property(nonatomic) unsigned long long profileAdToastState; // @synthesize profileAdToastState=_profileAdToastState;
@property(nonatomic) double feedTopRightCustomPromptDesiredWidth; // @synthesize feedTopRightCustomPromptDesiredWidth=_feedTopRightCustomPromptDesiredWidth;
@property(nonatomic) unsigned long long feedTopRightCustomPromptSource; // @synthesize feedTopRightCustomPromptSource=_feedTopRightCustomPromptSource;
@property(nonatomic) __weak UIView *feedTopRightCustomPromptView; // @synthesize feedTopRightCustomPromptView=_feedTopRightCustomPromptView;
@property(nonatomic) _Bool feedTopRightJumpInfoHiddenForSpeed; // @synthesize feedTopRightJumpInfoHiddenForSpeed=_feedTopRightJumpInfoHiddenForSpeed;
@property(retain, nonatomic) UIView *profileAdToastView; // @synthesize profileAdToastView=_profileAdToastView;
...
- (void)layoutFollowButton:(id)arg1;
- (struct CGRect)followButtonFrameInView:(id)arg1;
- (void)attachFollowButton:(id)arg1;
...
- (_Bool)isShowingTips;
- (void)autoDismissLastTips;
- (void)dislikeTipsClickAction;
- (_Bool)showDislikeEduTipsIfNeeded;
- (_Bool)dislikeEduTipsEnable;
...
- (void)recoverProfileAdCustomTopRightJumpInfoAfterToastIfNeededWithContentVM:(id)arg1;
- (void)showProfileAdCustomTopRightJumpInfoWithContentTid:(id)arg1 animated:(_Bool)arg2;
- (void)hideProfileAdCustomTopRightJumpInfoForToastIfNeededWithContentTid:(id)arg1;
- (_Bool)isProfileAdCustomTopRightJumpInfoView:(id)arg1;
- (void)updateProfileAdToastViewPosition:(id)arg1;
- (void)updateProfileAdToastViewPosition;
- (void)removeProfileAdToastView;
- (void)clearProfileAdToastViewAndShowCustomTopRightJumpInfo:(_Bool)arg1 animated:(_Bool)arg2;
- (void)resetProfileAdToastForNextExposeAndShowCustomTopRightJumpInfoIfNeeded;
- (_Bool)interruptProfileAdToastAndShowCustomTopRightJumpInfoIfNeeded;
- (void)dismissProfileAdToastView;
- (void)showProfileAdToastWithContentVM:(id)arg1;
- (void)tryShowProfileAdToastWithContentVM:(id)arg1;
- (void)prepareProfileAdToastViewIfNeededWithContentVM:(id)arg1;
- (void)prepareAndTryShowProfileAdToastWithContentVM:(id)arg1;
- (void)updateProfileAdCustomTopRightJumpInfoForToastStateWithContentVM:(id)arg1;
- (_Bool)shouldHideProfileAdCustomTopRightJumpInfoForToastWithContentVM:(id)arg1;
- (void)updateFeedTopRightJumpInfoHiddenForSpeed:(_Bool)arg1;
- (_Bool)hasValidProfileAdToastInfoWithContentVM:(id)arg1;
- (void)tryShowProfileAdToastForCurrentExpose;
- (void)resetProfileAdToastForNextExposeAndHideJumpInfo;
- (void)resetProfileAdToastForNextExpose;
- (void)clearToastView;
...
- (void)setBottomSuspendBubbleBackgroundAlpha:(double)arg1;
...
- (void)refreshWarningViewZOrderForInlineStickerAd;
...
- (void)setAllViewAlpha:(double)arg1 except:(id)arg2;
...
- (void)recoverAllJumpInfoView;
- (void)hideAllJumpInfoView;
...
- (void)onDidClickToolbarLikeAction:(id)arg1 isPrivateLike:(_Bool)arg2 preLikeFlag:(int)arg3;
- (void)updateToolbarContentWithContentVM:(id)arg1 privateStateChange:(_Bool)arg2;
- (void)tryPerformAvatarShootingAnimationWithLikeFlag:(int)arg1 likeList:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)clickAvatarWithContact:(id)arg1;
- (void)onClickCreateTimeLabel;
...
- (void)_layoutFeedTopRightPromptView:(id)arg1 desiredWidth:(double)arg2;
- (void)_layoutActiveFeedTopRightPromptIfNeeded;
- (id)_activeFeedTopRightPromptView;
- (double)_feedTopRightPromptMaxAllowedWidth;
- (double)_feedTopRightPromptCenterY;
- (double)_feedTopRightPromptSafeLeft;
- (double)_feedTopRightPromptVisibleRight;
- (id)_feedTopRightPromptCoordinateView;
- (double)jumpInfoPanelViewMaxWidthOnShowPosition:(int)arg1;
- (id)genJumpInfoPanelViewOnShowPosition:(int)arg1 width:(double)arg2;
- (void)offsetFeedTopRightPromptWithPanelOffset:(double)arg1;
- (void)updateFeedTopRightPromptView:(id)arg1 source:(unsigned long long)arg2 desiredWidth:(double)arg3;
...
- (void)recoverFromShowOnlyModeIfNeeded;
- (void)showOnlyHeaderViewAndToolBarWithOnRecover:(CDUnknownBlockType)arg1;
