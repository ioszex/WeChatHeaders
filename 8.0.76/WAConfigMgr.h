...
@class MISSING_TYPE, MemoryMappedKV, NSArray, NSDictionary, NSMutableDictionary, NSRecursiveLock, NSString, WAAppBrandNotifyStorage, WAAppBrandPluginNotifyStorage, WAEnableCopyPathMenuNotifyStorage, WAPackageSweeperLogic;
...
@interface WAConfigMgr
{
    ...
    MemoryMappedKV *_mbUserEnvVersionKv;
    _Bool _forceReportGamePerf;
    _Bool _overrideEntryPagePath;
    _Bool _preloadGamePowerSavingModeEnableCached;
    _Bool _preloadGamePowerSavingModeEnableValue;
    NSDictionary *_dicSystemConfig;
    WAPackageSweeperLogic *_pkgSweeperLogic;
    NSMutableDictionary *_tagsInfo;
    NSArray *_ignoreFreqIdKeyProtocolArray;
    NSArray *_ignoreFreqKeyValueProtocolArray;
...
+ (void)clearGamePowerSavingMode:(id)arg1;
+ (_Bool)hitPlayableListWithAppID:(id)arg1;
...
+ (int)benchMarkLevel;
+ (_Bool)isOverSeaUser;
+ (_Bool)isKeyValueIDInUdrWhiteList:(id)arg1;
+ (_Bool)isIdKeyIDInUdrWhiteList:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool preloadGamePowerSavingModeEnableValue; // @synthesize preloadGamePowerSavingModeEnableValue=_preloadGamePowerSavingModeEnableValue;
@property(nonatomic) _Bool preloadGamePowerSavingModeEnableCached; // @synthesize preloadGamePowerSavingModeEnableCached=_preloadGamePowerSavingModeEnableCached;
...
@property(retain, nonatomic) NSArray *ignoreFreqKeyValueProtocolArray; // @synthesize ignoreFreqKeyValueProtocolArray=_ignoreFreqKeyValueProtocolArray;
@property(retain, nonatomic) NSArray *ignoreFreqIdKeyProtocolArray; // @synthesize ignoreFreqIdKeyProtocolArray=_ignoreFreqIdKeyProtocolArray;
...
- (id)getGlobalExptJson;
- (void)processGlobalExpt:(id)arg1;
...
- (_Bool)setGamePowerSavingMode:(id)arg1 gamePowerMode:(int)arg2;
- (int)getGamePowerSavingMode:(id)arg1;
- (_Bool)gamePowerSavingModeEnable;
- (_Bool)calcPreloadGamePowerSavingModeEnable;
...
- (_Bool)isAppIdInGameAvoidAutoCleanWhiteList:(id)arg1;
- (_Bool)isAppIdInAvoidAutoCleanWhiteList:(id)arg1;
- (long long)getFixBgStateLeaksByHitTestDetection;
- (_Bool)isEnableFixOverlayingPresentBgStateLeaks;
- (_Bool)isAppidForceKeepContextPageInCycleJump:(id)arg1 version:(unsigned long long)arg2 debugModeType:(unsigned long long)arg3;
- (_Bool)isAppidForceUseDebugVersion:(id)arg1;
- (_Bool)isForceUseBundlePubVersion;
- (_Bool)isWeappAgentEnable;
- (_Bool)isSpecializedAgentEnable;
...
- (_Bool)gameEnableCmdbufferCanvasNormalMode;
- (_Bool)weappEnableCmdbufferCanvas;
- (_Bool)gameEnableCmdbufferCanvas;
- (_Bool)weappEnableCmdbufferCanvas2d;
- (_Bool)weappEnableUnifiedCmdbuffer;
- (_Bool)gameEnableCmdbufferCanvas2d;
- (_Bool)gameEnableUnifiedCmdbuffer;
- (_Bool)gameEnableMultiThread;
- (long long)enableParallelShaderCompile;
- (_Bool)isForbidGameMetal;
- (_Bool)isForbidGameRemoteDebug;
...
- (id)exposeURLWithAppid:(id)arg1 msgid:(id)arg2 extraData:(id)arg3 from:(unsigned long long)arg4;
...
- (_Bool)consumeSyncCheckDemoInfoFlagForAppID:(id)arg1 debugType:(unsigned long long)arg2;
...
- (_Bool)gameRewardsForAppID:(id)arg1 versionType:(int)arg2 outBizData:(id *)arg3;
...
- (void)parsePCWxaLaunchNotify:(id)arg1;
...
- (_Bool)setMbUserEnvVersion:(unsigned int)arg1;
- (unsigned int)getMbUserEnvVersion;
...
- (void)onInitWXAFinancialLicenseTags:(id)arg1;
...
- (long long)getOpConfigInPackageForAppId:(id)arg1 path:(id)arg2 publicLibVersion:(id)arg3;
- (id)getSplashCacheInfoForAppId:(id)arg1 path:(id)arg2;
- (_Bool)findOpConfigInPackageForAppId:(id)arg1 publicLibVersion:(id)arg2;
