...
+ (void)openMPUrlWithInfo:(id)arg1 enterSource:(unsigned long long)arg2 fromVC:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
+ (void)openMPUrlWithInfo:(id)arg1 enterSource:(unsigned long long)arg2 fromVC:(id)arg3;
+ (void)openMPArticleWithInfo:(id)arg1 enterSource:(unsigned long long)arg2 fromVC:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
