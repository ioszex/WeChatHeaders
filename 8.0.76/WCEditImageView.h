...
@class CALayer, CAShapeLayer, EVVideoPreviewBrowserView, EditImageCropOverlayView, EditImageDeleteBarView, EditImageWidgetTool, MMTimer, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WCEditEraserCurserView, WCEditImageOperationMgr, WCEditImagePenTraceMgr, WCEditImageScrollView, WCEditPanGestureFilter, WCEditViewControllerUIConfig;
...
- (void)updateClipMask;
- (void)setupClipMaskLayerIfNeeded;
