...
- (id)getInteractionNotifyDisplayContent:(id)arg1 maxContentWidth:(double)arg2;
- (void)calculateSizeForGameRecommend:(id)arg1;
- (void)calculateSizeForInteractionNotify:(id)arg1;
- (void)calculateSizeForFollowNotify:(id)arg1;
- (id)getLikeV2NotifyDisplayContent:(id)arg1 maxContentWidth:(double)arg2;
- (id)getLikeNotifyDisplayContent:(id)arg1 maxContentWidth:(double)arg2;
- (void)calculateSizeForTopAreaMsg:(id)arg1;
- (void)calculateSizeForLikeNotifyV2:(id)arg1;
...
- (double)calculateTopCommentBottomBarMinWidth;
