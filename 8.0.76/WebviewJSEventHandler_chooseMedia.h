...
@class CaptureVideoInfo, NSMutableDictionary, NSString, NewLifeImagePickViewController, UIColor, UIImage, UINavigationController;
...
@interface WebviewJSEventHandler_chooseMedia
{
    ...
    NSMutableDictionary *m_indexedLocalIds;
...
@property(nonatomic) _Bool livePhotoOnly; // @synthesize livePhotoOnly=_livePhotoOnly;
...
- (void)handleImageByIndexedLocalIds:(id)arg1;
- (void)tryResponse;
