...
@class CameraRecordDevice, NSDateFormatter, NSFileHandle, NSMutableParagraphStyle, NSObject, NSString, NSTimer, NSURLSessionDataTask, UIButton, UIImageView, UILabel, UITextView, UIView, YtFLCircleProgressView;
...
- (void)fetchCosConfigAndMerge:(id)arg1 withResponseBlock:(CDUnknownBlockType)arg2;
