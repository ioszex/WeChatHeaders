...
- (void)expandStateContentTaskList;
...
- (void)confirmedRemoveTaskByCloseButton:(id)arg1 TaskBizKey:(id)arg2;
...
- (void)callMinimizeTaskDataDisappear:(id)arg1;
...
- (void)showStarAddedSnackBar;
- (_Bool)shouldSkipStarAnimationAndShowSnackBar;
