...
- (_Bool)getAllFavoritesItems:(id)arg1 byType:(int)arg2;
...
- (_Bool)getNeedBatchGetFavoritesItemList:(id)arg1 byType:(int)arg2 andMinUpdateTime:(unsigned int)arg3 byTabMode:(long long)arg4 currentUserName:(id)arg5;
...
- (_Bool)getNextPageFavoritesItemList:(id)arg1 byType:(int)arg2 byTabMode:(long long)arg3 currentUserName:(id)arg4 andCurMinUpdateTime:(unsigned int)arg5 andPinTopFirst:(_Bool)arg6 byCurMinPinTopTime:(unsigned int)arg7;
- (_Bool)getFirstPageFavoritesItemList:(id)arg1 byType:(int)arg2 byTabMode:(long long)arg3 currentUserName:(id)arg4 andPinTopFirst:(_Bool)arg5;
...
- (_Bool)updateItemInFavItemDB:(id)arg1 source:(id)arg2;
