...
@class MMTimer, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
...
@interface WCFinderTimelineReportMgr : NSObject
{
    ...
    NSMutableSet *_reportingStatsArraySet;
...
@property(retain, nonatomic) NSMutableSet *reportingStatsArraySet; // @synthesize reportingStatsArraySet=_reportingStatsArraySet;
...
- (id)statsPoolKeyWithTid:(id)arg1 commentScene:(int)arg2;
- (_Bool)shouldUseCommentSceneStatsPoolKey:(int)arg1;
- (void)dealloc;
