...
@property(nonatomic) _Bool noClickState; // @synthesize noClickState=_noClickState;
@property(nonatomic) _Bool canShowLoading; // @synthesize canShowLoading=_canShowLoading;
@property(nonatomic) _Bool circleUnselectStyle; // @synthesize circleUnselectStyle=_circleUnselectStyle;
