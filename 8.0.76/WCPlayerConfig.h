...
@interface WCPlayerConfig : NSObject
{
    ...
    _Bool _useAlbumSightProgressBar;
    _Bool _albumShowLikeComment;
...
@property(nonatomic) _Bool albumShowLikeComment; // @synthesize albumShowLikeComment=_albumShowLikeComment;
@property(nonatomic) _Bool useAlbumSightProgressBar; // @synthesize useAlbumSightProgressBar=_useAlbumSightProgressBar;
