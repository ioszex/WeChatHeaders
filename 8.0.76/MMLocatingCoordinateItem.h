...
@interface MMLocatingCoordinateItem : NSObject
{
    ...
    double _longitude;
    id _requestObj;
    NSString *_addressNameId;
    NSString *_countryCode;
    NSString *_addressCode;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *addressCode; // @synthesize addressCode=_addressCode;
@property(retain, nonatomic) NSString *countryCode; // @synthesize countryCode=_countryCode;
@property(retain, nonatomic) NSString *addressNameId; // @synthesize addressNameId=_addressNameId;
