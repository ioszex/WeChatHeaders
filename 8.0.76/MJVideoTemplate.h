...
@class MJAlbumTemplateInfo, MJCameraTemplateInfo, MJCommonTemplateInfo, MJEffectEditInfo, MJFaceIDGuideInfo, MJMultiMaterialInfo, MJTemplateDynamicInfo, MJTemplateFinderEventTopicInfo, MJTemplateFinderUserInfo, MJTemplateVersionInfo, NSData, NSString, OMJTemplateInfo;
...
+ (unsigned long long)getAITemplateTypeWithModelType:(id)arg1;
+ (_Bool)isAIImage2ImageTemplate:(id)arg1;
+ (_Bool)isAIAutoCutTemplate:(id)arg1;
+ (void)initialize;
+ (void)PBArrayAdd_effectEditInfo;
+ (void)PBArrayAdd_effectCreateScene;
+ (void)PBArrayAdd_multiMaterialInfo;
+ (void)PBArrayAdd_faceIdInfo;
...
@property(retain, nonatomic) MJFaceIDGuideInfo *faceIdInfo; // @synthesize faceIdInfo=_faceIdInfo;
