...
@interface SightCaptureLogicF4
{
    ...
    struct map<unsigned int, bool, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, bool>>> m_captureInitState;
    _Bool _needAudio;
