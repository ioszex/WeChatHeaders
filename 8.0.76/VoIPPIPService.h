...
@property(nonatomic) long long contentSourceMode; // @synthesize contentSourceMode=_contentSourceMode;
@property(nonatomic) struct CGSize contentSize; // @synthesize contentSize=_contentSize;
@property(nonatomic) _Bool isWorking; // @synthesize isWorking=_isWorking;
- (void)prepareViewForScreenProjectPIP;
- (void)feedScreenProjectPixelBuffer:(struct __CVBuffer *)arg1;
- (struct CGSize)screenProjectPreferredContentSizeWithPixelWidth:(unsigned long long)arg1 height:(unsigned long long)arg2;
- (void)ensureControllerSetupForScreenProject;
...
- (id)init;
- (_Bool)customizeSmallWindowRenderCommandEncoder:(id)arg1 withYMetalTexutre:(struct __CVBuffer *)arg2 UVMetalTexutre:(struct __CVBuffer *)arg3 bufferWidth:(double)arg4 bufferHeight:(double)arg5 contentSize:(struct CGSize)arg6 fixedSmallWindowSize:(struct CGSize)arg7 isMirror:(_Bool)arg8;
...
- (_Bool)_reloadSmallWindowVertexBufferWithWidth:(double)arg1 height:(double)arg2 isMirror:(_Bool)arg3 contentSize:(struct CGSize)arg4 fixedSmallWindowSize:(struct CGSize)arg5;
