...
- (_Bool)checkAppLockEnabled;
- (void)reportAppLockEvent:(id)arg1;
...
- (void)initLazyPhaseLaunchTask;
- (void)initNormalPhaseLaunchTask;
- (void)initHighPhaseLaunchTask;
- (void)initServiceLaunchTask;
- (void)initRootServiceObject;
...
- (void)internalSwitchToUser:(struct Uin64)arg1 completion:(CDUnknownBlockType)arg2 isVirtual:(_Bool)arg3;
- (void)virtualSwitchToUser:(struct Uin64Adapter)arg1 completion:(CDUnknownBlockType)arg2;
- (void)switchToUser:(struct Uin64Adapter)arg1 completion:(CDUnknownBlockType)arg2;
