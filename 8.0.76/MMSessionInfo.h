...
@interface MMSessionInfo : NSObject
{
    ...
    unsigned int m_uBrandCNotifyCount;
    _Bool m_bGroupUndoneFlag;
    _Bool m_bShouldUpdateTimeField;
    _Bool m_bSpecialAttention;
    _Bool m_hasMigrateRedTips;
    _Bool _m_isFolding;
    unsigned int m_uTransferCount;
    unsigned int m_uAACount;
    unsigned int m_uExclusiveHbCount;
    unsigned int m_uEcsUnhandledGiftCount;
    unsigned int m_uEcsGiftRedLabelType;
    unsigned int m_uEcsLastHandleGiftTime;
    unsigned int _sortTime;
    unsigned int _m_uAtAllCount;
    unsigned int _m_draftStatus;
    unsigned int _m_waUpdatableMsgType;
    unsigned int _m_uBrandLatestDigestType;
    ...
    NSString *_m_nsLatestUnreadNotifyMsgNickname;
...
@property(copy, nonatomic) NSString *m_nsLatestUnreadNotifyMsgNickname; // @synthesize m_nsLatestUnreadNotifyMsgNickname=_m_nsLatestUnreadNotifyMsgNickname;
@property(nonatomic) unsigned int m_uBrandLatestDigestType; // @synthesize m_uBrandLatestDigestType=_m_uBrandLatestDigestType;
@property(nonatomic) unsigned long long m_uBrandAffMsgId; // @synthesize m_uBrandAffMsgId=_m_uBrandAffMsgId;
@property(nonatomic) unsigned int m_waUpdatableMsgType; // @synthesize m_waUpdatableMsgType=_m_waUpdatableMsgType;
@property(nonatomic) unsigned int m_draftStatus; // @synthesize m_draftStatus=_m_draftStatus;
...
@property(nonatomic) unsigned int m_uBrandCNotifyCount; // @synthesize m_uBrandCNotifyCount;
@property(nonatomic) _Bool m_hasMigrateRedTips; // @synthesize m_hasMigrateRedTips;
@property(nonatomic) unsigned int m_uEcsLastHandleGiftTime; // @synthesize m_uEcsLastHandleGiftTime;
@property(nonatomic) unsigned int m_uEcsGiftRedLabelType; // @synthesize m_uEcsGiftRedLabelType;
@property(nonatomic) unsigned int m_uEcsUnhandledGiftCount; // @synthesize m_uEcsUnhandledGiftCount;
...
@property(retain) NSString *m_nsUserName; // @synthesize m_nsUserName;
- (_Bool)isChatSession;
