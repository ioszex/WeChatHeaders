...
@interface WebViewA8KeyLogicImpl
{
    ...
    NSString *_cachedProfileUserName;
    ...
    unsigned int _opensdkShareMiddlePage;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) unsigned int opensdkShareMiddlePage; // @synthesize opensdkShareMiddlePage=_opensdkShareMiddlePage;
