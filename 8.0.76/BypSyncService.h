...
@class BypSyncKeyBuff, NSDictionary, NSMutableArray, NSMutableSet, NSSet, NSString;
...
@interface BypSyncService
{
    ...
    NSDictionary *_customHandlerConfigDic;
}

+ (id)parseMsgWrapFromBypSyncItem:(id)arg1;
+ (_Bool)Origin_IsSupportMsgItemTypeWithSyncKeyType:(int)arg1;
+ (id)CustomHandlerConfig;
+ (id)OtherKnownSelectors;
- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *customHandlerConfigDic; // @synthesize customHandlerConfigDic=_customHandlerConfigDic;
