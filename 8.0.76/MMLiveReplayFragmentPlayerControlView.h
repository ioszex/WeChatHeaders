...
@class CAGradientLayer, MMLiveBlurButton, MMLiveReplayFragmentPlayerConfig, MMUIButton, MMUILabel, NSObject, NSString, SightIconView, UIButton, UILabel, UITapGestureRecognizer, UIView, WCC2CPlayerProgressBar;
...
@interface MMLiveReplayFragmentPlayerControlView
{
    ...
    MMLiveBlurButton *_publishFinderFeedButton;
...
@property(retain, nonatomic) MMLiveBlurButton *publishFinderFeedButton; // @synthesize publishFinderFeedButton=_publishFinderFeedButton;
