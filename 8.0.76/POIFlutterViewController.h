...
- (void).cxx_destruct;
@property(nonatomic) _Bool showPoiShareMp; // @synthesize showPoiShareMp=_showPoiShareMp;
@property(nonatomic) double poiDistance; // @synthesize poiDistance=_poiDistance;
...
- (void)onTapWaService:(id)arg1 weAppUrl:(id)arg2;
