...
@class BEFlutterBrandNavigator, BSTLExptConfig, BSTLMainSessionExposeItem, BSTOftenReadBizCache, BSTimelineFlutterViewController, BrandSessionCache, MMBaseSessionStorage, MMFlutterInstance, MMTimer, MemoryMappedKV, NSData, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString;
...
@interface BSTimelineMsgMgr
{
    ...
    _Bool _isBSNotifyCacheInitializing;
    _Bool _shouldCancelRedDotSessionReport;
    ...
    _Bool _isBSSessionVisibleInMainSession;
...
@property(nonatomic) _Bool isBSSessionVisibleInMainSession; // @synthesize isBSSessionVisibleInMainSession=_isBSSessionVisibleInMainSession;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: isAffHasInit
...
@property(nonatomic) _Bool shouldCancelRedDotSessionReport; // @synthesize shouldCancelRedDotSessionReport=_shouldCancelRedDotSessionReport;
...
@property _Bool isBSNotifyCacheInitializing; // @synthesize isBSNotifyCacheInitializing=_isBSNotifyCacheInitializing;
...
- (_Bool)getFirstPageBufferRefactorSwitch;
- (_Bool)getSerialResortReqSwitch;
- (unsigned int)getKeepPosEndResortSwitch;
- (id)getLocalEcsTimelineUiStrategyJsonString;
- (unsigned int)getRequestCgiBufferMaxSize;
...
- (_Bool)getShowSaArticleEntrance;
- (_Bool)getIsFoldV2NotificationByContactEnabled;
- (_Bool)getIsFoldWeakNotificationByContactEnabled;
- (_Bool)getIsFoldNotificationByContactEnabled;
...
- (void)onServiceEnterBackgroundInCategoryMainPage;
...
- (void)updateExposeTime:(unsigned long long)arg1 currentTime:(unsigned long long)arg2;
...
- (id)buildClientReddotStatusJsonWithSessionInfo:(id)arg1 boxPos:(unsigned int)arg2;
...
- (unsigned int)getBoxLastDeleteTime;
...
- (void)doInitBSNotifyCacheDataForFlutter;
