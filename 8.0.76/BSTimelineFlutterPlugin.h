...
@class BSTLExptConfig, BizBaseCallbackApi, BizEnterStatusInfo, BrandServiceCallbackApi, BrandTimelineNotifyLogic, FlutterMethodChannel, ForwardMessageLogicController, LocationRetriever, MMFlutterViewController, NSMutableSet, NSString;
...
@interface BSTimelineFlutterPlugin : NSObject
{
    ...
    FlutterMethodChannel *_poiNavChannel;
...
@property(retain, nonatomic) FlutterMethodChannel *poiNavChannel; // @synthesize poiNavChannel=_poiNavChannel;
...
- (void)isWeAppClickUserName:(id)arg1 nativeLocalId:(long long)arg2 svrMsgId:(long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)openNotiPage;
...
- (void)doSearchWithQueryQuery:(id)arg1 scene:(long long)arg2 parentSearchId:(id)arg3 searchExtParams:(id)arg4 error:(id *)arg5;
...
- (void)onMoveToTop;
- (void)dealloc;
- (void)openPoiDetailWithParams:(id)arg1 result:(CDUnknownBlockType)arg2;
