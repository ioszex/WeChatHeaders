...
@class BizPoiInfo, BizProfileV2PagingInfo, NSMutableArray;
...
@property(nonatomic) _Bool hideList; // @dynamic hideList;
...
@property(retain, nonatomic) BizPoiInfo *poiInfo; // @dynamic poiInfo;
