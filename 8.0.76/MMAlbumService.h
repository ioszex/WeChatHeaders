...
- (void)internalSaveImages:(id)arg1 toAlbumNamed:(id)arg2 exifExtraInfo:(id)arg3 exifUserComment:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;
...
- (void)saveLivePhotoToAlbumNoCheckWithImagePath:(id)arg1 videoPath:(id)arg2 successBlock:(CDUnknownBlockType)arg3 failureBlock:(CDUnknownBlockType)arg4;
...
- (void)saveImageToAlbumAndShowTipsWithArrImage:(id)arg1 exifUserComment:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)saveImageToAlbumAndShowTipsWithArrImage:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)saveImageToAlbumAndShowTipsWithImage:(id)arg1 exifUserComment:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)saveImageToAlbumAndShowTipsWithPath:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
...
- (void)saveVideoToAlbumNoCheckWithPath:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
...
- (void)writeImageToSavedArrPhotosAlbum:(id)arg1 exifUserComment:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)writeImageToSavedPhotosAlbum:(id)arg1 exifExtraInfo:(id)arg2 exifUserComment:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)writeImageToSavedPhotosAlbum:(id)arg1 exifExtraInfo:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
