...
@interface MMFinderLiveGuidePubbleTipView
{
    ...
    CDUnknownBlockType _clickOutsideBlock;
}

+ (double)caculatePubbleTipViewWidthWithType:(long long)arg1 titleText:(id)arg2;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType clickOutsideBlock; // @synthesize clickOutsideBlock=_clickOutsideBlock;
