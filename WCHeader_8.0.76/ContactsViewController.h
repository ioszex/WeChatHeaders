...
@class ContactsDataLogic, ContactsRightTopMenuBtn, FTSVoiceSearchBarController, MMMainTableView, NSArray, NSMutableArray, NSString, UILabel, WCSearchBar;
...
@interface ContactsViewController
{
    ...
    _Bool _headerSearchBarExposure;
    _Bool _enableSearchBarButton;
    _Bool _searchBarButtonShown;
    long long _curTabPageSource;
    NSArray *_favourContactArray;
    WCSearchBar *_searchBar;
    NSString *_reportSessionId;
    double _scrollLastOffsetY;
    ContactsRightTopMenuBtn *_menuBarButton;
}

- (void).cxx_destruct;
@property(retain, nonatomic) ContactsRightTopMenuBtn *menuBarButton; // @synthesize menuBarButton=_menuBarButton;
@property(nonatomic) _Bool searchBarButtonShown; // @synthesize searchBarButtonShown=_searchBarButtonShown;
@property(nonatomic) _Bool enableSearchBarButton; // @synthesize enableSearchBarButton=_enableSearchBarButton;
@property(nonatomic) _Bool headerSearchBarExposure; // @synthesize headerSearchBarExposure=_headerSearchBarExposure;
@property(nonatomic) double scrollLastOffsetY; // @synthesize scrollLastOffsetY=_scrollLastOffsetY;
...
- (id)init;
- (void)scrollViewDidScrollForReport:(id)arg1;
- (void)reportClickContacts:(id)arg1 extraDic:(id)arg2;
- (void)reportExposureContacts:(id)arg1 extraDic:(id)arg2;
...
- (void)reportClickContactsAddressbookCell:(unsigned int)arg1;
- (void)reportExposureContactsAddressbookCell:(unsigned int)arg1;
