...
- (id)initWithMicUsersCount:(unsigned long long)arg1 applyingMicUsersCount:(unsigned long long)arg2 isAudiencePkEnable:(_Bool)arg3 canBeInvitedMicUsersCount:(unsigned long long)arg4 isPaidConnectMic:(_Bool)arg5 canShowKtvSongList:(_Bool)arg6 canShowMicTopic:(_Bool)arg7 canShowLayoutBaseMode:(_Bool)arg8;
