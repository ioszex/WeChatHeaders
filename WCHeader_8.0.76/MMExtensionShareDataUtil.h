...
+ (void)saveTimelineVideoMaxDuration:(double)arg1;
+ (void)saveEnableJumpToTimelineVideoPublishPage:(_Bool)arg1;
+ (void)saveEnableJumpToTimelinePublishPage:(_Bool)arg1;
+ (void)saveEnableShareParseUrl:(_Bool)arg1;
+ (void)saveExtraUserDefaults:(id)arg1;
+ (_Bool)syncUserDefaultData;
+ (void)saveShareExtQBarAIScan:(_Bool)arg1;
+ (void)saveNSENewSyncResultFileSize:(unsigned int)arg1;
+ (void)saveNSENewSyncOpen:(_Bool)arg1;
