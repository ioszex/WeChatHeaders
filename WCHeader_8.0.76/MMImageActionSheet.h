...
@class MMImageActionAskXiaoWeiItem, MMImageActionBizShareItem, MMImageActionCircleToSearchItem, MMImageActionCropItem, MMImageActionEditItem, MMImageActionFavoriateItem, MMImageActionFileSource, MMImageActionFindTextItem, MMImageActionForwardItem, MMImageActionGameCircle, MMImageActionImageSource, MMImageActionOpenDeviceItem, MMImageActionOpenWeAppListItem, MMImageActionQRCodeItem, MMImageActionRecentForwardItem, MMImageActionSaveItem, MMImageActionSearchItem, MMImageActionSnsShareItem, MMImageActionTranslateItem, MMImageOpenWeAppLogic, MMUIViewController, NSMutableArray, NSString, UIImage, WCImageTranslateLogic;
...
@interface MMImageActionSheet
{
    ...
    MMImageActionAskXiaoWeiItem *_askXiaoWei;
    MMImageActionImageSource *_imageSource;
    NSString *_imagePath;
    UIImage *_image;
...
@property(retain, nonatomic) MMImageActionImageSource *imageSource; // @synthesize imageSource=_imageSource;
@property(retain, nonatomic) MMImageActionAskXiaoWeiItem *askXiaoWei; // @synthesize askXiaoWei=_askXiaoWei;
...
- (id)initWithAskXiaoWeiTitle:(id)arg1;
- (id)init;
