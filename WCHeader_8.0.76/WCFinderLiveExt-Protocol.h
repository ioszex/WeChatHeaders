...
@class FinderCreateLiveWarnPage, FinderJumpInfo, FinderLiveAbnormalClosedPageInfo, FinderLiveAliasInfo, FinderLiveAnchorHeaderEcInfo, FinderLiveAppMsg, FinderLiveAppMsgAlertInfo, FinderLiveAppMsgAnchorQuestUpdateInfo, FinderLiveAppMsgAudienceActionInfo, FinderLiveAppMsgBattleNotifyInfo, FinderLiveAppMsgCloseMicInfo, FinderLiveAppMsgGameCommentAnimationInfo, FinderLiveAppMsgGameInvitationInfo, FinderLiveAppMsgGameLiveTeamUpInfo, FinderLiveAppMsgGameSysNotifyInfo, FinderLiveAppMsgGiftWallTopOneInfo, FinderLiveAppMsgKtvCurrentSongInfo, FinderLiveAppMsgKtvSongListChangeInfo, FinderLiveAppMsgLevelUpUnlockGiftInfo, FinderLiveAppMsgLotteryDrawInfo, FinderLiveAppMsgPromoteStatusInfo, FinderLiveAppMsgRealnameLikeLiveInfo, FinderLiveAppMsgReplayTransition, FinderLiveAppMsgReserveOrDownloadGameInfo, FinderLiveAppMsgShopInfo, FinderLiveAppMsgSyncNewSongInfo, FinderLiveAppMsgToastInfo, FinderLiveAppMsgTopLiveDesc, FinderLiveAppMsgUpdateCheerAnimation, FinderLiveAppMsgUpdateFinderObjectInfo, FinderLiveAppMsgUpdateMultiPullStreamInfo, FinderLiveBannerData, FinderLiveBattleInfo, FinderLiveBoardEventSubTitle, FinderLiveBoxId, FinderLiveBulletin, FinderLiveButtonInfo, FinderLiveCheerInfo, FinderLiveContact, FinderLiveCoverInfo, FinderLiveErrorPage, FinderLiveFlashSaleInfo, FinderLiveFunctionReminderNotificationInfo, FinderLiveGameData, FinderLiveGameDataBannerData, FinderLiveGiftActivityInfo, FinderLiveGiftInfo, FinderLiveGiftWallInfo, FinderLiveGuideFollowAdInfo, FinderLiveGuideInfo, FinderLiveLayerAnchorVerificationShowInfo, FinderLiveMicInfo, FinderLiveMilestoneLotteryInfo, FinderLiveMilestoneLotteryMetaInfo, FinderLiveMsgBoxInfo, FinderLiveNextLiveNotificationInfo, FinderLiveNoticeInfo, FinderLiveNoticeListInfo, FinderLivePromoteExtInfo, FinderLivePromoteMsgInfo, FinderLivePromotionEntrance, FinderLiveQuestInstance_StageItem_TargetItem, FinderLiveRecallLiveRoomMsgInfo, FinderLiveShortcutWordingInfo, FinderLiveUpdateEcPromoteInfo, FinderLiveUpdateEcShopShelfInfo, FinderLiveVisibilityConfig, FinderLiveVisibilityState, FinderLiveVotingInfo, FinderObject, FinderWindowProductInfo, GameLiveJumpInfo, InteractionWishConfig, LiveRoomImg, LiveSdkInfo, MMFinderJoinLiveContext, MMFinderLiveAnchorStatusItem, MMFinderLiveCreateResponseModel, MMFinderLiveGameTeamWAGameJumpInfo, MMFinderLiveGetLiveMessageRespContext, MMFinderLiveKTVSongItem, MMFinderLiveLikePostResult, MMFinderLiveMsgPostFailToastInfo, MMFinderLivePlayGiftAnimationCommand, MMFinderLiveRedPacketReceiveInfo, MMFinderLiveRedPacketSendInfo, MMFinderLiveRewardAppMsgInfo, MMFinderLiveTaskId, MMFinderLiveWatchMilestoneInfo, MMLiveTaskId, NSArray, NSData, NSDictionary, NSError, NSMutableArray, NSString, NewAnchorPkInfo, ShopItemIDUnit, WAJSEventControlFinderLiveShopShelfParams, WCFinderContact, WCFinderCreateLiveCGI, WCFinderDataItem, WCFinderGetLiveOnlineMemberResult, WCFinderLiveInfo, WCFinderLiveKtvGetPlayMemberResult;

@protocol WCFinderLiveExt <NSObject>

@optional
- (void)onReceiveLevelUpUnlockGiftInfo:(FinderLiveAppMsgLevelUpUnlockGiftInfo *)arg1 taskId:(MMFinderLiveTaskId *)arg2;
- (void)onECPromoteUpdatePartiallyWithTaskID:(MMFinderLiveTaskId *)arg1 info:(FinderLiveUpdateEcPromoteInfo *)arg2;
- (void)onLiveRecentWatchEntranceUpdate:(_Bool)arg1;
- (void)onGetFinderLiveRecallLiveMsgWithTaskId:(MMFinderLiveTaskId *)arg1 recallMsgInfo:(FinderLiveRecallLiveRoomMsgInfo *)arg2;
- (void)onCatalogedMerchandiseLotteryActivityInfoReceived:(FinderLiveGiftActivityInfo *)arg1;
- (void)onLiveVisibilityStateWithTaskId:(MMFinderLiveTaskId *)arg1 state:(FinderLiveVisibilityState *)arg2;
- (void)onLiveVisibilityConfigWithTaskId:(MMFinderLiveTaskId *)arg1 config:(FinderLiveVisibilityConfig *)arg2;
- (void)onGetFinderLiveFriendLikeInfoWithTaskId:(MMFinderLiveTaskId *)arg1 likeInfo:(FinderLiveAppMsgRealnameLikeLiveInfo *)arg2;
- (void)onLiveNoticeListInfoUpdatedWithTaskId:(MMFinderLiveTaskId *)arg1 noticeListInfo:(FinderLiveNoticeListInfo *)arg2;
...
- (void)onLiveUpdateSongListNewWithTaskId:(MMFinderLiveTaskId *)arg1 syncNewSongInfo:(FinderLiveAppMsgSyncNewSongInfo *)arg2;
- (void)onKtvOperateSongNotify:(FinderLiveAppMsg *)arg1 taskId:(MMFinderLiveTaskId *)arg2;
...
- (void)onGetInteractionWishInfoWithTaskId:(MMFinderLiveTaskId *)arg1 info:(InteractionWishConfig *)arg2;
- (void)onGetGiftWallInfoWithTaskId:(MMFinderLiveTaskId *)arg1 info:(FinderLiveGiftWallInfo *)arg2;
- (void)onGetAnchorHeaderEcInfoWithTaskId:(MMFinderLiveTaskId *)arg1 info:(FinderLiveAnchorHeaderEcInfo *)arg2 source:(unsigned long long)arg3;
...
- (void)onShowLiveGuide:(NSString *)arg1;
...
- (void)onGetBoardEventSubTitleWithTaskId:(MMFinderLiveTaskId *)arg1 info:(FinderLiveBoardEventSubTitle *)arg2;
...
- (void)onGetPollingFetchEventWithTaskId:(MMFinderLiveTaskId *)arg1 cmdId:(long long)arg2 respBuffer:(NSData *)arg3 ret:(unsigned int)arg4 requestIntervalSec:(double)arg5;
...
- (void)onFinderLiveNextLiveNoticeForFinderUsername:(NSString *)arg1 nextLiveNoticeInfo:(FinderLiveNextLiveNotificationInfo *)arg2;
...
- (void)onShowLiveHalfScreenNotification:(MMFinderLiveTaskId *)arg1 info:(FinderLiveMsgBoxInfo *)arg2;
...
- (void)onGetLikeAudienceHighlightCheerUserInfoWithTaskId:(MMFinderLiveTaskId *)arg1 userInfoList:(NSMutableArray *)arg2;
...
- (void)onGetFinderLiveLayerAnchorVerificationShowInfoWithTaskId:(MMFinderLiveTaskId *)arg1 showInfo:(FinderLiveLayerAnchorVerificationShowInfo *)arg2;
- (void)onGetFinderLiveWatchMilestoneInfoWithTaskId:(MMFinderLiveTaskId *)arg1 milestoneInfo:(MMFinderLiveWatchMilestoneInfo *)arg2;
...
- (void)onGetFinderLiveShortcutWordingInfoWithTaskId:(MMFinderLiveTaskId *)arg1 shortcutWordingInfo:(FinderLiveShortcutWordingInfo *)arg2;
...
- (void)onGetFinderLiveAcceptMicMessageWithTaskId:(MMFinderLiveTaskId *)arg1 connectMicFinderContact:(FinderLiveContact *)arg2 liveSdkInfo:(LiveSdkInfo *)arg3 withVideo:(_Bool)arg4 seatId:(unsigned int)arg5 expiredTime:(unsigned long long)arg6 sdkUserId:(NSString *)arg7 sessionId:(NSString *)arg8 sequence:(unsigned long long)arg9 gameBuffer:(NSString *)arg10;
...
- (void)onFinderEventLiveUpdateWithTaskId:(MMFinderLiveTaskId *)arg1 finderDataItem:(WCFinderDataItem *)arg2;
...
- (void)onGetFinderLiveComboLiveRewardAppMsgWithTaskId:(MMFinderLiveTaskId *)arg1 comboLiveRewardAppMsg:(FinderLiveAppMsg *)arg2;
- (void)onGetFinderLiveInteractionAppMsgWithTaskId:(MMFinderLiveTaskId *)arg1 interactionAppMsg:(FinderLiveAppMsg *)arg2;
- (void)onGetFinderLiveFollowAppMsgWithTaskId:(MMFinderLiveTaskId *)arg1 followAppMsg:(FinderLiveAppMsg *)arg2;
- (void)onGetFinderLiveLikeV2AppMsgWithTaskId:(MMFinderLiveTaskId *)arg1 likeV2AppMsg:(FinderLiveAppMsg *)arg2;
...
- (void)onFinderLiveHotWordDismissed:(MMFinderLiveTaskId *)arg1 hotwordAppMsg:(FinderLiveAppMsg *)arg2;
- (void)onGetFinderLiveHotWordAppMsgWithTaskId:(MMFinderLiveTaskId *)arg1 hotwordAppMsg:(FinderLiveAppMsg *)arg2;
- (void)onShelfUpdateNotify:(MMFinderLiveTaskId *)arg1 shelfInfo:(FinderLiveUpdateEcShopShelfInfo *)arg2;
...
- (void)onDeleteFinderShopShelfProduct:(NSError *)arg1 idUnits:(NSArray *)arg2;
- (void)onSetTopFinderShopShelfProduct:(NSError *)arg1 idUnit:(ShopItemIDUnit *)arg2;
...
- (void)onFinderGetLiveOnlineMember:(NSError *)arg1 taskId:(MMFinderLiveTaskId *)arg2 boardType:(unsigned int)arg3 onlineMemberResult:(WCFinderGetLiveOnlineMemberResult *)arg4;
...
- (void)onFinderLiveCloseWithTidByExtention:(NSString *)arg1;
...
- (void)onPostFinderLiveMessage:(NSError *)arg1 taskId:(MMFinderLiveTaskId *)arg2 statusFlag:(unsigned int)arg3 userInfo:(NSDictionary *)arg4 failToastInfo:(MMFinderLiveMsgPostFailToastInfo *)arg5;
- (void)onGetFinderLiveFeedStreamMessage:(NSError *)arg1 taskId:(MMLiveTaskId *)arg2 onlineContacts:(NSArray *)arg3 msgList:(NSArray *)arg4 finderLiveInfo:(WCFinderLiveInfo *)arg5 onlineCount:(unsigned int)arg6 liveInfoEnable:(_Bool)arg7 liveClosed:(_Bool)arg8 liveExtFlag:(unsigned int)arg9 onlineViewCount:(unsigned int)arg10 nextRequestInterval:(unsigned int)arg11 currentLikeCount:(unsigned long long)arg12 extraClientConfigUpdated:(_Bool)arg13 liveGameData:(FinderLiveGameData *)arg14 liveMicInfo:(FinderLiveMicInfo *)arg15 respContext:(MMFinderLiveGetLiveMessageRespContext *)arg16 finderLiveAppMsgList:(NSArray *)arg17 templateInfoList:(NSArray *)arg18 commentArray:(NSArray *)arg19;
- (void)onGetFinderLiveMessage:(NSError *)arg1 taskId:(MMFinderLiveTaskId *)arg2 onlineContacts:(NSArray *)arg3 msgList:(NSArray *)arg4 finderLiveInfo:(WCFinderLiveInfo *)arg5 onlineCount:(unsigned int)arg6 liveInfoEnable:(_Bool)arg7 liveClosed:(_Bool)arg8 liveExtFlag:(unsigned int)arg9 onlineViewCount:(unsigned int)arg10 ktvPlayerCount:(unsigned int)arg11 nextRequestInterval:(unsigned int)arg12 currentLikeCount:(unsigned long long)arg13 extraClientConfigUpdated:(_Bool)arg14 liveGameData:(FinderLiveGameData *)arg15 respContext:(MMFinderLiveGetLiveMessageRespContext *)arg16;
...
- (void)onCreateFinderLiveError:(NSError *)arg1 finderDataItem:(WCFinderDataItem *)arg2 responseModel:(MMFinderLiveCreateResponseModel *)arg3 errorPage:(FinderLiveErrorPage *)arg4 warnPage:(FinderCreateLiveWarnPage *)arg5 createLiveCGI:(WCFinderCreateLiveCGI *)arg6 isMiniGameLive:(_Bool)arg7;
@end
