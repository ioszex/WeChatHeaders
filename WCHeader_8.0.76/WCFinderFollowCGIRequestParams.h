...
- (void).cxx_destruct;
@property(nonatomic) _Bool ignoreFollowToast; // @synthesize ignoreFollowToast=_ignoreFollowToast;
@property(retain, nonatomic) NSString *refMicID; // @synthesize refMicID=_refMicID;
...
- (id)initWithPosterUsername:(id)arg1 reportScene:(int)arg2 optype:(unsigned long long)arg3 enterType:(int)arg4 followScene:(unsigned long long)arg5;
