...
@class MISSING_TYPE, NSString, WCTDatabase, WCTTable;
...
@interface WADatabaseMgr
{
    ...
    MISSING_TYPE *_tableABTestPermissionInfo;
    ...
    WCTTable *_tableWeAppPackageUsageLru;
...
- (void).cxx_destruct;
@property(retain) WCTTable *tableSkillInfo; // @synthesize tableSkillInfo=_tableSkillInfo;
...
@property(retain) WCTTable *tableWeAppPackageUsageLru; // @synthesize tableWeAppPackageUsageLru=_tableWeAppPackageUsageLru;
...
- (_Bool)deleteSkillInfoByAppID:(id)arg1 appVersion:(unsigned int)arg2;
- (_Bool)deleteSkillInfoByAppID:(id)arg1;
- (_Bool)insertOrUpdateSkillInfo:(id)arg1;
- (id)getSkillInfoByAppID:(id)arg1 appVersion:(unsigned int)arg2;
- (void)didRecoverDatabase;
- (void)willRecoverDatabase;
- (void)resetPackageUsageDBEnableTime;
...
- (_Bool)deleteAppModuleInfoByInfoDataArr:(id)arg1;
...
- (id)getPackageUsageInfoByInfoData:(id)arg1;
- (id)getAllPackageUsageInfo;
- (_Bool)deletePackageUsageByAppID:(id)arg1;
- (_Bool)deletePackageUsageByInfoDatas:(id)arg1;
- (_Bool)deletePackageUsageByInfoData:(id)arg1;
- (_Bool)insertOrUpdatePackageUsageList:(id)arg1;
- (_Bool)insertOrUpdatePackageUsage:(id)arg1;
- (id)getPluginCodeUsageInfoByAppIDAndVersion:(id)arg1 version:(unsigned int)arg2;
- (id)getPluginCodeInfoUpdatedBefore:(unsigned int)arg1;
