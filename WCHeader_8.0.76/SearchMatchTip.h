...
@interface SearchMatchTip : NSObject
{
    ...
    NSArray *_showSuffixMatchRanges;
...
@property(copy, nonatomic) NSArray *showSuffixMatchRanges; // @synthesize showSuffixMatchRanges=_showSuffixMatchRanges;
...
- (id)matchKeywordsForDisplayWithFuzzyFallback:(id)arg1;
