...
@class MMTableView, NSArray, NSMutableArray, NSSet, NSString;
...
@interface FavSearchExtendFilterPanel
{
    ...
    NSSet *_quickFilterSelectedNames;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSSet *quickFilterSelectedNames; // @synthesize quickFilterSelectedNames=_quickFilterSelectedNames;
@property(copy, nonatomic) NSArray *quickFilters; // @synthesize quickFilters=_quickFilters;
...
- (id)genCollapseButtonAtTop:(double)arg1;
...
- (double)quickSectionHeight;
- (void)updateQuickFilterSelectedNames:(id)arg1;
- (void)updateQuickFilters:(id)arg1;
- (long long)tagSectionIndex;
- (long long)typeSectionIndex;
- (_Bool)hasQuickSection;
- (void)initTableView;
