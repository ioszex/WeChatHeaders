...
@class FlutterMethodChannel, PKAddPassButton;

@interface LiteAppPKAddPassButtonImpl : UIView
{
    PKAddPassButton *_addPassButton;
...
@property(retain, nonatomic) PKAddPassButton *addPassButton; // @synthesize addPassButton=_addPassButton;
- (void)dealloc;
- (void)handleMethodCall:(id)arg1 result:(CDUnknownBlockType)arg2;
- (void)addPassButtonTapped:(id)arg1;
- (void)layoutSubviews;
