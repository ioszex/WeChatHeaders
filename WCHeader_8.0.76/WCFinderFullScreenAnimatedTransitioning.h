...
@interface WCFinderFullScreenAnimatedTransitioning : NSObject
{
    ...
    long long _profileSlidePushTriggerVelocity;
    long long _profileSlidePushTriggerPositionStyle;
}

+ (id)animatorWithGesture:(id)arg1 transitioningType:(unsigned int)arg2;
- (void).cxx_destruct;
@property(nonatomic) long long profileSlidePushTriggerPositionStyle; // @synthesize profileSlidePushTriggerPositionStyle=_profileSlidePushTriggerPositionStyle;
@property(nonatomic) long long profileSlidePushTriggerVelocity; // @synthesize profileSlidePushTriggerVelocity=_profileSlidePushTriggerVelocity;
