...
@class CEmoticonWrap, FinderCommentSectionPromptInfo, FinderCommentSortCtrl, FinderGetCommentListCtx, FinderPresentHalfSheetInfo, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIImage, WAAppOpenParameter, WCFinderComment, WCFinderCommentDetailTranslator, WCFinderCommentExtraViewModel, WCFinderContact, WCFinderContentVMShareModel, WCFinderDataItem, WCFinderFeedContentVM, WCFinderFeedMembershipInfo;
...
@interface WCFinderCommentDetailViewModel : NSObject
{
    ...
    FinderCommentSortCtrl *_commentSortCtrl;
    ...
    FinderPresentHalfSheetInfo *_halfSheetInfo;
    ...
    NSString *_editedAssetIdForCurSelectedImage;
    unsigned long long _cacheFuncFlag;
    unsigned long long _selectType;
    NSString *_emotionViewSelectedID;
    unsigned long long _justWatchingCommentID;
    UIImage *_launchComposeWithImage;
    ...
    NSMutableDictionary *_authorSelectedTypeCommentCountDict;
    struct _NSRange _commentTextViewLatestSelectionRange;
}

+ (void)markEmoticonWrapFromEmoticonScene:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *authorSelectedTypeCommentCountDict; // @synthesize authorSelectedTypeCommentCountDict=_authorSelectedTypeCommentCountDict;
...
@property(retain, nonatomic) UIImage *launchComposeWithImage; // @synthesize launchComposeWithImage=_launchComposeWithImage;
@property(nonatomic) unsigned long long justWatchingCommentID; // @synthesize justWatchingCommentID=_justWatchingCommentID;
@property(copy, nonatomic) NSString *emotionViewSelectedID; // @synthesize emotionViewSelectedID=_emotionViewSelectedID;
@property(nonatomic) unsigned long long selectType; // @synthesize selectType=_selectType;
@property(nonatomic) unsigned long long cacheFuncFlag; // @synthesize cacheFuncFlag=_cacheFuncFlag;
@property(retain, nonatomic) NSString *editedAssetIdForCurSelectedImage; // @synthesize editedAssetIdForCurSelectedImage=_editedAssetIdForCurSelectedImage;
...
@property(retain, nonatomic) FinderPresentHalfSheetInfo *halfSheetInfo; // @synthesize halfSheetInfo=_halfSheetInfo;
...
@property(retain, nonatomic) FinderCommentSortCtrl *commentSortCtrl; // @synthesize commentSortCtrl=_commentSortCtrl;
...
- (void)onFeedContentAsyncLoadInfoUpdated:(id)arg1;
- (_Bool)enableRecommendCommentWithComment:(id)arg1;
...
- (void)handleSubCommentMoreClickWithCellType:(unsigned long long)arg1 section:(unsigned long long)arg2;
...
- (void)updateEmotionViewID:(id)arg1;
...
- (id)_createCommentWithContent:(id)arg1;
- (id)genCommentUdfKvWithEmoticon:(id)arg1;
- (void)setCommentHandPickWithComment:(id)arg1 isHandPick:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)removeLiveRecommendTopicSection;
- (void)insertLiveRecommendTopicIfNeed;
...
- (id)getIndexPathWithRefCommentID:(unsigned long long)arg1;
...
- (void)replyComment:(id)arg1 repalyStr:(id)arg2 rootCommentID:(unsigned long long)arg3 image:(id)arg4;
...
- (void)postComment:(id)arg1 withImage:(id)arg2;
...
- (void)checkShouldPrementionWithContact:(id)arg1;
- (id)commentPlaceholderAttachText;
- (_Bool)canShowHandPickButton;
- (_Bool)isCommentSelection;
