...
@class InternalFavorDescView, MISSING_TYPE, NSString, UIButton, UIImageView, UILabel, UIScrollView, WCPayControlData, WCPayLineSeparatorView, WCPayLotteryView, WCPayWebImageView;
