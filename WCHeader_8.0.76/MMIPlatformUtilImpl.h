...
- (id)getWebViewInfoData;
- (void)updateWalletRegion:(int)arg1;
- (id)getPhoneOsVersion;
- (id)getPhonePlatform;
- (void)openNativeScanView;
- (float)getTextWidth:(id)arg1 fontSize:(float)arg2;
- (void)triggerPrefetchMallIndexWeApp:(id)arg1;
- (_Bool)getYuanBaoIsForOldUser;
- (_Bool)getYuanBaoInstalledState;
- (void)saveAdInfoWithPosId:(int)arg1 pbDataString:(id)arg2;
- (void)reportAdWithAidAndType:(id)arg1;
- (void)handleAdOpenWithAid:(id)arg1;
- (void)handleAdFeedbackCloseWithAid:(id)arg1;
- (id)getCashierLiteAppInfo;
- (id)getDeviceInfoForYuanBaoAd;
- (int)getClientVersion;
- (id)getExptStringValue:(id)arg1;
- (id)insertZeroWidthJoiner:(id)arg1;
- (id)md5Data:(id)arg1;
- (id)faceDataEncrypt:(id)arg1 key:(id)arg2;
- (id)faceDataDecrypt:(id)arg1 key:(id)arg2;
- (void)releasePreloadLiteApp:(id)arg1 path:(id)arg2;
- (void)preloadLiteApp:(id)arg1 path:(id)arg2;
- (void)publishPayLiteAppGlobalEvent:(id)arg1;
