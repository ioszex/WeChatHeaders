...
@class NSString, TXLivePlayerContainerView, V2TXLivePlayerJSAdapter, WAMediaCastingRoutePickerController;
...
@interface TXLivePlayJSAdapter : NSObject
{
    ...
    _Bool _shouldTeardownBeforeDealloc;
    _Bool _didTeardown;
    _Bool _muteOnAudioConflict;
    _Bool _passiveMuted;
    ...
    TXLivePlayerContainerView *_containerView;
    NSString *_appId;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool passiveMuted; // @synthesize passiveMuted=_passiveMuted;
@property(nonatomic) _Bool muteOnAudioConflict; // @synthesize muteOnAudioConflict=_muteOnAudioConflict;
@property(nonatomic) _Bool didTeardown; // @synthesize didTeardown=_didTeardown;
@property(nonatomic) _Bool shouldTeardownBeforeDealloc; // @synthesize shouldTeardownBeforeDealloc=_shouldTeardownBeforeDealloc;
...
@property(retain, nonatomic) TXLivePlayerContainerView *containerView; // @synthesize containerView=_containerView;
...
- (void)onRenderVideoFrame:(id)arg1;
...
- (_Bool)isCurrentPlayerAudioActiving;
- (void)exitPassiveMuteForAudioConflict;
- (void)enterPassiveMuteForAudioConflict;
- (_Bool)setAudioActiveAddToInterruptList:(_Bool)arg1;
...
- (id)initLivePlayerWithId:(unsigned int)arg1 configs:(id)arg2 containerView:(id)arg3 appId:(id)arg4 useSkyline:(_Bool)arg5 delegate:(id)arg6;
- (void)teardown;
- (void)dealloc;
