...
@class CgiUnionTransferPlaceOrderResp, GetUrlInfoReqSession, JSEvent, MMTipsViewController, NSString, WCPayBizF2FTransferControlLogic, WCPayF2FMiddlePageSubLogic, WCPayF2FPayCheckCgi, WCPayInterceptWinLogic, WCPayPayMoneyLogic, WCPayTipsPageSheet, WCPayTransferAmountReInputPageStruct, WCPayTransferMoneyWebViewDelegateObject, WCPayTransferPayCheckCgi, WCPayTransferPrepayResponseStruct, WCPayUnionTransferPayCheckCgi, WCPayUnionTransferPlaceOrderCgi;
...
@interface WCPayTransferMoneyControlLogic
{
    ...
    WCPayTransferMoneyWebViewDelegateObject *_martialWebviewDelegateObject;
    GetUrlInfoReqSession *_scanCodeSessionInfo;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool hasTryHkpay; // @synthesize hasTryHkpay=_hasTryHkpay;
@property(nonatomic) _Bool needSkipCancelPay; // @synthesize needSkipCancelPay=_needSkipCancelPay;
@property(retain, nonatomic) GetUrlInfoReqSession *scanCodeSessionInfo; // @synthesize scanCodeSessionInfo=_scanCodeSessionInfo;
@property(retain, nonatomic) WCPayTransferMoneyWebViewDelegateObject *martialWebviewDelegateObject; // @synthesize martialWebviewDelegateObject=_martialWebviewDelegateObject;
...
- (_Bool)tryOpenPlaceOrderPopupLiteApp:(id)arg1 transferId:(id)arg2;
...
- (id)initWithData:(id)arg1 a8KeyResponseUrl:(id)arg2 scanCodeSessionInfo:(id)arg3;
