...
@class MMFinderLiveAudioRoomMicAudioAnimationView, MMFinderLiveCommonOnlineMemberSheet, MMFinderLiveConnectMicSeatInfo, MMFinderLiveConnectMicUser, MMFinderLiveRedPacketView, MMFinderLiveTaskId, MMLiveMultipleTapGestureRecognizer, MMLiveRewardGiftNotificationContainerView, MMUIButton, NSString, PAGView, UIColor, UIImageView, UILabel, UILongPressGestureRecognizer, WCFinderHeadImageView;
@protocol MMFinderLiveAudioRoomMicUserViewDelegate;

@interface MMFinderLiveAudioRoomMicUserBaseView : UIView
{
    _Bool _isDoubleClickLikeEnabled;
...
@property(nonatomic) _Bool isDoubleClickLikeEnabled; // @synthesize isDoubleClickLikeEnabled=_isDoubleClickLikeEnabled;
...
- (_Bool)isTouchPointInLikeEnabledArea:(struct CGPoint)arg1;
- (void)handleLongPressGesture:(id)arg1;
- (void)handleDoubleTapAtPoint:(struct CGPoint)arg1;
- (void)handleMultipleTapGesture:(id)arg1;
