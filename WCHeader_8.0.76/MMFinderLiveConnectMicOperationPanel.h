...
@class FinderLiveAiAssistantNotification, MMFinderLiveConnectMicAudienceContainerView, MMFinderLiveConnectMicBaseAnchorContainerView, MMFinderLiveConnectMicBaseContainerView, MMFinderLiveConnectMicIncomingAudienceSettingsPanel, MMFinderLiveConnectMicLayoutModeSubtitleWrap, MMFinderLiveConnectMicSearchAudienceView, MMFinderLiveConnectMicTabView, MMFinderLiveLastBufferHandler, MMFinderLiveTaskId, MMUnderlineTabsView, NSString, UIView;
...
@interface MMFinderLiveConnectMicOperationPanel
{
    ...
    MMFinderLiveConnectMicBaseAnchorContainerView *_anchorContainerView;
...
@property(retain, nonatomic) MMFinderLiveConnectMicBaseAnchorContainerView *anchorContainerView; // @synthesize anchorContainerView=_anchorContainerView;
...
- (_Bool)useNewAnchorContainerView;
...
- (void)onFinderLiveConnectMicContainerViewTryUpdateMicBaseMode:(unsigned long long)arg1;
- (void)onFinderLiveConnectMicContainerViewEditMicTopic;
...
- (void)onFinderLiveConnectMicContainerViewShowAnchorMicModeSettingsPanelWithAnchorContainerReporterExtInfo:(id)arg1;
...
- (void)tryRandomMatchAnchorMicWithFlag:(_Bool)arg1;
- (void)onFinderLiveConnectMicContainerViewRandomMatchButtonClicked;
- (void)onFinderLiveConnectMicContainerViewOpenSearchOnlineAnchorWithAnchorContainerReporterExtInfo:(id)arg1;
...
- (void)notifyMicBaseModeDidChange;
- (void)handleAudioRoomSceneChanged;
- (void)updateAudiencePanelMicTopic;
...
- (void)updateAnchorPanelWithAiAssistantInfo:(id)arg1;
...
- (void)updatePageSheetTitleForAudioMode;
