...
@class AppMMScheduleItem, AppMsgShareItem, AppProductItem, AppTVItem, BrandMpVideoItem, CMessageWrap, CardTicketItem, EcsGiftMsgItem, EcsInfoItem, EcsKFMsgItem, EmoticonAppMsgItem, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritePhotoAccountNameCard, FavoritesItem, GameLifeItem, GameShareCardItem, GameShareNameCard, GiftCardItem, GroupNoticeItem, HardWareItem, LiteAppSharedItem, MMFinderLiveLotteryReqInfo, MMMusicShareItem, MMTemplateMsg3rdAppShowItem, MallProductItem, MessageExpItem, MpShareTraceItem, NSArray, NSMutableDictionary, NSString, NotifyMsgItem, OpenSDKAppBrandItem, PatMessageWrap, PhotoAccountShareNameCard, ScanCodeHistoryItem, ServiceNotifyMessageItem, TingShareCategoryItem, TingShareChatRoomItem, TingShareListenItem, TingShareLyricsItem, VoIPMultiTalkMessageItem, VoiceAppMsgItem, WAAppMsgItem, WASourceWeappInfo, WAVoipCallInfo, WCCanvasPageItem, WCFinderCollectionShareItem, WCFinderContentColumnSharedItem, WCFinderLiveProductShareItem, WCFinderLiveShareItem, WCFinderLiveShopWindowShareItem, WCFinderMessageGuaranteeItem, WCFinderMessageShareNameCard, WCFinderMessageVerifyItem, WCFinderOrderShareItem, WCFinderShareItemContainer, WCFinderShareToMomentsItem, WCFinderThemeLiveStreamShareItem, WCFinderTopicShareItem, WCMegaVideoShareItem, WCPayExtensionInfo, WCPayInfoItem, WCPayPocketMoneyMsgItem, WCPayThirdInfo, WCPayThirdInfoV3, WSVideoModel, WXSecretMsgItem, WeChatIntroductionItem, WebviewSharedItem, WxGameCardItem, iWatchAppMsgItem;
...
@interface CExtendInfoOfAPP : NSObject
{
    ...
    unsigned long long m_uiAppDataSize;
    ...
    PhotoAccountShareNameCard *m_photoAccountShareNameCard;
    FavoritePhotoAccountNameCard *m_favPhotoAccountShareNameCard;
    ...
    unsigned int m_opensdkShareIsModified;
    WASourceWeappInfo *m_sourceWeappInfo;
    _Bool m_deleteAttachFileAfterSend;
    NSString *m_nsMd5SourceFileId;
    _Bool m_isDirectSend;
    _Bool m_bAppAttachExistInSvr;
    _Bool m_isReaderForbidForward;
    _Bool m_isHideHead;
    _Bool m_isNotifyTemplate;
    _Bool m_isAcceptWithNotify;
    _Bool m_isNotifyByAutoNotify;
    _Bool roomToolsFlag;
    ...
    unsigned int m_uiQuickReply;
    unsigned int m_forwardFlag;
    unsigned int m_chatBotCardMsgType;
    unsigned int _m_uiTemplateSubType;
    unsigned int _m_openWeAppBusinessScene;
    ...
    NSString *m_cbtThinkingContent;
    long long m_cbtOverwriteSvrId;
    NSString *m_chatBotCardData;
    NSString *_m_nsEmojiInfoBase64;
    VoiceAppMsgItem *_m_oVoiceAppMsgItem;
    WAVoipCallInfo *_m_oVoipCallInfo;
    NSString *_m_openWeAppNativeExtraData;
    ...
    VoIPMultiTalkMessageItem *_voipMultiTalkMessageItem;
...
@property(retain, nonatomic) EcsInfoItem *m_ecsInfo; // @synthesize m_ecsInfo=_m_ecsInfo;
...
@property(retain, nonatomic) VoIPMultiTalkMessageItem *voipMultiTalkMessageItem; // @synthesize voipMultiTalkMessageItem=_voipMultiTalkMessageItem;
...
@property(nonatomic) unsigned int m_openWeAppBusinessScene; // @synthesize m_openWeAppBusinessScene=_m_openWeAppBusinessScene;
@property(retain, nonatomic) NSString *m_openWeAppNativeExtraData; // @synthesize m_openWeAppNativeExtraData=_m_openWeAppNativeExtraData;
@property(nonatomic) unsigned int m_uiTemplateSubType; // @synthesize m_uiTemplateSubType=_m_uiTemplateSubType;
@property(retain, nonatomic) WAVoipCallInfo *m_oVoipCallInfo; // @synthesize m_oVoipCallInfo=_m_oVoipCallInfo;
...
@property(retain, nonatomic) NSString *m_nsMd5SourceFileId; // @synthesize m_nsMd5SourceFileId;
@property(copy, nonatomic) NSString *m_chatBotCardData; // @synthesize m_chatBotCardData;
@property(nonatomic) unsigned int m_chatBotCardMsgType; // @synthesize m_chatBotCardMsgType;
@property(nonatomic) long long m_cbtOverwriteSvrId; // @synthesize m_cbtOverwriteSvrId;
@property(copy, nonatomic) NSString *m_cbtThinkingContent; // @synthesize m_cbtThinkingContent;
@property(nonatomic) _Bool m_deleteAttachFileAfterSend; // @synthesize m_deleteAttachFileAfterSend;
@property(retain, nonatomic) WASourceWeappInfo *m_sourceWeappInfo; // @synthesize m_sourceWeappInfo;
@property(nonatomic) unsigned int m_opensdkShareIsModified; // @synthesize m_opensdkShareIsModified;
...
@property(retain, nonatomic) EcsKFMsgItem *m_ecsKFMsgItem; // @synthesize m_ecsKFMsgItem;
...
@property(retain, nonatomic) FavoritePhotoAccountNameCard *m_favPhotoAccountShareNameCard; // @synthesize m_favPhotoAccountShareNameCard;
@property(retain, nonatomic) PhotoAccountShareNameCard *m_photoAccountShareNameCard; // @synthesize m_photoAccountShareNameCard;
...
@property(nonatomic) unsigned int m_uiQuickReply; // @synthesize m_uiQuickReply;
...
@property(retain, nonatomic) WCPayThirdInfoV3 *m_thirdC2CInfoV3; // @synthesize m_thirdC2CInfoV3;
...
@property(nonatomic) unsigned long long m_templateMsgSendTimeMs; // @synthesize m_templateMsgSendTimeMs;
@property(nonatomic) _Bool m_isNotifyByAutoNotify; // @synthesize m_isNotifyByAutoNotify;
@property(nonatomic) _Bool m_isAcceptWithNotify; // @synthesize m_isAcceptWithNotify;
@property(nonatomic) _Bool m_isNotifyTemplate; // @synthesize m_isNotifyTemplate;
...
@property(retain, nonatomic) NSString *m_nsTemplateUniqueId; // @synthesize m_nsTemplateUniqueId;
...
@property(retain, nonatomic) NSArray *m_mergeArrReaderWaps; // @synthesize m_mergeArrReaderWaps;
...
@property(nonatomic) unsigned long long m_uiAppDataSize; // @synthesize m_uiAppDataSize;
...
@property(retain, nonatomic) NSString *m_nsAppFileName; // @synthesize m_nsAppFileName;
