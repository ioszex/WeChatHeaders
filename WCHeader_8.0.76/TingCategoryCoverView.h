...
@class MMListenCategoryItem, MMLiveGradientLayerView, MMUILabel, MMWebImageView, NSString, TingCoverInfo, TingMyCollectionCoverView, TingPAGCoverController, TingPAGImageView, TingPagCoverView, TingShareRadioCoverView, TingShareRadioInviteCoverView, UIImageView;
...
@interface TingCategoryCoverView : UIView
{
    ...
    TingShareRadioCoverView *_shareRadioCoverView;
    TingShareRadioInviteCoverView *_inviteCoverView;
    TingMyCollectionCoverView *_myCollectionCoverView;
    struct CGSize _contentSize;
    struct UIEdgeInsets _contentInsets;
}

- (void).cxx_destruct;
@property(retain, nonatomic) TingMyCollectionCoverView *myCollectionCoverView; // @synthesize myCollectionCoverView=_myCollectionCoverView;
@property(retain, nonatomic) TingShareRadioInviteCoverView *inviteCoverView; // @synthesize inviteCoverView=_inviteCoverView;
@property(retain, nonatomic) TingShareRadioCoverView *shareRadioCoverView; // @synthesize shareRadioCoverView=_shareRadioCoverView;
...
- (_Bool)isMyCollectionCategoryItem:(id)arg1;
