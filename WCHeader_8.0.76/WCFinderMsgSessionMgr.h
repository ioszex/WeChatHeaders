...
- (void)tryUpdateSessionStatusFromSvrWithSessionId:(id)arg1 feedID:(id)arg2 sourceType:(int)arg3 userpageEnterType:(int)arg4 lastCommentScene:(int)arg5;
...
- (void)asyncGetSessionIdForFinderLiveAnchorWithFinderContact:(id)arg1 sourceType:(int)arg2 objectId:(unsigned long long)arg3 liveContactExtInfo:(id)arg4 loadingVC:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
...
- (void)asyncStreamProfileGetSessionIdWithContact:(id)arg1 myAccountType:(unsigned int)arg2 loadingVC:(id)arg3 profileEnterSource:(int)arg4 feedID:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
