...
@class CreateChatLogic, FTSHomeViewController, MFTitleView, MMBarButtonItem, MMLoadingView, MMSessionInfo, MMTimer, MMUIViewController, MainFrameCustomBarView, MainFrameHeaderLogic, MainFrameLogicController, MainFrameSectionFoldView, MainFrameTableView, MainFrameUnreadReporter, MainSessionEditingLogic, NSIndexPath, NSString, UIColor, UIDynamicAnimator, UIImageView, UIView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarView, WAMainFrameTopHeaderView, WCFinderBoxOpener, WCSearchBar;
...
@interface NewMainFrameViewController
{
    ...
    MMBarButtonItem *m_menuBarButton;
    _Bool m_enableSearchBarButton;
    _Bool m_searchBarButtonShown;
    ...
    FTSHomeViewController *_lastHomeViewController;
    ...
    WCFinderBoxOpener *_finderBoxOpener;
...
@property(retain, nonatomic) WCFinderBoxOpener *finderBoxOpener; // @synthesize finderBoxOpener=_finderBoxOpener;
...
@property(nonatomic) __weak FTSHomeViewController *lastHomeViewController; // @synthesize lastHomeViewController=_lastHomeViewController;
...
- (void)onAggregation:(id)arg1 openSession:(id)arg2;
- (void)registerYReportSdk;
- (void)checkAndUpdateMenuBarItemSearchState:(id)arg1;
- (void)setupMenuBarSearchEntryConfig;
...
- (void)onRequestCleanBrandTimelineVC;
...
- (void)reloadSessions;
- (void)insertSessionCellAtIndexes:(id)arg1 scrollToCell:(_Bool)arg2;
...
- (void)openWWKFSessionView:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)openFinderBoxBrandFromSource:(unsigned long long)arg1 sessionInfo:(id)arg2 indexPath:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)willAppear;
- (void)showAggregationWithShock:(_Bool)arg1;
- (void)onLongPressAtMainFrameTab;
- (void)onDoubleClickAtMainFrameTab;
- (void)onClickAtMainFrameTab;
- (id)goToNextUnreadSessionWithOpen:(_Bool)arg1;
...
- (void)doRefreshTaskBarCommonUseDataImmediately:(unsigned long long)arg1;
...
- (void)restoreTaskBarSearchPlaceholderToDefault;
- (void)onTaskBarPlaceholderReady;
