...
@class NSString, TXLivePusherContainerView;
...
@interface WAWebViewPlugin_LivePusher
{
    ...
    TXLivePusherContainerView *_preview;
...
@property(retain, nonatomic) TXLivePusherContainerView *preview; // @synthesize preview=_preview;
...
- (void)onPusherEnterBackground:(id)arg1;
