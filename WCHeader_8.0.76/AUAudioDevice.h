...
@protocol AUAudioDataSource, AUAudioPlaybackInterceptor, OS_dispatch_queue;
...
@interface AUAudioDevice
{
    ...
    _Bool bEnableEnterEachStartup;
    _Bool bFirstEnterRecordEachStartup;
    _Bool bFirstEnterPlayEachStartup;
    _Bool bEnableReceiveCallbackSteadyTimestamp;
    ...
    char *pRMSRecBuff;
    _Bool m_isForPstn;
    struct shared_ptr<HumanVoiceDetection> m_humanVoiceDetector;
    _Bool bEnableRmIO;
    _Bool bFirstMediaServiceReset;
    _Bool _isFirst1sCheckRMS;
    _Bool _isUsingExternalAudioDevice;
    _Bool _canRestartAudioPlaying;
    int audioDevErrCode;
    ...
    long long _roomKey;
    id <AUAudioPlaybackInterceptor> _playbackInterceptor;
}
...
@property(nonatomic) __weak id <AUAudioPlaybackInterceptor> playbackInterceptor; // @synthesize playbackInterceptor=_playbackInterceptor;
@property(nonatomic) _Bool canRestartAudioPlaying; // @synthesize canRestartAudioPlaying=_canRestartAudioPlaying;
...
- (id)currentPlaybackInterceptor;
- (void)setBottomMic:(_Bool)arg1;
- (_Bool)getIfUsingExternalAudioDevice;
- (void)ResetAudioRecordStateErrorCnt;
- (int)getWorkMode;
- (_Bool)isBeingVoiceProcessingIO;
- (_Bool)isVoIPPlaying;
...
- (void)StopForVoIP;
- (_Bool)PauseAudioPlayingAndNotifyUIPause;
- (void)Stop;
- (_Bool)RestartAudioPlayingAndNotifyUIRestart;
- (void)Restart;
...
- (void)StartRecordAndPlayForChatbot;
- (void)StartPlayForChatbot;
- (void)StartRecordForChatbot;
...
- (void)loadAudioUnitStatus:(CDUnknownBlockType)arg1;
- (void)dispatchToAudioSessionQueue:(CDUnknownBlockType)arg1;
...
- (_Bool)StartSessionWithWorkMode1:(int)arg1 isAfterInterruption:(_Bool)arg2;
- (_Bool)StartSessionWithWorkMode:(int)arg1;
- (void)setupCategoryIfIsAfterInterruption:(_Bool)arg1;
- (void)setupCategory;
