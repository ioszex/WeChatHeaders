...
@class FinderJumpInfo_Style, FinderLiveNoticeInfo, InteractionCommResp, NSArray, NSString, NSURL, UIButton, UILongPressGestureRecognizer, UIView, WCFinderComment, WCFinderContact, WCFinderFeedContentTextView, WCFinderFeedContentVM, WCFinderFriendLikeToolbarView, WCFinderFullInteractivePanelView, WCFinderJumpInfo;
@protocol WCFinderJumpInfoViewProtocol;

@protocol WCFinderFullInteractivePanelViewDelegate <NSObject>

@optional
- (struct CGPoint)interactivePanelBulletButtonCenterInView:(UIView *)arg1;
...
- (void)interactivePanelClickPostSuspendJumpInfo:(WCFinderJumpInfo *)arg1;
...
- (void)interactivePanelClickWithJumpInfoView:(UIView<WCFinderJumpInfoViewProtocol> *)arg1 clickArea:(int)arg2 entranceType:(int)arg3;
- (void)interactivePanelReportUniversalJumperExposeWithJumpInfoView:(UIView<WCFinderJumpInfoViewProtocol> *)arg1;
...
- (void)interactivePanelHeaderClickNicknameWithContact:(WCFinderContact *)arg1;
- (void)interactivePanelHeaderClickAvatarWithContact:(WCFinderContact *)arg1;
