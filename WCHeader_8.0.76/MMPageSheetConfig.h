...
@class NSArray, NSNumber, NSString, PageSheetBarButtonContext, UIColor, UIFont, UIImage, UINavigationController, UIScrollView, UIView;
...
@interface MMPageSheetConfig : NSObject
{
    ...
    _Bool _enableDragToResize;
    _Bool _recognizeHorizontalWhenDragToClose;
    _Bool _ignoreDragVelocityThreshold;
    _Bool _dragNotCloseHalfScreen;
    _Bool _disablePageSheetChangeAnimation;
    _Bool _disableAlphaTransitionAtPresent;
    _Bool _navHidden;
    _Bool _isNavTranslucent;
    _Bool _isTruncateSubtitleHead;
    ...
    double _maxKeyboardAdjustHeight;
...
@property(nonatomic) _Bool isTruncateSubtitleHead; // @synthesize isTruncateSubtitleHead=_isTruncateSubtitleHead;
@property(nonatomic) double subTitleSpacing; // @synthesize subTitleSpacing=_subTitleSpacing;
...
@property(nonatomic) _Bool disableAlphaTransitionAtPresent; // @synthesize disableAlphaTransitionAtPresent=_disableAlphaTransitionAtPresent;
@property(nonatomic) _Bool disablePageSheetChangeAnimation; // @synthesize disablePageSheetChangeAnimation=_disablePageSheetChangeAnimation;
@property(retain, nonatomic) NSNumber *animateDuration; // @synthesize animateDuration=_animateDuration;
@property(nonatomic) _Bool dragNotCloseHalfScreen; // @synthesize dragNotCloseHalfScreen=_dragNotCloseHalfScreen;
...
@property(nonatomic) _Bool enableDragToResize; // @synthesize enableDragToResize=_enableDragToResize;
...
@property(nonatomic) __weak UINavigationController *externalNavigationController; // @synthesize externalNavigationController=_externalNavigationController;
...
@property(nonatomic) double maxKeyboardAdjustHeight; // @synthesize maxKeyboardAdjustHeight=_maxKeyboardAdjustHeight;
@property(nonatomic) _Bool autoAdjustAtKeyboardChange; // @synthesize autoAdjustAtKeyboardChange=_autoAdjustAtKeyboardChange;
@property(nonatomic) _Bool autoFittingSafeArea; // @synthesize autoFittingSafeArea=_autoFittingSafeArea;
