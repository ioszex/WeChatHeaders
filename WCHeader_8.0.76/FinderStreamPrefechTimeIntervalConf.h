...
@class FinderStreamCachePoolConfig, NSData;
...
@property(retain, nonatomic) FinderStreamCachePoolConfig *cachePoolConfig; // @dynamic cachePoolConfig;
...
@property(nonatomic) int followTabPrefetchPollingInterval; // @dynamic followTabPrefetchPollingInterval;
