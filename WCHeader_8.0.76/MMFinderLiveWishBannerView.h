...
@class CAGradientLayer, FinderLiveBoardEventSubTitle, FinderLiveGiftWallInfo, InteractionWishConfig, MMFinderLiveRewardWish, MMTimer, MMUILabel, NSArray, NSMutableSet, NSString, UIImageView;
...
@interface MMFinderLiveWishBannerView
{
    ...
    _Bool _isDisplayingActivityBannerItem;
    unsigned int _index;
    ...
    NSString *_displayingActivityEventId;
    CAGradientLayer *_gradientLayer;
    MMUILabel *_titleLabel;
    UIImageView *_iconImageView;
    MMTimer *_scheduleTimer;
    unsigned long long _displayingActivityBannerIndex;
...
@property(nonatomic) unsigned long long displayingActivityBannerIndex; // @synthesize displayingActivityBannerIndex=_displayingActivityBannerIndex;
@property(nonatomic) _Bool isDisplayingActivityBannerItem; // @synthesize isDisplayingActivityBannerItem=_isDisplayingActivityBannerItem;
...
@property(copy, nonatomic) NSString *displayingActivityEventId; // @synthesize displayingActivityEventId=_displayingActivityEventId;
...
- (id)finderLiveTask;
@property(readonly, nonatomic) _Bool isDisplayingActivityBanner;
@property(readonly, nonatomic) _Bool isActivityRankEnable;
...
- (void)showWishBannerWithTitle:(id)arg1 productTotalCount:(unsigned long long)arg2 productCurCount:(unsigned long long)arg3 liveRewardWishes:(id)arg4 giftWallInfo:(id)arg5 interactionWishConfig:(id)arg6 boardEventSubTitle:(id)arg7;
...
- (void)updateBannerWidthAnimation:(_Bool)arg1;
- (void)layoutUI;
