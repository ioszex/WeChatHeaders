...
@class BTOftenReadBizCache, BTResortPerformanceItem, BrandMsgResortContext, BrandResortConfig, BrandSessionCache, BrandTLExptConfig, BrandTLMainSessionExposeItem, BrandTimelineMsgDB, FlutterBrandNavigator, MMBaseSessionStorage, MMFlutterInstance, MMTimer, MemoryMappedKV, NSArray, NSData, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString;
...
@interface BrandTimelineMsgMgr
{
    ...
    _Bool _isBrandSessionVisibleInMainSession;
    ...
    _Bool _curForceDisableNewMsgDirect;
    ...
    _Bool _isMainTabOnStackTop;
    _Bool _hasNotifiedSpecificDisappearReason;
    _Bool _hasHandledFirstMainTabExposeAfterLaunch;
    ...
    double _mainFrameScrollOffset;
    NSString *_lastWillDisappearVCName;
    NSString *_lastWillAppearVCName;
    ...
    BrandTLMainSessionExposeItem *_lastExposedItemSnapshot;
    NSString *_lastExposeRankSessionId;
    NSString *_lastDigestRankSessionId;
    ...
    NSArray *_prevSessionUsernamesBeforeBrandBox;
...
@property(nonatomic) _Bool hasHandledFirstMainTabExposeAfterLaunch; // @synthesize hasHandledFirstMainTabExposeAfterLaunch=_hasHandledFirstMainTabExposeAfterLaunch;
@property(nonatomic) _Bool hasNotifiedSpecificDisappearReason; // @synthesize hasNotifiedSpecificDisappearReason=_hasNotifiedSpecificDisappearReason;
@property(nonatomic) _Bool isMainTabOnStackTop; // @synthesize isMainTabOnStackTop=_isMainTabOnStackTop;
...
@property(retain, nonatomic) NSArray *prevSessionUsernamesBeforeBrandBox; // @synthesize prevSessionUsernamesBeforeBrandBox=_prevSessionUsernamesBeforeBrandBox;
@property(nonatomic) _Bool curForceDisableNewMsgDirect; // @synthesize curForceDisableNewMsgDirect=_curForceDisableNewMsgDirect;
...
@property(copy, nonatomic) NSString *lastDigestRankSessionId; // @synthesize lastDigestRankSessionId=_lastDigestRankSessionId;
@property(copy, nonatomic) NSString *lastExposeRankSessionId; // @synthesize lastExposeRankSessionId=_lastExposeRankSessionId;
@property(retain) BrandTLMainSessionExposeItem *lastExposedItemSnapshot; // @synthesize lastExposedItemSnapshot=_lastExposedItemSnapshot;
@property(retain) BrandTLMainSessionExposeItem *exposeItemInMainSession; // @synthesize exposeItemInMainSession=_exposeItemInMainSession;
...
@property(nonatomic) _Bool isBrandSessionVisibleInMainSession; // @synthesize isBrandSessionVisibleInMainSession=_isBrandSessionVisibleInMainSession;
@property(retain, nonatomic) NSString *lastWillAppearVCName; // @synthesize lastWillAppearVCName=_lastWillAppearVCName;
@property(retain, nonatomic) NSString *lastWillDisappearVCName; // @synthesize lastWillDisappearVCName=_lastWillDisappearVCName;
@property(nonatomic) double mainFrameScrollOffset; // @synthesize mainFrameScrollOffset=_mainFrameScrollOffset;
...
- (void)onMinimizeTaskUserTapFloatingView:(id)arg1;
- (void)notifyPageChangeWithNewVC:(id)arg1;
...
- (void)saveContactCreateTimeUpdatedTimeInSecForPhotoAccount:(unsigned int)arg1;
- (_Bool)enableFetchPhotoAccountContactListCreateTime;
- (void)saveContactCreateTimeUpdatedTimeInSec:(unsigned int)arg1;
...
- (_Bool)enableXiaoweiSummaryDisplay;
- (_Bool)showRedPacketCover;
- (_Bool)hideSearchBarWhenEnter;
- (_Bool)nativeCardTitleUpEnable;
- (_Bool)isRecReasonAboveTitle;
- (_Bool)isNotifyPermanent;
- (_Bool)isPicTextScrollListEnable;
- (_Bool)enableFetchContactListCreateTime;
- (_Bool)enableOftenReadLiveScrollCardAutoPlay;
- (_Bool)finderLiveAutoPlayEnable;
- (_Bool)shouldKeepDataWhenDeleteTimeLineBox;
- (id)audioFeedsInfoData;
- (_Bool)enableGetLiveInfoNow;
- (void)markGetLiveInfoTimeStamp;
- (_Bool)showFinderLiveBreathingLight;
...
- (_Bool)enableClickReplaceSwitch;
- (_Bool)negativeReplaceNotExposedSwitch;
- (unsigned int)closeNegativeButton;
- (unsigned int)openNewRecCardUI;
...
- (void)onWebViewContentProcessDidTerminate:(id)arg1;
...
- (void)cleanBrandTimelineViewController:(unsigned int)arg1;
...
- (void)onNotifyAffMainTabDisappeared:(int)arg1;
- (void)onNotifyAffMainTabExposed:(int)arg1;
...
- (void)setBoxCntInScreenToAff:(int)arg1;
- (void)setBoxPosToAff:(int)arg1;
- (void)setNotifyCntToAff:(int)arg1;
- (long long)getInsertMsgRecordID;
- (void)getBizTimelineMsgListWithCompletion:(CDUnknownBlockType)arg1;
- (void)updateCurrentUserActiveReportAction:(int)arg1;
- (CDStruct_4811d97b)getAffResortUserActiveReportInfo;
...
- (void)resetAffData;
- (void)ignoreAffResortLimit:(_Bool)arg1;
...
- (id)__innerCreateFlutterInstanceWithExptConfig:(id)arg1 route:(id)arg2 extraParams:(id)arg3;
- (id)createFlutterInstanceWithExptConfig:(id)arg1 route:(id)arg2 extraParams:(id)arg3;
- (id)createFlutterInstanceWithExptConfig:(id)arg1 extraParams:(id)arg2;
...
- (_Bool)preloadEngineGroupEnable;
...
- (_Bool)isUseLikeTabNewUi;
- (_Bool)isMMCacheImageEnable;
- (_Bool)isExposeDelayCheckEnable;
- (_Bool)_enableBizAdToolsAllowDisableNewMsgDirect;
- (_Bool)__enableOftenReadBarNewUIShowFinderScrollCard;
- (_Bool)__enableOftenReadBarNewUINeedPreload;
- (_Bool)__enableOftenReadBarNewUI;
- (_Bool)enableClearKeepposAfterClientBack;
...
- (id)getExptConfig;
- (id)createFlutterInstanceWithImagePreviewInfo:(struct LaunchBizImagePreviewInfo)arg1;
- (void)handleBrandBoxIncrease:(id)arg1 currentBefore:(id)arg2;
- (void)handleBrandBoxDecrease:(id)arg1 currentBefore:(id)arg2 currentAll:(id)arg3;
- (void)updateBrandBoxPosChangeSceneWithCurrentUsernames:(id)arg1 brandSessionExist:(_Bool)arg2 brandSessionRowIndex:(unsigned int)arg3;
- (void)updateBoxStatusToCpp:(int)arg1;
- (void)report36986:(unsigned int)arg1 reddotActType:(unsigned int)arg2 prePos:(int)arg3 newPos:(int)arg4 boxPositionChangeReason:(unsigned int)arg5 reddotReason:(unsigned int)arg6;
- (void)updatePosChangeScene:(unsigned int)arg1;
- (void)updateReddotReason:(unsigned int)arg1;
- (void)updatePos:(int)arg1;
- (void)updateUnreadCountType:(unsigned int)arg1;
- (_Bool)isInvalidRankSessionIdForMsgId:(long long)arg1;
- (void)updateLastDigestTime:(unsigned int)arg1 isTimeFromConv:(_Bool)arg2 notifyType:(unsigned int)arg3 msgId:(long long)arg4 unreadNotifyMsgCount:(unsigned int)arg5 unreadMassMsgCount:(unsigned int)arg6;
- (void)onServiceEnterForegroundInCategoryMainSession;
- (void)onServiceEnterBackgroundInCategoryMainSession;
- (_Bool)shouldForceEndExposeWhenBackground;
- (id)makeRedDotReportItem:(id)arg1 actType:(unsigned int)arg2;
- (void)aggregateRedDotSessionInfo:(id)arg1 actType:(unsigned int)arg2 exposeStatusChangeReason:(unsigned int)arg3;
- (void)aggregateRedDotSessionInfo:(id)arg1 actType:(unsigned int)arg2;
- (void)reportRedDotWhenDeleteBox;
- (void)reportRedDotIfNeeded:(id)arg1 exposeItem:(id)arg2 actType:(unsigned int)arg3 exposeStatusChangeReason:(unsigned int)arg4;
...
- (void)workThread_reportAndUpdateExposeItem:(id)arg1 isExpose:(_Bool)arg2 exposeStatusChangeReason:(unsigned int)arg3;
- (void)handleMainSessionDisappearWithMsg:(id)arg1 rowIndex:(unsigned int)arg2 sessionInfo:(id)arg3 exposeStatusChangeReason:(unsigned int)arg4;
- (void)handleMainSessionExposeWithMsg:(id)arg1 rowIndex:(unsigned int)arg2 sessionInfo:(id)arg3 exposeStatusChangeReason:(unsigned int)arg4;
- (void)onMainSessionTabSelect;
- (void)onMainSessionExpose:(id)arg1 isExpose:(_Bool)arg2 rowIndex:(unsigned int)arg3 exposeStatusChangeReason:(unsigned int)arg4;
...
- (void)updateMainSessionLatestMsgWithAffData:(id)arg1 lastMsgTime:(unsigned int)arg2;
- (void)updateMainSessionLatestMsg;
- (void)fillMainSessionCache:(unsigned int)arg1 notifyMsgCount:(unsigned int)arg2 lastTimelineMsg:(id)arg3 lastTimelineMsgTime:(unsigned int)arg4;
- (void)updateMainSessionCacheAsync:(CDUnknownBlockType)arg1;
...
- (id)genReddotExposeMoment:(_Bool)arg1 exposeStatusChangeReason:(unsigned int)arg2 exposeItem:(id)arg3;
- (id)genReddotExposeMoment:(_Bool)arg1 exposeStatusChangeReason:(unsigned int)arg2;
...
- (id)getLastExposedItemSnapshot;
- (id)getMainSessionExposeItem;
- (unsigned int)cEndNotifyCountFromMainSessionCache;
...
- (void)onPhotoNotificationUnreadCountChange;
- (void)internalHandleNewNotificationByNewXml:(id)arg1 serviceType:(long long)arg2;
- (void)internalHandleNewNotificationByNewXml:(id)arg1;
- (void)internalHandleNewNotification:(id)arg1 serviceType:(long long)arg2;
- (void)internalHandleNewNotification:(id)arg1;
- (unsigned int)getAllCountWithServiceType:(long long)arg1;
- (void)syncAllFoldBlockMpArticleWithServiceType:(long long)arg1;
- (void)syncAllFoldBlockMpArticle;
- (_Bool)setNotifyMsgHasSharedServiceTypeBySvrId:(unsigned long long)arg1 hasSharedServiceType:(long long)arg2 serviceType:(long long)arg3;
- (_Bool)setNotifyMsgHasSharedServiceTypeBySvrId:(unsigned long long)arg1 hasSharedServiceType:(long long)arg2;
- (_Bool)setNotifyMsgHasSharedServiceTypeMsgId:(unsigned long long)arg1 hasSharedServiceType:(long long)arg2 serviceType:(long long)arg3;
- (_Bool)setNotifyMsgHasSharedServiceTypeMsgId:(unsigned long long)arg1 hasSharedServiceType:(long long)arg2;
- (_Bool)setNotifyMsgBlockStatusFlagMpArticleKey:(id)arg1 flag:(long long)arg2 serviceType:(long long)arg3;
- (_Bool)setNotifyMsgBlockStatusFlagMpArticleKey:(id)arg1 flag:(long long)arg2;
- (void)clearUnreadByTalker:(id)arg1;
- (void)clearFoldBlockUnreadByMsgIds:(id)arg1 serviceType:(long long)arg2;
- (void)clearFoldBlockUnreadByMsgIds:(id)arg1;
- (void)clearUnreadByMsgIds:(id)arg1 serviceType:(long long)arg2;
- (void)clearUnreadByMsgIds:(id)arg1;
- (void)clearAllNotificationUnreadStatusWithServiceType:(long long)arg1;
- (void)clearAllNotificationUnreadStatus;
- (_Bool)setNotificationDelFlag:(id)arg1 msgWrap:(id)arg2 serviceType:(long long)arg3;
- (_Bool)setNotificationDelFlag:(id)arg1 msgWrap:(id)arg2;
- (void)deleteUnreadNotificationForSession:(id)arg1 serviceType:(long long)arg2;
- (void)deleteUnreadNotificationForSession:(id)arg1;
- (_Bool)deleteNotification:(id)arg1 serviceType:(long long)arg2;
- (_Bool)deleteNotification:(id)arg1;
- (id)getNotificationBySvrId:(unsigned long long)arg1 serviceType:(long long)arg2;
- (id)getNotificationBySvrId:(unsigned long long)arg1;
- (id)getUnReadBlockNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 serviceType:(long long)arg3;
- (id)getUnReadBlockNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2;
- (unsigned int)getFoldBlockNotificationUnreadCountWithServiceType:(long long)arg1;
- (unsigned int)getFoldBlockNotificationUnreadCount;
- (id)getNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 serviceType:(long long)arg3;
- (id)getNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 needFoldMessage:(_Bool)arg3 serviceType:(long long)arg4;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 needFoldMessage:(_Bool)arg3;
- (id)getUnreadNotificationFromCreateTime:(unsigned int)arg1 limit:(unsigned int)arg2 serviceType:(long long)arg3;
...
- (unsigned int)getNotificationUnreadCountAfterCreateTime:(unsigned int)arg1 serviceType:(long long)arg2;
- (unsigned int)getNotificationUnreadCountWithServiceType:(long long)arg1;
- (unsigned int)getNotificationUnreadCount;
- (id)getLastUnreadNotificationWithServiceType:(long long)arg1;
- (id)getLastUnreadNotification;
- (id)getLastNotificationWithServiceType:(long long)arg1;
- (id)getLastNotification;
- (void)onServiceClearDataInCategoryNotification;
- (void)onServiceInitInCategoryNotification;
...
- (_Bool)canPreFetchFollowedContactDigest;
- (id)getBizNotificationTabInfo;
- (_Bool)useNotifyMsgListFlutterVersion;
...
- (id)tl_preloadUrlStringsForReader:(id)arg1 topLargeCover:(_Bool)arg2;
...
- (void)notifyBizPublishResult:(id)arg1;
- (void)setPublishResultCallback:(CDUnknownBlockType)arg1;
...
- (id)createFlutterInstanceForTextCoverWithParams:(id)arg1;
