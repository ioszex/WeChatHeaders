...
@interface MMTemplateMsgScopeCache
{
    ...
    unsigned int _importantNotifyNum;
    NSString *_userName;
    NSMutableArray *_scopeList;
}

+ (void)initialize;
+ (void)PBArrayAdd_importantNotifyNum;
+ (void)PBArrayAdd_hasSettingEntry;
+ (void)PBArrayAdd_scopeList;
+ (void)PBArrayAdd_isGlobalRecv;
+ (void)PBArrayAdd_userName;
- (void).cxx_destruct;
@property(nonatomic) unsigned int importantNotifyNum; // @synthesize importantNotifyNum=_importantNotifyNum;
