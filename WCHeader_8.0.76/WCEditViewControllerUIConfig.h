...
@interface WCEditViewControllerUIConfig : NSObject
{
    ...
    _Bool _keepCenterWhenSmallerThanScreen;
    _Bool _scaleWhenCrop;
    _Bool _clipContentToBrightFrame;
...
+ (id)configForEmotionEditWithContentDisplayFrame:(struct CGRect)arg1 keepCenter:(_Bool)arg2;
+ (id)configForEmotionEditWithContentDisplayFrame:(struct CGRect)arg1;
+ (id)configForEmotionEditWithContentDisplayFrame:(struct CGRect)arg1 isCropTimeOnly:(_Bool)arg2 keepCenter:(_Bool)arg3 clipContentToBrightFrame:(_Bool)arg4;
- (void).cxx_destruct;
...
@property(nonatomic) _Bool clipContentToBrightFrame; // @synthesize clipContentToBrightFrame=_clipContentToBrightFrame;
@property(nonatomic) _Bool scaleWhenCrop; // @synthesize scaleWhenCrop=_scaleWhenCrop;
@property(nonatomic) _Bool keepCenterWhenSmallerThanScreen; // @synthesize keepCenterWhenSmallerThanScreen=_keepCenterWhenSmallerThanScreen;
