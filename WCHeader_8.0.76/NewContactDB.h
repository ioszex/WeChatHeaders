...
@interface NewContactDB : NSObject
{
    ...
    WCTTable *_m_tableCustAsstContact;
    ...
    WCTTable *_m_tableContactTag;
    WCTTable *_m_tableContactTagRelation;
    WCTTable *_m_tableContactVerifyRecord;
}
...
- (void).cxx_destruct;
@property(retain) WCTTable *m_tableContactVerifyRecord; // @synthesize m_tableContactVerifyRecord=_m_tableContactVerifyRecord;
@property(retain) WCTTable *m_tableContactTagRelation; // @synthesize m_tableContactTagRelation=_m_tableContactTagRelation;
@property(retain) WCTTable *m_tableContactTag; // @synthesize m_tableContactTag=_m_tableContactTag;
...
@property(retain) WCTTable *m_tableCustAsstContact; // @synthesize m_tableCustAsstContact=_m_tableCustAsstContact;
...
- (id)getTableNameCustAsstContactName;
...
- (_Bool)getAllCustAsstContactList:(id)arg1;
...
- (id)getContactVerifyRecordList:(struct Expression)arg1 lastVersion:(unsigned long long)arg2 limit:(long long)arg3;
- (id)genDBContactVerifyRecordWithVerifyRecord:(id)arg1;
- (_Bool)deleteContactVerifyRecordWithUserName:(id)arg1;
- (_Bool)batchInsertOrUpdateContactVerifyRecord:(id)arg1;
- (_Bool)insertOrUpdateContactVerifyRecordWithUserName:(id)arg1 contactVerifyRecord:(id)arg2;
...
- (struct Statement)genChatRoomMemberTagOneStrategyWithUserName:(id)arg1 arrHadTagID:(id)arg2;
- (struct Statement)genChatRoomMemberTagWithUserName:(id)arg1 arrHadTagID:(id)arg2;
- (struct StatementSelect)genRoomMemberQueryStatementWithUserName:(id)arg1;
- (struct StatementSelect)genRoomMemberContactTagRelationStatementWithArrHadTagID:(id)arg1;
...
- (_Bool)insertContactTagRelation:(id)arg1 withHandle:(id)arg2;
- (_Bool)batchInsertContactTagRelationWithUserName:(id)arg1 arrContactTagID:(id)arg2;
- (_Bool)deleteContactTagWithID:(unsigned int)arg1 withHandle:(id)arg2;
- (_Bool)batchDeleteContactTagWithArrTagId:(id)arg1;
- (_Bool)updateContactTagOrderWithID:(unsigned int)arg1 tagIndex:(unsigned int)arg2 withHandle:(id)arg3;
- (_Bool)batchUpdateContactTagOrder:(id)arg1;
- (_Bool)updateContactTagWithID:(unsigned int)arg1 tagName:(id)arg2 withHandle:(id)arg3;
- (_Bool)batchUpdateContactTagName:(id)arg1;
- (_Bool)insertContactTagItem:(id)arg1 withHandle:(id)arg2;
