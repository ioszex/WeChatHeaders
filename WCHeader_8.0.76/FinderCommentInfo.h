...
@class AuthorReactionToCommentInfo, CommentContentInfo, CommentRecommendFriendList, CommentRefFeedJumpInfo, CommentRefProductJumpInfo, FinderCommentAdvertisementInfo, FinderCommentHelpPromotionButton, FinderCommentPromotionInfo, FinderCommentRelatedFeedInfo, FinderContact, FinderContactMsgInfo, FinderFriendRecExtInfo, FinderIpRegionInfo, NSData, NSMutableArray, NSString;
...
@property(retain, nonatomic) FinderCommentHelpPromotionButton *helpPromotionButton; // @dynamic helpPromotionButton;
