...
@class BitFeature, NSData, NSMutableArray, NSString, OfflineModeStrategy, OriginVal, SessionReportAdExtraInfo, ValFeature;
...
@property(retain, nonatomic) SessionReportAdExtraInfo *adExtraInfo; // @dynamic adExtraInfo;
...
@property(nonatomic) unsigned int exposeEndType; // @dynamic exposeEndType;
...
@property(retain, nonatomic) OfflineModeStrategy *offlineModeStrategy; // @dynamic offlineModeStrategy;
@property(retain, nonatomic) OriginVal *orgVal; // @dynamic orgVal;
@property(retain, nonatomic) NSString *playUuid; // @dynamic playUuid;
