...
@class FinderCommByPass, FinderLiveEntranceNavResponse_ExtInfo, MMFinderLivePivotEducationView, MMFinderLivePreviewExitButton, MMFinderLiveRelatedLiveParams, MMFinderLiveRouterParams, MMFinderLiveSquareSwitchGuideView, MMLiveDisplayLinkAnimator, MMLivePivotAutoSwipeInfo, MMLivePivotBlockingLoadReportContext, MMLivePivotCollectionView, MMLivePivotView, MMLivePreviewRelatedViewModel, MMLiveScrollGradientMaskingView, MMLiveTaskId, MMLiveView, MMTimer, MMUILabel, NSArray, NSData, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, UICollectionView, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, UIViewPropertyAnimator, WCFinderCreateLiveViewModel, WCFinderFullScreenAnimatedTransitioning, WCFinderFullShareListTemplatePlugin, WCFinderLiveBaseLogReporter, WCFinderLiveHomePageViewController, WCFinderLiveRoomFastSlipLogic;
...
@interface MMLivePivotViewController
{
    ...
    _Bool _hasJoinedLive;
    _Bool _hasFetchedRelatedLive;
    _Bool _hasFetchedLiveEntranceNav;
    ...
    WCFinderLiveRoomFastSlipLogic *_fastSlipLogic;
    ...
    NSString *_contentVMTidWhenInfoReceived;
    ...
    NSTimer *_squareSwitchNavCheckFallbackTimer;
...
@property(nonatomic) _Bool hasFetchedLiveEntranceNav; // @synthesize hasFetchedLiveEntranceNav=_hasFetchedLiveEntranceNav;
@property(nonatomic) _Bool hasFetchedRelatedLive; // @synthesize hasFetchedRelatedLive=_hasFetchedRelatedLive;
@property(nonatomic) _Bool hasJoinedLive; // @synthesize hasJoinedLive=_hasJoinedLive;
@property(retain, nonatomic) NSTimer *squareSwitchNavCheckFallbackTimer; // @synthesize squareSwitchNavCheckFallbackTimer=_squareSwitchNavCheckFallbackTimer;
...
@property(retain, nonatomic) NSString *contentVMTidWhenInfoReceived; // @synthesize contentVMTidWhenInfoReceived=_contentVMTidWhenInfoReceived;
...
@property(retain, nonatomic) WCFinderLiveRoomFastSlipLogic *fastSlipLogic; // @synthesize fastSlipLogic=_fastSlipLogic;
...
- (_Bool)isOffsetWithinInterimItem:(double)arg1;
@property(readonly, nonatomic) _Bool withinInterimItem;
...
@property(readonly, nonatomic) struct CGAffineTransform pivotVcRelatedLiveTransformation;
...
- (void)forceStartSquareSwitchNavCheckIfNeeded;
- (void)startSquareSwitchNavCheckIfNeeded;
- (void)triggerSquareSwitchNavCheckFromFetch;
- (void)startSquareSwitchNavCheckFallbackTimer;
- (void)invalidateSquareSwitchNavCheckFallbackTimer;
- (id)currentContentVM;
