...
@interface MMFInderLiveCreateNoticeSelectModeView : UIView
{
    ...
    CDUnknownBlockType _paidModeCannotSelectReasonBlock;
...
@property(copy, nonatomic) CDUnknownBlockType paidModeCannotSelectReasonBlock; // @synthesize paidModeCannotSelectReasonBlock=_paidModeCannotSelectReasonBlock;
