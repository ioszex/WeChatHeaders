...
@interface MMFinderLiveNoticeListViewController
{
    ...
    _Bool _allReserveButtonExposed;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool allReserveButtonExposed; // @synthesize allReserveButtonExposed=_allReserveButtonExposed;
...
- (void)reportAllReserveButtonClick:(_Bool)arg1;
- (void)reportAllReserveButtonExposeIfNeeded;
- (id)allReserveButtonEid;
