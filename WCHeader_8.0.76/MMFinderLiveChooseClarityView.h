...
+ (_Bool)isCanUseCdnTransInfoWithModelArray:(id)arg1 chooseStreamId:(id)arg2;
+ (id)getSwitchStreamClarityDataItemModelArray:(id)arg1 chooseStreamId:(id)arg2;
+ (id)transferToAnchorClarityModelArrayWithVideoLevels:(id)arg1 defaultQualityLevel:(unsigned int)arg2 liveTask:(id)arg3;
