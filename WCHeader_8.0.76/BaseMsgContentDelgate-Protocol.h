...
@class BaseChatViewModel, CBaseContact, CContact, CEmoticonWrap, CMessageWrap, ChatRoomPanelDynamicWeAppItem, ChatRoomToolMessageEventInfo, ChatTimeNodeRightButtonInfo, LinkBizSchemeWrap, LinkWeAppJumpWrap, MMGrowTextView, MMInputToolView, MMLiveInfoItem, MMMsgContentTipsItem, MMMusicInfo, MMWebViewController, MsgSendOpEntry, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSURL, ReaderMessageFolderViewModel, ReaderMessageTemplateMsgFolderViewModel, ServiceAppData, SolitaireObj, TemplateMsgFoldReportItem, TemplateReaderMessageFolderViewModel, TranslateInfo, UIBarButtonItem, UIColor, UIImage, UIImageView, UIScrollView, UIView;
@protocol MMMsgInputPresenter, ilinkMultiSelectLogicDelegate;

@protocol BaseMsgContentDelgate <NSObject, BaseMsgOperationDelegate, MsgDelegate>
...
- (void)StartPlaying:(CMessageWrap *)arg1 fromTime:(unsigned int)arg2;
- (_Bool)StopRecordingInTransState:(_Bool)arg1;
- (_Bool)IsRecording;
- (void)CancelRecording;
- (void)StopRecording;
- (_Bool)StartAudioRecording:(NSDictionary *)arg1;
- (double)GetHeadImageCornerRadius:(NSString *)arg1;
...
- (void)onMultiTalkButtonClick:(id <ilinkMultiSelectLogicDelegate>)arg1;
...
- (void)OnSharePreConfirmSendMsgList:(NSArray *)arg1;
- (_Bool)canReplyMsg;
...
- (void)onGrowTextViewDidStopVoiceInput:(MMGrowTextView *)arg1;
- (void)onGrowTextViewDidStartVoiceInput:(MMGrowTextView *)arg1;
...
- (void)onChangeReferMsgId:(long long)arg1 referPartXML:(NSString *)arg2;
- (void)onScheduleUrl:(NSString *)arg1 content:(NSString *)arg2;
...
- (void)shareMsgToDevice:(CMessageWrap *)arg1;
- (void)shareMsgToThirdPartyService:(CMessageWrap *)arg1;
...
- (void)onClickBrandPrivateMsgTipsBar:(MMMsgContentTipsItem *)arg1;
...
- (void)BatchRevokeMsg:(CMessageWrap *)arg1 withReportInterval:(unsigned long long)arg2;
...
- (NSMutableArray *)onMultiMsgDelete:(NSMutableArray *)arg1;
- (void)downloadMultiMsg:(NSMutableArray *)arg1 scene:(long long)arg2 params:(NSMutableDictionary *)arg3;
- (void)sendMultiMsgToThirdPartyService:(NSMutableArray *)arg1;
...
- (void)sendMultiMsgToFriend:(NSMutableArray *)arg1 params:(NSMutableDictionary *)arg2;
- (void)sendMultiMsgToFriend:(NSMutableArray *)arg1;
- (void)copyMultiMsg:(NSMutableArray *)arg1 params:(NSDictionary *)arg2;
...
- (_Bool)shouldBlockWebViewNavigationWithUrl:(NSString *)arg1 extraInfo:(NSMutableDictionary *)arg2 messageWrap:(CMessageWrap *)arg3;
...
- (void)OnTagBizSchemeLink:(LinkBizSchemeWrap *)arg1 messageWrap:(CMessageWrap *)arg2;
...
- (double)selectFlagCenterYForMessage:(CMessageWrap *)arg1 viewModel:(BaseChatViewModel *)arg2;
@end
