...
@interface MultiTalkMainViewController
{
    ...
    vector_4a6250cc memberIDMsgVector;
    ...
    _Bool _isFirstTimeViewDidAppeared;
    ...
    _Bool _hasReportGroupHideBtnExp;
    _Bool _isVoIPRoomWithOutsideContacts;
    _Bool _isSelfOutsideChatRoom;
    int _m_layoutType;
    ...
    WeToast *_toast;
    CDUnknownBlockType _displayAudioInterruptionToastBlock;
    unsigned long long _audioUnitReceivedCallbackCount;
    VoIPInvitationBreadthView *_invitationBreadthView;
    VoIPInvitationInfo *_invitationInfo;
    UIImageView *_invitationBreadthTransformView;
    VoIPInComingReportManager *_voipReportManager;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool isSelfOutsideChatRoom; // @synthesize isSelfOutsideChatRoom=_isSelfOutsideChatRoom;
@property(nonatomic) _Bool isVoIPRoomWithOutsideContacts; // @synthesize isVoIPRoomWithOutsideContacts=_isVoIPRoomWithOutsideContacts;
@property(nonatomic) _Bool hasReportGroupHideBtnExp; // @synthesize hasReportGroupHideBtnExp=_hasReportGroupHideBtnExp;
...
@property(retain, nonatomic) UIImageView *invitationBreadthTransformView; // @synthesize invitationBreadthTransformView=_invitationBreadthTransformView;
@property(retain, nonatomic) VoIPInvitationInfo *invitationInfo; // @synthesize invitationInfo=_invitationInfo;
@property(retain, nonatomic) VoIPInvitationBreadthView *invitationBreadthView; // @synthesize invitationBreadthView=_invitationBreadthView;
...
@property(copy, nonatomic) CDUnknownBlockType displayAudioInterruptionToastBlock; // @synthesize displayAudioInterruptionToastBlock=_displayAudioInterruptionToastBlock;
...
@property(nonatomic) _Bool isFirstTimeViewDidAppeared; // @synthesize isFirstTimeViewDidAppeared=_isFirstTimeViewDidAppeared;
...
- (id)rootView;
- (void)setupLockScreenIfNeeded;
- (void)reportGroupHideBtnClick;
- (void)reportGroupHideBtnExpIfNeeded;
- (id)groupHideBtnReportParams;
- (void)reportHiddenWithin1hBtnClick;
- (void)reportHiddenWithin1hBtnExpIfNeeded;
- (id)hiddenWithin1hBtnReportParamsForGroupCall;
- (void)reportMultiTalkFloatWindowClick;
- (void)scheduleMultiTalkFloatWindowExposureWithHiddenType:(long long)arg1 voipOperScene:(long long)arg2;
...
- (_Bool)voipMultiTalkLockScreenEnabled;
- (_Bool)shouldUseCrossPlatformScreenSharing;
- (void)onScreenProjectSelectMedia;
- (void)onScreenProjectSelectFile;
- (void)configScreenProjectSourceMenu;
- (void)showScreenProjectSourceMenu;
...
- (id)onMultiTalkMembersViewMemberStatusMapBeforeTalking;
...
- (void)onMultiTalkMemberDidTapped:(id)arg1;
...
- (void)handleCrossPlatformRemoteViewingIfNeeded;
...
- (void)updateMemberOutSideChatRoom:(id)arg1;
...
- (void)addRoomMembersWithChatRoomContact:(id)arg1;
...
- (_Bool)isInvitationCardViewExists;
...
- (void)_cancelDisplayingAudioInterruptionToast:(_Bool)arg1;
