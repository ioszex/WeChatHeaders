...
@class NSData, NSString, SnsEmojiInfoObj, WCAdSnsCommentExtInfo, WCMediaItem, WCMomentsDragonCommentInfo;
...
@interface WCUserComment : NSObject
{
    ...
    long long _springWishFlag;
    NSString *_springClientId;
    long long _messgaeRelevanceType;
...
+ (void)initialize;
+ (void)PBArrayAdd_springClientId;
...
@property(nonatomic) long long messgaeRelevanceType; // @synthesize messgaeRelevanceType=_messgaeRelevanceType;
...
@property(nonatomic) long long springWishFlag; // @synthesize springWishFlag=_springWishFlag;
...
@property(readonly, nonatomic) _Bool showsSpringBackground;
@property(readonly, nonatomic) _Bool isSpringGreeting;
...
- (_Bool)isMessageRelatedToMeFromDB;
@property(readonly, nonatomic) _Bool mentionSelfPost;
