...
@class CContact, MMHeadImageView, MMTipsViewController, MMUIButton, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, SharePreConfirmSheetView, TLProfileDragAnimateHelper, TLProfileExpandableHeaderView, TLProfileModel, UIButton, UIPanGestureRecognizer, UIView, WCADPageWrap, WCAdvertiseActionFloatView, WCAdvertiseFeedbackBaseView, WCCommentEmotionFloatView, WCCoverActionReporter, WCDataItem, WCFinderSnSShareLiveLogicController, WCListHeaderView, WCMomentsPostReportSession, WCMomentsPostShareBaseViewModel, WCMomentsShareScopeMgr, WCMomentsTemplateShareInfo, WCMomentsTigerReporter, WCOperateFloatView, WCPasteTextLengthLogic, WCPlainTextTipFullScreenView, WCScrollViewMonitor, WCTimeLineFooterView, WCTimeLineHeaderView, WCTimeLineVideoPreloadMgr, WCTimelineDeleteDataItemWrap, WCTimelineFPSLabel, WCTimelineFPSMonitor, WCTogetherTailReporter;
...
@interface WCTimeLineViewController
{
    ...
    _Bool _bInvalidateCacheAsLimitModeChanged;
    _Bool _isCoverNewVersion;
    _Bool _isModeTall;
    _Bool _hasChangedFoldedState;
    _Bool _isModifyingStarStatus;
    _Bool _isStaysAtFirstPageWhenLeaving;
    ...
    WCMomentsPostShareBaseViewModel *_postingViewModel;
    ...
    long long _messageTipCount;
    NSString *_messageTipUserName;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool isStaysAtFirstPageWhenLeaving; // @synthesize isStaysAtFirstPageWhenLeaving=_isStaysAtFirstPageWhenLeaving;
...
@property(nonatomic) _Bool isModeTall; // @synthesize isModeTall=_isModeTall;
@property(nonatomic) _Bool isCoverNewVersion; // @synthesize isCoverNewVersion=_isCoverNewVersion;
...
@property(nonatomic) _Bool bInvalidateCacheAsLimitModeChanged; // @synthesize bInvalidateCacheAsLimitModeChanged=_bInvalidateCacheAsLimitModeChanged;
...
@property(retain, nonatomic) NSString *messageTipUserName; // @synthesize messageTipUserName=_messageTipUserName;
@property(nonatomic) long long messageTipCount; // @synthesize messageTipCount=_messageTipCount;
...
@property(retain) WCMomentsPostShareBaseViewModel *postingViewModel; // @synthesize postingViewModel=_postingViewModel;
...
- (void)reportFinderPostResult:(_Bool)arg1;
- (void)postEditMgrFailByPostSession:(id)arg1;
- (void)postEditMgrSucFromVC:(id)arg1 postSession:(id)arg2;
- (void)onCommentViewAddEmotionForItem:(id)arg1 comment:(id)arg2;
- (void)onCommentViewPicClickForItem:(id)arg1 comment:(id)arg2;
- (void)onCommentViewEmoticonClickForItem:(id)arg1 comment:(id)arg2;
- (void)onCommentViewClickForItem:(id)arg1 comment:(id)arg2;
- (void)onCommentViewExposureForItem:(id)arg1 comment:(id)arg2;
...
- (_Bool)canShowSharePublishPage;
- (void)footerCellDidClickPoiShareButton:(id)arg1;
- (void)footerCellDidClickFinderShareButton:(id)arg1;
- (void)footerCellDidClickMicroMerchantMoreView:(id)arg1;
...
- (void)doWorldCupAvatarLeaveCanvasWithDataItem:(id)arg1;
- (void)onAdCommonBarWorldCupAvatarLeaveCanvasWithDataItem:(id)arg1;
- (void)onRockPaperScissorsLeaveCanvasWithDataItem:(id)arg1 showComment:(_Bool)arg2;
...
- (void)onRemoveAd:(id)arg1 dislikeReasonIdList:(id)arg2 deferReport:(_Bool)arg3;
...
- (void)onWCTimeLineCellViewShowProfile:(id)arg1 jumpData:(id)arg2;
...
- (void)configDataReportForMessageTipView:(id)arg1;
...
- (void)configDataReportForActionSheet:(id)arg1;
...
- (_Bool)shouldPauseAutoPlayForRealodData;
...
- (void)onPostTipsViewDisappearWithDataItemIDs:(id)arg1;
...
- (_Bool)isTableViewStaysAtFirstPage:(id)arg1;
- (void)willDisshow;
- (void)willDisappear;
- (void)didAppear;
- (void)willAppear;
...
- (void)configDataReportForCameraBtn:(id)arg1;
- (void)resetRightBarItem;
- (void)viewDidLayoutSubviews;
- (void)adjustViewAndNavBarRect;
- (void)viewDidTransitionToNewSize;
- (_Bool)shouldRefreshHead;
...
- (void)handleDragCover:(double)arg1;
