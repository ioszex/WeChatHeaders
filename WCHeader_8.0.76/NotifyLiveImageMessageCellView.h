...
@property(retain, nonatomic) MMUIButton *headerTapButton; // @synthesize headerTapButton=_headerTapButton;
...
- (void)reportWatchLiveBanner:(_Bool)arg1;
...
- (void)onTapHeaderArea;
- (id)genHeaderTapButton;
