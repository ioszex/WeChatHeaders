...
+ (void)onClickAudio:(id)arg1 section:(id)arg2 scene:(int)arg3 username:(id)arg4 postLiteAppParams:(id)arg5 navController:(id)arg6 reportParams:(id)arg7;
...
+ (id)reportProfileAudioCardClickForAudio:(id)arg1 profileUsername:(id)arg2 cardIndex:(long long)arg3 commentScene:(int)arg4;
+ (void)reportProfileAudioCardExposeForAudio:(id)arg1 profileUsername:(id)arg2 cardIndex:(long long)arg3 commentScene:(int)arg4;
+ (id)profileAudioCardParamsForAudio:(id)arg1 profileUsername:(id)arg2 cardIndex:(long long)arg3 commentScene:(int)arg4;
...
- (void)onClickAudio:(id)arg1 section:(id)arg2 postLiteAppParams:(id)arg3 navController:(id)arg4 reportParams:(id)arg5;
...
- (void)bindSDKReport:(id)arg1 forAudio:(id)arg2 tabName:(id)arg3 cardIndex:(long long)arg4;
