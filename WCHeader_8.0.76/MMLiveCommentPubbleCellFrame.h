...
@class MMLiveBaseTask, MMLiveCommentDataItem, MMLiveCommentPubbleCellFrameExtraConfig, MMLiveTaskId, NSArray, NSMutableDictionary, NSNumber, NSString;
...
@interface MMLiveCommentPubbleCellFrame : NSObject
{
    ...
    MMLiveCommentPubbleCellFrameExtraConfig *_extraConfig;
...
+ (id)createTextView;
- (void).cxx_destruct;
@property(retain, nonatomic) MMLiveCommentPubbleCellFrameExtraConfig *extraConfig; // @synthesize extraConfig=_extraConfig;
...
- (void)transferToPubbleUIType:(id)arg1 newHeaderStyle:(_Bool)arg2;
