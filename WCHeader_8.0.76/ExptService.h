...
@interface ExptService
{
    ...
    _Bool _isAuthOk;
    _Bool _isReqNow;
    _Bool _isUseExptV2Logic;
    _Bool _isUseEnFormatNumber;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isUseEnFormatNumber; // @synthesize isUseEnFormatNumber=_isUseEnFormatNumber;
@property(nonatomic) _Bool isUseExptV2Logic; // @synthesize isUseExptV2Logic=_isUseExptV2Logic;
@property(retain) NSString *globalSequence; // @synthesize globalSequence=_globalSequence;
...
- (id)getStringExptV2:(id)arg1 andNeedReport:(_Bool)arg2;
- (id)getExptItemByUseFlag:(id)arg1;
- (id)getStringExpt:(id)arg1;
- (long long)getIntegerExpt:(id)arg1 withDef:(long long)arg2;
- (id)useEnUSFormatNumber:(id)arg1;
