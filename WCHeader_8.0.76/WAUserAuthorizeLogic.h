...
@interface WAUserAuthorizeLogic
{
    ...
    CDUnknownBlockType _agentCardConfirmCompletion;
...
@property(copy, nonatomic) CDUnknownBlockType agentCardConfirmCompletion; // @synthesize agentCardConfirmCompletion=_agentCardConfirmCompletion;
...
- (void)notifyAgentCardConfirmCompletion:(_Bool)arg1;
...
- (_Bool)shouldPassAuthorize:(id)arg1;
