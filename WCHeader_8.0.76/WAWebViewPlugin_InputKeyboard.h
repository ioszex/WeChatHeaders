...
@interface WAWebViewPlugin_InputKeyboard
{
    ...
    _Bool _isExptEnableInputRecover;
    ...
    NSMutableDictionary *_originalInputViews;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *originalInputViews; // @synthesize originalInputViews=_originalInputViews;
@property(nonatomic) _Bool isExptEnableInputRecover; // @synthesize isExptEnableInputRecover=_isExptEnableInputRecover;
...
- (void)parseVariant:(id)arg1 forTextView:(id)arg2;
...
- (void)scheduleKeyboardShowTimeoutForField:(id)arg1;
...
- (void)onDone;
- (void)hideKeyBoard:(_Bool)arg1 inputId:(long long)arg2;
...
- (void)sendOnKeyboardShowEvent:(id)arg1 height:(double)arg2 duration:(double)arg3;
...
- (void)recoverInputView:(id)arg1;
- (void)setEmptyInputViewIfAgentMode:(id)arg1;
