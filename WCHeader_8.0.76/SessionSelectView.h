...
@class FTSTopHitMgr, MISSING_TYPE, MMTableView, MMUILabel, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, OrderedDictionary, RecentForwardScrollView, SessionSelectMessageSearchLogic, SessionSelectSectionFoldView, UIColor, WCDataSearcher, WCSearchBar;
...
@interface SessionSelectView : UIView
{
    ...
    _Bool _m_ignoresChatBotTransfer;
    _Bool _m_recentForwardHidden;
    _Bool _m_searchPanelHidden;
    _Bool _m_disableSearchBar;
    _Bool _useNewSearchBar;
    _Bool _m_isSupportMultipleWordsSearchCreateGroup;
    _Bool _isFoldTopSession;
    _Bool _canFoldTopSession;
    _Bool _hasModifiedSelectedContacts;
    _Bool _contactSearchDidFinish;
    int _forwardOtherAppEntry;
    NSDictionary *m_dicRequiredContact;
    unsigned long long m_specificLogicScene;
    MISSING_TYPE *_searcher;
    NSDictionary *_m_disabledContacts;
    ...
    SessionSelectMessageSearchLogic *_messageSearchLogic;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool contactSearchDidFinish; // @synthesize contactSearchDidFinish=_contactSearchDidFinish;
@property(retain, nonatomic) SessionSelectMessageSearchLogic *messageSearchLogic; // @synthesize messageSearchLogic=_messageSearchLogic;
@property(nonatomic) int forwardOtherAppEntry; // @synthesize forwardOtherAppEntry=_forwardOtherAppEntry;
...
@property(nonatomic) _Bool m_isSupportMultipleWordsSearchCreateGroup; // @synthesize m_isSupportMultipleWordsSearchCreateGroup=_m_isSupportMultipleWordsSearchCreateGroup;
...
@property(nonatomic) _Bool m_disableSearchBar; // @synthesize m_disableSearchBar=_m_disableSearchBar;
...
@property(copy, nonatomic) NSDictionary *m_disabledContacts; // @synthesize m_disabledContacts=_m_disabledContacts;
...
@property(nonatomic) _Bool m_ignoresChatBotTransfer; // @synthesize m_ignoresChatBotTransfer=_m_ignoresChatBotTransfer;
...
@property(nonatomic) unsigned long long m_specificLogicScene; // @synthesize m_specificLogicScene;
...
@property(retain, nonatomic) NSDictionary *m_dicRequiredContact; // @synthesize m_dicRequiredContact;
...
- (void)mergeMessageSearchResultsAndNotify;
- (_Bool)sessionSelectMessageSearchLogic:(id)arg1 shouldIncludeContact:(id)arg2;
- (void)sessionSelectMessageSearchLogicDidUpdate:(id)arg1;
...
- (void)resetCombinedSearchResultForNewQuery;
- (void)cancelSearch;
...
- (_Bool)isSelectEnabledForContact:(id)arg1;
- (id)getGroupDispName:(id)arg1;
- (void)onSelect:(id)arg1;
- (void)handleForwardToOtherApp;
...
- (id)getForwardParams;
- (id)generateForwardButton;
- (double)getRecentChatSectionHeaderHeight;
- (long long)forwardEntryType;
- (_Bool)isOpenOtherAppEntry;
