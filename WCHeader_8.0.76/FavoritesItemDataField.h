...
@class FavBrandMpVideoItem, FavEmoticonItem, FavLocationItem, FavProductItem, FavReferMsgItem, FavStreamVideoItem, FavTVItem, FavURLItem, FavWeAppItem, FavoritePhotoAccountNameCard, FavoritesDataItemSource, FavoritesLivePhoto, LiteAppSharedItem, MMMusicShareItem, NSArray, NSString, RecordGroupCdn, TingShareCategoryItem, TingShareListenItem, WCFinderCollectionShareItem, WCFinderContentColumnSharedItem, WCFinderLiveProductShareItem, WCFinderLiveShareItem, WCFinderLiveShopWindowShareItem, WCFinderMessageShareNameCard, WCFinderShareToMomentsItem, WCFinderThemeLiveStreamShareItem, WCFinderTopicShareItem, WCMegaVideoShareItem;

@interface FavoritesItemDataField
{
    _Bool _isHighQualityResources;
    _Bool _isSmallImage;
    ...
    FavoritesLivePhoto *_livePhoto;
    FavoritePhotoAccountNameCard *_photoAccountNameCard;
    RecordGroupCdn *_groupCdn;
    NSString *_link;
    NSString *_brandId;
...
+ (id)configWithWebPageURLItem:(id)arg1;
...
+ (id)configWithVideoData:(id)arg1 format:(id)arg2;
...
@property(retain, nonatomic) RecordGroupCdn *groupCdn; // @synthesize groupCdn=_groupCdn;
@property(retain, nonatomic) FavoritePhotoAccountNameCard *photoAccountNameCard; // @synthesize photoAccountNameCard=_photoAccountNameCard;
@property(retain, nonatomic) FavoritesLivePhoto *livePhoto; // @synthesize livePhoto=_livePhoto;
...
@property(retain, nonatomic) NSString *srcMsgContent; // @synthesize srcMsgContent=_srcMsgContent;
...
@property(nonatomic) _Bool isHighQualityResources; // @synthesize isHighQualityResources=_isHighQualityResources;
