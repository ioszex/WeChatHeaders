...
@class BraceletRankLikeButton, DeviceBrandJumpInfo, DeviceRankInfo, MMHeadImageView, MMUIButton, MMUIViewController, MMWebImageView, NSString, UILabel, UIView, WAContact, WAContactGetter;

@interface BraceletRankInfoViewV2
{
    DeviceRankInfo *m_rankInfo;
    _Bool m_isBotton;
    _Bool m_isFromFocus;
    _Bool m_bShowRedDot;
    _Bool _hasWorkoutView;
    UILabel *_rankLabel;
    UILabel *_scoreLabel;
    ...
    double _workoutViewCenterY;
    MMUIViewController *_parentVC;
    DeviceBrandJumpInfo *_jumpInfo;
}

+ (double)heightWithDeviceRankInfo:(id)arg1;
+ (id)p_displayRecordForRankInfo:(id)arg1;
+ (void)setGlobalReservedUnitWidth:(double)arg1;
- (void).cxx_destruct;
...
@property(nonatomic) double workoutViewCenterY; // @synthesize workoutViewCenterY=_workoutViewCenterY;
@property(nonatomic) _Bool hasWorkoutView; // @synthesize hasWorkoutView=_hasWorkoutView;
...
- (void)p_layoutLikeButtonIfNeeded;
- (void)p_updateHeightWithContentBottom:(double)arg1;
- (void)addWorkoutRecordViewWithRecord:(id)arg1;
- (void)addWorkoutView;
- (void)addSeperateLine;
- (void)initView;
- (double)p_reservedUnitWidth;
- (_Bool)p_hasWorkoutImageForRecord:(id)arg1;
- (id)p_workoutAttributedTextWithRecord:(id)arg1;
