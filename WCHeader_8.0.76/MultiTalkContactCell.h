...
@class CContact, ColorGradientView, MMTimer, MMUILabel, MultiTalkHDHeadView, MultiTalkMuteIconView, MultiTalkSharingScreenTipsView, NSObject, NSString, UIImageView, UILabel, VoIPPendingDotsView, WCVideoRender;
@protocol MultiTalkContactCellDelegate, MultiTalkMemberProtocol;
...
@interface MultiTalkContactCell : UIView
{
    ...
    VoIPPendingDotsView *_m_waittingDotsView;
    unsigned long long _m_waittingImageListIndex;
    UIView *_m_pendingOverlayView;
    VoIPPendingDotsView *_m_pendingDotsView;
...
@property(nonatomic) _Bool m_beforeTalkingPending; // @synthesize m_beforeTalkingPending=_m_beforeTalkingPending;
@property(retain, nonatomic) VoIPPendingDotsView *m_pendingDotsView; // @synthesize m_pendingDotsView=_m_pendingDotsView;
@property(retain, nonatomic) UIView *m_pendingOverlayView; // @synthesize m_pendingOverlayView=_m_pendingOverlayView;
@property(nonatomic) unsigned long long m_waittingImageListIndex; // @synthesize m_waittingImageListIndex=_m_waittingImageListIndex;
@property(retain, nonatomic) VoIPPendingDotsView *m_waittingDotsView; // @synthesize m_waittingDotsView=_m_waittingDotsView;
...
- (void)updateCellInviteInfoView:(_Bool)arg1 callerName:(id)arg2;
...
- (void)setBeforeTalkingPending:(_Bool)arg1;
