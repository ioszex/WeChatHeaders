...
@interface WCFinderSyncExptSwitchModel : NSObject
{
    ...
    _Bool _privateRedDotUseFinderSvr;
    _Bool _allowComboLike;
    NSString *_testExptString;
    long long _timelineTabCacheFeedValue;
    NSString *_findPageRedDotAvatarAvoidanceRule;
    NSString *_findPageRedDotTwoLinesAvoidanceRule;
...
@property(nonatomic) _Bool allowComboLike; // @synthesize allowComboLike=_allowComboLike;
@property(nonatomic) _Bool privateRedDotUseFinderSvr; // @synthesize privateRedDotUseFinderSvr=_privateRedDotUseFinderSvr;
...
@property(copy, nonatomic) NSString *findPageRedDotTwoLinesAvoidanceRule; // @synthesize findPageRedDotTwoLinesAvoidanceRule=_findPageRedDotTwoLinesAvoidanceRule;
@property(copy, nonatomic) NSString *findPageRedDotAvatarAvoidanceRule; // @synthesize findPageRedDotAvatarAvoidanceRule=_findPageRedDotAvatarAvoidanceRule;
...
@property(readonly, nonatomic) _Bool isNewLifeTagStreamOpened;
@property(readonly, nonatomic) _Bool isNewLifeEntryOpened;
- (_Bool)getPureIsNewLifeTagStreamOpened;
- (_Bool)getPureIsNewLifeEntryOpened;
@property(readonly, nonatomic) _Bool isNewLifePhotoAtSecondTab;
- (_Bool)enableFriendTabHighEntropy;
- (id)getExptValueByKeyName:(id)arg1;
