...
+ (void)ensureFTSStarTypeBackfilledIfNeeded;
+ (_Bool)hasAnyStarredFavorites;
+ (_Bool)isFavFilterStarTabName:(id)arg1;
+ (id)favFilterStarTabName;
+ (_Bool)isFavStarFilterEnabled;
+ (_Bool)isFilterRedesignEnabled;
+ (_Bool)isFavOriginImgVideoEnabled;
+ (id)genMessageTimeStringFromFavData:(id)arg1;
...
+ (void)logNewCardBottomBarSourceDebugInfo:(id)arg1 showStarIcon:(_Bool)arg2 hideBottomRow:(_Bool)arg3;
+ (id)getNewCardBottomSourceNameForBaselineData:(id)arg1;
+ (id)getNewMediaCardSourceTypeDisplayNameForItem:(id)arg1;
+ (id)getNewCardBottomFromTextForSenderName:(id)arg1;
+ (_Bool)shouldShowSingleChatSecondSourceSegmentForItem:(id)arg1;
+ (id)getNewMediaCardSenderDisplayNameForItem:(id)arg1;
+ (id)getDisplaySourceNameForItem:(id)arg1 delegate:(id)arg2;
+ (id)getUnnamedChatRoomDisplayNameForGroupUsr:(id)arg1;
+ (id)getNewCardBottomSenderDisplayNameForItem:(id)arg1;
+ (id)getSingleChatPeerDisplayNameForItem:(id)arg1;
+ (_Bool)isFavItemFromSingleChat:(id)arg1;
+ (_Bool)shouldShowNewCardBottomFromTextForItem:(id)arg1;
+ (_Bool)isFavItemFromChatSession:(id)arg1;
+ (_Bool)isFavItemFromMoments:(id)arg1;
...
+ (id)ConvertPhotoAccountNameCard2FavItem:(id)arg1;
+ (id)ConvertFinderCollectionItem2FavItem:(id)arg1 lastUpdateTime:(unsigned int)arg2;
...
+ (id)ConvertImg2MsgWrap:(id)arg1 isOriginImage:(_Bool)arg2;
+ (id)ConvertImg2MsgWrap:(id)arg1;
+ (id)ConvertImgFavData2MsgWrap:(id)arg1 isFavFastSendToChatEnable:(_Bool)arg2;
...
+ (_Bool)isRecordMsgExpiredAndInvalid:(id)arg1;
+ (_Bool)checkDataListHasInvalidResource:(id)arg1;
...
+ (id)ConvertAISearchMsgToFavItem:(id)arg1;
+ (id)ConvertAISearchWCToFavItem:(id)arg1;
...
+ (id)ConvertVideoMsg2FavItem:(id)arg1 isForceOriginal:(_Bool)arg2;
...
+ (id)ConvertImgPost2FavItem:(id)arg1 ThumbPath:(id)arg2 sourceType:(int)arg3;
...
+ (id)ConvertImgMsg2FavItem:(id)arg1 isForceOriginal:(_Bool)arg2;
...
+ (id)ConvertUrlWeb2FavItem:(id)arg1 Title:(id)arg2 Desc:(id)arg3 ThumbUrl:(id)arg4 AppId:(id)arg5 UserName:(id)arg6 publisherUsername:(id)arg7 PublishId:(id)arg8 appShareItem:(id)arg9 starBizKey:(id)arg10;
...
+ (id)ConvertSelectedTextSNS2FavItem:(id)arg1 selectedText:(id)arg2;
...
+ (id)ConvertMsgToFavItem:(id)arg1 isForceOriginal:(_Bool)arg2;
