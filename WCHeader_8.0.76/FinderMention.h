...
@class CommentContentInfo, FinderAchievementMentionInfo, FinderCommentMentionedUser, FinderContact, FinderFollowReasonInfo, FinderHelpPromotionMentionInfo, FinderIdentityInfo, FinderJumpInfo, FinderMentionAggregated, FinderMentionContact, FinderMentionExtInfo, FinderMention_FinderMentionThankInfo, FinderMention_LikeContactInfo, FinderNotification, FinderPoiInteractionInfo, NSMutableArray, NSString, NewLifeMentionInfo;
...
@property(retain, nonatomic) FinderAchievementMentionInfo *achievementMentionInfo; // @dynamic achievementMentionInfo;
...
@property(nonatomic) unsigned int reddotMentionType; // @dynamic reddotMentionType;
...
@property(retain, nonatomic) NSString *reportUdfKvJson; // @dynamic reportUdfKvJson;
