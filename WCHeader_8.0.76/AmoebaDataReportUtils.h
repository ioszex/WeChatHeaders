...
+ (void)setExposeDebugLogSwitchStatus:(_Bool)arg1;
+ (_Bool)getExposeDebugLogSwitchStatus;
+ (void)setAmoebaDebugViewSwitchStatus:(_Bool)arg1;
+ (_Bool)getAmoebaDebugViewSwitchStatus;
+ (_Bool)isSentinelDebugEnabled;
+ (_Bool)getSentinelDebugCloudSwitchStatus;
+ (void)setSentinelDebugLocalSwitchStatus:(_Bool)arg1;
+ (_Bool)getSentinelDebugLocalSwitchStatus;
+ (_Bool)isSentinelKVReportEnabled;
+ (void)resetSentinelKVCloudSwitchTime;
+ (_Bool)getSentinelKVCloudSwitchStatus;
+ (void)setSentinelKVLocalSwitchStatus:(_Bool)arg1;
+ (_Bool)getSentinelKVLocalSwitchStatus;
...
+ (id)safeCopyParamsInternal:(id)arg1 retry:(long long)arg2;
+ (id)safeCopyParams:(id)arg1;
+ (_Bool)checkContainsMutableCollectionInternal:(id)arg1 keyPath:(id)arg2;
+ (_Bool)checkContainsMutableCollection:(id)arg1;
