...
@property(nonatomic) _Bool m_isCurrentInActive; // @synthesize m_isCurrentInActive=_m_isCurrentInActive;
...
- (_Bool)setCategroy:(unsigned long long)arg1 mode:(id)arg2 options:(unsigned long long)arg3 optionsForbidModify:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5 error:(id *)arg6 withBlockType:(unsigned long long)arg7;
...
- (_Bool)setCategroy:(unsigned long long)arg1 mode:(id)arg2 defaultToSpeaker:(_Bool)arg3 mixWithOthers:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5;
