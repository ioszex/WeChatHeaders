...
@class CMessageWrap, CTRichTextView, CrossfadeAnimationController, MMMsgMenuReporter, MMRichTextCoverView, MMScrollView, MMTextFloatBottomToolView, NSMutableArray, NSString, TextFloatReferButton, UIButton, UIFont, UIView;
...
- (void)forceUnderlyingChatBackToPortraitIfNeeded;
