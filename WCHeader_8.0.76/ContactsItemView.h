...
@interface ContactsItemView
{
    ...
    _Bool _m_bShowChatRoomFriendCount;
    ...
    double _messageSearchDetailMaxWidth;
}

- (void).cxx_destruct;
@property(nonatomic) double messageSearchDetailMaxWidth; // @synthesize messageSearchDetailMaxWidth=_messageSearchDetailMaxWidth;
...
@property(nonatomic) _Bool m_bShowChatRoomFriendCount; // @synthesize m_bShowChatRoomFriendCount=_m_bShowChatRoomFriendCount;
...
- (double)messageSearchDescLabelMaxWidth;
...
- (void)showChatRoomMemberContactsItemView:(id)arg1 chatContact:(id)arg2;
