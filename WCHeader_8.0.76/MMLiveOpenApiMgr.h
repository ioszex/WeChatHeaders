...
@interface MMLiveOpenApiMgr
{
    ...
    double _videoFrameStatStartTime;
}

- (void).cxx_destruct;
@property(nonatomic) double videoFrameStatStartTime; // @synthesize videoFrameStatStartTime=_videoFrameStatStartTime;
@property unsigned long long videoFrameCount; // @synthesize videoFrameCount=_videoFrameCount;
@property(nonatomic) _Bool miniGamePking; // @synthesize miniGamePking=_miniGamePking;
...
- (unsigned int)convertFromLiveCommentMsgType:(id)arg1;
- (_Bool)isLiveRoomMsgTypeSupport:(id)arg1;
...
- (void)onGetFinderLiveLayerAnchorVerificationShowInfoWithTaskId:(id)arg1 showInfo:(id)arg2;
...
- (void)stopMiniGamePK:(unsigned long long)arg1;
- (void)onCaptureStatusChange:(unsigned long long)arg1;
- (void)recordVideoFrameStat;
