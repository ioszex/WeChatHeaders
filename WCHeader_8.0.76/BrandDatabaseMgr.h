...
{
    id <BrandDatabaseNotifyDelegate> _delegate;
    WCTDatabase *_db;
    WCTTable *_tableMPPageCacheItem;
    WCTTable *_tableMPPageReportItem;
    WCTTable *_tableBrandDigestInfo;
    WCTTable *_tablePhotoAccountDigestInfo;
...
@property(retain) WCTTable *tablePhotoAccountDigestInfo; // @synthesize tablePhotoAccountDigestInfo=_tablePhotoAccountDigestInfo;
@property(retain) WCTTable *tableBrandDigestInfo; // @synthesize tableBrandDigestInfo=_tableBrandDigestInfo;
...
@property(nonatomic) __weak id <BrandDatabaseNotifyDelegate> delegate; // @synthesize delegate=_delegate;
- (id)setupTableWithName:(id)arg1 tableClass:(Class)arg2;
- (void)createTables;
- (id)dbPath;
- (void)closeDB;
- (void)openDB;
- (_Bool)checkPhotoAccountDigestInfoShouldUpdate:(id)arg1;
- (void)deletePhotoAccountDigestInfoByUsername:(id)arg1;
- (id)getPhotoAccountDigestInfoWithUsername:(id)arg1;
- (id)getLatestPhotoAccountDigestInfo;
- (_Bool)updateDigestInfoForPhotoAccount:(id)arg1;
- (void)setHasDeleteUnSubscribeContactDigestInfo;
- (_Bool)shouldDeleteUnSubscribeContactDigestInfo;
- (void)deleteUnSubscribeContactDigestInfoIfNeed;
- (void)deleteDigestInfoByUsername:(id)arg1;
- (id)getDigestInfoWithUsername:(id)arg1;
- (_Bool)checkDigestInfoShouldUpdate:(id)arg1;
- (long long)genDataIdData:(id)arg1;
- (long long)getSavedDataId;
- (id)getLatestDigestInfo;
- (_Bool)replaceOrInsertDigestInfo:(id)arg1;
