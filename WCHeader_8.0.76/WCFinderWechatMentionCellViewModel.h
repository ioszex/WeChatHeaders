...
@class NSArray, NSString, WCFinderAuthInfo, WCFinderContact, WCFinderMention, WCFinderMentionLayoutMetrics;
...
- (_Bool)supportShowThankSharingTips;
...
- (void)dealloc;
- (id)initWithMention:(id)arg1 cacheContainerWidth:(double)arg2 displayStyle:(unsigned long long)arg3;
