...
@interface CommonMessageViewModel
{
    ...
    struct CGSize _sourceTailSize;
    struct UIEdgeInsets _replyTextInset;
}

- (void).cxx_destruct;
@property(nonatomic) struct CGSize sourceTailSize; // @synthesize sourceTailSize=_sourceTailSize;
...
- (struct CGSize)calculateCommonTailSize;
- (struct CGSize)commonTailSize;
