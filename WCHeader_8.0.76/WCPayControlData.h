...
@interface WCPayControlData : NSObject
{
    ...
    MISSING_TYPE *_m_uiFetchChargeFee;
    ...
    NSString *_payInitRawUrl;
    long long _payInitTimestamp;
    NSString *_nfcCardType;
    NSString *_nfcCardId;
    SimplePKPass *_pkPass;
    NFCCardsQueryNFCCardInfoResponse *_nfcCardInfoResponse;
    NSString *_recvBindSerial;
    NSString *_collectPalmSessionId;
    NSString *_palmSdkConfig;
    NSString *_palmGuidePopupConfig;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool fromTransCollection; // @synthesize fromTransCollection=_fromTransCollection;
@property(retain, nonatomic) NSString *palmGuidePopupConfig; // @synthesize palmGuidePopupConfig=_palmGuidePopupConfig;
@property(nonatomic) unsigned int guidePopUpMode; // @synthesize guidePopUpMode=_guidePopUpMode;
...
@property(retain, nonatomic) NSString *recvBindSerial; // @synthesize recvBindSerial=_recvBindSerial;
...
@property(nonatomic) long long payInitTimestamp; // @synthesize payInitTimestamp=_payInitTimestamp;
@property(retain, nonatomic) NSString *payInitRawUrl; // @synthesize payInitRawUrl=_payInitRawUrl;
...
@property(retain, nonatomic) NSString *m_mktBizInfo; // @synthesize m_mktBizInfo=_m_mktBizInfo;
...
@property(nonatomic) _Bool fromPinnedShortcut; // @synthesize fromPinnedShortcut=_fromPinnedShortcut;
