...
- (void)setMessageUnreadConditionForSyncClearUnread:(void *)arg1;
...
- (id)getAllNewMessageWrapArray:(id)arg1 onType:(unsigned int)arg2;
- (id)getValidNewMessageWrapArray:(id)arg1 onType:(unsigned int)arg2;
- (_Bool)addMessageToWCPayBizExtTable:(id)arg1;
- (_Bool)isNewBizExtHandled:(id)arg1 bizId:(id)arg2 bizType:(unsigned int)arg3;
