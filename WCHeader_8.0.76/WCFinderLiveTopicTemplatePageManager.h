...
@class FinderLiveEcGetLiveConfigResponse_ShowAnimation_HotSellingOptions, NSMutableArray, NSMutableSet, NSString, WCFinderFeedFlowView, WCFinderLiveStreamContainerModel;
...
@interface WCFinderLiveTopicTemplatePageManager : NSObject
{
    ...
    NSMutableSet *_playingIndexPaths;
...
@property(retain, nonatomic) NSMutableSet *playingIndexPaths; // @synthesize playingIndexPaths=_playingIndexPaths;
