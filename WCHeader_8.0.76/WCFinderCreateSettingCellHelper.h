...
+ (id)_createAntiLikeMistakeLeftView:(double)arg1 title:(id)arg2 subtitle:(id)arg3;
+ (id)createAntiLikeMistakeSwitchCell:(double)arg1 showLoadingBlock:(CDUnknownBlockType)arg2;
...
+ (id)createShowInWXProfileLeftView:(double)arg1 navVC:(id)arg2 enable:(_Bool)arg3;
...
+ (id)createShowInWXProfileSwitchCellIfNeedDisplay:(double)arg1 enable:(_Bool)arg2 navVC:(id)arg3;
