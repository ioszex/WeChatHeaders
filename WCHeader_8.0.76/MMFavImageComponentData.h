...
@interface MMFavImageComponentData
{
    ...
    _Bool _fromWebPage;
    _Bool _useStarMediaCompactLayout;
    _Bool _useNewMediaVideoStyle;
    _Bool _useNewMediaFinderOverlay;
    ...
    NSString *_finderOverlayName;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *finderOverlayName; // @synthesize finderOverlayName=_finderOverlayName;
@property(nonatomic) _Bool useNewMediaFinderOverlay; // @synthesize useNewMediaFinderOverlay=_useNewMediaFinderOverlay;
@property(copy, nonatomic) NSString *videoDurationText; // @synthesize videoDurationText=_videoDurationText;
@property(nonatomic) _Bool useNewMediaVideoStyle; // @synthesize useNewMediaVideoStyle=_useNewMediaVideoStyle;
@property(nonatomic) _Bool useStarMediaCompactLayout; // @synthesize useStarMediaCompactLayout=_useStarMediaCompactLayout;
