...
@class NSString, UIColor, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WAAppOpenSheetModeParameter, WAAppTask, WASheetPresentationController, WAWebViewController;
