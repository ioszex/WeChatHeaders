...
@class FBDocumentViewController, FBFilesViewController, MMAssetPickerController, MMUIViewController, MMUnderlineTabsView, NSArray, NSString, UIDocumentPickerViewController, UINavigationController, WCFileBrowserToolBar, WCFileBrowserToolBarViewModel;
...
@interface WCFileBrowser
{
    ...
    NSArray *_customTabItems;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *customTabItems; // @synthesize customTabItems=_customTabItems;
...
@property(retain, nonatomic) NSArray *allowFileExtension; // @synthesize allowFileExtension=_allowFileExtension;
...
- (void)reportFileSize;
- (void)reportLargeFileFinishButton;
- (void)sendMultiSelectFiles:(id)arg1;
