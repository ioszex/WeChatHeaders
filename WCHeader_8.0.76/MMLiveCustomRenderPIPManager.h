...
@interface MMLiveCustomRenderPIPManager
{
    ...
    _Bool _isManualRestorePictureInPicture;
...
@property(nonatomic) _Bool isManualRestorePictureInPicture; // @synthesize isManualRestorePictureInPicture=_isManualRestorePictureInPicture;
...
@property(nonatomic) _Bool isPIPContentAttached; // @synthesize isPIPContentAttached=_isPIPContentAttached;
...
- (int)getTemplateVideoSrcDuration:(_Bool)arg1;
- (void)initPIPVideoSrcWithCompletion:(CDUnknownBlockType)arg1;
- (void)createVideoCompositionWithAsset:(id)arg1 renderSize:(struct CGSize)arg2;
- (void)initTemplateVideoSrcWithRenderSize:(struct CGSize)arg1 duration:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)manualRestorePictureInPicture;
