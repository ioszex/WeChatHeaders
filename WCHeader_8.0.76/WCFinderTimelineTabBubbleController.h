...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, UIView, WCFinderBubbleActionItem, WCFinderCornerTextBubbleView, WCFinderEnterStreamTipBubbleView, WCFinderPopupPanelView, WCFinderPostStateBubbleView, WCFinderShadowBubbleView, WCFinderTLTabBubble, WCFinderTimelineRedDotBubbleDisplayInfo, WCFinderTimelineScrollTipsView;
...
@interface WCFinderTimelineTabBubbleController : NSObject
{
    ...
    NSMutableDictionary *_exposedExpiredTimeMap;
    long long _currentSelectedTabType;
    WCFinderShadowBubbleView *_refreshBubbleView;
    WCFinderPostStateBubbleView *_postBubbleView;
    struct CGRect _personalFrame;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderPostStateBubbleView *postBubbleView; // @synthesize postBubbleView=_postBubbleView;
...
@property(retain, nonatomic) NSMutableDictionary *exposedExpiredTimeMap; // @synthesize exposedExpiredTimeMap=_exposedExpiredTimeMap;
...
@property(nonatomic) struct CGRect personalFrame; // @synthesize personalFrame=_personalFrame;
...
- (void)notifyBubbleExpired:(long long)arg1;
...
- (void)_notifyBubbleItemDidDismiss:(unsigned long long)arg1;
- (void)_notifyBubbleItemDidShow:(unsigned long long)arg1;
- (void)_notifyBubbleItemDidEnqueue:(unsigned long long)arg1;
...
- (unsigned long long)timelineBubblePendingType;
- (unsigned long long)timelineBubbleShowType;
- (_Bool)hasBubblePendingInPipeline;
- (_Bool)timelineBubbleIsShowing;
- (void)hideStatusRefreshClickTips;
- (void)hideStatusRefreshByScrollToTid:(id)arg1;
- (void)showStatusRefreshClickTips:(CDUnknownBlockType)arg1 feedID:(id)arg2 animatePreconditionBlock:(CDUnknownBlockType)arg3;
- (void)resetPostBubbleView;
- (_Bool)showPostBubbleViewByLastContentVM:(id)arg1 currentContentVM:(id)arg2 beginBubbleState:(unsigned long long)arg3;
...
- (double)networkTipsMaxWidth;
- (unsigned long long)currentNetworkTipsStyle;
...
- (void)showBubbleWithIconUrls:(id)arg1 text:(id)arg2 style:(long long)arg3 darkBG:(_Bool)arg4 displayInfo:(id)arg5 requirements:(id)arg6;
- (void)showBubbleWithDslRender:(id)arg1 displayInfo:(id)arg2 requirements:(id)arg3 darkBG:(_Bool)arg4;
- (id)covertDisplayIconUrls:(id)arg1 mulitIcon:(_Bool)arg2;
- (long long)displayStyleForShowInfoType:(unsigned long long)arg1;
- (_Bool)_displayTipsWith:(id)arg1 requirements:(id)arg2 darkBG:(_Bool)arg3;
- (_Bool)displayStreamShowInfo:(id)arg1;
- (_Bool)refreshAnchorFramesBeforeDisplay;
- (void)recordTabFrames:(id)arg1 personalFrame:(struct CGRect)arg2;
