...
@class CALayer, EditFinderImageAttr, EditStoryImageAttr, EditVideoBGMSelectedMusicInfo, FinderMusicReportInfo, MISSING_TYPE, NSArray, NSMutableArray, NSMutableDictionary, NSString, NSURL, UIImage, WCLocationInfo;

@interface EditImageAttr
{
    _Bool _isEdited;
    _Bool _isEditedForReport;
    NSString *_url;
    UIImage *_editedImage;
    NSString *_editedImageAssetId;
    NSArray *_editedWidgetStateList;
    NSMutableArray *_editedImages;
    NSMutableArray *_selectGifDatas;
    ...
    double _snsCoverOffset;
    unsigned long long _editorSessionId;
    NSString *_yuanbaoTemplateId;
    NSString *_yuanbaoPhotoPath;
    NSString *_yuanbaoVideoPath;
...
@property(nonatomic) _Bool isEditedForReport; // @synthesize isEditedForReport=_isEditedForReport;
@property(nonatomic) struct CGSize cropSize; // @synthesize cropSize=_cropSize;
@property(retain, nonatomic) NSString *yuanbaoVideoPath; // @synthesize yuanbaoVideoPath=_yuanbaoVideoPath;
@property(retain, nonatomic) NSString *yuanbaoPhotoPath; // @synthesize yuanbaoPhotoPath=_yuanbaoPhotoPath;
@property(retain, nonatomic) NSString *yuanbaoTemplateId; // @synthesize yuanbaoTemplateId=_yuanbaoTemplateId;
@property(nonatomic) unsigned long long editorSessionId; // @synthesize editorSessionId=_editorSessionId;
@property(nonatomic) double snsCoverOffset; // @synthesize snsCoverOffset=_snsCoverOffset;
...
@property(retain, nonatomic) NSMutableArray *selectGifDatas; // @synthesize selectGifDatas=_selectGifDatas;
...
@property(retain, nonatomic) NSString *editedImageAssetId; // @synthesize editedImageAssetId=_editedImageAssetId;
...
- (void)generateImageMusicReportInfo;
