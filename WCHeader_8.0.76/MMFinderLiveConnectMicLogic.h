...
@class FinderJumpInfo, FinderJumpInfo_LiteApp, FinderLiveBattleInfo, FinderLiveBattleSettingInfo, FinderLiveGetPurchaseMicInfoResponse, FinderLiveLocation, FinderLiveMicInfo_Wording, FinderLivePurchaseMicConfig, MMFinderLiveAudioRoomConnectMicView, MMFinderLiveAudioRoomLocationGuideView, MMFinderLiveConnectMicAudienceApplyInfo, MMFinderLiveConnectMicAudienceApplyPageSheet, MMFinderLiveConnectMicFlowReporter, MMFinderLiveConnectMicLayoutModeSubtitleWrap, MMFinderLiveConnectMicOperationPanel, MMFinderLiveConnectMicPkPanel, MMFinderLiveConnectMicPkSelectionResult, MMFinderLiveConnectMicTeamPkPanel, MMFinderLiveConnectMicUser, MMFinderLiveFreeMicFeatureDescriptionPanel, MMFinderLiveMicInviteAudiencePanel, MMFinderLiveModifyMicSeatNamePanel, MMFinderLiveOperationView, MMFinderLiveOperationViewModel, MMFinderLivePaidConnectMicAudienceApplyInfo, MMFinderLivePaidConnectMicAudienceApplyPanel, MMFinderLivePaidConnectMicAudienceOperationPanel, MMFinderLivePaidConnectMicKeepAliveTipsView, MMFinderLiveTaskId, MMFinderLivedConnectMicAudiencePreviewCameraView, MMLiveAnchorConnectMicInfoFloatingViewDisplayLogic, MMLiveAudienceConnectMicSessionDataReporter, MMLiveBeautyUnifiedOperationPanel, MMLiveCachedConnectMicInfoBeforeSwitchCdnOrTrtc, MMLiveConnectMicAudienceCameraOperationPageSheet, MMLocatingCoordinateLogic, MMTimer, NSArray, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, OrderedDictionary, UIView, WCLiveActionSheet;
...
@interface MMFinderLiveConnectMicLogic
{
    ...
    _Bool _shouldShowStatisticsPanelAfterCloseMic;
    unsigned int _fetchLiveMicInfoFailedCount;
    int _closeCountOfJoinLiveRespAnchorMicSession;
    int _closeCountOfBattleInfoInJoinLiveResp;
    unsigned int _connectMicLayoutDurationStartTime;
    ...
    FinderLiveBattleInfo *_battleInfoInJoinLiveResp;
    ...
    CDUnknownBlockType _randomMicCompletionBlock;
    ...
    MMLiveAnchorConnectMicInfoFloatingViewDisplayLogic *_anchorConnectMicInfoFloatingViewDisplayLogic;
    ...
    unsigned long long _micLayoutBaseMode;
    ...
    MMLiveConnectMicAudienceCameraOperationPageSheet *_cameraSettingsPageSheet;
    ...
    unsigned long long _minConnectMicDurationForShowingStatisticsPanel;
...
@property(nonatomic) unsigned long long minConnectMicDurationForShowingStatisticsPanel; // @synthesize minConnectMicDurationForShowingStatisticsPanel=_minConnectMicDurationForShowingStatisticsPanel;
@property(nonatomic) _Bool shouldShowStatisticsPanelAfterCloseMic; // @synthesize shouldShowStatisticsPanelAfterCloseMic=_shouldShowStatisticsPanelAfterCloseMic;
...
@property(retain, nonatomic) MMLiveConnectMicAudienceCameraOperationPageSheet *cameraSettingsPageSheet; // @synthesize cameraSettingsPageSheet=_cameraSettingsPageSheet;
...
@property(nonatomic) unsigned int connectMicLayoutDurationStartTime; // @synthesize connectMicLayoutDurationStartTime=_connectMicLayoutDurationStartTime;
@property(nonatomic) unsigned long long micLayoutBaseMode; // @synthesize micLayoutBaseMode=_micLayoutBaseMode;
...
@property(nonatomic) int closeCountOfBattleInfoInJoinLiveResp; // @synthesize closeCountOfBattleInfoInJoinLiveResp=_closeCountOfBattleInfoInJoinLiveResp;
...
@property(retain, nonatomic) MMLiveAnchorConnectMicInfoFloatingViewDisplayLogic *anchorConnectMicInfoFloatingViewDisplayLogic; // @synthesize anchorConnectMicInfoFloatingViewDisplayLogic=_anchorConnectMicInfoFloatingViewDisplayLogic;
...
@property(copy, nonatomic) CDUnknownBlockType randomMicCompletionBlock; // @synthesize randomMicCompletionBlock=_randomMicCompletionBlock;
...
@property(retain, nonatomic) FinderLiveBattleInfo *battleInfoInJoinLiveResp; // @synthesize battleInfoInJoinLiveResp=_battleInfoInJoinLiveResp;
...
- (void)onLiveConnectMicOperationStopAudienceConnectMicWithFinderUserName:(id)arg1 forTaskId:(id)arg2;
- (void)onLiveConnectMicOperationInviteAudienceWithFinderLiveContact:(id)arg1 forTaskId:(id)arg2;
- (void)onLiveKTVSongOperationRequestSongBlockedWithType:(unsigned long long)arg1 taskId:(id)arg2 connectMicScene:(unsigned long long)arg3;
...
- (void)applyConnectMicToUser:(id)arg1 suppressMessages:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)startRandomMicWithApplyPos:(unsigned long long)arg1 suppressMessages:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)startRandomMicWithApplyPos:(unsigned long long)arg1;
...
- (void)reportConnectMicEstablishedWithUserSessionId:(id)arg1 timestampInMS:(unsigned long long)arg2 retryCount:(unsigned char)arg3;
...
- (_Bool)checkAndUpdateConnectMicUserTipViewRandomMicGuideStateWithFlag:(_Bool)arg1;
- (void)checkAndClearConnectMicUserTipViewWithUserInfo:(id)arg1;
- (void)checkAndClearConnectMicInfoFloatingViewForAudienceWithUserInfo:(id)arg1;
...
- (void)showCameraOperationPageSheetForAudience:(id)arg1;
- (void)showCameraOperationPageSheetForAudience;
- (void)showConfirmStopMicActionSheetForAudience;
- (_Bool)shouldShowConnectMicLeaveGuideWithScene:(unsigned int)arg1;
...
- (void)connectMicActionWithAiAssistantInfo:(id)arg1;
- (void)connectMicAction;
- (void)applyAudioMicForMiniGamePk;
- (void)doConnectMicActionForAudience;
- (void)connectMicActionForAudience:(unsigned long long)arg1 directAudioMic:(_Bool)arg2;
- (void)connectMicActionForMiniGamePk;
- (void)continueConnectMicApplyForAudience;
...
- (void)notifyGamePkStatusIfNeeded;
- (long long)currentMiniGamePkStatus;
- (void)applyOrdinaryConnectMicButtonStyleWithHighlighted:(_Bool)arg1 forLiveTask:(id)arg2;
- (_Bool)isConnectMicButtonHighlighted;
- (_Bool)canShowConnectMicPkButton;
- (void)refreshConnectMicButtonIconForAudioRoomSceneChange;
...
- (void)handleExitLiveRoomBecauseOfError;
- (void)handleUserManualCloseLive;
...
- (void)updateAllMicNormalizedUserFrameForTrtcUserInAnchorToAudiencePipScenario;
- (void)updateAllMicNormalizedUserFrameForTrtcUserInAnchorToAudienceDualScenario;
...
- (void)updateAnchorConnectMicInfoFloatingViewDisplayLogicWithMicInfo;
...
- (void)handleJoinLiveBattleInfoForAnchor:(id)arg1;
...
- (void)handleAnchorNewApplyConnectMicFromContact:(id)arg1 applyAnchor:(id)arg2 acceptorAnchor:(id)arg3 pkroomAnchors:(id)arg4 applyId:(id)arg5 randomMicBuffer:(id)arg6 expiredTime:(unsigned long long)arg7 applyFinderObject:(id)arg8;
...
- (void)receiveConnectMicLiveSdkInfo:(id)arg1 expiredTime:(unsigned long long)arg2 sessionId:(id)arg3 sdkUserId:(id)arg4 sequence:(unsigned long long)arg5 seatId:(unsigned int)arg6 useVideo:(_Bool)arg7 gameBuffer:(id)arg8;
...
- (void)onMMLiveConnectMicStatisticsPanelShowReplay:(id)arg1 withFragmentItem:(id)arg2 isKTVMode:(_Bool)arg3;
...
- (void)onConnectMicAudienceApplyIdentitySwitchTappedFromPageSheet:(id)arg1;
...
- (void)onMMFinderLiveConnectMicAllUserInfoViewTapAnchorSelfWithUserInfo:(id)arg1;
...
- (void)onMMFinderLiveConnectMicAllUserInfoViewTapCatalogedMerchandiseLotteryIndicatorView:(id)arg1;
...
- (void)onFinderLiveConnectMicContainerViewRefreshMicAnchorInfoWithSessionIds:(id)arg1 CompletionBlock:(CDUnknownBlockType)arg2;
...
- (void)onMMFinderLiveAudioRoomInfoViewEditMicTopic;
...
- (void)handleInviteAudienceMicWithSeatId:(unsigned int)arg1 inviteScene:(unsigned int)arg2 isVideoMic:(_Bool)arg3 expiredTime:(unsigned long long)arg4 inviteMicBuffer:(id)arg5;
- (void)inviteAudienceConnectMicWithUserInfo:(id)arg1 micIndex:(unsigned long long)arg2 inviteScene:(unsigned long long)arg3;
- (void)showInviteAudiencePanelWithMicIndex:(unsigned long long)arg1;
- (void)reportConnectMicLayoutDurationWithMicLayoutMode:(unsigned long long)arg1 micLayoutBaseMode:(unsigned long long)arg2 resetStartTime:(_Bool)arg3;
- (void)reportConnectMicLayoutDurationWithMicLayoutMode:(unsigned long long)arg1 micLayoutBaseMode:(unsigned long long)arg2 resetStartTime:(_Bool)arg3 lastMicTopic:(id)arg4;
- (unsigned long long)recommendedMicLayoutModeForPipBaseMode;
- (unsigned long long)recommendedMicLayoutModeForDualBaseMode;
- (unsigned long long)recommendedMicLayoutModeAfterAnchorChangedBaseModeToNewValue:(unsigned long long)arg1;
- (int)currentMicSettingMicLayoutBaseMode;
...
- (void)manualUpdateMicLayoutBaseMode:(unsigned long long)arg1;
- (void)updateMicLayoutBaseMode:(unsigned long long)arg1 micLayoutMode:(unsigned long long)arg2 focusedUserId:(id)arg3 userIndicesDict:(id)arg4 andUpdateMicInfo:(_Bool)arg5;
...
- (_Bool)enableConnectMicDirectMode;
- (_Bool)enableConnectMicSwitchIdentity;
- (_Bool)enableConnectMicControlBar;
- (void)showEndMicConfirmForAudience;
- (void)showCameraSettingsForAudience;
- (void)toggleAudienceMicMute;
...
- (void)checkAndShowConnectMicStatisticsPanel;
...
- (void)updateCanShowMicTopicForAnchor;
- (void)showMicTopicSettingPanelWithScene:(unsigned long long)arg1;
