...
@class MISSING_TYPE, MMITransmitKvData, MMLocationInfoStruct, MMVoidF32F32BoolCallback, MMVoidStringCallback, NSArray, NSData, NSString;
@protocol MMKView;

@protocol MMIPlatformUtil <NSObject>
- (MMITransmitKvData *)getWebViewInfoData;
- (void)updateWalletRegion:(int)arg1;
...
- (NSString *)getCashierLiteAppInfo;
...
- (MISSING_TYPE *)base64Encode: /* Error: Ran out of types for this method. */;
