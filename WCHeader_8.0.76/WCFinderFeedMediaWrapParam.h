...
@class MISSING_TYPE, NSString, WCFinderMediaInfo;
...
@interface WCFinderFeedMediaWrapParam : NSObject
{
    ...
    _Bool _ignoreHDR;
    _Bool _useOfflinePath;
    int _scene;
    int _setMaxBitrate;
    NSString *_fileFormat;
    unsigned long long _liveCoverPreferredAspectRatio;
    MISSING_TYPE *_mediaInfo;
}

+ (id)defaultParamWithMediaInfo:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool useOfflinePath; // @synthesize useOfflinePath=_useOfflinePath;
