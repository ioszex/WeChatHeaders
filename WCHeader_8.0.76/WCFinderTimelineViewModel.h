...
@interface WCFinderTimelineViewModel : NSObject
{
    ...
    long long _likePrivacyGuideShowState;
...
@property(nonatomic) long long likePrivacyGuideShowState; // @synthesize likePrivacyGuideShowState=_likePrivacyGuideShowState;
...
@property(nonatomic) _Bool enableShowDramaTab; // @synthesize enableShowDramaTab=_enableShowDramaTab;
