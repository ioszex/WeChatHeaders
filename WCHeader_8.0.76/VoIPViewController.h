...
@class AVRoutePickerView, CADisplayLink, CContact, CMessageWrap, MMStringToastView, MMUIButton, MMVoIPToastAdapter, MinimizeNewTransitionController, MultiTalkHDHeadView, NSString, RingBackSoundCoordinator, RingDancingButton, RingToneDetail, SharePreConfirmSheetView, UIImageView, UILabel, UIView, VoIPHeadImageBlurView, VoIPMPUIv2DotsLoadingView, VoIPTalkingView, VoIPViewControllerIlinkServiceObserver, VoipMinimizeReportObject, WCUIAlertView;
...
@interface VoIPViewController
{
    ...
    _Bool _isToastViewAddingScrollingString;
    ...
    int _currentRemoteScreenProjectingMemberId;
    ...
    VoIPMPUIv2DotsLoadingView *_v2_dotsLoadingView;
    VoIPViewControllerIlinkServiceObserver *_ilinkServiceObserver;
    ...
    SharePreConfirmSheetView *_sheetView;
...
@property(retain, nonatomic) SharePreConfirmSheetView *sheetView; // @synthesize sheetView=_sheetView;
...
@property(nonatomic) _Bool isToastViewAddingScrollingString; // @synthesize isToastViewAddingScrollingString=_isToastViewAddingScrollingString;
...
@property(nonatomic) int currentRemoteScreenProjectingMemberId; // @synthesize currentRemoteScreenProjectingMemberId=_currentRemoteScreenProjectingMemberId;
...
- (void);
@property(retain, nonatomic) VoIPViewControllerIlinkServiceObserver *ilinkServiceObserver; // @synthesize ilinkServiceObserver=_ilinkServiceObserver;
@property(nonatomic) _Bool isAudioInterruption; // @synthesize isAudioInterruption=_isAudioInterruption;
@property(retain, nonatomic) VoIPMPUIv2DotsLoadingView *v2_dotsLoadingView; // @synthesize v2_dotsLoadingView=_v2_dotsLoadingView;
...
- (void)voipIlinkServiceObserverDidUpdateMemberMgr:(id)arg1;
- (void)voipIlinkServiceObserverDidBeginTalk;
- (void)voipIlinkServiceObserverDidHangupByCallEnd:(id)arg1;
- (void)voipIlinkServiceObserverDidChangeToMultiTalk:(id)arg1;
...
- (void)onSupportClickAddMembersBtn:(_Bool)arg1;
...
- (void)layoutToastViewWithBottom:(double)arg1;
- (void)cleanIfNeedWithTargetString:(id)arg1;
- (id)getContact;
...
- (void)refreshCrossPlatformRemoteViewingIfNeeded;
- (void)handleCrossPlatformRemoteViewingIfNeededWithMemberMgr:(id)arg1;
- (void)stopCrossPlatformRemoteViewingIfNeeded;
- (_Bool)canAutoEnterCrossPlatformRemoteViewing;
- (int)currentRemoteScreenProjectingMemberIdFromMemberMgr:(id)arg1;
