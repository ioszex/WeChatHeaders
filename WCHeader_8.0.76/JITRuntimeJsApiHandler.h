...
@interface JITRuntimeJsApiHandler : NSObject
{
    ...
    NSMutableDictionary *_innerApiPool;
    NSMutableDictionary *_asyncHandlerDict;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *asyncHandlerDict; // @synthesize asyncHandlerDict=_asyncHandlerDict;
@property(retain, nonatomic) NSMutableDictionary *innerApiPool; // @synthesize innerApiPool=_innerApiPool;
...
- (id)processJsApi:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3 useBase64:(_Bool)arg4 workerId:(unsigned int)arg5;
...
- (id)useBase64DictForWorker:(unsigned int)arg1;
- (id)callBackResultDictForWorker:(unsigned int)arg1;
- (id)init;
- (_Bool)processInnerJsApi:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3 workerId:(unsigned int)arg4;
- (void)initInnerApi;
- (unsigned int)processArrayBuffer:(id)arg1 fromEncode:(_Bool)arg2 commandBufferBuffers:(id)arg3;
- (id)processInvokeHandler:(id)arg1 eventId:(int)arg2 dicParam:(id)arg3 useBase64:(_Bool)arg4 workerId:(int)arg5;
- (id)processJsApiCommandBuffer:(const char *)arg1 useBase64:(_Bool)arg2 workerId:(unsigned int)arg3 commandBufferBuffers:(id)arg4;
