...
@class AVAsset, CMessageWrap, CdnProgressInfo, CdnUploadTaskInfo, MMCommonCgiUploader, NSString, NSURL, SingleFileDeduplicateResponse;
@protocol VideoUploadTaskDelegate;

@interface VideoUploadTask : NSObject
{
    _Bool _isHadFileIdCdnHitCheck;
    _Bool _isSlowMotion;
    _Bool _isUseCgi;
    _Bool _isRawTask;
    ...
    unsigned long long _uploadDataStartTimeMs;
    NSURL *_url;
    AVAsset *_asset;
    NSString *_videoPath;
    ...
    SingleFileDeduplicateResponse *_deduplicateResponse;
}

- (void).cxx_destruct;
@property(retain, nonatomic) SingleFileDeduplicateResponse *deduplicateResponse; // @synthesize deduplicateResponse=_deduplicateResponse;
...
@property(nonatomic) unsigned long long uploadDataStartTimeMs; // @synthesize uploadDataStartTimeMs=_uploadDataStartTimeMs;
@property(nonatomic) _Bool isHadFileIdCdnHitCheck; // @synthesize isHadFileIdCdnHitCheck=_isHadFileIdCdnHitCheck;
