...
- (void)HandlePayRespThread:(id)arg1;
- (void)HandleRespThread:(id)arg1;
- (int)payBuf2Resp:(unsigned int)arg1 In:(const struct AutoBuffer *)arg2 Err:(int *)arg3 Flags:(unsigned long long *)arg4 sequenceId:(unsigned short *)arg5;
