...
+ (_Bool)isShowingGuideOnView:(id)arg1;
...
- (void).cxx_destruct;
@property(nonatomic) long long lastShowTimeStamp; // @synthesize lastShowTimeStamp=_lastShowTimeStamp;
...
- (void)triggerReportByOutType:(unsigned long long)arg1;
...
- (id)createBottomNoMoreButton:(double)arg1;
- (id)createBottomWeakIKnowButton:(double)arg1;
