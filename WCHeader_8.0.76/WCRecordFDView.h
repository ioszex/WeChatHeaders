...
@property(nonatomic) double pillarMargin; // @synthesize pillarMargin=_pillarMargin;
...
- (void)dynamicSetPillarsColor:(id)arg1;
- (void)initPillars;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 PillarCount:(unsigned int)arg2 MaxHeight:(float)arg3 pillarColor:(id)arg4 pillarWidth:(double)arg5;
