...
@class AnchorSwitchSkinInfo, AudienceAiCustomGiftInfo, CustomGiftInfo, DesignerInfo, FinderJumpInfo, FinderLiveGiftBatchGiveConfigList, FinderLiveGift_ForegroundInfo, FinderLiveGift_SwitchSkinInfo, NSData, NSMutableArray, NSString;
...
@property(retain, nonatomic) AudienceAiCustomGiftInfo *audienceAiCustomGiftInfo; // @dynamic audienceAiCustomGiftInfo;
...
@property(retain, nonatomic) DesignerInfo *designerInfo; // @dynamic designerInfo;
