...
@class CgiTransferBeforeResp, CgiUnionTransferBeforeResp, GetTransferWordingResponse, KindaOpenIMInfoView, MMHeadImageView, MMTipsViewController, MMUIActivityIndicatorView, MMUILabel, NSDictionary, NSMutableString, NSNumber, NSString, RichTextView, UIButton, UILabel, UIView, WCPayBeforeTransferCgi, WCPayDecimalKeyboardView, WCPayGetTransferWordingCgi, WCPayMoneyTextFieldItem, WCPayNoticeBanner, WCPayRemarkPageSheet, WCPayRemarkPageSheetConfig, WCPayTextField, WCPayTransferMoneyAntiCheatUIView, WCPayUnionTransferBeforeCgi, WCUIAlertView;
...
@interface WCPayTransferMoneyViewController
{
    ...
    NSString *_pendingInitialRemark;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *pendingInitialRemark; // @synthesize pendingInitialRemark=_pendingInitialRemark;
...
- (void)setInitialRemark:(id)arg1;
- (void)setInitialTransferMoneyInFen:(unsigned long long)arg1;
