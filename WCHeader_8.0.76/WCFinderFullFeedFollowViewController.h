...
@class NSString, WCFinderFeedFollowVM, WCFinderFollowLiveOftenReadCoordinator;
...
@interface WCFinderFullFeedFollowViewController
{
    ...
    WCFinderFollowLiveOftenReadCoordinator *_liveBarCoordinator;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderFollowLiveOftenReadCoordinator *liveBarCoordinator; // @synthesize liveBarCoordinator=_liveBarCoordinator;
...
- (id)_liveBarCoordinatorForBubbleEvent;
- (void)liveBarCoordinatorResetTableViewLayout:(id)arg1;
- (void)liveBarCoordinator:(id)arg1 applyExpandedTableViewLayoutWithBottom:(double)arg2;
...
- (void)_updateLiveBarDisplay;
- (void)_ensureLiveBarCoordinator;
