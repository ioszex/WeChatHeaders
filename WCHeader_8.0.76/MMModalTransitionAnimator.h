...
@interface MMModalTransitionAnimator : UIPercentDrivenInteractiveTransition
{
    ...
    CDUnknownBlockType _transitionCancel;
    CDUnknownBlockType _shouldInterceptInteractiveFinish;
...
@property(copy, nonatomic) CDUnknownBlockType shouldInterceptInteractiveFinish; // @synthesize shouldInterceptInteractiveFinish=_shouldInterceptInteractiveFinish;
@property(copy, nonatomic) CDUnknownBlockType transitionCancel; // @synthesize transitionCancel=_transitionCancel;
