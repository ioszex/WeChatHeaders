...
@class CContact, MultiSelectContactsViewController, NSArray, NSDictionary, NSString, SessionSelectController;
...
- (void)OnSelectControllerForwardOtherAppPageSheetDidCloseWithoutSelection:(SessionSelectController *)arg1;
- (void)OnSelectControllerForwardOtherAppPageSheetDidShow:(SessionSelectController *)arg1;
- (void)OnSelectController:(SessionSelectController *)arg1 forwardOtherAppType:(long long)arg2 params:(NSDictionary *)arg3;
