...
@interface MMMinimizeLiveContainerView : UIView
{
    ...
    MMMinimizeLiveIndicatorView *_chatRoomIndicatorView;
...
@property(retain, nonatomic) MMMinimizeLiveIndicatorView *chatRoomIndicatorView; // @synthesize chatRoomIndicatorView=_chatRoomIndicatorView;
