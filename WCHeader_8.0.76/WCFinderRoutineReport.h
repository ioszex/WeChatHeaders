...
+ (void)reportStayTimeWithSence:(int)arg1 contentVM:(id)arg2 duration:(unsigned long long)arg3 isFullScreen:(_Bool)arg4 firstVideoDataSource:(unsigned long long)arg5 feedClientInfo:(id)arg6;
