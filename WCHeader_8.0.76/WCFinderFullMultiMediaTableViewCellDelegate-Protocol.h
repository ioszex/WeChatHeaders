...
@class FinderJumpInfo_Style, NSString, NSURL, UIButton, UIImage, UILongPressGestureRecognizer, UIView, WCFinderBulletCommentInfo, WCFinderComment, WCFinderCommonBottomBannerView, WCFinderDataItem, WCFinderFeedContentVM, WCFinderFeedLiveCellRouterModel, WCFinderFeedMediaWrap, WCFinderFeedStickerAdMeta, WCFinderFullMultiMediaTableViewCell, WCFinderJumpInfo, WCFinderLongPressRatePlayStateModel, WCFinderPlayerReport;

@protocol WCFinderFullMultiMediaTableViewCellDelegate <NSObject>

@optional
- (_Bool)multiMediaCell:(WCFinderFullMultiMediaTableViewCell *)arg1 tryShowLikePrivacyGuide:(unsigned long long)arg2;
...
- (void)onMoreBulletComment:(WCFinderBulletCommentInfo *)arg1 isInBlackList:(_Bool)arg2 isAuthorScene:(_Bool)arg3 contentVM:(WCFinderFeedContentVM *)arg4;
- (void)onFeedCellClickHotComment:(WCFinderComment *)arg1 contentVM:(WCFinderFeedContentVM *)arg2 enterType:(unsigned long long)arg3;
- (void)onBulletCommentOpenStateChanged:(NSString *)arg1;
- (void)onDeleteBulletComment:(WCFinderBulletCommentInfo *)arg1 contentVM:(WCFinderFeedContentVM *)arg2;
- (void)onReportBulletComment:(WCFinderBulletCommentInfo *)arg1 contentVM:(WCFinderFeedContentVM *)arg2;
- (void)onFeedCellTriggerBulletCommentWithReplyCommentInfo:(WCFinderBulletCommentInfo *)arg1;
- (void)onFeedCellClickSeeLater:(WCFinderFeedContentVM *)arg1;
...
- (void)onFeedClickJumpInfo:(WCFinderJumpInfo *)arg1 style:(FinderJumpInfo_Style *)arg2 clickTraceId:(NSString *)arg3;
...
- (void)onClickBottomAreaTipsButton:(WCFinderFeedContentVM *)arg1;
...
- (_Bool)multiMediaCellDisableSetRate:(WCFinderFullMultiMediaTableViewCell *)arg1 contentVM:(WCFinderFeedContentVM *)arg2;
- (_Bool)multiMediaCell:(WCFinderFullMultiMediaTableViewCell *)arg1 contentVM:(WCFinderFeedContentVM *)arg2 showStickerAdPreviewMeta:(WCFinderFeedStickerAdMeta *)arg3 showComplection:(void (^)(void))arg4 cancelBlock:(void (^)(void))arg5;
- (void)multiMediaCell:(WCFinderFullMultiMediaTableViewCell *)arg1 contentVM:(WCFinderFeedContentVM *)arg2 composeCommentWithImage:(UIImage *)arg3;
...
- (void)multiMediaCell:(WCFinderFullMultiMediaTableViewCell *)arg1 didChangePlayRateByLockingArea:(long long)arg2;
...
- (void)onLiveFeedDidTap:(WCFinderFeedContentVM *)arg1 routeModel:(WCFinderFeedLiveCellRouterModel *)arg2;
- (void)onVideoPIPStop:(WCFinderFeedContentVM *)arg1;
- (void)onVideoPIPStart:(WCFinderFeedContentVM *)arg1;
...
- (void)onClickListenVideoButton:(UIButton *)arg1 contentVM:(WCFinderFeedContentVM *)arg2;
...
- (_Bool)isMultiMediaCellFocused:(WCFinderFullMultiMediaTableViewCell *)arg1;
