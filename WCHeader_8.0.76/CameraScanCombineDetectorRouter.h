...
@interface CameraScanCombineDetectorRouter
{
    ...
    long long _goodsDetectShadowFilterTotalCount;
    long long _goodsDetectShadowSampleHitCount;
    long long _goodsDetectShadowItemFoundCount;
...
@property(nonatomic) long long goodsDetectShadowItemFoundCount; // @synthesize goodsDetectShadowItemFoundCount=_goodsDetectShadowItemFoundCount;
@property(nonatomic) long long goodsDetectShadowSampleHitCount; // @synthesize goodsDetectShadowSampleHitCount=_goodsDetectShadowSampleHitCount;
@property(nonatomic) long long goodsDetectShadowFilterTotalCount; // @synthesize goodsDetectShadowFilterTotalCount=_goodsDetectShadowFilterTotalCount;
...
- (void)submitImageProcessResultToDetectorQueue:(id)arg1;
...
- (void)reportOnShadowItemFound;
- (void)reportOnShadowSampleHit;
- (void)reportOnShadowFilterTotal;
