...
@class CAGradientLayer, ImageBrowseButton, MISSING_TYPE, NSString, OCRTransReport, UIImage, UIImageView, UIView, WCActionSheet;
...
- (void)reportDoTranslate:(_Bool)arg1;
...
- (void)startOCRScanningAnimationOnView:(id)arg1 selfView:(id)arg2;
- (void)prepareViewForTranslateOnView:(id)arg1 andBackView:(id)arg2;
...
- (_Bool)translateImage:(id)arg1 aboveView:(id)arg2 andBackView:(id)arg3;
