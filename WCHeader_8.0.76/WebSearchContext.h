...
@interface WebSearchContext : NSObject
{
    ...
    _Bool _enableParallelSearchGuideByReqType;
    ...
    NSString *_multiContentBizKey;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *multiContentBizKey; // @synthesize multiContentBizKey=_multiContentBizKey;
@property(copy, nonatomic) NSString *starBizKey; // @synthesize starBizKey=_starBizKey;
...
@property(nonatomic) _Bool enableParallelSearchGuideByReqType; // @synthesize enableParallelSearchGuideByReqType=_enableParallelSearchGuideByReqType;
...
- (void)setNewWebviewStyleEnabled:(_Bool)arg1;
...
@property(copy, nonatomic) NSString *displayQuery;
...
- (id)init;
- (id)initContextWithParallelRequest:(id)arg1;
- (long long)mmSearchGetParentTypeFromScene:(long long)arg1;
