...
@interface MMFinderLiveConnectMicUsersInfo : NSObject
{
    ...
    double _aspectRatio;
    unsigned long long _micBaseMode;
...
@property(nonatomic) unsigned long long micBaseMode; // @synthesize micBaseMode=_micBaseMode;
...
- (unsigned long long);
@property(readonly, nonatomic) _Bool isInConnectedMicFocusedUI;
