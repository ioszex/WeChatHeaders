...
@class MISSING_TYPE, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, WCFinderLiteAppInfo;
...
@interface WCFinderDynamicConfigModel : NSObject
{
    ...
    MISSING_TYPE *_dynamicFinderLiveNewEntranceSwitch;
    ...
    WCFinderLiteAppInfo *_postLinkMiniGameDramaLiteAppParams;
...
@property(retain, nonatomic) WCFinderLiteAppInfo *postLinkMiniGameDramaLiteAppParams; // @synthesize postLinkMiniGameDramaLiteAppParams=_postLinkMiniGameDramaLiteAppParams;
