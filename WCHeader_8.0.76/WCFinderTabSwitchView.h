...
@interface WCFinderTabSwitchView : UIView
{
    ...
    double _extraTopTouchInset;
    double _extraBottomTouchInset;
    double _itemPadding;
...
@property(nonatomic) _Bool hasMoveToNavBar; // @synthesize hasMoveToNavBar=_hasMoveToNavBar;
...
@property(nonatomic) _Bool positionInNavBar; // @synthesize positionInNavBar=_positionInNavBar;
...
@property(nonatomic) double extraBottomTouchInset; // @synthesize extraBottomTouchInset=_extraBottomTouchInset;
@property(nonatomic) double extraTopTouchInset; // @synthesize extraTopTouchInset=_extraTopTouchInset;
