...
@interface FTSMsgSearchResultWrap : NSObject
{
    ...
    NSMutableDictionary *_dicClusterSubResults;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *dicClusterSubResults; // @synthesize dicClusterSubResults=_dicClusterSubResults;
