...
- (unsigned int)startLQTDetailControlLogic:(id)arg1 fromScene:(unsigned long long)arg2 controlData:(id)arg3 traceInfo:(id)arg4 lqtbalance:(long long)arg5;
...
- (unsigned int)startGroupPayLogicFromOrder:(id)arg1 controlData:(id)arg2 currentContact:(id)arg3 launchDelegate:(id)arg4;
- (void)setOrderLaunchInnerLaunchDelegate:(id)arg1;
- (unsigned int)startGroupPayLogicFromJSAPI:(id)arg1 controlData:(id)arg2 amount:(long long)arg3 title:(id)arg4;
- (unsigned int)startGroupPayLogicFromWallet:(id)arg1 controlData:(id)arg2 launchDelegate:(id)arg3;
...
- (unsigned int)startOpenTouchIDAuthLogic:(id)arg1 Data:(id)arg2 Action:(unsigned long long)arg3 Source:(unsigned long long)arg4 Delegate:(id)arg5;
...
- (unsigned int)startTransferMoneyLogic:(id)arg1 WithA8KeyUrl:(id)arg2 Data:(id)arg3 scanCodeSessionInfo:(id)arg4;
...
- (void)reportAppPayEntryFunnel:(long long)arg1 result:(long long)arg2 usecase:(id)arg3 extra:(id)arg4 reqKey:(id)arg5;
- (void)reportAppPayEntryFunnel:(long long)arg1 result:(long long)arg2 usecase:(id)arg3 extra:(id)arg4;
