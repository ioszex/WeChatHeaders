...
@interface ChatbotCardFlutterApi : NSObject
{
...
- (void)onHeightChangedHeight:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (void)onReadyWithCompletion:(CDUnknownBlockType)arg1;
