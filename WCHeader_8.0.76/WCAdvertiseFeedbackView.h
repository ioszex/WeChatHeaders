...
@class MMUIImageView, MMUILabel, MMUIView, NSMutableArray, NSString, UIButton, WCAdFeedbackPersonalizedPanel, WCCanvasDynamicDataLoader, WCDataItem;
...
@interface WCAdvertiseFeedbackView
{
    ...
    _Bool _showPersonalizedInfo;
    _Bool _showPersonalizedPanel;
    _Bool _showReceivedReasonBtn;
    _Bool _showLikedAdBtn;
    ...
    unsigned long long _curToastType;
...
@property(nonatomic) _Bool showLikedAdBtn; // @synthesize showLikedAdBtn=_showLikedAdBtn;
@property(nonatomic) _Bool showReceivedReasonBtn; // @synthesize showReceivedReasonBtn=_showReceivedReasonBtn;
@property(nonatomic) _Bool showPersonalizedPanel; // @synthesize showPersonalizedPanel=_showPersonalizedPanel;
@property(nonatomic) _Bool showPersonalizedInfo; // @synthesize showPersonalizedInfo=_showPersonalizedInfo;
...
@property(nonatomic) unsigned long long curToastType; // @synthesize curToastType=_curToastType;
...
@property(retain, nonatomic) UIButton *receivedReasonBtn; // @synthesize receivedReasonBtn=_receivedReasonBtn;
@property(retain, nonatomic) UIButton *likedBtn; // @synthesize likedBtn=_likedBtn;
...
- (void)notifyFeedbackViewDisappear:(unsigned long long)arg1 toastTitle:(id)arg2;
...
- (void)layoutGuideAdManageViewWithOffsetY:(double)arg1;
...
- (void)checkAndSetConfirmButtonState:(_Bool)arg1;
...
- (void)hide;
- (void)show;
- (id)initWithData:(id)arg1 andClickPoint:(struct CGPoint)arg2 scene:(unsigned long long)arg3;
