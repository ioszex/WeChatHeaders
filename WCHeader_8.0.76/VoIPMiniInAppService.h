...
@class MinimizeTaskData, NSString, VoIPInComingReportManager, VoIPMiniInAppView;
...
@interface VoIPMiniInAppService
{
    ...
    VoIPInComingReportManager *_currentReportManager;
}

+ (id)minimizeTaskKey;
- (void).cxx_destruct;
@property(nonatomic) __weak VoIPInComingReportManager *currentReportManager; // @synthesize currentReportManager=_currentReportManager;
...
- (void)bindFloatWindowReportContextWithHiddenType:(long long)arg1 voipOperScene:(long long)arg2 reportManager:(id)arg3;
...
- (_Bool)tryReportFloatWindowClickIfBound;
- (void)reportFloatWindowClickViaCurrentReportManager;
