...
- (void)onConsultBarButtonClickedAtIndex:(unsigned long long)arg1;
- (void)onConsultBarTitleClickedAtIndex:(unsigned long long)arg1;
- (void)onGameGiftTagClicked;
- (void)injectHalfScreenListenerToExtInfo:(id)arg1;
