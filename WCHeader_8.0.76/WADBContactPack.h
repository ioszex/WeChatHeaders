...
@interface WADBContactPack : NSObject
{
    ...
    unsigned int _basicInfoVersion;
    NSString *_aliasName;
    NSString *_nickName;
...
+ (void)initialize;
+ (void)PBArrayAdd_basicInfoVersion;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int basicInfoVersion; // @synthesize basicInfoVersion=_basicInfoVersion;
