...
@class CBaseContact, ChatRoomPanelDynamicWeAppItem, MsgSendOpEntry, NSArray, NSDictionary, NSMutableArray, ServiceAppData, UIButton;

@protocol SelectAttachmentViewControllerDelegate <NSObject>
- (CBaseContact *)getContactForReport;
...
- (void)onXiaoWeiButtonClicked:(UIButton *)arg1;
