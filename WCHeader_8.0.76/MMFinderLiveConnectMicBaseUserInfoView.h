...
@class MMFinderLiveConnectMicUser, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveTaskId, MMUIButton, MMUIImageView, UILabel, WCFinderHeadImageView;
...
@interface MMFinderLiveConnectMicBaseUserInfoView : UIView
{
    ...
    _Bool _headImageViewUserInteractionEnabled;
...
@property(nonatomic) _Bool headImageViewUserInteractionEnabled; // @synthesize headImageViewUserInteractionEnabled=_headImageViewUserInteractionEnabled;
...
- (_Bool)isTouchPointInsideHeadImageView:(struct CGPoint)arg1;
