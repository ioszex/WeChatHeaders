...
@class MMTimer, MMUIActivityIndicatorView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TextStateCardListViewController, TextStateHistoryLogic, TextStateMessageBoxInfo, UICollectionView, UICollectionViewFlowLayout, UITapGestureRecognizer, UIView, _TtC6WeChat31TextStateFriendSquareTransition, _TtC6WeChat42TextStateSquareMixHeaderCollectionViewCell;
...
@property(retain, nonatomic) MMTimer *cacheCheckTimer; // @synthesize cacheCheckTimer=_cacheCheckTimer;
...
- (void)doPublishWithScene:(unsigned int)arg1 publish2ndScene:(int)arg2;
...
- (void)stopCacheStatusMonitoring;
- (void)checkCacheStatus;
- (void)startCacheStatusMonitoring;
- (void)hideLoadingIndicator;
- (void)showLoadingIndicator;
- (void)checkCacheStatusAndUpdateData;
- (void)updateData;
- (void)updateLayouts;
- (void)initGesture;
- (void)initView;
