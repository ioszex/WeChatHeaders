...
@class FinderAudienceReserveLiveNotification, FinderCollectionInfo, FinderEnhanceTypeList, FinderFlowCardRecommendReason, FinderMemberData, FinderModFeedInfo, FinderMusicRealtimeInfo, FinderNewLifeDesc, FinderObjectExtend, FinderObjectMemberInfo, FinderObjectOriginalInfo, FinderObjectPlaceHolderInfo, FinderObjectWordingInfo, FinderOriginalDesc, FinderPlayHistoryInfo, FinderPostTraceInfo, FinderPromotionJumpInfo, FinderSimpleTopicInfo, JumpListenInfo, MMListenAudioMixFeedItem, NSMutableArray, NSString, OriginalSoundInfo, VideoEncodeTask, WCFinderFeedBindEventInfo, WCFinderGeneralReportModel, WCFinderIpRegionInfo, WCFinderMemberShipQAItem, WCFinderObjectHighlightInfo, WCFinderPostCompressMetrics, WCFinderPreviewEditVideoCompositionTask;

@interface WCFinderDataItemInnerModel : NSObject
{
    _Bool _isBlocked;
    _Bool _hasShowPostFailTips;
    ...
    unsigned long long _triggerBeginPostTimeStamp;
    ...
    NSString *_tagSecKey;
    JumpListenInfo *_jumpListenInfo;
    unsigned long long _uploadStatus;
    MMListenAudioMixFeedItem *_audioMixFeedItem;
    ...
    WCFinderPostCompressMetrics *_postCompressMetrics;
}
...
+ (void)initialize;
+ (void)PBArrayAdd_audioMixFeedItem;
+ (void)PBArrayAdd_uploadStatus;
...
- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderPostCompressMetrics *postCompressMetrics; // @synthesize postCompressMetrics=_postCompressMetrics;
...
@property(retain, nonatomic) MMListenAudioMixFeedItem *audioMixFeedItem; // @synthesize audioMixFeedItem=_audioMixFeedItem;
@property(nonatomic) unsigned long long uploadStatus; // @synthesize uploadStatus=_uploadStatus;
@property(retain, nonatomic) JumpListenInfo *jumpListenInfo; // @synthesize jumpListenInfo=_jumpListenInfo;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: postFromScene
...
@property(nonatomic) _Bool hasShowPostFailTips; // @synthesize hasShowPostFailTips=_hasShowPostFailTips;
@property(nonatomic) unsigned long long triggerBeginPostTimeStamp; // @synthesize triggerBeginPostTimeStamp=_triggerBeginPostTimeStamp;
