...
@class CAGradientLayer, MJServerAIAssetOrderCoordinator, MJServerAIMusicStatusScheduler, MMBGMSelectHalfScreenViewController, MMUIButton, NSMutableArray, NSString, UIImageView, UIView, WCColorProxy, WCFinderVideoProducerAssetClipperViewController, WCFinderVideoProducerMusicBarViewController, WCFinderVideoProducerMusicInfoMarqueeView, WCFinderVideoProducerMusicSearcherViewController, WCFinderVideoProducerTemplateBarViewController, WCFinderVideoProducerTemplateFlowViewController, WCFinderVideoProducerTemplatePanelViewController, WCFinderVideoProducerViewModel;
@protocol WCFinderVideoProducerViewControllerDelegate;

@interface WCFinderVideoProducerViewController
{
    WCFinderVideoProducerViewModel *_privateVideoProducerVM;
    UIView *_proxyRootView;
    id <WCFinderVideoProducerViewControllerDelegate> _delegate;
    WCColorProxy *_colorProxy;
    WCFinderVideoProducerTemplateBarViewController *_templateBarVC;
    WCFinderVideoProducerMusicBarViewController *_musicBarVC;
    WCFinderVideoProducerAssetClipperViewController *_assetClipperVC;
    MMBGMSelectHalfScreenViewController *_bgmPanelVC;
    MMUIButton *_doneButton;
    MMUIButton *_cancelButton;
    MMUIButton *_recommendDebugButton;
    UIView *_topActionBarView;
    CAGradientLayer *_topActionBarGradientLayer;
    WCFinderVideoProducerMusicInfoMarqueeView *_musicInfoMarqueeView;
    WCFinderVideoProducerMusicSearcherViewController *_musicSearcherVC;
    UIView *_previewRenderView;
    UIImageView *_previewThumbView;
    NSMutableArray *_showingFragmentStack;
    WCFinderVideoProducerTemplateFlowViewController *_templateFlowVC;
    WCFinderVideoProducerTemplatePanelViewController *_templatePanelVC;
    MJServerAIAssetOrderCoordinator *_serverAIAssetOrderCoordinator;
    MJServerAIMusicStatusScheduler *_serverAIMusicStatusScheduler;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MJServerAIMusicStatusScheduler *serverAIMusicStatusScheduler; // @synthesize serverAIMusicStatusScheduler=_serverAIMusicStatusScheduler;
@property(retain, nonatomic) MJServerAIAssetOrderCoordinator *serverAIAssetOrderCoordinator; // @synthesize serverAIAssetOrderCoordinator=_serverAIAssetOrderCoordinator;
@property(retain, nonatomic) WCFinderVideoProducerTemplatePanelViewController *templatePanelVC; // @synthesize templatePanelVC=_templatePanelVC;
@property(retain, nonatomic) WCFinderVideoProducerTemplateFlowViewController *templateFlowVC; // @synthesize templateFlowVC=_templateFlowVC;
...
@property(retain, nonatomic) WCFinderVideoProducerMusicSearcherViewController *musicSearcherVC; // @synthesize musicSearcherVC=_musicSearcherVC;
@property(retain, nonatomic) WCFinderVideoProducerMusicInfoMarqueeView *musicInfoMarqueeView; // @synthesize musicInfoMarqueeView=_musicInfoMarqueeView;
...
@property(retain, nonatomic) MMUIButton *recommendDebugButton; // @synthesize recommendDebugButton=_recommendDebugButton;
...
@property(retain, nonatomic) WCFinderVideoProducerAssetClipperViewController *assetClipperVC; // @synthesize assetClipperVC=_assetClipperVC;
@property(retain, nonatomic) WCFinderVideoProducerMusicBarViewController *musicBarVC; // @synthesize musicBarVC=_musicBarVC;
@property(retain, nonatomic) WCFinderVideoProducerTemplateBarViewController *templateBarVC; // @synthesize templateBarVC=_templateBarVC;
@property(retain, nonatomic) WCColorProxy *colorProxy; // @synthesize colorProxy=_colorProxy;
@property(nonatomic) __weak id <WCFinderVideoProducerViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) WCFinderVideoProducerViewModel *videoProducerVM; // @synthesize videoProducerVM=_privateVideoProducerVM;
- (id);
- (void)_onClickCloseRecommendDebugView;
- (void)_onClickRecommendDebugButton;
- (void)checkPreviewRenderViewForNewAISession;
- (void)didCommitMusicForNewAISession:(id)arg1;
- (_Bool)serverAIDesiredOSTEnabledForNextMusicStatusUpdate;
- (_Bool)serverAIDesiredBGMEnabledForNextMusicStatusUpdate;
- (void)handleStatusChangedForMusicFromNewAISession:(_Bool)arg1 isOSTEnabled:(_Bool)arg2 isLyricsEnabled:(_Bool)arg3;
- (void)handleSelectedMusicInfoForNewAISession:(id)arg1 atIndex:(long long)arg2 showsLoading:(_Bool)arg3;
- (void)updateMusicBarVCForNewAISession;
- (void)handleWillSelectMusicInfoForNewAISession:(id)arg1 atIndex:(long long)arg2 tabIndex:(unsigned long long)arg3;
- (void)handleSelectedSearchMusicInfoForNewAISession:(id)arg1 atIndex:(long long)arg2;
- (id)createBGMPanelTabModelsForNewAISession;
- (void)_startPlayForNewAISessionCurrentRoute;
- (void)_buildMusicListsForNewAISession:(id)arg1 searchMusicList:(id *)arg2;
- (void)_onClickCancelButton;
- (void)exportTemplateVideo;
- (void)_onClickDoneButton;
- (id)_reportServerAIComposingCompletionIfNeededWithExpectedClientRenderRet:(unsigned long long)arg1;
...
- (id)_serverAIComposingMusicInfoWithMusicData:(id)arg1 baseMusicInfo:(id)arg2;
...
- (void)assetClipperVC:(id)arg1 didPlayComposingSegmentWithTimeRange:(CDStruct_e83c9415)arg2;
...
- (id)composingSegmentIDListFromClipSegments:(id)arg1;
- (_Bool)shouldUseNewAIAssetReorderRouteForCurrentRoute;
- (void)_updateAssetClipperVCDataSource;
- (void)dismissAssetClipperVC;
- (void)showAssetClipperVCForNewAIComposing;
