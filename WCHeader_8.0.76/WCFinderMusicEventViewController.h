...
@interface WCFinderMusicEventViewController
{
    ...
    NSString *_jumperClickSessionId;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *jumperClickSessionId; // @synthesize jumperClickSessionId=_jumperClickSessionId;
...
- (void)resetJumperClickSessionId;
- (void)updateJumperClickSessionId;
- (void)onMusicEventHeaderClickListenWholeByMusicInfo:(id)arg1 jumpInfo:(id)arg2;
...
- (id)getListenWholeSongReportDic;
- (id)getListenWholeSongReportViewID;
