...
@class MiniTaskTransitionContext, NSArray, NSDictionary, NSString, UINavigationController, UIView, UIViewController, WAAppOpenCustomLoadingParameter, WAAppOpenCustomUIParameter, WAAppOpenDebugModeParameter, WAAppOpenExtJSParameter, WAAppOpenSheetModeParameter, WAContact, WAProvideApiConfig, WARunningModeParameter;

@interface WAAppOpenParameter
{
    _Bool _m_bUpdateAndForceReloadTask;
    _Bool _m_bIsSilentOpen;
    _Bool _m_uSilentOpenShouldShowModalOrError;
    _Bool _m_bDisableDetectWhiteScreen;
    ...
    _Bool _m_bIsDirectGame;
    _Bool _disableRelayoutOnRotate;
    _Bool _disableReOpenOnContainerSizeChange;
    _Bool _m_bEnableWebViewBottomBar;
    _Bool _m_bIsHideNavLeftButton;
    _Bool _m_bForceSyncUpdateContact;
    ...
    UIViewController *_m_presentingViewController;
    ...
    unsigned long long _m_taskMinimizedMode;
    ...
    WARunningModeParameter *_m_runningModeParams;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_bForceSyncUpdateContact; // @synthesize m_bForceSyncUpdateContact=_m_bForceSyncUpdateContact;
...
@property(nonatomic) _Bool m_bIsHideNavLeftButton; // @synthesize m_bIsHideNavLeftButton=_m_bIsHideNavLeftButton;
@property(nonatomic) _Bool m_bEnableWebViewBottomBar; // @synthesize m_bEnableWebViewBottomBar=_m_bEnableWebViewBottomBar;
@property(nonatomic) _Bool disableReOpenOnContainerSizeChange; // @synthesize disableReOpenOnContainerSizeChange=_disableReOpenOnContainerSizeChange;
@property(nonatomic) _Bool disableRelayoutOnRotate; // @synthesize disableRelayoutOnRotate=_disableRelayoutOnRotate;
...
@property(nonatomic) _Bool m_bIsDirectGame; // @synthesize m_bIsDirectGame=_m_bIsDirectGame;
...
@property(copy, nonatomic) NSDictionary *m_miniToolParam; // @synthesize m_miniToolParam=_m_miniToolParam;
...
@property(retain, nonatomic) WARunningModeParameter *m_runningModeParams; // @synthesize m_runningModeParams=_m_runningModeParams;
@property(nonatomic) _Bool m_bDisableDetectWhiteScreen; // @synthesize m_bDisableDetectWhiteScreen=_m_bDisableDetectWhiteScreen;
@property(nonatomic) _Bool m_uSilentOpenShouldShowModalOrError; // @synthesize m_uSilentOpenShouldShowModalOrError=_m_uSilentOpenShouldShowModalOrError;
...
@property(nonatomic) unsigned long long m_taskMinimizedMode; // @synthesize m_taskMinimizedMode=_m_taskMinimizedMode;
...
@property(nonatomic) __weak UIViewController *m_presentingViewController; // @synthesize m_presentingViewController=_m_presentingViewController;
