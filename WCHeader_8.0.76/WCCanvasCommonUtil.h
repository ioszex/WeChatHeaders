...
+ (void)loadCanvasFromFavWithCanvasId:(id)arg1 uxInfo:(id)arg2 canvasDynamicInfo:(id)arg3 canvasDynamicExtInfo:(id)arg4 canvasDynamicLoadExtInfo:(id)arg5 originAdInfo:(id)arg6 showNavigationBar:(_Bool)arg7 originView:(id)arg8 originCanvasPageXml:(id)arg9 originThumbUrl:(id)arg10;
+ (_Bool)tryToOpenAdCanvasFromFavWithShareInfoInAdInfo:(id)arg1 showNavigationBar:(_Bool)arg2 originView:(id)arg3 originCanvasPageXml:(id)arg4 originThumbUrl:(id)arg5;
+ (_Bool)tryToOpenAdCanvasFromCombineFavExtraParams:(id)arg1;
