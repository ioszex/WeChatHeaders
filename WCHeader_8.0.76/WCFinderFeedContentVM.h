...
@interface WCFinderFeedContentVM : NSObject
{
    ...
    _Bool _fullShareListShowWatchFinderGuideYet;
    ...
    double _currentDisplayImageOffsetX;
...
@property(nonatomic) _Bool fullShareListShowWatchFinderGuideYet; // @synthesize fullShareListShowWatchFinderGuideYet=_fullShareListShowWatchFinderGuideYet;
...
@property(nonatomic) double currentDisplayImageOffsetX; // @synthesize currentDisplayImageOffsetX=_currentDisplayImageOffsetX;
...
- (id)displayDescriptionContent:(_Bool)arg1;
...
- (id)listenVideoAudioItemBuffer;
- (void)generateEnterAudioSid;
