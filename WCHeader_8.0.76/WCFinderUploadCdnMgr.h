...
@interface WCFinderUploadCdnMgr : NSObject
{
    ...
    NSMutableSet *_preparingLegacyOriginInfoTids;
...
+ (void)moveFileToDataItemPath:(id)arg1 fromPendingDataItem:(id)arg2;
+ (void)updateMentionedHistoryArray:(id)arg1;
+ (_Bool)shouldMoveFileAfterConfirmForTask:(id)arg1;
- (void).cxx_destruct;
...
@property(retain, nonatomic) NSMutableSet *preparingLegacyOriginInfoTids; // @synthesize preparingLegacyOriginInfoTids=_preparingLegacyOriginInfoTids;
...
- (void)OnCdnInit;
- (void)moveFileToDataItemPath:(id)arg1 fromDraft:(_Bool)arg2;
- (void)finderUploadCDNSuccess:(id)arg1;
- (void)finderPreuploadCDNSuccess:(id)arg1;
- (void)handleDirectUploadPreuploadSuccessWithUploadInfo:(id)arg1;
- (void)handleCDNUploadSuccessWithUploadInfo:(id)arg1;
- (void)addPostTaskToUploadQueue:(id)arg1;
- (void)bindTraceInfoToDataItem:(id)arg1 traceInfo:(id)arg2;
- (void)executePostCGIWithSuccessBlock:(CDUnknownBlockType)arg1 failBlock:(CDUnknownBlockType)arg2;
- (void)executeTemplateCreationCGIIfNeededWithCompletionBlock:(CDUnknownBlockType)arg1 failBlock:(CDUnknownBlockType)arg2;
- (void)finderPost;
...
- (void)writeQueuesToLocalWithDeepCopy:(_Bool)arg1;
- (void)syncQueueToLocalImmediately;
...
- (void)removeUncommittedPreUploadTask:(id)arg1;
- (void)cancelCurrentTaskWithTid:(id)arg1;
- (void)releaseBackgroundTaskForUploadTask:(id)arg1;
- (void)holdBackgroundTaskForUploadTask:(id)arg1;
- (_Bool)uploadTask:(id)arg1 hasSamePlanWithPostSession:(id)arg2;
- (_Bool)hasPostRequestedTaskWithTid:(id)arg1;
- (void)removeTasksWithTid:(id)arg1 fromQueue:(id)arg2;
- (id)tasksWithTid:(id)arg1 inQueue:(id)arg2;
...
- (void)markPostRequestedForTask:(id)arg1;
- (void)preparePostPhaseForPreUploadTask:(id)arg1 restartCDNUpload:(_Bool)arg2;
- (void)repairLegacyPreUploadTask:(id)arg1;
- (long long)recoveryPriorityForTask:(id)arg1;
