...
@class CADisplayLink, CAGradientLayer, DynamicBackgroundSystemConfig, MFTitleView, MMUIViewController, MainFrameLeftBarView, NSMutableArray, NSString, NewMainFrameRightTopMenuBtn, UIBarButtonItem, UIButton, UICollectionView, UIImageView, UILabel, UISearchBar, WAAppContainerSearchBar, WADynamicBackgroundGLViewController, WAMainFrameAudioCenterBaseView, WAMainFrameChatBotVoIPView, WAMainFrameDesktopContainerView, WAMainFrameTaskBarCloseArea, WAMainFrameTaskBarDotLoadingView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarSearchCustomView, WAMainFrameTaskBarSectionOtherView, WAMainFrameTaskBarSectionSearchView, WAMainFrameTaskBarSectionWeAppContainerView, WATaskBarCollectionViewLayout;
...
@interface WAMainFrameTaskBarView : UIView
{
    ...
    WAMainFrameTaskBarSectionOtherView *_sectionOtherView;
    WAMainFrameTaskBarSectionSearchView *_sectionSearchView;
    ...
    WAMainFrameChatBotVoIPView *_chatBotVoIPView;
...
- (void).cxx_destruct;
@property(retain, nonatomic) WAMainFrameChatBotVoIPView *chatBotVoIPView; // @synthesize chatBotVoIPView=_chatBotVoIPView;
...
@property(nonatomic) __weak WAMainFrameTaskBarSectionSearchView *sectionSearchView; // @synthesize sectionSearchView=_sectionSearchView;
@property(retain, nonatomic) WAMainFrameTaskBarSectionOtherView *sectionOtherView; // @synthesize sectionOtherView=_sectionOtherView;
...
- (void)applySearchPlaceHolder:(id)arg1;
...
- (void)onClickSearchWithSearchBar:(id)arg1;
...
- (void)ensureSearchButtonCreated;
