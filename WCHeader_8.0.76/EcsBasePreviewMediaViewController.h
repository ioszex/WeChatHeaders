...
@interface EcsBasePreviewMediaViewController
{
    ...
    _Bool _hideVideoCloseBtn;
    _Bool _mbShowBottomTool;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool mbShowBottomTool; // @synthesize mbShowBottomTool=_mbShowBottomTool;
@property(nonatomic) _Bool hideVideoCloseBtn; // @synthesize hideVideoCloseBtn=_hideVideoCloseBtn;
...
- (void)preloadImageAtIndex:(long long)arg1;
- (void)preloadAdjacentImagesForIndex:(long long)arg1;
- (void)updatePhotoatIndex:(unsigned int)arg1;
- (void)removeLoadingIndicatorFromView:(id)arg1;
- (void)addLoadingIndicatorToView:(id)arg1 frame:(struct CGRect)arg2;
