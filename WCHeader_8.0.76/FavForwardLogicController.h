...
@interface FavForwardLogicController
{
    ...
    NSMutableDictionary *_reportParamMap;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *reportParamMap; // @synthesize reportParamMap=_reportParamMap;
...
@property(nonatomic) int fileSource; // @synthesize fileSource=_fileSource;
...
- (void)forwardFavDataItemWraps:(id)arg1 ToUser:(id)arg2 delegate:(id)arg3 showConfirmView:(_Bool)arg4 reportParamMap:(id)arg5;
- (id)checkBaseMsgForwardFavDataItemWraps:(id)arg1;
- (void)forwardFavDataItemWraps:(id)arg1 ToUser:(id)arg2 delegate:(id)arg3 reportParamMap:(id)arg4;
...
- (void)ForwardFavItemList:(id)arg1 toUser:(id)arg2 delegate:(id)arg3 reportParamMap:(id)arg4;
