...
@class ActiveSessionContext, NSData, NSDictionary, NSString, TingEntranceReddotInfo, TingItem, TingLaunchOptionsNextPage, TingLaunchOptionsOpenPlayerTab, TingListSourceContext, UIViewController;
...
@interface TingLaunchOptions : NSObject
{
    ...
    NSDictionary *_flutterRouterExtraParams;
}
...
@property(retain, nonatomic) NSDictionary *flutterRouterExtraParams; // @synthesize flutterRouterExtraParams=_flutterRouterExtraParams;
