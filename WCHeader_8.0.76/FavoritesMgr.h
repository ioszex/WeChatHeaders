...
@interface FavoritesMgr
{
    ...
    FavoritesReuploadMgr *_favReuploadMgr;
    ...
    _Bool _enableFlutterFavList;
    _Bool _useNewNoteShareImage;
    _Bool _useNewNoteSourceTitle;
    _Bool _useNewNoteShareImageFlutter;
...
@property(nonatomic) _Bool useNewNoteShareImageFlutter; // @synthesize useNewNoteShareImageFlutter=_useNewNoteShareImageFlutter;
@property(nonatomic) _Bool useNewNoteSourceTitle; // @synthesize useNewNoteSourceTitle=_useNewNoteSourceTitle;
@property(nonatomic) _Bool useNewNoteShareImage; // @synthesize useNewNoteShareImage=_useNewNoteShareImage;
@property(nonatomic) _Bool enableFlutterFavList; // @synthesize enableFlutterFavList=_enableFlutterFavList;
...
- (void)resetCdnInfoAndReuploadFavItem:(id)arg1;
- (id)getFavReuploadMgr;
...
- (id)getFavoritesItemByFavIdArr:(id)arg1;
- (id)getFavoritesItemByLocalIdArr:(id)arg1;
- (id)getFavoritesItemByLocalId:(unsigned int)arg1;
- (id)getAllFavoritesItemsByType:(int)arg1;
- (id)getFavoritesItemByStarBizKey:(id)arg1;
...
- (void)asyncSearch:(id)arg1 byType:(long long)arg2 tags:(id)arg3 starredOnly:(_Bool)arg4 recentUsedLocalIds:(id)arg5 taskKey:(id)arg6;
...
- (void)dumpAllFavoritesItemsForStarTypeDebug;
- (_Bool)hasAnyStarredFavorites;
- (id)getAllStarredLocalIdToStarTypeMap;
...
- (id)getAllNoteFavIdsByTabMode:(long long)arg1;
...
- (_Bool)shouldOpenFavAiSearchDebugWindow;
- (_Bool)shouldOpenFavAiSearch;
- (_Bool)shouldUseFlutterFavList;
...
- (_Bool)enableMarkdownNotePublish;
- (_Bool)enableMarkdownNote;
