...
+ (_Bool)isImageFormatSupported:(id)arg1;
+ (_Bool)isColorSpaceSupported:(id)arg1;
...
+ (id)defaultBlurImage;
+ (id)VoIPMPUIv2_voipSelectHangupAndAcceptButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_voipHangupButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_voipAcceptButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_disabledAndSelectedVoipDescriptButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_disabledVoipDescriptButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_selectedVoipDescriptButtonBackImageWithLength:(double)arg1;
+ (id)VoIPMPUIv2_normalVoipDescriptButtonBackImageWithLength:(double)arg1;
...
+ (unsigned long long)GetUIImageColorSpace:(id)arg1;
+ (unsigned long long)GetCGImageColorSpace:(struct CGImage *)arg1;
+ (id)GetSdrImageFromCGImage:(struct CGImage *)arg1 scale:(double)arg2 orientation:(long long)arg3;
+ (id)GetSdrImageFromCGImage:(struct CGImage *)arg1;
+ (id)GetSdrImageFromUIImage:(id)arg1;
...
+ (id)getRGBAWithImage:(id)arg1 needWhiteBg:(_Bool)arg2;
...
- (id)getRawGrayDataWithFilter:(struct CGSize *)arg1 hasPadding:(_Bool *)arg2;
- (id)getRawGrayDataWithSdr:(struct CGSize *)arg1;
- (id)safeGetRawGrayData:(struct CGSize *)arg1;
@property(copy, nonatomic) NSString *chatbotImageFileType;
@property(copy, nonatomic) NSString *chatbotImageFileAesKey;
@property(copy, nonatomic) NSString *chatbotImageFileId;
@property(copy, nonatomic) NSString *chatbotImagePath;
- (id)hq_imageByResizingToSize:(struct CGSize)arg1 withAlpha:(double)arg2;
...
- (id)normalize;
@property(copy, nonatomic) NSString *weFileTempPath;
@property(copy, nonatomic) NSString *waAgentImagePath;
...
- (id)printImageInfo;
- (id)formattedMemorySize;
- (unsigned long long)estimatedMemorySize;
...
- (id)cropImageTo3by4;
- (id)cropImageTo3by4FromTopWithY:(double)arg1;
- (unsigned long long)getColorSpace;
- (id)getSdrImageIfNeeded;
- (id)getSdrImage;
...
- (id)resizeScaleAspectFitInRect:(struct CGRect)arg1;
- (id)resizeScaleAspectFillInRect:(struct CGRect)arg1;
...
- (id)resizeToMaxWidth:(int)arg1 andMaxHeight:(int)arg2 keepImgScale:(_Bool)arg3;
