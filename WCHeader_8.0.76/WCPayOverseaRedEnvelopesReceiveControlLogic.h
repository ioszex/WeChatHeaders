...
@interface WCPayOverseaRedEnvelopesReceiveControlLogic
{
    int m_scene;
    _Bool _fromSysMsg;
    _Bool _isOverseaTransfer;
    NSString *_h5UrlString;
    NSString *_msgRouteInfo;
...
@property(nonatomic) _Bool isOverseaTransfer; // @synthesize isOverseaTransfer=_isOverseaTransfer;
@property(nonatomic) _Bool fromSysMsg; // @synthesize fromSysMsg=_fromSysMsg;
@property(retain, nonatomic) NSString *msgRouteInfo; // @synthesize msgRouteInfo=_msgRouteInfo;
...
- (void)handleBubbleRouteInfo:(id)arg1 h5String:(id)arg2;
- (void)handleOverseaTransferBubbleClick;
- (void)startLogic;
- (void)stopLoading;
