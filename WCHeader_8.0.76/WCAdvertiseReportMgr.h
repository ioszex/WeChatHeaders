...
+ (void)commonReportAdChannel:(id)arg1 snsId:(id)arg2 scene:(int)arg3 actType:(int)arg4 actValue:(long long)arg5 actCount:(int)arg6 traceTag:(id)arg7;
+ (void)commonReportAdChannel:(id)arg1 snsId:(id)arg2 scene:(int)arg3 actType:(int)arg4 actValue:(long long)arg5;
...
+ (int)fetchAdCanvasTypeWithExtInfo:(id)arg1;
+ (int)fetchAdCanvasTypeWithCanvasPageXml:(id)arg1;
+ (void)reportCanvasShareClickWithCombineShareInfo:(id)arg1 shareScene:(int)arg2;
+ (void)reportCanvasShareClickWithAdInfo:(id)arg1 shareScene:(int)arg2;
+ (void)reportAdPageExposureLogWithScene:(unsigned int)arg1 andStatisticsExtInfo:(id)arg2 andAppMediaUrl:(id)arg3 msgContent:(id)arg4 canvasPageXml:(id)arg5;
...
+ (void)reportConversionOnlineForLaunchApp:(int)arg1 advertiseInfo:(id)arg2 canvasId:(id)arg3 canvasScene:(int)arg4 useHalfScreen:(_Bool)arg5 deeplinkType:(int)arg6;
...
+ (void)reportSessionRecordsMonitor:(id)arg1 sessionRecords:(id)arg2;
...
+ (id)buildContractAdReportCommonInfoWithDataItem:(id)arg1 reportType:(id)arg2;
+ (id)buildRandomSelectCardReportContentWith:(id)arg1 scene:(int)arg2;
+ (void)reportRandomSelectCardInfo:(id)arg1 dataItem:(id)arg2 scene:(int)arg3;
+ (void)reportFlipCardInfo:(id)arg1 snsId:(id)arg2 scene:(int)arg3 reportInfo:(id)arg4;
...
+ (void)reportAdCommentMonitor:(id)arg1 extInfo:(id)arg2;
+ (void)reportWorldCupAvatarMonitor:(id)arg1 extInfo:(id)arg2;
