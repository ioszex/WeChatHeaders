...
@class GetA8KeyResp, GetA8KeyRespVerifyPrefetchInfo, NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, WebViewA8KeyLogicImpl;
...
@optional
- (NSString *)a8keyProfileUserNameForLogicImpl:(WebViewA8KeyLogicImpl *)arg1;
...
- (void)onRejectOverlyLongUrl:(NSString *)arg1;
- (_Bool)shouldRejectOverlyLongUrl:(NSString *)arg1 reason:(int)arg2;
