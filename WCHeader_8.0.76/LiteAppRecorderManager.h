...
- (void).cxx_destruct;
@property(nonatomic) _Bool frameRecordedEnabled; // @synthesize frameRecordedEnabled=_frameRecordedEnabled;
...
- (id)startRecord:(id)arg1 sampleRate:(unsigned long long)arg2 encodeBitRate:(unsigned long long)arg3 channels:(unsigned long long)arg4 duration:(unsigned long long)arg5 frameByteSize:(unsigned long long)arg6 audioSource:(id)arg7 audioThreshold:(unsigned long long)arg8 frameRecordedEnabled:(_Bool)arg9;
