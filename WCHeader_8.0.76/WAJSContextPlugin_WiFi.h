...
@class NEHotspotConfigurationManager, NEHotspotHelperCommand, NSMutableArray, NSMutableDictionary, NSObject, NSString;
...
- (void).cxx_destruct;
- (void)handleHotspotCommand:(id)arg1;
...
- (void)connectToWifiWithSSID:(id)arg1 password:(id)arg2 isWEP:(_Bool)arg3 lifeTimeInDays:(id)arg4;
