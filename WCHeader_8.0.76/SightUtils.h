...
+ (void)asyncGenerateSnapShotImageWithAsset:(id)arg1 params:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (id)generateVideoThumbImageWithAsset:(id)arg1 params:(id)arg2;
+ (id)generateVideoThumbImageWithPath:(id)arg1 params:(id)arg2;
+ (id)generateVideoThumbImageWithAsset:(id)arg1;
...
+ (id)thumbForVideoWithPath:(id)arg1 atTimeStart:(double)arg2 untilTimeEnd:(double)arg3 autoAdjustHDRColor:(_Bool)arg4;
+ (id)thumbForVideoWithAsset:(id)arg1 atTime:(double)arg2;
+ (_Bool)detectImagePureColor:(id)arg1;
+ (_Bool)detectImageBlack:(id)arg1;
+ (id)generateImageFromVideoURL:(id)arg1 withStartTime:(double)arg2 endTime:(double)arg3 actualOffsetRef:(double *)arg4 enableUndersampling:(_Bool)arg5 enableBlackAvoiding:(_Bool)arg6 autoAdjustHDRColor:(_Bool)arg7;
+ (id)thumbForVideoWithAsset:(id)arg1;
+ (id)newThumbForVideoWithPath:(id)arg1 needResize:(_Bool)arg2;
+ (id)newThumbForVideoWithPath:(id)arg1;
+ (id)thumbForVideoWithPath:(id)arg1;
+ (id)unBlackFrameCoverForVideoWithPath:(id)arg1 atTimeStart:(double)arg2 untilTimeEnd:(double)arg3 autoAdjustHDRColor:(_Bool)arg4;
...
+ (id)imageFromImageBuffer:(struct __CVBuffer *)arg1 orientation:(long long)arg2;
