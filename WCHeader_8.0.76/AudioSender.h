...
@class BaseAudioRecorder, BaseUploadVoiceMgr, MMNewUploadVoiceMgr, MMNewVoiceInputCacheLogic, NSHashTable, NSString, UploadVoiceCDNMgr;
...
@interface AudioSender
{
    ...
    BaseAudioRecorder *m_currentRecorder;
    NSHashTable *m_interruptionDelegates;
    _Bool useNewInterruptBehaviour;
    _Bool continueRecordingOverTime;
    MMNewVoiceInputCacheLogic *_transcacheLogic;
    UploadVoiceCDNMgr *_bypUploader;
}

+ (_Bool)supportOpusAudioPlayer;
+ (_Bool)IsVoiceUseCdnUpload;
- (void).cxx_destruct;
@property(retain, nonatomic) UploadVoiceCDNMgr *bypUploader; // @synthesize bypUploader=_bypUploader;
...
- (void)notifyInterruptionDelegates:(id)arg1 param:(id)arg2;
...
- (unsigned int)opusAudioDuration;
...
- (id)createRecorderForFormat:(unsigned int)arg1;
- (id)createRecorderForToUser:(id)arg1;
- (_Bool)isTranslatableRecorder:(id)arg1;
- (_Bool)isSupportVoiceTranslate:(id)arg1;
- (_Bool)isNeedRecordByOpusByUsername:(id)arg1;
- (_Bool)opusVoiceMessageOpen;
- (_Bool)isNeedRecordBySilkByUsername:(id)arg1;
- (_Bool)isNeedSpeexAudioByUsrName:(id)arg1;
- (void)dealloc;
- (void)onServiceInit;
- (id)uploaderForMsgWrap:(id)arg1;
