...
{
    unsigned int _isGreetSession;
    unsigned int _firstHitGreetTime;
    int _bizType;
    NSString *fansOpenID;
...
+ (id)swift_firstHitGreetTime;
+ (const void *)__wcdb_synthesize_15:(void *)arg1;
+ (const void *)firstHitGreetTime;
+ (id)swift_isGreetSession;
+ (const void *)__wcdb_synthesize_14:(void *)arg1;
+ (const void *)isGreetSession;
...
@property(nonatomic) unsigned int firstHitGreetTime; // @synthesize firstHitGreetTime=_firstHitGreetTime;
@property(nonatomic) unsigned int isGreetSession; // @synthesize isGreetSession=_isGreetSession;
