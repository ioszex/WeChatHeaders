...
- (long long)FindtheIndexToFillFullLine:(id)arg1 startIndex:(long long)arg2 endIndex:(long long)arg3 width:(double)arg4 prefixContent:(id)arg5 withFont:(id)arg6;
