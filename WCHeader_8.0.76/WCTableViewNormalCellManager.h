...
@interface WCTableViewNormalCellManager
{
    ...
    CDUnknownBlockType _dr_callbackBlock;
    CDUnknownBlockType _doWithUIViewAction;
}
...
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType doWithUIViewAction; // @synthesize doWithUIViewAction=_doWithUIViewAction;
@property(copy, nonatomic) CDUnknownBlockType dr_callbackBlock; // @synthesize dr_callbackBlock=_dr_callbackBlock;
...
- (void)doWithUIView:(CDUnknownBlockType)arg1;
...
- (void)dr_setViewExpEventCallback:(CDUnknownBlockType)arg1;
