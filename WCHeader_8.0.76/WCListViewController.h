...
@property(retain, nonatomic) UIBarButtonItem *messageBarButtonItem; // @synthesize messageBarButtonItem=_messageBarButtonItem;
@property(retain, nonatomic) UIBarButtonItem *albumV2BarButtonItem; // @synthesize albumV2BarButtonItem=_albumV2BarButtonItem;
...
@property(retain, nonatomic) NSString *snsChannel; // @synthesize snsChannel=_snsChannel;
...
- (id)buildSnsUserCommonParams;
- (void)reportSnsUserPageOut;
- (void)reportSnsUserPageIn;
- (void)reportOnEnd;
- (void)reportOnBeign;
...
- (void)onDissmiss;
- (void)onAlbumV2:(id)arg1;
- (void)onSearch:(id)arg1;
- (void)onMessageIconV2:(id)arg1;
...
- (void)momentsConfigurationDidUpdate:(id)arg1;
- (void)updateSearchBarButtonItem;
- (void)initBarItem;
- (void)commitRightBarButtonItems:(id)arg1;
