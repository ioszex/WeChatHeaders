...
@class FinderBizInfo_BizInfo, FinderJustWatchControl, MISSING_TYPE, NSData, NSDictionary, NSMutableArray, NSMutableSet, NSString, WCFinderCGIProfile, WCFinderCoverLoadCostTime;
...
@interface WCFinderBrandStreamProfileViewModel : NSObject
{
    ...
    MISSING_TYPE *_pendingFetchJustWatchFeedBlocks;
...
@property(retain, nonatomic) NSString *showPostTimeFeedTid; // @synthesize showPostTimeFeedTid=_showPostTimeFeedTid;
...
- (id)createFinderBrandProfileViewModel:(id)arg1;
