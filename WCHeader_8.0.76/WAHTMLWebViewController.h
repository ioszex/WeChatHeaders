...
@class MMWebBottomToolBar, MMWebProgressBar, NSArray, NSCache, NSString, UIColor, UIImageView, UILabel, WAWebViewController, WAWebViewPlugin_HTMLWeb, WebTransWebpageLogic;
...
@property(retain, nonatomic) NSArray *bizDomainList; // @synthesize bizDomainList;
@property(nonatomic) unsigned int webviewId; // @synthesize webviewId;
@property(retain, nonatomic) UILabel *m_addressLabel; // @synthesize m_addressLabel;
- (_Bool)skipAskUsrToMakeAuth;
- (_Bool)checkURLInDomainList:(id)arg1;
...
- (void)onBottomBarGoForward;
- (void)onBottomBarGoBack;
- (void)updateBottomBarState;
- (void)layoutBottomBarAndWebView;
- (void)cacheBottomBarEnabled;
...
- (void)onRejectOverlyLongUrl:(id)arg1;
