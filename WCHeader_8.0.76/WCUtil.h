...
+ (id)getEmoticonBoardTabOfPidWithType:(long long)arg1;
...
+ (id)getSnsFlutterPublishPath;
+ (id)getSnsFlutterMediaPath;
+ (id)getSnsFlutterCachePath;
...
+ (void)exportLivePhotoVideoWithAsset:(id)arg1 maxDuration:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
+ (id)getSnsPostMusicType:(id)arg1;
+ (_Bool)bindBgmInfoFromSightDraft:(id)arg1 intoUploadTask:(id)arg2;
+ (id)getBgmInfoFromFinderBgmItem:(id)arg1;
+ (id)getBgmInfoFromMusicData:(id)arg1;
+ (id)getBgmInfoFromEditVideoBGMSelectedMusicInfo:(id)arg1;
...
+ (id)tryConvertWCDownloadImageData:(id)arg1;
...
+ (id)generateBackupPathWithTimestampAndCopy:(id)arg1;
