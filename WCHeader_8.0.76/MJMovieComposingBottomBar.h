...
{
    _Bool _shouldShowShootTemplateEntry;
    ...
    MMUIButton *_shootTemplateButton;
...
@property(retain, nonatomic) MMUIButton *shootTemplateButton; // @synthesize shootTemplateButton=_shootTemplateButton;
...
@property(nonatomic) _Bool shouldShowShootTemplateEntry; // @synthesize shouldShowShootTemplateEntry=_shouldShowShootTemplateEntry;
...
- (void)layoutViews;
- (void)updateShootTemplateButtonVisibility;
- (void)setupViews;
