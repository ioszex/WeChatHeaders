...
@class AdvertisementExtInfo, AppMsgCoverPreloadInfo, AudioFeedsInfo, BaseResponse, BizFinderLiveControlInfo, BizMsgReSortConfig, BizMsgResortV2ControlInfo, BizMsgResortV3ControlInfo, BizPersonalCenterCellList, BizReportConfig, BizStrategyControlInfo, BizWxaPersonalCenter, BoxSearchSettingInfo, BoxXiaoWeiConfig, ContactListConfig, FinderLiveAutoplayConfig, MenuEntryListInfo, NotifyConfig, OftenReadBarFeedsInfo, PaySubscribeInfo, PicScrollConfig, ProfilePreloadInfo, PublisherNewMsgInfo, RecReasonDisplayConfig, RecommendFeedsInfo, RedPacketCoverConfig, TimelineFinderInfo, TimelineSettingInfo, TimelineTitlePosConfig, ValidExposeConfig, VideoChannelControlInfo;
...
@property(retain, nonatomic) BizMsgResortV3ControlInfo *bizMsgResortV3ControlInfo; // @dynamic bizMsgResortV3ControlInfo;
...
@property(retain, nonatomic) BoxXiaoWeiConfig *boxXiaoweiConfig; // @dynamic boxXiaoweiConfig;
@property(retain, nonatomic) VideoChannelControlInfo *channelInfo; // @dynamic channelInfo;
@property(retain, nonatomic) ContactListConfig *contactListConfig; // @dynamic contactListConfig;
...
@property(nonatomic) unsigned int exptReportListRankWaitCnt; // @dynamic exptReportListRankWaitCnt;
...
@property(retain, nonatomic) NotifyConfig *notifyConfig; // @dynamic notifyConfig;
@property(retain, nonatomic) OftenReadBarFeedsInfo *oftenReadBarFeedsInfo; // @dynamic oftenReadBarFeedsInfo;
@property(retain, nonatomic) PicScrollConfig *picScrollConfig; // @dynamic picScrollConfig;
@property(nonatomic) unsigned int prodReportListRankWaitCnt; // @dynamic prodReportListRankWaitCnt;
@property(retain, nonatomic) RecommendFeedsInfo *recFeedsInfo; // @dynamic recFeedsInfo;
@property(retain, nonatomic) RecReasonDisplayConfig *recReasonConfig; // @dynamic recReasonConfig;
...
@property(retain, nonatomic) ValidExposeConfig *validExposeConfig; // @dynamic validExposeConfig;
