...
- (void)onPlayerPlayByResume:(id)arg1;
- (void)onPlayerPauseByInterrupt:(id)arg1;
...
- (void)exitBackgroundPlayback:(id)arg1 needClearBgInfo:(_Bool)arg2;
- (void)requestBackgroundPlayback:(id)arg1 playerId:(unsigned int)arg2;
- (id)minimizationHostId;
- (void)updateBackgroundPlayback:(id)arg1 playerId:(unsigned int)arg2;
- (id)currentBgPlayer;
