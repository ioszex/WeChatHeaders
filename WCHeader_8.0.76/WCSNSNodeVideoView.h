...
@interface WCSNSNodeVideoView
{
    ...
    _Bool _suppressPauseOverlayUpdate;
...
@property(nonatomic) _Bool suppressPauseOverlayUpdate; // @synthesize suppressPauseOverlayUpdate=_suppressPauseOverlayUpdate;
...
- (void)showPauseOverlayForCurrentScreenVideo;
- (void)pauseCurrentScreenVideoForAudioRouteChangeIfNeeded;
- (void)onVideoPause;
- (void)onVideoPlay;
