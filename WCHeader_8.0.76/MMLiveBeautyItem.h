...
+ (id)itemInJsonDictionary:(id)arg1 suiteId:(id)arg2 suiteResourcePath:(id)arg3 itemGroups:(id)arg4 badges:(id)arg5 capabilities:(id)arg6;
- (void).cxx_destruct;
