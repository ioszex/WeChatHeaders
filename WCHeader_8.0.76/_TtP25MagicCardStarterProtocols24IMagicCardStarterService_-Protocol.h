...
@class MMUIViewController, NSString, UIView, _TtC25MagicCardStarterProtocols22MagicCardStarterHandle, _TtC25MagicCardStarterProtocols23MagicCardStarterJsEvent, _TtC25MagicCardStarterProtocols26MagicCardStarterRootConfig, _TtC25MagicCardStarterProtocols32MagicCardStarterPreloadBizConfig;
@protocol MagicSimpleViewDelegate, _TtP25MagicCardStarterProtocols27IMagicCardStarterBizCreator_;

@protocol _TtP25MagicCardStarterProtocols24IMagicCardStarterService_
- (void)bindSimpleViewDelegateWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1 viewDelegate:(id <MagicSimpleViewDelegate>)arg2;
- (void)testEvaluateScriptWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1 script:(NSString *)arg2 callback:(void (^)(NSString *))arg3;
...
- (void)bindFrameSetViewWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1 rootConfig:(_TtC25MagicCardStarterProtocols26MagicCardStarterRootConfig *)arg2 containerView:(UIView *)arg3 frameSetName:(NSString *)arg4 frameSetData:(NSString *)arg5 viewId:(long long)arg6 callback:(void (^)(UIView *))arg7;
...
- (void)redrawWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1;
- (void)resumeBizWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1;
- (void)pauseFrameSetRootWithHandle:(_TtC25MagicCardStarterProtocols22MagicCardStarterHandle *)arg1;
...
- (long long)preloadWithBizConfig:(_TtC25MagicCardStarterProtocols32MagicCardStarterPreloadBizConfig *)arg1;
- (_Bool)checkBizValid:(NSString *)arg1 ensurePkg:(_Bool)arg2 ensurePkgCallback:(void (^)(_Bool))arg3;
@end
