...
@interface WCPayPayMoneyFromBrandContactJSApiLogicV2
{
    ...
    NSString *_webviewRawUrl;
    long long _initTimestamp;
...
@property(nonatomic) long long initTimestamp; // @synthesize initTimestamp=_initTimestamp;
@property(retain, nonatomic) NSString *webviewRawUrl; // @synthesize webviewRawUrl=_webviewRawUrl;
