...
@class CreateMobileTemplateButtonInfo, NSArray, NSData, NSMutableArray, NSString;
...
@interface WCFinderProfileMJTempPageModel
{
    ...
    CreateMobileTemplateButtonInfo *_createMobileTemplateButtonInfo;
...
@property(retain, nonatomic) CreateMobileTemplateButtonInfo *createMobileTemplateButtonInfo; // @synthesize createMobileTemplateButtonInfo=_createMobileTemplateButtonInfo;
...
- (_Bool)hasContentForProfileTabReport;
