...
@class CContact, CEmoticonWrap, EmoticonBoardView, EmoticonCustomManageAddLogic, MMCPLabel, MMGrowTextView, MMHeadImageView, MMImage, MMRTCSnsMenuResponder, MMSnsRichTextCoverView, MMTableView, MMUIButton, MMUILabel, MMURLHandler, MMWebImageView, NSArray, NSMutableArray, NSMutableDictionary, NSObject, NSString, RichTextView, SharePreConfirmSheetView, SnsAlbumFeedBehaviour, TextStateItemView, UIButton, UILabel, UIView, UrlLabel, WCADPageWrap, WCAdActionLinkDetailView, WCAdBreakFrameTagView, WCAdBreakFrameView, WCAdCommonBarContainerView, WCAdContinuousLikeBannerAnimationView, WCAdContinuousLikeTagView, WCAdHeadLivingView, WCAdHeadStateView, WCAdHighlightTagView, WCAdInteractionLabelView, WCAdInteractionTagView, WCAdPreviewMaskView, WCAdRandomPickCardView, WCAdSocialLikeCheerPlayerView, WCAdSocialLikeView, WCAdStateSettingBarView, WCAdTagButton, WCAdWeGameGiftTagView, WCAdvertiseActionFloatView, WCAdvertiseFeedbackBaseView, WCAlbumForwardFinderUtil, WCCommentBigEmoticonAddHelper, WCCommentImageHelper, WCCommentItem, WCCommentReport, WCCommentView, WCContentItem, WCContentItemBaseView, WCDataItem, WCEcsLogoNameView, WCHeaderGridView, WCInputController, WCMomentsAnimatedFireworksView, WCMomentsClickHandler, WCMomentsCommentBrowseAggreReport, WCMomentsFinderShareViewModel, WCMomentsInputAreaReportInfo, WCMomentsInvisibleTipsView, WCMomentsPageContext, WCMomentsPostSessionController, WCMomentsPostShareButton, WCMomentsShareScopeMgr, WCMomentsSpringTextContainerView, WCMomentsStarGuideButton, WCMomentsStarGuideViewModel, WCMomentsTigerReporter, WCMomentsWeAppLogoNameView, WCOperateFloatView, WCPasteTextLengthLogic, WCRichTextView, WCSnsCommentDetailRewardView, WCSpringWishBubbleView, WCTimelineCommentEmotionReport, WCTimelineExtBean, WCTogetherHistoryReportSession, WCTogetherTailReporter, WCUserComment;
...
@interface WCCommentDetailViewControllerFB
{
    ...
    WCRichTextView *_contentDescView;
    ...
    _Bool _isShowingCommentPickerVC;
    ...
    long long _fromPageScene;
    long long _homepageType;
    NSString *_snsPageSessionId;
    ...
    MMRTCSnsMenuResponder *_selectableMenuResponder;
    ...
    UrlLabel *_individualSourceLabel;
    UILabel *_locationLabel;
    UILabel *_individualLocationLabel;
    WCAdvertiseFeedbackBaseView *_adFeedbackView;
    WCMomentsWeAppLogoNameView *_weAppView;
    WCMomentsWeAppLogoNameView *_individualWeAppView;
    WCEcsLogoNameView *_ecsView;
    ...
    WCAdHeadLivingView *_adHeadLivingView;
    WCAdHighlightTagView *_adHighlightTagView;
    WCAdCommonBarContainerView *_adMediaBottomBarContainerView;
    ...
    WCSpringWishBubbleView *_springBubbleView;
...
@property(nonatomic) _Bool isShowingCommentPickerVC; // @synthesize isShowingCommentPickerVC=_isShowingCommentPickerVC;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: commentBrowseAggreReporter
...
@property(retain, nonatomic) WCSpringWishBubbleView *springBubbleView; // @synthesize springBubbleView=_springBubbleView;
...
@property(retain, nonatomic) WCAdCommonBarContainerView *adMediaBottomBarContainerView; // @synthesize adMediaBottomBarContainerView=_adMediaBottomBarContainerView;
@property(retain, nonatomic) WCAdHighlightTagView *adHighlightTagView; // @synthesize adHighlightTagView=_adHighlightTagView;
@property(retain, nonatomic) WCAdHeadLivingView *adHeadLivingView; // @synthesize adHeadLivingView=_adHeadLivingView;
...
@property(retain, nonatomic) WCEcsLogoNameView *ecsView; // @synthesize ecsView=_ecsView;
@property(retain, nonatomic) WCMomentsWeAppLogoNameView *individualWeAppView; // @synthesize individualWeAppView=_individualWeAppView;
...
@property(retain, nonatomic) UILabel *individualLocationLabel; // @synthesize individualLocationLabel=_individualLocationLabel;
@property(retain, nonatomic) UILabel *locationLabel; // @synthesize locationLabel=_locationLabel;
@property(retain, nonatomic) UrlLabel *individualSourceLabel; // @synthesize individualSourceLabel=_individualSourceLabel;
...
@property(retain, nonatomic) MMRTCSnsMenuResponder *selectableMenuResponder; // @synthesize selectableMenuResponder=_selectableMenuResponder;
...
@property(nonatomic) _Bool bShowSpringBubble; // @synthesize bShowSpringBubble=_bShowSpringBubble;
...
@property(nonatomic) double pageEnterTime; // @synthesize pageEnterTime=_pageEnterTime;
@property(retain, nonatomic) NSString *snsPageSessionId; // @synthesize snsPageSessionId=_snsPageSessionId;
@property(nonatomic) long long homepageType; // @synthesize homepageType=_homepageType;
@property(nonatomic) long long fromPageScene; // @synthesize fromPageScene=_fromPageScene;
...
- (id)fetchAdCellViewExtContainerForItemView:(id)arg1 type:(long long)arg2;
- (id)getCurrentViewControllerForContentItemView:(id)arg1;
- (void)reportSnsFeedLikeWithResult:(unsigned long long)arg1;
- (void)reportSnsFeedCmt;
- (void)reportSnsFeedModifyVisibility;
- (void)reportSnsFeedPin;
- (void)reportSnsFeedDel;
- (long long)homeTypeToAlbumScene:(long long)arg1;
- (void)reportSnsUserHomeCustomEvent:(id)arg1 params:(id)arg2;
...
- (void)onFeedbackClickReceivedReasonBtn:(id)arg1;
- (void)onFeedbackClickLikedBtn:(id)arg1;
- (void)onClickComplainBtn:(id)arg1 dataItem:(id)arg2;
- (void)onAdFeedbackDisappear:(unsigned long long)arg1 toastTitle:(id)arg2 dataItem:(id)arg3;
...
- (long long)postPrivacyToVisibleRange:(long long)arg1;
- (void)modifyShareScope;
- (void)onWebSearch:(id)arg1;
- (void)onAskXiaoWeiComment:(id)arg1;
- (void)onAskXiaoWeiText:(id)arg1;
...
- (_Bool)canShowIndividualLocationLabel;
- (_Bool)canShowLocationLabel;
- (_Bool)canShowIndividualwWeAppView;
- (_Bool)canShowWeAppView;
- (_Bool)canShowIndividualSourceLabel;
- (_Bool)canShowSourceLabel;
- (double)layoutHeadInnerView;
- (unsigned int)getLikeIconCountPerLineWithLikeIconSize:(double)arg1 likeIconRowSpace:(double)arg2;
- (double)calculateLikeIconRightMarginWithLikeIconSize:(double)arg1;
...
- (void)reportSnsFeedDetailPageBlankState:(long long)arg1;
...
- (void)animateSpringBubbleView:(id)arg1;
...
- (id)createCommentDetailTextStateView:(id)arg1;
- (void)configTextStateViewReportWithContact:(id)arg1;
- (_Bool)useStatusIconStyleUpgrade;
...
- (_Bool)shouldForbidCommentDataItem:(id)arg1;
...
- (id)getExtInfoForMenuAction;
- (void)exitSelectState;
- (void)onLongPressWithRichTextView:(id)arg1 menuItems:(id)arg2 isTranslatedText:(_Bool)arg3 bubblePullType:(long long)arg4 textSelectType:(long long)arg5;
- (void)onLongPressWithRichTextCoverView:(id)arg1 nsText:(id)arg2 isWord:(_Bool)arg3 bubblePullType:(long long)arg4 textSelectType:(long long)arg5;
- (id)menuItemsForTextView:(id)arg1 isWord:(_Bool)arg2 andView:(id)arg3 isCommentText:(_Bool)arg4;
...
- (id)onAdCommonBarFetchMediaViewWithDataItem:(id)arg1;
- (void)doWorldCupAvatarLeaveCanvasInDetailWithDataItem:(id)arg1;
- (void)onAdCommonBarWorldCupAvatarLeaveCanvasWithDataItem:(id)arg1;
- (void)showCommentForDataItem:(id)arg1;
- (void)onAdCommonBarRockPaperScissorsLeaveCanvasWithDataItem:(id)arg1 showComment:(_Bool)arg2;
...
- (void)onImageButtonClicked:(id)arg1;
...
- (_Bool)shouldShowCommentMenuItemForText:(id)arg1 comment:(id)arg2;
...
- (void)handleUrl:(id)arg1 backupUrl:(id)arg2 extraInfo:(id)arg3 adClickSource:(long long)arg4;
- (void)handleUrl:(id)arg1 backupUrl:(id)arg2 adClickSource:(long long)arg3;
- (void)handleUrl:(id)arg1 backupUrl:(id)arg2;
- (void)onLinkClicked:(id)arg1 backupUrl:(id)arg2 withRect:(struct CGRect)arg3 extraInfo:(id)arg4 adClickSource:(long long)arg5;
...
- (void)showEmoitionOrImageMenuItemWithRect:(struct CGRect)arg1 userComment:(id)arg2;
...
- (_Bool)supportCommentEmoticonPost;
- (_Bool)supportCommentImagePost;
- (_Bool)supportCommentEmoticonOrImagePost;
