...
@class FinderLiveNextLiveNotificationInfo, FinderLiveNoticeInfo, FinderLiveNoticeListInfo, MMPaddingView, MMUIButton, NSString, RichTextView, UIColor, UIImageView, UILabel, WCFinderLiveNoticePayActionView, WCFinderLiveNoticeViewItemView;
...
@interface WCFinderLiveNoticeView : UIView
{
    ...
    WCFinderLiveNoticeViewItemView *_nextLiveNoticeView;
    ...
    UILabel *_bindItemLabel;
    MMPaddingView *_couponsTitleLabel;
    UIImageView *_nextLiveNoticeLogoView;
    UILabel *_nextLiveNoticeLabel;
    MMUIButton *_nextLiveNoticeButton;
    UIView *_nextLiveNoticeCoverView;
...
+ (_Bool)showNextLiveNoticeWithNoticeList:(id)arg1 nextLiveNoticeInfo:(id)arg2 isAuthor:(_Bool)arg3;
+ (_Bool)showsMoreNoticesWithNoticeList:(id)arg1 nextLiveNoticeInfo:(id)arg2 isAuthor:(_Bool)arg3;
+ (id)getReserveString:(id)arg1;
+ (id)getTitleFont:(_Bool)arg1;
+ (double)nextLiveNoticeViewHeight:(_Bool)arg1 isInList:(_Bool)arg2;
+ (double)heightWithIdentity:(_Bool)arg1 noticeInfo:(id)arg2 noticeList:(id)arg3 nextLiveNoticeInfo:(id)arg4 width:(double)arg5 introductionStyle:(long long)arg6 isInList:(_Bool)arg7 memberVisitant:(_Bool)arg8 isStartReminder:(_Bool)arg9;
+ (double)heightWithIdentity:(_Bool)arg1 noticeInfo:(id)arg2 noticeList:(id)arg3 nextLiveNoticeInfo:(id)arg4 width:(double)arg5 introductionStyle:(long long)arg6 isInList:(_Bool)arg7 memberVisitant:(_Bool)arg8 isStartReminder:(_Bool)arg9 displayLiveTimeOnSingleLine:(_Bool)arg10;
...
@property(retain, nonatomic) UIView *nextLiveNoticeCoverView; // @synthesize nextLiveNoticeCoverView=_nextLiveNoticeCoverView;
@property(retain, nonatomic) MMUIButton *nextLiveNoticeButton; // @synthesize nextLiveNoticeButton=_nextLiveNoticeButton;
@property(retain, nonatomic) UILabel *nextLiveNoticeLabel; // @synthesize nextLiveNoticeLabel=_nextLiveNoticeLabel;
@property(retain, nonatomic) UIImageView *nextLiveNoticeLogoView; // @synthesize nextLiveNoticeLogoView=_nextLiveNoticeLogoView;
@property(retain, nonatomic) MMPaddingView *couponsTitleLabel; // @synthesize couponsTitleLabel=_couponsTitleLabel;
@property(retain, nonatomic) UILabel *bindItemLabel; // @synthesize bindItemLabel=_bindItemLabel;
...
@property(retain, nonatomic) WCFinderLiveNoticeViewItemView *nextLiveNoticeView; // @synthesize nextLiveNoticeView=_nextLiveNoticeView;
...
- (void)onNextLiveNoticeClicked:(id)arg1;
...
- (void)updateWithIdentity:(_Bool)arg1 anchorFinderUsername:(id)arg2 noticeInfo:(id)arg3 noticeList:(id)arg4 nextLiveNoticeInfo:(id)arg5 isInList:(_Bool)arg6 memberVisitant:(_Bool)arg7 isStartReminder:(_Bool)arg8 indexInList:(long long)arg9 totalNoticeCount:(long long)arg10;
