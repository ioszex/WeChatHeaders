...
@interface MultiSelectTableViewCell : UITableViewCell
{
    ...
    double _m_editingOffsetPadding;
    double _m_selectFlagCenterY;
}

- (void).cxx_destruct;
@property(nonatomic) double m_selectFlagCenterY; // @synthesize m_selectFlagCenterY=_m_selectFlagCenterY;
@property(nonatomic) double m_editingOffsetPadding; // @synthesize m_editingOffsetPadding=_m_editingOffsetPadding;
