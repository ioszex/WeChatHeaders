...
@class FinderCheckPrefetchConfig, MMLRUCache, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderFeedContentVM, WCFinderThreadSafeLRUCache, WCFinderVideoPlayDisplayReportInfo;
...
@interface WCFinderMemoryCacheMgr : NSObject
{
    ...
    NSMutableDictionary *_reserveStatusByNoticeIdDic;
    ...
    WCFinderThreadSafeLRUCache *_dupIdentifierLastPlayCache;
    MMLRUCache *_progressAnchorInfoCache;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMLRUCache *progressAnchorInfoCache; // @synthesize progressAnchorInfoCache=_progressAnchorInfoCache;
@property(retain, nonatomic) WCFinderThreadSafeLRUCache *dupIdentifierLastPlayCache; // @synthesize dupIdentifierLastPlayCache=_dupIdentifierLastPlayCache;
...
@property(retain, nonatomic) NSMutableDictionary *reserveStatusByNoticeIdDic; // @synthesize reserveStatusByNoticeIdDic=_reserveStatusByNoticeIdDic;
...
- (void)saveLastDupIdentifierWithTid:(id)arg1 commentScene:(int)arg2 dupIdentifier:(id)arg3;
- (id)lastDupIdentifierWithTid:(id)arg1 commentScene:(int)arg2;
...
- (void)setReserveStatus:(long long)arg1 forNoticeId:(id)arg2;
- (id)reserveStatusForNoticeId:(id)arg1;
...
- (void)updateProgressAnchorInfoWithDataArray:(id)arg1 commentScene:(int)arg2;
- (id)progressAnchorInfoWithTid:(id)arg1 commentScene:(int)arg2;
