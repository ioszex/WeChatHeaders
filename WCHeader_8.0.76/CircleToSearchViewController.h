...
- (void)handleCircleToSearchActionPreviewTranslatedImage:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;
- (void)handleCircleToSearchActionDownloadTranslatedImage:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;
...
- (void)notifyInitialData:(id)arg1;
