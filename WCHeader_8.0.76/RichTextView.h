...
@protocol ILinkEventExt, RichTextEmoticonExtension, RichTextLayoutDelegate;
...
@interface RichTextView
{
    ...
    _Bool _bDisableInnerDoubleTap;
    _Bool _isDoubleTapDetected;
    ...
    long long _truncatedTrailingPosition;
    ...
    struct _NSRange _selectedRangeForCoverView;
...
@property(nonatomic) _Bool isSupportImageClick; // @synthesize isSupportImageClick=_isSupportImageClick;
...
@property(nonatomic) struct _NSRange selectedRangeForCoverView; // @synthesize selectedRangeForCoverView=_selectedRangeForCoverView;
...
@property(nonatomic) long long truncatedTrailingPosition; // @synthesize truncatedTrailingPosition=_truncatedTrailingPosition;
...
@property(nonatomic) _Bool isDoubleTapDetected; // @synthesize isDoubleTapDetected=_isDoubleTapDetected;
@property(nonatomic) long long inlineVerticalAlign; // @synthesize inlineVerticalAlign=_inlineVerticalAlign;
@property(nonatomic) _Bool bDisableInnerDoubleTap; // @synthesize bDisableInnerDoubleTap=_bDisableInnerDoubleTap;
...
@property(nonatomic) __weak id <RichTextEmoticonExtension> emoticonExt; // @synthesize emoticonExt=_emoticonExt;
...
- (struct _NSRange)getLastStyleRange;
...
- (double)getOffsetXInTextStyle:(id)arg1 atIndex:(unsigned long long)arg2;
...
- (void)onImageStyle:(id)arg1 didFinishLoadWebImage:(id)arg2;
- (void)onImageStyleUpdateContent;
- (void)onAddLoadingAnimationView:(id)arg1;
...
- (_Bool)canPeek;
- (void)imageDelayedTouchesEnded:(id)arg1;
...
- (void)resetDoubleTapStateWithTouches:(id)arg1;
...
- (void)onRichTextViewDoubleClick:(id)arg1;
...
- (void)clickOnBizSchemeLinkEvent:(id)arg1;
...
- (void)asyncLoadEmoticonThumb:(id)arg1;
