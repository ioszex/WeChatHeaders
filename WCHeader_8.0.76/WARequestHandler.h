...
- (void)startRequestTaskWithURL:(id)arg1 ip:(id)arg2 port:(unsigned int)arg3 host:(id)arg4 forbidReuse:(_Bool)arg5 taskID:(id)arg6 data:(id)arg7 httpHeaders:(id)arg8 method:(id)arg9 isIgnoreCheckDomain:(_Bool)arg10 context:(id)arg11 chunkedHandler:(CDUnknownBlockType)arg12 headersReceivedHandler:(CDUnknownBlockType)arg13 completionHandler:(CDUnknownBlockType)arg14 isUseCronet:(_Bool)arg15 useQuic:(_Bool)arg16 useHttp2:(_Bool)arg17 useCache:(_Bool)arg18 useChunked:(_Bool)arg19 appType:(unsigned int)arg20 forceCellularNetwork:(_Bool)arg21;
- (void)dealloc;
