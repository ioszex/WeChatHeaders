...
@class CameraScanCodeVerifier, CameraScanOperateOptmize, CameraScanOperateReporter, CameraScanParallelImageScanner, CameraScannerViewWrapper, NSRecursiveLock, NSString, UIImage;
...
@interface NewQRCodeScanner
{
    ...
    _Bool _isResultFromParallelImageScan;
    ...
    unsigned int _parallelImageScanExecuteCount;
    unsigned int _parallelImageScanExecuteTotalTime;
    float _rotateDegree;
    ...
    NSString *_preset;
    CameraScanParallelImageScanner *_parallelImageScanner;
    CameraScanCodeVerifier *_codeVerifier;
...
@property(retain, nonatomic) CameraScanCodeVerifier *codeVerifier; // @synthesize codeVerifier=_codeVerifier;
@property(retain, nonatomic) CameraScanParallelImageScanner *parallelImageScanner; // @synthesize parallelImageScanner=_parallelImageScanner;
@property(nonatomic) unsigned int parallelImageScanExecuteTotalTime; // @synthesize parallelImageScanExecuteTotalTime=_parallelImageScanExecuteTotalTime;
@property(nonatomic) unsigned int parallelImageScanExecuteCount; // @synthesize parallelImageScanExecuteCount=_parallelImageScanExecuteCount;
...
@property(nonatomic) _Bool isResultFromParallelImageScan; // @synthesize isResultFromParallelImageScan=_isResultFromParallelImageScan;
...
- (id)getCameraSnapshotContextWithImageOrientation:(long long)arg1;
- (id)getCameraSnapshotContext;
- (long long)cameraImageOrientation;
- (void)releaseCurrentSampleBuffer;
- (struct opaqueCMSampleBuffer *)getAndRetainCurrentSampleBuffer;
- (void)setCurrentSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 hasCodeInDetection:(_Bool)arg2;
...
- (void)resetEngine:(unsigned long long)arg1;
- (void)stopCapture;
- (_Bool)shouldResetNewSessionWithScanSession:(unsigned long long)arg1 uiSession:(unsigned int)arg2;
- (void)resetParallelImageScanStatus;
- (void)startCaptureWithScanSession:(unsigned long long)arg1 uiSession:(unsigned int)arg2;
- (void)startCapture;
- (void)applyParallelScanResult:(id)arg1;
- (void)parallelImageScanner:(id)arg1 didGetResults:(id)arg2;
...
- (void)LogScanSuccessInfo:(id)arg1;
