...
@class MMUIButton, MMWebImageView, NSLayoutConstraint, NSString, RichTextView, UIImageView, UILabel, UIView, WCFinderHeadImageView, WCFinderMentionTitleView, WCFinderNotifyAttachDisplayView, WCFinderRichTextView, WCFinderWechatMentionCellViewModel;
...
@property(nonatomic) __weak UILabel *feedTypeTag; // @synthesize feedTypeTag=_feedTypeTag;
...
- (void)applyLayoutMetrics:(id)arg1;
