...
@class NSArray, NSMutableArray, NSMutableSet, NSString, QAOIMarkerManager, QAnnotationContainerView, QAnnotationMarkerDragGestureRecognizer, QAppKeyCheck, QBaseVisualLayerManager, QBasicMapView, QBasicMapViewLayer, QBrandPromotionServer, QConfigManager, QConfigPreference, QCustomLayerManager, QDataChecker, QEngineResourceManager, QHandDrawTileOverlay, QIndoorBuilding, QIndoorLevel, QIndoorManager, QInnerMarkerManager, QIntersectionOverlayManager, QL4Manager, QLayerManager, QLocalStateCollector, QMapContentView, QMapDataManager, QMapDataSafetyInternalManager, QMapViewAccessibilityElement, QMarker, QMediator, QOverlayContainer, QPointEventMananger, QScaleView, QStatisticer, QStyleManager, QTileOverlayManager, QTrafficManager, QUniversalMapCounter, QUserLocation, QUserLocationAccessibilityElement, QUserLocationManager, QUserLocationPresentation, QWorldTileOverlay, QWorldTileOverlayCustomProvider, TBRegionChangeDistributor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@interface QMapView : UIView
{
    ...
    QInnerMarkerManager *_nativeMarkerManager;
    ...
    QAnnotationMarkerDragGestureRecognizer *_annotationMarkerDragGesture;
    QMarker *_markerLongPressed;
...
@property(retain, nonatomic) QMarker *markerLongPressed; // @synthesize markerLongPressed=_markerLongPressed;
@property(nonatomic) struct CGPoint originalSingleTapPoint; // @synthesize originalSingleTapPoint=_originalSingleTapPoint;
@property(retain, nonatomic) QAnnotationMarkerDragGestureRecognizer *annotationMarkerDragGesture; // @synthesize annotationMarkerDragGesture=_annotationMarkerDragGesture;
...
@property(retain, nonatomic) QInnerMarkerManager *nativeMarkerManager; // @synthesize nativeMarkerManager=_nativeMarkerManager;
...
- (void)showQMarkers:(id)arg1 edgePadding:(struct UIEdgeInsets)arg2 animated:(_Bool)arg3;
...
- (id)searchForQMarkerOverlayOnLongPress:(struct CGPoint)arg1;
...
- (void)callDelegateDidTapMarkerOverlayCallout:(id)arg1;
...
- (void)_triggerAnnotationViewTappedForMarkerID:(int)arg1;
