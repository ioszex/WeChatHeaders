...
@class MarsCdnSKBuiltinBuffer_t, NSMutableArray, NSString;

@interface MarsCdnCDNDnsInfo : WXPBGeneratedMessage
{
}
...
@property(retain, nonatomic) MarsCdnSKBuiltinBuffer_t *authKey; // @dynamic authKey;
...
@property(retain, nonatomic) MarsCdnSKBuiltinBuffer_t *newAuthKey; // @dynamic newAuthKey;
