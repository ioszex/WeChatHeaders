...
@class MMFinderLiveGoodsItem, MMFinderLiveLotteryCreateInfo, MMFinderLiveMicAnchorReportParams, MMFinderLiveShopContext, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveTask, NSDictionary, NSString, WCFinderContact;
...
- (void)onCoverEnhanceAction:(NSDictionary *)arg1;
- (void)onAnchorModifyLiveModeAction:(unsigned long long)arg1 extraInfo:(NSDictionary *)arg2;
- (void)onAnchorModifyLiveModeAction:(unsigned long long)arg1;
- (void)reportMicAnchortWithType:(unsigned long long)arg1 aiAssistantInfoId:(NSString *)arg2 reportParams:(MMFinderLiveMicAnchorReportParams *)arg3;
- (void)reportCommerceAction:(unsigned long long)arg1 extra:(NSDictionary *)arg2;
...
- (void)onLiveAnchorOperationWithActionType:(unsigned long long)arg1 dict:(NSDictionary *)arg2 andTask:(MMFinderLiveTask *)arg3;
...
- (void)onAnchorReplyComment:(NSDictionary *)arg1;
- (void)onAnchorCommentAction:(unsigned long long)arg1 dicActionResult:(NSDictionary *)arg2;
...
- (void)onMicAction:(unsigned long long)arg1 withActionResultDictionary:(NSDictionary *)arg2;
...
- (void)onSimpleModePubbleGuide:(MMFinderLiveTask *)arg1;
- (void)onJoinLiveAfterAbnormal:(MMFinderLiveTask *)arg1 startExtraInfo:(NSDictionary *)arg2;
