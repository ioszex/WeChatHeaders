...
- (void)handleBizLoveInteractionResponse:(id)arg1;
- (void)handleSetProfileSettingResponse:(id)arg1;
- (void)MessageReturn:(id)arg1 Event:(unsigned int)arg2;
- (void)handleModBizUseUserInfoResponse:(id)arg1;
- (void)requestModifyLoveStatusWithBizName:(id)arg1 blockStatus:(unsigned int)arg2;
- (void)requestModifyProfileSettingWithBizName:(id)arg1 finderUserName:(id)arg2 setting:(id)arg3 shouldToast:(_Bool)arg4;
...
- (_Bool)_fetchBiz:(id)arg1 bizSessionID:(unsigned int)arg2 scene:(unsigned int)arg3 action:(int)arg4 offset:(id)arg5 pageSize:(unsigned int)arg6 userInfo:(id)arg7 searchClickId:(id)arg8 pageMode:(unsigned int)arg9 bizFromScene:(int)arg10 isMpManagementScene:(_Bool)arg11;
- (_Bool)fetchProfileNextPkg:(id)arg1 bizSessionID:(unsigned int)arg2 scene:(unsigned int)arg3 action:(int)arg4 offset:(id)arg5 userInfo:(id)arg6 searchClickId:(id)arg7 pageMode:(unsigned int)arg8 bizFromScene:(int)arg9 isMpManagementScene:(_Bool)arg10;
- (_Bool)fetchProfileFirstPkg:(id)arg1 bizSessionID:(unsigned int)arg2 scene:(unsigned int)arg3 userInfo:(id)arg4 searchClickId:(id)arg5 pageMode:(unsigned int)arg6 bizFromScene:(int)arg7 isMpManagementScene:(_Bool)arg8;
- (void)onGetContactByNewAttrCGI:(id)arg1;
- (_Bool)getBrandInfoByNewAttrCGI:(id)arg1 ignoreCheckInterval:(_Bool)arg2;
