...
- (void)calcContentViewsSizeWithContainerSize:(struct CGSize)arg1 outMediaViewSize:(struct CGSize *)arg2 outDetailViewSize:(struct CGSize *)arg3 outNarrowWidth:(double *)arg4;
- (struct CGSize)effectiveContainerSize;
