...
@class MsgCheckInfo, NSString, WCPayAlertItem, WCPayPlaceOrderPopupTip, WCPayTransferAmountReInputPageStruct;
...
@interface WCPayTransferPrepayResponseStruct : NSObject
{
    ...
    WCPayPlaceOrderPopupTip *_placeOrderPopupTip;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCPayPlaceOrderPopupTip *placeOrderPopupTip; // @synthesize placeOrderPopupTip=_placeOrderPopupTip;
