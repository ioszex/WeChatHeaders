...
@class AddMemLogic, CBaseContact, CContact, DelMemLogic, MMPageSheetAdapter, MMTableView, MMTableViewInfo, NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NewContactsSearchPanelView, OrderedDictionary, SearchHelpDataItem, UILabel, UIView, WCColorProxy, WCSearchBar, WCSearcher;
...
@interface RoomContactSelectViewController
{
    ...
    _Bool m_hasExpandedSearchPanel;
    ...
    _Bool _m_bHideBlack;
    _Bool _m_bShowAtAll;
    _Bool _m_bShowOperateBtn;
    _Bool _m_bOwnerAtFirst;
    ...
    CDUnknownBlockType _m_reportSelectContactBlock;
...
@property(nonatomic) _Bool m_bOwnerAtFirst; // @synthesize m_bOwnerAtFirst=_m_bOwnerAtFirst;
@property(nonatomic) _Bool m_bShowOperateBtn; // @synthesize m_bShowOperateBtn=_m_bShowOperateBtn;
...
@property(copy, nonatomic) CDUnknownBlockType m_reportSelectContactBlock; // @synthesize m_reportSelectContactBlock=_m_reportSelectContactBlock;
...
- (void)initView;
- (void)updatePanelView:(id)arg1 isSelected:(_Bool)arg2;
