...
@class MMUIViewController, NSCache, NSDictionary, NSString, ScanQRCodeLogicController, UIImage, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
...
- (void)dealloc;
- (id)init;
- (void)askXiaoWeiWithImageData:(id)arg1;
...
- (_Bool)shouldInterceptSaveOriginImageForURL:(id)arg1;
- (_Bool)trySendMsgByMpForward:(id)arg1;
- (id)getMpInfoModel;
- (id)getColorL1:(id)arg1;
- (_Bool)shouldShowWatermark:(id)arg1;
- (id)getWatermarkImage:(id)arg1 data:(id)arg2 imgUrl:(id)arg3;
- (void)saveImageToAlbumWithUrl:(id)arg1 OrBase64Data:(id)arg2 canAddWatermark:(_Bool)arg3 Selector:(SEL)arg4;
- (void)PreScanQRCode;
...
- (_Bool)shouldAddAskXiaoWeiButton;
