...
@property(nonatomic) _Bool aggregationLongPress; // @synthesize aggregationLongPress=_aggregationLongPress;
...
- (long long)visibleSessionIndexForUsername:(id)arg1;
