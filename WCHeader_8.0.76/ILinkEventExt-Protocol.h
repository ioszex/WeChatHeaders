...
@class CTRichTextView, LinkBizSchemeWrap, LinkWeAppJumpWrap, MMCPLabel, NSDictionary, NSString, RichTextView, UIImage;
...
- (void)onBizSchemeLinkClicked:(LinkBizSchemeWrap *)arg1 withRect:(struct CGRect)arg2;
