...
- (id)getWebImgView;
- (id)currentImage;
- (void)reloadSquareImageIfNeeded;
- (void)startLoadImageWithGCD;
- (void)updateImagePath:(id)arg1;
- (void)compressAndSaveImageInBackground:(id)arg1 compressionQuality:(double)arg2 path:(id)arg3;
...
- (_Bool)isCheckImageChange;
- (id)initWithImgInfo:(id)arg1 AndChatName:(id)arg2 msgWrap:(id)arg3 selectable:(_Bool)arg4 fullAsync:(_Bool)arg5 thumbSize:(struct CGSize)arg6;
- (id)initWithImgInfo:(id)arg1 AndChatName:(id)arg2 msgWrap:(id)arg3 selectable:(_Bool)arg4 fullAsync:(_Bool)arg5;
- (void)dealloc;
