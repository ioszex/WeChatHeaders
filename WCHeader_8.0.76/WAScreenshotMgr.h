...
@class NSMutableArray, NSMutableDictionary, NSObject, NSString, PHFetchResult, WAAppTask;
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *photoLibraryQueue; // @synthesize photoLibraryQueue=_photoLibraryQueue;
...
- (_Bool)hasPendingInfo;
- (id)getLastScreenshotContextInfoWithWebVC:(id)arg1;
- (id)getScreenshotContextInfoWithAssetId:(id)arg1;
- (id)getCurrentVisibleTaskByTaskMgr;
- (id)getCurrentVisibleTaskWithCacheInMiliSec:(unsigned long long)arg1;
