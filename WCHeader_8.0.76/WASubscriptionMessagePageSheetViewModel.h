...
@class NSArray, NSData, NSString, SubscribeMsgShowInfo, UIColor, UIFont;
...
@interface WASubscriptionMessagePageSheetViewModel
{
    ...
    NSString *_kvUid;
    UIFont *_listItemTitleFont;
    UIColor *_listItemBackgroundColor;
}

+ (id)readOnlyViewModelFromSnapshotPayload:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) UIColor *listItemBackgroundColor; // @synthesize listItemBackgroundColor=_listItemBackgroundColor;
@property(retain, nonatomic) UIFont *listItemTitleFont; // @synthesize listItemTitleFont=_listItemTitleFont;
