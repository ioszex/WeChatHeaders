...
// Error: Property attributes should begin with the type ('T') attribute, property name: musicPlayLogic
...
- (void)reportAction:(unsigned long long)arg1 music:(id)arg2 refreshPlayId:(_Bool)arg3;
...
- (void)insertMusicData:(id)arg1 animated:(_Bool)arg2;
