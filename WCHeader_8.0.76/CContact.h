...
@class BypChatRoomMemberData, CAppBrandInfo, COpenIMInfo, CardImgItemInfo, ChatRoomData, ChatRoomDetail, EncryptSecretInfo, NSArray, NSData, NSDictionary, NSRecursiveLock, NSString, RingTone;
...
@interface CContact
{
    ...
    NSString *m_contactVersionJson;
    NSDictionary *_m_dicWeiDianInfo;
    NSString *_m_nsChatRoomSpecialAttentionMemList;
    NSString *_m_nsChatRoomBypMemberList;
    BypChatRoomMemberData *_m_ChatRoomBypMemberData;
    NSData *_m_nsChatRoomBypDerivedSyncKey;
    CardImgItemInfo *_m_businessCardItem;
...
+ (void)initialize;
+ (void)PBArrayAdd_m_contactVersionJson;
...
+ (_Bool)isEcsKfUserName:(id)arg1;
+ (_Bool)isWeWorkKFUserName:(id)arg1;
+ (_Bool)isWeAppUserName:(id)arg1;
+ (id)contactFromPhotoAccountShareCardMsgContent:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool isDeleteInSynModcontact; // @synthesize isDeleteInSynModcontact=_isDeleteInSynModcontact;
...
@property(retain, nonatomic) CardImgItemInfo *m_businessCardItem; // @synthesize m_businessCardItem=_m_businessCardItem;
@property(retain, nonatomic) NSData *m_nsChatRoomBypDerivedSyncKey; // @synthesize m_nsChatRoomBypDerivedSyncKey=_m_nsChatRoomBypDerivedSyncKey;
@property(retain, nonatomic) BypChatRoomMemberData *m_ChatRoomBypMemberData; // @synthesize m_ChatRoomBypMemberData=_m_ChatRoomBypMemberData;
@property(retain, nonatomic) NSString *m_nsChatRoomBypMemberList; // @synthesize m_nsChatRoomBypMemberList=_m_nsChatRoomBypMemberList;
...
@property(nonatomic) unsigned int m_uiLocalAddContactTime; // @synthesize m_uiLocalAddContactTime;
...
@property(retain, nonatomic) NSString *m_contactVersionJson; // @synthesize m_contactVersionJson;
@property(nonatomic) unsigned int m_uiChatRoomQRCodeAccessType; // @synthesize m_uiChatRoomQRCodeAccessType;
...
- (void)setM_uiChatRoomStatus:(unsigned int)arg1;
- (unsigned int)m_uiChatRoomStatus;
@property(retain) NSString *m_nsChatRoomMemList; // @synthesize m_nsChatRoomMemList;
...
- (_Bool)isSingleChatBoxContact;
- (_Bool)isChatBoxContact;
- (_Bool)isNormalContact;
- (_Bool)isSingleContactNotNecessarilyMM;
- (_Bool)isWeixinSingleConatctCore;
- (_Bool)isWeixinSingleConatct;
- (_Bool)isHolderContact;
- (_Bool)isOfficialContact;
- (_Bool)isVerified;
...
- (_Bool)isChatRoomNeedPushGroupNoticeMsg;
- (_Bool)isChatRoomNeedPushAtAllMsg;
- (_Bool)isChatRoomNeedPushAtMeMsg;
- (_Bool)isBlack;
...
- (_Bool)isEcsKefuContact;
- (_Bool)isWeAppContact;
- (id)getWeAppID;
- (id)getAppBrandInfo;
- (id)getBizAIReplyWording;
- (_Bool)isBizAIReplyEnabled;
- (id)getPrivateMsgBlockingTips;
- (_Bool)getIsOneMsgBeforeReply;
- (unsigned long long)getPrivateMsgScope;
- (_Bool)hasPrivateMsgScope;
...
- (id)getBrandAppId;
- (id)genPhotoAccountShareNameCard:(id)arg1;
- (void)setBrandContactType:(unsigned int)arg1;
...
- (_Bool)isOpenImExpressKefuContact;
- (_Bool)isOpenImFinderShopTalentKefuContact;
