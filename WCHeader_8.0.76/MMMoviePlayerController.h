...
@class AVAsset, CMessageWrap, FavoritesItemDataField, ImageBrowseButton, MMProgressView, MMScrollView, MessageShareHelper, NSString, NSURL, UIImageView, UILabel, UIView, WCActionSheet, WCPlayerConfigControlView, WCPlayerView, WXFullScreenGestureRecognizer;
...
@interface MMMoviePlayerController
{
    ...
    NSString *_chatName;
    MessageShareHelper *_shareHelper;
    CMessageWrap *_originMsgWrap;
    FavoritesItemDataField *_originDataItem;
    struct UIEdgeInsets _pageContentInset;
}

+ (id)playerWithVideoMsg:(id)arg1 videoPath:(id)arg2 originMsgWrap:(id)arg3 originDataItem:(id)arg4;
- (void).cxx_destruct;
@property(retain, nonatomic) FavoritesItemDataField *originDataItem; // @synthesize originDataItem=_originDataItem;
@property(retain, nonatomic) CMessageWrap *originMsgWrap; // @synthesize originMsgWrap=_originMsgWrap;
@property(retain, nonatomic) MessageShareHelper *shareHelper; // @synthesize shareHelper=_shareHelper;
