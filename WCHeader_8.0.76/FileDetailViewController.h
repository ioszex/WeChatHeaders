...
@interface FileDetailViewController
{
    ...
    _Bool _isMultiTaskMinimizeTransition;
...
@property(nonatomic) _Bool isMultiTaskMinimizeTransition; // @synthesize isMultiTaskMinimizeTransition=_isMultiTaskMinimizeTransition;
...
- (void)fileDetailWebPreviewControllerLoadDidFail:(id)arg1;
- (void)fileDetailWebPreviewControllerLoadDidFinish:(id)arg1;
...
- (_Bool)isMultiContentWindowState;
...
- (void)OnReturn;
- (id)addActionSheetItem:(id)arg1 icon:(id)arg2 toArray:(id)arg3;
...
- (void)onEnterFilePreview:(_Bool)arg1;
- (id)commViewParams;
- (void)viewDidLoad;
