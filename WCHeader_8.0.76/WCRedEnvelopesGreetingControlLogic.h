...
- (void).cxx_destruct;
@property(nonatomic) _Bool ishkCashier; // @synthesize ishkCashier=_ishkCashier;
...
- (void)callPayFail;
- (void)handleGreetingRedEnvPaySuccessWithTransid:(id)arg1 fromWalletMix:(_Bool)arg2;
- (void)callPaySuccWithTransId:(id)arg1 fromWalletMix:(_Bool)arg2;
- (void)call:(id)arg1;
