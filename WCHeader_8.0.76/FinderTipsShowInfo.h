...
@property(retain, nonatomic) NSString *avatarInfoHash; // @dynamic avatarInfoHash;
...
@property(nonatomic) unsigned int exposeExpireTime; // @dynamic exposeExpireTime;
...
@property(nonatomic) unsigned int ignoreSameAvatarAvoidance; // @dynamic ignoreSameAvatarAvoidance;
@property(nonatomic) unsigned int ignoreTwoLinesAvoidance; // @dynamic ignoreTwoLinesAvoidance;
@property(nonatomic) _Bool isExemptNmControl; // @dynamic isExemptNmControl;
