...
@class MMLiteAppEncryptMetaData, MMLiteAppOpenParam, NSMutableArray, NSString, ResourceMeta;

@interface MMLiteAppDownloadItem : NSObject
{
    _Bool _isUseCronetDownload;
    _Bool _isPushResource;
    ...
    NSMutableArray *_fallbackMetaDataList;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *fallbackMetaDataList; // @synthesize fallbackMetaDataList=_fallbackMetaDataList;
...
@property(nonatomic) _Bool isPushResource; // @synthesize isPushResource=_isPushResource;
