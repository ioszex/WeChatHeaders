...
- (void)notifyDidFinishPickImageAssetInfos:(id)arg1 picker:(id)arg2;
- (_Bool)shouldInterruptForAssetsDurationCheckWithAssetInfos:(id)arg1;
- (_Bool)isFromFinderRedPackageEntryInNewMovieComposing;
- (_Bool)isFromFinderRedPackageEntryInOldMovieComposing;
...
- (void)showAlbumPickerForSingleImageSelectionWithEnterScene:(unsigned long long)arg1;
