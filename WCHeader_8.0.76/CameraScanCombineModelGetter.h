...
- (id)fetchXNetModelInfoFromUdrWithDetKey:(id)arg1 classifyKey:(id)arg2 modelConfigName:(id)arg3;
- (id)fetchXNetModelInfoFromUdr;
- (id)readLocalModelConfigForXNet;
- (id)readLocalTextModelConfigForXNet;
