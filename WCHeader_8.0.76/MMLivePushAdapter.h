...
@class MMLiveAudio3AParamConfig, MMLivePushMediaConfig, MMLivePushParams, MMLivePushReporterExtInfo, MMLiveVideoEncParam, NSArray, NSMutableDictionary, NSMutableSet, NSString, TRTCCloud, UIView;
...
- (void)stopMiniGamePkRender;
- (void)startMiniGamePkRender;
