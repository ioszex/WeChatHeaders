...
@class MMImageScrollViewHelper, NSArray, NSObject, NSRecursiveLock, NSString, UIImageView, WCCorePlayer, WCPipContentSourcePlayer, WCPlayerActionEvent, WCPlayerFairPlayResourceLoader, WCPlayerLayerView, WCPlayerPlayArgs, WCPlayerPlaybackInfo, WCPlayerPredicter, WCPlayerReporter, WCPlayerResourceLoader;
...
@interface WCPlayerView : UIScrollView
{
    ...
    double _dragStartPlaybackTime;
    WCPlayerActionEvent *_pendingSeekAction;
...
@property(nonatomic) _Bool hasCleared; // @synthesize hasCleared=_hasCleared;
...
@property(retain, nonatomic) WCPlayerActionEvent *pendingSeekAction; // @synthesize pendingSeekAction=_pendingSeekAction;
@property(nonatomic) double dragStartPlaybackTime; // @synthesize dragStartPlaybackTime=_dragStartPlaybackTime;
...
- (void)onRecieveLoadingRequestAfterSeek:(id)arg1;
...
- (void)reportWhenBufferEnd:(id)arg1;
...
- (void)finalizePendingSeekAction;
...
- (id)generatePipContentSourcePlayerWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (void)interruptPlay;
- (void)onScreenCapturedDidChange:(id)arg1;
