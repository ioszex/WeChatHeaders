...
@class InteractionLabel, MMHeadImageView, MMUIButton, NSString, RichTextView, TextStateItemView, UIButton, UILabel, UIView, UrlLabel, WCActionAreaVM, WCAdActionLinkDetailView, WCAdBreakFrameTagView, WCAdBreakFrameView, WCAdCommonBarContainerView, WCAdContinuousLikeTagView, WCAdHeadLivingView, WCAdHeadStateView, WCAdHighlightTagView, WCAdInteractionLabelView, WCAdInteractionTagView, WCAdPreviewMaskView, WCAdRandomPickCardContainerView, WCAdSocialLikeCheerPlayerView, WCAdSocialLikeView, WCAdStateSettingBarView, WCAdTagButton, WCAdWeGameGiftTagView, WCDataItem, WCEcsLogoNameView, WCMomentsAnimatedFireworksView, WCMomentsPageContext, WCMomentsSpringTextContainerView, WCMomentsWeAppLogoNameView, WCRichTextView, WCTimelineErrTipsView, WCTimelinePostTipsView;
...
@interface WCTimeLineCellView
{
    ...
    WCRichTextView *m_contentDescView;
...
+ (_Bool)canShowOperateButtonForDataItem:(id)arg1 pageContext:(id)arg2;
+ (double)maxActionAreaWidthForDataItem:(id)arg1 pageContext:(id)arg2;
+ (unsigned long long)actionAreaRowCount:(id)arg1 pageContext:(id)arg2 actionAreaVM:(id)arg3;
...
- (id)textViewForTranslatedState:(_Bool)arg1;
- (id)generateMenuItemsForView:(id)arg1;
- (id)menuItemsForTextView:(id)arg1;
- (void)onLongPressWithRichTextCoverView:(id)arg1 bubblePullType:(long long)arg2 textSelectType:(long long)arg3;
...
- (void)setupLocationView:(id)arg1 rightMostRect:(struct CGRect *)arg2 adjustTimeLabelWidth:(_Bool *)arg3;
...
- (void)hideTimelineTextStateView;
...
- (void)onStatusChange;
- (id)createTimelineCellTextStateView:(id)arg1;
- (Class)timelineCellTextStateViewClass;
