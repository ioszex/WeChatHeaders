...
@protocol WCFinderFeedFlowViewDataSource, WCFinderFeedFlowViewDelegate, WCFinderFeedFlowViewLayoutDelegate, WCFinderFeedFlowViewMonitorDelegate, WCFinderFeedFlowViewSelectionDelegate;
...
@interface WCFinderFeedFlowView : UIView
{
    ...
    id <WCFinderFeedFlowViewSelectionDelegate> _selectionDelegate;
    unsigned long long _consumerType;
    NSString *_emptyTipsText;
    NSString *_noMoreDataTipsText;
...
+ (id)flowLayoutFeedFlowView:(struct CGRect)arg1;
...
@property(retain, nonatomic) NSIndexPath *appendedIndexPath; // @synthesize appendedIndexPath=_appendedIndexPath;
...
@property(retain, nonatomic) NSString *noMoreDataTipsText; // @synthesize noMoreDataTipsText=_noMoreDataTipsText;
...
@property(nonatomic) __weak id <WCFinderFeedFlowViewSelectionDelegate> selectionDelegate; // @synthesize selectionDelegate=_selectionDelegate;
...
- (void)setAllItemsSelected:(_Bool)arg1;
- (id)selectableContentVMAtIndexPath:(id)arg1;
- (void)setSelectedItems:(id)arg1 selected:(_Bool)arg2;
- (id)getSelectedItems;
- (_Bool)onSelectItem:(id)arg1 selected:(_Bool)arg2;
- (void)updateSelectedItems:(id)arg1 selected:(_Bool)arg2;
- (id)selectedItems;
- (_Bool)isContentVMSelected:(id)arg1;
...
- (void)onClickMutiSelectedAction:(id)arg1;
...
- (void)setOuterGestureRecognizer:(id)arg1;
...
- (id)getFullyExposedPlayUnits:(id)arg1 ctx:(id)arg2 filterBlock:(CDUnknownBlockType)arg3;
- (id)filterValidPlayUnits:(id)arg1;
- (void);
- (void)calculateVerticalUnitsWithHorizontalScroll:(id)arg1;
- (void)calculateExposureAndIndexPaths:(id)arg1 autoPlayMode:(unsigned long long)arg2;
- (void)calculateWithFallbackExposeRatio:(id)arg1 autoPlayMode:(unsigned long long)arg2;
- (void)fallbackCalculateIfNeeded:(id)arg1 autoPlayMode:(unsigned long long)arg2;
- (void)createDoubleColumnUnit:(id)arg1 section:(unsigned long long)arg2 sectionVM:(id)arg3 cell:(id)arg4;
- (void)createAggregationTabUnit:(id)arg1 section:(unsigned long long)arg2 sectionVM:(id)arg3 cell:(id)arg4 aggregationAdapters:(id)arg5 autoPlayMode:(unsigned long long)arg6;
- (void)createSpecialColumnUnit:(id)arg1 section:(unsigned long long)arg2 sectionVM:(id)arg3 cell:(id)arg4 horizontalScrollViews:(id)arg5;
- (void)createBannerUnit:(id)arg1 section:(unsigned long long)arg2 sectionVM:(id)arg3 cell:(id)arg4 horizontalScrollViews:(id)arg5;
- (id)createPlayUnits:(id)arg1 sectionVMs:(id)arg2 horizontalScrollViews:(id)arg3 aggregationAdapters:(id)arg4 autoPlayMode:(unsigned long long)arg5;
- (id)filterAndSortVisibleIndexPaths:(id)arg1 filterBlock:(CDUnknownBlockType)arg2;
- (id)getFullyExposedPlayUnits:(id)arg1 horizontalScrollViews:(id)arg2 aggregationAdapters:(id)arg3 autoPlayMode:(unsigned long long)arg4 filterBlock:(CDUnknownBlockType)arg5;
- (_Bool)isAutoPlayValid:(id)arg1;
- (_Bool)isStreamCellExposed:(id)arg1 exposeRatio:(double)arg2;
- (_Bool)isStreamCellFullExpose:(id)arg1;
- (void)GetStreamAutoPlayDoubleRowIndexPaths:(id *)arg1 firstRowRight:(id *)arg2 secondRowLeft:(id *)arg3 secondRowRight:(id *)arg4 firstRowExposeRatio:(double)arg5 secondRowExposeRatio:(double)arg6 filterBlock:(CDUnknownBlockType)arg7;
- (void)GetStreamAutoPlayFirstRowIndexPaths:(id *)arg1 rightIndexPath:(id *)arg2 exposeRatio:(double)arg3 filterBlock:(CDUnknownBlockType)arg4;
