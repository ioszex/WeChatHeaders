...
@class MMLiveManger, MMWeEffectManager, NSArray, NSMutableArray, NSNumber, NSString, NSURLSessionDownloadTask, TXLivePusherContainerView, V2TXLivePusherJSAdapter;
...
@interface TXLivePushJSAdapter : NSObject
{
    ...
    TXLivePusherContainerView *_previewView;
    NSString *_appId;
...
@property(retain, nonatomic) TXLivePusherContainerView *previewView; // @synthesize previewView=_previewView;
...
- (id)initLivePusherWithId:(unsigned int)arg1 configs:(id)arg2 preview:(id)arg3 appId:(id)arg4 useSkyline:(_Bool)arg5 delegate:(id)arg6;
- (void)initTorchState;
