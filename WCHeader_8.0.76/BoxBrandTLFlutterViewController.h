...
@class BTLFinderLiveTexturePlugin, BoxBrandTimelineReportLogic, BrandTLExptConfig, CMessageWrap, FlutterBrandTLApiImplementation, MusicCallbackApi, NSString;

@interface BoxBrandTLFlutterViewController
{
    _Bool isShowRedDotInMainFrameSession;
    _Bool _hasViewWillBePushedOnce;
    _Bool _hasColdLaunched;
    _Bool _didAppear;
    _Bool _canShowPersonalCenter;
    _Bool _enableAd;
    _Bool _enableBrandService;
    _Bool _isExitingForUpdatedSettings;
    ...
    BoxBrandTimelineReportLogic *_reportLogic;
    MusicCallbackApi *_flutterMusicPlayerCallBack;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isExitingForUpdatedSettings; // @synthesize isExitingForUpdatedSettings=_isExitingForUpdatedSettings;
...
@property(nonatomic) _Bool hasColdLaunched; // @synthesize hasColdLaunched=_hasColdLaunched;
@property(nonatomic) _Bool hasViewWillBePushedOnce; // @synthesize hasViewWillBePushedOnce=_hasViewWillBePushedOnce;
@property(retain, nonatomic) BoxBrandTimelineReportLogic *reportLogic; // @synthesize reportLogic=_reportLogic;
...
- (void)_tryExitForUpdatedSettings;
- (void)onBoxShouldExitForUpdatedSettings;
...
- (id)generateSessionParamsIdIfNeed;
