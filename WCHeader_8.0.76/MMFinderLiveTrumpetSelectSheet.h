...
{
    _Bool _fromConnectMicApply;
    _Bool _isCreatingIdentity;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isCreatingIdentity; // @synthesize isCreatingIdentity=_isCreatingIdentity;
...
@property(nonatomic) _Bool fromConnectMicApply; // @synthesize fromConnectMicApply=_fromConnectMicApply;
...
- (void)doDeleteTrumpetAccount;
- (void)deleteTrumpetAccount;
- (void)editTrumpetAccount;
- (void)onClickMMFinderLiveTrumpetSelectCellEditSubtitle:(id)arg1;
- (double)tableWidth;
- (double)privacyTableCellHeight;
- (double)finderIdentityCellHeight;
- (double)tableCellHeight;
- (id)liveTask;
- (id)genericLiveWordingForType:(int)arg1;
