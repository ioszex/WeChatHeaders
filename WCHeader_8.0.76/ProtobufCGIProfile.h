...
@interface ProtobufCGIProfile : NSObject
{
    ...
    NSString *_netLabel;
    unsigned long long _startTaskTick;
    unsigned long long _startTaskTimeStamp;
    unsigned long long _endTaskTick;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long endTaskTick; // @synthesize endTaskTick=_endTaskTick;
@property(nonatomic) unsigned long long startTaskTimeStamp; // @synthesize startTaskTimeStamp=_startTaskTimeStamp;
@property(nonatomic) unsigned long long startTaskTick; // @synthesize startTaskTick=_startTaskTick;
...
- (id)initWithPayCGIProfile:(const void *)arg1;
