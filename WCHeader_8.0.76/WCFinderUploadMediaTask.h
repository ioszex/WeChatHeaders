...
@class FinderLivePhotoMediaInfo, FinderMediaCodecInfo, NSString, WCFinderFullScreenEditRectModel;
...
@interface WCFinderUploadMediaTask : NSObject
{
    ...
    FinderLivePhotoMediaInfo *_livePhotoVideoInfo;
}

+ (id)extractClientIDFromCDNKey:(id)arg1;
+ (void)initialize;
+ (void)PBArrayAdd_livePhotoVideoInfo;
+ (void)PBArrayAdd_ratio;
+ (void)PBArrayAdd_editRectModel;
+ (void)PBArrayAdd_endUploadcdnTimestampMs;
+ (void)PBArrayAdd_startUploadcdnTimestampMs;
+ (void)PBArrayAdd_requestHeader;
+ (void)PBArrayAdd_uploadFullThumbURL;
+ (void)PBArrayAdd_uploadHalfMediaURL;
+ (void)PBArrayAdd_halfBitrate;
+ (void)PBArrayAdd_halfFileSize;
+ (void)PBArrayAdd_halfHeight;
+ (void)PBArrayAdd_halfWidth;
+ (void)PBArrayAdd_halfScreenMediaMd5;
+ (void)PBArrayAdd_halfScreenMediaUrl;
+ (void)PBArrayAdd_fullScreenThumbMd5;
+ (void)PBArrayAdd_fullScreenThumbUrl;
+ (void)PBArrayAdd_patMusicUrl;
+ (void)PBArrayAdd_dynamicRangeType;
+ (void)PBArrayAdd_videoType;
+ (void)PBArrayAdd_coverShowStyle;
+ (void)PBArrayAdd_uploadCDNType;
...
- (void).cxx_destruct;
@property(retain, nonatomic) FinderLivePhotoMediaInfo *livePhotoVideoInfo; // @synthesize livePhotoVideoInfo=_livePhotoVideoInfo;
...
@property(nonatomic) long long uploadCDNIndex; // @synthesize uploadCDNIndex=_uploadCDNIndex;
...
- (void)fillMediaInfoFromServerMedia:(id)arg1;
@property(readonly, copy) NSString *description;
- (id)uploadCDNKey;
- (id)initWithUploadIndex:(long long)arg1;
- (id)init;
- (id)getPBPropertyTable;
- (_Bool)isLivePhotoWithVideoTask;
- (_Bool)isLivePhotoVideoTask;
- (id)genUploadLivePhotoMediaInfo;
- (void)updateWithLivePhotoMediaInfo:(id)arg1;
