...
@class FinderLiveRewardGiftExtInfo, MISSING_TYPE, MMFinderLiveCommomQueue, MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMLiveRewardGiftSelectionView, MMLiveRewardQuotaSheetView, NSData, NSMutableDictionary, NSString, WCFinderContact;
...
@interface MMFinderLiveRewardSendingLogic : NSObject
{
    ...
    MISSING_TYPE *_lastComboGiftCount;
...
- (void)chargeCoinWithFromPage:(id)arg1 rechargeScene:(unsigned int)arg2 diffWecoinCount:(unsigned int)arg3;
...
- (void)onBuyCoinAfterGetBalance:(id)arg1 rechargeScene:(unsigned int)arg2 consumeCoinCount:(unsigned int)arg3;
- (void)onBuyCoin:(id)arg1 rechargeScene:(unsigned int)arg2;
- (void)onNeedBuyCoin:(id)arg1 currentBalance:(long long)arg2 consumeCoinCount:(unsigned int)arg3;
...
- (id)openNewRewardGiftSelectionView:(_Bool)arg1 preferredGiftId:(id)arg2 preferredGiftUnlockType:(unsigned int)arg3 sendingHint:(id)arg4 viewDelegate:(id)arg5;
