...
@class FinderLocation, MMUIViewController, NSMutableDictionary, NSMutableSet, NSString;
...
@property(retain, nonatomic) NSMutableSet *resumingCompositionTaskIds; // @synthesize resumingCompositionTaskIds=_resumingCompositionTaskIds;
...
@property(nonatomic) __weak id <WCFinderPostEditEntrySnsProtocol> postDelegate; // @synthesize postDelegate=_postDelegate;
...
- (void)resumeDeferredCompositionTask:(id)arg1 forDataItem:(id)arg2;
- (_Bool)registerDeferredDirectUploadCompositionTaskWithCompletion:(CDUnknownBlockType)arg1 postSession:(id)arg2;
- (_Bool)isDeferredDirectUploadCompositionTask:(id)arg1;
- (void)discardCompositionTaskForDirectUpload:(id)arg1 fromPostSession:(id)arg2;
- (void)fillActualOutputMetrics:(id)arg1 asset:(id)arg2;
- (unsigned long long)actualCodecFromVideoTrack:(id)arg1;
- (id)postCompressMetricsWithFinderTask:(id)arg1 success:(_Bool)arg2 error:(id)arg3;
- (unsigned long long)postCompressEncoderTypeFromTargetType:(unsigned long long)arg1;
- (unsigned long long)postCompressCodecFromTargetCodec:(unsigned long long)arg1;
