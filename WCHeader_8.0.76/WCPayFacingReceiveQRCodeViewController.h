...
@interface WCPayFacingReceiveQRCodeViewController
{
    ...
    _Bool _bNeedRemoveOfficialReddotFromOtherView;
    ...
    UIImageView *_officialReddotImgView;
    MMUILabel *_officialReddotTitleLabel;
    UIView *_officialReddotDotView;
    ...
    UIView *_mOfficialCodeEntranceView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UIView *mOfficialCodeEntranceView; // @synthesize mOfficialCodeEntranceView=_mOfficialCodeEntranceView;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: mchCodeContentMaskView
...
@property(retain, nonatomic) UIView *officialReddotDotView; // @synthesize officialReddotDotView=_officialReddotDotView;
@property(retain, nonatomic) MMUILabel *officialReddotTitleLabel; // @synthesize officialReddotTitleLabel=_officialReddotTitleLabel;
@property(retain, nonatomic) UIImageView *officialReddotImgView; // @synthesize officialReddotImgView=_officialReddotImgView;
@property(nonatomic) _Bool bNeedRemoveOfficialReddotFromOtherView; // @synthesize bNeedRemoveOfficialReddotFromOtherView=_bNeedRemoveOfficialReddotFromOtherView;
...
- (_Bool)isShowPersonalReceiptSettingSheet;
- (_Bool)isShowReceiptSettingSheet;
...
- (void)ClickOfficialCoeEntrance;
- (void)setupOfficialCodeEntrance;
