...
@interface MMAssetPickerSlider
{
    ...
    _Bool _isThumbViewActive;
    _Bool _isHiddenSliderTopMask;
    double _value;
    double _topMaskOffset;
...
@property(nonatomic) _Bool isThumbViewActive; // @synthesize isThumbViewActive=_isThumbViewActive;
...
@property(nonatomic) double topMaskOffset; // @synthesize topMaskOffset=_topMaskOffset;
...
- (void)setBackgroundLayerHidden:(_Bool)arg1;
...
- (void)updateFrame:(struct CGRect)arg1 thumbViewEdgeInset:(struct UIEdgeInsets)arg2 preservedThumbScreenCenter:(struct CGPoint)arg3;
- (void)updateFrame:(struct CGRect)arg1 thumbViewEdgeInset:(struct UIEdgeInsets)arg2;
- (struct CGPoint)thumbScreenCenter;
