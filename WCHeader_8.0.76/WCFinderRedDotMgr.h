...
@interface WCFinderRedDotMgr
{
    ...
    double _lastPreloadAvatarTime;
}

+ (id)getShouldClearTimelineRedDotPath:(id)arg1;
+ (id)buildPureRedDotCtrlInfoFromPath:(id)arg1 businessType:(unsigned long long)arg2;
+ (void)buildPostFailTipsRedDotFromFeedId:(id)arg1;
...
+ (void)buildScanEntranceRedDotWithWording:(id)arg1;
+ (id)mockScanEntranceShowInfoWithWording:(id)arg1;
...
+ (void)addFinderEntranceIgnoreRedDotByTitle:(id)arg1;
+ (id)mockEntanceShowInfo:(id)arg1;
+ (id)mockEntanceShowInfo;
+ (_Bool)finderRedDotCurrentHasEarphone;
+ (unsigned int)finderRedDotCurrentEarphoneType;
+ (unsigned int)finderRedDotCurrentAudioMode;
+ (unsigned int)finderRedDotCurrentVolume;
+ (int)finderRedDotCurrentBatteryLevel;
+ (_Bool)finderRedDotCurrentIsWifi;
+ (unsigned int)finderRedDotCurrentNetworkType;
- (void).cxx_destruct;
@property(nonatomic) double lastPreloadAvatarTime; // @synthesize lastPreloadAvatarTime=_lastPreloadAvatarTime;
...
- (id)existsCtrlInfoWithSamePaths:(id)arg1;
...
- (id)_innerCtrlInfoAtPath:(id)arg1;
...
- (id)getLastShowCtrlInfoBy:(id)arg1;
...
- (void)targetRedDotShowInfoExpired:(id)arg1 expiredCtrlInfoArray:(id)arg2;
