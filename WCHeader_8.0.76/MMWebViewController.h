...
@interface MMWebViewController
{
    ...
    _Bool _m_bIsSkipNavInteractiveGesture;
    _Bool _reportInstantly;
    _Bool _isPreloadEnded;
    _Bool _isMenuShowAiSearch;
    _Bool _isMediaPlaybackPlaying;
    _Bool _useLimitedMenu;
    ...
    _Bool _canShowPublicImageEntry;
...
+ (_Bool)isBizProfileSwipeFeatureEnabled;
...
@property(nonatomic) double curTopInset; // @synthesize curTopInset=_curTopInset;
@property(nonatomic) _Bool canShowPublicImageEntry; // @synthesize canShowPublicImageEntry=_canShowPublicImageEntry;
...
@property(copy, nonatomic) NSString *pageRestoreKey; // @synthesize pageRestoreKey=_pageRestoreKey;
...
@property(nonatomic) _Bool useLimitedMenu; // @synthesize useLimitedMenu=_useLimitedMenu;
@property(nonatomic) _Bool isMediaPlaybackPlaying; // @synthesize isMediaPlaybackPlaying=_isMediaPlaybackPlaying;
@property(retain, nonatomic) NSString *entranceGMsgID; // @synthesize entranceGMsgID=_entranceGMsgID;
@property(nonatomic) _Bool isMenuShowAiSearch; // @synthesize isMenuShowAiSearch=_isMenuShowAiSearch;
...
@property(nonatomic) _Bool m_bIsSkipNavInteractiveGesture; // @synthesize m_bIsSkipNavInteractiveGesture=_m_bIsSkipNavInteractiveGesture;
...
- (void)whitelistJSAPI:(id)arg1 forFilePatterns:(id)arg2;
- (void)onAlertJumpToApp;
- (void)onCancelJumpToApp;
- (void)onJumpToAppStoreWithUrl:(id)arg1;
- (void)onJumpToAppWithUrl:(id)arg1 isUniversalLink:(_Bool)arg2;
- (void)onCreateScreenShotInfo:(id *)arg1;
- (void)getTokenWithAdUrl:(id)arg1 posId:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)isAllowAboutSrcdoc;
- (_Bool)isAllowAboutBlankPage;
...
- (id)a8keyProfileUserNameForLogicImpl:(id)arg1;
...
- (void)handleAdScriptMessage:(id)arg1;
...
- (void)doLineBreak:(id)arg1;
- (_Bool)isEnableLineBreak;
...
- (void)reportTranslateEvent:(id)arg1;
- (void)webviewBuildMenuWithBuilder:(id)arg1;
...
- (void)askXiaoweiWithBizArticle:(id)arg1;
...
- (void)openFastLoadWebVCWithUrl:(id)arg1;
...
- (void)readArticle;
- (unsigned int)mpSceneFromUrl:(id)arg1;
- (void)onAddToListenLaterSucceedForItem:(id)arg1;
...
- (_Bool)shouldShowScheduleButton;
...
@property(nonatomic) long long voteStatus;
...
- (id)logStringForMenuItemClickAndExposeWithOpType:(unsigned long long)arg1 logId:(unsigned long long)arg2 positionX:(unsigned long long)arg3 positionY:(unsigned long long)arg4;
- (void)logFeature35108WithOpType:(unsigned long long)arg1 positionX:(unsigned long long)arg2 positionY:(unsigned long long)arg3;
- (void)logFeature35108WithOpType:(unsigned long long)arg1;
...
- (unsigned long long)findItemIndex:(id)arg1;
- (id)setupRow1;
...
- (void)showBizCustomSharePanel:(unsigned long long)arg1;
- (_Bool)shouldShowBizCustomSharePanel;
...
- (void)addScheduleButtonWithArrary:(id)arg1;
- (void)addReadArticleButtonWithArrary:(id)arg1;
- (void)addReadLaterArticleButtonWithArrary:(id)arg1;
- (void)addMiniWindowWithArray:(id)arg1;
- (void)addAskAIAsstButtonWithArray:(id)arg1;
...
- (_Bool)checkCanShareToQQBrowser;
- (_Bool)checkCanShareToQQ;
- (_Bool)checkCanShareToWeRead;
- (_Bool)shouldShowNewFontButton;
...
- (void)addSearchButtonWithArray:(id)arg1;
- (void)addNoteButtonWithArray:(id)arg1;
- (void)addAskXiaoweiButtonWithArray:(id)arg1;
- (void)addFavouriteButtonWithArray:(id)arg1;
- (void)addUnderlineButtonWithArray:(id)arg1;
- (void)addRecentReadButtonWithArray:(id)arg1;
...
- (void)clickOnOpenOtherAppWithoutSheetView;
- (void)sendToDevice;
- (void)shareWithEmail;
- (void)shareToWeWork;
- (void)addToMiniWindowFromItem:(id)arg1;
...
- (void)addToNoteWithUrl:(id)arg1 title:(id)arg2 desc:(id)arg3 imageUrl:(id)arg4;
...
- (void)menu_willWebViewDisappear;
- (void)menu_didWebViewAppear;
- (id)scheduleRemindLogic;
- (id)genReportParams;
...
- (void)bizProfileSwipeTransitionDidEndWithComplete:(_Bool)arg1;
- (void)bizProfileSwipeTransitionWillBegin;
- (id)bizProfileSwipeParallaxContentView;
- (id)bizProfileSwipeDestinationViewController;
- (_Bool)bizProfileSwipeShouldTakeOverNow;
- (_Bool)bizProfileSwipeShouldBeginWithLocation:(struct CGPoint)arg1;
- (void)handleBizProfileSwipeTouchResultForSeq:(long long)arg1 shouldRespond:(_Bool)arg2;
- (void)bizProfileSwipeDidTouchUp;
- (void)bizProfileSwipeDidTouchDownAtLocation:(struct CGPoint)arg1;
- (id)bizProfileSwipePublisherParam;
- (_Bool)isBizProfileSwipeUrlMatched;
- (void)setupBizProfileSwipeGestureIfNeeded;
- (void)setBizProfileSwipeNegotiationState:(id)arg1;
- (id)bizProfileSwipeNegotiationState;
- (void)setBizProfileSwipeCoordinator:(id)arg1;
- (id)bizProfileSwipeCoordinator;
- (void)mm_resumeScreenCaptureProtection;
- (void)mm_suspendScreenCaptureProtection;
- (void)restoreScreenCaptureProtectionIfNeeded;
- (_Bool)suspendScreenCaptureProtectionUntilVisible;
- (void)disableScreenCaptureProtection;
- (void)enableScreenCaptureProtectionWithParameter:(id)arg1;
- (void)mm_setPendingScreenCaptureProtectionParameter:(id)arg1;
- (id)mm_pendingScreenCaptureProtectionParameter;
- (void)mm_setSuspendedUntilVisible:(_Bool)arg1;
- (_Bool)mm_isSuspendedUntilVisible;
- (void)mm_setShouldRestoreScreenCaptureProtection:(_Bool)arg1;
- (_Bool)mm_shouldRestoreScreenCaptureProtection;
@property(retain, nonatomic) WCBrandScreenCaptureProtectionView *screenCaptureProtectionView;
...
- (void)onLongImagePreviewActionSaveImage:(id)arg1 image:(id)arg2 isSucc:(_Bool)arg3 localIdentifiers:(id)arg4 error:(id)arg5;
...
- (void)takeFullSnapshotForbidLoading:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)takeFullSnapshotWithCompletion:(CDUnknownBlockType)arg1;
- (void)setIsForbidLoadingOnSnapshot:(_Bool)arg1;
- (_Bool)isForbidLoadingOnSnapshot;
- (void)setTakeSnapshotCompletion:(CDUnknownBlockType)arg1;
- (CDUnknownBlockType)takeSnapshotCompletion;
...
- (void)tryRecoverMultiContentFloatingIfNeeded;
- (_Bool)isCurrentlyMinimizedToMultiContent;
...
- (void)addWebToStarWithMinimizeType:(unsigned int)arg1;
- (void)miniMizeAniWithDeleLay:(double)arg1 animated:(_Bool)arg2 minimizeType:(unsigned int)arg3 needAdd:(_Bool)arg4;
...
- (_Bool)navigationController:(id)arg1 needAddBackButtonForViewController:(id)arg2;
- (void)relayoutHangTipsBar;
- (double)_getNormalTopInset;
- (void)_notifyFakeImmersiveUIStyleTopInsetChanged:(double)arg1;
- (void)relayoutTopBar;
- (void)onClickClose;
- (void)onClickLink;
...
- (_Bool)isCurrentWindowedWebViewController;
...
- (void)switchPublishImageEntry:(_Bool)arg1;
