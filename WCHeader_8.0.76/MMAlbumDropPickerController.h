...
@class ColorGradientView, MMTableView, MMUIActivityIndicatorView, MMUIView, MMUIViewController, NSArray, NSString, UIView;
...
@interface MMAlbumDropPickerController : NSObject
{
    ...
    MMUIView *_blurView;
    ColorGradientView *_shadowImageView;
...
@property(retain, nonatomic) ColorGradientView *shadowImageView; // @synthesize shadowImageView=_shadowImageView;
...
@property(nonatomic) _Bool isShowAlbumList; // @synthesize isShowAlbumList=_isShowAlbumList;
...
- (void)updateShadowImageViewVisibility;
