...
- (void)collectNormalDataInList:(id)arg1 inFavItem:(id)arg2;
- (void)collectThumbDataInList:(id)arg1 inFavItem:(id)arg2;
- (void)collectHtmlDataInList:(id)arg1 inFavItem:(id)arg2;
