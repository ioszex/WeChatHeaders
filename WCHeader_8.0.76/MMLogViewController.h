...
@interface MMLogViewController
{
    ...
    double _routeStartTime;
    double _routeEndTime;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool hasRouteTimeRange; // @synthesize hasRouteTimeRange=_hasRouteTimeRange;
@property(nonatomic) double routeEndTime; // @synthesize routeEndTime=_routeEndTime;
@property(nonatomic) double routeStartTime; // @synthesize routeStartTime=_routeStartTime;
...
- (void)initDates;
- (void)initLists;
- (void)applyRouteTimeRange;
- (_Bool)setUploadTimeRangeWithStartTime:(double)arg1 endTime:(double)arg2;
