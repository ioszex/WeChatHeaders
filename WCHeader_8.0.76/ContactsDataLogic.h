...
@class ContactsDataMessageSearchLogic, FTSMultiContactSearchLogic, FTSTopHitMgr, MMTimer, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, WCSTokenPickLogic, WCSmartGroupCore;
...
@interface ContactsDataLogic
{
    ...
    ContactsDataMessageSearchLogic *_messageSearchLogic;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool contactSearchDidFinish; // @synthesize contactSearchDidFinish=_contactSearchDidFinish;
@property(retain, nonatomic) ContactsDataMessageSearchLogic *messageSearchLogic; // @synthesize messageSearchLogic=_messageSearchLogic;
...
@property(nonatomic) _Bool bEnableMessageSearch; // @synthesize bEnableMessageSearch=_bEnableMessageSearch;
...
- (void)contactsDataMessageSearchLogicDidUpdateTokenResult:(id)arg1;
- (void)contactsDataMessageSearchLogicDidUpdateQueryResult:(id)arg1;
- (_Bool)contactsDataMessageSearchLogic:(id)arg1 shouldIncludeContact:(id)arg2;
...
- (void)onAddContactBlack:(id)arg1;
...
- (void)filterOnlyBrandContactContact:(id)arg1 brandType:(unsigned long long)arg2;
