...
@class EmoticonBoardView, ImageSelectorController, MMGrowTextView, MMUIButton, MMUILabel, NSString, RichTextView, SightDraft, UIButton, UIImageView, UILabel, UIView, WCDragableSelectorView, WCFinderDataItem, WCFinderHeadImageView, WCFinderMaskButton, WCFinderSizingRichTextView, WCInputController, WCTableViewManager;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: emoticonBoardView
