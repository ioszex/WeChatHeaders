...
@class CAAnimationGroup, CABasicAnimation, CameraOpButtonWrapView, CameraScanCodesCenterDotView, CameraScanCombineContentView, CameraScanEnergyInfoView, CameraScannerViewWrapper, ImageFitWithBlurredBackgroundView, MMUIButton, NSMutableArray, NSString, UIImageView, UILabel, UIView;
...
@interface CameraScanCodesContentView
{
    ...
    _Bool _isEnableAskAI;
    _Bool _isUseSmallCropArea;
    _Bool _isMultiCodes;
    CameraOpButtonWrapView *_mixedMyQRWrapView;
    ...
    CameraScanEnergyInfoView *_energyInfoView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) CameraScanEnergyInfoView *energyInfoView; // @synthesize energyInfoView=_energyInfoView;
...
@property(nonatomic) _Bool isEnableAskAI; // @synthesize isEnableAskAI=_isEnableAskAI;
...
@property(retain, nonatomic) CameraOpButtonWrapView *mixedMyQRWrapView; // @synthesize mixedMyQRWrapView=_mixedMyQRWrapView;
- (void)resetEnergyInfo;
- (void)updateEnergyInfoWithLiveData:(id)arg1;
...
- (void)startLoadingDotAnimationWithTitle:(id)arg1;
...
- (id)centerTabTitle;
- (void)setupSubViews;
- (id)initWithIsUseSmallCropArea:(_Bool)arg1 bShowMyQRCode:(_Bool)arg2 bEnableCombineTab:(_Bool)arg3 bEnableAskAi:(_Bool)arg4 mixedSwitchValue:(unsigned long long)arg5;
