...
@class EmoticonCustomCreateLogic, MMFinderHandOffItem, MMScrollViewProxy, MMTimer, NSIndexPath, NSMutableDictionary, NSMutableSet, NSNumber, NSString, UIImage, UIImageView, UILabel, UITableView, UITableViewCell, UIViewController, WCFinderAnimationLoadingView, WCFinderFeedAudioHelper, WCFinderFeedFriendsLikeListBaseViewController, WCFinderFeedLiveCardFastSlipLogic, WCFinderFullMultiMediaTableViewCell, WCFinderLandscapeReportInfo, WCFinderPagingTableVoiceOverHelper, WCFinderPlayRateOperationView, WCFinderPlayRateSelectPanelView, WCFinderPlaybackSpeedView, WCFinderPostMgr, WCFinderPullDownRefreshHeaderView, WCFinderRefreshTableFooterView, WCFinderScrollActionSheet, WCFinderTopPullStatusView, _TtC6WeChat25WCFinderFeedFastSlipLogic;
...
- (void)_showProfileWithContentVM:(id)arg1 username:(id)arg2 avatarType:(unsigned long long)arg3;
- (void)_complainFeedWithContentVM:(id)arg1;
- (void)performActionWithContentVM:(id)arg1 actionParams:(id)arg2;
...
- (void)commentDetailViewController:(id)arg1 didInsertPostCommentWithTid:(id)arg2;
...
- (id)finderFeedbackCustomQuery:(id)arg1;
...
- (void)onClickThankForShareButtonWithThank:(_Bool)arg1;
...
- (void)showCommentListWithContentVM:(id)arg1 shouldEnterKeyBoard:(_Bool)arg2 enterParams:(id)arg3 commentAction:(unsigned long long)arg4 enterType:(unsigned long long)arg5 appendCommentModel:(id)arg6;
- (_Bool)forceCloseCommentListView;
...
- (_Bool)multiMediaCellDisableSetRate:(id)arg1 contentVM:(id)arg2;
...
- (_Bool)_isCurrentVCVisibleOnScreen;
...
@property(readonly, nonatomic) struct CGPoint headerViewOrigin;
...
- (void)finderFeedListViewResumeCurrentFeedPlay;
...
- (void)tryUpdateNavigationBarHidden:(_Bool)arg1;
...
- (void)updateFriendHighEntropyDetailExposeEndTypeWithTargetIndexPath:(id)arg1;
- (int)currentFriendHighEntropyDetailExposeEndType;
- (void)clearFriendHighEntropyDetailExposeEndType;
- (void)markFriendHighEntropyDetailExposeEndTypeIfNeeded:(int)arg1;
- (void)markFriendHighEntropyDetailExposeEndType:(int)arg1;
- (id)currentFriendHighEntropyDetailTempModel;
- (_Bool)isFriendHighEntropyDetailScene;
- (id)finderFetchTransitionInnerScrollView;
- (id)fetchCurrentPlayDataItemThenPause:(double *)arg1;
- (void)minimizeOnFocusChangedWithContentTid:(id)arg1;
...
- (_Bool)shouldMinimizeImediatelyWhenPageClose:(id)arg1;
...
- (void)_updateNavigationItemWithViewWithDisplay:(_Bool)arg1;
