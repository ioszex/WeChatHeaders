...
@class AudioRecorderUserData, NSMutableArray, NSMutableString, NSString, ReportVoiceResultMgr;
...
@interface MMNewVoiceInputReportObj : NSObject
{
    ...
    NSString *_voiceSessionid;
    NSString *_lastTransSnapshot;
...
@property(copy, nonatomic) NSString *lastTransSnapshot; // @synthesize lastTransSnapshot=_lastTransSnapshot;
@property(retain, nonatomic) NSString *voiceSessionid; // @synthesize voiceSessionid=_voiceSessionid;
...
- (void)checkModifyWithCurrentText:(id)arg1;
- (void)onTransEndWithText:(id)arg1;
