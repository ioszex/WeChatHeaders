...
- (void)windowMinimizedCurTaskWithGenerateType:(unsigned long long)arg1 completion:(void (^)(_Bool))arg2;
- (_Bool)windowMinimizedCurTaskWithGenerateType:(unsigned long long)arg1;
- (void)manuallyMinimizedCurTaskWithGenerateType:(unsigned long long)arg1 completion:(void (^)(_Bool))arg2;
