...
@protocol MMLiveManagerCaptureDelegate, MMLiveManagerMetricsDelegate, MMLiveMangerPusherDelegate, OS_dispatch_queue;
...
@interface MMLiveManger : NSObject
{
    ...
    _Bool _miniGamePkRenderRunning;
    ...
    NSObject<OS_dispatch_queue> *_miniGamePkRenderQueue;
...
@property _Bool miniGamePkRenderRunning; // @synthesize miniGamePkRenderRunning=_miniGamePkRenderRunning;
@property(retain) NSObject<OS_dispatch_queue> *miniGamePkRenderQueue; // @synthesize miniGamePkRenderQueue=_miniGamePkRenderQueue;
...
@property(retain) CIContext *cropProcessContext; // @synthesize cropProcessContext=_cropProcessContext;
...
- (void)renderMiniGamePkVideoData:(struct __CVBuffer *)arg1;
...
- (struct CGSize)getCaptureVideoSizeWithCroped;
- (struct CGSize)getCaptureVideoSize;
- (void)updateVideoAspectRatio21_10:(_Bool)arg1;
...
- (void)notifyOutputInitialSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;
- (void)sendVideoData:(struct opaqueCMSampleBuffer *)arg1 shouldReportCaptureMetrics:(_Bool)arg2;
- (struct opaqueCMSampleBuffer *)cropSampleFrame:(struct opaqueCMSampleBuffer *)arg1;
- (_Bool)createCropPixelBufferIfNeed:(unsigned int)arg1;
- (_Bool)cropPixelBuffer:(struct __CVBuffer *)arg1 outPixelBuffer:(struct __CVBuffer *)arg2;
