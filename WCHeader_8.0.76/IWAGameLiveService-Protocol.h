...
+ (void)stopMiniGamePkWithLiveId:(unsigned long long)arg1 callback:(void (^)(_Bool, NSString *))arg2;
+ (void)notifyGameFirstFrameForPk:(NSString *)arg1;
+ (void)onCaptureStatusChange:(unsigned long long)arg1;
+ (void)openMiniGameForPk:(NSString *)arg1 path:(NSString *)arg2 scene:(unsigned long long)arg3 sceneNote:(NSString *)arg4;
+ (void)stopMiniGameMediaCapture:(unsigned long long)arg1 appId:(NSString *)arg2;
+ (_Bool)startMiniGameMediaCapture:(unsigned long long)arg1 appId:(NSString *)arg2 path:(NSString *)arg3 scene:(unsigned long long)arg4 sceneNote:(NSString *)arg5;
...
+ (_Bool)minimize;
+ (void)notifyOpenMiniGame:(NSString *)arg1 versionType:(unsigned long long)arg2 scene:(unsigned int)arg3;
+ (_Bool)isMiniGamePkingForAppId:(NSString *)arg1;
