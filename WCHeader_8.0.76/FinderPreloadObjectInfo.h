...
@class FinderPreloadObjectLutConfig, FinderPreloadObjectPlayEnhanceConfig, FinderPreloadObjectReportSwitch, NSMutableArray, NSString;
...
@property(retain, nonatomic) FinderPreloadObjectPlayEnhanceConfig *enhanceConfig; // @dynamic enhanceConfig;
...
@property(retain, nonatomic) FinderPreloadObjectLutConfig *lutConfig; // @dynamic lutConfig;
