...
@class CBaseContact, CMessageWrap, MMMsgMenuReporter, MMRichTextCoverView, MMTableView, MMUIWindow, NSArray, NSMutableDictionary, NSString;
...
@interface MsgRecordDetailViewController
{
    ...
    id <RecordNodeDataSource> _forwardingDataSource;
}

+ (id)getDefaultFooterViewWithSize:(struct CGSize)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) id <RecordNodeDataSource> forwardingDataSource; // @synthesize forwardingDataSource=_forwardingDataSource;
...
- (void)openWeAppWithUsername:(id)arg1 pagePath:(id)arg2 debugMode:(unsigned long long)arg3 referrerInfo:(id)arg4;
- (void)selectPhotoAccountNameCardMsg:(id)arg1;
- (void)selectChatBotShareMsg:(id)arg1;
- (void)selectWeAppMsg:(id)arg1;
...
- (void)onClickOnVideoNode:(id)arg1 soundable:(_Bool)arg2;
