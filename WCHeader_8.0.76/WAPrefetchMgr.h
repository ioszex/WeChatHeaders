...
@interface WAPrefetchMgr
{
    ...
    NSMutableDictionary *_packageLoadInfoMap;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *packageLoadInfoMap; // @synthesize packageLoadInfoMap=_packageLoadInfoMap;
...
- (void)updateOptimizationPackageLoadInfoWithInfoData:(id)arg1 needDownload:(_Bool)arg2 optimization:(unsigned long long)arg3;
- (void)clearPackageLoadInfoForAppId:(id)arg1;
- (id)getPackageLoadInfoForAppId:(id)arg1;
- (id)getOrCreatePackageLoadInfoForAppId:(id)arg1;
...
- (void)markParallelDownloadReallyNeeded:(_Bool)arg1 forInfoData:(id)arg2;
- (void)markPreDownloadReallyNeeded:(_Bool)arg1 forInfoData:(id)arg2;
