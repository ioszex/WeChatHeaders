...
+ (unsigned long long)covertAVCategroy2WCCategroy:(NSString *)arg1;
+ (_Bool)setAVCategroy:(NSString *)arg1 mode:(NSString *)arg2 options:(unsigned long long)arg3 optionsForbidModify:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5 error:(id *)arg6 withBlockType:(unsigned long long)arg7;
+ (_Bool)setAVCategroy:(NSString *)arg1 mode:(NSString *)arg2 defaultToSpeaker:(_Bool)arg3 mixWithOthers:(_Bool)arg4 forceUseBuiltinMic:(_Bool)arg5;
