...
@class CBaseContact, LiveSEIData, LiveSdkInfo, MMFinderLiveConnectMicUsersInfo, MMFinderLivePIPHandler, MMLiveAnchorSEIInfo, MMLiveAnchorStatusItem, MMLiveAudioRoomSEIConnectMicMsg, MMLiveBaseTask, MMLiveCDNPlayerItem, MMLiveSEIConnectMicMsg, MMLiveTask, MMLiveTaskId, MMMetricsInfo, NSArray, NSDictionary, NSError, NSString, TRTCAudioFrame, TRTCQualityInfo, TRTCStatistics;

@protocol MMLiveTaskMgrExt <NSObject>

@optional
- (void)onLiveTask:(MMLiveTask *)arg1 commentNewHeaderStyleShouldDisplay:(_Bool)arg2;
- (void)onLiveTask:(MMLiveTask *)arg1 localCaptureSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;
- (void)onLiveTask:(MMLiveTask *)arg1 capturedAudioFrame:(TRTCAudioFrame *)arg2;
- (void)onLiveTask:(MMLiveTask *)arg1 processNewMusicSEI:(LiveSEIData *)arg2;
- (void)onLiveTask:(MMLiveTask *)arg1 cameraCastConnectionChanged:(_Bool)arg2;
- (void)onLiveTask:(MMLiveTask *)arg1 trtcAudioFrameCostTime:(long long)arg2 userId:(NSString *)arg3 business:(long long)arg4;
...
- (void)onLiveTask:(MMLiveTask *)arg1 audienceApplyingMicStatusChanged:(_Bool)arg2;
...
- (void)onLiveTask:(MMLiveTask *)arg1 isSyndicateParticipantValueChanged:(_Bool)arg2;
...
- (void)onLiveTask:(MMLiveTask *)arg1 SEIMicMsgInfoUpdated:(MMLiveSEIConnectMicMsg *)arg2 listChanged:(_Bool)arg3 showMicTopic:(_Bool)arg4;
...
- (void)onLiveTaskConnectionRecovery:(MMLiveTask *)arg1;
- (void)onLiveTaskConnectionLost:(MMLiveTask *)arg1;
...
- (void)onLiveTaskReportFaceTrackOutputData:(MMLiveTask *)arg1;
