...
@class NSIndexPath, NSString, WCFinderBrandStreamProfileViewModel, WCFinderExtStatsReporter, WCFinderFeedFlowView, WCFinderLeftOvalTipsView;
...
- (void)finderBrandStreamProfileShotPostTimeTidChanged:(id)arg1 oldTid:(id)arg2;
