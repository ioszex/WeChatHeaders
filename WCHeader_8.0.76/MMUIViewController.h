...
@interface MMUIViewController : UIViewController
{
    ...
    _Bool _isTempBeingRemovedFromStackForAddingToNewStack;
...
@property(nonatomic) _Bool isTempBeingRemovedFromStackForAddingToNewStack; // @synthesize isTempBeingRemovedFromStackForAddingToNewStack=_isTempBeingRemovedFromStackForAddingToNewStack;
...
- (_Bool)interactiveDismissShouldIntercept;
...
- (void)setTopBarsHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)setTitle:(id)arg1 subTitle:(id)arg2 leftLoading:(_Bool)arg3 rightView:(id)arg4 rightViewLeftMargin:(double)arg5 subLeftView:(id)arg6 titleOffset:(double)arg7;
- (void)setTitle:(id)arg1 subTitle:(id)arg2 leftLoading:(_Bool)arg3 rightView:(id)arg4 subLeftView:(id)arg5 titleOffset:(double)arg6 rightViewLeftMargin:(double)arg7;
...
- (CDUnknownBlockType)dr_setCustomRouteInfo;
...
- (void)stopLoadingAndShowIcon:(id)arg1 text:(id)arg2 completionBlock:(CDUnknownBlockType)arg3 asModule:(id)arg4 identification:(id)arg5 endReasonType:(unsigned long long)arg6;
- (void)stopLoadingAndShowIcon:(id)arg1 text:(id)arg2 asModule:(id)arg3 identification:(id)arg4 endReasonType:(unsigned long long)arg5;
- (void)stopLoadingWithFailText:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 asModule:(id)arg3 identification:(id)arg4 endReasonType:(unsigned long long)arg5;
- (void)stopLoadingWithFailText:(id)arg1 asModule:(id)arg2 identification:(id)arg3 endReasonType:(unsigned long long)arg4;
- (void)stopLoadingWithOKText:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 asModule:(id)arg3 identification:(id)arg4 endReasonType:(unsigned long long)arg5;
- (void)stopLoadingWithOKText:(id)arg1 asModule:(id)arg2 identification:(id)arg3 endReasonType:(unsigned long long)arg4;
- (void)stopLoadingAsModule:(id)arg1 identification:(id)arg2 endReasonType:(unsigned long long)arg3;
...
- (void)stopLoadingAndShowIcon:(id)arg1 text:(id)arg2 completionBlock:(CDUnknownBlockType)arg3 atPageName:(id)arg4 moduleName:(id)arg5 identification:(id)arg6 endReasonType:(unsigned long long)arg7;
- (void)stopLoadingAndShowIcon:(id)arg1 text:(id)arg2 atPageName:(id)arg3 moduleName:(id)arg4 identification:(id)arg5 endReasonType:(unsigned long long)arg6;
- (void)stopLoadingWithFailText:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 atPageName:(id)arg3 moduleName:(id)arg4 identification:(id)arg5 endReasonType:(unsigned long long)arg6;
- (void)stopLoadingWithFailText:(id)arg1 atPageName:(id)arg2 moduleName:(id)arg3 identification:(id)arg4 endReasonType:(unsigned long long)arg5;
- (void)stopLoadingWithOKText:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 atPageName:(id)arg3 moduleName:(id)arg4 identification:(id)arg5 endReasonType:(unsigned long long)arg6;
- (void)stopLoadingWithOKText:(id)arg1 atPageName:(id)arg2 moduleName:(id)arg3 identification:(id)arg4 endReasonType:(unsigned long long)arg5;
- (void)stopLoadingAtPageName:(id)arg1 moduleName:(id)arg2 identification:(id)arg3 endReasonType:(unsigned long long)arg4;
...
@property(nonatomic) __weak id <UIViewControllerAnimatedTransitioning> finder_animatedTransitioning;
...
- (_Bool)canPresentMiniTaskDetailPageDerectly:(id)arg1;
...
- (void)openChatBotVoIPViewControllerWithInteractiveController:(id)arg1 transitionContext:(id)arg2 guideTransitionContext:(id)arg3 animated:(_Bool)arg4 pageActionInfo:(id)arg5;
- (void)openChatBotFlutterViewControllerWithInteractiveController:(id)arg1 transitionContext:(id)arg2 animated:(_Bool)arg3;
...
- (void)openOriginalMiniTaskViewController:(long long)arg1;
...
@property(nonatomic) _Bool isTruncateSubtitleHead;
- (void)applyLeftGradientMaskToLabel:(id)arg1;
