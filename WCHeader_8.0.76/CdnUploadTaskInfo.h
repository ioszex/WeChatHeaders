...
@class CDNUploadMsgImgPrepareResponse, MarsCdnUploadResult, NSArray, NSData, NSString;
...
@interface CdnUploadTaskInfo : NSObject
{
    ...
    MarsCdnUploadResult *m_pbUploadResult;
    _Bool _m_useSafeCdn;
    ...
    NSArray *_arrFileInfo;
    NSData *_cdnProtoData;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSData *cdnProtoData; // @synthesize cdnProtoData=_cdnProtoData;
@property(retain, nonatomic) NSArray *arrFileInfo; // @synthesize arrFileInfo=_arrFileInfo;
...
@property(retain, nonatomic) MarsCdnUploadResult *m_pbUploadResult; // @synthesize m_pbUploadResult;
