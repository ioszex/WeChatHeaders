...
@class MMCPLabel, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveMemberSignView, MMFinderLiveNormalTextSignView, MMFinderLiveTask, MMFinderLiveUserStateItem, MMLiveHeadImageView, MMLiveHeatAndIconButton, MMUIImageView, MMUILabel, UIView;
...
@property(nonatomic) _Bool useKTVStyle; // @synthesize useKTVStyle=_useKTVStyle;
