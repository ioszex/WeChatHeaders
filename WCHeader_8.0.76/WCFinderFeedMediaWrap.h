...
@class FinderLivePhotoMediaInfo, FinderMediaAndPlayerQoEInfo, FinderMediaSpec, FinderObjectScalingInfo, NSData, NSMutableArray, NSMutableSet, NSString, WCFinderFeedPreloadObjectInfo, WCFinderFullScreenEditRectModel, WCFinderVideoPreDownloadInfo, WCPlayerReporter;
...
@interface WCFinderFeedMediaWrap
{
    ...
    FinderLivePhotoMediaInfo *_livePhoto;
...
+ (id)getDownloadImagePath:(id)arg1;
+ (id)hashStringWithMediaInfo:(id)arg1;
+ (id)hashStringWithKey:(id)arg1;
+ (_Bool)copyMediaFileFromPath:(id)arg1 toPath:(id)arg2;
+ (void)checkShouldImmigratePreCache:(id)arg1;
+ (void)immigrateOfflineCacheIfNeeded:(id)arg1;
...
+ (id)mediaWrapForOfflinePreloadWith:(id)arg1 scene:(int)arg2;
...
@property(retain, nonatomic) FinderLivePhotoMediaInfo *livePhoto; // @synthesize livePhoto=_livePhoto;
...
@property(nonatomic) _Bool isOfflineTask; // @synthesize isOfflineTask=_isOfflineTask;
...
@property(nonatomic) int useTransEnhanceInfo; // @synthesize useTransEnhanceInfo=_useTransEnhanceInfo;
@property(copy, nonatomic) NSString *transEnhanceInfo; // @synthesize transEnhanceInfo=_transEnhanceInfo;
...
- (_Bool)removeFailedCurrentMediaSpecFromMediaInfo:(id)arg1;
...
- (_Bool)checkFinishFirstFrameDownload;
...
- (void)updateLutColorWithPlayerInfo:(id)arg1 colorLutType:(unsigned long long)arg2;
- (void)setPlayerExperimentalParameters:(id)arg1;
- (id)genArrDataSourceWith:(id)arg1;
- (id)offlineVideoPath:(_Bool)arg1;
- (id)codingFormatType;
