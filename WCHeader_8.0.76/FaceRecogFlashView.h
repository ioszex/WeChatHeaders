...
@class CAShapeLayer, FaceIdentifyResp_CTIDVerifyParam, FaceRecogResultView, FaceRecogRoundView, MMUILabel, NSString, UIColor, UIFont, UIView;
...
@interface FaceRecogFlashView
{
    ...
    FaceIdentifyResp_CTIDVerifyParam *_ctidVerifyParam;
...
@property(retain, nonatomic) FaceIdentifyResp_CTIDVerifyParam *ctidVerifyParam; // @synthesize ctidVerifyParam=_ctidVerifyParam;
@property(nonatomic) _Bool hideResultView; // @synthesize hideResultView=_hideResultView;
...
- (void)showCTIDSystemError;
- (void)showCTIDFinishWithTitle:(id)arg1 desc:(id)arg2;
- (void)showFinish;
