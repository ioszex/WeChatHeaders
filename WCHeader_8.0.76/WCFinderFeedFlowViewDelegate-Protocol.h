...
- (void)onFinderFeedLongPress:(WCFinderFeedContentVM *)arg1;
...
- (void)onFinderFeedFlowViewFavorite:(WCFinderFeedContentVM *)arg1;
- (void)onFinderFeedFlowViewForward:(WCFinderFeedContentVM *)arg1;
- (void)onFinderFeedFlowViewMultiSelect:(WCFinderFeedContentVM *)arg1;
