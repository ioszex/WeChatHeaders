...
@interface MMFinderLivePromoteManageLogic : NSObject
{
    ...
    CDUnknownBlockType _showPanelDataFetchCompletionBlock;
}

- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType showPanelDataFetchCompletionBlock; // @synthesize showPanelDataFetchCompletionBlock=_showPanelDataFetchCompletionBlock;
...
@property(nonatomic) unsigned int noticeScene; // @synthesize noticeScene=_noticeScene;
...
- (_Bool)consumeAddPanelFirstShowIfNeeded;
...
- (void)onFetchDataWithCompletionBlock:(CDUnknownBlockType)arg1;
- (void)onFetchData;
...
- (void)redPacketAddPromoteWithOpType:(unsigned int)arg1 jumpinfoId:(id)arg2 redPacketInfo:(id)arg3;
- (_Bool)onRedPacketInfo:(id)arg1 opType:(unsigned int)arg2;
- (void)fetchRedPacketInfoForLink:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)onSelectRedEnvelopeCoverUrl:(id)arg1 isPurchase:(_Bool)arg2 fromSheet:(id)arg3;
- (void)jumpToRedPacketComponentPageSheet:(id)arg1 isFromAddPanel:(_Bool)arg2;
...
- (void)presentNoticeListVcWithViewModel:(id)arg1 loadIndicator:(id)arg2;
...
- (void)navigateToLiveNoticeCreationDefaultingToUntimedNotice:(_Bool)arg1 showNoticeListVCAfterSucessfullyCreated:(_Bool)arg2 noticeListLoadIndicator:(id)arg3 reporter:(id)arg4;
- (void)addLiveNoticeInfo:(id)arg1;
- (void)reportCreateNoticeAction:(unsigned long long)arg1 actionDict:(id)arg2;
- (void)showLiveNoticeListWithViewModel:(id)arg1 loadIndicator:(id)arg2;
- (void)loadNoticeListViewModelWithCompletionBlock:(CDUnknownBlockType)arg1;
- (void)directShowLiveNoticeWithLoadIndicator:(id)arg1 scene:(unsigned int)arg2;
