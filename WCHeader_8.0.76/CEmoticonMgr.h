...
@class EmoticonDataDB, EmoticonSearchKeywordRecordList, EmoticonSendRecordList, NSMutableSet, NSRecursiveLock, NSString;
...
@interface CEmoticonMgr
{
    ...
    EmoticonSearchKeywordRecordList *_recentSearchRecordList;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) EmoticonSearchKeywordRecordList *recentSearchRecordList; // @synthesize recentSearchRecordList=_recentSearchRecordList;
...
- (void)clearRecentSearchKeywordList;
- (void)updateRecentSearchKeyword:(id)arg1;
- (id)getRecentSearchKeywordList:(unsigned int)arg1;
- (_Bool)clearRecentUsedEmoticonList;
...
- (_Bool)isStoreUnique:(id)arg1;
- (_Bool)updateStoreUnique:(id)arg1 storeUnique:(unsigned int)arg2;
...
- (_Bool)AddEmoticonSilently:(id)arg1 Type:(unsigned int)arg2 packageId:(id)arg3 Source:(int)arg4 Index:(unsigned int)arg5;
