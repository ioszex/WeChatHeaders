...
@class BaseResponse, FinderJumpInfo, FinderLivePersonalCenterPrepareInfo, FinderPrivacySetting, FinderWxUserAnonymousInfo, FinderWxUserSettingInfo, GameRankSwitchInfo, JoinLiveInvisiableSwitchInfo, NSMutableArray, NSString, PlayHistorySettings, PostActionWording, PrepareFinder, PrepareFinderRealNameInfo, RecommendPersonalizedConfig, RelatedWxAcctInfo;
...
@property(retain, nonatomic) FinderWxUserAnonymousInfo *wxUserAnonymousInfo; // @dynamic wxUserAnonymousInfo;
