...
- (void)createRequest;
- (id)initForHighlightCheerMicUserWithMicId:(id)arg1 liveTaskId:(id)arg2 finderDataItem:(id)arg3 liveScene:(unsigned int)arg4 liveCookies:(id)arg5 successBlock:(CDUnknownBlockType)arg6 failBlock:(CDUnknownBlockType)arg7;
- (id)initWithLiveTaskForEmoticonComment:(id)arg1 finderDataItem:(id)arg2 liveScene:(unsigned int)arg3 liveCookies:(id)arg4 clientMsgId:(id)arg5 boxId:(id)arg6 emoticonMd5:(id)arg7 successBlock:(CDUnknownBlockType)arg8 failBlock:(CDUnknownBlockType)arg9;
...
- (id)initWithLiveTaskId:(id)arg1 finderDataItem:(id)arg2 msgType:(unsigned int)arg3 liveScene:(unsigned int)arg4 liveCookies:(id)arg5 toUser:(id)arg6 replyConten:(id)arg7 replyEmojiMd5:(id)arg8 clientMsgId:(id)arg9 location:(id)arg10 poiAddrSubStr:(id)arg11 likeMsg:(id)arg12 boxId:(id)arg13 extraInfo:(id)arg14 successBlock:(CDUnknownBlockType)arg15 failBlock:(CDUnknownBlockType)arg16;
