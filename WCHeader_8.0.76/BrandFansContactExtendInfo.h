...
+ (void)initialize;
+ (void)PBArrayAdd_inviteStatus;
+ (void)PBArrayAdd_canSendMsg;
+ (void)PBArrayAdd_friendUserName;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int inviteStatus; // @synthesize inviteStatus=_inviteStatus;
