...
@class MMScrollView, MMUIButton, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSTimer, UIButton, UIImageView, UIView, WCFinderAppendTabDatasModel, WCFinderCreateCoordinator, WCFinderFeedAudioHelper, WCFinderLeadToMachineCellState, WCFinderNavTeenagerView, WCFinderOpenTimelineParams, WCFinderPlaybackSpeedView, WCFinderPostMgr, WCFinderTLUnreadModel, WCFinderTimelineCityViewController, WCFinderTimelineNaviTabsView, WCFinderTimelineTabBubbleController, WCFinderTimelineViewModel;
...
@interface WCFinderTimelineTabViewController
{
    ...
    _Bool _isLandScape;
    _Bool _needCheckPersonalBubble;
    _Bool _hasShowNetOffTips;
    _Bool _halfScreenIsShowState;
    _Bool _isFromMiniFloat;
    _Bool _isAntiAddictionTimerRunning;
    _Bool _onCellPlayPrepared;
    ...
    WCFinderTimelineViewModel *_viewModel;
    UIView *_midView;
    WCFinderTimelineNaviTabsView *_tabContainer;
    ...
    MMUIButton *_personalMenuButton;
    NSMutableDictionary *_sessionExposeFeedDict;
    NSNumber *_halfScreenMoveProgress;
    long long _currentNavBarInterfaceStyle;
    WCFinderNavTeenagerView *_teenagerNavView;
    NSMutableArray *_rightBtnItemList;
    WCFinderPostMgr *_timelinePostMgr;
    UIView *_customBackOnlyNavBar;
    NSTimer *_scrollEnableTimer;
    ...
    WCFinderTimelineCityViewController *_cityVC;
    long long _lastAntiAddictionTriggerTime;
}

+ (id)viewControllerDict;
+ (_Bool)isValidBubbleAnchorFrame:(struct CGRect)arg1 validRegion:(struct CGRect)arg2;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool onCellPlayPrepared; // @synthesize onCellPlayPrepared=_onCellPlayPrepared;
@property(nonatomic) long long lastAntiAddictionTriggerTime; // @synthesize lastAntiAddictionTriggerTime=_lastAntiAddictionTriggerTime;
@property(retain, nonatomic) WCFinderTimelineCityViewController *cityVC; // @synthesize cityVC=_cityVC;
...
@property(retain, nonatomic) NSTimer *scrollEnableTimer; // @synthesize scrollEnableTimer=_scrollEnableTimer;
@property(nonatomic) _Bool isAntiAddictionTimerRunning; // @synthesize isAntiAddictionTimerRunning=_isAntiAddictionTimerRunning;
@property(retain, nonatomic) UIView *customBackOnlyNavBar; // @synthesize customBackOnlyNavBar=_customBackOnlyNavBar;
...
@property(nonatomic) long long currentNavBarInterfaceStyle; // @synthesize currentNavBarInterfaceStyle=_currentNavBarInterfaceStyle;
...
@property(nonatomic) _Bool hasShowNetOffTips; // @synthesize hasShowNetOffTips=_hasShowNetOffTips;
@property(retain, nonatomic) NSMutableDictionary *sessionExposeFeedDict; // @synthesize sessionExposeFeedDict=_sessionExposeFeedDict;
@property(nonatomic) _Bool needCheckPersonalBubble; // @synthesize needCheckPersonalBubble=_needCheckPersonalBubble;
@property(nonatomic) __weak MMUIButton *personalMenuButton; // @synthesize personalMenuButton=_personalMenuButton;
...
@property(retain, nonatomic) UIView *notifyRedPoint; // @synthesize notifyRedPoint=_notifyRedPoint;
...
@property(retain, nonatomic) WCFinderTimelineNaviTabsView *tabContainer; // @synthesize tabContainer=_tabContainer;
@property(retain, nonatomic) UIView *midView; // @synthesize midView=_midView;
@property(retain, nonatomic) WCFinderTimelineViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
- (void)triggerAntiAddiction;
- (void)stopAntiAddictionTimer;
- (void)setupAntiAddictionTimerIfNeeded;
- (void)checkAntiAddictionAfterEnter;
- (long long)calculateRemainingTime;
- (_Bool)skipAntiAddictionLogic;
- (void)onFeedCityClickMoreHotContent;
- (_Bool)tabIsEnterByFindPageFromPageVC:(id)arg1;
- (_Bool)onFeedTLCityIsByFindPage;
- (void)tabResetAppendTabDatasByPageVC:(id)arg1;
- (void)onFeedTLCityClickJumpView;
- (void)onFeedTLCityShowJumpViewWithContentArray:(id)arg1;
- (void)onFeedTLCityClickHotCardItemWithContentArray:(id)arg1 scrollToContentVM:(id)arg2;
- (_Bool)onFeedTLCityGetHotTabNeedTopRefresh;
- (id)onTLCityGetHotTabLastBuff;
- (_Bool)onTLCityTimelineNoMoreCanShowHotSwitch;
- (void)onFeedVMData:(id)arg1 failedToFetchEnhanceWithEventType:(int)arg2 streamType:(int)arg3 ret:(int)arg4 errorMsg:(id)arg5;
- (void)onFeedVMData:(id)arg1 didFetchEnhanceList:(id)arg2 eventType:(int)arg3 streamType:(int)arg4;
...
- (void)onFinderElderlyModeChanged:(_Bool)arg1;
- (void)wechatPersonalizedChangeType:(long long)arg1 value:(_Bool)arg2;
- (void)finderVideoPipWindowClose:(id)arg1;
...
- (id)transitionHelperFetchCurrentPlayContentVM;
...
- (id)mapTabBubbleReportEidFromBubbleType:(long long)arg1;
...
- (void)onBubbleCtrlDidClick:(id)arg1 bubbleType:(long long)arg2 redDotInfo:(id)arg3;
- (void)onBubbleCtrl:(id)arg1 showBubbleWithShowInfo:(id)arg2;
- (void)onBubbleCtrl:(id)arg1 bubbleType:(long long)arg2 exposeTime:(double)arg3 dismisssBubbleWithShowInfo:(id)arg4;
...
- (unsigned long long)networkTipsStyleForBubbleController:(id)arg1;
- (_Bool)currentSelectedViewControllerShouldUseHighEntropyNetworkTipsStyle;
...
- (void)_forwardTabBubbleLifecycleToCurrentTab:(_Bool)arg1 itemType:(unsigned long long)arg2;
- (void)_forwardTabBubbleEnqueueToCurrentTab:(unsigned long long)arg1;
- (void)onBubbleCtrl:(id)arg1 bubbleItemDidDismiss:(unsigned long long)arg2;
- (void)onBubbleCtrl:(id)arg1 bubbleItemDidShow:(unsigned long long)arg2;
- (void)onBubbleCtrl:(id)arg1 bubbleItemDidEnqueue:(unsigned long long)arg2;
...
- (void)triggerTabRefreshByElderlyModeChange:(_Bool)arg1;
- (void)triggerTabRefreshByTeenagerModeChange;
- (void)networkFreeFlowStatusChange;
- (void)checkAndShowNetOffTips:(id)arg1;
...
- (void)tabFeedChangedByPageVC:(id)arg1;
...
- (void)tryShowLikePrivacyGuideFromPreparedContent:(_Bool)arg1;
- (void)onTimelineTabVC:(id)arg1 updatestreamTipsShowInfo:(id)arg2 delayBubble:(id)arg3 originCtrlInfo:(id)arg4;
- (void)makeBubbleShowStatusRefreshClickTips:(CDUnknownBlockType)arg1 feedID:(id)arg2 animatePreconditionBlock:(CDUnknownBlockType)arg3;
- (void)makeBubbleCtrlHideStatusRefreshByScrollToTid:(id)arg1;
- (void)onCurrentForceIndexPathDidChangedAboveNewFeed:(_Bool)arg1 curFeedIndex:(unsigned long long)arg2;
- (void)tryPrefetchOtherTabContent;
- (void)tryDisplayImmediatePopupIfNeeded;
...
- (void)onTimelineTabVCTopRefeshTriggleLoading:(id)arg1 enterRefresh:(_Bool)arg2 isTopRefresh:(_Bool)arg3;
- (void)onTimelineTabVC:(id)arg1 byUser:(_Bool)arg2 isTopRefresh:(_Bool)arg3;
- (id)timelineTabVCGetCurrentPlayableContentVMWithTabType:(int)arg1;
- (void)enableAllTableViewScroll;
- (void)disableAllTableViewScroll;
- (void)updateCustomNavBarAppearance;
...
- (id)tabGetAppendTabDatasByPageVC:(id)arg1;
...
- (void)onPostStateBubbleClickFromFeedId:(id)arg1 nonceId:(id)arg2;
...
- (void)tabTimelineAutoPlayFromTab:(id)arg1 lastContentVM:(id)arg2 currentContentVM:(id)arg3;
...
- (void)updateNotifyRedPointFrameAfterSizeTransition;
...
- (_Bool)shouldDisposeEntryRedDot;
...
- (_Bool)showDidOpenFindEntryPanelIfNeed;
- (void)onSearchClicked;
- (void)onPostClick;
- (void)onClickMinimizeButton;
- (void)onBackButtonClicked:(id)arg1;
- (void)refreshPersonalCenterRedPoint;
- (void)_updateRightNotifyRedPointIgnoreLimitLogic:(_Bool)arg1;
- (void)syncNotifyRedPointWithNavigationBarVisible:(_Bool)arg1;
- (void)reportRightBarItemRedDotAfterTransition;
- (void)checkRemoveNotifyRedPoint;
- (_Bool)canShowPersonalCenterRedPoint;
- (_Bool)enablePersonalCenterRedDotSyncOpt;
...
- (_Bool)showSearchBtn;
- (id)_minimizeNavIconName;
- (id)fetchMinimizeButtonForTab:(long long)arg1;
- (id)fetchMinimizeButton;
- (_Bool)enableShowMinimizeButtonForTab:(long long)arg1;
- (_Bool)enableShowMinimizeButton;
- (id)buttonItemWithNavCustomView:(id)arg1;
- (void)updateLeftMenuItemBtnForTab:(long long)arg1;
...
- (void)triggerUpdateNaviBarByIgnoreAppearState:(_Bool)arg1 useDebounce:(_Bool)arg2;
- (void)_debounceUpdatePersonalCenterRedDot;
- (void)updatePersonalCenterRedDot;
- (void)_updateRightBarButtonItemIgnoreLimitLogic:(id)arg1;
- (void)updateRightBarButtonItem;
- (id)covertStreamRedDotTypeToKeyPath:(int)arg1 andTabType:(int *)arg2;
- (_Bool)setUpNaviTabItemRedDotAs:(long long)arg1;
- (_Bool)recordBubbleCtrlFramesForVisibleHierarchy;
- (_Bool)recordBubbleCtrlFrames;
...
- (_Bool)isFriendHighEntropyTab:(long long)arg1;
...
- (void)preloadPersonalCenterOftenReadData;
- (void)viewDidLoad;
- (void)updateTimelineScrollViewContentSize;
- (void)viewWillLayoutSubviews;
- (_Bool)isFeedValidToShowInSession:(id)arg1 InCommentScene:(int)arg2;
- (void)addSessionExposeInfo:(id)arg1 fromCommentScene:(int)arg2 reason:(long long)arg3;
...
- (void)_applyIconColor:(id)arg1 toBarButtonItem:(id)arg2;
- (void)_setNavIconImage:(id)arg1 highlightedImage:(id)arg2 disabledImage:(id)arg3 toButton:(id)arg4;
- (id)_navIconDisabledImageWithIconName:(id)arg1 iconSize:(struct CGSize)arg2 color:(id)arg3;
- (id)_navIconHighlightedImageWithIconName:(id)arg1 iconSize:(struct CGSize)arg2 color:(id)arg3;
- (id)_navIconImageForControlState:(unsigned long long)arg1 iconName:(id)arg2 iconSize:(struct CGSize)arg3 color:(id)arg4;
- (id)_navBarButtonItemWithIconName:(id)arg1 target:(id)arg2 action:(SEL)arg3 style:(unsigned long long)arg4 accessibility:(id)arg5 color:(id)arg6;
- (id)_navTemplateIconImageWithIconName:(id)arg1 iconSize:(struct CGSize)arg2 color:(id)arg3;
- (id)_navIconImageWithIconName:(id)arg1 iconSize:(struct CGSize)arg2 color:(id)arg3;
- (struct CGSize)_navIconSizeFromBarButtonItem:(id)arg1;
- (id)_navIconNameFromBarButtonItem:(id)arg1;
- (void)_attachNavIconName:(id)arg1 iconSize:(struct CGSize)arg2 toObject:(id)arg3;
- (void)_attachNavIconName:(id)arg1 iconSize:(struct CGSize)arg2 toBarButtonItem:(id)arg3;
- (void)_attachNavIconName:(id)arg1 toBarButtonItem:(id)arg2;
- (void)updateNavBarButtonItemsColor:(id)arg1;
- (void)refreshNavBarAppearanceForCurrentTab;
- (void)refreshTeenagerNavViewUIModeStyle:(unsigned long long)arg1;
- (void)_applyNavBarAppearanceForInterfaceStyle:(long long)arg1;
- (void)updateNavBarAppearanceForTargetTab:(long long)arg1;
- (void)updateStatusBarAppearanceForInterfaceStyle:(long long)arg1;
- (long long)statusBarStyleForInterfaceStyle:(long long)arg1;
- (unsigned long long)navTeenagerUIModeStyleForInterfaceStyle:(long long)arg1;
- (id)navItemHighlightColorForInterfaceStyle:(long long)arg1;
- (id)navItemColorForInterfaceStyle:(long long)arg1;
- (long long)currentTabSupportedInterfaceStyle;
