...
+ (void)navigateToFlutterAlbumV2ViewController:(id)arg1 source:(id)arg2;
+ (void)navigateToFlutterSearchViewController:(id)arg1 source:(id)arg2;
+ (_Bool)isFlutterDetailEnabled;
+ (void)navigateToFlutterDetailViewController:(id)arg1 currentViewController:(id)arg2 forbidComment:(_Bool)arg3 tipType:(long long)arg4 failedComment:(id)arg5 canShowInvisibleTipsView:(_Bool)arg6 targetComment:(id)arg7;
+ (void)navigateToFlutterDetailViewController:(id)arg1 currentViewController:(id)arg2 forbidComment:(_Bool)arg3 tipType:(long long)arg4 failedComment:(id)arg5 canShowInvisibleTipsView:(_Bool)arg6;
+ (void)navigateToFlutterDetailViewController:(id)arg1 currentViewController:(id)arg2 forbidComment:(_Bool)arg3;
+ (void)navigateToFlutterTimelineWithViewController:(id)arg1;
+ (void)navigateToUserPageViewController:(id)arg1 contact:(id)arg2 scene:(unsigned int)arg3 thumbnailCnt:(unsigned int)arg4 source:(id)arg5;
...
+ (_Bool)navigateToContactInfoViewController:(id)arg1 scene:(unsigned int)arg2 opInfo:(id)arg3 jumpData:(id)arg4 currentViewController:(id)arg5;
...
+ (_Bool)presentCommitViewController:(_Bool)arg1 arrImage:(id)arg2 postReportSession:(id)arg3 trashReportData:(id)arg4 pureCurrentViewController:(id)arg5 withExtBean:(id)arg6 resultDelegate:(id)arg7;
...
+ (_Bool)navigateToBizWithShare:(id)arg1 postSharePoiViewModel:(id)arg2 currentViewController:(id)arg3 postCallback:(CDUnknownBlockType)arg4;
...
+ (id)genGMsgIdWithTid:(id)arg1 createTime:(unsigned long long)arg2;
