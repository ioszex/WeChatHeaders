...
@interface MMFinderLiveConnectMicAllUserInfoView : UIView
{
    ...
    UIView *_micTopicContainerView;
    UILabel *_micTopicLabel;
    NSString *_micTopicText;
...
@property(copy, nonatomic) NSString *micTopicText; // @synthesize micTopicText=_micTopicText;
@property(retain, nonatomic) UILabel *micTopicLabel; // @synthesize micTopicLabel=_micTopicLabel;
@property(retain, nonatomic) UIView *micTopicContainerView; // @synthesize micTopicContainerView=_micTopicContainerView;
...
- (void)onMMFinderLiveConnectMicOperationViewTapCatalogedMerchandiseLotteryIndicatorView:(id)arg1;
...
- (id)micTopicContainerViewIfExists;
- (void)relayoutMicTopicContainerViewForAudienceMicFullScreenDisplayMode;
- (double)currentMicTopicContainerHeight;
- (_Bool)shouldPlaceMicTopicAtFocusedHeaderOriginalTop;
- (void)notifyMicTopicLayoutChangedIfNeededFromFrame:(struct CGRect)arg1;
- (void)layoutMicTopicLabel;
- (void)updateMicTopicLabelVisibility;
- (void)onMicTopicContentContainerViewTapped;
- (void)configMicTopicLabel;
- (void)applyMicTopicParagraphStyleToAttributedString:(id)arg1;
- (void)updateMicTopic:(id)arg1 andTopicTitle:(id)arg2;
...
- (id)focusedMicUserOperationView;
