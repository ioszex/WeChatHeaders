...
@class FinderClientAudio, FinderClientBrightness, FinderClientPerformance, NSMutableArray, NSString;
...
@property(retain, nonatomic) FinderClientAudio *clientAudio; // @dynamic clientAudio;
...
@property(nonatomic) unsigned int isVpnConnected; // @dynamic isVpnConnected;
