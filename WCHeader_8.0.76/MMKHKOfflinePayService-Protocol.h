...
@class MMVoidBoolCallback, MMVoidITransmitKvDataCallback, NSData, NSString;
...
- (void)asyncGetCftCSRImpl:(NSString *)arg1 resultCallback:(MMVoidITransmitKvDataCallback *)arg2;
