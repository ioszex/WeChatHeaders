...
@class MISSING_TYPE, NSString, UICollectionView, UICollectionViewFlowLayout, WAMainFrameTaskBarSectionOtherViewCell, WAMainFrameTaskBarSectionViewModel;
...
+ (MISSING_TYPE *)contentHeight: /* Error: Ran out of types for this method. */;
