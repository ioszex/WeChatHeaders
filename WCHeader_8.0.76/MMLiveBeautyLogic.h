...
@class MMFinderLiveTask, MMLiveBeautyPackage, MMLiveBeautyResourcesDescriptor, MMLiveBeautySnapshotData, MMLiveEffectsUsingContext, MMLiveEnergyController, MMLiveFilterDataItem, MMLiveFilterPackage, MMLiveFilterSnapshotData, MMLiveMakeupDataItem, MMLiveMakeupPackage, MMLiveMakeupSnapshotData, MMLiveTask, MMWeEffectManager, MemoryMappedKV, NSDictionary, NSMutableDictionary, NSString, WCFinderLiveAnchorLogReporter, WCFinderLiveStarterReporter;
...
@interface MMLiveBeautyLogic : NSObject
{
    ...
    MMLiveBeautySnapshotData *_beautySnapshotData;
    MMLiveMakeupSnapshotData *_makeupSnapshotData;
    MMLiveFilterSnapshotData *_filterSnapshotData;
}

+ (_Bool)makeupAvailable;
+ (_Bool)deviceSatisfiesPerformanceRequirement:(unsigned long long)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) MMLiveFilterSnapshotData *filterSnapshotData; // @synthesize filterSnapshotData=_filterSnapshotData;
@property(retain, nonatomic) MMLiveMakeupSnapshotData *makeupSnapshotData; // @synthesize makeupSnapshotData=_makeupSnapshotData;
@property(retain, nonatomic) MMLiveBeautySnapshotData *beautySnapshotData; // @synthesize beautySnapshotData=_beautySnapshotData;
...
- (void)loadBeautyItemValue:(id)arg1 forSuite:(id)arg2;
- (void)createDriverBeautyItem:(id)arg1 forSuite:(id)arg2;
...
- (void)applyExclusiveGroupActiveItem:(id)arg1;
...
- (void)clearFilterSnapshot;
- (_Bool)hasFilterSnapshot;
- (_Bool)restoreFilterSnapshot;
- (void)saveFilterSnapshot;
- (void)clearMakeupSnapshot;
- (_Bool)hasMakeupSnapshot;
- (_Bool)restoreMakeupSnapshot;
- (void)saveMakeupSnapshot;
- (void)clearBeautySnapshot;
- (_Bool)hasBeautySnapshot;
- (_Bool)restoreBeautySnapshot;
- (void)saveBeautySnapshot;
- (id)beautyLogic;
