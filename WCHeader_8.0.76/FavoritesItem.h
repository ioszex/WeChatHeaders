...
@class FavLiteAppItem, FavLocationItem, FavProductItem, FavTVItem, FavURLItem, FavWeAppItem, MMMusicShareItem, NSArray, NSDate, NSMutableArray, NSSet, NSString, WCFinderCollectionShareItem, WCFinderContentColumnSharedItem, WCFinderLiveShareItem, WCFinderMessageShareNameCard, WCFinderShareToMomentsItem, WCFinderThemeLiveStreamShareItem, WCFinderTopicShareItem, WCMegaVideoShareItem;
...
@interface FavoritesItem
{
    ...
    NSSet *_forceReuploadCdnDataURLSet;
    NSString *_starBizKey;
...
@property(retain, nonatomic) NSString *starBizKey; // @synthesize starBizKey=_starBizKey;
...
@property(retain, nonatomic) NSSet *forceReuploadCdnDataURLSet; // @synthesize forceReuploadCdnDataURLSet=_forceReuploadCdnDataURLSet;
...
@property(nonatomic) unsigned int pinTopTimestamp; // @synthesize pinTopTimestamp=_pinTopTimestamp;
...
@property(nonatomic) _Bool isFoldBtn; // @synthesize isFoldBtn=_isFoldBtn;
...
- (_Bool)needDownLoad;
- (_Bool)shouldShowEraseSwipeMenuItem;
- (_Bool)shouldLimitFavMenuToDeleteOnly;
- (_Bool)isUploadFail;
- (_Bool)isUploading;
- (_Bool)needUpload;
- (_Bool)canBeForward;
- (_Bool)checkNeedDownloadDataBeforeForward:(_Bool)arg1;
