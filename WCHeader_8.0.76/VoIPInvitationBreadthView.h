...
@class CContact, NSString, UIPanGestureRecognizer, VOIPVideoRender, VoIPInvitationBreadthQuickReplyView, VoIPInvitationInfo, XImageViewRenderer;
@protocol VoIPInvitationBreadthInviteView, VoIPInvitationBreadthViewDelegate, VoIPInvitationFullScreenView;
...
@interface VoIPInvitationBreadthView : UIView
{
    ...
    UIView<VoIPInvitationBreadthInviteView> *_inviteView;
    ...
    UIView<VoIPInvitationFullScreenView> *_fullScreenView;
...
@property(retain, nonatomic) UIView<VoIPInvitationFullScreenView> *fullScreenView; // @synthesize fullScreenView=_fullScreenView;
...
@property(retain, nonatomic) UIView<VoIPInvitationBreadthInviteView> *inviteView; // @synthesize inviteView=_inviteView;
...
- (void)voIPInvitationFullScreenViewDidIgnoreButtonClick:(id)arg1;
...
- (void)voIPInvitationBreadthInviteViewDidIgnore:(id)arg1;
...
- (void)updateFullScreenViewForNewRoomType;
