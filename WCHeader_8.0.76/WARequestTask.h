...
@interface WARequestTask : NSObject
{
    ...
    basic_string_911c138e _cronetTaskID;
    ...
    CDUnknownBlockType _chunkedHandler;
    CDUnknownBlockType _headersReceivedHandler;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(copy) CDUnknownBlockType headersReceivedHandler; // @synthesize headersReceivedHandler=_headersReceivedHandler;
@property(copy) CDUnknownBlockType chunkedHandler; // @synthesize chunkedHandler=_chunkedHandler;
...
- (void)startWithURL:(id)arg1 postData:(id)arg2 httpHeaders:(id)arg3 timeoutMS:(unsigned int)arg4 userAgent:(id)arg5 referer:(id)arg6 method:(id)arg7 chunkedHandler:(CDUnknownBlockType)arg8 headersReceivedHandler:(CDUnknownBlockType)arg9 completionHandler:(CDUnknownBlockType)arg10;
- (void)callCronetRequest:(struct CronetTaskParams)arg1;
- (void)cronetRequestTimeOut;
- (void)startCronetWithURL:(id)arg1 ip:(id)arg2 port:(unsigned int)arg3 host:(id)arg4 forbidReuse:(_Bool)arg5 postData:(id)arg6 httpHeaders:(id)arg7 timeoutMS:(unsigned int)arg8 userAgent:(id)arg9 referer:(id)arg10 method:(id)arg11 chunkedHandler:(CDUnknownBlockType)arg12 headersReceivedHandler:(CDUnknownBlockType)arg13 completionHandler:(CDUnknownBlockType)arg14;
@property(readonly, nonatomic) unsigned long long environmentType;
- (id)getTaskID;
- (void)dealloc;
