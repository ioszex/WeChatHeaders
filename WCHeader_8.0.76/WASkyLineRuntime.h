...
@interface WASkyLineRuntime : NSObject
{
    ...
    NSMutableDictionary *_rootScrollViewInfoDic;
    WANativeViewPlugin *_nativeViewPlugin;
    MMContext *_userContext;
    MMTimer *_timer;
    NSMutableArray *_pendingRuntimeDelegateBlocks;
}

+ (void)onSkylineCppLog:(int)arg1 file:(const char *)arg2 line:(int)arg3 str:(const char *)arg4 strLen:(int)arg5;
+ (id)getVersionString;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *pendingRuntimeDelegateBlocks; // @synthesize pendingRuntimeDelegateBlocks=_pendingRuntimeDelegateBlocks;
...
@property(retain, nonatomic) NSMutableDictionary *rootScrollViewInfoDic; // @synthesize rootScrollViewInfoDic=_rootScrollViewInfoDic;
...
- (void)onNotifyRootScrollViewChange:(id)arg1;
- (_Bool)isJsc2Enabled;
...
- (id)getNativeViewClassName:(id)arg1 nativeViewType:(id)arg2 extraData:(id)arg3;
...
- (id)getRootScrollViewInfo:(long long)arg1;
- (_Bool)listenRootScrollViewChange;
- (id)getSkylineViewByWindowId:(long long)arg1;
- (void)updateCurrentKeyboardHeight:(long long)arg1 widgetId:(long long)arg2 height:(double)arg3;
...
- (void)executeRuntimeDelegateBlocks;
- (void)callRuntimeDelegate:(CDUnknownBlockType)arg1;
