...
@property(retain, nonatomic) NSString *acctFirstRouteInfo; // @dynamic acctFirstRouteInfo;
@property(retain, nonatomic) TipsInfo *acctUsageTips; // @dynamic acctUsageTips;
@property(retain, nonatomic) NSString *defaultBindSerial; // @dynamic defaultBindSerial;
