...
@class CMessageWrap, ImageUploadUnifyBaseMgr, MultiMediaUploadUnifyMgr, NSString, OpenUploadCDNMgr, OpenUploadVideoCDNMgr, RecordBaseUploadCDNMgr, VideoUploadUnifyMgr;
...
@interface HistoryMsgUploadTask : NSObject
{
    ...
    RecordBaseUploadCDNMgr *_recordUploadCDNMgr;
...
@property(retain, nonatomic) RecordBaseUploadCDNMgr *recordUploadCDNMgr; // @synthesize recordUploadCDNMgr=_recordUploadCDNMgr;
