...
@class MISSING_TYPE, MMLiveTask, MMMetricsInfo, MMPowerABTest, NSString;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool injected; // @synthesize injected=_injected;
