...
- (void)onGetFinderLiveComboLiveRewardAppMsgWithTaskId:(id)arg1 comboLiveRewardAppMsg:(id)arg2;
...
- (void)loadImageReplaceResourcesForAnimationResource:(id)arg1 correlationId:(id)arg2 isPortrait:(_Bool)arg3 completionBlock:(CDUnknownBlockType)arg4;
