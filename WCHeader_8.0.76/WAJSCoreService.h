...
@interface WAJSCoreService
{
    ...
    id <IWASkylineRuntime> _skylineRuntimeDestroying;
    ...
    _TtC9WeAppCore25MagicAdMiniProgramService *_magicAdMiniProgramService;
}

+ (void)setTransitInfo:(id)arg1 toDicParam:(id)arg2;
+ (void)setRefererInfo:(id)arg1 toDicParam:(id)arg2;
- (void).cxx_destruct;
@property(retain, nonatomic) _TtC9WeAppCore25MagicAdMiniProgramService *magicAdMiniProgramService; // @synthesize magicAdMiniProgramService=_magicAdMiniProgramService;
...
@property(retain, nonatomic) id <IWASkylineRuntime> skylineRuntimeDestroying; // @synthesize skylineRuntimeDestroying=_skylineRuntimeDestroying;
...
@property _Bool remoteDebugHasInjected; // @synthesize remoteDebugHasInjected=_remoteDebugHasInjected;
...
- (void)addDelayToAgentJSEvent:(CDUnknownBlockType)arg1 jsapiFailHandler:(CDUnknownBlockType)arg2 jsapiReplyHandler:(CDUnknownBlockType)arg3 jsapiParams:(id)arg4 jsapiName:(id)arg5 eventType:(unsigned long long)arg6;
- (unsigned long long)checkJSEventNeedDelayInAgentMode:(id)arg1;
- (_Bool)checkJSEventNeedCallUserInAgentMode:(id)arg1;
- (id)convertJSError:(id)arg1;
- (void)handleSyncResult:(id)arg1 startTime:(double)arg2 safeCompletion:(CDUnknownBlockType)arg3;
- (void)handleAsyncResult:(id)arg1 timeout:(double)arg2 startTime:(double)arg3 safeCompletion:(CDUnknownBlockType)arg4;
- (_Bool)isPromise:(id)arg1;
- (void)setupExceptionHandler:(id)arg1 safeCompletion:(CDUnknownBlockType)arg2;
...
- (void)onWeAppEnterForeground:(id)arg1 isFromSystemAwake:(_Bool)arg2 useNewNavStack:(_Bool)arg3;
...
- (id)makeSubscribeInvoker:(id)arg1 param:(id)arg2 srcWebviewID:(unsigned int)arg3 dstWebviewID:(unsigned int)arg4 isThirdAppEvent:(_Bool)arg5;
- (id)makeSubscribeInvoker:(id)arg1 param:(id)arg2 webviewID:(unsigned int)arg3 isThirdAppEvent:(_Bool)arg4;
...
- (void)invokeThirdJSApiCallbackWithEventName:(id)arg1 eventParams:(id)arg2 callbackId:(unsigned int)arg3 contextId:(unsigned int)arg4 workerId:(unsigned int)arg5;
- (void)invokeThirdJSApiWithEventName:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3 contextId:(unsigned int)arg4 workerId:(unsigned int)arg5;
- (void)invokeThirdJSApiWithEventName:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3 contextId:(unsigned int)arg4;
...
- (void)preloadMagicAdMiniProgramServiceIfNeeded;
...
- (void)stopDebugNew;
- (void)startDebugNew;
- (void)_injectRemoteDebugScript:(id)arg1;
...
- (void)sendEventToMBBiz:(id)arg1 event:(id)arg2 data:(id)arg3;
