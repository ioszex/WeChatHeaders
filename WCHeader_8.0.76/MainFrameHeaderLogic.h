...
@class FTSVoiceSearchBarController, MFBackupBtn, MFBannerBtn, MFMigrationBtn, MFMusicPlayBtn, MFPushBannerLogic, MFPushSystemMsgLogic, MFRoamLiteBtn, MFRoamRemindBtn, MFWebMMBtn, MFWebViewVCKeepHoldBtn, NSMutableArray, NSString;
...
- (void)onChangeRoamLiteBannerMsg:(id)arg1 bannerTitle:(id)arg2;
