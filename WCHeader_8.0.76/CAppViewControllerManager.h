...
+ (id)viewControllersHierecyOfWindow:(id)arg1;
...
@property(nonatomic) _Bool m_fromPinnedShortcut; // @synthesize m_fromPinnedShortcut=_m_fromPinnedShortcut;
...
- (void)onPasteboardChangedNotification:(id)arg1;
...
- (void)jumpToOfflinePayWithEntryVC:(id)arg1 fromPinnedShortcut:(_Bool)arg2;
- (void)jumpToOfflinePayWithEntryVC:(id)arg1;
- (void)jumpToQuickCall;
- (void)jumpToWriteNote;
- (void)jumpToMyQrCodeWithEntryScene:(unsigned int)arg1;
- (void)jumpToMyQrCodeLongPressIcon;
- (void)jumpToMyQrCodeFromWidget;
- (void)jumpToOfflinePayFromShortcut;
- (void)jumpToOfflinePay;
- (void)internalJumpToShareCard;
- (void)jumpToShareCardAndCheck;
- (void)jumpToShareCard;
- (void)jumpToAlbum;
- (void)jumpToStorage:(unsigned long long)arg1;
...
- (void)dirctMoveToRootViewControllerForIndex:(long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
