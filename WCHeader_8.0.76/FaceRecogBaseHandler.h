...
@class FaceIdentifyResp_CTIDVerifyParam, FaceRecogBaseViewController, FaceRecogConfigLogic, FaceRecogReporter, FaceRecogUploadLogic, LocationRetriever, MMUIViewController, NSMutableDictionary, NSString, UIColor;
...
@interface FaceRecogBaseHandler
{
    ...
    NSMutableDictionary *_ctidAuthParams;
    FaceIdentifyResp_CTIDVerifyParam *_ctidVerifyParamForView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) FaceIdentifyResp_CTIDVerifyParam *ctidVerifyParamForView; // @synthesize ctidVerifyParamForView=_ctidVerifyParamForView;
@property(retain, nonatomic) NSMutableDictionary *ctidAuthParams; // @synthesize ctidAuthParams=_ctidAuthParams;
...
@property(nonatomic) _Bool uploadVideoForPay; // @synthesize uploadVideoForPay=_uploadVideoForPay;
...
- (void)handleUploadFaceFlashVideoForPayWithFlag:(_Bool)arg1;
- (void)didAccessLocation:(double)arg1 longitude:(double)arg2;
- (void)didAccessConfig;
- (void)didAccessAudio;
- (void)didAccessVideo;
- (void)didUploadFaceData:(id)arg1;
- (void)handlerDidFinishWithCode:(long long)arg1 msg:(id)arg2 errorTips:(id)arg3 verifyResult:(id)arg4 canRetry:(_Bool)arg5 showCtidVerifyEntry:(_Bool)arg6 ctidVerifyParam:(id)arg7;
...
- (void)faceRecogDidClickOpenCTID:(id)arg1;
