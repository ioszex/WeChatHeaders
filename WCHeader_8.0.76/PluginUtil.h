...
+ (id)getOfficialLocNickNameWithUserName:(id)arg1;
...
+ (_Bool)preparePlugin:(id)arg1 uiViewContraller:(id)arg2 prepared:(CDUnknownBlockType)arg3;
+ (_Bool)isPluginInstalledByName:(id)arg1;
+ (_Bool)isPluginInstalled:(long long)arg1;
+ (unsigned int)pluginTypeToUnInstallBit:(long long)arg1;
+ (long long)getPluginCount;
