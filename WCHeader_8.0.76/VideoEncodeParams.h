...
@class AVVideoCompositionCoreAnimationTool, MISSING_TYPE, NSDictionary, WCColorProperties;
...
@interface VideoEncodeParams : NSObject
{
    ...
    MISSING_TYPE *_useAssetDurationForCompose;
    _Bool _useHDRToSDR;
    _Bool _HDRSwitch;
    ...
    WCColorProperties *_originVideoColorPropertiesObj;
    struct CGRect _cropFrame;
    CDStruct_e83c9415 _timeRange;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCColorProperties *originVideoColorPropertiesObj; // @synthesize originVideoColorPropertiesObj=_originVideoColorPropertiesObj;
@property(nonatomic) int enhancementMode; // @synthesize enhancementMode=_enhancementMode;
