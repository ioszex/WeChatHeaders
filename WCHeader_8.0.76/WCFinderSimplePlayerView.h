...
@interface WCFinderSimplePlayerView
{
    ...
    _Bool _bLoop;
    _Bool _disableMoveToEmptyWindowProtection;
    _Bool _disable19059Report;
...
@property(nonatomic) _Bool disable19059Report; // @synthesize disable19059Report=_disable19059Report;
@property(nonatomic) _Bool disableMoveToEmptyWindowProtection; // @synthesize disableMoveToEmptyWindowProtection=_disableMoveToEmptyWindowProtection;
...
- (void)queryCacheWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)resume;
- (void)pause;
- (void)pauseVideoWithPlayerInfoReportIfNeeded;
- (void)playVideoWithPlayerInfoReportPreparation;
- (void)preparePlayerInfoReportForResumeIfNeeded;
- (void)reportPlayerInfoIfNeeded;
