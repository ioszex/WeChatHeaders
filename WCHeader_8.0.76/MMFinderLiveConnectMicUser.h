...
@interface MMFinderLiveConnectMicUser
{
    ...
    _Bool _isSelf;
    _Bool _isPaidConnectMic;
    _Bool _isWxaGameChallenge;
    _Bool _isWholeConnectionInKTVMode;
    _Bool _isAnchor;
    ...
    _Bool _hasShownConnectMicStatisticsPanel;
    _Bool _forbidShowConnectMicStatisticsPanel;
    unsigned int _boardType;
    unsigned int _micUserAttrFlag;
    unsigned int _sdkRoomId;
    int _talkingCount;
    unsigned int _applyScene;
    unsigned int _connectingMicServerTimeStamp;
    ...
    unsigned long long _randomMicApplyPos;
...
+ (id)connectMicUserFromFinderObject:(id)arg1;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool forbidShowConnectMicStatisticsPanel; // @synthesize forbidShowConnectMicStatisticsPanel=_forbidShowConnectMicStatisticsPanel;
@property(nonatomic) _Bool hasShownConnectMicStatisticsPanel; // @synthesize hasShownConnectMicStatisticsPanel=_hasShownConnectMicStatisticsPanel;
@property(nonatomic) unsigned int connectingMicServerTimeStamp; // @synthesize connectingMicServerTimeStamp=_connectingMicServerTimeStamp;
...
@property(nonatomic) unsigned long long randomMicApplyPos; // @synthesize randomMicApplyPos=_randomMicApplyPos;
...
@property(nonatomic) _Bool isWholeConnectionInKTVMode; // @synthesize isWholeConnectionInKTVMode=_isWholeConnectionInKTVMode;
@property(nonatomic) _Bool isWxaGameChallenge; // @synthesize isWxaGameChallenge=_isWxaGameChallenge;
@property(nonatomic) _Bool isPaidConnectMic; // @synthesize isPaidConnectMic=_isPaidConnectMic;
