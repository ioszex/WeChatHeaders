...
@protocol WCFinderWechatMentionVCDelegate;

@interface WCFinderWechatMentionVC
{
    _Bool _hasRequestedFirstPage;
    id <WCFinderWechatMentionVCDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderWechatMentionVCDelegate> delegate; // @synthesize delegate=_delegate;
