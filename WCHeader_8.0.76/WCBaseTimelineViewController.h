...
@class CEmoticonWrap, EmoticonBoardView, MMGrowTextView, MMImage, MMRTCSnsMenuResponder, MMSnsRichTextCoverView, MMTableView, MMUIButton, MMUILabel, MMURLHandler, MMWebImageView, NSMutableDictionary, NSString, RichTextView, UIButton, UIImageView, UIView, WCCommentBigEmoticonAddHelper, WCCommentImageHelper, WCDataItem, WCInputController, WCMomentsClickHandler, WCMomentsInputAreaReportInfo, WCMomentsPageContext, WCTimeLineCellView, WCUserComment;
...
@interface WCBaseTimelineViewController
{
    ...
    WCDataItem *_selectableDataItem;
    WCTimeLineCellView *_selectableCellView;
...
@property(retain, nonatomic) WCTimeLineCellView *selectableCellView; // @synthesize selectableCellView=_selectableCellView;
@property(retain, nonatomic) WCDataItem *selectableDataItem; // @synthesize selectableDataItem=_selectableDataItem;
...
- (void)updateContentOffsetIfNeededForCommentPackup:(id)arg1 inDataItem:(id)arg2;
...
- (void)autoExitSelectStateIfInvisible;
...
- (void)shouldExitSelectStateWithTableView:(id)arg1 touches:(id)arg2 withEvent:(id)arg3;
- (void)hideSelectableRichTextCoverView;
- (id)getExtInfoForMenuAction;
- (void)exitSelectState;
- (void)onCopyFinishWithString:(id)arg1;
- (void)onDataItemDidSelect:(id)arg1 cellView:(id)arg2;
- (void)onShowMenuItemsForDataItem:(id)arg1 richTextView:(id)arg2 cellView:(id)arg3 menuItems:(id)arg4 isTranslatedText:(_Bool)arg5 bubblePullType:(long long)arg6 textSelectType:(long long)arg7;
