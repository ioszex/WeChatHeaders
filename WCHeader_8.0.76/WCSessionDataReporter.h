...
@interface WCSessionDataReporter
{
    ...
    NSString *_k1kFinderLongVideoRedDotJson;
...
@property(copy) NSString *k1kFinderLongVideoRedDotJson; // @synthesize k1kFinderLongVideoRedDotJson=_k1kFinderLongVideoRedDotJson;
