...
@interface TPIDKeyboardView : UIView
{
    ...
    double _initBtnWidthPortrait;
    double _initBtnWidthLandscape;
    double _lastPortraitWidth;
    double _lastLandscapeWidth;
    int maxInput;
}
...
- (void)_setKeyboardNumFont:(id)arg1 rootView:(id)arg2;
- (void)setKeyboardNumFont:(id)arg1;
...
- (void)layoutKeyboardButtonForRootView:(id)arg1;
- (double)commonBtnWidthForRootView:(id)arg1;
- (void)layoutKeyboardButtonWithoutAnimation:(id)arg1;
- (void)checkAndLayoutFloatKeyboardButtons;
