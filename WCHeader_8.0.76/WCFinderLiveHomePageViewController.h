...
@class MMBarButtonItem, MMFinderLiveFeedFriendsLikeListViewController, MMFinderLiveHomePageBottomPlayerView, MMFinderLiveHomePageBottomPlayerViewModel, MMFinderLiveIconTransitionCarouselView, MMLiveQcPollPageSheet, MMUIButton, NSString, UIImage, UILabel, UIView, WCFinderFeedFlowView, WCFinderLiveHomePageInitialParams, WCFinderLiveHomePageScrollActionSheet, WCFinderLiveHomePageTabLiveStreamSectionCollectionViewCell, WCFinderLiveHomePageViewModel, WCFinderRedDotCtrlInfo, _TtC6WeChat22MMFinderLiveFPSMonitor;
...
@interface WCFinderLiveHomePageViewController
{
    ...
    MMLiveQcPollPageSheet *_tmpQcPollSheet;
    UIView *_notifyRedPoint;
    MMBarButtonItem *_personCenterNavBtn;
    struct CGSize _lastLayoutBoundsSize;
}

+ (double)calculateRecommendAreaTwoColumnCellWidthInVC:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) MMBarButtonItem *personCenterNavBtn; // @synthesize personCenterNavBtn=_personCenterNavBtn;
@property(retain, nonatomic) UIView *notifyRedPoint; // @synthesize notifyRedPoint=_notifyRedPoint;
@property(nonatomic) __weak MMLiveQcPollPageSheet *tmpQcPollSheet; // @synthesize tmpQcPollSheet=_tmpQcPollSheet;
...
- (void)onHomePageNpsSurveyCell:(id)arg1 selectOption:(id)arg2;
...
- (void)onTabLiveStreamSectionFeedView:(id)arg1 clickFriendLikeReason:(id)arg2;
...
- (void)onHomePageSectionHeaderViewExpand:(id)arg1;
...
- (void)onInteractionEntranceSectionView:(id)arg1 selectElementVM:(id)arg2;
- (void)onSpecialColumnSectionView:(id)arg1 clickFriendLikeReason:(id)arg2;
...
- (void)horizontalScrollSectionDidEndScrolling:(id)arg1;
- (void)onBannerSectionView:(id)arg1 clickFriendLikeReason:(id)arg2;
...
- (void)showSquareSwitchGuideIfNeeded;
