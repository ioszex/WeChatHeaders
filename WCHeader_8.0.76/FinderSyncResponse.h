...
@class BaseResponse, CmdList, EntranceReportSwitch, FinderCheckExpireInfo, FinderObjectCtrl, FinderPopupClientFreqConfig, FinderPopupFetchOnEnterConfig, NSData, NSMutableArray, SKBuiltinBuffer_t;
...
@property(retain, nonatomic) NSMutableArray *findPageLockConfig; // @dynamic findPageLockConfig;
...
@property(retain, nonatomic) FinderPopupFetchOnEnterConfig *popupFetchOnEnterConfig; // @dynamic popupFetchOnEnterConfig;
