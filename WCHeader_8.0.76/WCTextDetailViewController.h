...
@class EmoticonCustomManageAddLogic, MMRTCSnsMenuResponder, MMSnsRichTextCoverView, NSString, RichTextView, UIButton, UIScrollView, UIView, WCCommentBigEmoticonAddHelper, WCCommentRichTextView, WCDataItem, WCMomentsClickHandler, WCRichTextView, WCUserComment;
