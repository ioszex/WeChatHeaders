...
@class AnnotationLogicController, CAShapeLayer, MMFloorPickView, MMLoadingView, MMMapView, MMTimer, NSString, NavigateLogicController, POIInfo, TrackRoomReporter, TrackRoomTopBarViewV1, UIButton, UIView, WCUIAlertView;
@protocol TrackRoomViewV1Delegate;

@interface TrackRoomViewV1
{
    id <TrackRoomViewV1Delegate> _trackRoomViewDelegate;
    _Bool _isInit;
    _Bool _getMicSucc;
    _Bool _showAllHead;
    ...
    TrackRoomTopBarViewV1 *_topbarView;
...
@property(nonatomic) __weak id <TrackRoomViewV1Delegate> trackRoomViewDelegate; // @synthesize trackRoomViewDelegate=_trackRoomViewDelegate;
- (void)reportLog26734;
