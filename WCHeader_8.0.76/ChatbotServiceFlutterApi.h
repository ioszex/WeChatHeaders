...
@interface ChatbotServiceFlutterApi : NSObject
{
...
- (void)notifyEnterSceneScene:(long long)arg1 completion:(CDUnknownBlockType)arg2;
- (void)notifyPanelExitSourceSource:(long long)arg1 completion:(CDUnknownBlockType)arg2;
- (void)notifyPanelEnterSourceSource:(long long)arg1 completion:(CDUnknownBlockType)arg2;
- (void)updateUdrPathPath:(id)arg1 completion:(CDUnknownBlockType)arg2;
