...
@class MMImageScrollViewHelper, MMLoadingView, MMProgressViewEx, MMScrollViewZoomReporter, MMUIButton, NSArray, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, SessionForwardRecordLogic, UIImage, UIImageView, UIView, UIViewPropertyAnimator, WCImageFullScreenTagView, WCImageTranslateLogic, WCLivePhotoBrowseReport, WCMediaItem, WCMediaItemWrap, WCMomentsPageContext, WCMomentsScrollActionSheet, WXFullScreenGestureRecognizer, WXFullScreenHorizontalGestureRecognizer;
...
@interface WCImageFullScreenViewContainer
{
    ...
    long long _loadImageType;
    double _loadOriginScaleLimit;
    WCLivePhotoBrowseReport *_livePhotoBrowseReport;
    WXFullScreenHorizontalGestureRecognizer *_horizontalGesture;
    struct UIEdgeInsets _imageTagSafeArea;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WXFullScreenHorizontalGestureRecognizer *horizontalGesture; // @synthesize horizontalGesture=_horizontalGesture;
...
@property(nonatomic) _Bool m_isShowOriginImage; // @synthesize m_isShowOriginImage=_m_isShowOriginImage;
@property(nonatomic) double loadOriginScaleLimit; // @synthesize loadOriginScaleLimit=_loadOriginScaleLimit;
@property(nonatomic) long long loadImageType; // @synthesize loadImageType=_loadImageType;
...
@property(nonatomic) _Bool useHorizontalGesture; // @synthesize useHorizontalGesture=_useHorizontalGesture;
...
- (void)startImageSearchFromEntrance:(unsigned long long)arg1;
...
- (struct CGRect)calculateContainerFrameWithImgSize:(struct CGSize)arg1;
- (void)initGestureView;
- (void)initFullGesture;
- (void)initHorizontalGesture;
- (void)resetZoomScale;
...
- (void)yuanBaoTemplateFollowButtonClickedInImageTagView:(id)arg1;
- (void)imageSearchButtonClickedInImageTagView:(id)arg1;
...
- (id)getSnsSessionIdWithMediaItemWrap:(id)arg1;
