...
@interface XImageViewRenderer : NSObject
{
    ...
    struct unique_ptr<rfx::RaisrFilter, std::default_delete<rfx::RaisrFilter>> _raisrFilter;
    ...
    _Bool _enableAsyncResize;
    _Bool _isSupportHDR;
    _Bool _preferHdr;
    float _contentsScale;
    int _sharpenIntensity;
    unsigned int _raisrCapFlag;
    int _raisrCapIPhoneVersion;
    int _raisrCapIPadVersion;
    unsigned int _raisrStrengthFlag;
...
@property(nonatomic) unsigned int raisrStrengthFlag; // @synthesize raisrStrengthFlag=_raisrStrengthFlag;
@property(nonatomic) int raisrCapIPadVersion; // @synthesize raisrCapIPadVersion=_raisrCapIPadVersion;
@property(nonatomic) int raisrCapIPhoneVersion; // @synthesize raisrCapIPhoneVersion=_raisrCapIPhoneVersion;
@property(nonatomic) unsigned int raisrCapFlag; // @synthesize raisrCapFlag=_raisrCapFlag;
@property(nonatomic) _Bool enableAsyncResize; // @synthesize enableAsyncResize=_enableAsyncResize;
