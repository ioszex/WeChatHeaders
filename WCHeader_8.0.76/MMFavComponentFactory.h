...
+ (_Bool)hasThumbAtRightLayoutWithoutImageForComData:(id)arg1;
...
+ (id)convertVideoDurationToStrInDigits:(int)arg1;
...
+ (void)getFavNoteCellTitleAndDesc:(id)arg1 outTitle:(id *)arg2 outDesc:(id *)arg3 maxTitleLength:(unsigned long long)arg4;
+ (void)getFavNoteCellTitleAndDesc:(id)arg1 outTitle:(id *)arg2 outDesc:(id *)arg3;
+ (id)getFavTextCellText:(id)arg1;
+ (id)createComponentByFavItem:(id)arg1 showDataSize:(_Bool)arg2 cellStyle:(unsigned long long)arg3 delegate:(id)arg4 isFoldBtn:(_Bool)arg5 isFolding:(_Bool)arg6 foldingSize:(long long)arg7;
+ (double)heightForFavItem:(id)arg1 isMultiSelect:(_Bool)arg2 cellStyle:(unsigned long long)arg3 isFoldBtn:(_Bool)arg4 isFolding:(_Bool)arg5;
