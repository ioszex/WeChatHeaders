...
@class MISSING_TYPE, MMMsgReferStateGesture, MMReferPartialInfo, MMUIButton, NSString, RichTextView, UIColor, UIImage, UIImageView, UITapGestureRecognizer, UIVisualEffectView;
...
@interface MMInputMsgReferView : UIView
{
    ...
    MISSING_TYPE *_forbidInteraction;
