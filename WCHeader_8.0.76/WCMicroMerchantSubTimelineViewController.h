...
@class EGORefreshTableHeaderView, MMUIImageView, MMUILabel, MicroMerchantTableViewModel, NSMutableArray, NSString, UIView, WCActionButtonFloatView, WCDataItem, WCMicroMerchantAdFeedbackView, WCMicroMerchantFeedsGroup, WCMomentsShareScopeMgr, WCOperateFloatView, WCPasteTextLengthLogic, WCTimeLineFooterView;
...
@interface WCMicroMerchantSubTimelineViewController
{
    ...
    WCMicroMerchantFeedsGroup *_merchantFeedsGroupItem;
    WCMicroMerchantAdFeedbackView *_adFeedbackView;
...
@property(retain, nonatomic) WCMicroMerchantAdFeedbackView *adFeedbackView; // @synthesize adFeedbackView=_adFeedbackView;
@property(retain, nonatomic) WCMicroMerchantFeedsGroup *merchantFeedsGroupItem; // @synthesize merchantFeedsGroupItem=_merchantFeedsGroupItem;
...
- (id)getVisibleAdCellView;
- (void)adOnTimelineViewReturn;
- (void)adScrollViewDidScroll;
- (void)adViewDidDisappear;
- (void)adViewDidAppear;
- (id)fetchMerchantAdView:(id)arg1;
- (void)notifyAdCellDidScroll;
- (void)didEndDisplayingAdCell:(id)arg1 forRowAtIndexPath:(id)arg2 tableView:(id)arg3;
- (void)willDisplayAdCell:(id)arg1 forRowAtIndexPath:(id)arg2 tableView:(id)arg3;
- (void)initAdLogic;
- (void)onClickPositiveBtn:(id)arg1;
- (void)removeFoldAdAndReportFeedback:(id)arg1 reasonList:(id)arg2;
- (void)onClickNegativeReasonBtn:(id)arg1 dataItem:(id)arg2;
- (void)onClickNegativeBtn:(id)arg1;
...
- (void)_firstBatchFetchServerDataAndOverrideLocal:(_Bool)arg1 addLocalData:(_Bool)arg2;
...
- (void)onFoldAdFeedbackBtnClick:(id)arg1 point:(struct CGPoint)arg2;
...
- (void)onMoreBarButtonItemClicked:(id)arg1;
- (void)configDataReportForWsFoldSettingBtn:(id)arg1;
