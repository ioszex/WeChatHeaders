...
@class BaseRequest, FinderBaseRequest, FinderLiveBulletin, FinderLiveClientStatus, FinderLiveModeInfo, FinderLiveTagInfo, FinderObjectDesc, LiveMicTopicInfo, LiveRoomImg, MicSetting_PurchaseMicSetting, NSData, NSMutableArray, NSString, PurchaseLivePreviewInfo, WxaGameLiveInfo;
...
@property(nonatomic) unsigned long long coLiveInvitationId; // @dynamic coLiveInvitationId;
...
@property(retain, nonatomic) NSString *entranceChatroomId; // @dynamic entranceChatroomId;
...
@property(retain, nonatomic) LiveMicTopicInfo *micTopicInfo; // @dynamic micTopicInfo;
