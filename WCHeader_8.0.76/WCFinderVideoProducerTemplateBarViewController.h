...
@class CAGradientLayer, NSIndexPath, NSString, UICollectionView, UIView, WCFinderVideoProducerDataSource;
@protocol WCVideoProducerTemplateBarDelegate;

@interface WCFinderVideoProducerTemplateBarViewController
{
