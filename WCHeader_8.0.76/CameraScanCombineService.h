...
@class CameraScanCombineModelGetter, CameraScanCombineModelInfo, CameraScanModelABConfig, NSObject, NSString;
...
@interface CameraScanCombineService
{
    ...
    CameraScanModelABConfig *_innerValidatedModelABConfig;
...
@property(retain, nonatomic) CameraScanModelABConfig *innerValidatedModelABConfig; // @synthesize innerValidatedModelABConfig=_innerValidatedModelABConfig;
...
- (void)setFfeSvrConfigDetObjGuideText:(id)arg1;
- (id)ffeSvrConfigDetObjGuideText;
