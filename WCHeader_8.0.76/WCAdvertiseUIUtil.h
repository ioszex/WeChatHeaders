...
+ (_Bool)shouldShowProductCardWithMinishopData:(id)arg1;
+ (double)adCombinedGridHeight:(_Bool)arg1;
+ (double)adCombinedGridCardMainHeight:(_Bool)arg1;
+ (double)adCombinedGridCardWidth:(_Bool)arg1;
+ (double)adFullCardTimeline;
+ (struct CGRect)adActionIconFrame:(_Bool)arg1;
...
+ (id)collectedSubAdItem:(id)arg1 index:(long long)arg2;
+ (_Bool)isMiniGameCollectedAd:(id)arg1;
+ (_Bool)shouldShowPriceLabel:(id)arg1 index:(long long)arg2;
+ (id)collectedSubAdItemPriceStr:(id)arg1 index:(long long)arg2;
...
+ (void)setMasksToBoundsToView:(id)arg1;
...
+ (id)getAdvertiseLogoTitleWithItem:(id)arg1;
+ (id)generateTimelineAdLogoWithItem:(id)arg1;
+ (id)generateSimpleLabelWithFont:(id)arg1 textColor:(id)arg2 text:(id)arg3;
+ (_Bool)updateRichLabel:(id)arg1 withContent:(id)arg2;
...
+ (void)tryToLoadAsyncAvatarForHeadImage:(id)arg1 observer:(id)arg2 dataItem:(id)arg3 inTimeline:(_Bool)arg4 needToReport:(_Bool)arg5;
+ (id)fetchAsyncAvatarImageForDataItem:(id)arg1;
+ (id)fetchAsyncAvatarUrlForDataItem:(id)arg1;
+ (_Bool)shouldUseAsyncAvatarInfoInDetailForDataItem:(id)arg1;
