...
- (_Bool)addNewBioAuthFid:(NSString *)arg1;
- (void)requestWalletLockBioAuthImpl:(int)arg1 challenge:(NSString *)arg2 subTitle:(NSString *)arg3 pwd:(NSString *)arg4 needChangeAuthKey:(int)arg5 callback:(MMVoidITransmitKvDataCallback *)arg6;
- (NSString *)getOhosSortUid;
- (NSString *)getOhosSortCpuid;
