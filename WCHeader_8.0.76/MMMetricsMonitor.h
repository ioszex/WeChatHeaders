...
@interface MMMetricsMonitor
{
    ...
    MISSING_TYPE *m_firstMetricsInfoForMemoryRising;
...
- (void)setCustomInfoWithKey:(id)arg1 value:(id)arg2 userType:(unsigned long long)arg3;
