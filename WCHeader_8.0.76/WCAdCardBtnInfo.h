...
@interface WCAdCardBtnInfo : NSObject
{
    ...
    WCAdGamePlayableInfo *_adGamePlayableInfo;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool canShowCommonMoreBtn; // @synthesize canShowCommonMoreBtn=_canShowCommonMoreBtn;
@property(nonatomic) _Bool notAppendParamsToActionLink; // @synthesize notAppendParamsToActionLink=_notAppendParamsToActionLink;
@property(nonatomic) _Bool finderLiveShowProduct; // @synthesize finderLiveShowProduct=_finderLiveShowProduct;
...
@property(retain, nonatomic) WCAdGamePlayableInfo *adGamePlayableInfo; // @synthesize adGamePlayableInfo=_adGamePlayableInfo;
...
@property(nonatomic) _Bool isGamePlayable; // @synthesize isGamePlayable=_isGamePlayable;
