...
@class EcsJumpInfo, FinderShopCouponInfo_AcquireInfo, FinderShopCouponInfo_Condition, FinderShopCouponInfo_CouponPromoteMoneyOffExtraInfo, FinderWindowProductInfo, NSString;
...
@property(retain, nonatomic) EcsJumpInfo *activityJumpInfo; // @dynamic activityJumpInfo;
...
@property(nonatomic) _Bool hasRestrictDetail; // @dynamic hasRestrictDetail;
...
@property(retain, nonatomic) EcsJumpInfo *restrictJumpInfo; // @dynamic restrictJumpInfo;
@property(nonatomic) unsigned int restrictType; // @dynamic restrictType;
@property(retain, nonatomic) NSString *restrictWording; // @dynamic restrictWording;
