...
@class MMUIButton, MMUIImageView, MMUILabel, NSString, NSURLConnection, TPVideoFrameBuffer, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UITopTouchView, WAMediaCastingRoutePickerController, WANativeViewTexture, WAPlayerHttpMediaWrap, WAScreenBrightnessStateView, WAVideoLayer, WCNetworkMediaSlider, WCPlayerPlayArgs, WCPlayerView;
...
@interface WAVideoPlayerView
{
    ...
    _Bool _keepBackgroundPlaybackAfterEnd;
    _Bool _autoSystemPipWhenRequestPlayback;
    _Bool _nativeViewUseTexture;
    _Bool _preferredBackgroundPlayback;
...
@property(nonatomic) _Bool preferredBackgroundPlayback; // @synthesize preferredBackgroundPlayback=_preferredBackgroundPlayback;
...
@property(nonatomic) _Bool autoSystemPipWhenRequestPlayback; // @synthesize autoSystemPipWhenRequestPlayback=_autoSystemPipWhenRequestPlayback;
@property(nonatomic) _Bool keepBackgroundPlaybackAfterEnd; // @synthesize keepBackgroundPlaybackAfterEnd=_keepBackgroundPlaybackAfterEnd;
...
- (void)updateSystemPIPStatusIfNeeded:(_Bool)arg1;
- (_Bool)enableSystemPIP;
...
- (void)resetPlayerViewSuperview;
- (struct CGRect)aspectFittedRectForVideoSize:(struct CGSize)arg1 inContainer:(struct CGSize)arg2;
...
- (void)dealloc;
- (void)setReportBizScene:(id)arg1;
- (void)destroyPlayer;
