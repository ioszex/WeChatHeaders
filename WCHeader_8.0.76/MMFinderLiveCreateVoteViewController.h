...
@interface MMFinderLiveCreateVoteViewController
{
    ...
    MMFinderLiveLiveVoteItem *_prefillItem;
}

+ (id)createVoteViewControllerWithTaskId:(id)arg1 prefillItem:(id)arg2 successBlock:(CDUnknownBlockType)arg3;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveLiveVoteItem *prefillItem; // @synthesize prefillItem=_prefillItem;
