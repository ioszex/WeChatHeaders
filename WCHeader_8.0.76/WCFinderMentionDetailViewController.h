...
@class NSString, WCFinderCommentDetailViewController, WCFinderCreateCoordinator, WCFinderFeedListView, WCFinderMentionDetailVCParams, WCFinderShareCustomTransition, WCFinderShareListReportModel;
...
- (int)finderFeedListViewTLFollowEnterType:(id)arg1;
