...
@property(retain) NSNumber *originalVideoFileSize; // @synthesize originalVideoFileSize=_originalVideoFileSize;
...
- (id)getEditVideoAttr;
- (void)updateEditImageAttr:(id)arg1;
- (id)getEditImageAttr;
- (_Bool)getIsEdited;
- (_Bool)isAiEdited;
...
- (_Bool)isYuanBaoMakeImageToLivePhoto;
- (_Bool)isAVIF;
- (_Bool)isGif;
- (_Bool)isPicture;
- (double)longitude;
