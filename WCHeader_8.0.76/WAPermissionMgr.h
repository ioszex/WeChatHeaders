...
- (id)opSwitchListFromResponse:(id)arg1;
...
- (_Bool)shouldUpdateSiderbarHistoryItem:(id)arg1;
...
- (id)generateLaunchCGIUserInfo:(id)arg1 debugMode:(unsigned int)arg2 enterScene:(unsigned int)arg3 sessionId:(id)arg4 isFromBackground:(_Bool)arg5 isSilentOpen:(_Bool)arg6 silentOpenType:(unsigned int)arg7 isSheetMode:(_Bool)arg8 isCustomLoading:(_Bool)arg9 launchMode:(unsigned int)arg10 migrateFromUsername:(id)arg11;
...
- (int)getCommRequestSourceSyncTypeForLaunchRequestType:(int)arg1 isDirectGame:(_Bool)arg2;
