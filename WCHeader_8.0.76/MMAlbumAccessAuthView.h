...
@interface MMAlbumAccessAuthView : UIView
{
    ...
    MMUIButton *_goAuthButton;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool showWechatAuthStyle; // @synthesize showWechatAuthStyle=_showWechatAuthStyle;
@property(retain, nonatomic) MMUIButton *goAuthButton; // @synthesize goAuthButton=_goAuthButton;
...
- (void)layoutSubviews;
- (void)initViewForSystemDenied;
- (void)initViewForPhotoAccessLimited;
