...
+ (void)notifyChatBotAmoebaMiniAppTakeOverWinEvent:(id)arg1 eventId:(id)arg2 sessionId:(id)arg3 appId:(id)arg4 winExitType:(long long)arg5;
+ (void)notifyChatBotAmoebaMiniAppInterruptWithType:(long long)arg1 sessionId:(id)arg2 appId:(id)arg3;
...
+ (_Bool)isNativeViewUseTexture:(id)arg1;
+ (id)createNativeViewWithName:(id)arg1;
+ (unsigned long long)getChatTypeWithChatUsername:(id)arg1;
+ (id)flutterRevision;
