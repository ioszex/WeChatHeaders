...
@class CustomVisualEffectView, MMTimer, NSCondition, NSDictionary, NSHashTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PriorityArray, UINavigationController, UIView, UIViewController, UIVisualEffectView, WAAfterLaunchHandlerObjC, WAAppOpenParameter, WAAppTansitionController, WAAppTaskCapsuleMenu, WAAppTaskExtInfo, WAAppTaskHandlerWrapper, WAAppTaskLifeCycleRecord, WAAppTaskLoader, WAAppTaskReferrerInfo, WAAppTaskRunningStateEnterBackgroundContext, WAAppTaskShowFromBackgroundContext, WAAppTaskSplashADConfig, WAAppTaskSystemCoverView, WAApptaskPublicResLogic, WABrandTitleBar, WAColdLaunchPreFetchCGILogic, WAContact, WAFPSMonitor, WAIpadAdaptLogic, WAJSCoreService, WAOpConfigSkylinePath, WAPackageConfig, WAPerformanceIndexObject, WAPermissionHandler, WAPopOverTaskBarlogic, WAPopOverView, WAPreloadAppTask, WARemoteDebugger, WARunningModeParameter, WASkylineRuntimeInfo, WASubscriptionMessageLogic, WAThreadSafeMutableDictionary, WAUINavigationController, WAWebViewController, WAWebViewPageMgr, WMPFLaunchTipView, WxaExternalInfo, _TtC9WeAppCore14WASiderbarView, _TtC9WeAppCore15WASiderbarLogic, _TtC9WeAppCore20WAAfterLaunchHandler, _TtC9WeAppCore23WAHumanActionDetectView;
...
@interface WAAppTask : NSObject
{
    ...
    _Bool _sheetModeForceDisableDragExpandGesture;
    _Bool _isSheetModeDragging;
    _Bool _siderbarFlag;
    NSString *_lastHitTestReportVCTreeWithAddress;
    _Bool _backgroundMusic;
    _Bool _isSpecializedAgentVisible;
    _Bool _specializedAgentSheetActive;
    _Bool _agentSheetBlockingHostGestures;
    ...
    _Bool _shouldRecoverLastGameIfHaveAfterDismiss;
    _Bool _canTriggerMultiTaskGesture;
    _Bool _markIgnoreEnterForegroundEvent;
    _Bool _globalMuted;
    _Bool _bgAudioMode;
    _Bool _bgVoipMode;
    ...
    _Bool _hasBeenFormalLaunched;
    _Bool _siderbarExitSnapshotPreparedBeforeExit;
    _Bool _isWaitingForAgentOpen;
    _Bool _viewEmbeddedModeRotating;
    _Bool _isSkylineValid;
    _Bool _isSkylineDefault;
    _Bool _canSwitchRender;
    _Bool _launchVcInited;
    _Bool _foundOpConfigInPackage;
    _Bool _hasCalculateFoundOpConfigInPackage;
    ...
    unsigned int _navigatePaymentTimestamp;
    ...
    id _specializedAgentSheet;
    WAUINavigationController *_specializedAgentSheetHostNav;
    long long _specializedAgentTransitionStyle;
    ...
    NSMutableArray *_cachedAuxiliaryStacks;
    ...
    NSString *_navigatePaymentTraceId;
    NSString *_navigatePaymentTargetAppId;
    WASubscriptionMessageLogic *_subscriptLogic;
    CDUnknownBlockType _humanInterventionAction;
    NSMutableArray *_loadingToastFinishedBlocks;
    UIView *_headlessContainerView;
    CDUnknownBlockType _onAppRouteBlock;
    ...
    _TtC9WeAppCore23WAHumanActionDetectView *_humanActionDetectView;
    NSMutableSet *_downloadedPluginAppid;
    NSMutableSet *_setLoadedInfoDatas;
    _TtC9WeAppCore20WAAfterLaunchHandler *_afterLaunchHandler;
    NSMutableDictionary *_dicJSEventListened;
    WAAfterLaunchHandlerObjC *_afterLaunchHandlerObjC;
    WAAppTaskLoader *_childPageAppLoader;
    WAAppTaskLoader *_asyncUpdateAppLoader;
    ...
    _TtC9WeAppCore15WASiderbarLogic *_siderbarLogic;
    _TtC9WeAppCore14WASiderbarView *_siderbarView;
    unsigned long long _siderbarExitSnapshotRequestID;
    ...
    unsigned long long _coldLaunchFinishTimeInMs;
    NSHashTable *_unmutedlivePlayerHashTable;
    ...
    WAOpConfigSkylinePath *_opConfigSkylinePathAll;
    NSMutableDictionary *_opConfigSkylinePathDic;
    NSMutableDictionary *_bizDataPipeHandlerDic;
    WASkylineRuntimeInfo *_skylineRuntimeInfo;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(retain, nonatomic) WASkylineRuntimeInfo *skylineRuntimeInfo; // @synthesize skylineRuntimeInfo=_skylineRuntimeInfo;
...
@property(nonatomic) _Bool hasCalculateFoundOpConfigInPackage; // @synthesize hasCalculateFoundOpConfigInPackage=_hasCalculateFoundOpConfigInPackage;
@property(nonatomic) _Bool foundOpConfigInPackage; // @synthesize foundOpConfigInPackage=_foundOpConfigInPackage;
@property(retain, nonatomic) NSMutableDictionary *opConfigSkylinePathDic; // @synthesize opConfigSkylinePathDic=_opConfigSkylinePathDic;
@property(retain, nonatomic) WAOpConfigSkylinePath *opConfigSkylinePathAll; // @synthesize opConfigSkylinePathAll=_opConfigSkylinePathAll;
...
@property(nonatomic) _Bool isWaitingForAgentOpen; // @synthesize isWaitingForAgentOpen=_isWaitingForAgentOpen;
@property(retain, nonatomic) NSHashTable *unmutedlivePlayerHashTable; // @synthesize unmutedlivePlayerHashTable=_unmutedlivePlayerHashTable;
- (void)setColdLaunchFinishTimeInMs:(unsigned long long)arg1;
- (unsigned long long)coldLaunchFinishTimeInMs;
...
@property(nonatomic) _Bool siderbarExitSnapshotPreparedBeforeExit; // @synthesize siderbarExitSnapshotPreparedBeforeExit=_siderbarExitSnapshotPreparedBeforeExit;
@property(nonatomic) unsigned long long siderbarExitSnapshotRequestID; // @synthesize siderbarExitSnapshotRequestID=_siderbarExitSnapshotRequestID;
@property(retain, nonatomic) _TtC9WeAppCore14WASiderbarView *siderbarView; // @synthesize siderbarView=_siderbarView;
@property(retain, nonatomic) _TtC9WeAppCore15WASiderbarLogic *siderbarLogic; // @synthesize siderbarLogic=_siderbarLogic;
...
@property(retain, nonatomic) WAAppTaskLoader *asyncUpdateAppLoader; // @synthesize asyncUpdateAppLoader=_asyncUpdateAppLoader;
@property(retain, nonatomic) WAAppTaskLoader *childPageAppLoader; // @synthesize childPageAppLoader=_childPageAppLoader;
@property(retain, nonatomic) WAAfterLaunchHandlerObjC *afterLaunchHandlerObjC; // @synthesize afterLaunchHandlerObjC=_afterLaunchHandlerObjC;
...
@property(retain, nonatomic) NSMutableSet *setLoadedInfoDatas; // @synthesize setLoadedInfoDatas=_setLoadedInfoDatas;
@property(retain, nonatomic) NSMutableSet *downloadedPluginAppid; // @synthesize downloadedPluginAppid=_downloadedPluginAppid;
@property(nonatomic) _Bool hasBeenFormalLaunched; // @synthesize hasBeenFormalLaunched=_hasBeenFormalLaunched;
@property(nonatomic) _Bool hasBeenFullLaunched; // @synthesize hasBeenFullLaunched=_hasBeenFullLaunched;
@property(retain, nonatomic) _TtC9WeAppCore23WAHumanActionDetectView *humanActionDetectView; // @synthesize humanActionDetectView=_humanActionDetectView;
...
@property(nonatomic) _Bool markIgnoreEnterForegroundEvent; // @synthesize markIgnoreEnterForegroundEvent=_markIgnoreEnterForegroundEvent;
@property(nonatomic) _Bool canTriggerMultiTaskGesture; // @synthesize canTriggerMultiTaskGesture=_canTriggerMultiTaskGesture;
@property(copy, nonatomic) CDUnknownBlockType onAppRouteBlock; // @synthesize onAppRouteBlock=_onAppRouteBlock;
@property(retain, nonatomic) UIView *headlessContainerView; // @synthesize headlessContainerView=_headlessContainerView;
@property(retain, nonatomic) NSMutableArray *loadingToastFinishedBlocks; // @synthesize loadingToastFinishedBlocks=_loadingToastFinishedBlocks;
@property(copy, nonatomic) CDUnknownBlockType humanInterventionAction; // @synthesize humanInterventionAction=_humanInterventionAction;
@property(nonatomic) __weak WASubscriptionMessageLogic *subscriptLogic; // @synthesize subscriptLogic=_subscriptLogic;
@property(nonatomic) unsigned int navigatePaymentTimestamp; // @synthesize navigatePaymentTimestamp=_navigatePaymentTimestamp;
@property(copy, nonatomic) NSString *navigatePaymentTargetAppId; // @synthesize navigatePaymentTargetAppId=_navigatePaymentTargetAppId;
@property(copy, nonatomic) NSString *navigatePaymentTraceId; // @synthesize navigatePaymentTraceId=_navigatePaymentTraceId;
@property(nonatomic) _Bool shouldRecoverLastGameIfHaveAfterDismiss; // @synthesize shouldRecoverLastGameIfHaveAfterDismiss=_shouldRecoverLastGameIfHaveAfterDismiss;
...
@property(retain, nonatomic) NSMutableArray *cachedAuxiliaryStacks; // @synthesize cachedAuxiliaryStacks=_cachedAuxiliaryStacks;
...
@property(nonatomic) long long specializedAgentTransitionStyle; // @synthesize specializedAgentTransitionStyle=_specializedAgentTransitionStyle;
@property(nonatomic) _Bool agentSheetBlockingHostGestures; // @synthesize agentSheetBlockingHostGestures=_agentSheetBlockingHostGestures;
@property(nonatomic) _Bool specializedAgentSheetActive; // @synthesize specializedAgentSheetActive=_specializedAgentSheetActive;
@property(nonatomic) __weak WAUINavigationController *specializedAgentSheetHostNav; // @synthesize specializedAgentSheetHostNav=_specializedAgentSheetHostNav;
@property(retain, nonatomic) id specializedAgentSheet; // @synthesize specializedAgentSheet=_specializedAgentSheet;
@property(nonatomic) _Bool isSpecializedAgentVisible; // @synthesize isSpecializedAgentVisible=_isSpecializedAgentVisible;
...
- (void)newPopChildrenAndSwitchInMainTabWebView:(id)arg1 currentWebView:(id)arg2 withPagePath:(id)arg3 routeId:(id)arg4;
- (void)popChildrenAndSwitchInMainTabWebView:(id)arg1 currentWebView:(id)arg2 withPagePath:(id)arg3 routeId:(id)arg4;
- (void)directSwitchInMainTabWebView:(id)arg1 withPagePath:(id)arg2 routeId:(id)arg3 forceRouteEvent:(_Bool)arg4;
- (void)switchInMainTabWebView:(id)arg1 pagePath:(id)arg2 currentWebView:(id)arg3 routeId:(id)arg4 forceRouteEvent:(_Bool)arg5;
- (void)popAllAndCreateTabWebViewWithURL:(id)arg1 currentWebView:(id)arg2 routeId:(id)arg3;
- (void)switchTabWithURL:(id)arg1 pagePath:(id)arg2 currentWebView:(id)arg3 routeId:(id)arg4 forceRouteEvent:(_Bool)arg5;
- (void)switchTabWithURL:(id)arg1 pagePath:(id)arg2 currentWebView:(id)arg3 routeId:(id)arg4;
...
- (id)getCapsuleMenu;
- (struct CGRect)getCapsuleMenuOriginalFrameRelativeToViewWithAgentButton:(id)arg1;
...
- (void)navigationControllerViewDidBeDismissed:(id)arg1;
- (void)navigationControllerViewWillBeDismissed:(id)arg1;
...
- (void)setupSiderbarViewActions;
- (void)showSiderbarView:(long long)arg1;
- (void)handleSwipeLeft:(id)arg1;
- (_Bool)canShowSiderbar;
- (void)saveCurrentSnapshotIfNeeded;
- (void)prepareSiderbarSnapshotBeforeOpenTaskWithCompletion:(CDUnknownBlockType)arg1;
- (void)prepareSiderbarSnapshotBeforeExitWithCompletion:(CDUnknownBlockType)arg1;
- (void)prepareGameSiderbarSnapshotWithWaitTimeout:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (void)saveCurrentWebSiderbarSnapshot;
- (void)requestAndSaveGameSiderbarSnapshotWithViewController:(id)arg1 username:(id)arg2 debugModeType:(unsigned long long)arg3;
- (void)requestGameSiderbarSnapshotWithViewController:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (id)currentGameSiderbarSnapshotViewController;
- (void)saveSiderbarSnapshotImage:(id)arg1 username:(id)arg2 debugModeType:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)updateExistingWindowMinimizeTaskSnapshotWithSiderbarImage:(id)arg1 username:(id)arg2;
- (void)saveSiderbarSnapshotImage:(id)arg1 username:(id)arg2 debugModeType:(unsigned long long)arg3;
...
- (void)setAgentSlotIndexToEnd;
- (void)openAgentPageWithContext:(id)arg1 openAgentScene:(unsigned long long)arg2 pushCompletion:(CDUnknownBlockType)arg3 contextReadyCompletion:(CDUnknownBlockType)arg4;
- (void)openAgentPageWithContext:(id)arg1 openAgentScene:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)openAgentPageWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)openAgentPageWithContext:(id)arg1;
- (void)handleAgentButtonClick;
- (void)onMenuAgentClickSpecializedAgentFromSecondaryCapsule;
- (void)onMenuAgentClickSpecializedAgent;
- (void)openMiniToolCreatorTool;
- (void)updateSpecializedAgentButtonForViewController:(id)arg1;
- (_Bool)hasAgentHalfScreen;
- (id)getSpecializedAgentSessionId;
- (id)buildFullNavigationStack;
- (void)updateSpecializedAgentStateForViewController:(id)arg1 inNav:(id)arg2;
- (void)updateAgentSlotIndexInNav:(id)arg1;
- (_Bool)isSpecializedAgentViewController:(id)arg1;
- (void)onMenuAgentTipsButtonChanged:(_Bool)arg1;
- (void)onMenuAgentTipsButtonAdded;
- (void)onMenuExit:(long long)arg1;
- (void)resetSiderbarExitSnapshotPreparation;
- (void)continueMenuExitWithAction:(long long)arg1;
- (void)onMenuMore;
...
- (void)onJSEventEndWithResult:(id)arg1 handler:(id)arg2;
...
- (_Bool)isAgentRelatedScene:(unsigned long long)arg1;
- (void)resumeAgentTask;
- (void)resetExternalInfoSourceForAgentMode;
- (void)markExternalInfoSourceForAgentMode;
- (void)showAgentTakeoverTips;
- (void)showAgentPauseTips;
- (void)onTapHumanActionDetectView:(id)arg1;
- (void)addHumanActionDetectViewIfNeeded;
- (_Bool)isLoadingToastExsist;
- (void)presentNextWithStack:(id)arg1 indexValue:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)presentSnapshotStack:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)resetHeadlessStateAndDismissAgentPage;
- (_Bool)restoreFromHeadlessFromPresentingViewController:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)attemptToPresentWeappNavControllerIfInAgentMode:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)moveNavigationControllerToHeadless;
- (void)dismissNavigationControllerToHeadless;
- (void)configAgentModeAfterLaunch;
- (void)configAgentModeBeforeLaunch;
- (_Bool)isHeadless;
- (void)evaluateJavaScriptInIsolateContext:(id)arg1 timeout:(double)arg2 completion:(CDUnknownBlockType)arg3;
- (id)foregroundPage;
- (id)backgroundPages;
- (id)allPages;
...
- (_Bool)shouldEnterForegroundAfterDismissSheetWeAppTask:(id)arg1;
- (_Bool)isCoveredByOtherViewControllerForSheetDismiss:(id)arg1;
- (_Bool)isViewController:(id)arg1 forSheetWeAppTaskAppId:(id)arg2;
...
- (_Bool)isWebViewCurrentNavStackBottom:(id)arg1;
...
- (void)asyncUpdateWithContact:(id)arg1;
...
- (void)onUpdateDebugNotifyInfo:(id)arg1;
...
- (void)webView:(id)arg1 pageRouteDownloadedInfoDatas:(id)arg2 beginTime:(unsigned long long)arg3 endTime:(unsigned long long)arg4;
- (id)getLockInfoDataForLoadedPluginIfHave:(id)arg1;
...
- (_Bool)isInfoDataLoaded:(id)arg1;
- (void)addLoadedInfoData:(id)arg1;
...
- (_Bool)shouldMinimizeCurTaskByWindowTask;
...
- (unsigned int)wxaagentEntranceFlag;
- (_Bool)shouldShowMenuAgentButton;
...
- (void)reportOpenChildWebViewError:(unsigned int)arg1 relativeURL:(id)arg2 useNewStack:(_Bool)arg3;
...
- (void)createCodeCacheForEvaluatedScriptAfterAyncUpdateGotNewContact:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)getMagicBrushVConsoleContainerView;
- (void)printConsoleLog:(id)arg1;
- (id)GetWeAppPluginIfExist:(id)arg1;
...
- (void)closeTask;
- (void)dismissAuxiliaryStacksIfNeeded;
...
- (_Bool)isUsingMiniToolPreviewMode;
...
- (id)genStateChangedEventWithPlatformType:(unsigned long long)arg1 direction:(unsigned long long)arg2 reason:(unsigned int)arg3 executeDelayToForegroundJSAPI:(_Bool)arg4;
- (id)genSilentOpenServiceEvent;
- (void)silentOpenServiceTriggerEnterBackground;
- (void)setTaskPlatformState:(unsigned long long)arg1 reason:(unsigned int)arg2 executeDelayToForegroundJSAPI:(_Bool)arg3;
...
- (void)enterForeground:(_Bool)arg1 targetRelativeURL:(id)arg2;
- (void)enterForeground:(_Bool)arg1;
- (void)enterForegroundIfNeed:(_Bool)arg1;
- (void)enterForegroundIfNeed;
- (_Bool)shouldEnterForeground;
- (_Bool)shouldSendEnterForegroundEventToServiceWhenHotLaunch;
- (_Bool)isFirstWebViewHasNavStackPresented;
- (_Bool)isFirstWebViewOnForeground;
- (void)onBackFromTransparentLiteApp;
- (void)onJumpToTransparentLiteApp:(id)arg1;
...
- (void)taskEnterForeground:(long long)arg1 executeDelayToForegroundJSAPI:(_Bool)arg2;
...
- (id)calcSafeAreaForSheetMode;
- (id)getSystemInfoForSheetMode;
- (id)getSystemInfo;
...
- (void)handleAfterLaunchCgiPassThroughInfo:(id)arg1;
- (void)onAfterLaunchFinished;
- (void)onCommentLowScoreBannerShouldShow:(_Bool)arg1;
- (id)getRecommendDishBuffer;
- (void)onCommentDishTips:(id)arg1 iconUrlInDarkMode:(id)arg2 text:(id)arg3;
...
- (void)appServiceSendOnEnterForeground:(id)arg1 isFromSystemAwake:(_Bool)arg2 useNewNavStack:(_Bool)arg3;
...
- (void)sendAppRouteEventFromWebView:(id)arg1 openType:(unsigned long long)arg2 extraInfo:(id)arg3;
- (void)sendAppRouteEventFromWebView:(id)arg1 openType:(unsigned long long)arg2;
- (void)checkIfResendAppRouteDoneEventFromAppRouteWebview:(id)arg1;
- (void)checkSendAppRouteDoneEventFromWebView:(id)arg1;
...
- (void)didSendOnAppRouteEventForWebView:(id)arg1 openType:(unsigned long long)arg2 param:(id)arg3;
- (void)willSendOnAppRouteEventForWebView:(id)arg1 openType:(unsigned long long)arg2 param:(id)arg3;
- (void)setupAppServiceWithContact:(id)arg1 extraInfo:(id)arg2 preloadedAppService:(id)arg3 isGamePowerMode:(_Bool)arg4;
...
- (long long)currentMenuMutationTypeForWebView:(id)arg1;
...
- (void)setForceDisableDragExpandGestureInSheetMode:(_Bool)arg1;
...
- (void)updateChatToolChatRoomInfos:(id)arg1;
- (void)openChatToolAllPage:(id)arg1;
- (void)openChatToolSubpackage:(id)arg1 pagePath:(id)arg2;
- (void)openChatToolPage:(id)arg1 chatToolMaterials:(id)arg2;
- (_Bool)isRunningInChatToolAllPageMode;
- (_Bool)isRunningInChatToolPageMode;
- (_Bool)isRunningInChatToolSubpackageMode;
...
- (void)injectRemoteDebugToServiceIfNeeded:(CDUnknownBlockType)arg1;
...
- (void)webviewApiResult:(id)arg1 handler:(id)arg2;
...
- (void)sendThirdJSEventToService:(id)arg1 eventParams:(id)arg2;
...
- (id)sendNavigateBackToStackPreviousWebViewWhenDismissingStack:(id)arg1 enterBackground:(_Bool)arg2 action:(long long)arg3;
- (void)directlyDismissStackInstanceFromWebView:(id)arg1 enterBackground:(_Bool)arg2 action:(long long)arg3;
- (id)dismissCurrentStackInstanceThenEnterBackgroundIfNeedFromWebView:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (id)dismissCurrentStackInstanceThenEnterBackgroundIfNeedFromWebView:(id)arg1 animated:(_Bool)arg2;
- (void)exitToBackgroundFromWebView:(id)arg1 action:(long long)arg2 extraDataIfHave:(id)arg3 privateExtraDataIfHave:(id)arg4 fromNavigateBackWeApp:(_Bool)arg5;
...
- (void)removeWebviewFromWebview:(id)arg1 popToWebview:(id)arg2 popToIndex:(unsigned long long)arg3 animated:(_Bool *)arg4;
- (id)popWebViewCount:(int)arg1 fromWebView:(id)arg2 skipIntermediate:(_Bool)arg3 mixedStack:(_Bool)arg4 animated:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
- (id)popWebViewCountMixedStack:(int)arg1 fromWebView:(id)arg2 skipIntermediate:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (id)popWebViewCount:(int)arg1 fromWebView:(id)arg2 skipIntermediate:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)popToWebView:(id)arg1 fromWebView:(id)arg2 skipIntermediate:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)getTabChildWebViewWithRelativeURL:(id)arg1 extraInfo:(id)arg2 fromWebView:(id)arg3;
...
- (_Bool)checkEnterForegroundIfWebviewIsTopAppearVC:(id)arg1;
- (void)webView:(id)arg1 receiveHitTest:(id)arg2;
- (void)observePresentedVCWithNoLifeCycleCallbackDisappear:(id)arg1 didPresent:(id)arg2;
...
- (void)restoreCachedAuxiliaryStacksIfNeeded;
- (void)popStackInstanceToNav:(id)arg1;
- (id)getStackIntanceForNav:(id)arg1;
- (id)getTopStackWebView;
- (id)getTopStackInstance;
- (_Bool)isNavAlreadyInStackInstance:(id)arg1;
- (id)getPreviousStackInstanceInStackInstances:(id)arg1;
- (id)getBeforeNavInStackInstances:(id)arg1;
- (_Bool)isBeforeNavInStackInstancesDisplaying:(id)arg1;
- (_Bool)hasMultiStackInstances;
- (id)getNavStackInstanceWithWebviewVC:(id)arg1;
...
- (id)getTabChildWebViewWithRelativeURL:(id)arg1 extraInfo:(id)arg2 fromParentWebView:(id)arg3;
...
- (void)onWANavigationControllerInsertToHeadless:(id)arg1;
- (void)insertHeadlessWebViewFromBackground:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showWebViewFromBackground:(id)arg1 presentingViewController:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)recoverAgentStackIfNeeded;
- (void)didFinishLaunch;
- (void)didFinishHotLaunch;
- (void)didFinishColdLaunch;
- (void)didFinishReLaunch;
- (void)realBackgroundPrefetchDataWithLocationWithReportItem:(id)arg1;
- (void)realBackgroundPrefetchDataWithReportItem:(id)arg1;
...
- (void)onDidPushChildWebView:(id)arg1 animated:(_Bool)arg2;
...
- (void)updateEnterScene:(unsigned int)arg1;
...
- (void)getCurrentCaptureImageForMinimizedAsync:(CDUnknownBlockType)arg1;
- (id)getBackgroundPlaybackCaptureImageForMinimized;
...
- (void)openFirstWebViewWithRelativeURL:(id)arg1 childExtraInfo:(id)arg2 loaderContextData:(id)arg3 navigationController:(id)arg4 presentingViewController:(id)arg5 errorHandler:(CDUnknownBlockType)arg6 successHandler:(CDUnknownBlockType)arg7;
...
- (_Bool)shouldKeepContextPageInCycleJump:(_Bool)arg1;
- (_Bool)shouldKeepContextPageInCycleJump;
...
- (_Bool)splashAd_checkForceShowSplashAdWhenHotStart;
...
- (void)removeMinimizeEduWithAnimated:(_Bool)arg1;
- (void)doPopupMinimizeEdu;
- (void)scheduleToPopupMinimizeEdu;
- (void)delayShow:(id)arg1;
- (void)beginMinimizationTansitionAnimationWithGesture:(id)arg1 fromView:(id)arg2 snapshot:(id)arg3 percent:(double)arg4 taskBizKey:(id)arg5;
- (void)beginFirstPageMinimizationTansitionAnimationWithGesture:(id)arg1 percent:(double)arg2 taskBizKey:(id)arg3;
...
- (void)windowMinimizedCurTaskWithGenerateType:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)windowMinimizedCurTaskWithGenerateType:(unsigned long long)arg1;
- (void)updateTaskMinimizedMode:(unsigned long long)arg1;
- (void)manuallyMinimizedCurTaskWithGenerateType:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)statusMinimizedCurTaskWithGenerateType:(unsigned long long)arg1;
- (void)checkCanWindowMinimizeAndThen:(CDUnknownBlockType)arg1;
...
- (_Bool)processMinimizeWindowTaskIfNeeded:(unsigned long long)arg1;
- (_Bool)processMinimizeWindowTaskIfNeeded;
- (_Bool)processMinimizeStatusTaskIfNeeded;
...
- (void)dismissMyselfAndPresentedTasks:(CDUnknownBlockType)arg1;
...
- (_Bool)setAudioActive:(_Bool)arg1 scene:(int)arg2 groupName:(id)arg3 identifier:(id)arg4 options:(unsigned long long)arg5 listener:(id)arg6;
- (void)onGlobalMutedChanged:(_Bool)arg1;
...
- (id)getOpConfigEnableSkylineWithPath:(id)arg1;
- (_Bool)isEnoughMemWithPath:(id)arg1;
- (long long)getOpConfigInPackageWithPath:(id)arg1;
- (void)findOpConfigInPackageIfNeeded;
- (_Bool)useSkylineForPage:(id)arg1 needReport:(_Bool)arg2;
...
- (void)publishJSEventOnWhiteScreenDetectedWithWebview:(id)arg1 scene:(unsigned long long)arg2;
- (void)resolveUsernameWithChatRoomInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)removeLoadingToastFinishBlocks;
- (void)triggerLoadingToastFinishBlocks;
- (id)getAgentSessionId;
- (_Bool)canShowAuthCard;
- (_Bool)isAgentMode;
- (void)markAgentStackSilentForeground:(_Bool)arg1;
- (_Bool)checkJSEventNeedProxyByModel:(id)arg1;
- (_Bool)checkJSEventNeedInterrupt:(id)arg1;
- (_Bool)checkJSEventNeedCallUser:(id)arg1;
- (void)addAgentModeDelayJSEvent:(id)arg1;
- (void)stopAgentModeWithState:(unsigned long long)arg1;
- (void)startAgentModeWithSessionId:(id)arg1;
- (void)routeToPage:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getCDPOuterHTMLWithCompletionHandler:(void (^)(NSString *))arg1;
- (void)saveWebViewHTMLToFileWithCompletionHandler:(void (^)(NSString *))arg1;
