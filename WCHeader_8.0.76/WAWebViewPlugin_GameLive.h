...
@class MMGameAudioMixWrapper, MMGameOffTexture, NSHashTable, NSString;
...
@interface WAWebViewPlugin_GameLive
{
    ...
    _Bool _frameTapForceCapturing;
    CDUnknownBlockType _closeBlock;
    MMGameAudioMixWrapper *_mixWrapper;
    MMGameOffTexture *_offTexture;
    NSHashTable *_frameTapDelegates;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool frameTapForceCapturing; // @synthesize frameTapForceCapturing=_frameTapForceCapturing;
@property(retain, nonatomic) NSHashTable *frameTapDelegates; // @synthesize frameTapDelegates=_frameTapDelegates;
...
- (_Bool)forceEnableCaptureForFrameTap:(_Bool)arg1;
- (void)dispatchFrameToTapDelegates:(struct __CVBuffer *)arg1 width:(unsigned int)arg2 height:(unsigned int)arg3;
- (void)removeFrameTapDelegate:(id)arg1;
- (void)addFrameTapDelegate:(id)arg1;
