...
+ (multimap_0af93965)keywordHiglightFrameInStyleArray:(id)arg1;
+ (_Bool)isFinderKeywordJumpUrl:(id)arg1;
+ (int)contextCommentSceneFromView:(id)arg1;
+ (void)extStatsReportCommentJumpInfo:(id)arg1 actionType:(unsigned long long)arg2 commentScene:(int)arg3 refDataItem:(id)arg4;
...
- (id)_displayTitleIconForKeywordId:(id)arg1;
...
- (id)_parseTitleXMLForString:(id)arg1 targetKeywordIdString:(id)arg2;
- (id)parseTitleXMLForString:(id)arg1 targetKeywordId:(unsigned long long)arg2;
- (id)parseTitleXMLForString:(id)arg1;
