...
@class LinkBizSchemeWrap, LinkWeAppJumpWrap, NSString, UIColor;
...
@interface LinkAnchorParser
{
    ...
    LinkBizSchemeWrap *_bizSchemeWrap;
    _Bool _isNativeWeApp;
}

+ (id)stringByStrippingWCCustomLink:(id)arg1;
...
- (struct _NSRange)rangeOfWCCustomLinkInString:(id)arg1 withRange:(struct _NSRange)arg2;
- (id)init;
