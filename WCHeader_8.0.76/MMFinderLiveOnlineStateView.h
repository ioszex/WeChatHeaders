...
@class FinderJumpInfo, MMFinderLiveFlowCollectionViewLegoAdapter, MMFinderLiveOnlineStateHotCardView, MMFinderLiveOnlineStateRewardCountView, MMFinderLiveOnlineStateSessionInfo, MMFinderLiveOnlineStateTabsView, MMFinderLiveOnlineUserLogic, MMFinderLiveUserStateItem, MMPageSheetAdapter, MMUIActivityIndicatorView, MMWebImageView, NSArray, NSMutableArray, NSString, RichTextView, UICollectionView, UILabel, UIView, WCPinBottomCollectionViewFlowLayout;
...
@interface MMFinderLiveOnlineStateView
{
    ...
    _Bool _hasScheduledDataLoadingTimeout;
...
@property(nonatomic) _Bool hasScheduledDataLoadingTimeout; // @synthesize hasScheduledDataLoadingTimeout=_hasScheduledDataLoadingTimeout;
...
- (void)scheduleDataLoadingTimeoutFallback;
...
- (void)layoutTopGradientView;
- (void)updateTopGradientViewVisibility;
