...
@class CContact, MMTipsViewController, NSCache, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TenpayCertificate, WCPayApplePayAuthorizationLogic, WCPayAuthenticationPay, WCPayAuthenticationPayVerifySMSStruct, WCPayAvalibleBankCardBinInfo, WCPayBindCardInfo, WCPayBindInfo, WCPayBindInfoSMS, WCPayGPLaunchControlLogic, WCPayLocalCachedData, WCPayNetworkHelper, WCPayPassKitFacade, WCPayRealNameTipsViewController, WCPayResetPasswordInfo, WCRedEnvelopesSendControlLogic, WalletRequestInfo, WxSmCertUtil;
...
@interface WCPayLogicMgr
{
    ...
    WCPayGPLaunchControlLogic *_weakGroupPayControlLogic;
    NSString *_deepLinkForPay;
...
@property(retain, nonatomic) NSString *deepLinkForPay; // @synthesize deepLinkForPay=_deepLinkForPay;
@property(nonatomic) __weak WCPayGPLaunchControlLogic *weakGroupPayControlLogic; // @synthesize weakGroupPayControlLogic=_weakGroupPayControlLogic;
...
- (void)notifyBaseMsgContentViewDidBePoped:(_Bool)arg1;
...
- (void)openCreateCustomHongbaoSkinLiteapp:(id)arg1 imageUrl:(id)arg2 channel:(id)arg3 token:(id)arg4;
- (void)handleHongbaoSchemeUrl:(id)arg1;
- (_Bool)isApplePaySupport;
- (_Bool)isApplePaySupportStatusIsCached;
- (void)initApplePaySupportStatus;
- (void)onServiceInit;
- (void)ImageDidFail:(id)arg1;
- (void)ImageDidLoadWithData:(id)arg1 Url:(id)arg2;
- (void)onWcPayChatInputToolAction:(unsigned long long)arg1 chatUsername:(id)arg2;
- (void)onWCPayWalletChange;
- (void)reloadOfflineCertObjWhenSwitchWallet;
- (void)notifyAllLiteAppForPay:(id)arg1 withData:(id)arg2;
- (void)unregisterLiteAppModuleEventForPay:(id)arg1 withCallbackId:(long long)arg2;
- (long long)registerLiteAppModuleEventForPay:(id)arg1 withCallback:(id)arg2;
...
- (void)UnBindCard:(id)arg1 WCPayPassword:(id)arg2 unbindScene:(int)arg3 SupportQuickBind:(id)arg4;
...
- (void)clearGroupPayLaunchControlLogic;
- (id)getGroupPayLaunchControlLogic;
- (void)holdGroupPayLaunchControlLogic:(id)arg1;
...
- (void)onReceiveF2fHongBaoDistributeNewXml:(id)arg1;
...
- (_Bool)updateLocalAAMsgPaySubType:(unsigned int)arg1 billno:(id)arg2 conversationName:(id)arg3;
- (_Bool)addLocalAASysMsgWithConversationName:(id)arg1 content:(id)arg2 paymsgid:(id)arg3;
- (_Bool)addLocalAAMsgWithConversationName:(id)arg1 content:(id)arg2;
...
- (void)handleOpenPayLiteAppMsg:(id)arg1;
- (void)handleWCPayThirdC2CXMLMessage:(id)arg1;
- (void)handleReceiveNormalHBMsg:(id)arg1;
...
- (void)GetTransferUserName:(id)arg1 payChannel:(long long)arg2 extendInfo:(id)arg3 qrcodeSenderUsername:(id)arg4 scanCodeSessionInfo:(id)arg5 msgID:(id)arg6;
...
- (id)m_reportUUID;
- (void)getWPHKUrlConfig:(long long)arg1 resType:(unsigned int)arg2 subResType:(unsigned int)arg3;
