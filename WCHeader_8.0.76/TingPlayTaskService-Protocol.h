...
@class MMListenCategoryItem, MMListenMusicChatRoomInfo, MMListenSurveyInfo, NSArray, NSData, NSString, TingItem, TingListSourceContext, TingPlayTaskContext;
...
- (MMListenSurveyInfo *)getSurveyInfo;
...
- (void)modifyPlayTaskContext:(TingPlayTaskContext * (^)(TingPlayTaskContext *))arg1;
