...
@interface WCFinderTabPageHeaderView : UIView
{
    ...
    double _responseHorizontalPadding;
}

- (void).cxx_destruct;
@property(nonatomic) double responseHorizontalPadding; // @synthesize responseHorizontalPadding=_responseHorizontalPadding;
...
- (id)tabViewForExtendedHitAtPoint:(struct CGPoint)arg1;
- (id)tabViewForActualBoundsAtPoint:(struct CGPoint)arg1;
- (void)adjustContentOffsetWithTabView:(id)arg1;
- (void)adjustLineViewWithTabView:(id)arg1;
- (void)adjustFrame;
- (void)updateResponseHorizontalPadding;
- (void)resetResponseHorizontalPadding;
- (struct CGRect)hitTestBoundsForTabView:(id)arg1;
- (void)setUpUI;
