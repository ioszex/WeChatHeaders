...
@class CAShapeLayer, MMCursorView, MMMagnifiterView, MMRTCMenuResponder, NSArray, NSMutableArray, NSString, UIColor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UITextLoupeSession;
...
- (void).cxx_destruct;
@property(retain, nonatomic) UITextLoupeSession *loupeSession; // @synthesize loupeSession=_loupeSession;
...
- (void)setRightCursorVisibility:(_Bool)arg1;
...
- (void)turnOffMagnifier;
- (_Bool)shouldUseSystemLoupe;
- (id)highlightTextWithRange:(struct _NSRange)arg1 showCursor:(_Bool)arg2;
- (void)selectAllText;
- (void)selectWithRange:(struct _NSRange)arg1 showSelectMenu:(_Bool)arg2;
- (void)selectWithRange:(struct _NSRange)arg1;
@property(readonly, nonatomic) _Bool isAllSelected;
