...
@class NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PardusSearchRequest, PardusSearchResponse, ProtobufCGIWrap, WebSearchBoxCtrlInfo;
...
@interface FTSWebSearchMgr
{
    ...
    NSMutableSet *_inflightReqTypeBuckets;
    NSMutableDictionary *_trueRecmdDataRequestIDMap;
    NSMutableArray *_searchGuideEventIDArray;
}

+ (_Bool)IsWebRecommendPublishId:(id)arg1;
+ (void)sendSearchGlobalEduCommApi:(id)arg1 sessionId:(id)arg2 scene:(unsigned long long)arg3 type:(unsigned int)arg4 query:(id)arg5 callback:(CDUnknownBlockType)arg6;
+ (id)getWKResourceTmpDir;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *searchGuideEventIDArray; // @synthesize searchGuideEventIDArray=_searchGuideEventIDArray;
@property(retain, nonatomic) NSMutableDictionary *trueRecmdDataRequestIDMap; // @synthesize trueRecmdDataRequestIDMap=_trueRecmdDataRequestIDMap;
@property(retain, nonatomic) NSMutableSet *inflightReqTypeBuckets; // @synthesize inflightReqTypeBuckets=_inflightReqTypeBuckets;
...
- (void)sendWebSearchDataReport:(id)arg1 logid:(unsigned int)arg2 logstring:(id)arg3;
...
- (void)addWebSearchLog:(id)arg1 forLogID:(unsigned int)arg2 isReportNow:(_Bool)arg3 isIgnoreFreq:(_Bool)arg4;
...
- (void)handleGuideCgi:(id)arg1 eventID:(unsigned int)arg2;
...
- (void)cacheRecmdData:(id)arg1 andScene:(unsigned int)arg2 andVersion:(unsigned int)arg3 andBusinessType:(unsigned long long)arg4 andReqType:(long long)arg5;
...
- (void)searchGuideRequest:(id)arg1;
- (void)hotSearchRequest:(id)arg1;
...
- (void)pageRequestEmot:(id)arg1 forceLoad:(_Bool)arg2;
...
- (_Bool)eableDowloadRawData:(_Bool)arg1;
