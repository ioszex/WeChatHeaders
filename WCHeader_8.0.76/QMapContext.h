...
@interface QMapContext : NSObject
{
    ...
    _Bool _userHasSetMinMaxZoomLevel;
    _Bool _internalMaxOverlookingEnable;
    _Bool _keepCenterEnabled;
    _Bool _handDrawMapEnable;
    _Bool _worldTileEnable;
    ...
    double _internalMaxZoomLevel;
    double _internalMinZoomLevel;
    double _userInputMaxZoomLevel;
...
@property(nonatomic) _Bool worldTileEnable; // @synthesize worldTileEnable=_worldTileEnable;
@property(nonatomic) _Bool handDrawMapEnable; // @synthesize handDrawMapEnable=_handDrawMapEnable;
...
@property(nonatomic) _Bool userHasSetMinMaxZoomLevel; // @synthesize userHasSetMinMaxZoomLevel=_userHasSetMinMaxZoomLevel;
@property(nonatomic) double userInputMaxZoomLevel; // @synthesize userInputMaxZoomLevel=_userInputMaxZoomLevel;
@property(nonatomic) double internalMinZoomLevel; // @synthesize internalMinZoomLevel=_internalMinZoomLevel;
@property(nonatomic) double internalMaxZoomLevel; // @synthesize internalMaxZoomLevel=_internalMaxZoomLevel;
...
- (id)getMarkerIDArray:(struct vector<int, std::allocator<int>>)arg1 startIndex:(int)arg2 count:(int)arg3;
...
- (void)handleEngineDrawTextToBitmap:(struct TMBitmapContext *)arg1 text:(unsigned short *)arg2 count:(int)arg3 fontSize:(int)arg4 weight:(int)arg5 density:(float)arg6;
- (struct TMSize)handleEngineCalcTextSizeWithText:(unsigned short *)arg1 count:(int)arg2 fontSize:(int)arg3 weight:(int)arg4;
...
- (double)internalScaleForZoomLevel:(double)arg1 byGesture:(_Bool)arg2;
- (double)zoomLevelForInternalScale:(double)arg1;
- (double)normalizeGestureZoomLevel:(double)arg1;
...
- (double)availableMinZoomLevel:(double)arg1;
- (double)availableInternalMaxZoomLevel;
- (double)availableMaxZoomLevel;
- (void)setHandrawEnable:(_Bool)arg1;
...
- (void)setOverlayInteractive:(int)arg1 enable:(_Bool)arg2;
...
- (void)updateMarkerDisplayLevel:(id)arg1 level:(int)arg2;
...
- (void)updateLocationPriority:(int)arg1 locatorID:(int)arg2;
...
- (void)constructMapMarkerAnnotationInfo:(struct MapMarkerAnnotationInfo *)arg1 withPayload:(id)arg2;
- (void)updateTextMarkerInternal:(id)arg1 withPayload:(id)arg2;
- (id)addTextMarkerInternal:(id)arg1;
- (void)setMarkerOnTop:(id)arg1;
- (void)updateMarkerScale:(id)arg1 scaleValue:(struct CGPoint)arg2;
- (void)modifyMarker:(id)arg1 angle:(double)arg2;
- (void)updateMarkerAnchor:(id)arg1 anchorPoint:(struct CGPoint)arg2;
- (void)updateMarkerImage:(id)arg1 path:(id)arg2 anchor:(struct CGPoint)arg3;
- (void)updateMarkerAlpha:(id)arg1 alphaValue:(double)arg2;
- (void)bindMapMarkerMainRelation:(id)arg1 MainMarker:(id)arg2 BindSyncVisibility:(_Bool)arg3;
...
- (void)configureMarkerWithID:(int)arg1 visibility:(_Bool)arg2 priority:(int)arg3 avoidOtherMarkers:(_Bool)arg4 minZoom:(int)arg5 maxZoom:(int)arg6;
...
- (void)updateTextMarkerCollisionStatus:(id)arg1 avoidAnnotation:(_Bool)arg2 avoidOtherMarker:(_Bool)arg3;
