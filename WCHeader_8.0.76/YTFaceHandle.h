...
- (void)clearAG;
- (long long)initAG:(id)arg1 device:(id)arg2 shapeView:(id)arg3 onDalayCalc:(CDUnknownBlockType)arg4 onFinish:(CDUnknownBlockType)arg5 outputDurationMS:(long long *)arg6 refBigFrameCnt:(int)arg7;
- (void)handleFinish;
