...
@class NSArray, NSNumber, NSString, UIColor, UIFont;
...
@interface WCFinderFeedContentTextViewConfig : NSObject
{
    ...
    _Bool _extendSuffixMaskViewEdges;
    _Bool _truncatedTrailingAlignToEnd;
    _Bool _autoHandleURLLink;
    NSString *_content;
    NSString *_prefix;
...
+ (id)defaultConfig;
- (void).cxx_destruct;
@property(nonatomic) _Bool autoHandleURLLink; // @synthesize autoHandleURLLink=_autoHandleURLLink;
@property(nonatomic) _Bool truncatedTrailingAlignToEnd; // @synthesize truncatedTrailingAlignToEnd=_truncatedTrailingAlignToEnd;
@property(nonatomic) _Bool extendSuffixMaskViewEdges; // @synthesize extendSuffixMaskViewEdges=_extendSuffixMaskViewEdges;
...
@property(retain, nonatomic) NSNumber *suffixViewMargin; // @synthesize suffixViewMargin=_suffixViewMargin;
