...
@class NSString, UIButton, UIImageView, UILabel, UIView, WCFinderHeadImageView, WCFinderInteractionLabelGroupView, WCFinderLikeInfo, WCFinderThanksButton;
...
- (void)layoutUI;
- (void)updateLabelsAndIdentityWithLikeInfo:(id)arg1;
