...
@interface OMJCamoSession : NSObject
{
    ...
    OMJAIGCBridgeService *_aigcBridgeService;
...
@property(readonly, nonatomic) OMJAIGCBridgeService *aigcBridgeService; // @synthesize aigcBridgeService=_aigcBridgeService;
...
- (void)setContentScaleMode:(unsigned long long)arg1;
...
- (int)loadTemplateWithMeta:(id)arg1 loadPriority:(long long)arg2 progressHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)cancelAIGCTaskWithReason:(unsigned long long)arg1;
- (void)notifyAIGCTaskDidCompleted;
- (void)registerAIGCBridgeService:(id)arg1;
...
- (void)beginUseMultiAssetInputWithAssetInfos:(id)arg1 timelineConfig:(id)arg2 outputFilePath:(id)arg3 recordingSettings:(id)arg4 auditCaptureSettings:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)beginUseCameraInputWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)beginUseAssetInputWithAssetInfo:(id)arg1 outputFilePath:(id)arg2 recordingSettings:(id)arg3 auditCaptureSettings:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)capturePhotoThenUseAsInputWithOutputFilePath:(id)arg1 recordingSettings:(id)arg2 auditCaptureSettings:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)setMusicVolumeWithDesc:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)setSegmentationDesc:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)getFilterDesc;
...
- (void)startupWithParams:(id)arg1 usingFrontCamera:(_Bool)arg2 needRunningCaptureSession:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
