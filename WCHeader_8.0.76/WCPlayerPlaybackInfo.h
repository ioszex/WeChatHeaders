...
@interface WCPlayerPlaybackInfo : NSObject
{
    ...
    NSMutableArray *_arrActionEvent;
...
@property(retain, nonatomic) NSMutableArray *arrActionEvent; // @synthesize arrActionEvent=_arrActionEvent;
...
@property(nonatomic) _Bool isAudioModuleActive; // @synthesize isAudioModuleActive=_isAudioModuleActive;
...
- (id)lastActionEventOfType:(unsigned long long)arg1;
- (id)recordActionWithType:(unsigned long long)arg1 extras:(id)arg2;
