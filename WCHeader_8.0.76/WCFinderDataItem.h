...
@class ConcertTicketInfo, FinderCommByPass, FinderExtendedReading, FinderLiveQuickReplyWordingInfo, FinderLocation, FinderMusicInfo, FinderObjectAsyncLoadInfo, FinderObjectExtend, FinderStreamDivider, FinderTipsInfo, FinderTopic, MMFinderLiveGoodsItem, MMLiveAdsParams, MMMusicMVModel, NSArray, NSData, NSMutableArray, NSString, StatusFooterJumpFinderFeed, WCBulletinInfo, WCFinderAttachmentList, WCFinderCommentMutableArray, WCFinderContact, WCFinderDataItemInnerModel, WCFinderDataItemMemberShipModel, WCFinderDataItemRecommendConfiguration, WCFinderDataItemSingleStreamSharedData, WCFinderFeedBindEventInfo, WCFinderFoldLayout, WCFinderFriendsLikeMutableArray, WCFinderJumpInfoContainer, WCFinderLikeMutableArray, WCFinderLiveInfo, WCFinderLocationInfo, WCFinderMedia, WCFinderMegaVideo, WCFinderNativeDramaDataItemContext, WCFinderObjectHotTopicMutableArray, WCFinderObjectHotWordInfo, WCFinderRecommenderMutableArray, WCFinderRedDotTipsShowInfo, WCFinderSnsShareInfo;
...
@interface WCFinderDataItem : NSObject
{
    ...
    WCFinderDataItemSingleStreamSharedData *_streamShareData;
...
+ (void)removeLocalImportAudioPostFileIfNeeded:(id)arg1;
...
@property(retain, nonatomic) WCFinderDataItemSingleStreamSharedData *streamShareData; // @synthesize streamShareData=_streamShareData;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: locationInfo
...
- (_Bool)isAuthorViewerScene:(int)arg1;
- (_Bool)isSelfClubContactPostFeed;
- (_Bool)isSelfPostFeed;
- (_Bool)isAntiAddictionData;
- (_Bool)isColumnData;
- (_Bool)disableThankRecommend;
- (_Bool)hasStreamShareData;
- (id)getThanksRecomendOtherLikeComment:(_Bool)arg1;
...
- (long long)indexOfMediaInfo:(id)arg1;
- (id)getLivePhotoMediaInfoWithIndex:(unsigned long long)arg1 count:(unsigned long long)arg2;
...
- (void)setFeedSubtitleOpen:(_Bool)arg1;
- (_Bool)isFeedSubtitleOpen;
- (_Bool)hasFeedSubtitle;
- (_Bool)shouldFillVideoBackgroundColor;
- (_Bool)shouldIgnoreSessionFilter;
...
- (void)mergeLiveMonotonicData:(id)arg1;
...
- (_Bool)disableAskXiaowei;
- (_Bool)disableFastCommentNewPhoto;
- (_Bool)disableInteractionMilestone;
- (_Bool)isGlobalFav;
- (_Bool)hideFavAction;
- (_Bool)disableFavAction;
- (_Bool)disableCommentEntry;
- (_Bool)disableLikeAction;
- (_Bool)disableCommentImage;
...
@property(readonly, copy, nonatomic) NSString *dupIdentifier;
...
- (_Bool)isFromAdsStream;
- (void)setIsFromAdsStream:(_Bool)arg1;
...
- (id)musicId;
- (id)musicUrl;
@property(readonly, nonatomic) NSArray *coAuthorInvitedAuthors;
@property(readonly, nonatomic) NSArray *allCoAuthorNicknames;
- (id)coAuthorDisplaySuffix;
- (id)coAuthorNicknameContent;
- (unsigned long long)coAuthorCount;
- (id)coAuthorAvatarUrl;
- (_Bool)isCoAuthorLive;
