...
@class MMFinderLiveImagePickerParams, MMNearbyPoiInfo, NSArray, NSMutableDictionary, NSNumber, NSString, UIColor, WCFinderEditOptionModel, WCFinderPickerTemplateParams;
...
@interface MMImagePickerManagerOptionObj
{
    ...
    _Bool _enablePageSheetMode;
    _Bool _enableNewAlbumNavStyle;
    int _previewType;
    int _compressType;
    int _finishWordMode;
    int m_pickerScene;
    ...
    double _pageSheetModeHeight;
    struct _NSRange _selectCountLimit;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool enableNewAlbumNavStyle; // @synthesize enableNewAlbumNavStyle=_enableNewAlbumNavStyle;
@property(nonatomic) double pageSheetModeHeight; // @synthesize pageSheetModeHeight=_pageSheetModeHeight;
@property(nonatomic) _Bool enablePageSheetMode; // @synthesize enablePageSheetMode=_enablePageSheetMode;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: videoQualityType
...
@property(copy, nonatomic) NSString *finishButtonWording; // @synthesize finishButtonWording=_finishButtonWording;
