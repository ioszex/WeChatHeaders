...
@class BypSendEmotionMessageMgr, BypSendMessageMgr, CDownloadVideoMgr, CEmoticonDownloadMgr, CEmoticonUploadMgr, CMessageDB, DownloadImageCDNMgr, DownloadImageMgr, DownloadVideoCDNMgr, ImageUploadUnifyBaseMgr, MessageAssetThreshold, MessagePatternCacheMgr, NSDate, NSMutableArray, NSMutableDictionary, NSNumber, NSObject, NSString, OpenDownloadCDNMgr, OpenDownloadMgr, OpenUploadCDNMgr, OpenUploadMgr, OpenUploadVideoCDNMgr, RecordBaseUploadCDNMgr, RecordDownloadCDNMgr, RoomHistoryDownloadCDNMgr, ThumbDownloadMgr, VideoUploadUnifyMgr;
...
@interface CMessageMgr
{
    ...
    RecordBaseUploadCDNMgr *m_oRecordUploadCDNMgr;
    ...
    unsigned long long _imageMaxDisplaySize;
...
@property(nonatomic) unsigned long long imageMaxDisplaySize; // @synthesize imageMaxDisplaySize=_imageMaxDisplaySize;
...
- (id)getUnreadEcsGiftMsgInSession:(id)arg1 newerThan:(id)arg2;
...
- (void)onUploadBypassRecordFinish:(id)arg1;
...
- (void)StartDownloadRecordData:(id)arg1 DataId:(id)arg2;
- (void)StartDownloadRecordMiddleData:(id)arg1 DataId:(id)arg2;
- (void)StartDownloadRecordThumbData:(id)arg1 DataId:(id)arg2;
...
- (_Bool)IsNonQuotaDownloading:(id)arg1 MsgWrap:(id)arg2;
...
- (id)GetVerticalSearchNextMsgs:(id)arg1 StartCreateTime:(unsigned int)arg2 EndCreateTime:(unsigned int)arg3 Limit:(int)arg4 needFullMessage:(_Bool)arg5;
- (id)GetVerticalSearchLastMsgs:(id)arg1 StartCreateTime:(unsigned int)arg2 EndCreateTime:(unsigned int)arg3 Limit:(int)arg4 needFullMessage:(_Bool)arg5;
...
- (unsigned int)GetVerticalSearchMsgMinCreateTime:(id)arg1;
...
- (void)updateMsgExtCommonInfo:(id)arg1 xmlContent:(id)arg2;
...
- (void)StartDownloadVideo:(id)arg1 MsgWrap:(id)arg2 Priority:(_Bool)arg3 Silent:(_Bool)arg4;
...
- (unsigned int)GetMaxLocalIDInHelloMessage:(id)arg1;
...
- (id)GetAllDBHelloUsers:(id)arg1 arrNoInUserName:(id)arg2;
...
- (unsigned int)GetTextMsgCountExcludeVoice:(id)arg1 FromID:(unsigned int)arg2 ToID:(unsigned int)arg3;
...
- (_Bool)isNewBizExtHandled:(id)arg1;
...
- (id)getAllNewMessageWrapArray:(id)arg1 bizType:(long long)arg2;
...
- (id)GetDownMsgByCreateTimeAndType:(id)arg1 FromCreateTime:(unsigned int)arg2 ToCreateTime:(unsigned int)arg3 type:(id)arg4 Limit:(unsigned int)arg5 NeedOrder:(_Bool)arg6;
- (id)GetMsgByCreateTimeAndType:(id)arg1 FromCreateTime:(unsigned int)arg2 ToCreateTime:(unsigned int)arg3 type:(id)arg4 Limit:(unsigned int)arg5 NeedOrder:(_Bool)arg6;
...
- (id)GetDownMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5 FromSequence:(unsigned int)arg6 containBatchRevoke:(_Bool)arg7;
- (id)GetDownMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5 containBatchRevoke:(_Bool)arg6;
- (id)GetDownMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 ToCreateTime:(unsigned int)arg4 Limit:(int)arg5 LeftCount:(unsigned int *)arg6;
...
- (id)GetMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 ToCreateTime:(unsigned int)arg4 Limit:(int)arg5 LeftCount:(unsigned int *)arg6 FromSequence:(unsigned int)arg7 containBatchRevoke:(_Bool)arg8;
- (id)GetMsgByCreateTimeWithoutFilter:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 ToCreateTime:(unsigned int)arg4 Limit:(int)arg5 LeftCount:(unsigned int *)arg6;
- (id)GetMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5 FromSequence:(unsigned int)arg6 containBatchRevoke:(_Bool)arg7;
- (id)GetMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 ToCreateTime:(unsigned int)arg4 Limit:(int)arg5 LeftCount:(unsigned int *)arg6 containBatchRevoke:(_Bool)arg7;
- (id)GetMsgByCreateTime:(id)arg1 FromID:(unsigned int)arg2 FromCreateTime:(unsigned int)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5 containBatchRevoke:(_Bool)arg6;
...
- (unsigned long long)messageDataSize:(id)arg1;
