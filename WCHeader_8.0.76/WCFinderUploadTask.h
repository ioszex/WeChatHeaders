...
@class FinderMVInfo, FinderPostOriginInfo, NSArray, NSString, WCFinderFeedDraft, WCFinderPostSessionModel;

@interface WCFinderUploadTask : NSObject
{
    _Bool _preUploadTask;
    _Bool _postRequested;
    _Bool _backgroundTaskHeld;
    _Bool _isRetrying;
    ...
    _Bool _templateCreationCGISuccess;
    ...
    NSString *_uploadPlanIdentifier;
...
+ (id)createCoverMeidaUploadTask:(id)arg1 bindToMediaTask:(id)arg2 task:(id)arg3 clientId:(id)arg4 uploadCDNIndex:(long long *)arg5;
+ (id)createLivePhotoVideoTaskWithInfo:(id)arg1 bindToMediaTask:(id)arg2 taskClientID:(id)arg3 uploadCDNIndex:(long long *)arg4;
+ (id)createShareCoverMeidaUploadTask:(id)arg1 bindToMediaTask:(id)arg2 task:(id)arg3 clientId:(id)arg4 uploadCDNIndex:(long long *)arg5;
+ (id)buildUploadMediaTaskWithCDNIndex:(long long *)arg1;
...
+ (void)PBArrayAdd_uploadPlanIdentifier;
+ (void)PBArrayAdd_postRequested;
+ (void)PBArrayAdd_preUploadTask;
+ (void)PBArrayAdd_templateCreationCGISuccess;
...
@property(nonatomic) _Bool templateCreationCGISuccess; // @synthesize templateCreationCGISuccess=_templateCreationCGISuccess;
...
@property(copy, nonatomic) NSString *uploadPlanIdentifier; // @synthesize uploadPlanIdentifier=_uploadPlanIdentifier;
@property(nonatomic) long long videoMediaHash; // @synthesize videoMediaHash=_videoMediaHash;
@property(nonatomic) _Bool backgroundTaskHeld; // @synthesize backgroundTaskHeld=_backgroundTaskHeld;
@property(nonatomic) _Bool postRequested; // @synthesize postRequested=_postRequested;
...
- (int)postInfoFollowType;
- (id)genObjectDesc;
- (id)getEffectCreateContext;
- (int)getVideoDynamicRangeTypeWithResultPath:(id)arg1;
- (int)getVideoTypeWithResultPath:(id)arg1;
- (_Bool)hasSameUploadPlanWithTask:(id)arg1;
- (id)buildUploadPlanIdentifier;
