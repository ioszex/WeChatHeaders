...
@class CMessageWrap, FavDataItemWrap, FavoritesItem, FavoritesItemDataField, MMScrollActionSheet, MMTimer, MiniRecTransitionController, NSMutableArray, NSString, RTEAttachmentViewProvider, UIImage, WCDataItem, WNContentStorage, WNSaveImageLogic, WeNoteAffDelegateLogic, WeNoteFlutterInstance, WeNoteNewSaveImageLogic, WeNoteReportLogic;
...
@interface WeNoteFlutterViewController
{
    ...
    CDUnknownBlockType m_pendingForwardBlock;
    ...
    MMTimer *m_saveTimer;
    _Bool _enableNullAutoDelete;
    _Bool _bEditable;
    _Bool _bPresentedByMiniTask;
    _Bool _bShowLocateToMsg;
    _Bool _disableMinimize;
    _Bool _usePlaceholderTransition;
    _Bool _bConfigFromFavItem;
    ...
    NSString *_plusSessionId;
    unsigned long long _m_viewDidLoadTime;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool bConfigFromFavItem; // @synthesize bConfigFromFavItem=_bConfigFromFavItem;
@property(nonatomic) _Bool usePlaceholderTransition; // @synthesize usePlaceholderTransition=_usePlaceholderTransition;
@property(nonatomic) _Bool disableMinimize; // @synthesize disableMinimize=_disableMinimize;
@property(nonatomic) unsigned long long m_viewDidLoadTime; // @synthesize m_viewDidLoadTime=_m_viewDidLoadTime;
@property(retain, nonatomic) NSString *plusSessionId; // @synthesize plusSessionId=_plusSessionId;
...
- (id)getMidImageWidthAndHeightForVideo:(id)arg1;
- (id)getMidImageWidthAndHeightForImage:(id)arg1;
- (void)setEdgeGestureEnable:(_Bool)arg1;
- (void)setNavigationBackEnable:(_Bool)arg1;
...
- (_Bool)checkHTMLWithDataId:(id)arg1 isSuccess:(_Bool)arg2 retCode:(int)arg3;
...
- (void)loadNote;
- (_Bool)fixRegisterIFavCdnDownloadMgrExt;
- (void)saveNoteWithCompleteHandler:(CDUnknownBlockType)arg1 isAutoSave:(_Bool)arg2;
- (void)applicationWillResignActive;
- (void)tryRestoreDictationFromFloatingWindow;
- (void)activateDictationFloatingWindow;
- (void)handleDictationOnDisappear;
- (void)tryRestoreRecordingFromFloatingWindow;
- (void)activateRecordingFloatingWindow;
- (void)patchDataListWithLiveRecordingIfNeeded;
- (void)syncRecordingFavLocalIdAfterSaveIfNeeded;
- (_Bool)shouldInteractiveDismiss;
- (_Bool)shouldInteractivePop;
- (_Bool)DismissMyselfAnimated:(_Bool)arg1;
- (_Bool)disMissSelf;
- (void)handleRecordingOnDisappear;
...
- (void)saveSectionNoteAsImageStartIndex:(long long)arg1 endIndex:(long long)arg2;
- (void)realSaveNoteAsImage;
- (void)_fillPreTabCount:(id)arg1 fromPreviousSection:(id)arg2;
- (id)clipContentSectionListData:(id)arg1 startIndex:(long long)arg2 endIndex:(long long)arg3;
...
- (_Bool)isMultiContentPage;
- (_Bool)isStarMinimizePage;
- (void)fixMinimizationIssueWhenPopedOrDismiss;
- (void)tryUpdateToMinimizeWithInteractive:(_Bool)arg1;
...
- (_Bool)isMarkdownNoteAndUploadFailed;
