...
@class MISSING_TYPE, NSMapTable, NSMutableOrderedSet, OMCStoryline, UBValueSignal;
@protocol MJMovieComposingContext;

@interface MJStorylineViewModel : NSObject
{
    CDStruct_1b6d18a9 _durationBeforeSync;
    _Bool _containsImageStorySegment;
    ...
    MISSING_TYPE *_storyElementSegmentVMs;
...
@property(nonatomic) _Bool containsImageStorySegment; // @synthesize containsImageStorySegment=_containsImageStorySegment;
