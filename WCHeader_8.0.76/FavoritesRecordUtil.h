...
+ (id)ConvertPhotoAccountNameCard2MsgWrap:(id)arg1;
...
+ (id)Convert2PhotoAccountNameCardMsg:(id)arg1;
+ (id)Convert2AppFileMsg:(id)arg1;
+ (id)ConvertFinderCollectionFavItem2Message:(id)arg1;
...
+ (id)sourceIdForFavItem:(id)arg1 fromDataList:(id)arg2;
+ (id)ConvertFavData2FavItem:(id)arg1 fromMessage:(id)arg2 updateSourceId:(_Bool)arg3;
+ (id)ConvertFavData2FavItem:(id)arg1 fromMessage:(id)arg2;
+ (id)ConvertFavData2FavItem:(id)arg1;
+ (id)ConvertAppMsg2FavData:(id)arg1;
...
+ (id)ConvertFinderCollection2FavData:(id)arg1;
...
+ (id)generateRecordGroupCdnWithVideoMsg:(id)arg1;
+ (id)ConvertVideoMsg2FavData:(id)arg1 isForceOriginal:(_Bool)arg2;
+ (id)ConvertVideoMsg2FavData:(id)arg1;
+ (void)fillBrandMPVideoInfo:(id)arg1 videoData:(id)arg2;
+ (id)generateFavStreamVideoItem:(id)arg1;
+ (id)ConvertVoiceMsg2FavData:(id)arg1;
+ (id)generateRecordGroupCdnWithImgMsg:(id)arg1;
+ (id)ConvertImgMsg2FavData:(id)arg1 isForceOriginal:(_Bool)arg2;
...
+ (_Bool)canConvertAppMsg2FavData:(id)arg1;
+ (id)ConvertMsg2FavData:(id)arg1 forFav:(_Bool)arg2 isForceOriginal:(_Bool)arg3;
...
+ (id)sourceUsernameFromFavData:(id)arg1;
