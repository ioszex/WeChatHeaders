...
@interface WATextView : UITextView
{
    ...
    _Bool blockFocus;
    _Bool isWaitingKeyboardShow;
    _Bool _hasFrozenContainer;
    _Bool _disableContainerInset;
    _Bool _isDisabledParentGes;
    _Bool _isEnableTextAreaLoupe;
    unsigned int inputId;
    long long _variant;
    UIColor *_strokeColor;
    double _strokeWidth;
    UIColor *_fillBackgroundColor;
    double _fillBorderRadius;
    ...
    struct UIEdgeInsets _fillPadding;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isEnableTextAreaLoupe; // @synthesize isEnableTextAreaLoupe=_isEnableTextAreaLoupe;
@property(nonatomic) _Bool isDisabledParentGes; // @synthesize isDisabledParentGes=_isDisabledParentGes;
...
@property(nonatomic) _Bool isWaitingKeyboardShow; // @synthesize isWaitingKeyboardShow;
...
@property(nonatomic) double fillBorderRadius; // @synthesize fillBorderRadius=_fillBorderRadius;
@property(nonatomic) _Bool fillPaddingSet; // @synthesize fillPaddingSet=_fillPaddingSet;
@property(nonatomic) struct UIEdgeInsets fillPadding; // @synthesize fillPadding=_fillPadding;
...
- (void)removeStrokeAttributes;
- (void)applyStrokeAttributeIfNeeded;
...
- (void)refreshInputValue:(_Bool)arg1;
...
- (void)setSelectedRangeByPresetAttr:(id)arg1;
