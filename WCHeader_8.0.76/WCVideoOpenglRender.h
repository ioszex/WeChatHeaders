...
@class MMTimer, OpenglRenderView, UILabel, UIView, VoIPPendingDotsView, VoipOpenglesContext;
...
@interface WCVideoOpenglRender
{
    ...
    VoIPPendingDotsView *_loadingDotsView;
...
@property(retain, nonatomic) VoIPPendingDotsView *loadingDotsView; // @synthesize loadingDotsView=_loadingDotsView;
