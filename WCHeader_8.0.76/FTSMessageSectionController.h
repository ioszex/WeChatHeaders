...
- (unsigned long long)mgrSessionIndexForDisplayedItemRow:(long long)arg1;
...
- (id)msgCellForItemAtIndex:(long long)arg1 indexPath:(id)arg2;
- (id)talkerCellForItemAtIndex:(long long)arg1 indexPath:(id)arg2;
