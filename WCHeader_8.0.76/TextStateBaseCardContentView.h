...
@class MMEmoticonView, MMUIButton, NSString, RichTextView, TextStateCardReporter, TextStateFavoriteButton, TextStateFeverTapGestureRecognizer, TextStateModel, TextStatePublishIconButton, TextStatePublishSourceView, TextStateViewCountButton;
...
- (void)initSubviews;
@property(readonly, nonatomic) TextStateViewCountButton *viewCountButton;
- (id)viewCountBubbleHostView;
- (void)updateIconButton;
- (void)updateViewCountButton;
...
- (unsigned long long)mm_enterSceneForReport;
- (void)refreshViewCountReportConfig;
...
- (id)isPullDownStatusForReport;
- (id)isEnterProfileFromSns;
- (void)reportTextStateWithEvent:(id)arg1;
- (void)reportTextStatusPullLike;
- (void)reportTextStatusCmtSend;
- (void)reportTextStatusPullExp;
- (void)configFavoriteButtonReport;
- (void)configCommentButtonReport;
- (void)configProfileStatusReport;
- (id)buttonReportBaseParams;
@property(copy, nonatomic) NSString *ts_avatarPopoverSessionId;
@property(nonatomic) _Bool ts_isAvatarPopoverEnter;
