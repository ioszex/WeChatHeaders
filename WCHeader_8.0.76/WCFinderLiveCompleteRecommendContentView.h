...
@class FinderLiveSquareStyleInfo, MMUIImageView, MMUILabel, NSArray, NSIndexPath, NSMutableSet, NSString, UICollectionView, UIViewController;
...
@interface WCFinderLiveCompleteRecommendContentView : UIView
{
    ...
    NSMutableSet *_reportedDataItemTidSet;
}
...
@property(retain, nonatomic) NSMutableSet *reportedDataItemTidSet; // @synthesize reportedDataItemTidSet=_reportedDataItemTidSet;
...
- (void)onClickRecommendItem:(id)arg1 dataItem:(id)arg2 index:(long long)arg3;
...
- (_Bool)checkCellExposeAtIndexPath:(id)arg1 fromCollectionView:(id)arg2;
