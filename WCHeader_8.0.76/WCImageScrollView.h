...
@class MMImageScrollViewHelper, MMScrollViewZoomReporter, MMUIActivityIndicatorView, NSArray, NSString, UIView, WCImageMaterial, WXFullScreenGestureRecognizer;
@protocol UIScrollViewDelegate, WCImageScrollViewDelegate;
...
@interface WCImageScrollView
{
    ...
    WCImageMaterial *_imageMaterial;
    long long _browseScene;
    id <UIScrollViewDelegate> _scrollOuterDelegate;
...
@property(nonatomic) __weak id <UIScrollViewDelegate> scrollOuterDelegate; // @synthesize scrollOuterDelegate=_scrollOuterDelegate;
...
@property(retain, nonatomic) WCImageMaterial *imageMaterial; // @synthesize imageMaterial=_imageMaterial;
...
- (void)setZoomReportSnsId:(id)arg1 index:(long long)arg2;
- (id)getImageView;
