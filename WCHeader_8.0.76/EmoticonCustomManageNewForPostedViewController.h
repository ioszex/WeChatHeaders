...
@class EmoticonCustomCreateLogic, EmoticonCustomManageAddLogic, EmoticonCustomManageCollectionLayout, EmoticonCustomManageCollectionView, EmoticonCustomManageDataLogic, EmoticonCustomManagePopInteractiveTransition, EmoticonCustomManageSwipeSelectGestureRecognizer, EmoticonCustomSortBGView, EmoticonCustomSortInsertBrickView, EmoticonLoadMoreFooterView, NSArray, NSMutableArray, NSString, UIButton, UILabel, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView;

@interface EmoticonCustomManageNewForPostedViewController
{
    _Bool _isConflictViewClosed;
    _Bool _shouldShowConflictView;
    _Bool _needResetBrickView;
    _Bool _shouldShowPostView;
    ...
    NSMutableArray *_postedEmoticonInfos;
...
@property(retain, nonatomic) NSMutableArray *postedEmoticonInfos; // @synthesize postedEmoticonInfos=_postedEmoticonInfos;
@property(nonatomic) _Bool shouldShowPostView; // @synthesize shouldShowPostView=_shouldShowPostView;
...
- (void)reportEvent:(id)arg1 eventId:(id)arg2;
...
- (void)makeNewAddedEmoticons:(id)arg1 wrap:(id)arg2;
- (void)onAddEmoticonFinishedWithSuccessObj:(id)arg1 sucNum:(long long)arg2 failNum:(long long)arg3;
- (void)onAddEmoticonFinishedWithWrapObj:(_Bool)arg1 md5:(id)arg2 wrap:(id)arg3;
- (void)scrollViewWillBeginDecelerating:(id)arg1;
- (void)scrollViewDidScroll:(id)arg1;
- (void)checkIfIsOnEmoticonCustomManageViewController:(_Bool *)arg1;
- (_Bool)enablePostEmoticonEntrance;
- (void)jumpToWeApp:(CDUnknownBlockType)arg1;
- (void)jumpToPostEmoticonLiteApp:(CDUnknownBlockType)arg1;
- (void)resetPostedEmoticon;
