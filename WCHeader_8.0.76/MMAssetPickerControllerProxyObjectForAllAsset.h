...
@interface MMAssetPickerControllerProxyObjectForAllAsset : NSObject
{
    ...
    NSMutableArray *_previewSnapshotInfos;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *previewSnapshotInfos; // @synthesize previewSnapshotInfos=_previewSnapshotInfos;
