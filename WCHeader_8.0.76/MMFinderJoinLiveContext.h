...
@class CommentHintWordings, FinderBizUserInfo, FinderJoinLiveReq, FinderJoinLiveResp, FinderJoinLiveRespExtend, FinderJumpInfo, FinderLiveAdInfo, FinderLiveAnchorFlashSaleConfigInfo, FinderLiveAudienceEventInfo, FinderLiveBackendPeriodSeiInfo, FinderLiveBackgroundMusicInfo, FinderLiveCheerInfo, FinderLiveConcertRights, FinderLiveFlashSaleInfo, FinderLiveGamePlayTogether, FinderLiveHotCommentAnimationInfoList, FinderLiveInternalPageInfo, FinderLiveKtvExtInfo, FinderLiveKtvPlayerWaitList, FinderLiveMicInfo, FinderLiveModeInfo, FinderLivePackageExtInfo, FinderLivePromoteExtInfo, FinderLivePromoteMsgInfo, FinderLiveRecommendPreloadInfo, FinderLiveResourcePreloadInfo, FinderLiveRewardQuotaSwitchInfo, FinderLiveShopWindowAdItem, FinderLiveShortcutWordingConfig, FinderLiveUserAttrUserSetting, FinderLiveUserInfo, FinderLocation, FinderObjectMonotonicData_LiveIndependentData, FinderShopCouponInfo, FinderWindowProductInfo, GameLiveRankInfo, GameRankSwitchInfo, LiveDescInfo, LiveRoomImg, LiveSdkInfo, MMFinderJoinLivePrefetchInfo, MMFinderLiveConcertInfo, MMFinderLiveFansGroupInfo, MMFinderLiveTaskId, NSArray, NSData, NSMutableArray, NSString, WCFinderLiveIdentityModel, WCFinderLiveInfo, WCLocationInfo;
...
@interface MMFinderJoinLiveContext : NSObject
{
    ...
    FinderObjectMonotonicData_LiveIndependentData *_requestLiveMonoData;
    FinderLiveShortcutWordingConfig *_shortcutWordingConfig;
...
@property(retain, nonatomic) FinderLiveShortcutWordingConfig *shortcutWordingConfig; // @synthesize shortcutWordingConfig=_shortcutWordingConfig;
@property(retain, nonatomic) FinderObjectMonotonicData_LiveIndependentData *requestLiveMonoData; // @synthesize requestLiveMonoData=_requestLiveMonoData;
...
@property(nonatomic) _Bool isSyndicateParticipant; // @synthesize isSyndicateParticipant=_isSyndicateParticipant;
...
- (id)description;
@property(readonly, nonatomic) double maxBigEmoticonBarrageImgSize;
@property(readonly, nonatomic) _Bool isUsingInlineBigEmoticonCommentStyle;
...
@property(readonly, nonatomic) _Bool allowPreloadECProductPromoteBubble;
