...
@class MISSING_TYPE, NSArray, NSData, NSDictionary, NSString, TRTCQualityInfo, TRTCSpeedTestResult, TRTCStatistics;
...
- (void)onLocalRecordFragment:(NSString *)arg1;
...
- (void)onCdnStreamStateChanged:(NSString *)arg1 status:(int)arg2 code:(int)arg3 msg:(NSString *)arg4 extraInfo:(NSDictionary *)arg5;
- (void)onStopPublishMediaStream:(NSString *)arg1 code:(int)arg2 message:(NSString *)arg3 extraInfo:(NSDictionary *)arg4;
- (void)onUpdatePublishMediaStream:(NSString *)arg1 code:(int)arg2 message:(NSString *)arg3 extraInfo:(NSDictionary *)arg4;
- (void)onStartPublishMediaStream:(NSString *)arg1 code:(int)arg2 message:(NSString *)arg3 extraInfo:(NSDictionary *)arg4;
...
- (void)onRemoteAudioStatusUpdated:(NSString *)arg1 streamStatus:(unsigned long long)arg2 reason:(unsigned long long)arg3 extrainfo:(NSDictionary *)arg4;
- (MISSING_TYPE *)onRemoteVideoStatusUpdated:streamType:streamStatus:reason:extrainfo: /* Error: Ran out of types for this method. */;
...
- (void)onUpdateOtherRoomForwardMode:(int)arg1 errMsg:(NSString *)arg2;
