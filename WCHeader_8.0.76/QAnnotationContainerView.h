...
@class NSArray, NSMapTable, NSMutableDictionary, QMapContext, QMediator, TBOrderedSafeDictionary;
...
@interface QAnnotationContainerView : UIView
{
    ...
    NSMapTable *_engineMarkerIDToAnnotationViewMap;
}
...
@property(retain, nonatomic) NSMapTable *engineMarkerIDToAnnotationViewMap; // @synthesize engineMarkerIDToAnnotationViewMap=_engineMarkerIDToAnnotationViewMap;
...
- (id)annotationViewForEngineMarkerID:(int)arg1;
- (void)dealloc;
