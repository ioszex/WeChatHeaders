...
@class FinderBaseMediaInfo, FinderCoverScalingInfo, FinderHalfRect, FinderHdrMediaSpecList, FinderHlsMediaSpecList, FinderLiveMediaSpec, FinderLivePhotoMediaInfo, FinderLocation, FinderMediaCdnInfo, FinderMediaCodecInfo, FinderMediaDebug, FinderObjectScalingInfo, FinderProgressPreviewInfo, NSData, NSMutableArray, NSString;
...
@property(nonatomic) unsigned long long cdnFileSize; // @dynamic cdnFileSize;
...
@property(retain, nonatomic) NSData *mediaCdnInfoBytes; // @dynamic mediaCdnInfoBytes;
...
@property(retain, nonatomic) NSString *outpaintCoverUrl; // @dynamic outpaintCoverUrl;
@property(retain, nonatomic) NSString *outpaintCoverUrlToken; // @dynamic outpaintCoverUrlToken;
@property(retain, nonatomic) FinderLocation *poiInfo; // @dynamic poiInfo;
@property(retain, nonatomic) FinderProgressPreviewInfo *progressPreview; // @dynamic progressPreview;
