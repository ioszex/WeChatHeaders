...
@class AmoebaSubstitutePage, NSMutableArray, NSMutableDictionary, NSString;
...
- (id)mergedNextParamsForPage:(id)arg1 inMap:(id)arg2 bucketId:(unsigned long long)arg3;
- (id)bucketParamsForPage:(id)arg1 inMap:(id)arg2 bucketId:(unsigned long long)arg3 create:(_Bool)arg4;
- (id)bucketsForPage:(id)arg1 inMap:(id)arg2 create:(_Bool)arg3;
...
- (void)setFinderLatestEnterMethod:(id)arg1 enterMethod:(id)arg2;
- (id)getFinderLatestEnterMethod:(id)arg1;
- (void)setCurAppInTime:(unsigned long long)arg1;
...
- (id)getPagePaths:(unsigned long long)arg1;
