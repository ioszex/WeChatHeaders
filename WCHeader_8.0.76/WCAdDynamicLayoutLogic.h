...
@class NSMutableArray, NSMutableDictionary, NSString, UIView, WCAdDynamicFeedElementInfo, WCDataItem;
...
@interface WCAdDynamicLayoutLogic
{
    ...
    NSMutableArray *_viewsWithClickIndex;
}

+ (void)tryToReloadDynamicInfoWithDataItem:(id)arg1 scene:(unsigned long long)arg2;
+ (id)getDynamicLayoutLogicWithDataItem:(id)arg1 scene:(unsigned long long)arg2 reloadData:(_Bool)arg3;
...
@property(retain, nonatomic) NSMutableArray *viewsWithClickIndex; // @synthesize viewsWithClickIndex=_viewsWithClickIndex;
...
- (id)modeForAnimationObject:(id)arg1;
- (unsigned long long)getAnimationOptionsForAnimation:(id)arg1;
- (id)fetchValidProperties:(id)arg1 isSpecial:(_Bool)arg2 containTranslate:(_Bool)arg3;
...
- (id)copyViewFrom:(id)arg1;
- (struct CATransform3D)transformFromProperty:(id)arg1 toView:(id)arg2 isFromValue:(_Bool)arg3;
- (void)applyCommonAnimationProperties:(id)arg1 toView:(id)arg2 isFromValue:(_Bool)arg3;
- (void)doAnimationWithTranslation:(id)arg1;
- (_Bool)containTransitionProperty:(id)arg1;
...
- (void)asyncUpdateDynamicFeedUpdateInfo:(_Bool)arg1;
