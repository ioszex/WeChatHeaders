...
@class MMFinderLiveConnectMicJoinLiveBattleInfoWrap, MMFinderLiveConnectMicPKInfo, MMFinderLiveConnectMicUsersInfo, MMLiveAudioRoomSEIConnectMicMsg, MMLiveConnectMicSEIHandler, MMLiveSEIConnectMicMsg, NSMutableArray, NSString, OrderedDictionary;

@interface MMFinderLiveCDNViewerMicLogic
{
    _Bool _isVideoLandscapeMode;
    _Bool _isAnchorMain;
    _Bool _isBackendSeiInfoEnabled;
    _Bool _canShowMicTopic;
    ...
    MMLiveConnectMicSEIHandler *_seiHandler;
    unsigned long long _dataSrcFlag;
}

+ (id)generateNoUserMicUsersInfoForMultiPlayerAudioRoomModeWithAnchorSdkUserId:(id)arg1 andAnchorContact:(id)arg2;
+ (id)generateSortedMicUserListWithOriginalList:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) unsigned long long dataSrcFlag; // @synthesize dataSrcFlag=_dataSrcFlag;
@property(nonatomic) _Bool canShowMicTopic; // @synthesize canShowMicTopic=_canShowMicTopic;
@property(nonatomic) _Bool isBackendSeiInfoEnabled; // @synthesize isBackendSeiInfoEnabled=_isBackendSeiInfoEnabled;
@property(retain, nonatomic) MMLiveConnectMicSEIHandler *seiHandler; // @synthesize seiHandler=_seiHandler;
...
- (void)updateCanShowMicTopic:(_Bool)arg1;
- (void)updateMicTopicWithFinderLiveMicConfig:(id)arg1 updateAll:(_Bool)arg2;
...
- (void)updateBackendSeiInfoEnabled:(_Bool)arg1;
...
- (void)resetMicUserIsTalkingByAnchorSEIWithMicUserInfo:(id)arg1;
- (void)updateKtvSingerFlagInAudioRoomMicUsersInfoWithResetLastSingerTalkingStatusFlag:(_Bool)arg1;
...
- (_Bool)enableGenerateMicUserFromSei;
...
- (_Bool)isCurrDataSrcCompletely;
- (void)addDataSrcFlag:(unsigned long long)arg1 async:(_Bool)arg2;
