...
@class CContact, MMTimerLabel, MMUIButton, MultiTalkHDHeadView, NSString, UIImageView, UILabel, UIView, VoIPEnhanceVoiceCoordinator, VoipDescriptionButton, VoipRecentStatusCardView, VoipRecentStatusFoldButton, VoipRecentStatusUnFoldButton, _TtC6WeChat22VoIPExtOperateMenuView;
...
@property(nonatomic) __weak VoIPEnhanceVoiceCoordinator *enhanceVoiceCoordinator; // @synthesize enhanceVoiceCoordinator=_enhanceVoiceCoordinator;
...
- (void)hideEnhanceVoiceBubble;
- (void)showEnhanceVoiceBubble;
