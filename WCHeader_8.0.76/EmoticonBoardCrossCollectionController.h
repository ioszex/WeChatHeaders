...
@class EmoticonBoardCrossSectionInfo, MISSING_TYPE, MMUIView, NSArray, NSMutableDictionary, NSString, UICollectionView, UICollectionViewFlowLayout, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
...
@interface EmoticonBoardCrossCollectionController
{
    ...
    _Bool _disablePanOnRightQuarter;
    ...
    MISSING_TYPE *_selectTime;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long selectTime; // @synthesize selectTime=_selectTime;
...
@property(nonatomic) _Bool disablePanOnRightQuarter; // @synthesize disablePanOnRightQuarter=_disablePanOnRightQuarter;
...
- (unsigned long long)countOfEmoticonByPid:(id)arg1;
- (unsigned long long)getLatestTagSelectedTime;
...
- (void)setEmoticonPageArray:(id)arg1 show:(_Bool)arg2;
