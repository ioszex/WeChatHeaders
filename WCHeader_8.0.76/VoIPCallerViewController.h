...
@class AnyPromise, MMTimer, MMUIButton, NSDictionary, NSString, UIImageView, UIView, VOIPVideoRender, VoipDescriptionButton, VoipRecentStatusCardView, VoipRecentStatusFoldButton, VoipRecentStatusUnFoldButton, XImageViewRenderer;
...
- (void)onSupportClickAddMembersBtnBeforeAccept;
