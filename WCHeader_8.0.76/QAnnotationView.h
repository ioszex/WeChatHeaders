...
@class NSMutableArray, NSString, QAnnotationContainerView, QAnnotationViewTextStyle, QMUAnnoViewAnimationMediator, UIImage, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
@interface QAnnotationView : UIView
{
    ...
    long long _type;
    NSString *_text;
    QAnnotationViewTextStyle *_textStyle;
...
@property(retain, nonatomic) QAnnotationViewTextStyle *textStyle; // @synthesize textStyle=_textStyle;
