...
- (unsigned long long)convertDisplayTypeToSearchIndex:(long long)arg1;
- (long long)convertSearchIndexToDisplayType:(unsigned long long)arg1;
- (unsigned long long)filterTypeForCategoryDisplayType:(long long)arg1;
