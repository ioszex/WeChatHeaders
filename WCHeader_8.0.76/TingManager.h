...
@class MemoryMappedKV, NSString, TingAllPlayerManager, TingAppTaskManager, TingAudioTabDataManager, TingCdnImageUploadManager, TingCrossplatformManager, TingImageDownloader, TingLyricsManager, TingMembershipManager, TingMinimizeMgr, TingPlayAppTaskControllerCpp, TingPlayCenterMgr, TingPlayerUIManager, TingShareManager, _TtC6WeChat13TingEntryKara;
