...
@class NSAttributedString, NSNumber, NSString, NSValue, UIColor, UIFont, UIImage, UIView;

@interface WCTableViewCellLeftConfig : NSObject
{
    _Bool _isMakeImageCenterWhenHaveDetail;
    _Bool _bDetailRichTextView;
    _Bool _selected;
    _Bool _titleCenter;
    _Bool _isSubOptionLineCenterTitle;
    ...
    CDUnknownBlockType _onDetailLinkClicked;
    NSString *_detail;
    ...
    struct CGSize _smallIconSize;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isSubOptionLineCenterTitle; // @synthesize isSubOptionLineCenterTitle=_isSubOptionLineCenterTitle;
...
@property(nonatomic) double smallIconLeftMargin; // @synthesize smallIconLeftMargin=_smallIconLeftMargin;
@property(nonatomic) struct CGSize smallIconSize; // @synthesize smallIconSize=_smallIconSize;
...
@property(copy, nonatomic) CDUnknownBlockType onDetailLinkClicked; // @synthesize onDetailLinkClicked=_onDetailLinkClicked;
@property(nonatomic) _Bool bDetailRichTextView; // @synthesize bDetailRichTextView=_bDetailRichTextView;
...
@property(nonatomic) _Bool isMakeImageCenterWhenHaveDetail; // @synthesize isMakeImageCenterWhenHaveDetail=_isMakeImageCenterWhenHaveDetail;
