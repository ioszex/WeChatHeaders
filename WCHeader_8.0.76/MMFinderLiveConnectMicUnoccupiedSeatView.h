...
- (_Bool)isSmallMode;
- (void)updateWithSeatInfo:(id)arg1 micLayoutMode:(unsigned long long)arg2 pkState:(unsigned long long)arg3 customTitle:(id)arg4;
- (void)layoutUI;
- (void)onTapBackground:(id)arg1;
- (void)updateViewsColorAfterPIPModeChanged;
- (void)configUI;
- (void)layoutSubviews;
