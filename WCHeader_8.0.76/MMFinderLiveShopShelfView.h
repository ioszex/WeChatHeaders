...
@class FinderDirectAddPreviousLiveProductsPageInfo, FinderShopShelfLabelClassifyInfo, MMFinderLiveCouponsView, MMFinderLiveGoodsEmptyView, MMFinderLiveHotSaleInfosView, MMFinderLiveShopContext, MMFinderLiveShopGoodsSectionHeaderStickView, MMFinderLiveShopShelfContainerView, MMFinderLiveShopShelfCoordinator, MMFinderLiveShopShelfExtraHeaderCell, MMFinderLiveShopShelfGoodsWithCouponView, MMFinderLiveShopShelfGroupedProductsAdapter, MMFinderLiveShopShelfHeaderView, MMFinderLiveShopShelfOpenParams, MMFinderLiveShopShelfPagesManageView, MMFinderLiveShopShelfTipsView, MMFinderLiveTaskId, MMFinderLiveWithCallbackSet, MMGradientView, MMLoadingView, MMTableView, NSArray, NSData, NSDate, NSMutableArray, NSMutableSet, NSObject, NSString, OrderedDictionary, UIButton, UILabel;
...
@interface MMFinderLiveShopShelfView : UIView
{
    ...
    MMFinderLiveShopShelfOpenParams *_params;
    ...
    UILabel *_presenterTipsButton;
    NSObject *_currentGetShopShelf;
    NSMutableArray *_classifyInfos;
    MMFinderLiveShopGoodsSectionHeaderStickView *_stickHeaderView;
...
@property(retain, nonatomic) MMFinderLiveShopGoodsSectionHeaderStickView *stickHeaderView; // @synthesize stickHeaderView=_stickHeaderView;
...
@property(retain, nonatomic) UILabel *presenterTipsButton; // @synthesize presenterTipsButton=_presenterTipsButton;
...
@property(retain, nonatomic) MMFinderLiveShopShelfOpenParams *params; // @synthesize params=_params;
...
- (_Bool)shouldUseDeepPromotingBg;
- (_Bool)shouldShowReplayFloatPromotionAnimation;
- (unsigned int)promotingProductStyleOpt;
...
- (void)onPresenterTipsButtonClicked:(id)arg1;
- (void)onAddGoodsButtonClicked;
- (_Bool)canShowHeaderStickerView;
- (void)onDeleteFinderShopShelfProduct:(id)arg1 idUnits:(id)arg2;
- (void)onSetTopFinderShopShelfProduct:(id)arg1 idUnit:(id)arg2;
- (void)toCanUseCouponList:(id)arg1 backmode:(long long)arg2 animated:(_Bool)arg3;
- (void)toCanUseCouponList:(id)arg1;
- (void)openWithCanUseCouponList:(id)arg1;
...
- (void)layoutPresenterTipsButton;
- (void)initPresenterTipsButton;
- (void)initAddGoodsButton;
- (void)checkAndInitAddGoodsButton;
- (void)checkPresenterTipsButton;
- (id)headerShopContentView;
- (void)initView;
