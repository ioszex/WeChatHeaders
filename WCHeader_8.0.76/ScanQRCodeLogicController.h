...
@class BizScanTabBarInfo, CameraScanCodesContentView, CameraScanCombineConfig, CameraScanCombineContentView, CameraScanCombineDetectorRouter, CameraScanOperateReporter, GetA8KeyLogic, MMTimer, MMUIViewController, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSOperationQueue, NSRecursiveLock, NSString, NewQRCodeScanner, ScanCodeOcrHandler, ScanOpenIMRoomReporter, ScanQRCodeLogicParams, ScanQRCodeResultInfo, ScanQRCodeUrlPrefixRule, ScanWXCodeUrlPrefixRule;
...
@interface ScanQRCodeLogicController
{
    ...
    _Bool _hasUserClickedItemDisplayed;
    _Bool _hasReportedFirstBubbleCost;
    ...
    unsigned int _scanGetA8keyScene;
    unsigned int _scanSubScene;
    unsigned int _scanVersion;
    unsigned int _scanGetA8KeyRequestId;
    int _goodsCacheTime;
    ...
    CameraScanOperateReporter *_qrcodeOperateReporter;
    ScanQRCodeUrlPrefixRule *_m_urlPrefixRule;
    ScanCodeOcrHandler *_m_scanOcrHandler;
    ScanOpenIMRoomReporter *_m_scanOpenIMRoomReporter;
    ...
    NSString *_scanGetA8keyCodeType;
    NSString *_preset;
    ...
    NSMutableArray *_goodsCachePool;
    MMTimer *_goodsCacheTimer;
...
@property(nonatomic) _Bool hasReportedFirstBubbleCost; // @synthesize hasReportedFirstBubbleCost=_hasReportedFirstBubbleCost;
@property(nonatomic) _Bool hasUserClickedItemDisplayed; // @synthesize hasUserClickedItemDisplayed=_hasUserClickedItemDisplayed;
@property(retain, nonatomic) MMTimer *goodsCacheTimer; // @synthesize goodsCacheTimer=_goodsCacheTimer;
@property(retain, nonatomic) NSMutableArray *goodsCachePool; // @synthesize goodsCachePool=_goodsCachePool;
@property(nonatomic) int goodsCacheTime; // @synthesize goodsCacheTime=_goodsCacheTime;
...
@property(nonatomic) unsigned int scanGetA8KeyRequestId; // @synthesize scanGetA8KeyRequestId=_scanGetA8KeyRequestId;
@property(nonatomic) unsigned int scanVersion; // @synthesize scanVersion=_scanVersion;
@property(retain, nonatomic) NSString *scanGetA8keyCodeType; // @synthesize scanGetA8keyCodeType=_scanGetA8keyCodeType;
@property(nonatomic) unsigned int scanSubScene; // @synthesize scanSubScene=_scanSubScene;
@property(nonatomic) unsigned int scanGetA8keyScene; // @synthesize scanGetA8keyScene=_scanGetA8keyScene;
@property(retain, nonatomic) NSString *scanResultString; // @synthesize scanResultString=_scanResultString;
@property(nonatomic) long long picFrom; // @synthesize picFrom=_picFrom;
...
@property(retain, nonatomic) ScanOpenIMRoomReporter *m_scanOpenIMRoomReporter; // @synthesize m_scanOpenIMRoomReporter=_m_scanOpenIMRoomReporter;
...
@property(retain, nonatomic) CameraScanOperateReporter *qrcodeOperateReporter; // @synthesize qrcodeOperateReporter=_qrcodeOperateReporter;
...
- (void)handleTapForDetectionFromGesture:(id)arg1;
...
- (void)onCanceItemOpenWithItemViewModel:(id)arg1 index:(unsigned long long)arg2;
...
- (id)getScanQRCodeSourceWebViewPayTraceInfo;
...
- (void)onGetA8KeyFail;
- (void)onGetA8KeyEnd;
- (void)onReportA8KeyType:(unsigned int)arg1 codeType:(long long)arg2;
- (void)onReportA8KeyQrCodeType:(unsigned int)arg1;
- (void)onGetA8KeyBarCodeType:(unsigned int)arg1;
...
- (void)onRecievePixelBufferInCaptureDelegateThread:(id)arg1;
...
- (void)handleHKWalletScanCodeRoute:(id)arg1 getA8keyScene:(unsigned int)arg2;
- (_Bool)shouldHandleHKWalletCGPUrl:(id)arg1;
- (void)handleOcrReport:(id)arg1 codeType:(id)arg2 codeRect:(struct CGRect)arg3 getA8KeyScene:(int)arg4 getA8KeyRequestId:(unsigned int)arg5 reportType:(unsigned long long)arg6;
- (void)handleOcrReport:(id)arg1 codeType:(id)arg2 codeRect:(struct CGRect)arg3 getA8KeyScene:(int)arg4 getA8KeyRequestId:(unsigned int)arg5;
- (void)openQRCodeOrWXCodeLandingPage:(id)arg1 isShowMultiCodes:(_Bool)arg2 businessScene:(id)arg3;
- (void)openQRCodeOrWXCodeLandingPage:(id)arg1 isShowMultiCodes:(_Bool)arg2;
- (void)openLandingPageWithMarkDotInfo:(id)arg1 isShowMultiCodes:(_Bool)arg2 businessScene:(id)arg3;
...
@property(readonly, nonatomic) _Bool isShowMyQRCode;
...
- (void)reportAfterCameraViewControlelrExitOrDetectedCodes:(long long)arg1;
...
- (void)didClose:(id)arg1 session:(id)arg2;
...
- (long long)getGoodsType:(id)arg1 hasTitle:(_Bool)arg2;
- (void)stopCacheTimer;
- (id)selectValidItemFromCachePool;
- (void)flushCachePool;
- (void)startCacheTimerIfNeeded;
- (void)addItemToCachePool:(id)arg1;
- (void)addItemToContentView:(id)arg1;
- (void)onDetectScanMixTextItem:(id)arg1 errCode:(unsigned int)arg2;
- (void)onDetectScanMixItem:(id)arg1 errCode:(unsigned int)arg2;
...
- (void)distributeScanGoodsResult:(id)arg1 isFromAlbum:(_Bool)arg2;
- (_Bool)needChangeSceneForNewUI:(long long)arg1 itemVM:(id)arg2;
- (void)openViewCtrlWithItemViewModel:(id)arg1 isFromAlbum:(_Bool)arg2;
- (id)combineInfoText;
...
- (void)handleCapturePixelBufferOnCatagoryGoodCombine:(id)arg1;
