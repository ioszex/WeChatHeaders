...
@class CMessageWrap, FavoritesItem, FavoritesItemDataField, NSString, UINavigationController, WCDataItem, WeNoteFlutterExpandTransitionConfig;
...
@interface WNOpenParameter
{
    ...
    WeNoteFlutterExpandTransitionConfig *_expandTransitionConfig;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WeNoteFlutterExpandTransitionConfig *expandTransitionConfig; // @synthesize expandTransitionConfig=_expandTransitionConfig;
@property(retain, nonatomic) NSString *plusSessionId; // @synthesize plusSessionId=_plusSessionId;
@property(nonatomic) _Bool bShowFullScreen; // @synthesize bShowFullScreen=_bShowFullScreen;
