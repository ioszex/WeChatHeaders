...
@property(nonatomic) _Bool hasGuideCellInserted; // @synthesize hasGuideCellInserted=_hasGuideCellInserted;
...
- (void)insertGuideToDiscoverCell;
- (_Bool)_feedArrayContainsGuideCell;
- (void)syncAllowGuideToDiscover;
