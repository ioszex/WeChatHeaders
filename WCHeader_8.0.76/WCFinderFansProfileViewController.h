...
@class CContact, FinderContactExtRelationInfo, FinderGetContactListReq, MISSING_TYPE, MMUIButton, NSData, NSString, RichTextView, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCFinderComment, WCFinderContact, WCFinderHalfProfileInfoView, WCFinderHalfProfileInteractionInfoView, WCFinderHeadImageView, WCFinderLikeInfo, WCFinderMention, WCFinderRichTextView;
@protocol WCFinderFansProfileViewControllerDelegate;

@interface WCFinderFansProfileViewController
{
    _Bool _showMsgButton;
    _Bool _showLikePrivacySection;
    ...
    UIView *_likePrivacyView;
    UIView *_likePrivacyTopSepLine;
    WCFinderRichTextView *_likePrivacyTitleLabel;
    WCFinderRichTextView *_likePrivacyStatusLabel;
    UIImageView *_likePrivacyArrowImageView;
...
@property(retain, nonatomic) UIImageView *likePrivacyArrowImageView; // @synthesize likePrivacyArrowImageView=_likePrivacyArrowImageView;
@property(retain, nonatomic) WCFinderRichTextView *likePrivacyStatusLabel; // @synthesize likePrivacyStatusLabel=_likePrivacyStatusLabel;
@property(retain, nonatomic) WCFinderRichTextView *likePrivacyTitleLabel; // @synthesize likePrivacyTitleLabel=_likePrivacyTitleLabel;
@property(retain, nonatomic) UIView *likePrivacyTopSepLine; // @synthesize likePrivacyTopSepLine=_likePrivacyTopSepLine;
@property(retain, nonatomic) UIView *likePrivacyView; // @synthesize likePrivacyView=_likePrivacyView;
...
@property(copy, nonatomic) NSString *watchingFeedID; // @synthesize watchingFeedID=_watchingFeedID;
...
@property(nonatomic) _Bool showLikePrivacySection; // @synthesize showLikePrivacySection=_showLikePrivacySection;
...
- (void)dismissModalVCAction;
- (void)clickLikePrivacyAction;
- (_Bool)isLikePrivacySectionForbidden;
- (void)updateLikePrivacyStatusLabel;
- (void)setupLikePrivacyView;
...
- (void)interactionInfoView:(id)arg1 didTapItem:(id)arg2;
...
- (void)layoutUI;
- (void)updateMoreBtnAndLikePrivacySection;
