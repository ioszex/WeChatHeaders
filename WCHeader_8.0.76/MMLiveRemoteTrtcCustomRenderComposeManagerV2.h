...
@class CADisplayLink, CIContext, MISSING_TYPE, MMFinderLiveTask, MMLivePixelBuffer, MMLiveRemoteTrtcCustomRenderComposeV2MetricsMonitor, MMLiveTaskId, MMWeEffectFrame, MMWeEffectManager, NSLock, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIView, WCLoopMetricsCollector;
