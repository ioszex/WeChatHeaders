...
@class BaseRequest, EntranceExposeContent, FinderBaseRequest, FinderClientStatus, FinderSyncClientInfo, FinderSyncClientStatus, FinderSyncRequest_Coordinate, NSData, NSMutableArray, NSString, SKBuiltinBuffer_t;
...
@property(nonatomic) unsigned int fetchDataType; // @dynamic fetchDataType;
@property(retain, nonatomic) FinderBaseRequest *finderBasereq; // @dynamic finderBasereq;
@property(retain, nonatomic) FinderClientStatus *finderClientStatus; // @dynamic finderClientStatus;
