...
@class FinderLiveContact, MMFinderLiveAudioRoomMicAudioAnimationView, MMFinderLiveConnectMicUser, MMFinderLiveRedPacketView, MMFinderLiveTaskId, MMLiveMultipleTapGestureRecognizer, MMLiveRewardGiftNotificationContainerView, MMUIButton, NSString, UIColor, UILabel, UILongPressGestureRecognizer, UIView, WCFinderContact, WCFinderHeadImageView;
...
+ (double)secondLineTopMarginNew:(_Bool)arg1;
+ (double)preferExtraHeight:(_Bool)arg1;
- (void).cxx_destruct;
...
@property(nonatomic) _Bool enableShowUserTalking; // @synthesize enableShowUserTalking=_enableShowUserTalking;
...
- (void)updateUserTalkingShowEnabled:(_Bool)arg1;
...
- (void)onLiveKTVUserHeatValueUpdate:(id)arg1 withMicUserInfo:(id)arg2 taskId:(id)arg3;
