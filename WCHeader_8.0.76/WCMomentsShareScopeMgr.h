...
@protocol WCMomentsShareScopeMgrDelegate;
...
@interface WCMomentsShareScopeMgr : NSObject
{
    ...
    id <WCMomentsShareScopeMgrDelegate> _delegate;
...
@property(nonatomic) __weak id <WCMomentsShareScopeMgrDelegate> delegate; // @synthesize delegate=_delegate;
