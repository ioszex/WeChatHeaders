...
@protocol WCFinderLiveHomePageSpecialColumnSectionViewDelegate <NSObject, WCFinderLiveHorizontalScrollSectionProtocol>

@optional
- (void)onSpecialColumnSectionView:(WCFinderLiveHomePageSpecialColumnSectionView *)arg1 clickFriendLikeReason:(WCFinderLiveGenericFeedVM *)arg2;
