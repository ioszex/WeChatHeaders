...
@interface SelectionToolbarProxyFlutterApi : NSObject
{
...
- (void)onSelectionToolbarDismissedWithCompletion:(CDUnknownBlockType)arg1;
- (void)onSelectionToolbarMenuItemSelectedMenuType:(id)arg1 completion:(CDUnknownBlockType)arg2;
