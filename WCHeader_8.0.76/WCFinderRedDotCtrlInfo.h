...
- (unsigned long long)finderPopupObjectId;
- (int)streamShowReddotTypeToFinderTabType:(int)arg1;
- (id)pinToTopObjectInfo;
- (_Bool)isEnableGeCommentDetailPrefetch;
- (_Bool)isSafeContactBanRedDot;
- (_Bool)isUltraHighPriorityRedDot;
- (_Bool)hasRedDotPath:(id)arg1;
- (_Bool)openCreateRedPacketEvent:(id)arg1 completeBlock:(CDUnknownBlockType)arg2;
- (_Bool)openJumpInfoPage;
- (_Bool)isExemptNMControlRedDot;
