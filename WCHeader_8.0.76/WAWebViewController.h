...
@interface WAWebViewController
{
    ...
    _Bool _isAgentDetailPageWebVC;
    _Bool _isInvalidatedByMultiStackDismiss;
    _Bool _isViewDidFirstAppear;
    _Bool _remoteDebugHasInjected;
    _Bool _agentJSHasInjected;
    ...
    NSString *_lastRouteOpenTypeBeforeReload;
    ...
    NSMutableArray *_nativeRootViews;
    ...
    WAWebActionSheet *_webActionSheet;
    NSString *_systemMenuSessionBuffer;
    WAMenuActionSheetDelegateLogic *_delegateLogic;
    NSMutableArray *_afterLoadInitReadyBlocks;
    NSDictionary *_singlePageRouteData;
    NSMutableDictionary *_dicCheckAliveBlock;
    _TtC9WeAppCore14CDPEventSender *_eventSender;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) _TtC9WeAppCore14CDPEventSender *eventSender; // @synthesize eventSender=_eventSender;
@property(nonatomic) _Bool agentJSHasInjected; // @synthesize agentJSHasInjected=_agentJSHasInjected;
@property(nonatomic) _Bool remoteDebugHasInjected; // @synthesize remoteDebugHasInjected=_remoteDebugHasInjected;
...
@property(retain, nonatomic) NSMutableArray *afterLoadInitReadyBlocks; // @synthesize afterLoadInitReadyBlocks=_afterLoadInitReadyBlocks;
@property(retain, nonatomic) WAMenuActionSheetDelegateLogic *delegateLogic; // @synthesize delegateLogic=_delegateLogic;
@property(retain, nonatomic) NSString *systemMenuSessionBuffer; // @synthesize systemMenuSessionBuffer=_systemMenuSessionBuffer;
@property(nonatomic) _Bool isInvalidatedByMultiStackDismiss; // @synthesize isInvalidatedByMultiStackDismiss=_isInvalidatedByMultiStackDismiss;
@property(nonatomic) _Bool isAgentDetailPageWebVC; // @synthesize isAgentDetailPageWebVC=_isAgentDetailPageWebVC;
...
@property(nonatomic) __weak WAWebActionSheet *webActionSheet; // @synthesize webActionSheet=_webActionSheet;
...
@property(retain, nonatomic) NSMutableArray *nativeRootViews; // @synthesize nativeRootViews=_nativeRootViews;
...
@property(copy, nonatomic) NSString *lastRouteOpenTypeBeforeReload; // @synthesize lastRouteOpenTypeBeforeReload=_lastRouteOpenTypeBeforeReload;
...
- (void)onAppTaskClose;
- (void)agentEvaluateJavaScriptFromString:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)scrollIntoViewIfNeededByXpath:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getPageInnerHTML:(CDUnknownBlockType)arg1;
- (void)getElementFrameWithXPath:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getAllElementsRects:(CDUnknownBlockType)arg1;
- (void)getPageElementsInfoCSV:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)checkKeyboardInstanceExists:(CDUnknownBlockType)arg1;
- (void)getPageImageLoadStatus:(CDUnknownBlockType)arg1;
- (void)agentInnerEvaluateJavaScript:(id)arg1 logContext:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)agentServiceRemoveCallback:(id)arg1;
- (void)agentServiceNotifyWithResult:(id)arg1 callbackId:(id)arg2;
- (void)agentServiceEndWithResult:(id)arg1 callbackId:(id)arg2;
- (void)injectAgentJSIfNeeded;
- (void)injectRemoteDebugIfNeeded:(CDUnknownBlockType)arg1;
- (_Bool)agentEnvReady;
...
- (id)popWebViewCountFromSelf:(int)arg1 skipIntermediate:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)web_viewControllerDidReceiveScriptMessage:(id)arg1 handler:(id)arg2;
...
- (void)htmlWebRunCDPCommands:(id)arg1;
- (_Bool)hasHTMLWeb;
...
- (_Bool)isMiniTaskFirstPageSwipeFromRightEdge:(id)arg1;
...
- (_Bool)onPopShouldRequireFailureOfGestureRecognizer:(id)arg1;
...
- (void)initTouchDelayWithGesture:(id)arg1;
- (void)removeSwipeLeftEdgeGesture;
...
- (void)graphicsImageDrawingActions:(id)arg1;
- (id)wa_secureProtectedSnapshotForRootView:(id)arg1;
- (id)wa_secureProtectedHostImageIfNeeded;
@property(retain, nonatomic) WCSecureCaptureProtector *waSecureCaptureProtector;
...
- (void)onLoadModuleData:(_Bool)arg1 errorCode:(long long)arg2 moduleName:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)reloadModuleData;
- (void)hideModuleDataLoading;
- (void)showModuleDataLoading;
- (void)checkModuleDataLoaded:(CDUnknownBlockType)arg1;
...
- (void)loadIndexDataWithRelativeURL:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)setIsHideDefaultInputAccessoryView:(_Bool)arg1;
...
- (void)openMiniToolTargetWeAppWithPath:(id)arg1;
- (void)onMiniToolPreviewAddBtnClicked;
- (void)onMiniToolPreviewBannerAddBtnClicked:(id)arg1;
...
- (id)buildSinglePageBottomBannerViewModel;
...
- (id)getTabChildWebViewWithRelativeURL:(id)arg1 extraInfo:(id)arg2;
...
- (void)tryShareToContactWithCustomCallback:(CDUnknownBlockType)arg1;
- (_Bool)canShareAppMsg;
...
- (void)onGetOriginalUrl:(id)arg1;
- (void)getOriginalUrl:(CDUnknownBlockType)arg1;
- (id)getNativeOriginalUrl;
...
- (void)reportMultiContentMinimizeMenuItemReddot:(id)arg1 btnLocInfo:(id)arg2;
- (void)reportMultiContentMinimizeMenuItem:(id)arg1;
- (void)reportMenuAction:(unsigned long long)arg1 actionNote:(id)arg2;
...
- (void)clickActionSheet:(long long)arg1;
...
- (void)onCommentDishShown:(unsigned int)arg1 actionNote:(id)arg2;
- (void)onCommentDishTaped:(unsigned int)arg1 actionNote:(id)arg2;
- (void)onTapedCoverAd;
...
- (unsigned long long)presentingInterfaceOrientationMaskInSheetMode;
- (_Bool)isCurrentNavigationControllerInSheetMode;
