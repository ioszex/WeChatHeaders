...
@class CLLocation, MISSING_TYPE, MMAutoSearchLogic, MMFloorPickView, MMLocationAttributeBanner, MMLocationPinView, MMMapView, MMPickLocationReporter, MMPickLocationSearchView, NSMutableArray, NSString, POIItem, PickLocationManager, QPoiInfo, UIBarButtonItem, UIButton, UIImageView, UIPinchGestureRecognizer, UIView, WCUIAlertView;
...
@interface MMPickLocationViewController
{
    ...
    _Bool _locPageInReported;
    _Bool _noPoiSelectedReported;
    unsigned long long _locMapRenderStartTime;
    _Bool _locMapRenderResultReported;
    unsigned long long _locLocateStartTime;
    _Bool _locLocateResultReported;
    unsigned long long _locSendStartTime;
    _Bool _locSendResultReported;
    NSString *_locPoiQuerySource;
    unsigned long long _locPoiAttemptId;
    unsigned long long _locNearPoiStartTime;
    NSString *_locNearPoiSource;
    unsigned long long _locNearPoiAttemptId;
    unsigned long long _locSearchPoiStartTime;
    unsigned long long _locSearchPoiAttemptId;
    unsigned long long _locAutoSearchPoiStartTime;
    unsigned long long _locAutoSearchPoiAttemptId;
    unsigned long long _locPoiDetailStartTime;
    struct CGSize _beginTouchDeltaRatio;
    MISSING_TYPE *_beginTouchRegion;
...
- (void)onPickLocLocateTimeout;
- (void)reportPickLocLocateFailIfNeed:(id)arg1;
- (void)reportPickLocLocateSuccessIfNeed;
- (void)reportPickLocPoiResult:(_Bool)arg1 errCode:(long long)arg2 source:(id)arg3 attemptId:(unsigned long long)arg4 request:(id)arg5 startTime:(unsigned long long)arg6 extra:(id)arg7;
- (id)pickLocPoiExtraWithRequest:(id)arg1 extra:(id)arg2;
- (id)pickLocPoiExtraWithSource:(id)arg1 attemptId:(unsigned long long)arg2 request:(id)arg3 extra:(id)arg4;
- (void)beginPickLocPoiAttemptWithSource:(id)arg1 startFromFirst:(_Bool)arg2;
- (void)onPickLocMapRenderTimeout;
- (void)reportPickLocMapRenderResult:(id)arg1 errCode:(long long)arg2 extra:(id)arg3;
- (id)sanitizePickLocReportExtra:(id)arg1;
...
- (id)getReportParam:(_Bool)arg1;
- (void)reportFinishSelect:(id)arg1;
- (void)reportPoiDetailFailWithErrCode:(long long)arg1 reason:(id)arg2;
- (void)reportPoiDetailSuccess;
- (void)reportPoiDetailStart;
- (void)onPickLocSendTimeout;
- (void)reportSendFailWithErrCode:(long long)arg1 reason:(id)arg2;
- (void)reportSendSuccess;
- (void)reportSendStart;
- (void)reportOnDone;
- (void)dealloc;
