...
@class MMUIButton, MMWebImageView, NSIndexPath, NSMutableSet, NSString, UIButton, UIColor, UIImageView, UILabel, UIView, WCDownloadArgsWrap, WCFinderCommentSectionViewModel, WCFinderFeedContentTextView, WCFinderHeadImageView, WCFinderJumpInfoPanelView, WCFinderLiveNowView, WCPlayerView;
...
+ (struct CGSize)sizeForCardMediaWithCardInfo:(id)arg1;
...
@property(retain, nonatomic) MMWebImageView *identityView; // @synthesize identityView=_identityView;
