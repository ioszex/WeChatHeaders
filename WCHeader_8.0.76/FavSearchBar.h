...
@interface FavSearchBar
{
    ...
    double m_verticalMargin;
    NSMutableArray *m_arrButtons;
    MMUIButton *m_highlightButton;
    NSString *m_updateSearchingName;
    NSString *m_prevTextFieldText;
    _Bool _shouldEdit;
    _Bool _starFilterSelected;
    id <FavSearchBarDelegate> _delegate;
    NSString *_starFilterTitle;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSString *starFilterTitle; // @synthesize starFilterTitle=_starFilterTitle;
@property(nonatomic) _Bool starFilterSelected; // @synthesize starFilterSelected=_starFilterSelected;
...
- (void)setStarFilterSelected:(_Bool)arg1 starTitle:(id)arg2;
...
- (void)initView;
- (_Bool)hasSearchTextContent;
- (double)buttonHeight;
@property(readonly, nonatomic) double verticalMargin;
- (id)initWithWidth:(double)arg1 rightMargin:(double)arg2 verticalMargin:(double)arg3;
