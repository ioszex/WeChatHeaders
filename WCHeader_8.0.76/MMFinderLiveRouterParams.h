...
@class MMFinderLiveContentVM, MMFinderLiveRelatedLiveParams, MMLiveAdsParams, MMLivePivotFlowSharedData, NSArray, NSData, NSMutableDictionary, NSString, UIViewController, WCFinderLiveShareItem;
...
@interface MMFinderLiveRouterParams : NSObject
{
    ...
    NSData *_ofterReadBarLastBuffer;
...
@property(retain, nonatomic) NSData *ofterReadBarLastBuffer; // @synthesize ofterReadBarLastBuffer=_ofterReadBarLastBuffer;
...
- (id)initWithFromVC:(id)arg1 allContentVMs:(id)arg2 selectIndex:(unsigned long long)arg3 tabType:(long long)arg4 fromNotFinder:(_Bool)arg5 commentScene:(int)arg6 entryScene:(int)arg7 entryCardType:(int)arg8 replayEntryType:(id)arg9 withByPass:(_Bool)arg10 enableScroll:(_Bool)arg11 exportIds:(id)arg12;
- (id)initWithFromVC:(id)arg1 contactVM:(id)arg2 customParams:(id)arg3 tabType:(long long)arg4 fromNotFinder:(_Bool)arg5 commentScene:(int)arg6 entryScene:(int)arg7 entryCardType:(int)arg8;
