...
@interface VoIPMPUIv2TouchAlgorithm
{
    _Bool m_hasMoved;
    _Bool m_hasStart;
    _Bool _canMoveOutside;
    _Bool _allowAdsorbToWindow;
    _Bool _isChangingFoldToUnfold;
    _Bool _shouldScaleMinWhenFold;
    _Bool _isScaling;
    _Bool _hasMoveLong;
    id <VoIPMPUIv2TouchAlgorithmDelegate> m_delegate;
    double _edgeOffsetX;
...
@property(nonatomic) _Bool isChangingFoldToUnfold; // @synthesize isChangingFoldToUnfold=_isChangingFoldToUnfold;
...
@property(nonatomic) __weak id <VoIPMPUIv2TouchAlgorithmDelegate> m_delegate; // @synthesize m_delegate;
...
- (double)calculateScaleRatioWithOriginX:(double)arg1 viewWidth:(double)arg2 screenWidth:(double)arg3;
- (void)setupScaleVars:(id)arg1;
- (void)setVoIPMPUIv2TouchAlgorithmDelegate:(id)arg1;
- (id)init;
