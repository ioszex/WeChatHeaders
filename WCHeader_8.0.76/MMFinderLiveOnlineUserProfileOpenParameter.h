...
{
    _Bool _canShowFollowButtonForAudience;
    _Bool _isConnectMicUserNotPKAnchor;
...
@property(nonatomic) _Bool isConnectMicUserNotPKAnchor; // @synthesize isConnectMicUserNotPKAnchor=_isConnectMicUserNotPKAnchor;
@property(nonatomic) _Bool canShowFollowButtonForAudience; // @synthesize canShowFollowButtonForAudience=_canShowFollowButtonForAudience;
