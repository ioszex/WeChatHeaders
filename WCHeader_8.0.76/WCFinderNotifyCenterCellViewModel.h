...
@class FinderFollowReasonInfo, NSArray, NSString, WCFinderAuthInfo, WCFinderContact, WCFinderMention, WCFinderMentionLayoutMetrics;
...
@interface WCFinderNotifyCenterCellViewModel : NSObject
{
    ...
    WCFinderMentionLayoutMetrics *_layoutMetrics;
...
@property(readonly, nonatomic) WCFinderMentionLayoutMetrics *layoutMetrics; // @synthesize layoutMetrics=_layoutMetrics;
...
- (_Bool)isValidBulletCommentMention;
...
- (id)initWithMention:(id)arg1 finderUsername:(id)arg2 containerWidth:(double)arg3 displayStyle:(unsigned long long)arg4;
