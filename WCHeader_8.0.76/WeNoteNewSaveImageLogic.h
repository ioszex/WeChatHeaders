...
@protocol WeNoteNewSaveImageLogicDataSource;

@interface WeNoteNewSaveImageLogic
{
    id <WeNoteNewSaveImageLogicDataSource> m_dataController;
    ...
    struct CGSize _currentContainerViewSize;
}
...
@property(retain, nonatomic) NSMutableAttributedString *sectionContent; // @synthesize sectionContent=_sectionContent;
@property(retain, nonatomic) NSMutableAttributedString *allContent; // @synthesize allContent=_allContent;
@property(nonatomic) struct CGSize currentContainerViewSize; // @synthesize currentContainerViewSize=_currentContainerViewSize;
...
@property(readonly, nonatomic) WNContentStorage *storage; // @synthesize storage=m_storage;
@property(readonly, nonatomic) struct _NSRange paragraphRange; // @synthesize paragraphRange=m_paragraphRange;
...
- (void)fixEmojiFont:(id)arg1;
- (void)replaceWemojiAttachmentsInAttributedString:(id)arg1;
...
- (id)getLongNoteImageWithContent:(id)arg1;
- (id)getLongNoteImage;
- (id)getLongTableViewTextViewWithContent:(id)arg1;
- (id)getLongTableViewTextView;
- (id)getLongNoteView;
- (id)getLongNoteViewWithContent:(id)arg1;
- (id)getLongNoteContainerView:(id)arg1;
...
- (id)getUserInfoView;
- (id)getNewFooterViewForIndex;
- (id)getHeaderView;
- (void)updateShowDate:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)updateShowAuthor:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)setParagraphWithStartIndex:(long long)arg1 endIndex:(long long)arg2;
- (void)clearParagraph;
- (void)setNoteViewController:(id)arg1 withTableView:(id)arg2 andStorage:(id)arg3 andVisibHeight:(double)arg4 andSquareWidth:(double)arg5 andForceLoadImage:(_Bool *)arg6;
