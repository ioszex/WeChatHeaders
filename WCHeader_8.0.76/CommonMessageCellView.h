...
@interface CommonMessageCellView
{
    ...
    UIImageView *m_chatRoomAiTagView;
...
+ (void)showSameTextTranslateDialogInView:(id)arg1 viewModel:(id)arg2 retranslateBlock:(CDUnknownBlockType)arg3;
- (void).cxx_destruct;
...
@property(retain, nonatomic) UIView *plainBgView; // @synthesize plainBgView=_plainBgView;
...
- (void)configChatRoomTextStateViewReportWithContact:(id)arg1;
- (void)onTapChatRoomTextStateViewForCard;
- (void)hideChatRoomTextStateView;
- (void)setChatRoomTextStateEmojiColor;
- (void)initChatRoomAiTagView;
- (void)initChatRoomTextStateLabel;
- (id)createChatRoomTextStateView:(id)arg1;
- (Class)chatRoomTextStateViewClass;
...
- (void)onAppear;
- (void)layoutInternal;
- (void)initPlainBgView;
- (_Bool)isCustAsstContext;
- (void)layoutSubviews;
