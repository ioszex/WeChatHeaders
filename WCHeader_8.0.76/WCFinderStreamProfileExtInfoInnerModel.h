...
+ (void)initialize;
+ (void)PBArrayAdd_cleanDataWhenEnter;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool cleanDataWhenEnter; // @synthesize cleanDataWhenEnter=_cleanDataWhenEnter;
