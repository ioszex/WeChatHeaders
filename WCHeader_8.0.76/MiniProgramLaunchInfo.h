...
@interface MiniProgramLaunchInfo : NSObject
{
    NSString *_appid;
    NSString *_username;
    NSString *_path;
...
+ (id)fromList:(id)arg1;
+ (id)makeWithAppid:(id)arg1 username:(id)arg2 path:(id)arg3 scene:(id)arg4 scene_note:(id)arg5 extra_data:(id)arg6 referrer_info_extra_data:(id)arg7 app_version:(id)arg8 versionType:(id)arg9;
- (void).cxx_destruct;
@property(retain, nonatomic) NSNumber *versionType; // @synthesize versionType=_versionType;
