...
@interface MMLiveStarterWeakNetTipView
{
    ...
    MMUILabel *_clarityTipNumLabel;
    MMUILabel *_clarityTipTitleLabel;
    MMUILabel *_clarityTipDetailLabel;
...
@property(nonatomic) _Bool showClarityItem; // @synthesize showClarityItem=_showClarityItem;
@property(nonatomic) _Bool isShowing; // @synthesize isShowing=_isShowing;
@property(nonatomic) unsigned long long type; // @synthesize type=_type;
- (void)pageSheetDidClose:(_Bool)arg1;
- (void)pageSheetWillDisappear;
- (void)pageSheetDidAppear;
- (void)updateClarityTipDetailLabelText;
...
@property(readonly, nonatomic) MMUILabel *clarityTipDetailLabel;
@property(readonly, nonatomic) MMUILabel *clarityTipTitleLabel;
@property(readonly, nonatomic) MMUILabel *clarityTipNumLabel;
