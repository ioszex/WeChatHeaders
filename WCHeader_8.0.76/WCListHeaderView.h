...
@interface WCListHeaderView
{
    ...
    _Bool m_didConfigureStatusIcon;
...
- (void)configureNicknameContainerStatusIconIfNeeded;
- (_Bool)useNewTextStateViewForProfileScene:(long long)arg1;
- (long long)resolvedNicknameContainerProfileScene;
