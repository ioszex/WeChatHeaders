...
@interface MMHeadImageView
{
    ...
    _Bool _isResetToDefault;
    unsigned int _conerSize;
    MMUILongPressImageView *_headImageView;
    id <MMHeadImageViewDelegate> _delegate;
    struct CGSize _imageSize;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isResetToDefault; // @synthesize isResetToDefault=_isResetToDefault;
@property(nonatomic) __weak id <MMHeadImageViewDelegate> delegate; // @synthesize delegate=_delegate;
