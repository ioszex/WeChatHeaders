...
@interface OMJRecordingSettings : NSObject
{
    ...
    _Bool _shouldDisableExportingAtPreviewing;
    _Bool _shouldExportPhoto;
...
@property(nonatomic) _Bool shouldExportPhoto; // @synthesize shouldExportPhoto=_shouldExportPhoto;
@property(nonatomic) _Bool shouldDisableExportingAtPreviewing; // @synthesize shouldDisableExportingAtPreviewing=_shouldDisableExportingAtPreviewing;
