...
- (void)sizeToFit;
- (void)updateWithVisibleRoomIds:(id)arg1 visibleUserNames:(id)arg2 firstVisibleUserName:(id)arg3 fromRoomId:(id)arg4 selectMode:(long long)arg5 liveMode:(int)arg6;
