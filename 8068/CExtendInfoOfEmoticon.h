...
@interface CExtendInfoOfEmoticon : NSObject
{
    ...
    unsigned int _storeUniqueItem;
    unsigned int _emoticonFrom;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int emoticonFrom; // @synthesize emoticonFrom=_emoticonFrom;
@property(nonatomic) unsigned int storeUniqueItem; // @synthesize storeUniqueItem=_storeUniqueItem;
