...
+ (_Bool)pausePlay;
- (void).cxx_destruct;
@property(nonatomic) _Bool expandFromOutter; // @synthesize expandFromOutter=_expandFromOutter;
...
- (void)_minimizePage:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_minimizePage:(id)arg1;
- (void)minimizePage:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)genSnapImageViewWithImage:(id)arg1;
...
- (void)floatingViewSizeDidChanged:(id)arg1 pinch:(_Bool)arg2;
...
- (struct CGRect)getCurrMinimizeWindowFrame;
