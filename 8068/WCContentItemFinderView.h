...
@class MMUIButton, NSString, NSURL, SightIconView, UIImage, UIImageView, UILabel, UIView, WCContentItemFinderViewModel, WCFinderDataItem, WCFinderFeedMediaWrap, WCFinderMediaInfo;
