...
@class MMUIButton, MMUIView, NSString, UIImageView, WCAdAppointmentLogic, WCAdCardActionButtonLogic, WCAdCardDescriptionView, WCAdCommonInteractionLogic, WCAdCountdownView, WCAdCouponLogic, WCAdFinderFollowLogic, WCAdFinderLiveLogic, WCAdFinderLiveNoticeLogic, WCAdFinderLivePlayerView, WCAdLiveDisplayView, WCAdLiveLikeAnimationView, WCAdMultiProductsLogic, WCAdQuicklyAddBrandLogic, WCAdRollView, WCAdScratchCardLogic, WCAdScratchCardView, WCAdSellingPointLogic, WCAdSubscriptionLogic, WCDataItem, WCHighLightButton, WCSightView, WCTagsView, WCTimeLineTagView;
...
@interface WCTimeLineAdCardBaseView
{
    ...
    WCAdScratchCardView *_scratchCardView;
    WCAdScratchCardLogic *_scratchCardLogic;
    WCAdFinderLiveLogic *_finderLiveLogic;
    WCAdCommonInteractionLogic *_commonInteractionLogic;
    UIImageView *_scratchGapLeft;
    UIImageView *_scratchGapRight;
...
@property(retain, nonatomic) UIImageView *scratchGapRight; // @synthesize scratchGapRight=_scratchGapRight;
@property(retain, nonatomic) UIImageView *scratchGapLeft; // @synthesize scratchGapLeft=_scratchGapLeft;
...
@property(retain, nonatomic) WCAdScratchCardLogic *scratchCardLogic; // @synthesize scratchCardLogic=_scratchCardLogic;
@property(retain, nonatomic) WCAdScratchCardView *scratchCardView; // @synthesize scratchCardView=_scratchCardView;
...
- (void)initScratchGap:(id)arg1;
- (void)initScratchCardView:(id)arg1;
