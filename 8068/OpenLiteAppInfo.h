...
@class LiteAppReferrerInfo, LiteAppStore, MISSING_TYPE, MMUIViewController, NSDictionary, NSString;
...
@interface OpenLiteAppInfo : NSObject
{
    ...
    MISSING_TYPE *_withDownloadLoading;
...
@property(nonatomic) long long keepAliveGroup; // @synthesize keepAliveGroup=_keepAliveGroup;
...
@property(retain, nonatomic) NSString *checkMode; // @synthesize checkMode=_checkMode;
