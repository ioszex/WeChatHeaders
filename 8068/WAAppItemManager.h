...
- (void)onOpenWeAppItem:(id)arg1 scene:(unsigned long long)arg2 sessionId:(id)arg3 isAlreadyRunning:(_Bool)arg4 migrateFromUsername:(id)arg5 reason:(unsigned int)arg6;
- (void)onOpenWeAppItem:(id)arg1 scene:(unsigned long long)arg2 sessionId:(id)arg3 isAlreadyRunning:(_Bool)arg4 migrateFromUsername:(id)arg5;
- (void)onExpandEmbedWeAppItem:(id)arg1 scene:(unsigned long long)arg2 sessionId:(id)arg3;
