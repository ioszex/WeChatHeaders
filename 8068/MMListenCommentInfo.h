...
@class MMListenCommentInfo_FeedbackInfo, MMListenDigitalAlbumInfo, MMListenExtShowInfo, MMListenFootprintInfo, MMListenJumpInfo, MMListenMpCommentInfo, MMListenMusicRewardInfo, MMListenRecommendInfo, NSMutableArray, NSString;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: recommendDesc
