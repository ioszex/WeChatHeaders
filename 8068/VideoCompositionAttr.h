...
@interface VideoCompositionAttr
{
    ...
    double _currentVideoEncodeProgress;
...
- (void).cxx_destruct;
@property(nonatomic) double currentVideoEncodeProgress; // @synthesize currentVideoEncodeProgress=_currentVideoEncodeProgress;
