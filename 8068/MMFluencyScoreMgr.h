...
@class CADisplayLink, NSArray, NSMutableArray, NSString, NSTimer, UILabel, UIScrollView;
...
@interface MMFluencyScoreMgr : NSObject
{
    ...
    _Bool _scoreLabelExpanded;
    _Bool _hitRecord;
    _Bool _hitShowFloat;
    _Bool _hitGenCallTrace;
    _Bool _hitFluencyOptForbidAll;
    _Bool _hitFastPaging;
    float _score;
    ...
    UILabel *_scoreLabel;
    unsigned long long _curAllForbidSwitches;
    NSString *_curAllForbidSwitchesType;
    unsigned long long _hitFastPagingDuration;
...
@property(nonatomic) unsigned long long hitFastPagingDuration; // @synthesize hitFastPagingDuration=_hitFastPagingDuration;
@property(nonatomic) _Bool hitFastPaging; // @synthesize hitFastPaging=_hitFastPaging;
@property(copy, nonatomic) NSString *curAllForbidSwitchesType; // @synthesize curAllForbidSwitchesType=_curAllForbidSwitchesType;
@property(nonatomic) unsigned long long curAllForbidSwitches; // @synthesize curAllForbidSwitches=_curAllForbidSwitches;
@property(nonatomic) _Bool hitFluencyOptForbidAll; // @synthesize hitFluencyOptForbidAll=_hitFluencyOptForbidAll;
...
@property(nonatomic) _Bool scoreLabelExpanded; // @synthesize scoreLabelExpanded=_scoreLabelExpanded;
