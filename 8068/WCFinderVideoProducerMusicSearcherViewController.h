...
@class EditVideoBGMPlayer, NSData, NSIndexPath, NSString, UIButton, UICollectionView, UITextField, UIView, WCFinderVideoProducerDataSource, WCFinderVideoProducerLoadMoreView;
@protocol WCFinderVideoProducerMusicSearcherDelegate;

@interface WCFinderVideoProducerMusicSearcherViewController
{
    _Bool _isSearchingAfterInputEnabled;
    _Bool _isSearching;
    _Bool _lastSearchSequence;
    id <WCFinderVideoProducerMusicSearcherDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderVideoProducerMusicSearcherDelegate> delegate; // @synthesize delegate=_delegate;
