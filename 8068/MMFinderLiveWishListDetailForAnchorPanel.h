...
@class FinderLiveGiftWallInfo, InteractionWishConfig, MMFinderLiveInteractionWishProgressView, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveHalfScreenTitleBarView, MMUIButton, MMUILabel, NSArray, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView, UIScrollView, UIView;
