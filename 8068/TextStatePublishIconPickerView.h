...
@class CAGradientLayer, NSString, TextStateEmojiBoardReportObject, TextStateEmojiBoardView, TextStatePublishCustomIconPanelReportObject, TextStatePublishCustomIconView, TextStatePublishIconList, TextStatePublishOfficialIconCollectionView, TextStatePublishRecentUseIconView, TextStatePublishReportObject, UIView;
...
@interface TextStatePublishIconPickerView : UIScrollView
{
    ...
    TextStatePublishCustomIconPanelReportObject *_customIconPanelReportObject;
...
@property(retain, nonatomic) TextStatePublishCustomIconPanelReportObject *customIconPanelReportObject; // @synthesize customIconPanelReportObject=_customIconPanelReportObject;
...
- (void)onEmojiBoardItemSelected:(id)arg1 groupDescription:(id)arg2 iconSelectFrom:(long long)arg3;
- (void)onDescTextShouldRequestRecommend:(id)arg1;
...
- (void)onTapSwitchIconButton:(id)arg1;
