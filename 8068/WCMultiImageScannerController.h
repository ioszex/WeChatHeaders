...
@class MJTemplatePlayerView, NSMutableArray, NSMutableSet, NSString, PageScrollView, SightAssetPreviewView, SightDraft, UIButton, WCMomentsPageContext;
...
- (void)autoPlayLivePhotoIfReady:(unsigned long long)arg1;
...
- (id)generateLivePhotoBrowseReportWithMMImage:(id)arg1;
