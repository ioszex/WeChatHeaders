...
@interface WCAddressControlLogic
{
    ...
    _Bool _responseWithAddressID;
    unsigned long long _entryScene;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool responseWithAddressID; // @synthesize responseWithAddressID=_responseWithAddressID;
...
- (void)setSelectedAddressID:(unsigned int)arg1;
...
- (void)startLoading;
- (id)getLatestAddress;
- (id)initWithJSEvent:(id)arg1 AuthenticationStruct:(id)arg2 entryScene:(unsigned long long)arg3 isFromManage:(_Bool)arg4;
- (id)initWithJSEvent:(id)arg1 AuthenticationStruct:(id)arg2 entryScene:(unsigned long long)arg3;
