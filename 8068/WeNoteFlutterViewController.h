...
@class CMessageWrap, FavDataItemWrap, FavoritesItem, FavoritesItemDataField, MMScrollActionSheet, MMTimer, MiniRecTransitionController, NSMutableArray, NSString, RTEAttachmentViewProvider, UIImage, WCDataItem, WNContentStorage, WNSaveImageLogic, WeNoteAffDelegateLogic, WeNoteFlutterInstance, WeNoteReportLogic;
