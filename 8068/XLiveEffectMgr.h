...
- (struct CGSize)executeAlgorithm:(struct __CVBuffer *)arg1;
- (id)processPixelBuffer:(struct __CVBuffer *)arg1 flipX:(_Bool)arg2 algorithmTexSize:(struct CGSize *)arg3;
