...
@class CContact, EditImageForwardAndEditLogicController, ForwardMessageLogicController, MISSING_TYPE, MMHeadImageView, MMImageOpenWeAppLogic, MMScrollView, MMUIButton, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, RichTextView, ScanQRCodeLogicController, SessionForwardRecordLogic, ShareDataToOpenSDKController, UIButton, UIImageView, UILabel, UIView, WCImageTranslateLogic, WCLikeButton, WCMomentsPageContext, WCMomentsScrollActionSheet, WCMomentsShareScopeMgr, WCTogetherHistoryReportSession;
