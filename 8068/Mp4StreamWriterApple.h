...
- (int)writeVideoFrame:(unique_ptr_646ed924)arg1 duration:(long long)arg2;
- (_Bool)writeAudioSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;
- (int)writeAudioFrame:(unique_ptr_076c7c9d)arg1;
- (int)enqueueVideoFrame:(unique_ptr_646ed924)arg1;
- (int)enqueueAudioFrame:(unique_ptr_076c7c9d)arg1;
