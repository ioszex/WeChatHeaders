...
@class FlutterEventChannel, NSString, TingAudioRecordCallback, TingFlutterPlayController, TingLaterListenChannel, TingPlayerAdvertisement, TingStarItemChangeChannel, UIViewController, WCFinderCreateCoordinator;
...
- (void)startRecordWithFormatMinTimeInSecond:(long long)arg1 maxTimeInSecond:(long long)arg2 format:(id)arg3 completion:(CDUnknownBlockType)arg4;
