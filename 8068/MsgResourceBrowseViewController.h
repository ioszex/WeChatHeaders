...
+ (_Bool)previewZipFileWithRecord:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
+ (_Bool)previewZipFileWithMsg:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
+ (void)previewZip:(id)arg1 inNavigationController:(id)arg2 animated:(_Bool)arg3;
