...
@class CContact, ContactsDataLogic, NSString, SharePreConfirmSheetView, WCPayNetImageResource, WCPayRealnameAuthenResp, WCPayRealnameVerifyGuardianCgi, WCPayRealnameVerifyParentCgi;
