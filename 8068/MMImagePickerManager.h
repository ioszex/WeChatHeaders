...
- (void)MMImagePickerControllerDidCancelWithInfo:(id)arg1 selectedAssets:(id)arg2 finderData:(id)arg3;
...
- (void)MMImagePickerControllerDidCancelEditVideo:(id)arg1 infos:(id)arg2;
- (void)MMImagePickerControllerDidCancelEditImages:(id)arg1 infos:(id)arg2;
