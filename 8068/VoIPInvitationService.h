...
- (_Bool)handleCancelMonoMsgWithRoomID:(unsigned long long)arg1 roomKey:(long long)arg2 fromUserName:(id)arg3;
- (_Bool)handleInviteMonoMsg:(id)arg1 withTalkingRoomID:(unsigned long long)arg2 talkingRoomKey:(unsigned long long)arg3;
- (_Bool)handleInvitationInfo:(id)arg1 withTalkingRoomID:(unsigned long long)arg2 talkingRoomKey:(unsigned long long)arg3;
- (void)reset;
