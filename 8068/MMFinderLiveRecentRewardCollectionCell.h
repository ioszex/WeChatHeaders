...
@class MISSING_TYPE, MMCPLabel, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveMemberSignView, MMFinderLiveNormalTextSignView, MMFinderLiveRecentRewardGiftsView, MMFinderLiveRecentRewardUserItem, MMFinderLiveTask, MMUIImageView, NSMutableArray, NSString, UIView, WCFinderHeadImageView;
...
@interface MMFinderLiveRecentRewardCollectionCell : UICollectionViewCell
{
    ...
    MISSING_TYPE *_displayNameLabel;
