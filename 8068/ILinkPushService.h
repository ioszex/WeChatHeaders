...
@class CIContext, ConfAVMemberList, IConfSDKRegisterableCallbackHolder, MISSING_TYPE, MMConfSDKAudioMgr, MMConfSDKCGIImp, MMConfSDKMemberMgr, MMConfSDKNetworkMgr, MMConfSDKVideoHWenc, MMTimer, NSMutableArray, NSMutableData, NSMutableDictionary, NSObject, NSString, VoIPConfSDKNativeCallbackMgr;
...
@interface ILinkPushService
{
    ...
    MISSING_TYPE *_enableCustomAudio;
    NSMutableArray *_msgArray;
    _Bool _needReInit;
    _Bool _isPaused;
    NSMutableData *_xpsData;
    CIContext *_preProcessContext;
}

- (void).cxx_destruct;
@property(retain, nonatomic) CIContext *preProcessContext; // @synthesize preProcessContext=_preProcessContext;
...
- (struct __CVBuffer *)clipCVPixelBuffer:(struct __CVBuffer *)arg1 outPixelBuffer:(struct __CVBuffer *)arg2 dstW:(int)arg3 dstH:(int)arg4;
