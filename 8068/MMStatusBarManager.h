...
@interface MMStatusBarManager
{
    ...
    double _preferredStatusBarHeight;
}

- (void).cxx_destruct;
@property(nonatomic) double preferredStatusBarHeight; // @synthesize preferredStatusBarHeight=_preferredStatusBarHeight;
...
- (void)updateSystemNavigationBarFrame:(struct CGRect)arg1;
