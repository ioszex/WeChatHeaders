...
@class AnchorSwitchSkinInfo, AudienceAiCustomGiftInfo, CustomGiftInfo, FinderJumpInfo, FinderLiveGiftBatchGiveConfigList, FinderLiveGift_ForegroundInfo, FinderLiveGift_SwitchSkinInfo, NSData, NSMutableArray, NSString;
