...
@class NSAttributedString, NSMutableArray, NSMutableAttributedString, NSString, UITableView, UIView;
...
@interface WCTableViewSectionManager : NSObject
{
    ...
    NSAttributedString *_attributedHeaderTail;
...
@property(copy, nonatomic) NSAttributedString *attributedHeaderTail; // @synthesize attributedHeaderTail=_attributedHeaderTail;
...
- (id)getFooterView;
- (id)getHeaderView;
- (id)makeViewWith:(id)arg1 attributedTitle:(id)arg2 tailText:(id)arg3 topPading:(double)arg4 bottomPadding:(double)arg5;
