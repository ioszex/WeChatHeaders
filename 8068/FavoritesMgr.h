...
- (void)getNextPageFavoritesList:(int)arg1 byCurMinUpdateTime:(unsigned int)arg2 andPinTopFirst:(_Bool)arg3 byCurMinPinTopTime:(unsigned int)arg4;
- (void)checkInvalidNote:(id)arg1 batchgetList:(id)arg2;
- (_Bool)checkCanReUploadItem:(id)arg1;
- (void)tryFixUploadStatus;
- (void)getFirstPageFavoritesList:(int)arg1 andPinTopFirst:(_Bool)arg2;
