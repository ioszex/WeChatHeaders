...
@class NSAdaptiveImageGlyph, NSArray, NSAttributedString, NSDictionary, NSString, UIInputSuggestion, UIMenu, UITextPlaceholder, UITextPosition, UITextRange, UIView;
...
- (void)insertInputSuggestion:(UIInputSuggestion *)arg1;
