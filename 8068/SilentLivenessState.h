...
- (void)checkBestImage:(struct Mat)arg1 withTrackInfo:(CDStruct_0edc81f6)arg2 withInRectRatio:(float)arg3 withBlurScore:(double)arg4 mouthScore:(float)arg5 eyeScore:(float)arg6;
- (struct vector<float, std::allocator<float>>)covnertFaceShape:(void *)arg1;
