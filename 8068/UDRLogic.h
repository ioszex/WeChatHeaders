...
- (void)configParameters:(struct GetResourceDescriptionInfo *)arg1;
- (void)dealFailResourceCallback:(id)arg1 name:(id)arg2 version:(int)arg3 remoteVersion:(int)arg4 errorType:(int)arg5 errorCode:(int)arg6 timeStamp:(unsigned int)arg7 scene:(long long)arg8 sampleRate:(float)arg9;
...
- (id)getWxResourceDecrypt:(id)arg1 name:(id)arg2;
