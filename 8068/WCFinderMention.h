...
@class FinderContact, FinderJumpInfo, FinderMention, FinderMentionAggregated, FinderMentionContact, FinderMentionExtInfo, FinderMention_FinderMentionThankInfo, FinderMention_LikeContactInfo, FinderNotification, NSString, WCFinderCommentMentionInfo, WCFinderContact, WCFinderMentionAggregatedContactList;
...
- (_Bool)enableCommentImage;
- (_Bool)enableCommentEmotion;
- (void)setSilented:(_Bool)arg1;
- (_Bool)silented;
- (_Bool)enableSilent;
- (id)transToComment;
- (struct CGSize)_getEmojiDisplaySize;
- (struct CGSize)_getImageDisplaySize;
- (struct CGSize)getDisplayInfoSize;
- (_Bool)showDiplayAttachment;
