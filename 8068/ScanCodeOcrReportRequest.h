...
- (id)initWithCodeContent:(id)arg1 codeType:(int)arg2 paymentCodeType:(int)arg3 isPaymentCode:(_Bool)arg4 originalImage:(id)arg5 getA8KeyScene:(int)arg6 getA8KeyRequestId:(int)arg7 msgId:(id)arg8 fromRawScene:(long long)arg9 reportType:(unsigned long long)arg10;
