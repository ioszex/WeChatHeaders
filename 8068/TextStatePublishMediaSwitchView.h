...
@interface TextStatePublishMediaSwitchView : UIView
{
    ...
    _Bool _useSystemFilterToGenerateBlur;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool useSystemFilterToGenerateBlur; // @synthesize useSystemFilterToGenerateBlur=_useSystemFilterToGenerateBlur;
