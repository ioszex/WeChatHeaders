...
@class AutoTranslateMsgController, AutoTranslateMsgControllerV2, BaseMsgContentViewController, BaseMsgLoaderLogic, CBaseContact, CContactVerifyLogic, CMessageWrap, ForwardMessageLogicController, ImageController, MISSING_TYPE, MMEasterEggController, MMLocatingPoiDataLogic, MMPickLocationViewController, MMUIViewController, MultiSelectController, MyFavoritesListViewController, NSArray, NSMutableDictionary, NSMutableSet, NSString, RecordController, SendVerifyMsgLogicController, ShareDataToOpenSDKController, ShareFriendOnChatLogicController, ShareMessageConfirmLogicHelper, TypingController, UINavigationController, UIViewController, UrlController, VoiceAutoTranslateHelper, WAAppIdToUsernameTransfer, WCScheduleLogicController, ilinkMultiSelectLogic;
