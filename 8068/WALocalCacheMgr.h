...
@class NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, WAPackageDownloadLogic, WAPackageInfoCacheLogic;
...
@interface WALocalCacheMgr
{
    ...
    NSRecursiveLock *_checksumVerifiedSetLock;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSRecursiveLock *checksumVerifiedSetLock; // @synthesize checksumVerifiedSetLock=_checksumVerifiedSetLock;
...
- (void)reportPackageVerify:(id)arg1 verifyType:(long long)arg2 costTime:(unsigned long long)arg3 fileSize:(unsigned long long)arg4;
