...
@interface LoginUserInfo : NSObject
{
    ...
    NSString *_m_nsNoPwdLoginTicketForOneClick;
    NSData *_m_dtAutoAuthKey;
    NSString *_m_bindLoginUserName;
    NSData *_passkeyCredentialID;
    unsigned long long _extStatus2;
    unsigned long long _loginTypeCfg;
}

+ (void)initialize;
+ (void)PBArrayAdd_m_nsNoPwdLoginTicketForOneClick;
+ (void)PBArrayAdd_loginTypeCfg;
+ (void)PBArrayAdd_noPwdOpenStatus;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned long long loginTypeCfg; // @synthesize loginTypeCfg=_loginTypeCfg;
@property(nonatomic) _Bool noPwdOpenStatus; // @synthesize noPwdOpenStatus=_noPwdOpenStatus;
...
@property(retain, nonatomic) NSString *m_nsNoPwdLoginTicketForOneClick; // @synthesize m_nsNoPwdLoginTicketForOneClick=_m_nsNoPwdLoginTicketForOneClick;
