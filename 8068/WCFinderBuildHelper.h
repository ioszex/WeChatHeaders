...
+ (id)createSeparatorLineWithContainerWidth:(double)arg1 leftInset:(double)arg2 rightInset:(double)arg3;
+ (void)loadSVGImageFromURL:(id)arg1 size:(struct CGSize)arg2 color:(id)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)removeEdgeMaskToView:(id)arg1;
+ (void)addEdgeMaskToView:(id)arg1 maskWidth:(double)arg2 leftMask:(_Bool)arg3 rightMask:(_Bool)arg4;
...
+ (id)createCellWithImage:(id)arg1 iconUrl:(id)arg2 title:(id)arg3 subTitle:(id)arg4 themeColor:(id)arg5 subTitleColor:(id)arg6 showRightArrow:(_Bool)arg7 backgroundColor:(id)arg8 width:(double)arg9 rightTips:(id)arg10 rightShowRedDot:(_Bool)arg11 leftPadding:(double)arg12 rightPadding:(double)arg13;
...
+ (id)detectWechatEmotionRanges:(id)arg1;
