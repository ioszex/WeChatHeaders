...
- (void)snapshotAtTime:(CDStruct_1b6d18a9)arg1 withClipBundleID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)skimToTime:(CDStruct_1b6d18a9)arg1 withClipBundleID:(id)arg2;
...
- (void)startPlayingInView:(id)arg1 withClipBundleID:(id)arg2 startTime:(CDStruct_1b6d18a9)arg3 timeRange:(CDStruct_e83c9415)arg4 loopCount:(int)arg5 isMuted:(_Bool)arg6 completionHandler:(CDUnknownBlockType)arg7;
