...
@class NSArray, NSData, NSString, NewLifeShareExtInfo, WCFinderShareAttachInfo, WCFinderShareXMLExtInfo;
...
@interface WCFinderShareToMomentsItem : NSObject
{
    ...
    WCFinderShareXMLExtInfo *_extInfo;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderShareXMLExtInfo *extInfo; // @synthesize extInfo=_extInfo;
