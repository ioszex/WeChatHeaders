...
@interface ScanQRCodeLogicController
{
    ...
    _Bool _isSupportAlbumMultiCodes;
...
@property(nonatomic) _Bool isSupportAlbumMultiCodes; // @synthesize isSupportAlbumMultiCodes=_isSupportAlbumMultiCodes;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: isPreScanImageFinish
