...
@class MJTemplateMovieSession, MJVideoTemplate, NSString, OMJMusicInfo, OMJTemplateInfo, UIImage, UIView, WCFinderVideoProducerActionRecorder, WCFinderVideoProducerDataManager, WCFinderVideoProducerExportSettingsLoader, WCFinderVideoProducerFlavors, WCFinderVideoProducerOptions, WCMomentsPostReportSession;
