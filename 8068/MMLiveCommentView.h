...
@interface MMLiveCommentView : UIView
{
    ...
    WCLiveBottomTextButton *_barrageSwitchButton;
    ...
    CAGradientLayer *_cancelEditMaskGradientLayer;
...
@property(retain, nonatomic) CAGradientLayer *cancelEditMaskGradientLayer; // @synthesize cancelEditMaskGradientLayer=_cancelEditMaskGradientLayer;
...
@property(retain, nonatomic) WCLiveBottomTextButton *barrageSwitchButton; // @synthesize barrageSwitchButton=_barrageSwitchButton;
...
- (void)updateEditMaskGradientBottomPosition:(double)arg1;
