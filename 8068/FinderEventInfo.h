...
@class FinderContact, FinderEventDescriptionContact, FinderEventInfo_LiveEntranceInfo, FinderEventInfo_TemplateVersionInfo, FinderEventInfo_VideoTemplateInfo, FinderEventMusicInfo, FinderEventQuestInfo, FinderEventWordingInfo, FinderJumpInfo, FinderTopicHashTagInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) FinderEventInfo_LiveEntranceInfo *liveInfo; // @dynamic liveInfo;
