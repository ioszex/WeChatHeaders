...
{
    _Bool _getChatPackageUseSingleThread;
    ...
    unsigned long long _getChatLogSizeTaskId;
    NSRecursiveLock *_mapLock;
    NSRecursiveLock *_getChatLogLock;
    NSRecursiveLock *_taskMapLock;
}

+ (id)sharedInstance;
- (void).cxx_destruct;
@property(nonatomic) _Bool getChatPackageUseSingleThread; // @synthesize getChatPackageUseSingleThread=_getChatPackageUseSingleThread;
@property(retain, nonatomic) NSRecursiveLock *taskMapLock; // @synthesize taskMapLock=_taskMapLock;
@property(retain, nonatomic) NSRecursiveLock *getChatLogLock; // @synthesize getChatLogLock=_getChatLogLock;
@property(retain, nonatomic) NSRecursiveLock *mapLock; // @synthesize mapLock=_mapLock;
@property(nonatomic) unsigned long long getChatLogSizeTaskId; // @synthesize getChatLogSizeTaskId=_getChatLogSizeTaskId;
...
- (void)getAllConversationListInfoForBackupPrepareAsync:(unsigned long long)arg1 packageInfo:(id)arg2;
...
- (void)insertChatPackageCloudAsync:(unsigned long long)arg1 packageId:(unsigned long long)arg2 convId:(id)arg3 chatPackage:(id)arg4;
- (void)insertChatPackageAsync:(unsigned long long)arg1 packageId:(unsigned long long)arg2 convId:(id)arg3 chatPackage:(id)arg4;
- (void)onChatLogCalculateBackupChatLogFilter:(id)arg1 totalSize:(unsigned long long)arg2 fullDiffDic:(id)arg3;
- (void)getChatLogSizeAsync:(unsigned long long)arg1 usernameList:(id)arg2 backupTime:(int)arg3;
- (void)getChatPackageCloudAsync:(unsigned long long)arg1 conversationId:(id)arg2 fromTime:(unsigned long long)arg3 offset:(unsigned long long)arg4 limit:(int)arg5;
- (void)downloadFromCdnAsync:(unsigned long long)arg1 session:(id)arg2 fileId:(id)arg3 fileType:(int)arg4 size:(unsigned long long)arg5 savePath:(id)arg6 aesKey:(id)arg7 isAppend:(_Bool)arg8;
...
- (void)copyToCdnAsync:(unsigned long long)arg1 req:(id)arg2;
- (id)getAccountSalt;
- (void)removeMediaAsync:(unsigned long long)arg1 req:(id)arg2;
- (void)appendToCdnAsync:(unsigned long long)arg1 req:(id)arg2;
- (void)batchUploadToCdnAsync:(unsigned long long)arg1 req:(id)arg2;
- (void)uploadToCdnAsync:(unsigned long long)arg1 req:(id)arg2;
...
- (void)refreshConversations:(unsigned long long)arg1;
...
- (id)createTaskFromTaskInfo:(id)arg1;
- (void)fillModelByImcompleteTask:(id)arg1 task:(id)arg2;
- (void)getAllPackageModelsCrossPlatform;
- (void)getAllPackageModels:(_Bool)arg1 isFirstTime:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)setupAutoBackupEventWithModel:(id)arg1 delayFirst:(_Bool)arg2;
