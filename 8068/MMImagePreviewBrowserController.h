...
@class EditImageIntialView, EditVideoLogicItem, MMAsset, MMAssetSelectCheckButton, MMAssetSelectedCollectionView, MMUIActivityIndicatorView, MMUIButton, MMUILabel, MultiImageScrollView, NSMutableDictionary, NSMutableSet, NSString, UIButton, UIImageView, UILabel, UIView, VideoEncodeTask, WCFinderCreateCoordinator, WCFinderPreviewEditVideoCompositionTask, WCFinderSyncComposeResModel;
