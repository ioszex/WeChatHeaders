...
+ (_Bool)isFileHandleAtEnd:(id)arg1;
+ (id)decodeOneObjectFromFileHandle:(id)arg1 ofClass:(Class)arg2 error:(id *)arg3;
+ (_Bool)batchDecodeContainerOfClass:(Class)arg1 withValueClass:(Class)arg2 fromFile:(id)arg3 batchSize:(unsigned long long)arg4 usingBlock:(CDUnknownBlockType)arg5 error:(id *)arg6;
+ (_Bool)batchDecodeContainerOfClass:(Class)arg1 withValueClass:(Class)arg2 fromFile:(id)arg3 batchSize:(unsigned long long)arg4 usingBlock:(CDUnknownBlockType)arg5;
