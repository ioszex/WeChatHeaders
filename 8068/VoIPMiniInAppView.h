...
@interface VoIPMiniInAppView : UIView
{
    ...
    VoipMinimizeView *_extendMinimizeView;
    UIButton *_extendButton;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UIButton *extendButton; // @synthesize extendButton=_extendButton;
@property(retain, nonatomic) VoipMinimizeView *extendMinimizeView; // @synthesize extendMinimizeView=_extendMinimizeView;
...
@property(nonatomic) _Bool isSplitLocalOnTop; // @synthesize isSplitLocalOnTop=_isSplitLocalOnTop;
