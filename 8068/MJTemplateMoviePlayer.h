...
@interface MJTemplateMoviePlayer
{
    ...
    MJTemplateMoviePlayerConfiguration *_configuration;
...
@property(readonly, nonatomic) MJTemplateMoviePlayerConfiguration *configuration; // @synthesize configuration=_configuration;
...
- (id)initWithClipBundleID:(id)arg1 configuration:(id)arg2;
