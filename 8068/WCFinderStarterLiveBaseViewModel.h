...
- (void)setLiveChargableWithFlag:(int)arg1 liveMode:(int)arg2 chargeUnitPriceInWecoin:(unsigned int)arg3 purchaseLivePreviewType:(long long)arg4 trialTimeHour:(unsigned int)arg5 trialTimeMinute:(unsigned int)arg6 freeOfChargeChatroomIdList:(id)arg7 freeOfChargeUsernameList:(id)arg8 fullFreeOfChargeContactList:(id)arg9 selectedFreeRosterList:(id)arg10 selectedFreeTagList:(id)arg11 memberFree:(_Bool)arg12;
- (void)setVisibilityMode:(long long)arg1 liveMode:(int)arg2 andIdList:(id)arg3 chatRoomIdList:(id)arg4 visibleUsernameList:(id)arg5 selectedTagNameList:(id)arg6;
