...
@class ForeignHbCurrencyTips, MISSING_TYPE, NSData, NSMutableArray, NSString;
...
@interface WCRedEnvelopesDetailInfo : NSObject
{
    ...
    MISSING_TYPE *m_bHasWriteThanks;
    ...
    NSString *_amount_info_wording;
    NSString *_amount_info_routeInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *amount_info_routeInfo; // @synthesize amount_info_routeInfo=_amount_info_routeInfo;
@property(retain, nonatomic) NSString *amount_info_wording; // @synthesize amount_info_wording=_amount_info_wording;
