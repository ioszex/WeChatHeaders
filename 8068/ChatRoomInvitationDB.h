...
- (_Bool)updateInvitationQRCodeDisabledWithChatRoom:(id)arg1 svrId:(long long)arg2;
- (_Bool)batchUpdateInvitationQRCodeDisabledWithChatRoom:(id)arg1 arrQRCode:(id)arg2;
- (id)getEffectiveInvitationsInQRCodeSceneWithChatRoom:(id)arg1;
- (id)getInvitationWithChatRoom:(id)arg1 svrId:(long long)arg2;
- (id)getInvitationWithChatRoomInQrcodeScene:(id)arg1 inviter:(id)arg2 memberList:(id)arg3 hasApproved:(_Bool)arg4 qrCode:(id)arg5;
