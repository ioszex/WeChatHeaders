...
@class EmoticonCustomCreateLogic, EmoticonCustomManageAddLogic, EmoticonCustomManageCollectionLayout, EmoticonCustomManageCollectionView, EmoticonCustomManageDataLogic, EmoticonCustomManagePopInteractiveTransition, EmoticonCustomManageSwipeSelectGestureRecognizer, EmoticonCustomSortBGView, EmoticonCustomSortInsertBrickView, EmoticonLoadMoreFooterView, NSMutableArray, NSMutableDictionary, NSString, UIButton, UILabel, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView;
...
@interface EmoticonCustomManageNewForPostedViewController
{
    ...
    NSMutableArray *_postedEmoticons;
    NSMutableDictionary *_postedEmoticonsTokens;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *postedEmoticonsTokens; // @synthesize postedEmoticonsTokens=_postedEmoticonsTokens;
@property(retain, nonatomic) NSMutableArray *postedEmoticons; // @synthesize postedEmoticons=_postedEmoticons;
...
- (void)makeNewAddedEmoticons:(id)arg1 token:(id)arg2;
