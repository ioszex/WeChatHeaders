...
- (void)setServiceCheckAliveFailedCount:(unsigned int)arg1;
- (unsigned int)serviceCheckAliveFailedCount;
...
- (void)newPopChildrenAndSwitchInMainTabWebView:(id)arg1 currentWebView:(id)arg2 withPagePath:(id)arg3;
- (void)popChildrenAndSwitchInMainTabWebView:(id)arg1 currentWebView:(id)arg2 withPagePath:(id)arg3;
...
- (void)presentNextWithStack:(id)arg1 indexValue:(long long)arg2;
- (void)presentSnapshotStack:(id)arg1;
- (_Bool)attemptToPresentWeappNavControllerIfInAgentMode:(id)arg1;
...
- (id)sendNavigateBackToStackPreviousWebViewWhenDismissingStack:(id)arg1;
...
- (void)saveWebViewHTMLToFileWithCompletion:(CDUnknownBlockType)arg1;
