...
@class NSIndexPath, NSMutableSet, NSString, UIButton, UICollectionView, UIImageView, UILabel, UIView, WAMainFrameTaskBarDeleteActionWindow, WAMainFrameTaskBarSectionWeAppViewModel, WAStarCollectionViewLayout;
...
@interface WAMainFrameTaskBarSectionWeAppView
{
    ...
    NSMutableSet *_reportedCommonUsedAppIds;
}
...
+ (id)titleFont;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableSet *reportedCommonUsedAppIds; // @synthesize reportedCommonUsedAppIds=_reportedCommonUsedAppIds;
