...
@class LiteAppAssetInfo, LiteAppAssetPickerControlCenter, MMAssetICloudLoadingView, MMAssetSelectCheckButton, MMUILabel, NSMutableArray, NSString, UIImage, UIImageView, UILabel, UIView, WCLivePhotoButton, WCLivePhotoButtonModel;
...
- (_Bool)isShowLivePhotoIcon;
- (_Bool)isShowLivePhotoBtn;
