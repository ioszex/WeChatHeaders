...
@interface WCTimeLineAdFullCardView
{
    ...
    unsigned long long _uiValidDistance;
...
@property(nonatomic) unsigned long long uiValidDistance; // @synthesize uiValidDistance=_uiValidDistance;
@property(nonatomic) long long pointRadius; // @synthesize pointRadius=_pointRadius;
@property(nonatomic) _Bool uiIsSimpleGesture; // @synthesize uiIsSimpleGesture=_uiIsSimpleGesture;
...
- (_Bool)checkPointsOrientationHorizontal:(id)arg1;
- (_Bool)checkSourcePointsDistance;
- (_Bool)checkGestureMistake;
