...
- (void).cxx_destruct;
@property(copy, nonatomic) NSString *enterTid; // @synthesize enterTid=_enterTid;
...
- (id)initWithBizUsername:(id)arg1 bizInfo:(id)arg2 brandFinderJumpInfo:(id)arg3 dataArray:(id)arg4 lastBuffer:(id)arg5 continueFlag:(_Bool)arg6 enterTid:(id)arg7;
