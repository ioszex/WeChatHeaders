...
@class MMFinderLiveActivityView, MMFinderLiveLimitModeLiveInfoEnsurer, MMUIViewController, MMWebImageView, NSString, RichTextView, UIImageView, UILabel, UIView, WCFinderLiveNowView, WCFinderLiveShareCellFullStatusView, WCFinderShareLiveCellViewModel;
...
- (void)reportLiveShareActionWithEid:(id)arg1 isExpose:(_Bool)arg2;
