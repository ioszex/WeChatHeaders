...
@class NSArray, NSDictionary, NSMutableArray, NSString, WAAppTaskSystemCoverView, WAJSCoreService, WAPermissionResult, WATransferJSAPIRuntimeModel, WAWebViewController;
