...
@class ContentDateInfo, MMActionSheetDatePicker, MMUIViewController, NSString, UIView, WCScheduleItem;
@protocol WCScheduleLogicControllerDelegate;

@interface WCScheduleLogicController
{
    _Bool _isCancelSchedule;
    unsigned int _selectedRecommendInterval;
    id <WCScheduleLogicControllerDelegate> _delegate;
    ContentDateInfo *_contentDateInfo;
...
@property(nonatomic) unsigned int selectedRecommendInterval; // @synthesize selectedRecommendInterval=_selectedRecommendInterval;
@property(retain, nonatomic) ContentDateInfo *contentDateInfo; // @synthesize contentDateInfo=_contentDateInfo;
...
- (void)startCancelScheduleItem:(id)arg1 fromViewController:(id)arg2;
