...
@interface MMTemplateMsgScopeItem
{
    ...
    _Bool _isNotifyTemplate;
    _Bool _isAcceptWithNotify;
...
+ (void)initialize;
+ (void)PBArrayAdd_isAcceptWithNotify;
+ (void)PBArrayAdd_isNotifyTemplate;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isAcceptWithNotify; // @synthesize isAcceptWithNotify=_isAcceptWithNotify;
@property(nonatomic) _Bool isNotifyTemplate; // @synthesize isNotifyTemplate=_isNotifyTemplate;
