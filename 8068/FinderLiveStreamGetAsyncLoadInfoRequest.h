...
@property(retain, nonatomic) NSMutableArray *interactionEntryType; // @dynamic interactionEntryType;
...
@property(retain, nonatomic) NSMutableArray *liveroomInfo; // @dynamic liveroomInfo;
