...
@class MMBadgeView, NSAttributedString, NSString, UIImageView, UILabel, UITapGestureRecognizer, WCFinderRedDotTipsShowInfo, WCFinderSizingRichTextView, YYLabel;
...
@interface WCFinderPersonalCenterSidesButton : UIView
{
    ...
    WCFinderSizingRichTextView *_redDotTextView;
...
@property(retain, nonatomic) WCFinderSizingRichTextView *redDotTextView; // @synthesize redDotTextView=_redDotTextView;
