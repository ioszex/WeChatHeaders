...
+ (id)fromList:(id)arg1;
+ (id)makeWithUserName:(id)arg1 postalCode:(id)arg2 nationalCode:(id)arg3 telNumber:(id)arg4 province:(id)arg5 city:(id)arg6 county:(id)arg7 street:(id)arg8 detail:(id)arg9 houseNum:(id)arg10 addressId:(id)arg11;
- (void).cxx_destruct;
