...
@interface ChatRoomManagementViewController
{
    ...
    _Bool m_islodingForGetContact;
    _Bool m_isChangecRoomQRCodeAccessType;
...
- (void)viewDidLoad;
- (void)switchJoinChatRoomQRCode:(id)arg1;
- (_Bool)checkIsNewChatRoomManagementType;
- (void)onModifyContactInExpand:(id)arg1;
- (id)getChatRoomInvitationCellTitle;
- (void)addJoinChatRoomAllowOwnerApproveCellAtSection:(id)arg1;
