...
@class FinderLiveBoxId, MISSING_TYPE, MMFinderLiveCommentEntranceView, MMFinderLiveTaskId, NSMutableArray, UIScrollView;

@interface MMFinderLiveCommentEntranceTabBar : UIView
{
    MISSING_TYPE *_commentEntranceDidTapToChangeCallback;
