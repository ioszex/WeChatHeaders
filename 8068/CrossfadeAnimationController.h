...
@interface CrossfadeAnimationController : NSObject
{
    ...
    _Bool _reverse;
    _Bool _isDismiss;
    _Bool _shouldForwardLifecycleEvent;
    double _duration;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool shouldForwardLifecycleEvent; // @synthesize shouldForwardLifecycleEvent=_shouldForwardLifecycleEvent;
