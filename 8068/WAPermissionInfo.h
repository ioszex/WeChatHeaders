...
@class NSData, NSString, WALaunchOpSwitchList, WAPermissionActionSheetInfo, WAPermissionLaunchAction, WAPermissionLaunchRuntimeInfo, WAPermissionWeAppBindInfo, WAPublicResInfo, WAStatePermissionBytes;
...
@property(retain, nonatomic) WALaunchOpSwitchList *launchOpSwitchList; // @synthesize launchOpSwitchList=_launchOpSwitchList;
