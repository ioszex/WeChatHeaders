...
@class EmoticonBoardView, MMGrowTextView, MMHeadImageView, MMUIButton, NSString, UIButton, UIImageView, UILabel, UITapGestureRecognizer, WCFinderCommentIdentityActionSheetView, WCFinderFeedInputViewModel, WCFinderFeedInputViewOption, WCFinderGradientView, WCInputController;
...
@interface WCFinderFeedInputView : UIView
{
    ...
    WCFinderFeedInputViewOption *_option;
