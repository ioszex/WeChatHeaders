...
@class MMCircleProgressView, MMProgressView, MMUIActivityIndicatorView, MMUILabel, NSString, RichTextView, UIButton, UIImageView, UILabel, UIScrollView, UIView, WXGDotDotDotLabel;
...
@interface WXGMigrationClientEntryViewController
{
    ...
    UIView *_centerViewContainer;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isStartTransfer; // @synthesize isStartTransfer=_isStartTransfer;
@property(retain, nonatomic) UIView *centerViewContainer; // @synthesize centerViewContainer=_centerViewContainer;
...
- (id)getReportParamsForPageByNotifyCode:(unsigned long long)arg1;
- (void)reportPageChange:(unsigned long long)arg1 newCode:(unsigned long long)arg2;
