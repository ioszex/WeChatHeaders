...
@interface WCPayRealnameGuideInfo : NSObject
{
    ...
    NSString *_complianceUploadImageHalfPage;
}

+ (id)genFromUnion:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *complianceUploadImageHalfPage; // @synthesize complianceUploadImageHalfPage=_complianceUploadImageHalfPage;
