...
@class AVAudioPlayer, AVAudioRouteManager, AVVideoDevice, CMessageWrap, MMTimer, MMViewCapture, MMWindow, MinimizeTaskData, MultiTalkMainViewController, MultitalkMiniInAppView, NSArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, RingBackSoundCoordinator, SafeMutableDictionary, VoipCheckAudioDeviceObj, WeToast;
...
@interface MultiTalkMgr
{
    ...
    MMWindow<MultiTalkWindowProtocol> *m_mainWindow;
    ...
    WeToast *_toastForHumanVoiceDetect;
...
@property(nonatomic) __weak WeToast *toastForHumanVoiceDetect; // @synthesize toastForHumanVoiceDetect=_toastForHumanVoiceDetect;
...
@property(retain, nonatomic) MMWindow<MultiTalkWindowProtocol> *m_mainWindow; // @synthesize m_mainWindow;
- (void)showToastForHumanVoiceDetect:(id)arg1 duration:(double)arg2;
...
- (void)onIlinkChangeToMultiTalk:(id)arg1 confSDKMemberMgr:(id)arg2 isMicMute:(_Bool)arg3 isSpeakerOn:(_Bool)arg4 localVideoClosed:(_Bool)arg5 remoteVideoClosed:(_Bool)arg6 isConnected:(_Bool)arg7;
