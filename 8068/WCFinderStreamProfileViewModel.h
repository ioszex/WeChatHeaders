...
@interface WCFinderStreamProfileViewModel : NSObject
{
    ...
    NSMutableArray *_waitHeaderCGIFinishBlocks;
}

+ (int)makeCommentScene:(_Bool)arg1 isHalf:(_Bool)arg2;
+ (id)supportPluginClasses;
+ (id)localPageClasses;
+ (id)supportPageClasses;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *waitHeaderCGIFinishBlocks; // @synthesize waitHeaderCGIFinishBlocks=_waitHeaderCGIFinishBlocks;
@property(nonatomic) _Bool headerCGIReady; // @synthesize headerCGIReady=_headerCGIReady;
...
- (void)_fillDataFromHeaderResponse:(id)arg1;
- (void)requestHeaderData;
- (void)waitHeaderCgiFinish:(CDUnknownBlockType)arg1;
...
- (void)prepareWithUsername:(id)arg1 contact:(id)arg2 params:(id)arg3;
