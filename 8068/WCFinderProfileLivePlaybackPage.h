...
@class NSMutableDictionary, NSString, UICollectionViewDiffableDataSource, WCFinderExtStatsReporter, WCFinderStreamFooterView;
...
+ (id)onFeedCollectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2 isAuthor:(_Bool)arg3 contentVM:(id)arg4 showProgressBar:(_Bool)arg5 hiddenSticker:(_Bool)arg6;
+ (id)onLiveCollectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2 item:(id)arg3;
+ (id)collectionView:(id)arg1 displayCellForContentVM:(id)arg2 atIndexPath:(id)arg3 showProgressBar:(_Bool)arg4 hiddenSticker:(_Bool)arg5;
