...
- (_Bool)isXwechatDeviceSupportHandoffWithDeviceType:(unsigned int)arg1 clientVersion:(unsigned int)arg2;
...
- (void)modCurrentLiteAppHandoffItem:(CDUnknownBlockType)arg1;
