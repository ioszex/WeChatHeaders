...
- (void)onFetchCombineConfigureSuccess:(NSString *)arg1 confVersion:(NSString *)arg2 confGuide:(NSString *)arg3 detObjGuide:(NSString *)arg4 noModelFrameLimit:(unsigned int)arg5;
