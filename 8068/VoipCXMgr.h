...
- (void)reportIncomingCallFromUser:(id)arg1 ofType:(int)arg2 withMsg:(id)arg3 isPushKit:(_Bool)arg4 displayName:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (void)prepareForIncomingInvitationFromPushKit;
- (void)requestEndCallTrans;
- (void)requestAcceptCallTransactionWithRoom:(unsigned long long)arg1;
