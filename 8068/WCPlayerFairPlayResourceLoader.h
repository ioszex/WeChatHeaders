...
@interface WCPlayerFairPlayResourceLoader : NSObject
{
    ...
    AVURLAsset *_asset;
    id <WCPlayerFairPlayResourceLoaderDelegate> _delegate;
...
@property(nonatomic) __weak id <WCPlayerFairPlayResourceLoaderDelegate> delegate; // @synthesize delegate=_delegate;
