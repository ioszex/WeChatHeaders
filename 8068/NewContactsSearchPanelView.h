...
@interface NewContactsSearchPanelView
{
    ...
    _Bool _bTagViewNeedAddBlur;
    _Bool _bDeleteLastNotHiddeKeyInput;
    _Bool _bAlwaysShowSearchTable;
    MyUIScrollView *m_ScrollView;
    UIImageView *m_SearchIconView;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool bAlwaysShowSearchTable; // @synthesize bAlwaysShowSearchTable=_bAlwaysShowSearchTable;
@property(nonatomic) _Bool bDeleteLastNotHiddeKeyInput; // @synthesize bDeleteLastNotHiddeKeyInput=_bDeleteLastNotHiddeKeyInput;
...
@property(nonatomic) _Bool bTagViewNeedAddBlur; // @synthesize bTagViewNeedAddBlur=_bTagViewNeedAddBlur;
...
- (void)clearSearchInAlwaysShowSearchTable;
