...
- (_Bool)stopRecording;
- (_Bool)startRecordingWithOptions:(unsigned long long)arg1;
- (_Bool)startRecordingWithDurationLimit:(long long)arg1 reachedLimitToastText:(id)arg2 options:(unsigned long long)arg3;
