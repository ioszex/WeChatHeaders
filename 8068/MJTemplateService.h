...
- (void)getImageTemplateListWithPagebuf:(id)arg1 scene:(unsigned long long)arg2 finderUserName:(id)arg3 preFetchType:(unsigned long long)arg4 successfulBlock:(CDUnknownBlockType)arg5 failedBlock:(CDUnknownBlockType)arg6;
...
- (void)fetchTemplateInfoWithID:(id)arg1 type:(unsigned long long)arg2 scene:(unsigned long long)arg3 notUseCache:(_Bool)arg4 successBlock:(CDUnknownBlockType)arg5 failureBlock:(CDUnknownBlockType)arg6;
