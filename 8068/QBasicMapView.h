...
@class CADisplayLink, GLKView, NSArray, NSString, QMapContext, QMapMonitor, QMarkerCustomCalloutContainerView, TBDrawParam, TBRegionChangeDistributor;
...
@interface QBasicMapView : UIView
{
    ...
    QMarkerCustomCalloutContainerView *_qMarkerCustomCalloutContainerView;
...
@property(retain, nonatomic) QMarkerCustomCalloutContainerView *qMarkerCustomCalloutContainerView; // @synthesize qMarkerCustomCalloutContainerView=_qMarkerCustomCalloutContainerView;
...
- (void)setWorldTileEnable:(_Bool)arg1;
...
- (void)setHandDrawEnable:(_Bool)arg1;
- (float)pixelRatio;
- (double)glPointRatio;
