...
@property(nonatomic) int operatingEmojiScene; // @synthesize operatingEmojiScene=_operatingEmojiScene;
...
- (void)reportEmojiCollectionExposeWithRecommendInfo:(id)arg1 entrance:(int)arg2;
- (void)reportStoreEmotionAndEmojiExpose;
- (void)jumpToBannerSet:(id)arg1 entrance:(int)arg2;
- (double)contentWidth;
