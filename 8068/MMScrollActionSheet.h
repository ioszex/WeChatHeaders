...
@interface MMScrollActionSheet : UIView
{
    ...
    UIView *_bodyFooterView2SeperatorView;
...
@property(retain, nonatomic) UIView *bodyFooterView2SeperatorView; // @synthesize bodyFooterView2SeperatorView=_bodyFooterView2SeperatorView;
...
@property(nonatomic) unsigned int landscapeStyle; // @synthesize landscapeStyle=_landscapeStyle;
...
- (double)getMaxHeight;
- (void)setupBodyFooterView2WithLandScape:(_Bool)arg1;
...
- (void)setBodyFooterView2:(id)arg1;
