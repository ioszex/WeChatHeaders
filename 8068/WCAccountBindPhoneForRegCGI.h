...
- (_Bool)checkLoginVerifyCode:(id)arg1 verifyCode:(id)arg2 checkType:(unsigned int)arg3 checkCount:(unsigned int)arg4 authTargetUserName:(id)arg5 userShowName:(id)arg6;
...
- (_Bool)checkLoginPhoneNumberStatus:(id)arg1 tryCount:(unsigned int)arg2 adjustRet:(unsigned int)arg3 authTargetUserName:(id)arg4 userShowName:(id)arg5;
