...
@class AddMemLogic, CBaseContact, CContact, DelMemLogic, MMPageSheetAdapter, MMTableView, MMTableViewInfo, NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NewContactsSearchPanelView, OrderedDictionary, SearchHelpDataItem, UILabel, UIView, WCColorProxy, WCSearcher;
