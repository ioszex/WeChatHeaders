...
@interface MMLiveCommentData : NSObject
{
    ...
    NSMutableDictionary *_commentFetchedTagDict;
}

+ (_Bool)needFilterWithLoadedFromLastLive:(id)arg1;
+ (_Bool)updateSelfCommentStatusToDB:(unsigned int)arg1 msgLocalID:(unsigned int)arg2 boxId:(id)arg3;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *commentFetchedTagDict; // @synthesize commentFetchedTagDict=_commentFetchedTagDict;
...
- (id)filterCommentArrWithLoadedFromLastLive:(id)arg1;
- (void)clearTempCache;
@property(readonly, nonatomic) double maxCommentSeq;
- (void)clearAllComments;
- (id)getAllCommentByConditionBlock:(CDUnknownBlockType)arg1;
- (id)getAnyCommentByConditionBlock:(CDUnknownBlockType)arg1;
- (id)deleteCommentByConditionBlock:(CDUnknownBlockType)arg1;
