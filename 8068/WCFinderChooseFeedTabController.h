...
@class NSString, WCFinderChooseFeedTabControllerConfig, WCFinderChooseFeedTabViewModel, WCFinderFeedContentVM, WCFinderFeedFlowView;
...
@interface WCFinderChooseFeedTabController : NSObject
{
    ...
    WCFinderFeedContentVM *_selectedVM;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderFeedContentVM *selectedVM; // @synthesize selectedVM=_selectedVM;
...
- (void)onFinderFeedPickerSelectedCell:(id)arg1 selected:(_Bool)arg2;
...
- (void)setSelectionCell:(id)arg1 contentVm:(id)arg2;
