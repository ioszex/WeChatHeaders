...
@class EditImageAttr, MMAlbum, MMAlbumAccessAuthView, MMAlbumAuthorizationReportObject, MMAlbumDropPickerController, MMAlbumDropableTitleWithMultipleSectionView, MMAsset, MMAssetDragSelectHelper, MMAssetPickerActionBottomView, MMAssetPickerControllerProxyObjectForAllAsset, MMAssetPickerControllerState, MMAssetPickerSlider, MMAssetUserActionTipsView, MMDropableTitleView, MMImagePickerVideoCompressQueue, MMScrollView, MMSightCameraViewController, MMTableView, MMUIButton, MMUIImageView, MMUILabel, NSDateFormatter, NSHashTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIButton, UIImageView, UILabel, UIView, VideoEncodeTask, WCFinderFeedPickerSelectedInfo, WCFinderFeedPickerViewController, WCFinderPreviewEditVideoCompositionTask, WCFinderSyncComposeResModel;
...
@interface MMAssetPickerController
{
    ...
    _Bool _isAlbumOptimizeClicfgOn;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isAlbumOptimizeClicfgOn; // @synthesize isAlbumOptimizeClicfgOn=_isAlbumOptimizeClicfgOn;
