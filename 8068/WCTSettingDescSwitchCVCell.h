...
@class NSString, WCTSettingDescSwitchView;

@interface WCTSettingDescSwitchCVCell : UICollectionViewCell
{
    WCTSettingDescSwitchView *_view;
}

+ (double)viewHeightByDataModel:(id)arg1 hostView:(id)arg2;
- (void).cxx_destruct;
@property(readonly, nonatomic) WCTSettingDescSwitchView *view; // @synthesize view=_view;
