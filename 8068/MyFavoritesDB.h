...
- (id)getNextPageFavoritesItemListByType:(int)arg1 andCurMinUpdateTime:(unsigned int)arg2 andPinTopFirst:(_Bool)arg3 byCurMinPinTopTime:(unsigned int)arg4;
- (id)getFirstPageFavoritesItemListByType:(int)arg1 andPinTopFirst:(_Bool)arg2;
