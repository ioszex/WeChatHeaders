...
- (void)updateframe;
- (id)initWithTableView:(id)arg1 animator:(id)arg2 viewController:(id)arg3 config:(shared_ptr_448daa3e)arg4 bkgRect:(struct CGRect)arg5 profileModel:(id)arg6 isModeTall:(_Bool)arg7;
