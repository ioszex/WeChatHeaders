...
- (void)createRequest;
- (void)start;
- (id)initWithLiveTaskId:(id)arg1 finderDataItem:(id)arg2 scene:(unsigned long long)arg3 entranceQRCodeURL:(id)arg4 liveCookies:(id)arg5 livePkId:(id)arg6 sessionBuffer:(id)arg7 commentScene:(int)arg8 fromSrc:(unsigned long long)arg9 fetchType:(unsigned long long)arg10 mixedFlowType:(int)arg11 successBlock:(CDUnknownBlockType)arg12 failBlock:(CDUnknownBlockType)arg13;
