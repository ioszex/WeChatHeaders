...
{
    _Bool _isFromFlutterPersonalCenter;
...
@property(nonatomic) _Bool isFromFlutterPersonalCenter; // @synthesize isFromFlutterPersonalCenter=_isFromFlutterPersonalCenter;
