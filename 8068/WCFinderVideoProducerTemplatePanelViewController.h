...
@class MJVideoTemplate, MMUIButton, NSIndexPath, NSMutableDictionary, NSString, UICollectionView, UIView, WCFinderVideoProducerDataSource, WCFinderVideoProducerTemplateTableViewController;
@protocol WCFinderVideoProducerTemplatePanelDelegate;

@interface WCFinderVideoProducerTemplatePanelViewController
{
    ...
    id <WCFinderVideoProducerTemplatePanelDelegate> _delegate;
    WCFinderVideoProducerDataSource *_templateData;
    WCFinderVideoProducerDataSource *_tabCellVMData;
...
@property(retain, nonatomic) WCFinderVideoProducerDataSource *tabCellVMData; // @synthesize tabCellVMData=_tabCellVMData;
@property(retain, nonatomic) WCFinderVideoProducerDataSource *templateData; // @synthesize templateData=_templateData;
@property(nonatomic) __weak id <WCFinderVideoProducerTemplatePanelDelegate> delegate; // @synthesize delegate=_delegate;
