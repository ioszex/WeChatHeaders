...
@class MISSING_TYPE, NSArray, NSMutableArray, NSString, UIView, WAAppAuthRespData, WAContact;
...
@interface WAAppAuthorizationViewController
{
    ...
    _Bool _isEmployeeRelationAuthCancelled;
