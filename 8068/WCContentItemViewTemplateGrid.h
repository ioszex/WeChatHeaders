...
- (id)interactionView;
- (_Bool)isDownloadTypeValid:(long long)arg1;
...
- (void)checkUnregisterKeyExtension:(id)arg1;
...
- (void)onImageloadingStart:(id)arg1 type:(long long)arg2 reason:(int)arg3;
- (int)getDownloadReason:(id)arg1;
- (long long)unpackageDownloadTypeFromKey:(id)arg1;
- (id)unpackageMidFromKey:(id)arg1;
- (id)packageKey:(id)arg1 type:(long long)arg2;
