...
@class MMPageSheetAdapter, MinimizeTaskData, NSNumber, NSString, TingFlutterCommentInputController, TingInsertedContentCallBack, UIView;
...
@interface TingFlutterViewController
{
    ...
    UIView *_shadowView;
    MinimizeTaskData *_activeTaskData;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MinimizeTaskData *activeTaskData; // @synthesize activeTaskData=_activeTaskData;
...
- (void)setActiveWithListenId:(id)arg1 bizName:(id)arg2;
