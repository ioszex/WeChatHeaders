...
+ (CDUnknownBlockType)getOpenTeenageBlockByFeedId:(id)arg1 encrytedObjectidTid:(id)arg2 nonceID:(id)arg3 shareScene:(unsigned long long)arg4 currentNavController:(id)arg5 customParam:(id)arg6 functionalParams:(id)arg7 reportModel:(id)arg8 cardType:(int)arg9;
...
- (_Bool)triggerTeenagerRestCheckLogic:(unsigned long long)arg1;
