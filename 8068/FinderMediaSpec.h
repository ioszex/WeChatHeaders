...
@property(retain, nonatomic) NSString *enhance; // @dynamic enhance;
...
@property(nonatomic) unsigned int is3Az; // @dynamic is3Az;
@property(nonatomic) unsigned int levelOrder; // @dynamic levelOrder;
@property(nonatomic) unsigned int meanVol; // @dynamic meanVol;
@property(nonatomic) unsigned int meanVol3Sec; // @dynamic meanVol3Sec;
