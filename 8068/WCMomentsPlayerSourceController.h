...
- (id)multiSpecFlagMappingDefault:(id)arg1;
- (id)multiSpecFlagMapping:(id)arg1 bizReqPayload:(struct basic_string<char, std::char_traits<char>, std::allocator<char>>)arg2;
