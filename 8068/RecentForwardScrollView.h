...
@interface RecentForwardScrollView : UIView
{
    ...
    NSString *_forwardSessionId;
    NSString *_forwardFinishDeletSessionId;
}

+ (_Bool)hasRecentForward;
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *forwardFinishDeletSessionId; // @synthesize forwardFinishDeletSessionId=_forwardFinishDeletSessionId;
@property(retain, nonatomic) NSString *forwardSessionId; // @synthesize forwardSessionId=_forwardSessionId;
...
- (void)reportRemoveRecentFrowradChatsInNewEditModel:(id)arg1;
- (void)reportClickDeleteForwardChatNewEditModel;
- (void)reportRemoveRecentFrowradChats:(id)arg1;
- (void)reportLongPressRemoveRecentFrowradChats:(id)arg1;
