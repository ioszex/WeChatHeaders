...
@interface WeAPMFlutterApi : NSObject
{
...
- (void)reportFluencySummaryInfoWithCompletion:(CDUnknownBlockType)arg1;
- (void)startFluencyTrackerWithCompletion:(CDUnknownBlockType)arg1;
