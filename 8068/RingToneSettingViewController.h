...
@class AnyPromise, MMTableView, NSString, RingToneHomePageActionReporter_23612, RingToneMixPlayer, RingTonePickerViewController, RingToneSettingHeaderView, RingToneVideoFeedViewController, VideoRingExclusiveFriendsViewModel, VideoRingNetProvider, WCTimeLineFooterView;
