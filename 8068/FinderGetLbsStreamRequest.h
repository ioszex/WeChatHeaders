...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderLbsStreamLocation, NSData;
...
@property(retain, nonatomic) FinderLbsStreamLocation *location; // @dynamic location;
...
@property(retain, nonatomic) FinderLbsStreamLocation *realtimeLocation; // @dynamic realtimeLocation;
