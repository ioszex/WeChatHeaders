...
@class EmoticonGetWordListCGI, EmoticonRemoteRecommendTable, EmoticonWordListMeta, MISSING_TYPE, MMAsyncBlockOperation, MemoryMappedKV, NSArray, NSMutableDictionary, NSMutableSet, NSNumber, NSObject, NSOperationQueue, NSString;
...
@interface EmoticonInputRecommendMgr
{
    ...
    MISSING_TYPE *_shouldResumeLocalEmojiOcr;
