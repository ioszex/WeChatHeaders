...
+ (_Bool)shouldUpdateSession:(id)arg1 FromDraftInfo:(id)arg2;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: lastMsgUpdateTime
...
- (void)updateToDraftInfo:(id)arg1;
- (void)updateFromDraftInfo:(id)arg1 draftTime:(unsigned int)arg2;
