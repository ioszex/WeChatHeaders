...
@interface ContactsSearchController
{
    ...
    _Bool _bForbidMultiSelectChange;
    _Bool _bForceHiddenBottomBar;
...
@property(nonatomic) _Bool bForceHiddenBottomBar; // @synthesize bForceHiddenBottomBar=_bForceHiddenBottomBar;
@property(nonatomic) _Bool bForbidMultiSelectChange; // @synthesize bForbidMultiSelectChange=_bForbidMultiSelectChange;
