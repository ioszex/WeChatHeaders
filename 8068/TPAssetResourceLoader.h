...
@class NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, TPDownloadParamData, TPWorkerQueue;
...
@interface TPAssetResourceLoader : NSObject
{
    ...
    TPDownloadParamData *_downloadParamData;
...
@property(retain, nonatomic) TPDownloadParamData *downloadParamData; // @synthesize downloadParamData=_downloadParamData;
