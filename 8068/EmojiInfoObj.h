...
@interface EmojiInfoObj
{
    ...
    NSString *_generatedBusinessThumbUrl;
...
+ (void)PBArrayAdd_md5;
- (void).cxx_destruct;
@property(nonatomic) _Bool hasSetEmoticonFlag; // @synthesize hasSetEmoticonFlag=_hasSetEmoticonFlag;
...
@property(retain, nonatomic) NSString *generatedBusinessThumbUrl; // @synthesize generatedBusinessThumbUrl=_generatedBusinessThumbUrl;
...
- (id)initWithPackThumbExt:(id)arg1 pid:(id)arg2;
