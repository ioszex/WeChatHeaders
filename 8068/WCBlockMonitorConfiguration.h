...
+ (id)defaultConfig;
@property(nonatomic) _Bool bMainThreadLockTrace; // @synthesize bMainThreadLockTrace=_bMainThreadLockTrace;
...
@property(nonatomic) _Bool bPrintKSLogToFile; // @synthesize bPrintKSLogToFile=_bPrintKSLogToFile;
