...
@class NSMutableArray, OrderedDictionary, WCFinderVideoProducerTemplatePlayingOperation;
...
@interface WCFinderVideoProducerTemplateOperationContext : NSObject
{
    ...
    WCFinderVideoProducerTemplatePlayingOperation *_currentTemplateOperation;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderVideoProducerTemplatePlayingOperation *currentTemplateOperation; // @synthesize currentTemplateOperation=_currentTemplateOperation;
