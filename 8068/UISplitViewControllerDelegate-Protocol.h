...
- (void)splitViewController:(UISplitViewController *)arg1 didHideColumn:(long long)arg2;
- (void)splitViewController:(UISplitViewController *)arg1 didShowColumn:(long long)arg2;
