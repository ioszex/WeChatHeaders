...
@class EnhanceBubble, FinderJumpInfo_AccountStyle, FinderJumpInfo_AroundAccountCircleStyle, FinderJumpInfo_BannerStyle, FinderJumpInfo_BariableButtonStyle, FinderJumpInfo_BigBubbleStyle, FinderJumpInfo_BigButtonStyle, FinderJumpInfo_BottomSuspendBubbleStyle, FinderJumpInfo_ButtonStyle, FinderJumpInfo_CapsuleStyle, FinderJumpInfo_CardBottomBarLeftStyle, FinderJumpInfo_CardBottomBarRightStyle, FinderJumpInfo_CardStyle, FinderJumpInfo_CarouselCardStyle, FinderJumpInfo_CombinationStyle, FinderJumpInfo_CommentCarouselStyle, FinderJumpInfo_CommentControversialAlertStyle, FinderJumpInfo_DynamicCardStyle, FinderJumpInfo_DynamicCardStyleV2, FinderJumpInfo_DynamicCarouselCardStyle, FinderJumpInfo_FinderCrossPlatformCardStyle, FinderJumpInfo_FinderJumpShowControlInfo, FinderJumpInfo_GradientCardStyle, FinderJumpInfo_HotBubbleStyle, FinderJumpInfo_IconTextStyle, FinderJumpInfo_ImageStyle, FinderJumpInfo_JumpButtonStyle, FinderJumpInfo_LabelStyle, FinderJumpInfo_LbsLifeCardStyle, FinderJumpInfo_LinkStyle, FinderJumpInfo_LiveLivingStyle, FinderJumpInfo_LiveReservationStyle, FinderJumpInfo_LoadingStyle, FinderJumpInfo_LuckyBag, FinderJumpInfo_NormalBubbleStyle, FinderJumpInfo_PagStyle, FinderJumpInfo_RelativePosition, FinderJumpInfo_SubtitleBubbleStyle, FinderJumpInfo_TextStyle, FinderVideoStyle, LiveHighlightStyle, NextLiveNotificationStyle, ProductCardStyle;
...
@property(retain, nonatomic) FinderJumpInfo_CapsuleStyle *capsuleStyle; // @dynamic capsuleStyle;
...
@property(retain, nonatomic) FinderJumpInfo_CommentControversialAlertStyle *commentControversialAlertStyle; // @dynamic commentControversialAlertStyle;
...
@property(retain, nonatomic) LiveHighlightStyle *liveHighlightStyle; // @dynamic liveHighlightStyle;
...
@property(retain, nonatomic) NextLiveNotificationStyle *nextLiveNotificationStyle; // @dynamic nextLiveNotificationStyle;
@property(retain, nonatomic) FinderJumpInfo_NormalBubbleStyle *normalButtle; // @dynamic normalButtle;
@property(retain, nonatomic) FinderJumpInfo_PagStyle *pagStyle; // @dynamic pagStyle;
@property(nonatomic) unsigned int priority; // @dynamic priority;
@property(nonatomic) unsigned int priorityGroup; // @dynamic priorityGroup;
...
@property(nonatomic) unsigned int samePriorityIndex; // @dynamic samePriorityIndex;
@property(nonatomic) unsigned int screen; // @dynamic screen;
@property(nonatomic) _Bool showAdsIcon; // @dynamic showAdsIcon;
@property(retain, nonatomic) FinderJumpInfo_FinderJumpShowControlInfo *showControlInfo; // @dynamic showControlInfo;
...
@property(retain, nonatomic) FinderJumpInfo_BottomSuspendBubbleStyle *suspendBubbleStyle; // @dynamic suspendBubbleStyle;
@property(retain, nonatomic) FinderJumpInfo_TextStyle *textStyle; // @dynamic textStyle;
