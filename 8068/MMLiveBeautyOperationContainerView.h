...
@property(nonatomic) _Bool hideSkinSeg; // @synthesize hideSkinSeg=_hideSkinSeg;
...
- (void)openWithAnimation:(_Bool)arg1 closeDirectly:(_Bool)arg2 completeBlock:(CDUnknownBlockType)arg3;
