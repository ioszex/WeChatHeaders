...
@class MMGradientBottomView, MMLiveActionSheetFlowLayoutCustomConfig, MMScrollActionSheet, NSArray, NSIndexPath, NSString, UICollectionView, UICollectionViewFlowLayout;
...
@interface MMLiveActionSheetFlowLayoutView : UIView
{
    ...
    MMLiveActionSheetFlowLayoutCustomConfig *_customConfig;
...
@property(retain, nonatomic) MMLiveActionSheetFlowLayoutCustomConfig *customConfig; // @synthesize customConfig=_customConfig;
