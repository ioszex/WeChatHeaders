...
@class MMTableView, MMUIButton, NSMutableSet, NSString, UILabel, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderFeedFriendsLikeListViewModel, WCFinderMagicAnimationLogic, WCFinderRefreshTableFooterView, WCFinderSizingRichTextView;
