...
@class MMUIButton, NSIndexPath, NSString, UICollectionView, UIView, WCFinderVideoProducerDataSource;
@protocol WCFinderVideoProducerMusicBarDelegate;

@interface WCFinderVideoProducerMusicBarViewController
{
    NSIndexPath *_focusedIndex;
    NSIndexPath *_selectedIndex;
    long long _centerItemRow;
    _Bool _isMusicSearcherEnabled;
    id <WCFinderVideoProducerMusicBarDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderVideoProducerMusicBarDelegate> delegate; // @synthesize delegate=_delegate;
