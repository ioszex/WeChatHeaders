...
@class ContactsDataLogic, MISSING_TYPE, MMTableView, MMUIButton, MMUISearchBar, MMUIView, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSString, OrderedDictionary, UIView;
...
@interface MultiSelectChatRoomHalfScreenViewController
{
    ...
    NSString *m_tipWord;
    MISSING_TYPE *m_choiseSessionWord;
