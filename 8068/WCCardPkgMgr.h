...
@class CLLocation, LocationRetriever, MISSING_TYPE, NSDictionary, NSObject, NSString, WCCardBulkImportMgr, WCCardLayoutMgr, WCCardMsgCenterMgr, WCCardPkgBatchDelMgr, WCCardPkgBatchGetCardItemByTpInfoMgr, WCCardPkgBatchGetMgr, WCCardPkgDB, WCCardPkgSyncMgr, WCCardTipController, WCMktCardEnteranceStyleCgi;
...
@interface WCCardPkgMgr
{
    ...
    _Bool _hasRequestGetCardCount;
    MISSING_TYPE *_location;
    WCMktCardEnteranceStyleCgi *_mktCardStyleCgi;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool hasRequestGetCardCount; // @synthesize hasRequestGetCardCount=_hasRequestGetCardCount;
