...
- (void)reportStack:(id)arg1 killSelf:(id)arg2 error:(id)arg3 stackTrace:(id)arg4 wechatImage:(id)arg5;
- (void)reportKvParams:(id)arg1 killSelf:(_Bool)arg2 error:(id)arg3 stackTrace:(id)arg4 wechatImage:(id)arg5;
