...
@class EmoticonCustomCreateLogic, MMFinderHandOffItem, MMScrollViewProxy, MMTimer, NSIndexPath, NSMutableDictionary, NSMutableSet, NSNumber, NSString, UIImage, UIImageView, UILabel, UITableView, UITableViewCell, UIViewController, WCFinderAnimationLoadingView, WCFinderFeedAudioHelper, WCFinderFeedDragUpDislikeController, WCFinderFeedFriendsLikeListBaseViewController, WCFinderLandscapeReportInfo, WCFinderPlayRateSelectPanelView, WCFinderPlaybackSpeedView, WCFinderPostMgr, WCFinderPullDownRefreshHeaderView, WCFinderRefreshTableFooterView, WCFinderScrollActionSheet, WCFinderTopPullStatusView;
...
- (void)performActionWithContentVM:(id)arg1 actionType:(unsigned long long)arg2;
