...
@interface MMLiveRewardGiftSendingMoreButton
{
    ...
    CDUnknownBlockType _sendingMoreButtonLongPressingCallback;
...
@property(copy, nonatomic) CDUnknownBlockType sendingMoreButtonLongPressingCallback; // @synthesize sendingMoreButtonLongPressingCallback=_sendingMoreButtonLongPressingCallback;
