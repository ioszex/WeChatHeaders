...
@interface WCFinderPersonalCenterWeixinContactCollectionViewCell : UICollectionViewCell
{
    ...
    WCFinderPersonalCenterSidesButton *_ompactnessCell;
...
@property(retain, nonatomic) WCFinderPersonalCenterSidesButton *ompactnessCell; // @synthesize ompactnessCell=_ompactnessCell;
