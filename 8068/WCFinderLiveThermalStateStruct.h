...
@interface WCFinderLiveThermalStateStruct : NSObject
{
    ...
    unsigned int _isWeakNetFromMars;
    unsigned int _marsAvgSpeed;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int marsAvgSpeed; // @synthesize marsAvgSpeed=_marsAvgSpeed;
@property(nonatomic) unsigned int isWeakNetFromMars; // @synthesize isWeakNetFromMars=_isWeakNetFromMars;
