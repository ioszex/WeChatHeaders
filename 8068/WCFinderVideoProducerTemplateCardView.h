...
@class NSString, UIImageView, UILabel, UIView, WCFinderVideoProducerTemplateCellViewModel, WCProgressMaskView;

@interface WCFinderVideoProducerTemplateCardView : UICollectionViewCell
{
    _Bool _isAnimPlaying;
    WCFinderVideoProducerTemplateCellViewModel *_cellVM;
...
@property(retain, nonatomic) WCFinderVideoProducerTemplateCellViewModel *cellVM; // @synthesize cellVM=_cellVM;
