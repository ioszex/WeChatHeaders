...
@protocol RingBackSoundCoordinatorDelegate;
...
@interface RingBackSoundCoordinator : NSObject
{
    ...
    id <RingBackSoundCoordinatorDelegate> _delegate;
...
@property(nonatomic) __weak id <RingBackSoundCoordinatorDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)adjustPlayerVolume;
- (void)adjustPlayerBeforePlay;
