...
- (void)dumpAllCaches;
- (void)deleteFoldAdDataItemInCache:(id)arg1 groupId:(id)arg2;
...
- (void)tryMergeSvrDataListDataItem:(id)arg1 withLocal:(id)arg2;
- (void)fetchGroupItemsFromSvr:(id)arg1 originalDataList:(id)arg2 fetchFeedIds:(id)arg3 extAdInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)fetchGroupItemsFromSvr:(id)arg1 originalDataList:(id)arg2 extAdInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
