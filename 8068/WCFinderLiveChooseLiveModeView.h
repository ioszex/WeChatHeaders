...
+ (id)generateDataItemListWithLiveMode:(unsigned long long)arg1 hideLandscpe:(_Bool)arg2 disableVideoLandscape:(_Bool)arg3 hideKTVLiveMode:(_Bool)arg4 isFromNewStartController:(_Bool)arg5 redDotQueryBlock:(CDUnknownBlockType)arg6 redDotExposeBlock:(CDUnknownBlockType)arg7 redDotClickBlock:(CDUnknownBlockType)arg8;
