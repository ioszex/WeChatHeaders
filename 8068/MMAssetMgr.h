...
@interface MMAssetMgr
{
    ...
    EditImageLogicController *_m_snsEditImageLogicController;
}
...
- (void).cxx_destruct;
@property(nonatomic) __weak EditImageLogicController *m_snsEditImageLogicController; // @synthesize m_snsEditImageLogicController=_m_snsEditImageLogicController;
