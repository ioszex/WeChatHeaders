...
@interface EcsGiftContactSelectListBaseViewController
{
    ...
    id <EcsGiftContactSelectListBaseViewControllerDelegate> _m_delegate;
    CContact *_chatroomContact;
}

- (void).cxx_destruct;
@property(retain, nonatomic) CContact *chatroomContact; // @synthesize chatroomContact=_chatroomContact;
@property(nonatomic) __weak id <EcsGiftContactSelectListBaseViewControllerDelegate> m_delegate; // @synthesize m_delegate=_m_delegate;
