...
@class CMessageWrap, NSMutableArray, NSRecursiveLock, NSString, OpenBufferUploadMgr, RecordUploadTask;
...
- (void)AddUploadTaskForDataList:(id)arg1 ignoreMedia:(_Bool)arg2;
