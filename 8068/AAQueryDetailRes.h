...
@property(retain, nonatomic) NSString *amountInfoRouteInfo; // @dynamic amountInfoRouteInfo;
@property(retain, nonatomic) NSString *amountInfoWording; // @dynamic amountInfoWording;
...
@property(retain, nonatomic) NSString *detailSign; // @dynamic detailSign;
