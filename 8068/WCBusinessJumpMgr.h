...
- (_Bool)processQRCodeJSEvent:(id)arg1 runtimeAppid:(id)arg2 runtimeLaunchScene:(long long)arg3 qrCodeUuid:(id)arg4 invokeDic:(id)arg5 parentViewController:(id)arg6 disableAutoCloseWebview:(_Bool)arg7 delegate:(id)arg8;
