...
// Error: Property attributes should begin with the type ('T') attribute, property name: m_shareContacts
...
- (void)clickOnOpenOtherApp:(id)arg1;
- (void)clickOnYuanBaoAD:(id)arg1;
...
- (void)scrollToMessage:(id)arg1 highlight:(_Bool)arg2 marginTop:(double)arg3 animated:(_Bool)arg4 highlightRange:(struct _NSRange)arg5;
