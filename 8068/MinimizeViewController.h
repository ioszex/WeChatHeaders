...
@class MISSING_TYPE, MinimizeAbsorbFloatingView, MinimizeAntiCollisionLogic, MinimizeGestureCircleView, MinimizeMultiTaskExpandableView, MinimizePendingTaskContext, MinimizeStarFloatingView, MinimizeTaskOuterContentView, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIScrollView, UIView;
...
@interface MinimizeViewController
{
    ...
    MISSING_TYPE *_currentSystemKeyboardTop;
