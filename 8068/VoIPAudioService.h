...
@interface VoIPAudioService
{
    ...
    _Bool _hasAudioUnitCallbackFirstEachStartup;
...
@property(nonatomic) _Bool hasAudioUnitCallbackFirstEachStartup; // @synthesize hasAudioUnitCallbackFirstEachStartup=_hasAudioUnitCallbackFirstEachStartup;
