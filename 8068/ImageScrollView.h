...
- (void)updateLivePhoto:(id)arg1;
- (void)displayLivePhoto:(id)arg1 withVideoPath:(id)arg2 withFrame:(struct CGRect)arg3;
...
- (void)setOriginImageData:(id)arg1;
