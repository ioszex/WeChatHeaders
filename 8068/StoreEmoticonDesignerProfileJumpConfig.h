...
@property(nonatomic) int enterHasRedDot; // @synthesize enterHasRedDot=_enterHasRedDot;
...
@property(nonatomic) int extraceScene; // @synthesize extraceScene=_extraceScene;
