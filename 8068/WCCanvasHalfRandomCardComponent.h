...
@class NSString, UILabel, UIView, WCAdURLImageView, WCAdvertiseInfo, WCCanvasComponentHalfRandomCardItemInfo, WCCanvasDynamicDataLoader, WCCanvasHalfRandomSubCard;
...
@interface WCCanvasHalfRandomCardComponent
{
    ...
    WCAdURLImageView *_cardImageView;
    UILabel *_titleView;
...
@property(retain, nonatomic) WCAdURLImageView *cardImageView; // @synthesize cardImageView=_cardImageView;
...
- (void)changeAlignmentRightAndLeft:(id)arg1;
- (void)tryToShowTheChosenCard;
- (void)tryToShowTheChosenCardWithFlip;
- (void)tryToShowTheChosenCardWithFlipAnim:(_Bool)arg1;
- (void)animationFallback;
- (void)startRotateAnimation;
- (void)startRotateAnimationWithFlip;
- (void)startRotateAnimationWithFlip:(_Bool)arg1;
