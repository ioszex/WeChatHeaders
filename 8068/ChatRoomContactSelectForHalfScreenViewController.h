...
@class CContact, ChatRoomContactSelectModel, ContactsItemView, MMTableView, MMUIButton, MMUISearchBar, MultiSelectContactsInChatRoomReport, NSMutableArray, NSMutableDictionary, NSString, NewContactsSearchPanelView, OrderedDictionary, SearchHelpDataItem, UIView, WCSearchBar, _TtC6WeChat13DNDReportItem;
@protocol RoomContactSelectDelegate;

@interface ChatRoomContactSelectForHalfScreenViewController
{
    ...
    ChatRoomContactSelectModel *_viewModel;
    NSMutableArray *_arrRoomMembers;
    UIView *_chatRoomAllMemberViewFooter;
    unsigned long long _enterTime;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long enterTime; // @synthesize enterTime=_enterTime;
@property(retain, nonatomic) UIView *chatRoomAllMemberViewFooter; // @synthesize chatRoomAllMemberViewFooter=_chatRoomAllMemberViewFooter;
@property(retain, nonatomic) NSMutableArray *arrRoomMembers; // @synthesize arrRoomMembers=_arrRoomMembers;
@property(retain, nonatomic) ChatRoomContactSelectModel *viewModel; // @synthesize viewModel=_viewModel;
...
@property(nonatomic) _Bool supportAtRecord; // @synthesize supportAtRecord=_supportAtRecord;
...
- (_Bool)isAtAllSection:(unsigned long long)arg1;
...
- (CDUnknownBlockType)genRoomMemberComptr;
