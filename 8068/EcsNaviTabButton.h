...
@protocol EcsNaviTabButtonDelegate;

@interface EcsNaviTabButton
{
    _Bool _shouldShowLeftIcon;
    id <EcsNaviTabButtonDelegate> _delegate;
...
@property(nonatomic) __weak id <EcsNaviTabButtonDelegate> delegate; // @synthesize delegate=_delegate;
