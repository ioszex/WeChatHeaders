...
@interface WCDBUDRResource : NSObject
{
    ...
    unsigned int _encryptAlgo;
    unsigned int _encryptFileSize;
    NSString *_key;
    NSString *_projectId;
    NSString *_name;
    NSString *_url;
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSData *encryptAad; // @synthesize encryptAad=_encryptAad;
@property(retain, nonatomic) NSData *encryptTag; // @synthesize encryptTag=_encryptTag;
@property(retain, nonatomic) NSData *encryptIv; // @synthesize encryptIv=_encryptIv;
@property(retain, nonatomic) NSString *encryptMd5; // @synthesize encryptMd5=_encryptMd5;
@property(nonatomic) unsigned int encryptFileSize; // @synthesize encryptFileSize=_encryptFileSize;
@property(nonatomic) unsigned int encryptAlgo; // @synthesize encryptAlgo=_encryptAlgo;
@property(retain, nonatomic) NSString *uinMd5; // @synthesize uinMd5=_uinMd5;
@property(nonatomic) unsigned int storageType; // @synthesize storageType=_storageType;
