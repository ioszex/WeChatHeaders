...
@class MMFinderLiveCreateNoticeReporter, MMFinderLiveTaskId, MMRefreshTableFooterView, MMUIActivityIndicatorView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UITableView, WCFinderContact;
...
- (id)initWithAddedNoticeIds:(id)arg1 liveTaskId:(id)arg2;
