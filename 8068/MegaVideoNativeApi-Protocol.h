...
@class FlutterStandardTypedData, LVSnapshotInfo, MegaMainFeedListContext, MegaVideoFeedInfo, NSDictionary, NSNumber, NSString;

@protocol MegaVideoNativeApi
- (void)removeStarStarId:(NSString *)arg1 commentscene:(long long)arg2 error:(id *)arg3;
- (NSNumber *)isStarredStarId:(NSString *)arg1 commentscene:(long long)arg2 error:(id *)arg3;
- (void)updateStarInfoId:(NSString *)arg1 error:(id *)arg2;
