...
@interface MMFinderLiveMilestoneLotteryViewModel : NSObject
{
    ...
    NSString *_lastGoodsLotteryId;
}

+ (id)pathForBigLotteryPacketPAG;
+ (id)pathForSmallLotteryPacketPAG;
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *lastGoodsLotteryId; // @synthesize lastGoodsLotteryId=_lastGoodsLotteryId;
...
- (void)onMMFinderLiveMilestoneLotterySetAddressSuccessWithLotteryId:(id)arg1 claimInfo:(id)arg2;
...
- (void)openAddressSelectorWithLotteryId:(id)arg1;
