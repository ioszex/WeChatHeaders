...
@class BaseResponse, NSData, NSMutableArray, NSString, SubscribeMsgNotifyInfo, SubscribeMsgShowInfo, SubscribeMsgWording;
...
@property(retain, nonatomic) SubscribeMsgNotifyInfo *notifyInfo; // @dynamic notifyInfo;
@property(nonatomic) unsigned int notifySwitchStatus; // @dynamic notifySwitchStatus;
