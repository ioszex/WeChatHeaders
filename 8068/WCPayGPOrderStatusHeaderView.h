...
@interface WCPayGPOrderStatusHeaderView
{
    ...
    CDUnknownBlockType _onClickAmountInfoBtn;
}

- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType onClickAmountInfoBtn; // @synthesize onClickAmountInfoBtn=_onClickAmountInfoBtn;
