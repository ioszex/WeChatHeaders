...
@class ChatMigrationHeartBeatMonitor, MISSING_TYPE, MMTimer, NSArray, NSData, NSString, WXGChatLogProtoHandler, WXGLocalAreaCommunicationClient, WXGMigrationImportMessageHelper, WXGMigrationRecoverHelper;
...
@interface WXGMigrationClientLogic : NSObject
{
    ...
    MISSING_TYPE *m_totalSessionCount;
    _Bool m_bFirstTag;
...
- (void)p_processSelectTypeResponseData:(id)arg1;
- (void)p_processRequestSessionData:(id)arg1;
- (void)p_processStartResponseData:(id)arg1;
- (void)p_processChooseUserResponseData:(id)arg1;
