...
@interface CdnRenderView
{
    ...
    _Bool _renderInBackgroundEnabled;
...
@property _Bool renderInBackgroundEnabled; // @synthesize renderInBackgroundEnabled=_renderInBackgroundEnabled;
...
- (void)enableRenderInBackground:(_Bool)arg1;
