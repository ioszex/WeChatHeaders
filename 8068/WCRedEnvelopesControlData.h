...
@class CContact, CEmoticonWrap, CMessageWrap, CoverInfoDetail, GetDefaultRedpacketResponse, GetRecommendedCoverResponse, GetRedPacketFissionResp, GetShowSourceResp, HbEnvelopSource, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, RedEnvelopesLiteappJumpInfo, RedPacketPreviewMessage, RedPacketStoryInfo, UIColor, WCPayRealnameGuideInfo, WCRedEnvelopeQuickSendReportObject, WCRedEnvelopesAtomicInfo, WCRedEnvelopesDetailInfo, WCRedEnvelopesGreetingReportObject, WCRedEnvelopesHistoryInfo, WCRedEnvelopesOperationInfo, WCRedEnvelopesReceivedRedEnvelopesInfo, WCRedEnvelopesSendedRedEnvelopesInfo, WCRedEnvelopesSpringFestivalActivtyEntryInfo;
...
@interface WCRedEnvelopesControlData : NSObject
{
    ...
    RedEnvelopesLiteappJumpInfo *_packetListLiteappInfo;
    RedEnvelopesLiteappJumpInfo *_recommend_liteapp_info;
...
@property(retain, nonatomic) RedEnvelopesLiteappJumpInfo *recommend_liteapp_info; // @synthesize recommend_liteapp_info=_recommend_liteapp_info;
@property(retain, nonatomic) RedEnvelopesLiteappJumpInfo *packetListLiteappInfo; // @synthesize packetListLiteappInfo=_packetListLiteappInfo;
