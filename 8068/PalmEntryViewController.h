...
@class CAShapeLayer, CameraScannerView, MMTimer, NSString, PAGView, PalmEntryLogicController, PalmGuidingTipsView, PalmHalfScreenView, UIImageView, UIView;
...
@interface PalmEntryViewController
{
    ...
    PalmHalfScreenView *_guidePopUpView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) PalmHalfScreenView *guidePopUpView; // @synthesize guidePopUpView=_guidePopUpView;
...
@property(nonatomic) _Bool hasQualifiedPalm; // @synthesize hasQualifiedPalm=_hasQualifiedPalm;
...
- (void)palmEntryLogicDidGetFinalResult:(id)arg1 uploadVideoPath:(id)arg2;
...
- (void)showGuidePopUp;
- (void)initGuidePopUpViewWithTitle:(id)arg1 text:(id)arg2 timeoutMS:(unsigned int)arg3 videoUrl:(id)arg4 firstFrameUrl:(id)arg5 sessionId:(id)arg6;
