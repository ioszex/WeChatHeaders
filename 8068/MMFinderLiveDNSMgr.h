...
@class MMLiveFlowCancelationSource, MMTimer, NSArray, NSMutableDictionary, NSString;
...
@interface MMFinderLiveDNSMgr
{
    ...
    MMLiveFlowCancelationSource *_terminationCancelationSource;
}

+ (void)initMMDNSIfNeeded;
+ (void)mmdnsResolve:(id)arg1 fallbackLocal:(_Bool)arg2 hostIpMap:(id)arg3 cancelationToken:(id)arg4;
+ (id)localDNSResolve:(id)arg1;
+ (void)initDNSMgrServiceIfNeeded;
- (void).cxx_destruct;
@property(retain, nonatomic) MMLiveFlowCancelationSource *terminationCancelationSource; // @synthesize terminationCancelationSource=_terminationCancelationSource;
