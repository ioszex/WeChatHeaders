...
@class FlutterMethodChannel, FlutterViewController, LiteAppPageConfig, MMLiteAppReporter, NSMutableDictionary, NSString, UIView, UIViewController, WxaLiteAppStartReport, WxaLiteAppWidgetConsumer, WxaLiteAppWidgetFlutterPluginApi;
...
- (id)initWithAppUuid:(unsigned int)arg1 flutterViewcontroller:(id)arg2 pluginApi:(id)arg3 engineId:(unsigned long long)arg4 pluginHash:(unsigned long long)arg5 appId:(id)arg6 path:(id)arg7 page:(id)arg8 query:(id)arg9 sessionId:(id)arg10 signatureKey:(id)arg11 startReport:(id)arg12 reporter:(id)arg13;
