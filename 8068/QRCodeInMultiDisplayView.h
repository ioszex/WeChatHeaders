...
@class MISSING_TYPE, MMTimer, MMUIButton, MMUILabel, MMUIView, NSMutableArray;
...
@property(retain, nonatomic) MMUIView *curMaskView; // @synthesize curMaskView=_curMaskView;
