...
@class CContact, CMessageWrap, HistoryMsgsInfo, MISSING_TYPE, MMFinderLiveRedPacketMessage, NSArray, NSMutableArray, NSMutableDictionary, NSMutableString, NSString, RevokeWrap, WCFinderClubSystemMessage;
...
@interface CExtendInfoOfSysNewXmlForBiz : NSObject
{
    ...
    _Bool m_bCanFold;
    _Bool m_bFolded;
    MISSING_TYPE *m_bIsUpdatableMsgSubscribeMsg;
    _Bool m_bHadAddNewHistoryMsg;
    unsigned int m_updatableMsgType;
    unsigned int m_inviterQRCodeExpiredTime;
    unsigned int m_inviterJoinScene;
    ...
    NSString *m_inviterQRCode;
    RevokeWrap *revokeWrap;
    NSString *_m_reportExtraData;
...
@property(retain, nonatomic) NSString *m_reportExtraData; // @synthesize m_reportExtraData=_m_reportExtraData;
@property(retain, nonatomic) RevokeWrap *revokeWrap; // @synthesize revokeWrap;
@property(nonatomic) unsigned int m_inviterJoinScene; // @synthesize m_inviterJoinScene;
@property(nonatomic) unsigned int m_inviterQRCodeExpiredTime; // @synthesize m_inviterQRCodeExpiredTime;
- (void);
@property(retain, nonatomic) NSString *m_inviterQRCode; // @synthesize m_inviterQRCode;
...
@property(nonatomic) unsigned int m_updatableMsgType; // @synthesize m_updatableMsgType;
...
- (_Bool)isNewRevokeContentScene:(id)arg1;
