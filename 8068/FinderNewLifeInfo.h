...
@class ChatroomPushWording, FinderPostGuideInfo, FinderTopicInfo, NSMutableArray, NSString, NewLifeBizMpGuestDesc, NewLifeBizPicturDesc, NewLifeFollowPostInfo, NewLifeSearchWordingDesc, NewLifeTagStreamInfo;
...
@property(retain, nonatomic) NewLifeTagStreamInfo *tagStreamInfo; // @dynamic tagStreamInfo;
