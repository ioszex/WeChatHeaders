...
- (id)generateLaunchCGIUserInfo:(id)arg1 debugMode:(unsigned int)arg2 enterScene:(unsigned int)arg3 sessionId:(id)arg4 isFromBackground:(_Bool)arg5 isSilentOpen:(_Bool)arg6 isSheetMode:(_Bool)arg7 isCustomLoading:(_Bool)arg8 launchMode:(unsigned int)arg9 migrateFromUsername:(id)arg10;
