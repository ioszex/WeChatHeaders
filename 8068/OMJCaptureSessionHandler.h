...
@interface OMJCaptureSessionHandler : NSObject
{
    ...
    function_0d9fe91e _didCapturePhotoCallback;
    function_9994fbf9 _didOutputVideoSampleBufferCallback;
    function_2ff544b9 _didOutputAudioSampleBufferCallback;
    function_e88ba8d7 _didFinishSwitchCameraCallbackFunc;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) function_e88ba8d7 didFinishSwitchCameraCallbackFunc; // @synthesize didFinishSwitchCameraCallbackFunc=_didFinishSwitchCameraCallbackFunc;
...
@property(nonatomic) function_2ff544b9 didOutputAudioSampleBufferCallback; // @synthesize didOutputAudioSampleBufferCallback=_didOutputAudioSampleBufferCallback;
@property(nonatomic) function_9994fbf9 didOutputVideoSampleBufferCallback; // @synthesize didOutputVideoSampleBufferCallback=_didOutputVideoSampleBufferCallback;
@property(nonatomic) function_0d9fe91e didCapturePhotoCallback; // @synthesize didCapturePhotoCallback=_didCapturePhotoCallback;
...
- (void)capturePhoto;
- (void)calculateExposureValue:(function_5337ca1c)arg1;
