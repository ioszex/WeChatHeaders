...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderCommByPass, FinderLiveBeforeJoinLiveRoomStatus, FinderLiveClientStatus, FinderLiveReportBaseInfo, FinderPressureCtrl, NSData, NSMutableArray, NSString;
