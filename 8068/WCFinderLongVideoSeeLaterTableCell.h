...
@class MMUIButton, NSString, RichTextView, UIView, WCFinderAuthorContactView, WCFinderFeedContentVM, WCFinderFeedImageCDNView, WCFinderRichTextView, _TtC6WeChat25WCFinderSimpleProgressBar;
...
@interface WCFinderLongVideoSeeLaterTableCell : UITableViewCell
{
    ...
    WCFinderRichTextView *_reasonTextView;
...
@property(retain, nonatomic) WCFinderRichTextView *reasonTextView; // @synthesize reasonTextView=_reasonTextView;
