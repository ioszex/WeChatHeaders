...
@class MISSING_TYPE, NSArray, NSData, NSDictionary, NSMutableArray, NSObject, NSString, UIImage, WAEJFontDescriptor, WAEJPath, WAEJTexture, WCFinderDynamicIconFetcherResponse, WCFinderShareSpanState, WloginErrInfo, WloginUserInfo;
...
struct EmoticonEasterEggHelperCppCover;

struct EmoticonEasterEggHelperDispatcher;
...
struct shared_ptr<emoticon::EmoticonEasterEggHelperCppCover> {
    struct EmoticonEasterEggHelperCppCover *__ptr_;
    struct __shared_weak_count *__cntrl_;
};

struct shared_ptr<emoticon::EmoticonEasterEggHelperDispatcher> {
    struct EmoticonEasterEggHelperDispatcher *_field1;
    struct __shared_weak_count *_field2;
};
...
struct tagAVQualityReportInfo {
    ...
    struct tagVCodec2HWEngineReport _field544;
    ...
    unsigned int _field1014[10];
    int _field1015;
    int _field1016;
    unsigned int _field1017;
    unsigned int _field1018;
    unsigned long long _field1019;
};
...
struct weak_ptr<emoticon::EmoticonEasterEggHelperDispatcher> {
    struct EmoticonEasterEggHelperDispatcher *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
typedef struct shared_ptr<emoticon::EmoticonEasterEggHelperDispatcher> {
    struct EmoticonEasterEggHelperDispatcher *_field1;
    struct __shared_weak_count *_field2;
} shared_ptr_057dca59;
