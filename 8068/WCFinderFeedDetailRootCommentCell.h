...
@class MMUIButton, NSMutableArray, NSString, UIButton, UIColor, UIImageView, UILabel, UITapGestureRecognizer, UIView, WCFinderCommentLikeView, WCFinderCommentTranslateView, WCFinderDataItem, WCFinderFeedContentTextView, WCFinderHeadImageView, WCFinderInteractionLabelGroupView, WCFinderJumpInfoPanelView, WCFinderTemplateVideoCommentView;
