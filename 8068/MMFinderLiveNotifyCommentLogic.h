...
@class MMFinderLiveFollowNotifyCommentLogic, MMFinderLiveInteractionNotifyCommentLogic, MMFinderLiveLikeNotifyCommentLogic, MMFinderLiveLikeNotifyDataItem, MMFinderLiveLikeV2NotifyCommentLogic, MMFinderLiveRealNameFriendLikeCommentDataItem, MMFinderLiveTaskId, MMLiveCommentDataItem, MMLiveCommentPubbleCell, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSString, PAGFile, PAGView, UITableView, UIView;
...
@interface MMFinderLiveNotifyCommentLogic : NSObject
{
    ...
    id <MMFinderLiveNotifyCommentLogicDelegate> _delegate;
    MMFinderLiveTaskId *_taskId;
    MMFinderLiveLikeNotifyCommentLogic *_likeNotifyCommentLogic;
    MMFinderLiveLikeV2NotifyCommentLogic *_likeV2NotifyCommentLogic;
    MMFinderLiveFollowNotifyCommentLogic *_followNotifyCommentLogic;
    MMFinderLiveInteractionNotifyCommentLogic *_interactionNotifyCommentLogic;
    ...
    MMLiveCommentPubbleCell *_currentDisplayPubbleCell;
    ...
    unsigned long long _forbidRecOptions;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long forbidRecOptions; // @synthesize forbidRecOptions=_forbidRecOptions;
...
@property(retain, nonatomic) MMLiveCommentPubbleCell *currentDisplayPubbleCell; // @synthesize currentDisplayPubbleCell=_currentDisplayPubbleCell;
...
@property(retain, nonatomic) MMFinderLiveInteractionNotifyCommentLogic *interactionNotifyCommentLogic; // @synthesize interactionNotifyCommentLogic=_interactionNotifyCommentLogic;
...
@property(retain, nonatomic) MMFinderLiveLikeV2NotifyCommentLogic *likeV2NotifyCommentLogic; // @synthesize likeV2NotifyCommentLogic=_likeV2NotifyCommentLogic;
...
@property(nonatomic) __weak id <MMFinderLiveNotifyCommentLogicDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)onPreparingDisplayInteractionNotifyUpdate:(id)arg1;
- (_Bool)forbidReceiveMsg;
...
- (void)onPreparingDisplayFollowInteraction:(id)arg1 fromContact:(id)arg2;
- (void)onPreparingDisplayFollowNotifyUpdate:(id)arg1;
- (void)onPreparingDisplayLikeInteraction:(id)arg1 fromContact:(id)arg2;
- (void)onPreparingDisplayLikeV2MsgInfoUpdate:(id)arg1;
...
- (void)updateDisplayNextNotifyItemWithCurrentPubbleCell:(id)arg1 duration:(double)arg2;
