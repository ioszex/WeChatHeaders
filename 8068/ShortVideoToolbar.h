...
@interface ShortVideoToolbar
{
    ...
    UIView *_autoMacroSwitchAreaView;
...
@property(retain, nonatomic) UIView *autoMacroSwitchAreaView; // @synthesize autoMacroSwitchAreaView=_autoMacroSwitchAreaView;
