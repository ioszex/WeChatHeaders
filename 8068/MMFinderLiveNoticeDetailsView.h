...
@class FinderLiveNoticeInfo, MMFinderLiveNoticePosterModel, NSDateFormatter, NSString, UIButton, UIImage, UIImageView, UILabel, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView;
