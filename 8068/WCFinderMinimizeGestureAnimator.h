...
@interface WCFinderMinimizeGestureAnimator : NSObject
{
    ...
    double _dragOffsetToLock;
    struct CGPoint _beginPoint;
    struct CGRect _fromViewInitialFrame;
}

- (void).cxx_destruct;
@property(nonatomic) double dragOffsetToLock; // @synthesize dragOffsetToLock=_dragOffsetToLock;
...
- (id)initWithDragGesture:(id)arg1 behavior:(long long)arg2 direction:(long long)arg3 offsetToLock:(double)arg4;
