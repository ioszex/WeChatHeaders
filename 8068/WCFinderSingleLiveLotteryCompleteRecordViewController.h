...
@class MMFinderLiveTaskId, MMLiveLotteryCompleteInfoHeaderView, MMTableView, MMUILabel, NSData, NSMutableArray, NSString, PrizeRecord, WCTimeLineFooterView;
...
- (void)setLawDescriptionLabel:(id)arg1;
- (id)lawDescriptionLabel;
