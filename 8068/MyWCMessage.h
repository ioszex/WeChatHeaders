...
@interface MyWCMessage : NSObject
{
    ...
    long long _m_springWishFlag;
    long long _m_messgaeRelevanceType;
}
...
+ (void)__wcdb_column_constraint_32:(void *)arg1;
...
- (void).cxx_destruct;
@property(nonatomic) long long m_messgaeRelevanceType; // @synthesize m_messgaeRelevanceType=_m_messgaeRelevanceType;
@property(nonatomic) long long m_springWishFlag; // @synthesize m_springWishFlag=_m_springWishFlag;
