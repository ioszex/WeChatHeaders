...
@class NSMutableDictionary, NSString, WCActionSheetRecentItemsManager;
...
+ (_Bool)isDebugZipFile:(id)arg1;
+ (id)debugActionTitleForTemplateConfigDev:(id)arg1;
- (void).cxx_destruct;
...
- (void)jsApiCommandOpenByOthers;
- (void)jsApiCommandHandOffItem;
...
- (void)realOpenByApp:(id)arg1 reportParams:(id)arg2;
- (void)realOpenByApp:(id)arg1;
- (void)OnOpenByApp:(id)arg1;
- (id)getToSaveUrl;
- (void)performRecentItemAction:(id)arg1;
