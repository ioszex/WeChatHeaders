...
@interface MMLiveLeaveMicGuideView
{
    unsigned int _scene;
    CDUnknownBlockType _leaveMicBlock;
    CDUnknownBlockType _minimizeLiveBlock;
...
@property(copy, nonatomic) CDUnknownBlockType minimizeLiveBlock; // @synthesize minimizeLiveBlock=_minimizeLiveBlock;
