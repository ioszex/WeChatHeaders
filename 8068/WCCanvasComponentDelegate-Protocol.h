...
@class MMTableView, MMUIViewController, NSArray, NSMutableDictionary, NSNumber, NSString, POIInfo, UIColor, UIImage, UIView, UIViewController, WCAdCanvasLoadParams, WCAdDynamicCanvasServerData, WCAdExpressionCanvasHalfScreenJumpInfo, WCAdRandomPickCardItemInfo, WCAdRandomPickCardLogic, WCAdWeAppInfo, WCAdvertiseInfo, WCCanvasComponent, WCCanvasComponentItem, WCCanvasComponentRandomPickCardInfo, WCCanvasMusicMgr, WCCanvasReportMgr, WCDataItem, WCWeAppBizTempSessionInfo;
...
- (WCCanvasComponentRandomPickCardInfo *)onComponentFetchRandomPickComponentCardInfo;
...
- (WCAdRandomPickCardItemInfo *)onRandomPickCardComponentFetchLastStayPutItemInfo;
- (void)onRandomPickCardComponentUpdateStayPutItemWithInfo:(WCAdRandomPickCardItemInfo *)arg1;
- (void)onRandomPickCardComponentUpdateVanishingItemInfoWith:(WCAdRandomPickCardItemInfo *)arg1;
- (WCAdRandomPickCardItemInfo *)onRandomPickCardComponentFetchVanishingItemInfo;
...
- (void)onRandomPickCardComponentDidClick:(NSString *)arg1 isPicked:(_Bool)arg2 index:(unsigned long long)arg3;
...
- (long long)fetchPreviousClickedIndexForComponentItem:(WCCanvasComponentItem *)arg1;
