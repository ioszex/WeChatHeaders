...
+ (_Bool)isCameraScanOperateLogicUnsafe;
...
+ (_Bool)isCameraScanCombineBizDistributeLogicUnsafe:(id)arg1;
+ (id)cpKeyForCameraScanCombineBizDistributeLogic:(id)arg1;
...
+ (id)cpKeyForRecordDataItem:(id)arg1;
