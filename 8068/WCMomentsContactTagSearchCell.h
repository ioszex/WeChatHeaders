...
@class ContactTagData, MMUILabel, NSString, UIButton, UIView;
...
- (void)updateWithTagData:(id)arg1 query:(id)arg2 dicSearchMatchTip:(id)arg3 clickedDetail:(CDUnknownBlockType)arg4;
