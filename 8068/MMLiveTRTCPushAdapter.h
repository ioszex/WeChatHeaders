...
- (_Bool)updateCloudMixtureParamsForFinderLiveAudioRoomModeWithMicUsersInfo:(id)arg1 adminUser:(id)arg2 mixStreamIdentity:(id)arg3 mixWithVideo:(_Bool)arg4 useNewCloudMixture:(_Bool)arg5;
