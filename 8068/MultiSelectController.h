...
- (void)forwardYuanbaoH5:(id)arg1;
- (void)onClickToForwardYuanbaoH5:(id)arg1;
- (void)openYuanbao:(id)arg1;
- (void)showMsgCopyActionSheet:(id)arg1;
- (void)onClickToForwardYuanbao:(id)arg1;
...
- (void)reportSytemShare:(id)arg1 completed:(_Bool)arg2 params:(id)arg3;
- (void)showSystemShareSucc:(id)arg1;
- (void)showSystemShare:(id)arg1 params:(id)arg2;
- (void)shareMultiMsgSystem:(id)arg1 params:(id)arg2;
- (void)shareWithOtherAppMultiMsg:(id)arg1 WithUserName:(id)arg2 params:(id)arg3;
...
- (void)sendMultiMsgToYuanbao:(id)arg1 WithUserName:(id)arg2 params:(id)arg3;
- (_Bool)addYuanbaoH5Button:(id)arg1;
- (_Bool)addYuanbaoButton:(id)arg1 params:(id)arg2;
