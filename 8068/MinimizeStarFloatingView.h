...
@class MMTimer, MMUIView, MinimizeTaskContainerMoveContext, MinimizeTaskData, MoveWithTouchAlgorithm, NSString, UIImageView, UIVisualEffectView;
...
- (_Bool)canShowStarFloatingAt:(id)arg1;
- (void)MMUIViewControllerDidAppear:(id)arg1;
- (void)MMUIViewControllerWillAppear:(id)arg1;
- (void)checkUpdateShowingState:(id)arg1 animated:(_Bool)arg2;
