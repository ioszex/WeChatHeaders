...
@interface MMLiveLotteryDetailCardView : UIView
{
    ...
    UILabel *_noParticipateResultDescription;
    ...
    RichTextView *_winnersDetailResultTipLabel;
    ...
    NSString *_winnersDetailDescriptionText;
}

+ (long long)transferAliasRoleTypeFromPersonalMsgScene:(unsigned int)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *winnersDetailDescriptionText; // @synthesize winnersDetailDescriptionText=_winnersDetailDescriptionText;
...
@property(retain, nonatomic) RichTextView *winnersDetailResultTipLabel; // @synthesize winnersDetailResultTipLabel=_winnersDetailResultTipLabel;
...
@property(retain, nonatomic) UILabel *noParticipateResultDescription; // @synthesize noParticipateResultDescription=_noParticipateResultDescription;
