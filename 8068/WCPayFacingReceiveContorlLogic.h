...
@class MISSING_TYPE, MMTimer, MMWebViewController, NSMutableDictionary, NSString, WCPayApplyQrcodeCgi, WCPayF2FQrcodeCgi, WCPayF2fShortTermQrcodeCgi, WCPayFacingReceiveQRCodeViewController, WCPayGetMchQRCodeCgi, WCPayMchCodeVoiceOperateCgi, WCPayMchShortTermQrcodeCgi, WCPayNotifyMchQRCodeSaveCgi, WCPayQrcodeSaveNotifyCgi, WCPaySaveMchQRCodeCgi, WCPaySaveQrcodeCgi;
...
@interface WCPayFacingReceiveContorlLogic
{
    ...
    MISSING_TYPE *_m_WCPayFacingReceiveQRCodeViewController;
    ...
    NSMutableDictionary *_personalQRCodeExtraParams;
...
@property(retain, nonatomic) NSMutableDictionary *personalQRCodeExtraParams; // @synthesize personalQRCodeExtraParams=_personalQRCodeExtraParams;
...
- (void)setupPersonalQRCodeExtraParamsWithData:(id)arg1;
