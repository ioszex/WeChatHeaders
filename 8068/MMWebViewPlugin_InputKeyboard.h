...
- (void)showEmotionBoardAnimate:(int)arg1;
...
- (_Bool)showEmotionBoard:(double)arg1 ToShow:(_Bool)arg2 viewType:(int)arg3 EmotionBoardHeight:(double *)arg4 scene:(unsigned long long)arg5;
- (_Bool)showFullEmotionBoard:(double)arg1 ToShow:(_Bool)arg2 EmotionBoardHeight:(double *)arg3 scene:(unsigned long long)arg4;
- (_Bool)showEmotionBoardOnly:(double)arg1 ToShow:(_Bool)arg2 EmotionBoardHeight:(double *)arg3 scene:(unsigned long long)arg4;
