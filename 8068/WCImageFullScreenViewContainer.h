...
@class MMImageScrollViewHelper, MMLoadingView, MMProgressViewEx, MMScrollViewZoomReporter, MMUIButton, NSArray, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, SessionForwardRecordLogic, UIImage, UIImageView, UIView, UIViewPropertyAnimator, WCImageFullScreenTagView, WCImageTranslateLogic, WCLivePhotoBrowseReport, WCMediaItem, WCMediaItemWrap, WCMomentsPageContext, WCMomentsScrollActionSheet, WXFullScreenGestureRecognizer;
