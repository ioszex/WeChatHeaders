...
@class MMCPLabel, MMHeadImageView, MMTimer, MMUIButton, MMUIView, MoreViewControllerReporter, MyFavoritesViewController, NSString, TextStateFriendTopicButton, TextStatePrivacyMgr, TextStateProfileCardContentView, TextStateProfileDragAnimateHelper, TextStatePublishEntryButton, TextStateSquareButton, TextStateTopicModel, UITableView, UIView, UpdateWechatRedDotConfig, WCBizLoadingView, WCFinderCreateCoordinator, WCTableViewManager;
...
- (void)setupFinderEntranceIcon:(id *)arg1 title:(id *)arg2 iconSize:(struct CGSize)arg3 showFinder:(_Bool)arg4 showBrand:(_Bool)arg5 mixStyle:(_Bool)arg6;
- (_Bool)setupFinderEntranceRedDot:(_Bool *)arg1 rightText:(id *)arg2 badge:(id *)arg3;
