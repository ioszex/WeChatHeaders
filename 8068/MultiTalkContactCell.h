...
@class CContact, ColorGradientView, MMTimer, MMUILabel, MultiTalkHDHeadView, MultiTalkMuteIconView, MultiTalkSharingScreenTipsView, NSMutableArray, NSObject, NSString, UIImageView, UILabel, WCVideoRender;
