...
- (void)updateButtonTitleWithAnimation:(id)arg1 newCountString:(id)arg2 animationDuration:(double)arg3;
- (void)updateButton:(unsigned long long)arg1 withCount:(unsigned long long)arg2 animationDuration:(double)arg3;
- (void)updateWithRealTimeSyncData:(id)arg1;
