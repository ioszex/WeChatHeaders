...
@class FinderMusicTopicInfo, MMUIButton, MMUIView, MMWebImageView, NSString, RichTextView, UILabel, UIView, VideoTemplate, WCFinderAuthInfoIconView, WCFinderDataItem, WCFinderExpandHitTingPlayerContoller, WCFinderMusicEventHeaderRecommendListView, WCFinderShadowBubbleView, WCFinderShareItemInfo, WCFinderVideoTemplateView;
...
@interface WCFinderMusicEventHeaderView
{
    ...
    RichTextView *_listenWholeSongView;
...
@property(retain, nonatomic) RichTextView *listenWholeSongView; // @synthesize listenWholeSongView=_listenWholeSongView;
