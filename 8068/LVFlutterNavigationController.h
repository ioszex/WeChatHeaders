...
{
    _Bool _minizeWithPanStart;
    _Bool _minizeWithPan;
    _Bool _hasPrepared;
...
@property(nonatomic) _Bool minizeWithPan; // @synthesize minizeWithPan=_minizeWithPan;
@property(nonatomic) _Bool minizeWithPanStart; // @synthesize minizeWithPanStart=_minizeWithPanStart;
