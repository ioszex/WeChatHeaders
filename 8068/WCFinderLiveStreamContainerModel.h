...
@class FinderLiveFollowContainerInfo, FinderLiveTabListContainerInfo, FinderThemeLiveContainerInfo, NSData, NSMutableArray, NSString, WCFinderLiveTabInfo;
...
@interface WCFinderLiveStreamContainerModel : NSObject
{
    ...
    FinderLiveFollowContainerInfo *_liveFollowContainerInfo;
}

+ (id)finderLiveStreamContainerModelFrom:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) FinderLiveFollowContainerInfo *liveFollowContainerInfo; // @synthesize liveFollowContainerInfo=_liveFollowContainerInfo;
