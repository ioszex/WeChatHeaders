...
@class MMTableView, NSArray, NSDictionary, NSIndexPath, NSMutableArray, NSString, UIImage, UITextField, UIView, WCColorProxy, WCSTokenPickLogic;
...
- (UIView *)getSearchContactTagsView;
