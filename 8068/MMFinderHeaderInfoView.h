...
@class NSString, UILabel, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView;
...
@interface MMFinderHeaderInfoView : UIView
{
    ...
    WCFinderAuthInfoIconView *_authorizedIconView;
...
@property(retain, nonatomic) WCFinderAuthInfoIconView *authorizedIconView; // @synthesize authorizedIconView=_authorizedIconView;
