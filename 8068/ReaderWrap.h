...
@class BrandFinderLiveDataWrapper, MagicAdInfo, MiddleTipsWithBackground, NSDate, NSMutableArray, NSString, ProductActivity, ReaderTopNewWrap, TemplateAdvertiseOPWrap, TemplateDetailToplineWrap, TemplateFinderAIGCTaskWrap, TemplateFinderGameLiveOPWrap, TemplateFinderLiveOPWrap, TemplateFinderMemberCenterOPWrap, TemplateHeaderWrap, TemplateImageTextWrap, TemplateLiteAppOPWrap, TemplateMsgControlInfo, TemplateScheduleOPWrap, TemplateTingPlayListOPWrap, TemplateVoipCallInfoWrap, TemplateWeappOPWrap, TemplateWebSearchOPWrap, UIColor, WCFinderShareToMomentsItem;
...
@interface ReaderWrap : NSObject
{
    ...
    NSString *m_nsPublisherUserName;
    ...
    unsigned int _redPacketCoverV2;
    unsigned int _hasGiftActivity;
    ...
    TemplateWeappOPWrap *_pay_recepit_detail_weapp_wrap;
    ...
    TemplateVoipCallInfoWrap *_voipCallInfoWrap;
    NSString *_installedTitle;
    NSString *_rawAdInfo;
    MagicAdInfo *_yuanbaoAdInfo;
...
@property(retain, nonatomic) NSMutableArray *cdnUrls; // @synthesize cdnUrls=_cdnUrls;
@property(nonatomic) unsigned int hasGiftActivity; // @synthesize hasGiftActivity=_hasGiftActivity;
@property(nonatomic) unsigned int redPacketCoverV2; // @synthesize redPacketCoverV2=_redPacketCoverV2;
...
@property(retain, nonatomic) MagicAdInfo *yuanbaoAdInfo; // @synthesize yuanbaoAdInfo=_yuanbaoAdInfo;
@property(copy, nonatomic) NSString *rawAdInfo; // @synthesize rawAdInfo=_rawAdInfo;
@property(copy, nonatomic) NSString *installedTitle; // @synthesize installedTitle=_installedTitle;
@property(retain, nonatomic) TemplateVoipCallInfoWrap *voipCallInfoWrap; // @synthesize voipCallInfoWrap=_voipCallInfoWrap;
...
@property(retain, nonatomic) TemplateWeappOPWrap *pay_recepit_detail_weapp_wrap; // @synthesize pay_recepit_detail_weapp_wrap=_pay_recepit_detail_weapp_wrap;
...
@property(retain, nonatomic) NSString *m_nsPublisherUserName; // @synthesize m_nsPublisherUserName;
...
- (_Bool)isValidYuanBaoPromotionPosition;
- (_Bool)isReaderWrapYuanBaoPromotionMsg;
