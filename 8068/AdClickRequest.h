...
@class AdClickExtInfo, AdClickQualityInfo, AdShareInfo, BaseRequest, NSData, NSString;
...
@property(retain, nonatomic) AdClickExtInfo *adExtInfo; // @dynamic adExtInfo;
...
@property(retain, nonatomic) AdClickQualityInfo *clickQualityInfo; // @dynamic clickQualityInfo;
