...
@class NSString, OMCStoryline, OMJAspectRatio;
...
@property(readonly, nonatomic) _Bool containsHDRVideoSegment;
@property(nonatomic) _Bool isHDRRenderingEnabled;
...
- (id)anchorVisualEffectSegmentAtTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2 normalizedContentSize:(struct CGSize)arg3 blurIntensity:(double)arg4;
...
- (id)anchorFancyTextSegmentWithMaterialID:(id)arg1 atTime:(CDStruct_1b6d18a9)arg2 duration:(CDStruct_1b6d18a9)arg3 shouldUsePlaceholder:(_Bool)arg4 shouldUseDefaultContent:(_Bool)arg5;
