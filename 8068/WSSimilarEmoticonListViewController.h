...
@class CEmoticonWrap, CMessageWrap, EmoticonCustomAddLogicController, EmoticonCustomManageAddLogic, FTSWebSearchMgr, MMTableView, NSMutableArray, NSMutableDictionary, NSString, SharePreConfirmSheetView, WCTimeLineFooterView, WSEmoticonModel, WSSImilarPageModel;
