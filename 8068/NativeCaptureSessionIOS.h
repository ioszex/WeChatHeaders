...
- (void).cxx_destruct;
@property(nonatomic) _Bool need_gl_tex; // @synthesize need_gl_tex=_need_gl_tex;
...
- (void)startRunning;
- (_Bool)isRunning;
- (id)initWithCallback:(void *)arg1 width:(int)arg2 height:(int)arg3 autoFocus_once:(_Bool)arg4 need_gltex:(_Bool)arg5;
- (void)dealloc;
