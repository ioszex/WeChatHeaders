...
- (_Bool)isCommentItemCacheNeedDelete:(id)arg1;
...
- (void)checkNeedKeepDisplayCommentWithNewAppendedComments:(id)arg1 forTaskId:(id)arg2;
...
- (void)downgradeBigEmoticonCommentByConditionBlock:(CDUnknownBlockType)arg1 taskId:(id)arg2 boxId:(id)arg3 replaceContent:(id)arg4;
- (void)innerProcessDeletedCommentDataItem:(id)arg1 taskId:(id)arg2 boxId:(id)arg3;
- (void)deleteCommentByLocalClientMsgId:(id)arg1 taskId:(id)arg2 boxId:(id)arg3;
