...
+ (id)sessionWithProject:(id)arg1 imageOriginDuration:(CDStruct_1b6d18a9)arg2 minSegmentPreservedDuration:(CDStruct_1b6d18a9)arg3 calcDurationWithAllSegments:(_Bool)arg4 shouldUseSourceURL:(_Bool)arg5;
