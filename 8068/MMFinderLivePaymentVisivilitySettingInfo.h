...
@interface MMFinderLivePaymentVisivilitySettingInfo
{
    ...
    NSMutableArray *_selectedFreeTagNameList;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *selectedFreeTagNameList; // @synthesize selectedFreeTagNameList=_selectedFreeTagNameList;
