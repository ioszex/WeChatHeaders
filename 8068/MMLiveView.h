...
@interface MMLiveView : UIView
{
    ...
    _Bool _isCdnViewerMicDataSrcCompletely;
    ...
    CDUnknownBlockType _onVideoBottomViewShownOrFrameChanged;
...
@property(nonatomic) _Bool isCdnViewerMicDataSrcCompletely; // @synthesize isCdnViewerMicDataSrcCompletely=_isCdnViewerMicDataSrcCompletely;
...
@property(copy, nonatomic) CDUnknownBlockType onVideoBottomViewShownOrFrameChanged; // @synthesize onVideoBottomViewShownOrFrameChanged=_onVideoBottomViewShownOrFrameChanged;
...
- (void)onFinderLiveCDNViewerMicDataSrcUpdateCompletely:(id)arg1;
...
- (struct CGRect)relativeCdnPlayerRestrictedRect;
...
- (void)updatePlayerView:(id)arg1 withHoleList:(id)arg2;
- (void)generatePlayerViewMaskContext:(id *)arg1 forPlayerView:(id)arg2 coverViewMaskContext:(id *)arg3 forCoverView:(id)arg4;
