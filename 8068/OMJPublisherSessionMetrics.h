...
- (void)markMCWillStartExportingWithTimeline:(id)arg1 currentComposingStepIndex:(long long)arg2 maxComposingStepIndex:(long long)arg3 isFromSaveVideo:(_Bool)arg4;
...
- (void)notifyMCSelectFancyTextStyleID:(id)arg1 isFromRecentlyUsed:(_Bool)arg2;
...
- (void)notifyMCSelectEmoticonID:(id)arg1;
- (void)notifyMCSelectWhenWhereID:(id)arg1;
- (void)notifyMCSelectDecorPackageID:(id)arg1;
...
- (void)markSCWillStartAssetCreatingExportingWithIsFromSaveVideo:(_Bool)arg1;
...
- (void)notifySCAssetCreatingBeautyMakeupChanged:(_Bool)arg1;
...
- (void)markSCDidCancelRecordingWithCancelReason:(id)arg1 cancelMessage:(id)arg2;
...
- (void)notifySCUpdateFavoriteStateWithTemplateID:(id)arg1 isFavorite:(_Bool)arg2;
...
- (void)notifySCStartPreviewingUpdateAIGCInfoWithTemplateID:(id)arg1 isAIGC:(_Bool)arg2;
- (void)markSCWillStartPreviewingWithTemplateID:(id)arg1 templateTabID:(id)arg2 templateIndex:(long long)arg3 isTemplateSelectDefault:(_Bool)arg4 musicID:(id)arg5 isFrontFacingCamera:(_Bool)arg6 isMicrophoneOpened:(_Bool)arg7 isDuetShoot:(_Bool)arg8 isFavorite:(_Bool)arg9 isAIGC:(_Bool)arg10;
