...
@class MMWebOptimJSContextTaskMgr, MMWebOptimizationPrefetcher, MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString;
...
@interface MMWebOptimizationMgr
{
    ...
    MemoryMappedKV *_webControlDataSlotKv;
    MemoryMappedKV *_domainControlDataSlotKv;
    MemoryMappedKV *_domainPreDNSResultSlotKv;
    MemoryMappedKV *_prefetchDomainInfoSlowKv;
    MemoryMappedKV *_redirectInfoSlotKv;
    MemoryMappedKV *_prefetchIdentifierSlotKv;
    MemoryMappedKV *_webPrefetcherIdSlotKv;
...
@property(retain, nonatomic) MemoryMappedKV *webPrefetcherIdSlotKv; // @synthesize webPrefetcherIdSlotKv=_webPrefetcherIdSlotKv;
@property(retain, nonatomic) MemoryMappedKV *prefetchIdentifierSlotKv; // @synthesize prefetchIdentifierSlotKv=_prefetchIdentifierSlotKv;
@property(retain, nonatomic) MemoryMappedKV *redirectInfoSlotKv; // @synthesize redirectInfoSlotKv=_redirectInfoSlotKv;
@property(retain, nonatomic) MemoryMappedKV *prefetchDomainInfoSlowKv; // @synthesize prefetchDomainInfoSlowKv=_prefetchDomainInfoSlowKv;
@property(retain, nonatomic) MemoryMappedKV *domainPreDNSResultSlotKv; // @synthesize domainPreDNSResultSlotKv=_domainPreDNSResultSlotKv;
@property(retain, nonatomic) MemoryMappedKV *domainControlDataSlotKv; // @synthesize domainControlDataSlotKv=_domainControlDataSlotKv;
@property(retain, nonatomic) MemoryMappedKV *webControlDataSlotKv; // @synthesize webControlDataSlotKv=_webControlDataSlotKv;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: arrA8keyLiteWaitingQueue
