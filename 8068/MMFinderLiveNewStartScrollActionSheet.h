...
@class MMFinderLiveChooseModeView, MMFinderLiveModeModel, MMFinderLiveTaskId, MMLiveActionSheetFlowLayoutView, MMLiveShopShelfDragBar, MMScrollActionSheetItemView, NSArray, NSString, UILabel, UIPanGestureRecognizer, UIScrollView, UIView, WCFinderLiveAnchorLogReporter, WCFinderLiveStarterReporter, WCFinderStarterLiveViewModel, WCLiveStarterScrollActionSheetViewModel;
