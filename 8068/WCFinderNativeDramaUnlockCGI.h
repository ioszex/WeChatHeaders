...
@interface WCFinderNativeDramaUnlockCGI
{
    WCFinderNativeDramaUnlockCGIParams *_params;
...
@property(retain, nonatomic) WCFinderNativeDramaUnlockCGIParams *params; // @synthesize params=_params;
