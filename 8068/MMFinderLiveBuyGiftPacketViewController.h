...
@class MISSING_TYPE, MMCommonActionSheetPicker, MMFinderLiveGlobalRewardLevelView, MMFinderLiveRewardLevelConfigs, MMFinderLiveTaskId, MMUIActivityIndicatorView, MMUIButton, MMUILabel, NSArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView;
...
@interface MMFinderLiveBuyGiftPacketViewController
{
    ...
    MISSING_TYPE *_globalRewardLevelPreviewView;
