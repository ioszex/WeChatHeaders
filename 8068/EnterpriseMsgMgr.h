...
@class DownloadImageCDNMgr, EnterpriseSendMsgMgr, EnterpriseVoiceMsgMgr, ImageUploadUnifyBaseMgr, MessagePatternCacheMgr, MultiMediaUploadUnifyMgr, NSMutableDictionary, NSObject, NSString, OpenDownloadCDNMgr, OpenUploadCDNMgr, OpenUploadMgr, RecordUploadCDNMgr, ThumbDownloadMgr;
