...
+ (void)setDevCountCloudStorage:(unsigned int)arg1;
+ (void)setDevCountSMB:(unsigned int)arg1;
+ (void)setDevCountICloud:(unsigned int)arg1;
+ (void)setDevCountExternalStorage:(unsigned int)arg1;
...
+ (void)setDevIndexCloudStorage:(unsigned int)arg1;
+ (void)setDevIndexSMB:(unsigned int)arg1;
+ (void)setDevIndexICloud:(unsigned int)arg1;
+ (void)setDevIndexExternalStorage:(unsigned int)arg1;
