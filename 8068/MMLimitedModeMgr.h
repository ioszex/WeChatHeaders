...
- (void)continueSetLimitedModeOn:(_Bool)arg1 ticket:(id)arg2;
...
- (void)checkContactIsAdultAgeWithNewLogicBlock:(CDUnknownBlockType)arg1 oldLogicBlock:(CDUnknownBlockType)arg2;
