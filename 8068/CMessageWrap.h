...
// Error: Property attributes should begin with the type ('T') attribute, property name: m_pdqhash
...
@property(nonatomic) long long m_uiAppDataSize; // @dynamic m_uiAppDataSize;
