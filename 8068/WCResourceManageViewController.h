...
@class MISSING_TYPE, MMUIActivityIndicatorView, MMUILabel, NSDate, NSMutableArray, NSString, ResourceBrowseCollectionView, StorageFilterView, StorageFootPanelView, UIView, WCFilterView;
...
@interface WCResourceManageViewController
{
    ...
    MISSING_TYPE *_filterReportSession;
}
