...
@class NSArray, NSString, NSTextAttachment, NSURL, UIAction, UIInputSuggestion, UIMenu, UITextFormattingViewController, UITextItem, UITextItemMenuConfiguration, UITextView;
@protocol UIContextMenuInteractionAnimating, UIEditMenuInteractionAnimating;

@protocol UITextViewDelegate <NSObject, UIScrollViewDelegate>

@optional
- (void)textView:(UITextView *)arg1 insertInputSuggestion:(UIInputSuggestion *)arg2;
...
- (UIMenu *)textView:(UITextView *)arg1 editMenuForTextInRanges:(NSArray *)arg2 suggestedActions:(NSArray *)arg3;
...
- (_Bool)textView:(UITextView *)arg1 shouldChangeTextInRanges:(NSArray *)arg2 replacementText:(NSString *)arg3;
