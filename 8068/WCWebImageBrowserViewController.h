...
@class ImageBrowseButton, MMWebViewMpInfoModel, NSCache, WCImageSearchEntity, WCWebImageBrowserConfig, WCWebImageButtonsContainerView, WCWebImageSourceInfoButton;

@interface WCWebImageBrowserViewController
{
    NSCache *_watermarkImageCache;
    WCImageSearchEntity *_searchEntity;
    MMWebViewMpInfoModel *_mpInfoModel;
...
@property(retain, nonatomic) MMWebViewMpInfoModel *mpInfoModel; // @synthesize mpInfoModel=_mpInfoModel;
