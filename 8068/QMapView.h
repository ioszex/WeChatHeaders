...
@class NSArray, NSMutableArray, NSMutableSet, NSString, QAOIMarkerManager, QAnnotationContainerView, QAppKeyCheck, QBaseVisualLayerManager, QBasicMapView, QBasicMapViewLayer, QBrandPromotionServer, QConfigManager, QConfigPreference, QCustomLayerManager, QDataChecker, QEngineResourceManager, QHandDrawTileOverlay, QIndoorBuilding, QIndoorLevel, QIndoorManager, QInnerMarkerManager, QIntersectionOverlayManager, QL4Manager, QLayerManager, QLocalStateCollector, QMapContentView, QMapDataManager, QMapDataSafetyInternalManager, QMapViewAccessibilityElement, QMarker, QMediator, QOverlayContainer, QPointEventMananger, QScaleView, QStatisticer, QStyleManager, QTileOverlayManager, QTrafficManager, QUniversalMapCounter, QUserLocation, QUserLocationAccessibilityElement, QUserLocationManager, QUserLocationPresentation, QWorldTileOverlay, QWorldTileOverlayCustomProvider, TBRegionChangeDistributor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
