...
- (void)clearAndHide;
- (void)showWithConnectMicUserInfo:(MMFinderLiveConnectMicUser *)arg1 isGlobalSmallMode:(_Bool)arg2 isInFullScreenPKStyle:(_Bool)arg3 configureLiveDirtyHandle:(_Bool)arg4 hideSmallWidgets:(_Bool)arg5 micLayoutMode:(unsigned long long)arg6;
