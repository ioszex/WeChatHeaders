...
- (_Bool)isRedDotMeetWithCondition:(NSString *)arg1 ctrlInfo:(NSData *)arg2;
- (void)reddotWillRevokeTipsUuidArray:(NSArray *)arg1;
- (int)getCurFinderUnreadCountByUsername:(NSString *)arg1 fromRedDotPath:(_Bool)arg2 finderMsgCount:(int)arg3 finderMembershipCount:(int)arg4;
