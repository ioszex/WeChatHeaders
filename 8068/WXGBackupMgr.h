...
@class ChatMigrationGetConnectInfo, NSArray, NSData, NSString, WCBackupEntryViewController, WCPCMigrationEntryViewController, WXGBackupChatRecordStartExportXmlInfo, WXGBackupImportMessageHelper, WXGBackupLogic;
...
@interface WXGBackupMgr
{
    ...
    unsigned int _notificationActionTimeStamp;
    int _notificationActionScene;
    NSString *_server_id;
    NSData *_server_key;
    ...
    WXGBackupChatRecordStartExportXmlInfo *_startExportInfo;
    WCBackupEntryViewController *_brEntryVC;
    WCPCMigrationEntryViewController *_pcmEntryVC;
    WCPCMigrationEntryViewController *_pcmExportEntryVC;
...
@property(retain, nonatomic) WCPCMigrationEntryViewController *pcmExportEntryVC; // @synthesize pcmExportEntryVC=_pcmExportEntryVC;
...
@property(nonatomic) int notificationActionScene; // @synthesize notificationActionScene=_notificationActionScene;
@property(nonatomic) unsigned int notificationActionTimeStamp; // @synthesize notificationActionTimeStamp=_notificationActionTimeStamp;
@property(retain, nonatomic) WXGBackupChatRecordStartExportXmlInfo *startExportInfo; // @synthesize startExportInfo=_startExportInfo;
...
- (void)applicationDidEnterForegroundThroughNotification:(int)arg1;
- (int)getReportPageExpType;
- (void)reportDataReconciliation:(id)arg1;
- (void)unireport26824:(id)arg1;
- (void)report26824:(id)arg1 extra:(id)arg2;
...
- (void)onCancelEntryViewController:(id)arg1;
- (void)onMinimizeEntryViewController:(id)arg1;
...
- (_Bool)hasMigratePCEntryViewController;
