...
@class FinderSideBarRelatedLivePrepareInfo, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSString *jumpNavliveBufferEncode; // @dynamic jumpNavliveBufferEncode;
...
@property(retain, nonatomic) FinderSideBarRelatedLivePrepareInfo *sideBarRelatedLivePrepareInfo; // @dynamic sideBarRelatedLivePrepareInfo;
