...
@property(nonatomic) _Bool enableLivePhotoPreload; // @dynamic enableLivePhotoPreload;
...
@property(nonatomic) unsigned int livePhotoPreloadCount; // @dynamic livePhotoPreloadCount;
