...
@interface BrandProfileEnterInfo : NSObject
{
    _Bool _isFromFinder;
    _Bool _scrollToTab;
    _Bool _enterForManagementScene;
    ...
    unsigned int _enterItemShowType;
    NSString *_sendUser;
    NSString *_chatUser;
    NSString *_firstUrl;
    NSString *_lastUrl;
...
@property(nonatomic) unsigned int enterItemShowType; // @synthesize enterItemShowType=_enterItemShowType;
@property(nonatomic) _Bool enterForManagementScene; // @synthesize enterForManagementScene=_enterForManagementScene;
