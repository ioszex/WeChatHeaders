...
@class BaseScanSessionInfo, CameraScanBaseContentView, CameraScanTabSwitchingView, CameraScannerViewWrapper, NSString;
...
@interface BaseScanLogicController
{
    ...
    BaseScanSessionInfo *_scanSessionInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) BaseScanSessionInfo *scanSessionInfo; // @synthesize scanSessionInfo=_scanSessionInfo;
...
- (unsigned long long)scanSessionStartTimeStamp;
- (unsigned int)scanSessionID;
