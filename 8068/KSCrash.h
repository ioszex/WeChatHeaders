...
@interface KSCrash : NSObject
{
    ...
    MISSING_TYPE *_shouldPrintJSCType;
    _Bool _ksLoggerEnabled;
    ...
    CDUnknownFunctionPointerType _onWriteLockTraceCallBack;
}
...
+ (void)load;
- (void).cxx_destruct;
@property(nonatomic) CDUnknownFunctionPointerType onWriteLockTraceCallBack; // @synthesize onWriteLockTraceCallBack=_onWriteLockTraceCallBack;
...
@property(nonatomic) _Bool ksLoggerEnabled; // @synthesize ksLoggerEnabled=_ksLoggerEnabled;
