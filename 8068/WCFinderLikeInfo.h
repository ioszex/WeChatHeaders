...
- (void).cxx_destruct;
@property(nonatomic) long long comboLikeCount; // @synthesize comboLikeCount=_comboLikeCount;
@property(nonatomic) _Bool isAuthorViewer; // @synthesize isAuthorViewer=_isAuthorViewer;
@property(nonatomic) _Bool isSelfPosted; // @synthesize isSelfPosted=_isSelfPosted;
