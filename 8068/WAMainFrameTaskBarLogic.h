...
@interface WAMainFrameTaskBarLogic
{
    ...
    unsigned int _commonUseItemsUpdateScene;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int commonUseItemsUpdateScene; // @synthesize commonUseItemsUpdateScene=_commonUseItemsUpdateScene;
...
- (_Bool)isXDevice;
- (void)updateLatestUsageRecordInfo:(unsigned int)arg1;
- (void)realGetLatestUsageRecordInfo:(id)arg1 scene:(unsigned int)arg2;
- (void)updateLatestUsageRecordInfo:(unsigned int)arg1 explicitRequestType:(unsigned int)arg2;
