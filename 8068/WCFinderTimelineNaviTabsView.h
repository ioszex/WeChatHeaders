...
@protocol WCFinderTimelineNaviTabsViewDataSource, WCFinderTimelineNaviTabsViewDelegate;

@interface WCFinderTimelineNaviTabsView : UIView
{
    id <WCFinderTimelineNaviTabsViewDelegate> _delegate;
    id <WCFinderTimelineNaviTabsViewDataSource> _dataSource;
...
+ (_Bool)isLessThan402WidthScreen;
- (void).cxx_destruct;
...
@property(nonatomic) __weak id <WCFinderTimelineNaviTabsViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) __weak id <WCFinderTimelineNaviTabsViewDelegate> delegate; // @synthesize delegate=_delegate;
