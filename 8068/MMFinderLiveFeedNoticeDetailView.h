...
@class CAGradientLayer, FinderLiveNoticeInfo, MMFinderLiveFeedNoticeColumnView, MMFinderLiveMultiCouponForNoticeView, MMFinderLiveNoticeDetailPayView, MMLiveShopShelfDragBar, MMPaddingView, MMUIButton, MMUIImageView, MMUILabel, NSString, UILabel, UIScrollView, UIView, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView;
