...
@class MMFinderLiveGloryTopItemView, MMFinderLiveSharePubbleTipView, MMLiveTaskId, MMUILabel, NSString;
...
@interface MMFinderLiveGloryTopView
{
    ...
    MMFinderLiveGloryTopItemView *_tipsTargetView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveGloryTopItemView *tipsTargetView; // @synthesize tipsTargetView=_tipsTargetView;
