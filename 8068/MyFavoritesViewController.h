...
@class FavClickStreamData, FavDataBatchSaveLogic, FavMultiSelectToolView, FavWarningBannerView, MMTimer, MMUIButton, MMUIView, MMUIWindow, NSString, UIButton, UIView;
