...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, UILabel, UIView, WCFinderBubbleActionItem, WCFinderCornerTextBubbleView, WCFinderEnterStreamTipBubbleView, WCFinderPopupPanelView, WCFinderPostStateBubbleView, WCFinderShadowBubbleView, WCFinderTLTabBubble, WCFinderTimelineRedDotBubbleDisplayInfo, WCFinderTimelineScrollTipsView;
