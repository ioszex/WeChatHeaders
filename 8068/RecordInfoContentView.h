...
@class AudioRecorderUserData, CADisplayLink, CALayer, EmoticonBoardView, MMGrowTextView, MMNewVoiceInputReportObj, MMUIActivityIndicatorView, MMUIButton, NSMutableArray, NSString, SightIconView, SimplifyTextLogic, TranslateButton, TranslateFunctionButton, UIButton, UILabel, VoiceRecordSelectLanguageView, WCInputController, WCRecordFeedbackView, WorldTranslateManager;
