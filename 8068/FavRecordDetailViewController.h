...
@class FavoritesItemDataField, ForwardMessageLogicController, MMMsgMenuReporter, MMRichTextCoverView, MMUIWindow, NSArray, NSMutableDictionary, NSString;
...
- (_Bool)openBrandMpVideoByFavItem:(id)arg1 dataField:(id)arg2 thumbView:(id)arg3;
