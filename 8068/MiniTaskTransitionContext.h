...
@interface MiniTaskTransitionContext : NSObject
{
    ...
    _Bool _hasTriggerInteractiveAppend;
    _Bool _enableRightEdgePanGesture;
    _Bool _enableAddStarCorner;
    ...
    MinimizeTaskData *_taskDataForMinimizeTransition;
    id <MinimizeTransitionInterface> _minimizeTransitionDelegate;
    struct CGRect _snapshotFrameToSuperView;
    struct CGRect _snapshotFrameToWindow;
    struct CGRect _starFloatingFrameToWindow;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool enableAddStarCorner; // @synthesize enableAddStarCorner=_enableAddStarCorner;
@property(nonatomic) _Bool enableRightEdgePanGesture; // @synthesize enableRightEdgePanGesture=_enableRightEdgePanGesture;
@property(nonatomic) _Bool hasTriggerInteractiveAppend; // @synthesize hasTriggerInteractiveAppend=_hasTriggerInteractiveAppend;
@property(nonatomic) struct CGRect starFloatingFrameToWindow; // @synthesize starFloatingFrameToWindow=_starFloatingFrameToWindow;
@property(nonatomic) __weak id <MinimizeTransitionInterface> minimizeTransitionDelegate; // @synthesize minimizeTransitionDelegate=_minimizeTransitionDelegate;
@property(retain, nonatomic) MinimizeTaskData *taskDataForMinimizeTransition; // @synthesize taskDataForMinimizeTransition=_taskDataForMinimizeTransition;
