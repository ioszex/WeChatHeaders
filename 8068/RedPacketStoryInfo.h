...
@class CoverInfoDetail, EcsJumpInfo, NSMutableArray, NSString, RedPacketStoryInfo_JumpDetail, RedPacketStoryInfo_WxappInfo;
...
@property(retain, nonatomic) RedPacketStoryInfo_JumpDetail *outerJump; // @dynamic outerJump;
