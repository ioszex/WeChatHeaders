...
@class EcsInfo, EcsShareSnsInfo, MMMusicShareItem, NSMutableArray, NSMutableDictionary, NSString, TingShareCategoryItem, TingShareChatRoomItem, TingShareListenItem, TingShareLyricsItem, WCAppMsgShareInfo, WCBrandMpVideoItem, WCFinderCollectionShareItem, WCFinderContentColumnSharedItem, WCFinderLiveShareItem, WCFinderLiveShopWindowShareItem, WCFinderShareItemContainer, WCFinderShareToMomentsItem, WCFinderThemeLiveStreamShareItem, WCFinderTopicShareItem, WCMegaVideoShareItem, WCMomentsDragonInfo, WCMomentsRabbitInfo, WCMomentsSpringFestivalInfo, WCMomentsTigerInfo, WCNoteInfo;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: finderContentColumnSharedItem
