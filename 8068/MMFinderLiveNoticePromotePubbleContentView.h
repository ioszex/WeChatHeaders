...
@class FinderLiveNoticeInfo, MMFinderLiveReserveNoticeLogic, MMLiveIconButton, MMPaddingView, MMUIButton, MMUILabel, MMWebImageView, NSString, WCFinderBaseCgi, WCFinderLiveNoticePayActionView, WCLiveActionSheet;
