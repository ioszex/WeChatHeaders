...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_focusValue; // @synthesize m_focusValue=_m_focusValue;
...
- (void)setShowInputDot:(_Bool)arg1;
- (_Bool)getShowInputDot;
- (void)setMoneyShowBit:(int)arg1;
- (int)getMoneyShowBit;
- (void)setConfirmButtonColor:(id)arg1;
