...
@interface WCTPPlayer : NSObject
{
    ...
    _Bool _isBanDownloadProxy;
    _Bool _outputAudioFrame;
    _Bool _isForceUseAVDisplayerLayer;
    _Bool _enableSEICallback;
    _Bool _enableRenderOptYuv420;
    _Bool _muted;
    _Bool _isOpenAudioProcessCallback;
...
@property(nonatomic) long long outAudioFrameSizeByte; // @synthesize outAudioFrameSizeByte=_outAudioFrameSizeByte;
@property(nonatomic) _Bool isOpenAudioProcessCallback; // @synthesize isOpenAudioProcessCallback=_isOpenAudioProcessCallback;
...
@property(nonatomic) long long enableRendererColorLUT; // @synthesize enableRendererColorLUT=_enableRendererColorLUT;
...
@property(nonatomic) _Bool isForceUseAVDisplayerLayer; // @synthesize isForceUseAVDisplayerLayer=_isForceUseAVDisplayerLayer;
...
@property(nonatomic) _Bool isBanDownloadProxy; // @synthesize isBanDownloadProxy=_isBanDownloadProxy;
...
- (void)prepareAsync;
- (void)cleanPlayer;
- (_Bool)addSubtitleSource:(id)arg1 mimeType:(id)arg2 name:(id)arg3;
