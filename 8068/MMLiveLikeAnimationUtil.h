...
@interface MMLiveLikeAnimationUtil : NSObject
{
    ...
    NSMutableArray *_doubleClickAnimationRouteArr;
...
@property(retain, nonatomic) NSMutableArray *doubleClickAnimationRouteArr; // @synthesize doubleClickAnimationRouteArr=_doubleClickAnimationRouteArr;
...
- (void)startDoubleClickLiveLikeAnimationAtPosition:(struct CGPoint)arg1 inSuperView:(id)arg2;
