...
@class MMWebImageView, NSString, PAGFile, PAGView, UILabel, UIView, WCFinderVideoProducerTemplateCellViewModel, WCProgressMaskView;

@interface WCFinderVideoProducerTemplateIconView : UICollectionViewCell
{
    PAGFile *_pagFile;
    _Bool _isTemplateCellSelected;
    WCFinderVideoProducerTemplateCellViewModel *_templateCellViewModel;
...
@property(retain, nonatomic) WCFinderVideoProducerTemplateCellViewModel *templateCellViewModel; // @synthesize templateCellViewModel=_templateCellViewModel;
