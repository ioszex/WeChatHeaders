...
@interface WAAppOpenSheetModeParameter
{
    ...
    _Bool _m_bDraggingBarColorFollowNavBarBackgroundColor;
...
@property(nonatomic) _Bool m_bDraggingBarColorFollowNavBarBackgroundColor; // @synthesize m_bDraggingBarColorFollowNavBarBackgroundColor=_m_bDraggingBarColorFollowNavBarBackgroundColor;
