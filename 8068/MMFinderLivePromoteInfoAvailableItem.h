...
@interface MMFinderLivePromoteInfoAvailableItem : NSObject
{
    ...
    FinderJumpInfo *_componentJumpInfo;
...
@property(retain, nonatomic) FinderJumpInfo *componentJumpInfo; // @synthesize componentJumpInfo=_componentJumpInfo;
