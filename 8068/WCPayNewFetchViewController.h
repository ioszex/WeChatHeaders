...
@class MISSING_TYPE, MMUIButton, MMUILabel, MMUIView, NSDictionary, NSString, RichTextView, UIButton, UIImageView, UITextField, UIView, WCPayBalanceTipsLogic, WCPayBindCardInfo, WCPayDecimalKeyboardView, WCPayFetchBalanceReport, WCPayLQTipsModal, WCPayNoticeItemView, WCPayWebImageView;
