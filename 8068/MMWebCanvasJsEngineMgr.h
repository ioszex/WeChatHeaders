...
@class MMUIViewController, MMWebCanvasLogicJsEngine, MMWebCanvasPkgInfo, MMWebCanvasRenderJsEngine, MemoryMappedKV, NSMutableDictionary, NSString;
...
@interface MMWebCanvasJsEngineMgr
{
    ...
    MemoryMappedKV *_layoutDataSlotKv;
}
...
@property(retain, nonatomic) MemoryMappedKV *layoutDataSlotKv; // @synthesize layoutDataSlotKv=_layoutDataSlotKv;
