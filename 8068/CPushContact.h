...
@interface CPushContact
{
    ...
    NSString *_m_nsInitialDes;
}

+ (id)thread_GetContactDetailFromMsg:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool m_bHadMMContactDelete; // @synthesize m_bHadMMContactDelete=_m_bHadMMContactDelete;
@property(retain, nonatomic) NSString *m_nsInitialDes; // @synthesize m_nsInitialDes=_m_nsInitialDes;
