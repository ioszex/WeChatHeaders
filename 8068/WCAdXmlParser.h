...
+ (long long)extractNumberFromBrackets:(id)arg1;
...
+ (int)fetchBasicFontSizeWithInfo:(id)arg1;
+ (int)fetchBasicWidthWithInfo:(id)arg1;
...
+ (_Bool)setAdBannerInfoWithAdInfo:(id)arg1 byXmlNode:(struct XmlReaderNode_t *)arg2;
