...
@class NSString, TingShareCategoryItem, TingShareChatRoomItem, TingShareListenItem, TingShareLyricsItem, WCActionAreaVM, WCFinderLiveShareItem, WCFinderShareToMomentsItem, WCMegaVideoShareItem, WCMicroMerchantFeedsGroup;
...
@interface WCTimeLineCellShowItem : NSObject
{
    ...
    _Bool _isSpringStyle;
    _Bool _isDisplaySpringSource;
    _Bool _isShowEcsView;
    _Bool _isShowAppNameView;
    double _cacheTime;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isShowAppNameView; // @synthesize isShowAppNameView=_isShowAppNameView;
@property(nonatomic) _Bool isShowEcsView; // @synthesize isShowEcsView=_isShowEcsView;
...
@property(nonatomic) _Bool isDisplaySpringSource; // @synthesize isDisplaySpringSource=_isDisplaySpringSource;
@property(nonatomic) _Bool isSpringStyle; // @synthesize isSpringStyle=_isSpringStyle;
...
- (_Bool)canShowAppNameWithDataItem:(id)arg1;
