...
- (void)renderGLImpListForRemoteRole:(id)arg1 composeOutputSize:(struct CGSize)arg2 composeRes:(id)arg3 effectOutputSize:(struct CGSize)arg4 effectRes:(id)arg5 isBeginRenderEffect:(_Bool)arg6;
- (void)renderImpList:(id)arg1 composeOutputSize:(struct CGSize)arg2 composeRes:(id)arg3 effectOutputSize:(struct CGSize)arg4 effectRes:(id)arg5 isBeginRenderEffect:(_Bool)arg6;
- (void)renderFrames:(id)arg1 composeOutputSize:(struct CGSize)arg2 composeRes:(id)arg3 effectOutputSize:(struct CGSize)arg4 effectRes:(id)arg5 isBeginRenderEffect:(_Bool)arg6;
