...
@interface WABGAudioMinimizationMgr
{
    ...
    NSString *_interruptedIdByShiftIntoList;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *interruptedIdByShiftIntoList; // @synthesize interruptedIdByShiftIntoList=_interruptedIdByShiftIntoList;
...
- (id)getWCPlayerViewFromInfo:(id)arg1;
