...
@class MMUIButton, MagicSclFrameSetView, NSString, UIView, _TtC25MagicCardStarterProtocols22MagicCardStarterHandle, _TtC25MagicCardStarterProtocols28MagicCardStarterSclBizConfig, _TtC6WeChat18MagicSclCustomView, _TtC6WeChat22MagicCardStarterSclBiz;
...
@interface MagicCardNativeStarterDemoViewControlller
{
    ...
    _TtC25MagicCardStarterProtocols28MagicCardStarterSclBizConfig *_bizConfig;
    struct CGRect _halfScreen;
    struct CGRect _fullScreen;
}

- (void).cxx_destruct;
@property(retain, nonatomic) _TtC25MagicCardStarterProtocols28MagicCardStarterSclBizConfig *bizConfig; // @synthesize bizConfig=_bizConfig;
