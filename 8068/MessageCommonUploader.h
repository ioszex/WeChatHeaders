...
@interface MessageCommonUploader : NSObject
{
    ...
    NSString *_liveImgFileId;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *liveImgFileId; // @synthesize liveImgFileId=_liveImgFileId;
...
@property(readonly, nonatomic) NSString *liveVideoMd5; // @synthesize liveVideoMd5=_liveVideoMd5;
@property(readonly, nonatomic) NSString *imageMd5; // @synthesize imageMd5=_imageMd5;
