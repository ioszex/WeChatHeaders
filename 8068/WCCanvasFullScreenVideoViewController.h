...
@class MISSING_TYPE, NSString, UIButton, UIView, WCAdInteractionView, WCAdvertiseInfo, WCCanvasAdControlView, WCCanvasComponentItem, WCPlayerView, WCStatTimerHelper;
