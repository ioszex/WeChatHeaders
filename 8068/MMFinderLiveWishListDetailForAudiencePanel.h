...
@class FinderLiveGiftWallInfo, InteractionWishConfig, MMFinderLiveInteractionWishOperationView, MMFinderLiveSharePubbleTipView, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveHalfScreenTitleBarView, MMUIButton, MMUILabel, NSArray, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIScrollView, UIView;
