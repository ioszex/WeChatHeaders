...
@class ColorGradientView, MMDragManager, MainFrameCellData, MainFrameItemView, NSString, UIDragInteraction, UIImage, UIImageView, UIView;
...
@interface NewMainFrameCell
{
    ...
    ColorGradientView *_rightMaskView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) ColorGradientView *rightMaskView; // @synthesize rightMaskView=_rightMaskView;
