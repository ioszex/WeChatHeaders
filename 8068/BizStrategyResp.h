...
@class AdvertisementExtInfo, AppMsgCoverPreloadInfo, AudioFeedsInfo, BaseResponse, BizFinderLiveControlInfo, BizMsgReSortConfig, BizMsgResortV2ControlInfo, BizPersonalCenterCellList, BizReportConfig, BizStrategyControlInfo, BizWxaPersonalCenter, BoxSearchSettingInfo, ContactListConfig, FinderLiveAutoplayConfig, MenuEntryListInfo, OftenReadBarFeedsInfo, PaySubscribeInfo, PicScrollConfig, ProfilePreloadInfo, PublisherNewMsgInfo, RecommendFeedsInfo, RedPacketCoverConfig, TimelineFinderInfo, TimelineSettingInfo, TimelineTitlePosConfig, ValidExposeConfig, VideoChannelControlInfo;
