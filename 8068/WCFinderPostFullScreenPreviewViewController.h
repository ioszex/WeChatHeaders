...
- (void)viewDidLoad;
- (id)initWithDismissBlock:(CDUnknownBlockType)arg1 toolbarDisableConfig:(unsigned long long)arg2 isAuthorPerspective:(_Bool)arg3 postPageUIOptimize:(_Bool)arg4;
