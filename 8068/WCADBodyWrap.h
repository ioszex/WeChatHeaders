...
@class AdExposureTimerHelper, NSString, WCADSphereReportInfo, WCADVideoPlayInfo, WCAdBreakFrameReportInfo, WCAdClickQualityRelatedInfo, WCAdCommonInteractionReportInfo, WCAdContinuousLikeReportInfo, WCAdExpParamsReportInfo, WCAdFinderLiveStreamReportInfo, WCAdFinderTopicReportInfo, WCAdFireworkCheerReportInfo, WCAdFlipCardReportInfo, WCAdFullCardDragImageReportInfo, WCAdFullCardLongPressReportInfo, WCAdLookbookCardReportInfo, WCAdRandomSelectCardReportInfo, WCAdSliderCardReportInfo;
...
@interface WCADBodyWrap : NSObject
{
    ...
    WCAdFlipCardReportInfo *_flipCardReportInfo;
    WCAdRandomSelectCardReportInfo *_randomSelectCardReportInfo;
    ...
    WCAdClickQualityRelatedInfo *_clickQualityInfo;
    unsigned long long _asyncAvatarInfoStatus;
...
@property(nonatomic) unsigned long long asyncAvatarInfoStatus; // @synthesize asyncAvatarInfoStatus=_asyncAvatarInfoStatus;
@property(retain, nonatomic) WCAdClickQualityRelatedInfo *clickQualityInfo; // @synthesize clickQualityInfo=_clickQualityInfo;
...
@property(retain, nonatomic) WCAdRandomSelectCardReportInfo *randomSelectCardReportInfo; // @synthesize randomSelectCardReportInfo=_randomSelectCardReportInfo;
@property(retain, nonatomic) WCAdFlipCardReportInfo *flipCardReportInfo; // @synthesize flipCardReportInfo=_flipCardReportInfo;
