...
+ (void)reportScanGoodsSvrIdentify:(long long)arg1 resultId:(unsigned int)arg2 entranceStartMs:(unsigned long long)arg3 tabSessionID:(unsigned int)arg4 enterSessionID:(unsigned int)arg5 scanEntrance:(unsigned int)arg6 goodsType:(unsigned int)arg7;
+ (void)reportScanGoodsKVIdentify:(long long)arg1 resultId:(unsigned int)arg2 entranceStartMs:(unsigned long long)arg3 tabSessionID:(unsigned int)arg4 enterSessionID:(unsigned int)arg5 scanEntrance:(unsigned int)arg6 goodsType:(unsigned int)arg7;
+ (void)reportScanCodeKVIdentify:(long long)arg1 picFrom:(long long)arg2 resultId:(unsigned int)arg3 entranceStartMs:(unsigned long long)arg4 tabSessionID:(unsigned int)arg5 enterSessionID:(unsigned int)arg6 scanEntrance:(unsigned int)arg7;
+ (void)reportScanPageScanTabPageOut:(long long)arg1 entranceStartMs:(unsigned long long)arg2 tabSessionID:(unsigned int)arg3 enterSessionID:(unsigned int)arg4 scanEntrance:(unsigned int)arg5;
+ (void)reportScanGoodsBubbleViewClick:(long long)arg1 resultId:(unsigned int)arg2 entranceStartMs:(unsigned long long)arg3 tabSessionID:(unsigned int)arg4 enterSessionID:(unsigned int)arg5 scanEntrance:(unsigned int)arg6 goodsType:(unsigned int)arg7 retCode:(unsigned int)arg8;
+ (void)reportScanCodeJumpDotViewClick:(long long)arg1 codeSubType:(unsigned int)arg2 picFrom:(long long)arg3 resultId:(unsigned int)arg4 entranceStartMs:(unsigned long long)arg5 tabSessionID:(unsigned int)arg6 enterSessionID:(unsigned int)arg7 scanEntrance:(unsigned int)arg8;
