...
@class NSArray, NSString, UIViewController, WKContextMenuElementInfo, WKFrameInfo, WKNavigationAction, WKOpenPanelParameters, WKPreviewElementInfo, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures;
