...
@class MISSING_TYPE, MyWCDB, NSArray, NSCache, NSDate, NSMutableArray, NSMutableDictionary, NSString, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCMicroMerchantFeedsMgr, WCMicroMerchantFoldMgr, WCTimelineDataProvider;
...
@interface WCTimelineMgr
{
    ...
    MISSING_TYPE *_timelineDataList;
