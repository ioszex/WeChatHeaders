...
@interface MJMovieComposingAsyncExportInfo : NSObject
{
    ...
    unsigned long long _clipBundleSize;
    double _clipBundleGenerationTime;
    struct CGSize _renderPointSize;
    CDStruct_e83c9415 _timeRange;
}

- (void).cxx_destruct;
@property(nonatomic) double clipBundleGenerationTime; // @synthesize clipBundleGenerationTime=_clipBundleGenerationTime;
@property(nonatomic) unsigned long long clipBundleSize; // @synthesize clipBundleSize=_clipBundleSize;
@property(retain, nonatomic) OMJMovieExportSettings *exportSettings; // @synthesize exportSettings=_exportSettings;
@property(nonatomic) struct CGSize renderPointSize; // @synthesize renderPointSize=_renderPointSize;
...
- (id)initWithClipBundleID:(id)arg1 asyncTaskID:(id)arg2 sessionID:(id)arg3 outputFilePath:(id)arg4 exportSettings:(id)arg5 timeRange:(CDStruct_e83c9415)arg6 exportVideoDuration:(double)arg7 renderPointSize:(struct CGSize)arg8;
