...
@class CAGradientLayer, MISSING_TYPE, MJMaterialLoadingStatusCoordinator, MJShootMakeupInspectorViewModel, MMUIButton, MMUILabel, NSString, UICollectionView;
...
@interface MJShootMakeupInspector
{
    ...
    MISSING_TYPE *_panelBackgroundGradientLayer;
