...
@class MJMovieTextEditViewModel, MJMovieTextSuggestionView, MJPageView, MJPublisherInspectorContainerView, MMGrowTextView, MMTextView, MMUIButton, NSString, UIView;
...
@interface MJMovieTextEditInspector : UIViewController
{
    ...
    MMTextView *_showingTextView;
    MMTextView *_showingSubTextView;
    MMUIButton *_doneBtn;
...
@property(retain, nonatomic) MMTextView *showingSubTextView; // @synthesize showingSubTextView=_showingSubTextView;
@property(retain, nonatomic) MMTextView *showingTextView; // @synthesize showingTextView=_showingTextView;
