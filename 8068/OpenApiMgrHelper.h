...
+ (id)cutWebSendAppMsgThumbData:(id)arg1 minSideLen:(int)arg2 minDataLen:(int)arg3 imageConf:(id)arg4;
+ (id)checkWebSendAppMsgThumbData:(id)arg1 minSideLen:(int)arg2 minDataLen:(int)arg3;
