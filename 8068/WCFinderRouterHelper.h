...
+ (_Bool)pushPersonalSubPageFromRedDotBubble:(id)arg1 nav:(id)arg2;
...
+ (void)openFinderCommentHeatUpGuide:(id)arg1 fromVC:(id)arg2;
+ (void)openFinderMemberMsgCenterFromScene:(long long)arg1 contact:(id)arg2 fromVC:(id)arg3;
+ (void)openFinderPrivateMsgFromScene:(long long)arg1 contact:(id)arg2 fromNavVC:(id)arg3;
+ (void)openFinderMsgCenterFromScene:(long long)arg1 selectTabType:(id)arg2 contact:(id)arg3 nav:(id)arg4;
+ (void)openWxPrivateCenterFromScene:(long long)arg1 fromNavVC:(id)arg2;
+ (void)openWxMsgNotifyCenterFromScene:(long long)arg1 fromNavVC:(id)arg2 selectTab:(long long)arg3;
...
+ (void)pushToLiteAppByAppId:(id)arg1 pageRoute:(id)arg2 query:(id)arg3 currentNavController:(id)arg4 hookLiteVCBlock:(CDUnknownBlockType)arg5 animated:(_Bool)arg6;
+ (void)presentToLiteAppByAppId:(id)arg1 pageRoute:(id)arg2 query:(id)arg3 minVersion:(id)arg4 fromVC:(id)arg5 animated:(_Bool)arg6;
...
+ (void)pushToFinderTimelineFromSearch:(_Bool)arg1 currController:(id)arg2;
...
+ (void)openMiniAppWithGoodsItem:(id)arg1 productShareItem:(id)arg2 withEnterLivingWidget:(_Bool)arg3 isCurrentInLivingPromise:(id)arg4 currentGMsgID:(id)arg5 chatType:(unsigned long long)arg6 sceneNote:(id)arg7 scene:(unsigned long long)arg8 productPathCookie:(id)arg9 livingFinderUsername:(id)arg10 shareHandler:(CDUnknownBlockType)arg11 currentNavController:(id)arg12;
+ (void)openCollectionHalfVCWithViewModel:(id)arg1 viewController:(id)arg2 collectionDelegate:(id)arg3;
+ (void)openShareListCollectionInlinePanel:(id)arg1 viewController:(id)arg2;
...
+ (void)_showFinderTLActionWithTimelineVC:(id)arg1 currentNavController:(id)arg2 openTLParams:(id)arg3 animated:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
+ (void)pushToFinderPOILink:(id)arg1 poiClassifyId:(id)arg2 userName:(id)arg3 currentNavController:(id)arg4 entryScene:(int)arg5 poiSrcType:(unsigned int)arg6 reportID:(id)arg7;
...
+ (void)pushMentionProfileWithNickname:(id)arg1 dataItem:(id)arg2 currentViewController:(id)arg3 reportScene:(int)arg4 sucBlock:(CDUnknownBlockType)arg5;
...
+ (id)showLongVideoWithId:(id)arg1 videoNonceId:(id)arg2 encryptedVideoId:(id)arg3 viewScene:(unsigned long long)arg4 entryScene:(int)arg5;
...
+ (id)showLongVideoWithId:(id)arg1 videoNonceId:(id)arg2 encryptedVideoId:(id)arg3 authorName:(id)arg4 fromUserName:(id)arg5 toUserName:(id)arg6 scene:(unsigned long long)arg7 viewScene:(unsigned long long)arg8 entryScene:(int)arg9;
...
+ (void)_openJsApiSearchProfileFeedList:(id)arg1 username:(id)arg2 isAuthor:(_Bool)arg3 behavior:(id)arg4 reportModel:(id)arg5 jsapiPlugin:(id)arg6 reportExtraInfo:(id)arg7 navVC:(id)arg8;
...
+ (id)showBulletCommentViewControllerFromVC:(id)arg1 shouldShowSwitchButton:(_Bool)arg2 replyItem:(id)arg3 contentVM:(id)arg4;
...
+ (int)convertShareSceneToEntryScene:(unsigned long long)arg1;
+ (void)updateContextIdFrom:(unsigned long long)arg1 to:(id)arg2 cardType:(int)arg3;
...
+ (void)pushFinderShareDetailViewControllerWithEncrytedObjectidTid:(id)arg1 nonceID:(id)arg2 currentNavController:(id)arg3 enterScene:(unsigned long long)arg4 cardType:(int)arg5 requestScene:(unsigned long long)arg6 customParam:(id)arg7 functionalParams:(id)arg8 reportModel:(id)arg9 reportExtraInfo:(id)arg10;
...
+ (void)pushFinderFeedDetailViewControllerWithEncryptedTid:(id)arg1 nonceID:(id)arg2 currentNav:(id)arg3 enterScene:(unsigned long long)arg4 cardType:(int)arg5 requestScene:(unsigned long long)arg6 customParam:(id)arg7 functionalParams:(id)arg8 reportModel:(id)arg9 reportExtraInfo:(id)arg10;
+ (void)_checkAndPushFinderLandScapeViewControllerWithEncrytedObjectidTid:(id)arg1 nonceID:(id)arg2 currentNavController:(id)arg3 enterScene:(unsigned long long)arg4 cardType:(int)arg5 requestScene:(unsigned long long)arg6 customParam:(id)arg7 functionalParams:(id)arg8 reportModel:(id)arg9 reportExtraInfo:(id)arg10;
+ (id)createShareListViewControllerWithFeedID:(id)arg1 nonceID:(id)arg2 enterScene:(unsigned long long)arg3 customParam:(id)arg4 functionalParams:(id)arg5 reportModel:(id)arg6 cardType:(int)arg7;
+ (void)pushFinderShareDetailViewControllerWithFeedID:(id)arg1 nonceID:(id)arg2 currentNavController:(id)arg3 enterScene:(unsigned long long)arg4 customParam:(id)arg5 functionalParams:(id)arg6 reportModel:(id)arg7 cardType:(int)arg8;
...
+ (_Bool)pushFinderShareSnsAdDetailViewControllerWithFeedID:(id)arg1 nonceID:(id)arg2 encryptedTid:(id)arg3 userName:(id)arg4 currentNavController:(id)arg5 enterScene:(unsigned long long)arg6 customParam:(id)arg7 reportModel:(id)arg8 cardType:(int)arg9 adParamInofStr:(id)arg10;
...
+ (void)presentPostFullScreenPreviewVCWithPostSession:(id)arg1 fromVC:(id)arg2 toolbarDisableConfig:(unsigned long long)arg3 isAuthorPerspective:(_Bool)arg4 commentScene:(int)arg5 postPageUIOptimize:(_Bool)arg6;
...
+ (void)feedbackWithContentVM:(id)arg1 commentScene:(int)arg2 fromVC:(id)arg3 customDict:(id)arg4;
...
+ (id)profilePageWithUserName:(id)arg1 params:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4;
...
+ (void)pushProfileReport:(id)arg1 feedID:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4;
+ (void)presentProfileViewControllerWithUsername:(id)arg1 currentViewController:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4 params:(id)arg5 transition:(id)arg6 completion:(CDUnknownBlockType)arg7;
+ (void)pushProfileWithFeedID:(id)arg1 nonceID:(id)arg2 username:(id)arg3 currentViewController:(id)arg4 reportScene:(int)arg5 enterType:(int)arg6 params:(id)arg7;
...
+ (_Bool)_profileAccessLimitedWithUserName:(id)arg1 reportScene:(int)arg2 enterScene:(int)arg3 enterType:(int)arg4 limitedViewController:(id *)arg5;
+ (_Bool)_hasSameFinderContact:(id)arg1 fromNav:(id)arg2 params:(id)arg3;
+ (void)pushProfileUserName:(id)arg1 currentNavController:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4 params:(id)arg5;
+ (void)pushFinderProfileWithContact:(id)arg1 params:(id)arg2 fromVC:(id)arg3;
+ (id)getWXOfficialAccountsProfileViewController:(id)arg1 withViewController:(id)arg2 Scence:(unsigned int)arg3;
...
+ (void)pushAuthorProfileWithContact:(id)arg1 currentNavController:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4 params:(id)arg5 completion:(CDUnknownBlockType)arg6;
+ (void)pushAuthorProfileWithContact:(id)arg1 currentNavController:(id)arg2 reportScene:(int)arg3 enterType:(int)arg4 params:(id)arg5;
...
+ (void)pushMyTabFinderEntrance:(id)arg1 hasBrand:(_Bool)arg2;
