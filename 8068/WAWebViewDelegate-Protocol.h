...
@class NSArray, NSDictionary, NSMutableArray, NSObject, NSString, UIPanGestureRecognizer, UIScrollView, UIViewController, WAAppTaskExtInfo, WAGameExtraInfo, WAJSEventHandler_BaseEvent, WAPermissionResult, WATransferJSAPIRuntimeModel, WAWebViewController;
