...
@interface EmoticonViewWithPreview
{
    ...
    MMEmoticonView *m_emoticonShowPlayView;
...
@property(nonatomic) _Bool m_isNeedPlay; // @synthesize m_isNeedPlay=_m_isNeedPlay;
...
@property(retain, nonatomic) MMEmoticonView *m_emoticonShowPlayView; // @synthesize m_emoticonShowPlayView;
