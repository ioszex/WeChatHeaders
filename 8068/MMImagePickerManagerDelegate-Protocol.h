...
- (void)MMImagePickerManagerDidCancelWithInfo:(UINavigationController *)arg1 selectedAssets:(NSArray *)arg2 finderData:(WCFinderDataItem *)arg3;
- (void)MMImagePickerManagerDidUnselected:(UINavigationController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerManagerDidSendAssets:(UINavigationController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerManagerDidWarning:(UINavigationController *)arg1 warning:(NSString *)arg2 fromFinder:(_Bool)arg3;
- (void)MMImagePickerManagerDidCancelEditVideo:(UINavigationController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerManagerDidCancelEditImages:(UINavigationController *)arg1 infos:(NSArray *)arg2;
