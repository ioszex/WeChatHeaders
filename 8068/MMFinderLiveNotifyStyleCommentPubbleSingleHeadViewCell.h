...
@class CAGradientLayer, CALayer, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveMemberSignView, MMFinderLiveNormalTextSignView, MMUIImageView, MMUILabel, MMUIView, NSArray, NSMutableArray, NSString, UIImageView, UIView;
