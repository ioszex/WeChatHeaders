...
@class EcsFinderFeedSingleProductViewModel, FinderBarItem, FinderFeedRealtimeSyncCtrl, FinderNpsSurveyInfo, ForwardMessageLogicController, MMFinderLiveCastViewModel, NSData, NSNumber, NSString, SessionForwardRecordLogic, SharePreConfirmSheetView, WCFinderContentCarouselViewModel, WCFinderDataItem, WCFinderFeedContentReportModel, WCFinderFeedContentTempModel, WCFinderFeedFriendRecommendCommentModel, WCFinderFeedLayoutContentVM, WCFinderFeedLikeDisplayViewModel, WCFinderFeedLikeMilestoneViewModel, WCFinderFeedVideoCellViewModel, WCFinderLiveFeedVM, WCFinderLiveNoticeCellViewModel, WCFinderObjectHotTopic, WCFinderProfilePreloadInfo, WCFinderProgressBarStatusInfo;
...
@interface WCFinderFeedContentVM : NSObject
{
    ...
    FinderFeedRealtimeSyncCtrl *_nextTimeSyncCtrlInfo;
...
@property(retain, nonatomic) FinderFeedRealtimeSyncCtrl *nextTimeSyncCtrlInfo; // @synthesize nextTimeSyncCtrlInfo=_nextTimeSyncCtrlInfo;
...
- (_Bool)shouldShowRecommendReasonForColumn;
