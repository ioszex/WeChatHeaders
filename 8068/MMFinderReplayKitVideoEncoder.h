...
- (void)stop;
- (void)sendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 pts:(CDStruct_1b6d18a9)arg2 needsIFrame:(_Bool)arg3 isLandscape:(_Bool)arg4 orientation:(long long)arg5 rcLimit:(long long)arg6;
