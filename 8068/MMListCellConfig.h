...
@class MMListCellSeparatorConfig, MMListDataRepoetConfig, NSString, UIImage;
...
@interface MMListCellConfig : NSObject
{
    ...
    NSString *_pathKey;
    MMListCellSeparatorConfig *_separatorConfig;
    MMListDataRepoetConfig *_reportConfig;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MMListDataRepoetConfig *reportConfig; // @synthesize reportConfig=_reportConfig;
@property(retain, nonatomic) MMListCellSeparatorConfig *separatorConfig; // @synthesize separatorConfig=_separatorConfig;
