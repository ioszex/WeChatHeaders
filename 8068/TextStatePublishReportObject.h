...
@interface TextStatePublishReportObject : NSObject
{
    ...
    NSString *_customRecommendIconListReportString;
...
@property(retain, nonatomic) NSString *customRecommendIconListReportString; // @synthesize customRecommendIconListReportString=_customRecommendIconListReportString;
...
- (void)setCustomRecommendIconList:(id)arg1;
...
- (void)tapTopicButton;
- (void)selectIcon:(id)arg1 iconSelectFrom:(long long)arg2;
