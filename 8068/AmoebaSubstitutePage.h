...
- (void).cxx_destruct;
@property(retain, nonatomic) NSString *origEnterMethod; // @synthesize origEnterMethod=_origEnterMethod;
@property(retain, nonatomic) NSString *currEnterMethod; // @synthesize currEnterMethod=_currEnterMethod;
