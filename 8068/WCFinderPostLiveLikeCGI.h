...
@interface WCFinderPostLiveLikeCGI
{
    ...
    unsigned long long _accumulateLikeCount;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long accumulateLikeCount; // @synthesize accumulateLikeCount=_accumulateLikeCount;
...
- (void)createRequest;
- (id)initWithFeedStreamFriendLike:(id)arg1 isLike:(_Bool)arg2 sessionBuffer:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failBlock:(CDUnknownBlockType)arg5;
...
- (id)initWithFinderTaskId:(id)arg1 likeCount:(unsigned long long)arg2 liveCookies:(id)arg3 likeScene:(long long)arg4 opType:(long long)arg5 likeSource:(long long)arg6 accumulateLikeCount:(unsigned long long)arg7 successBlock:(CDUnknownBlockType)arg8 failBlock:(CDUnknownBlockType)arg9;
