...
@interface MMLiveBeautyOperationPanel : UIView
{
    ...
    UIView *_tabScrollBaseView;
    NSArray *_tabViews;
    UIView *_tabIndicatorView;
    unsigned long long _currentTabIndex;
    MMUIMaskContainerView *_collectionContainerView;
    unsigned long long _gradientStatus;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long gradientStatus; // @synthesize gradientStatus=_gradientStatus;
...
@property(retain, nonatomic) UIView *tabScrollBaseView; // @synthesize tabScrollBaseView=_tabScrollBaseView;
