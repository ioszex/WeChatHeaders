...
@class AVAudioPlayer, FlutterPAGInfo, FlutterPAGValueAnimator, NSNumber, NSString, PAGFile, PAGPlayer, PAGSurface, PAGViewListenerApi;
...
@property(nonatomic) long long audioStartTime; // @synthesize audioStartTime=_audioStartTime;
@property(nonatomic) _Bool audioFileAvail; // @synthesize audioFileAvail=_audioFileAvail;
...
- (_Bool)replaceTextIndex:(long long)arg1 text:(id)arg2;
- (_Bool)replaceImageIndex:(long long)arg1 path:(id)arg2;
