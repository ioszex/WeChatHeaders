...
- (void)MMImagePickerControllerDidCancelWithInfo:(UINavigationController *)arg1 selectedAssets:(NSArray *)arg2 finderData:(WCFinderDataItem *)arg3;
- (void)MMImagePickerManagerDidUnselected:(MMImagePickerController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerManagerDidSendAssets:(MMImagePickerController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerManagerDidWarning:(UINavigationController *)arg1 warning:(NSString *)arg2 fromFinder:(_Bool)arg3;
- (void)MMImagePickerControllerDidCancelEditVideo:(UINavigationController *)arg1 infos:(NSArray *)arg2;
- (void)MMImagePickerControllerDidCancelEditImages:(UINavigationController *)arg1 infos:(NSArray *)arg2;
