...
@class FinderNewUserPrepareResponse, NSMutableArray, NSString, NSURL, WCFinderContact, WCFinderContactPreviewData, WCFinderDataItem, WCFinderPersonalCenterOftenReadViewModel;
...
@interface WCFinderPersonalCenterViewModel : NSObject
{
    ...
    WCFinderPersonalCenterOftenReadViewModel *_oftenReadData;
...
@property(retain, nonatomic) WCFinderPersonalCenterOftenReadViewModel *oftenReadData; // @synthesize oftenReadData=_oftenReadData;
@property(nonatomic) int prepareScene; // @synthesize prepareScene=_prepareScene;
...
- (void)refetchUserPrepare:(CDUnknownBlockType)arg1;
