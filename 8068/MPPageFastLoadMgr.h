...
@class JSVirtualMachine, MMWebOptimVideoCacheTask, MPPageFastLoadCacheCleaner, MPPageFastLoadEventMgr, MPPageResourceDownloader, MPPageTemplateInfoContainer, MemoryMappedKV, NSCache, NSMutableArray, NSMutableDictionary, NSObject, NSOperationQueue, NSString, NSURLSession;
...
@interface MPPageFastLoadMgr
{
    ...
    MPPageFastLoadCacheCleaner *_cacheCleaner;
...
+ (id)overrideSceneIfNeedForURL:(id)arg1 scene:(unsigned int)arg2;
...
@property(retain, nonatomic) NSCache *imageMemoryCache; // @synthesize imageMemoryCache=_imageMemoryCache;
...
@property(retain, nonatomic) MPPageFastLoadCacheCleaner *cacheCleaner; // @synthesize cacheCleaner=_cacheCleaner;
...
- (_Bool)shouldPreloadImageForRequestInfo:(id)arg1;
...
- (void)advanceDirectUpdatePageDataWithUrl:(id)arg1 templateType:(unsigned int)arg2 scene:(unsigned int)arg3 enterType:(unsigned int)arg4 useOfflineCache:(_Bool)arg5 sourceUserName:(id)arg6;
...
- (void)handleResultForTask:(id)arg1 location:(id)arg2 error:(id)arg3 serverContentType:(id)arg4 startTime:(double)arg5;
- (void)runTask:(id)arg1;
- (void)runPendingTasksIfNeed;
- (void)addTaskIfNeed:(id)arg1;
- (id)popTaskFromPendingStack;
- (void)pushTaskToPendingStack:(id)arg1;
- (id)getExternalCoverImageDataFromMemoryForPageUrl:(id)arg1;
- (id)getExternalCoverImageDataForPageUrl:(id)arg1;
- (void)updateMemoryCacheForExternalCoverImageData:(id)arg1 forPageUrl:(id)arg2;
- (void)updateExternalCoverImageData:(id)arg1 forPageUrl:(id)arg2;
- (void)saveExternalCoverImageData:(id)arg1 forPageUrl:(id)arg2;
- (void)updateMemoryCacheForImageData:(id)arg1 forPageUrl:(id)arg2 andImageUrl:(id)arg3;
- (void)savePreloadImageData:(id)arg1 forPageUrl:(id)arg2 andImageUrl:(id)arg3;
- (_Bool)isImageDataValidForPageUrl:(id)arg1 andImageUrl:(id)arg2;
- (id)getPreloadImageDataFromMemoryForPageUrl:(id)arg1 andImageUrl:(id)arg2;
- (id)getPreloadImageDataForPageUrl:(id)arg1 andImageUrl:(id)arg2;
- (void)preloadImageUrls:(id)arg1 forPageIdentifity:(id)arg2 scene:(unsigned long long)arg3;
