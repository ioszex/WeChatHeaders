...
@class MMBadgeView, MMCPLabel, MMGroupView, MMHeadImageView, MainFrameCellData, MainFrameItemRedTipsLabel, NSString, TextStateItemView, UIImageView, UILabel, VoicePlayingView;
...
@interface MainFrameItemView : UIView
{
    ...
    UILabel *m_timeLabel;
    MainFrameItemRedTipsLabel *m_greenLabel;
    UIImageView *m_statusView;
    MMCPLabel *m_messageLabel;
    MMCPLabel *m_msgPostfixLabel;
...
@property(retain, nonatomic) MMCPLabel *m_msgPostfixLabel; // @synthesize m_msgPostfixLabel;
...
@property(retain, nonatomic) MainFrameItemRedTipsLabel *m_greenLabel; // @synthesize m_greenLabel;
@property(retain, nonatomic) MMCPLabel *m_nameLabel; // @synthesize m_nameLabel;
@property(retain, nonatomic) MMBadgeView *m_unreadCountView; // @synthesize m_unreadCountView;
@property(retain, nonatomic) MMHeadImageView *m_frameHeadView; // @synthesize m_frameHeadView;
- (void)onUpdateSessionRedTips:(id)arg1;
