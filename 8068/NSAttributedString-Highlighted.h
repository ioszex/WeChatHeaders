...
+ (id)attributedStringWithOriginalText:(id)arg1 highlightText:(id)arg2 originalColor:(id)arg3 highlightColor:(id)arg4 font:(id)arg5;
...
- (unsigned long long)prefixIndexForStr:(id)arg1 WithAttr:(id)arg2 inWidth:(double)arg3;
- (struct CGSize)stringSize:(id)arg1 WithAttr:(id)arg2;
- (struct CGSize)stringSizeWithFont:(id)arg1 constrainedToSize:(struct CGSize)arg2 lineSpacing:(double)arg3;
