...
@class FinderLiveAliasInfo, FinderStreamPrefechTimeIntervalConf, MISSING_TYPE, NSArray, NSDictionary, NSMutableArray, NSString, WCFinderTipsShowEntranceExtInfo, WCFinderUserMentionModel;
...
@interface WCFinderSetting : NSObject
{
    ...
    MISSING_TYPE *_antiAddictPassUpdateTimeStamp;
