...
- (void)createRequest;
- (id)initWithPullType:(unsigned long long)arg1 tabType:(int)arg2 finderCtrlInfo:(id)arg3 prefetchData:(id)arg4 lastBuffer:(id)arg5 successful:(CDUnknownBlockType)arg6 failure:(CDUnknownBlockType)arg7;
