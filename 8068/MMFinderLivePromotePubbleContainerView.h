...
@class FinderLivePromoteMsgInfo, FinderShopCouponInfo, MMFinderLiveAdsItem, MMFinderLiveBulkBuyPromotePubbleContentView, MMFinderLiveGoodsItem, MMFinderLiveProductPromotePubbleContentView, MMFinderLivePromotePubbleContentView, MMFinderLiveTaskId, MMUIButton;
...
- (void)showWithAnimationToBottom:(double)arg1 middleScale:(double)arg2 middleCenterY:(double)arg3 xAnchor:(double)arg4 xAnchorPart1Position:(double)arg5 part1Duration:(double)arg6 part2Duration:(double)arg7 part2Animating:(CDUnknownBlockType)arg8 completion:(CDUnknownBlockType)arg9;
