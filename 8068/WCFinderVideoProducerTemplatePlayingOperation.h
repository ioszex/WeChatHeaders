...
@class MJVideoTemplate, NSMutableArray, OrderedDictionary, WCFinderVideoProducerEditSegmentOperation, WCFinderVideoProducerMusicPlayingOperation, WCFinderVideoProducerMusicSearchingOperation;

@interface WCFinderVideoProducerTemplatePlayingOperation
{
    _Bool _isBGMEnabled;
    _Bool _isOSTEnabled;
    ...
    WCFinderVideoProducerMusicPlayingOperation *_currentMusicPlayingOperation;
    WCFinderVideoProducerMusicSearchingOperation *_currentMusicSearchingOperation;
    WCFinderVideoProducerEditSegmentOperation *_currentEditSegmentOperation;
...
@property(retain, nonatomic) WCFinderVideoProducerEditSegmentOperation *currentEditSegmentOperation; // @synthesize currentEditSegmentOperation=_currentEditSegmentOperation;
@property(retain, nonatomic) WCFinderVideoProducerMusicSearchingOperation *currentMusicSearchingOperation; // @synthesize currentMusicSearchingOperation=_currentMusicSearchingOperation;
@property(retain, nonatomic) WCFinderVideoProducerMusicPlayingOperation *currentMusicPlayingOperation; // @synthesize currentMusicPlayingOperation=_currentMusicPlayingOperation;
