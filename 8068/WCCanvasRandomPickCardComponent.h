...
- (void)onRandomPickCardItemsUpdateStayPutItemWithInfo:(id)arg1;
- (void)onRandomPickCardItemsUpdateVanishingItemInfoWith:(id)arg1;
...
- (void)randomPickSetCardViewsForTransitionBeginning:(_Bool)arg1 isToVC:(_Bool)arg2;
