...
@class FinderEventInfo, FinderTopicBgmInfo, JsApiSourceInfo, NSData, NSMutableArray, NSString, WCFinderEventTabInfo, WCFinderTopicInfo;
...
- (void)onFinderEventLiveUpdateWithTaskId:(id)arg1 finderDataItem:(id)arg2;
...
- (id)filterInfo;
- (id)genContentVMForDataItem:(id)arg1;
