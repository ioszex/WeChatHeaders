...
@interface MMFinderLiveKTVSEIRecvHandler : NSObject
{
    ...
    CDUnknownBlockType _checkNeedKTVInfoCallback;
...
@property(copy) CDUnknownBlockType checkNeedKTVInfoCallback; // @synthesize checkNeedKTVInfoCallback=_checkNeedKTVInfoCallback;
...
- (id)ktvReporter;
- (_Bool)checkNeedProcessKTVInfos:(id)arg1;
