...
@class FinderLiveLotteryAnchorInfo, FinderLiveLotteryAttendMethod, FinderLiveLotteryClaimMethod, FinderLiveLotteryInfo_ParticipantInfo, FinderLiveLotteryParticipability, FinderLiveLotteryPrizeMethod, FinderLiveLotteryWinnerExtInfo, NSString, WCFinderContact;
...
@interface MMFinderLiveLotteryInfo : NSObject
{
    ...
    FinderLiveLotteryAnchorInfo *_anchorInfo;
...
@property(retain, nonatomic) FinderLiveLotteryAnchorInfo *anchorInfo; // @synthesize anchorInfo=_anchorInfo;
