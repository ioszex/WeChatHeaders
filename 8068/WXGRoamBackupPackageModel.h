...
@interface WXGRoamBackupPackageModel : NSObject
{
    ...
    unsigned long long _continueOnErrorCount;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool hasNotifyPC; // @synthesize hasNotifyPC=_hasNotifyPC;
@property(nonatomic) unsigned long long continueOnErrorCount; // @synthesize continueOnErrorCount=_continueOnErrorCount;
...
@property(nonatomic) _Bool isStartedByAutoBackup; // @synthesize isStartedByAutoBackup=_isStartedByAutoBackup;
