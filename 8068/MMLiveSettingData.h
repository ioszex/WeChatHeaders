...
@interface MMLiveSettingData
{
    ...
    _Bool _isLiveAnchorWeakNetOptimizationEnabled;
    _Bool _isLiveAudienceWeakNetOptimizationEnabled;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isLiveAudienceWeakNetOptimizationEnabled; // @synthesize isLiveAudienceWeakNetOptimizationEnabled=_isLiveAudienceWeakNetOptimizationEnabled;
@property(nonatomic) _Bool isLiveAnchorWeakNetOptimizationEnabled; // @synthesize isLiveAnchorWeakNetOptimizationEnabled=_isLiveAnchorWeakNetOptimizationEnabled;
