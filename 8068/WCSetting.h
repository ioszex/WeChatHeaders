...
@class NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, WCDataItem;
...
@interface WCSetting : NSObject
{
    ...
    NSMutableDictionary *wsFoldTimestamp;
    NSMutableSet *isNotFirstTimeUser;
...
@property(retain, nonatomic) NSData *wsSessionBufData; // @synthesize wsSessionBufData=_wsSessionBufData;
...
@property(retain, nonatomic) NSMutableSet *isNotFirstTimeUser; // @synthesize isNotFirstTimeUser;
@property(retain, nonatomic) NSMutableDictionary *wsFoldTimestamp; // @synthesize wsFoldTimestamp;
...
- (_Bool)checkIsNotFirstTimeUsername:(id)arg1;
- (void)updateIsNotFirstTimeUsername:(id)arg1;
- (unsigned long long)getWsFoldTimestamp:(id)arg1;
- (void)addWsFoldTimestamp:(unsigned long long)arg1 Username:(id)arg2;
