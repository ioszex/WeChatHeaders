...
+ (const void *)type;
+ (id)swift_primHashUserName;
+ (const void *)__wcdb_synthesize_1:(void *)arg1;
+ (const void *)primHashUserName;
+ (id)swift_userName;
...
@property(retain, nonatomic) NSString *primHashUserName; // @synthesize primHashUserName=_primHashUserName;
