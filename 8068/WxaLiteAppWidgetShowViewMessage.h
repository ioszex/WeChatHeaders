...
+ (id)fromList:(id)arg1;
+ (id)makeWithAppId:(id)arg1 page:(id)arg2 query:(id)arg3 sessionId:(id)arg4 referrerInfo:(id)arg5 path:(id)arg6 signatureKey:(id)arg7 appUuid:(id)arg8 isTransparent:(id)arg9 sourceType:(id)arg10 enableActions:(id)arg11 enableViews:(id)arg12 openId:(id)arg13;
- (void).cxx_destruct;
