...
@class CADisplayLink, NSIndexPath, NSString, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITableView, UIView;
...
@interface MMTableViewReorder : NSObject
{
    ...
    double _autoScrollSpeedPerSecond;
...
@property(nonatomic) double autoScrollStep; // @synthesize autoScrollStep=_autoScrollStep;
...
@property(nonatomic) double autoScrollSpeedPerSecond; // @synthesize autoScrollSpeedPerSecond=_autoScrollSpeedPerSecond;
