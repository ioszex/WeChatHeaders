...
@class FinderObjectAsyncLoadInfo, FinderObjectHelpPromotionInfo, FinderOriginalDesc, FinderPlayHistoryInfo, NSArray, NSString, OriginalSoundInfo, WCFinderAdEntryItem, WCFinderComment, WCFinderDataItem, WCFinderJumpInfoContainer, WCFinderUploadProgressModel;

@protocol WCFinderDataItemExt <NSObject>

@optional
- (void)onFinderDataItemRealTimeSynced:(WCFinderDataItem *)arg1;
- (void)onFeedBulletSwitchChangedNeedReflush:(NSString *)arg1;
- (void)onFeedExtPersmissionFlagChanged:(NSString *)arg1 flag:(int)arg2;
- (void)onFinderAsyncLoadInfoSuccessful:(NSString *)arg1 scene:(int)arg2 asyncInfo:(FinderObjectAsyncLoadInfo *)arg3;
...
- (void)onFinderDataItemMediaCommentUpdateWithTid:(NSString *)arg1 mediaCommentList:(NSArray *)arg2 totalImageCommentCount:(unsigned long long)arg3 optionFlag:(int)arg4;
- (void)onFinderDataItemHotCommentUpdateWithTid:(NSString *)arg1 hotCommentList:(NSArray *)arg2 optionFlag:(int)arg3;
