...
@class MISSING_TYPE, NSMutableDictionary, NSString, UIViewController, WAAppTansitionController, WAAppTaskCapsuleMenu, WAAppTaskReferrerInfo, WAAppTaskTransitInfo, WAAppTaskWebLaunchInfo, WALoadingViewController, WAPageFlowAppInfo, WAPageFlowSessionInfo, WAUINavigationController;
...
@interface WAAppTaskExtInfo : NSObject
{
    ...
    _Bool _isSilentOpen;
    _Bool _isRemoteMode;
    _Bool _isGameIOSRemoteDebug;
    _Bool _isSkipGameJSWrap;
    _Bool _ignoreDomain;
    _Bool _isUseParalelRequest;
    _Bool _launchAppLoaderReloaded;
    MISSING_TYPE *_relaunchAppLoaderReloaded;
...
@property(nonatomic) _Bool isSkipGameJSWrap; // @synthesize isSkipGameJSWrap=_isSkipGameJSWrap;
@property(nonatomic) _Bool isGameIOSRemoteDebug; // @synthesize isGameIOSRemoteDebug=_isGameIOSRemoteDebug;
