...
@class MMEcsPriceViewConfig, NSString, UILabel;

@interface MMEcsPriceView : UIView
{
    MMEcsPriceViewConfig *_config;
...
@property(retain, nonatomic) MMEcsPriceViewConfig *config; // @synthesize config=_config;
