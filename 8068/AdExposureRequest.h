...
@class AdExposureExtInfo, AdExposureInfo, AdExposureSocialInfo, BaseRequest, NSData, NSString;
...
@property(retain, nonatomic) AdExposureExtInfo *adExtInfo; // @dynamic adExtInfo;
