...
- (void)shareToTimeline:(id)arg1 shareTitle:(id)arg2 shareDesc:(id)arg3 shareThumbUrl:(id)arg4 shareWebUrl:(id)arg5 canvasDynamicExtInfo:(id)arg6;
- (void)shareToFriend:(id)arg1 shareTitle:(id)arg2 shareDesc:(id)arg3 shareThumbUrl:(id)arg4 shareThumbImage:(id)arg5 shareWebUrl:(id)arg6 canvasDynamicExtInfo:(id)arg7;
