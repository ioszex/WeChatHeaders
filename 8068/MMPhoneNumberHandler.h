...
@interface MMPhoneNumberHandler
{
    ...
    _Bool _bIsShowCallPhoneNumber;
    _Bool _bIsShowCopyToast;
...
@property(nonatomic) _Bool bIsShowCopyToast; // @synthesize bIsShowCopyToast=_bIsShowCopyToast;
@property(nonatomic) _Bool bIsShowCallPhoneNumber; // @synthesize bIsShowCallPhoneNumber=_bIsShowCallPhoneNumber;
