...
- (id)_aicgDraftCellTipStringWithLocalDraft:(id)arg1;
...
- (void)finderLocalDraftCollectionViewCellDidDeleteDraft:(id)arg1 draftModel:(id)arg2;
- (id)hostVC;
- (void)onTagRetry;
...
- (void)viewModelTargetIndexChanged:(long long)arg1 localDraft:(id)arg2;
