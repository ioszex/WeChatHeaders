...
@interface MMMultiMenuItem : NSObject
{
    ...
    _Bool _forceUseItemBackgroundColor;
    _Bool _swipeToTrigger;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool swipeToTrigger; // @synthesize swipeToTrigger=_swipeToTrigger;
...
@property(nonatomic) _Bool forceUseItemBackgroundColor; // @synthesize forceUseItemBackgroundColor=_forceUseItemBackgroundColor;
