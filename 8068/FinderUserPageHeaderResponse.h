...
@class BaseResponse, FinderBizInfo, FinderClubInfo, FinderContact, FinderFeedBriefInfo, FinderFollowedNicknameUpdateInfo, FinderIpRegionInfo, FinderJumpInfo, FinderLiveAnchorStat, FinderLiveNextLiveNotificationInfo, FinderLiveNoticeListInfo, FinderMcnInfo, FinderMileStone, FinderMusicRadio, FinderNicknameVerifyInfo, FinderOriginal, FinderProfileBanner, FinderProfileData, FinderUserPageHeaderAdsInfo, FinderUserPagePoi, FinderUserPageRecentUpdatesInfo, FinderUserPageSignatureFoldInfo, FinderUserProtectionInfo, NSMutableArray, NSString;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: tabList
