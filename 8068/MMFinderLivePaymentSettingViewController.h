...
@property(retain, nonatomic) NSMutableArray *freeTagList; // @synthesize freeTagList=_freeTagList;
...
- (id)initWithPaymentOpened:(_Bool)arg1 allVisibilityFileList:(id)arg2 freeContactChatroomList:(id)arg3 freeContactUsernameList:(id)arg4 freeContactListForDigestDisplay:(id)arg5 freeTagList:(id)arg6 selectedFreeRosterList:(id)arg7 priceInWecoin:(unsigned int)arg8 purchaseLivePreviewType:(long long)arg9 trialTimeHour:(unsigned int)arg10 trialTimeMinute:(unsigned int)arg11 shareEntrySource:(unsigned long long)arg12 forceDarkMode:(_Bool)arg13 bindNotice:(_Bool)arg14;
