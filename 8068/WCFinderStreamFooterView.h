...
+ (double)displayHeightForEmpty:(_Bool)arg1;
...
@property(nonatomic) double elementPosition; // @synthesize elementPosition=_elementPosition;
...
- (void)updateElement:(id)arg1 expectPosition:(double)arg2;
- (_Bool)isLoading;
- (void)layoutSubviews;
