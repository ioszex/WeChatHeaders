...
@class EditEmoticonInfo, EmojiInfoObj, EmoticonStoreItem, EmoticonUploadInfoObj, EmotionFinderLinkInfo, NSNumber, NSString;
...
@interface AddEmoticonWrap
{
    ...
    _Bool _repeatedAsset;
    int _source;
    unsigned int _storeUnique;
    NSNumber *_fileType;
    long long _fileSize;
    ...
    EditEmoticonInfo *_editAssetInfo;
}
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int storeUnique; // @synthesize storeUnique=_storeUnique;
@property(retain, nonatomic) EditEmoticonInfo *editAssetInfo; // @synthesize editAssetInfo=_editAssetInfo;
@property(nonatomic) _Bool repeatedAsset; // @synthesize repeatedAsset=_repeatedAsset;
