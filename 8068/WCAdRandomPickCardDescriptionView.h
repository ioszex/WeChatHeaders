...
@interface WCAdRandomPickCardDescriptionView
{
    ...
    UILabel *_doneDescLabel;
}

+ (double)calcViewHeightForPickCardInfo:(id)arg1 maxWidth:(double)arg2;
- (void).cxx_destruct;
@property(retain, nonatomic) UILabel *doneDescLabel; // @synthesize doneDescLabel=_doneDescLabel;
@property(retain, nonatomic) UILabel *doneTitleLabel; // @synthesize doneTitleLabel=_doneTitleLabel;
@property(retain, nonatomic) UILabel *introduceDescLabel; // @synthesize introduceDescLabel=_introduceDescLabel;
...
- (void)updateRandomPickCardInfo:(id)arg1;
