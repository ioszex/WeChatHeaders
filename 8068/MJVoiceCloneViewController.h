...
@interface MJVoiceCloneViewController : UIViewController
{
    ...
    id <MJVoiceInputManagerDelegate> _prevVoiceInputDelegate;
}

+ (id)genAudioID;
- (void).cxx_destruct;
@property(readonly, nonatomic) __weak id <MJVoiceInputManagerDelegate> prevVoiceInputDelegate; // @synthesize prevVoiceInputDelegate=_prevVoiceInputDelegate;
