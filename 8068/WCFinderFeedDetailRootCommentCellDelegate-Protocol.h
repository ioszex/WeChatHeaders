...
@class FinderJumpInfo_Style, NSIndexPath, NSString, WCFinderComment, WCFinderContact, WCFinderFeedContentVM, WCFinderFeedDetailRootCommentCell, WCFinderJumpInfo;
...
- (WCFinderFeedContentVM *)rootCommentCellGetContentVM:(WCFinderFeedDetailRootCommentCell *)arg1;
- (int)rootCommentCellGetCommentScene:(WCFinderFeedDetailRootCommentCell *)arg1;
- (void)onRootCommentCell:(WCFinderFeedDetailRootCommentCell *)arg1 onClickForwardForComment:(WCFinderComment *)arg2;
