...
@interface TRTCRemoteStatistics : NSObject
{
    ...
    unsigned int _remoteNetworkUplinkLoss;
    unsigned int _remoteNetworkRTT;
    NSString *_userId;
...
@property(nonatomic) unsigned int remoteNetworkRTT; // @synthesize remoteNetworkRTT=_remoteNetworkRTT;
@property(nonatomic) unsigned int remoteNetworkUplinkLoss; // @synthesize remoteNetworkUplinkLoss=_remoteNetworkUplinkLoss;
