...
@class MISSING_TYPE, MMUIButton, MultipleTextStateCardCollectionCell, MultipleTextStateCardView, NSIndexPath, NSString, TextStateCardListCollectionView, TextStateCardListFooterView, TextStateCardListSlidingWindowRefreshTask, TextStateModel, TextStatePrivacyMgr, UICollectionViewFlowLayout, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UITapGestureRecognizer, UIView, UIViewPropertyAnimator, _TtC6WeChat31TextStateFriendSquareTransition;
