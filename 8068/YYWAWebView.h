...
@class NSMutableArray, NSMutableDictionary, NSString, NSURLRequest, UIScrollView, UIView, YYWAWebViewScriptMessageHandler;
...
@interface YYWAWebView : WKWebView
{
    ...
    NSMutableArray *_editMenuInteractions;
    struct UIEdgeInsets _oldSafeArea;
}

+ (id)processPool;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *editMenuInteractions; // @synthesize editMenuInteractions=_editMenuInteractions;
