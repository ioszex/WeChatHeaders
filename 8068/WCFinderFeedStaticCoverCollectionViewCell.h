...
@interface WCFinderFeedStaticCoverCollectionViewCell : UICollectionViewCell
{
    ...
    UIView *_topBubbleBox;
    UILabel *_topBubbleTimeLabel;
    UIView *_progressBar;
}
...
@property(retain, nonatomic) UILabel *topBubbleTimeLabel; // @synthesize topBubbleTimeLabel=_topBubbleTimeLabel;
@property(retain, nonatomic) UIView *topBubbleBox; // @synthesize topBubbleBox=_topBubbleBox;
...
- (void)onFeedStaticCoverViewLoadFinish:(id)arg1;
...
- (void)onFeedPlayHistoryProgressBarChanged:(id)arg1;
...
- (void)setupProgressBar:(unsigned long long)arg1;
...
- (void)_configTopBubbleLabel:(id)arg1;
- (void)_configTopBubbleLabel;
- (id)contactOfContentVM:(id)arg1;
