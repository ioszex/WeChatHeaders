...
@property(nonatomic) _Bool needCheckRepeated; // @dynamic needCheckRepeated;
@property(nonatomic) _Bool needLoadMore; // @dynamic needLoadMore;
@property(nonatomic) _Bool needRequestDirectly; // @dynamic needRequestDirectly;
