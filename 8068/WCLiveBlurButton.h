...
@interface WCLiveBlurButton
{
    ...
    _Bool _useForButtonFolder;
    _Bool _disableShowAtBottomOutside;
...
@property(nonatomic) _Bool disableShowAtBottomOutside; // @synthesize disableShowAtBottomOutside=_disableShowAtBottomOutside;
@property(nonatomic) _Bool useForButtonFolder; // @synthesize useForButtonFolder=_useForButtonFolder;
