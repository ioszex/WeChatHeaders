...
- (void)performAnimationWithComplete:(_Bool)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;
- (void)performAnimationWithComplete:(_Bool)arg1 delay:(double)arg2;
- (void)prepareForAnimation;
- (void)onEnterSqaureInteractiveTransitionDidEndHandle:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
