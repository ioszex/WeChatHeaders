...
@class NSArray, NSDictionary, NSMutableArray, NSString, UIColor, UINavigationController, UIView, UIViewController, WAAppTansitionController, WAAppTaskExtInfo, WAAppTaskLoader, WACacheVersionChecker, WAContact, WALoadingViewController, WAPackageConfig, WAPermissionHandler, WAWebViewController;
...
@interface WAAppTaskLoaderContext : NSObject
{
    ...
    unsigned long long _silentOpenType;
...
@property(nonatomic) unsigned long long silentOpenType; // @synthesize silentOpenType=_silentOpenType;
