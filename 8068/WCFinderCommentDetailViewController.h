...
- (void)onCommentClickHandPick:(id)arg1 button:(id)arg2;
- (void)removeJustWatchingTips;
- (void)showJustWatchingTipsForComment:(unsigned long long)arg1;
- (void)onCommentClickImageView:(id)arg1 image:(id)arg2 withComment:(id)arg3;
...
- (void)onCommentClickReplayAction:(id)arg1 comment:(id)arg2;
- (void)showCommentProfileViewWithComment:(id)arg1;
- (void)onSubCommentCell:(id)arg1 onClickForwardForComment:(id)arg2;
- (void)onRootCommentCell:(id)arg1 onClickForwardForComment:(id)arg2;
- (id)subCommentCellGetContentVM:(id)arg1;
- (id)rootCommentCellGetContentVM:(id)arg1;
