...
@class FinderNewUserPrepareResponse, MISSING_TYPE, MMFinderLivePurchasedFeedViewModel, MMUIViewController, NSString, WCFinderContact, WCFinderPersonalCenterParams, WCFinderWebViewOpener;
...
@interface WCFinderPersonalCenterController : NSObject
{
    ...
    MISSING_TYPE *_purchasedFeedViewModel;
}
