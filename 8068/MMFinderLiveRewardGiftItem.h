...
@class AudienceAiCustomGiftInfo, FinderJumpInfo, FinderLiveGift, FinderLiveGiftBatchGiveConfigList, FinderLiveGiftCustomInfo, MMFinderLiveAnchorCustomizeRewardStyleItem, MMFinderLiveGiftCustomizationModel, MMFinderLiveGiftNewCustomizationModel, NSArray, NSData, NSMutableArray, NSString, PackageResourceInfo_ProductBatchInfo;
...
@interface MMFinderLiveRewardGiftItem
{
    ...
    AudienceAiCustomGiftInfo *_aigcGiftInfo;
}
...
+ (id)swift_aigcGiftInfo;
+ (const void *)__wcdb_synthesize_24:(void *)arg1;
+ (const void *)aigcGiftInfo;
+ (id)swift_useRfxPag;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isKtvExposedGiftItem; // @synthesize isKtvExposedGiftItem=_isKtvExposedGiftItem;
...
@property(retain, nonatomic) AudienceAiCustomGiftInfo *aigcGiftInfo; // @synthesize aigcGiftInfo=_aigcGiftInfo;
...
- (_Bool)aigcGiftGenerateSuccess;
- (_Bool)aigcGiftGenerateFail;
- (_Bool)aigcGiftGenerating;
- (_Bool)isAIGCGift;
