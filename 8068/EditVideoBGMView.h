...
@class ColorGradientView, EditVideoBGMFetchFeedbackLogic, EditVideoBGMSearchView, EditVideoMusicController, MISSING_TYPE, MMMusicPickerScrollView, MMUIButton, NSMutableArray, NSString, UIView;
