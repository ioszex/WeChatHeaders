...
@class MISSING_TYPE, MMSessionInfo, NSIndexPath, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSMutableArray *m_redTips; // @synthesize m_redTips;
