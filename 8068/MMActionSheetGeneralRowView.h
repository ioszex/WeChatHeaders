...
@interface MMActionSheetGeneralRowView
{
    ...
    unsigned long long _subtitlePosition;
...
@property(nonatomic) unsigned long long subtitlePosition; // @synthesize subtitlePosition=_subtitlePosition;
...
- (id)initWithTitle:(id)arg1 subTitle:(id)arg2 iconUrl:(id)arg3 iconImage:(id)arg4 subtitlePosition:(unsigned long long)arg5 tapHandler:(CDUnknownBlockType)arg6;
