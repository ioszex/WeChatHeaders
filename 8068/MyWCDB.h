...
+ (void)initialize;
- (void).cxx_destruct;
- (void)setM_tableNewLifeShareRecord:(id)arg1;
- (id)m_tableNewLifeShareRecord;
...
- (_Bool)setWCMessageSpringWished:(id)arg1 springWishFlag:(long long)arg2;
