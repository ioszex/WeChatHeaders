...
@property(retain, nonatomic) FinderEncashPrepareInfo *lastEncashPrepareInfo; // @synthesize lastEncashPrepareInfo=_lastEncashPrepareInfo;
...
- (void)reportEncashLogicErrCode:(int)arg1;
- (void)reportEncashInterceptJumpInfo:(id)arg1;
