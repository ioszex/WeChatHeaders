...
@interface V2TXLivePusher : NSObject
{
    ...
    struct unique_ptr<liteav::video::NativePixelFrameFactory, std::default_delete<liteav::video::NativePixelFrameFactory>> _pixel_frame_factory;
}

- (id).cxx_construct;
- (void).cxx_destruct;
- (struct VideoSize)getVideoSizeWith:(long long)arg1 mode:(long long)arg2;
- (unique_ptr_0f27ab05)convertToInnerFrame:(id)arg1;
...
- (void)enableVoiceActivityDetection:(_Bool)arg1;
...
- (long long)enableAudioProcessObserver:(_Bool)arg1 format:(id)arg2;
