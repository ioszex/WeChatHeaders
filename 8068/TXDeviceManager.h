...
{
    weak_ptr_567df4d0 deviceManager_;
...
- (void)setCameraCapturerParam:(id)arg1;
- (long long)setExposureCompensation:(double)arg1;
...
- (_Bool)isFrontCamera;
- (void)setInternelDeviceManager:(weak_ptr_567df4d0)arg1;
