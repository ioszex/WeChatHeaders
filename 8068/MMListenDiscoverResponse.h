...
@class BaseResponse, MMListenAudioBaseResponse, MMListenDiscoverResponse_InterestRadioInfo, MMListenDiscoverResponse_JumpableTopToast, MMListenDiscoverResponse_JumpableTopToastV2, MMListenFinderAudioDiscoverMessage, MMListenFinderSingerDiscoverMessage, MMListenMusicBaseResponse, NSData, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSMutableArray *banner; // @dynamic banner;
...
@property(retain, nonatomic) MMListenDiscoverResponse_InterestRadioInfo *interestRadioInfo; // @dynamic interestRadioInfo;
