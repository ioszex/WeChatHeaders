...
@class ConfCallWordingInfo, MISSING_TYPE, MMConfSDKMemberMgr, NSArray, NSData, NSMutableArray, NSString, VoIPMtBannerMsg;

@protocol MultitalkApiDelegate
- (MISSING_TYPE *)hangupMultiTalkByCallEnd: /* Error: Ran out of types for this method. */;
