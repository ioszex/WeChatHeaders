...
@interface SightLocalVideoImageSlider : UIView
{
    ...
    double _centerXPositionOfEndFlag;
    ...
    SightLocalViewSliderMaskView *_sliderMaskView;
...
@property(retain, nonatomic) SightLocalViewSliderMaskView *sliderMaskView; // @synthesize sliderMaskView=_sliderMaskView;
...
@property(nonatomic) double centerXPositionOfEndFlag; // @synthesize centerXPositionOfEndFlag=_centerXPositionOfEndFlag;
