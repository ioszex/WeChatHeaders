...
- (void)onLivePhotoVideoDidPlayToEndWithMediaInfo:(WCFinderMediaInfo *)arg1;
- (void)onLivePhotoVideoUpdatePosition:(double)arg1 videoDuration:(double)arg2 mediaInfo:(WCFinderMediaInfo *)arg3;
