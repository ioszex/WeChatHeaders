...
@class BaseResponse, FinderBarInfo, FinderLivePreloadInfo, FinderPreloadInfo, FinderRelatedRecommendTips, FinderStreamLayoutInfo, FinderStreamLongVideoInfo, GetRelatedListPrefetchConfig, NSData, NSMutableArray, NSString, StreamBackupInfo, StreamExtContext;
...
@property(retain, nonatomic) NSData *asyncLoadInfoBuffer; // @dynamic asyncLoadInfoBuffer;
...
@property(nonatomic) unsigned int mergeType; // @dynamic mergeType;
...
@property(retain, nonatomic) StreamExtContext *streamExtContext; // @dynamic streamExtContext;
