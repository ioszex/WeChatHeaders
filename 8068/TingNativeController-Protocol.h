...
@class ContactInfoWrap, FlutterStandardTypedData, MISSING_TYPE, NSArray, NSDictionary, NSNumber, NSString, OpenWebPageInfo, SelectLocalPhotoResult, ThirdAppInfo, TingBrandContactInfo, TingFinderContactInfo, TingPoiInfo, TingRecordFormat, TingSelectContactsConfig, TingShareConfig, TingShareDataWrap, TingUserContactInfo;
...
- (MISSING_TYPE *)addToStarListenItemData:scene:music:cancel:snapInfo:closeTingApp:error: /* Error: Ran out of types for this method. */;
...
- (void)startRecordWithFormatMinTimeInSecond:(long long)arg1 maxTimeInSecond:(long long)arg2 format:(TingRecordFormat *)arg3 completion:(void (^)(NSNumber *, FlutterError *))arg4;
