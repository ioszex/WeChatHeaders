...
@interface WCFinderOpenTimelineParams : NSObject
{
    ...
    _Bool _showDidOpenFindEntryPanelSheet;
...
@property(nonatomic) _Bool showDidOpenFindEntryPanelSheet; // @synthesize showDidOpenFindEntryPanelSheet=_showDidOpenFindEntryPanelSheet;
@property(copy, nonatomic) NSString *bottomSnackTips; // @synthesize bottomSnackTips=_bottomSnackTips;
...
- (void)appendShowBottomSnackTipsAction:(id)arg1;
- (id)initByEntryScene:(int)arg1 entryCardType:(int)arg2 appendTabDatasModel:(id)arg3;
- (_Bool)forceInitFinderTimelineVC;
- (long long)getOpenFinderAppendAction;
- (id)initFromOpenFinderTLJSApiWithFromVC:(id)arg1 forceJumpTabType:(unsigned long long)arg2 entryScene:(int)arg3 entryCardType:(int)arg4 h5ByPass:(id)arg5 reportInfo:(id)arg6 complete:(CDUnknownBlockType)arg7;
- (id)initFromShareTypeWithTid:(id)arg1 nonceID:(id)arg2 playPosition:(double)arg3 entryScene:(int)arg4 requestScene:(unsigned long long)arg5;
...
- (id)initFromShareListFromVC:(id)arg1 shouldReloadTableView:(_Bool)arg2 forceJumpTabType:(unsigned long long)arg3 entryScene:(int)arg4 entryCardType:(int)arg5 appendContentVMArray:(id)arg6 scrollToFeedId:(id)arg7 appendCardLastBuffer:(id)arg8 appendDatasScene:(unsigned long long)arg9;
- (id)initFromShareListFromVC:(id)arg1 shouldReloadTableView:(_Bool)arg2 forceJumpTabType:(unsigned long long)arg3 entryScene:(int)arg4 entryCardType:(int)arg5 guideBarObjectId:(unsigned long long)arg6;
- (id)initFromShareListFromVC:(id)arg1 shouldReloadTableView:(_Bool)arg2 forceJumpTabType:(unsigned long long)arg3 entryScene:(int)arg4 entryCardType:(int)arg5;
- (id)initFromWXSearchShouldReloadTableView:(_Bool)arg1 fromVC:(id)arg2;
- (id)initFromShareListWithDatasModel:(id)arg1 entryScene:(int)arg2 entryCardType:(int)arg3;
- (id)initFromOpenBusinessSceneWithPostSession:(id)arg1;
- (id)_initWithEntryScene:(int)arg1 entryCardType:(int)arg2;
