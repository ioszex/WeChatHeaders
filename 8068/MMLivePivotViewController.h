...
- (_Bool)tryShowScrollingForHistoryTip;
...
- (void)extendAndReplaceFinderLiveContentVMs:(id)arg1 exportIds:(id)arg2 selectedIndex:(id)arg3 historyCount:(unsigned long long)arg4 scrollToNextAfterReplacement:(_Bool)arg5;
