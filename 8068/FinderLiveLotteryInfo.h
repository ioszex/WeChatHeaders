...
@class FinderLiveLotteryAnchorInfo, FinderLiveLotteryAttendMethod, FinderLiveLotteryClaimMethod, FinderLiveLotteryInfo_ParticipantInfo, FinderLiveLotteryParticipability, FinderLiveLotteryPrizeMethod, FinderLiveLotteryWinnerExtInfo, NSString;
...
@property(retain, nonatomic) FinderLiveLotteryAnchorInfo *anchorInfo; // @dynamic anchorInfo;
