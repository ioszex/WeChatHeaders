...
@class UIColor, UIImageView, WCFinderRichTextView;
...
@interface WCFinderBlurBubbleView : UIView
{
    ...
    WCFinderRichTextView *_bubbleTextView;
...
@property(retain, nonatomic) WCFinderRichTextView *bubbleTextView; // @synthesize bubbleTextView=_bubbleTextView;
