...
- (id)startMAVExportSessionTaskWithMAVVideoComposition:(id)arg1 config:(id)arg2 inputPath:(id)arg3 outputPath:(id)arg4 params:(id)arg5 videoEncodeTaskParams:(id)arg6 progressCallback:(CDUnknownBlockType)arg7 completionBlock:(CDUnknownBlockType)arg8;
...
- (id)startNewTaskForAsset:(id)arg1 inputPath:(id)arg2 outputPath:(id)arg3 params:(id)arg4 videoEncodeTaskParams:(id)arg5 configVideoComposition:(id)arg6 videoProgressCallback:(CDUnknownBlockType)arg7 completionBlock:(CDUnknownBlockType)arg8;
...
- (_Bool)isEnableHEVCEncodeWithSightScene:(unsigned long long)arg1 duration:(double)arg2;
