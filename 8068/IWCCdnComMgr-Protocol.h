...
+ (_Bool)StartSnsVideoStreamingDownload:(NSString *)arg1 httpUrl:(NSString *)arg2 fileType:(int)arg3 appType:(short)arg4 filePath:(NSString *)arg5 preloadPercent:(int)arg6 Timeout:(unsigned int)arg7 referer:(NSString *)arg8 blockSize:(unsigned int)arg9;
