...
+ (int)convertEnterSceneToEntryScene:(unsigned long long)arg1;
+ (int)convertEnterSceneToEntryCardType:(unsigned long long)arg1;
+ (id)convertFeedShortInfoToDataItem:(id)arg1;
+ (id)convertRecommendedMusicToFinderMusicInfo:(id)arg1 docType:(int)arg2;
+ (id)convertTabKeyPathFromTabType:(long long)arg1;
...
+ (int)_finderContentTypeForDataItem:(id)arg1;
...
+ (double)renderUnBlackCoverFrameBy:(id)arg1 editAttr:(id)arg2 specifiedCoverImage:(id)arg3;
