...
- (void)flutterTextInputView:(FlutterTextInputView *)arg1 lookUpSelectedText:(NSString *)arg2;
- (void)flutterTextInputView:(FlutterTextInputView *)arg1 searchWebWithSelectedText:(NSString *)arg2;
- (void)flutterTextInputView:(FlutterTextInputView *)arg1 shareSelectedText:(NSString *)arg2;
- (void)flutterTextInputView:(FlutterTextInputView *)arg1 willDismissEditMenuWithTextInputClient:(int)arg2;
