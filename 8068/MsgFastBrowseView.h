...
@class MMTableView, NSMutableArray, NSMutableDictionary, NSString, SimpleImgInfo, UIColor, UILabel, UIView, WCTimeLineFooterView;
...
- (void)setHeadTitleLeftMargin:(double)arg1;
- (void)setHeadTitleColor:(id)arg1;
