...
@interface WCCanvasComponentItem
{
    ...
    WCCanvasComponentRandomPickCardTitleInfo *_randomPickCardTitleInfo;
    double _paddingTop;
...
@property(retain, nonatomic) WCCanvasComponentRandomPickCardTitleInfo *randomPickCardTitleInfo; // @synthesize randomPickCardTitleInfo=_randomPickCardTitleInfo;
