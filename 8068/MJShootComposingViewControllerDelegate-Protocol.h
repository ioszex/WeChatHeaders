...
@class EditImageAttr, EditVideoAttr, MJShootComposingDraft, MJShootComposingViewController, MJShootRedPacketResponseInfo, MMAssetPickerController, MMImagePreviewControllerActionFlow, MMShortVideoParamModel, NSArray, NSData, NSDictionary, NSError, NSString, PHObjectPlaceholder, SightDraft, UIImage, WCFinderDataItem, WCFinderPostSessionModel;
...
- (void)shootComposingViewController:(MJShootComposingViewController *)arg1 didFinishUploadRedPacketCDNWithResponseInfo:(MJShootRedPacketResponseInfo *)arg2;
- (void)shootComposingViewController:(MJShootComposingViewController *)arg1 didSavedAIGCAsyncDraft:(MJShootComposingDraft *)arg2;
@end
