...
@class FinderObjectPlaceHolderInfo, MISSING_TYPE, NSString, RichTextView, UIImageView, UIView, WCFinderAuthInfoIconView, WCFinderDataItem, WCFinderFeedContentVM, WCFinderGradientView, WCFinderHeadImageView, WCFinderPlaceholderContentVM, WCFinderRichTextView, WCFinderSimplePlayerView;
...
- (void)updateUIStyle;
- (void)_updateWithPlaceholderInfo:(id)arg1 playItem:(id)arg2 contentVM:(id)arg3;
