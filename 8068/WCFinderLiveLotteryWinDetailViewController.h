...
@class MMFinderLiveLotteryGetPrizeMethodView, MMFinderLiveLotteryInfo, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveLotteryDetailCardGiftView, MMUIButton, MMUILabel, MilestoneLotteryInfo, NSString, PrizeRecord, RichTextView, UIImageView, UIScrollView, UIView, WCAddressBaseAddress, WCFinderContact;
...
@interface WCFinderLiveLotteryWinDetailViewController
{
    ...
    MilestoneLotteryInfo *_milestoneLotteryInfo;
...
@property(retain, nonatomic) MilestoneLotteryInfo *milestoneLotteryInfo; // @synthesize milestoneLotteryInfo=_milestoneLotteryInfo;
...
- (void)dealloc;
- (id)initWithLiveTaskId:(id)arg1 lotteryInfo:(id)arg2 milestoneLotteryInfo:(id)arg3 scene:(unsigned long long)arg4 anchorNickName:(id)arg5 anchorContact:(id)arg6 objectId:(unsigned long long)arg7 liveId:(unsigned long long)arg8;
- (id)initWithLiveTaskId:(id)arg1 prizeRecord:(id)arg2 scene:(unsigned long long)arg3 anchorNickName:(id)arg4 anchorContact:(id)arg5 objectId:(unsigned long long)arg6 liveId:(unsigned long long)arg7;
