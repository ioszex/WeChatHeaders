...
@protocol WCFinderFeedStaticCoverViewProtocol, WCFinderLiveIconAnimationProtocol;

@interface WCFinderFeedStaticCoverView : UIView
{
    _Bool _ignoreTopping;
    int _coverShowStyle;
    id <WCFinderFeedStaticCoverViewProtocol> _delegate;
...
@property(nonatomic) _Bool ignoreTopping; // @synthesize ignoreTopping=_ignoreTopping;
...
@property(nonatomic) __weak id <WCFinderFeedStaticCoverViewProtocol> delegate; // @synthesize delegate=_delegate;
