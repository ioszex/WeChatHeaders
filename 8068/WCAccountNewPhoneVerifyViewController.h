...
@class MISSING_TYPE, MMUIButton, MMUILabel, NSString, UIButton, WCAccountNewPhoneVerifyPageView, WCAgreementCheckBox, WCButtonListView, WCRedesignButtonItem;
@protocol WCAccountNewPhoneVerifyViewControllerDelegate;

@interface WCAccountNewPhoneVerifyViewController
{
    MISSING_TYPE *_isFromLogin;
    long long _iCount;
