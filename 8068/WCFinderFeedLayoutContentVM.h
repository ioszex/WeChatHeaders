...
@class FinderStreamCard, FinderStreamDivider, FinderStreamTxtCard, NSArray, NSData, NSMutableSet, NSString;
...
- (id)contentTid;
- (id)initWithDataItem:(id)arg1 dataItemArray:(id)arg2 lastBuffer:(id)arg3 continueFlag:(_Bool)arg4 scene:(int)arg5 titleWording:(id)arg6;
- (void)setupContentDatas:(id)arg1;
- (void)setupWithCard:(id)arg1;
- (id)initWithSnSLiveList:(int)arg1;
- (id)initWithStreamCard:(id)arg1 scene:(int)arg2;
- (id)initWithDivider:(id)arg1 scene:(int)arg2;
