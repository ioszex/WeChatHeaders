...
@class CAGradientLayer, CALayer, CAShapeLayer, FanClubPanelInfo, FinderLiveRewardGiftExtInfo, MMCPLabel, MMFinderLiveGlobalRankSignView, MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMHeadImageView, MMLiveHalfScreenTitleBarView, MMLiveRewardGiftAIGCOperationPanel, MMLiveRewardGiftAttackContactBubbleView, MMLiveRewardGiftCoinButton, MMLiveRewardGiftCustomizationTipView, MMLiveRewardGiftLayout, MMLiveRewardGiftNewCustomizationSettingPanel, MMLiveRewardGiftNewCustomizationTipView, MMLiveRewardGiftPreviewWindow, MMLiveRewardGiftSendingCountMenuBar, MMNormalTipsView, MMScrollView, MMUILabel, MMUIView, NSArray, NSIndexPath, NSMutableArray, NSMutableSet, NSString, UICollectionView, UIImageView, UILabel, UIPageControl, UIScrollView, UIView;
