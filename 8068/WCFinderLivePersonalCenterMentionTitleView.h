...
@class MMUIButton, RichTextView, UIImageView, UILabel, WCFinderAggregatedTitleView, WCFinderInteractionLabelGroupView, WCFinderLivePersonalCenterMentionTitleModel;
@protocol WCFinderLivePersonalCenterMentionTitleViewDelegate;

@interface WCFinderLivePersonalCenterMentionTitleView : UIView
{
    id <WCFinderLivePersonalCenterMentionTitleViewDelegate> _delegate;
    ...
    WCFinderLivePersonalCenterMentionTitleModel *_model;
    double _layoutWidth;
...
@property(retain, nonatomic) WCFinderLivePersonalCenterMentionTitleModel *model; // @synthesize model=_model;
...
@property(nonatomic) __weak id <WCFinderLivePersonalCenterMentionTitleViewDelegate> delegate; // @synthesize delegate=_delegate;
