...
@class MISSING_TYPE, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveCommentDataDictCache, MMLiveCommentDataItem, MMTimer, NSMutableArray, NSMutableDictionary, NSString;
...
- (id)getBarrageCommentItemWithLocalClientMsgId:(id)arg1 boxId:(id)arg2;
