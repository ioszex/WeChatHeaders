...
+ (id)buildVoiceCloneRoleVoiceItem;
+ (id)buildRegularRoleVoiceItem;
+ (id)addWavHeaderForPCMData:(id)arg1 sampleRate:(long long)arg2 channelCount:(long long)arg3;
...
+ (long long)requestSpeechRecognitionByILinkWithAudioID:(id)arg1 audioData:(id)arg2 sliceIndex:(long long)arg3 isEnd:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
+ (void)mj_cancelRequests:(id)arg1 isRequestCgi:(_Bool)arg2 cgiHelper:(id)arg3;
+ (void)mj_cancelRequest:(id)arg1 isRequestCgi:(_Bool)arg2 cgiHelper:(id)arg3;
+ (long long)mj_queryAsyncSTTRequestWithAudioID:(id)arg1 submitTaskID:(id)arg2 contextBuff:(id)arg3 isRequestCgi:(_Bool)arg4 cgiHelper:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
+ (long long)mj_submitAsyncSTTRequestWithAudioID:(id)arg1 voiceIDForRequest:(id)arg2 audioSlice:(id)arg3 audioDurationMillis:(unsigned long long)arg4 isRequestCgi:(_Bool)arg5 cgiHelper:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
