...
@class CAShapeLayer, CContact, FinderAudienceLiveInfo, FinderLiveContact, MISSING_TYPE, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveNormalTextSignView, MMFinderLiveOnlineUserProfileOpenParameter, MMHeadImageView, MMLiveActionSheetScrollView, MMLoadingIndicatorView, MMUIActivityIndicatorView, MMUIButton, MMUILabel, NSArray, NSMutableArray, NSString, RichTextView, UIButton, UIImageView, UILabel, UIView, UIVisualEffectView, WCFinderContact, WCFinderContactPreviewData, WCFinderProfileAuthView, WCLiveActionSheet, WCTableViewManager;
...
@interface MMFinderLiveOnlineUserProfileView
{
    ...
    MISSING_TYPE *_finderIconImageView;
