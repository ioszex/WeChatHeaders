...
@class CContact, ContactSearchLogic, DeepLinkBitSet, GeneralControlBitSet, JSAPIPermissionBitSet, JumpEmoticonDetailCgi, MMTipsViewController, MMUIViewController, NSData, NSDictionary, NSMutableDictionary, NSNumber, NSString, SKBuiltinBuffer_t, StrongNotificationScanLogic, WCFinderCreateLiveViewModel, WCFinderQRCodeViewModel, WCRedEnvelopesGetRedPacketPreviewCgi;
...
- (unsigned int)mapScanSceneToFinderScene:(long long)arg1;
