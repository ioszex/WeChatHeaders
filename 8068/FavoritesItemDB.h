...
- (_Bool)getNextPageFavoritesItemList:(id)arg1 byType:(int)arg2 andCurMinUpdateTime:(unsigned int)arg3 andPinTopFirst:(_Bool)arg4 byCurMinPinTopTime:(unsigned int)arg5;
- (_Bool)getFirstPageFavoritesItemList:(id)arg1 byType:(int)arg2 andPinTopFirst:(_Bool)arg3;
