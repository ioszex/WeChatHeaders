...
@class JITRuntimeMessageHandler, JITRuntimeURLSchemeHandler, NSMutableArray, NSMutableDictionary, NSString;
@protocol JITRuntimeViewDelegate;

@interface JITRuntimeView : WKWebView
{
    _Bool _forbidMetalCPP;
    _Bool _jitLoaded;
...
@property(readonly, nonatomic) _Bool forbidMetalCPP; // @synthesize forbidMetalCPP=_forbidMetalCPP;
