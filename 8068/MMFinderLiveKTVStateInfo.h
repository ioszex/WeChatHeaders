...
@interface MMFinderLiveKTVStateInfo : NSObject
{
    ...
    long long _majorBgmChannel;
    long long _chorusSingAsMinorError;
...
+ (id)transferMinorErrorToDesc:(long long)arg1;
+ (_Bool)checkBgmChanelIsValid:(int)arg1;
+ (_Bool)checkBgmPitchIsValid:(int)arg1;
+ (_Bool)checkBgmVolumeIsValid:(int)arg1;
+ (long long)transferPbBgmChannelToBgmChannel:(int)arg1;
+ (long long)transferPbSingModeToSingMode:(int)arg1;
+ (long long)transferPbSingStateToSingState:(int)arg1;
+ (int)transferBgmChannelToPbBgmChannel:(unsigned long long)arg1;
+ (int)transferSingModeToPbSingMode:(long long)arg1;
...
@property(nonatomic) long long chorusSingAsMinorError; // @synthesize chorusSingAsMinorError=_chorusSingAsMinorError;
@property(nonatomic) _Bool isCurrSingAsMinor; // @synthesize isCurrSingAsMinor=_isCurrSingAsMinor;
@property(nonatomic) _Bool isCurrSingBySelf; // @synthesize isCurrSingBySelf=_isCurrSingBySelf;
@property(nonatomic) int majorBgmPitch; // @synthesize majorBgmPitch=_majorBgmPitch;
@property(nonatomic) int majorBgmVolume; // @synthesize majorBgmVolume=_majorBgmVolume;
@property(nonatomic) long long majorBgmChannel; // @synthesize majorBgmChannel=_majorBgmChannel;
@property(nonatomic) int segmentSentenceCnt; // @synthesize segmentSentenceCnt=_segmentSentenceCnt;
...
- (_Bool)updateNextSongUniqueId:(id)arg1;
...
- (_Bool)updateSegmentSentenceCnt:(int)arg1;
- (_Bool)updateWonderfulPositionBegin:(int)arg1 end:(int)arg2;
- (_Bool)updateOnlySingSegment:(_Bool)arg1;
- (_Bool)updateScoreEngineFlag:(int)arg1;
- (_Bool)updateMajorBgmPitch:(int)arg1;
- (_Bool)updateMajorBgmChannel:(long long)arg1;
- (_Bool)updateMajorBgmVolume:(int)arg1;
- (_Bool)updateSingMode:(long long)arg1;
- (_Bool)updateSingState:(long long)arg1 force:(_Bool)arg2;
- (_Bool)updateCurrSongName:(id)arg1;
- (_Bool)updateCurrSingerUserId:(id)arg1 force:(_Bool)arg2;
...
- (void)clearDatas;
- (void)onEnterLive;
- (_Bool)currSongOnlySingSegment;
- (_Bool)isChorusSingAsMinorOccurError;
- (void)tagChorusSingAsMinorOccurError:(long long)arg1;
- (void)exitChorusSing;
- (_Bool)joinToChorusSing;
- (void)clearLastRecords;
- (void)tagDirty;
- (unsigned long long)getCurrSingerSelfVolumn;
- (_Bool)isSingingNotEnd;
...
- (void)updateSongData:(id)arg1;
- (void)startSing:(id)arg1;
- (void)beginSong:(id)arg1 singMode:(long long)arg2;
- (id)genSnapShot;
- (void)updateNewState:(id)arg1 force:(_Bool)arg2 notify:(_Bool)arg3;
