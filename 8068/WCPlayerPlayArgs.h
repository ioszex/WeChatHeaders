...
@class AVPlayerItem, MISSING_TYPE, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIImage, WCDownloadArgsWrap, WCPlayerFairPlayInfo, WCPlayerReporter;
...
@interface WCPlayerPlayArgs : NSObject
{
    ...
    _Bool _isOpenAudioFrameProcessCallback;
    ...
    double _livePhotoAnimationScale;
    double _pipDuration;
    ...
    NSMutableDictionary *_dicReportParams;
...
@property(retain, nonatomic) NSDictionary *pixelBufferAttributes; // @synthesize pixelBufferAttributes=_pixelBufferAttributes;
...
@property(nonatomic) int enableRendererColorLUT; // @synthesize enableRendererColorLUT=_enableRendererColorLUT;
...
@property(nonatomic) int waveHAidDevice; // @synthesize waveHAidDevice=_waveHAidDevice;
@property(nonatomic) int waveHAidMode; // @synthesize waveHAidMode=_waveHAidMode;
@property(nonatomic) _Bool isOpenWaveAudioHAidProcess; // @synthesize isOpenWaveAudioHAidProcess=_isOpenWaveAudioHAidProcess;
@property(nonatomic) _Bool isOpenAudioFrameProcessCallback; // @synthesize isOpenAudioFrameProcessCallback=_isOpenAudioFrameProcessCallback;
...
@property(retain, nonatomic) NSMutableDictionary *dicReportParams; // @synthesize dicReportParams=_dicReportParams;
...
@property(nonatomic) double livePhotoAnimationScale; // @synthesize livePhotoAnimationScale=_livePhotoAnimationScale;
