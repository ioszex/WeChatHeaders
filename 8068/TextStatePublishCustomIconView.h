...
@interface TextStatePublishCustomIconView : UIView
{
    ...
    _Bool _enableSwitchIconButtonShowBreathAnim;
    _Bool _expanded;
    ...
    UIViewPropertyAnimator *_switchIconButtonAnimator;
...
@property(retain, nonatomic) UIViewPropertyAnimator *switchIconButtonAnimator; // @synthesize switchIconButtonAnimator=_switchIconButtonAnimator;
...
@property(nonatomic) _Bool enableSwitchIconButtonShowBreathAnim; // @synthesize enableSwitchIconButtonShowBreathAnim=_enableSwitchIconButtonShowBreathAnim;
...
- (id)icon;
- (void)updateIcon;
- (void)setSwitchButtonSelected:(_Bool)arg1 animDuration:(double)arg2;
