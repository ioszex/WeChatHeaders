...
@interface WCFinderFeedLikeListViewController
{
    ...
    MMUIButton *_moreBtn;
    WCFinderSizingRichTextView *_titleLabel;
...
@property(retain, nonatomic) WCFinderSizingRichTextView *titleLabel; // @synthesize titleLabel=_titleLabel;
...
- (id)initWithContentVM:(id)arg1 entranceScene:(unsigned long long)arg2;
