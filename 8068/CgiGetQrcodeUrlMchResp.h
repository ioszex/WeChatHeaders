...
@class ApplyCellInfo, BaseResponse, CoverInfo, MenuItem, NSData, NSMutableArray, NSString, QRActionInfo, ReceiptItemSettingInfo, ReceiveOptionInfo;
...
@property(retain, nonatomic) ReceiptItemSettingInfo *receiptItemSettingInfo; // @dynamic receiptItemSettingInfo;
