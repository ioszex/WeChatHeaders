...
- (_Bool)closeNewDesignLength;
- (double)chatViewControllerShortSideLength;
- (double)chatViewControllerWidth;
- (_Bool)isShowInSubScene;
- (id)linkTextColorMaterialStyle;
- (id)pattedSelfMessageTextColorMaterialStyle;
- (id)normalTextColorMaterialStyle;
- (id)normalSystemTextColorMaterialStyle;
