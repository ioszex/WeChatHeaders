...
@class FinderLocation, FinderTopicBgmInfo, ForwardMessageLogicController, MISSING_TYPE, NSData, NSMutableArray, NSMutableSet, NSString, WCFinderSectionInfo, WCFinderTopicInfo;
...
@interface WCFinderTopicListViewModel : NSObject
{
    ...
    MISSING_TYPE *_poiTopicRecommend;
