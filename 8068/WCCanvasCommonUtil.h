...
+ (void)loadCanvasFromFavWithCanvasId:(id)arg1 uxInfo:(id)arg2 canvasDynamicInfo:(id)arg3 canvasDynamicExtInfo:(id)arg4 originAdInfo:(id)arg5 showNavigationBar:(_Bool)arg6 originView:(id)arg7 originCanvasPageXml:(id)arg8 originThumbUrl:(id)arg9;
