...
- (void)createRequest;
- (id)initWithPullType:(unsigned long long)arg1 tabType:(int)arg2 reddotInfo:(id)arg3 lastBuffer:(id)arg4 successful:(CDUnknownBlockType)arg5 failure:(CDUnknownBlockType)arg6;
