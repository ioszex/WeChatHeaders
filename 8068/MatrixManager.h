...
- (_Bool)p_isSupportNewReportStrategy;
- (_Bool)p_isReportSupportCustomLagStrategy;
- (int)p_callUseMarsReportIssueDelegate:(id)arg1;
...
- (_Bool)isSupportNewReportStrategy;
...
- (void)notifyReportResult:(int)arg1 success:(_Bool)arg2;
