...
+ (void)updateAudioOutputSettings:(id)arg1;
...
+ (id)anchorCaptionSegmentsForClipSegment:(id)arg1 captionGroups:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
+ (void)findBestMatchStyleID:(id *)arg1 colorID:(id *)arg2 fontName:(id *)arg3 animPresetID:(id *)arg4 forAnchoringSegmentWithType:(unsigned long long)arg5;
+ (id)latestUsedMaterialCacheItemForSegmentType:(unsigned long long)arg1;
...
+ (void)commitTimelineUpdateWithIsFullUpdate:(_Bool)arg1;
