...
- (void).cxx_destruct;
@property(nonatomic) _Bool isDetailPagHasPlay; // @synthesize isDetailPagHasPlay=_isDetailPagHasPlay;
...
- (_Bool)shouldShowAtmospherePagViewAtDetailView;
