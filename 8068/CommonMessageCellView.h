...
@class AppMessageBlockButton, CADisplayLink, CTRichTextView, CommonMessageCellViewExtTarget, CommonMessageViewModel, MMCPLabel, MMHeadImageView, MMInputMsgReferView, MMUIActivityIndicatorView, NSString, TextStateItemView, UIButton, UIImageView, UILabel, UIView, UIVisualEffectView, YYAsyncImageView;
