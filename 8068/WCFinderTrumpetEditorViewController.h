...
@interface WCFinderTrumpetEditorViewController
{
    ...
    NSString *_localUploadedHeadImageURL;
    UIView *_lastLineView;
}

- (void).cxx_destruct;
@property(nonatomic) __weak UIView *lastLineView; // @synthesize lastLineView=_lastLineView;
@property(copy, nonatomic) NSString *localUploadedHeadImageURL; // @synthesize localUploadedHeadImageURL=_localUploadedHeadImageURL;
