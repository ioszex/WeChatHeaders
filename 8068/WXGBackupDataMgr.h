...
@class NSCondition, NSData, NSLock, NSMutableArray, NSString, PacketFilterResponse, WXGBackupDataMgrConfig, WXGBackupMgrAnalyseInfo, WXGBackupMsgMgr;
...
@property(retain, nonatomic) NSString *mgrOwner; // @synthesize mgrOwner=_mgrOwner;
