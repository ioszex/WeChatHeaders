...
- (_Bool)markReadUserLatestStatus:(id)arg1;
- (id)deleteLocalPublishStatusInfo:(id)arg1;
...
- (void)initIconConfigAsync:(id)arg1 on:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)initIconConfigAsync:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)updateConfig:(id)arg1;
- (id)getAllCacheStatsInfo;
- (void)constructStatusInfoCache;
- (void)initWithRootDirUserNameClientVersionIsDebugMediaDirPath:(id)arg1 userName:(id)arg2 clientVersion:(int)arg3 isDebug:(_Bool)arg4 mediaDirPath:(id)arg5;
