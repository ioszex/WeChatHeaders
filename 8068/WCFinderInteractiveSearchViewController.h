...
+ (void)displayOnViewController:(id)arg1 tabType:(int)arg2 subTabType:(int)arg3 selectTab:(int)arg4 closeCallback:(CDUnknownBlockType)arg5;
+ (void)displayOnViewController:(id)arg1 tabType:(int)arg2 closeCallback:(CDUnknownBlockType)arg3;
- (void).cxx_destruct;
