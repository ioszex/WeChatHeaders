...
@interface CEmoticonWrap : NSObject
{
    ...
    _Bool _recommendFromSelfRefresh;
    ...
    unsigned int _m_storeUnique;
    unsigned int _recommendEmojiFrom;
    int _scene;
    NSString *_m_nsAppID;
    ...
    NSString *_m_query;
    unsigned long long _recommendRequestId;
    NSString *_fromSearchKey;
    NSString *_recommmendReason;
}

+ (void)initialize;
+ (void)PBArrayAdd_m_storeUnique;
...
@property(retain, nonatomic) NSString *recommmendReason; // @synthesize recommmendReason=_recommmendReason;
...
@property(nonatomic) _Bool recommendFromSelfRefresh; // @synthesize recommendFromSelfRefresh=_recommendFromSelfRefresh;
@property(nonatomic) unsigned long long recommendRequestId; // @synthesize recommendRequestId=_recommendRequestId;
@property(nonatomic) unsigned int recommendEmojiFrom; // @synthesize recommendEmojiFrom=_recommendEmojiFrom;
...
@property(nonatomic) unsigned int m_storeUnique; // @synthesize m_storeUnique=_m_storeUnique;
