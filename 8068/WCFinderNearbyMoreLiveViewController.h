...
@class MISSING_TYPE, MMUIButton, NSMutableDictionary, NSString, UIColor, UIView, WCFinderCreateCoordinator, WCFinderEmptyTipsView, WCFinderLivePageStayReporter, WCFinderLiveTabInfo, WCFinderNearbyMoreLiveViewModel, WCFinderTabPageView;
...
@interface WCFinderNearbyMoreLiveViewController
{
    ...
    MISSING_TYPE *_redDotModeObjectId;
...
- (id)finderMoreLivePageViewMangerChannelExtra:(id)arg1 contentVM:(id)arg2 isFold:(_Bool)arg3 index:(unsigned long long)arg4;
- (void)finderMoreLivePageViewMangerEnterLive:(id)arg1 contentVM:(id)arg2 isFold:(_Bool)arg3 index:(unsigned long long)arg4 isAutoPlaying:(_Bool)arg5;
...
- (void)dealloc;
- (id)initWithLiveTabList:(id)arg1 selectedTabId:(unsigned long long)arg2 fromScene:(int)arg3 jumpBuffer:(id)arg4;
