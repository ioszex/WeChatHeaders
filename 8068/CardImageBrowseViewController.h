...
{
    _Bool _biSHiddenButtonTool;
    _Bool _biSHiddenDeleteButton;
    _Bool _biSHiddenPageCtrl;
    _Bool _biSDisabledLongPress;
...
@property(nonatomic) _Bool biSDisabledLongPress; // @synthesize biSDisabledLongPress=_biSDisabledLongPress;
@property(nonatomic) _Bool biSHiddenPageCtrl; // @synthesize biSHiddenPageCtrl=_biSHiddenPageCtrl;
@property(nonatomic) _Bool biSHiddenDeleteButton; // @synthesize biSHiddenDeleteButton=_biSHiddenDeleteButton;
@property(nonatomic) _Bool biSHiddenButtonTool; // @synthesize biSHiddenButtonTool=_biSHiddenButtonTool;
...
- (void)resetButtonToolHidden:(_Bool)arg1;
- (id)currentImage;
