...
@interface WCFinderLbsLiveStreamCGI
{
    ...
    NSString *_byPass;
    NSString *_jumpNavliveBufferEncode;
...
@property(copy, nonatomic) NSString *jumpNavliveBufferEncode; // @synthesize jumpNavliveBufferEncode=_jumpNavliveBufferEncode;
...
- (void)start;
- (id)initWithLastBuffer:(id)arg1 longitude:(double)arg2 latitude:(double)arg3 clientStatus:(id)arg4 liveClientStatus:(id)arg5 pullType:(unsigned long long)arg6 readStats:(id)arg7 markUnreadList:(id)arg8 fromScene:(int)arg9 commentScene:(int)arg10 tabTipsInfo:(id)arg11 byPass:(id)arg12 beforeJoinLiveStatus:(id)arg13 relatedObjectId:(unsigned long long)arg14 liveTabInfo:(id)arg15 onlyFollowFeed:(_Bool)arg16 cacheDurationInSeconds:(unsigned long long)arg17 jumpNavliveBufferEncode:(id)arg18 successful:(CDUnknownBlockType)arg19 failure:(CDUnknownBlockType)arg20;
