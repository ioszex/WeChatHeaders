...
@class CgiCollectConfig, CgiReportDataController, CgiReportDataSender, CgiReportFlowGuarder, CgiReportItemConfiger, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
...
@interface CgiReportDataService
{
    ...
    NSMutableSet *_liteAppCustomReportBizIds;
    NSMutableDictionary *_collectConfigs;
    CgiCollectConfig *_defaultCollectConfig;
    CgiReportItemConfiger *_configer;
}

+ (id)sharedSerialQueue;
- (void).cxx_destruct;
@property(retain, nonatomic) CgiReportItemConfiger *configer; // @synthesize configer=_configer;
@property(retain, nonatomic) CgiCollectConfig *defaultCollectConfig; // @synthesize defaultCollectConfig=_defaultCollectConfig;
@property(retain, nonatomic) NSMutableDictionary *collectConfigs; // @synthesize collectConfigs=_collectConfigs;
@property(retain, nonatomic) NSMutableSet *liteAppCustomReportBizIds; // @synthesize liteAppCustomReportBizIds=_liteAppCustomReportBizIds;
...
- (id)checkToReturnCollectConfig:(unsigned int)arg1;
...
- (_Bool)sendH5AppReportData:(unsigned int)arg1 andIsBatchReport:(_Bool)arg2 andJsonArray:(id)arg3;
- (_Bool)sendLiteAppReportData:(unsigned int)arg1 andIsBatchReport:(_Bool)arg2 andJsonArray:(id)arg3;
- (_Bool)sendLiteAppCustomBatchReportData:(unsigned int)arg1 andIsBatchReport:(_Bool)arg2 andJsonArray:(id)arg3;
