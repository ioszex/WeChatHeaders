...
+ (void)savePhotoToSystemAlbum:(id)arg1 exifExtraInfo:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
+ (void)savePhotoToSystemAlbum:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
