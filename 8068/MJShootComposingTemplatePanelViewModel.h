...
@class MJShootComposingTemplateSinglePageViewModel, MJShootComposingViewModel, MJShootTemplateItemReportModel, MMCameraTemplateItem, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UBDictionarySignal, WCGetCameraTemplateListParams;
