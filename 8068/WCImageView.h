...
@interface WCImageView
{
    ...
    unsigned long long _imageViewScene;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long imageViewScene; // @synthesize imageViewScene=_imageViewScene;
...
- (void)manuallySetImageViewScene:(unsigned long long)arg1;
