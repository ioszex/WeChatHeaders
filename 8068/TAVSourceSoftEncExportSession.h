...
@class AVAssetReaderAudioMixOutput, AVAssetReaderVideoCompositionOutput, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, NSCondition, NSError, NSObject, NSURL, TAVExportReportData, TAVImageProcessor, TAVSourceExportReader;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(retain, nonatomic) TAVImageProcessor *processor; // @synthesize processor=_processor;
