...
@class BaseResponse, FinderJumpInfo, FinderLivePersonalCenterPrepareInfo, FinderPrivacySetting, GameRankSwitchInfo, JoinLiveInvisiableSwitchInfo, NSMutableArray, NSString, PlayHistorySettings, PostActionWording, PrepareFinder, PrepareFinderRealNameInfo, RecommendPersonalizedConfig, RelatedWxAcctInfo;
