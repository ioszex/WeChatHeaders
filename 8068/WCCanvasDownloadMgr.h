...
- (void)preloadH5ForSnsAdUrl:(id)arg1 advertiseInfo:(id)arg2 notAppendParams:(_Bool)arg3;
...
- (void)stopPreDownloadVideoForFlipCardInfo:(id)arg1;
- (void)preDownloadMediaWith:(id)arg1 preloadConfigInfo:(id)arg2 isStreamMode:(_Bool)arg3;
- (void)preDownloadFlipCardInfo:(id)arg1 preloadConfigInfo:(id)arg2 isStreamMode:(_Bool)arg3;
...
- (void)preDownloadAdBannerResourceWithDataItem:(id)arg1;
