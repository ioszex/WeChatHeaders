...
@class BaseResponse, FinderGetLiveMsgResp_ExtraClientConfig, FinderGetLiveMsgResp_LiveIntercomMicInfo, FinderGetLiveMsgResp_LiveMsgClientConfig, FinderJumpInfo, FinderLiveAudienceEventInfo, FinderLiveBackendPeriodSeiInfo, FinderLiveBadgeInfo, FinderLiveBubbleInfo, FinderLiveCheerInfo, FinderLiveContact, FinderLiveExtFlag, FinderLiveFanClubInfo, FinderLiveGameData, FinderLiveInfo, FinderLiveMicInfo, FinderLiveModModifyLiveCoverImageResponse, FinderLiveModeInfo, FinderLiveNoticeBubbleInfo, FinderLiveNpsSurveyTask, FinderLivePreloadInfo, FinderLivePromoteExtInfo, FinderLiveRealnameLikeBubbleInfo, FinderLiveUserQuitLiveGuideInfo, FinderLocation, NSData, NSMutableArray, OnQualityChangeInfo;
...
@property(nonatomic) unsigned long long curForwardCount; // @dynamic curForwardCount;
...
@property(retain, nonatomic) FinderGetLiveMsgResp_ExtraClientConfig *extraClientConfig; // @dynamic extraClientConfig;
...
@property(retain, nonatomic) FinderLiveBubbleInfo *liveBubbleInfo; // @dynamic liveBubbleInfo;
...
@property(retain, nonatomic) FinderLiveNpsSurveyTask *npsSurveyTask; // @dynamic npsSurveyTask;
