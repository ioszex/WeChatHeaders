...
- (_Bool)handleConflictWithNewFinderLiveContentVMs:(id)arg1 selectedIndex:(id)arg2 navigationController:(id)arg3 tabType:(long long)arg4 commentScene:(int)arg5 replayEntryType:(id)arg6 useVerticalFullscreenMinimization:(_Bool)arg7 routeParam:(id)arg8;
