...
+ (id)appMessageStyle;
+ (CDUnknownBlockType)fixshortLengthCalculationWithLength:(double)arg1;
...
- (struct CGSize)estimateSizeForOriginSize:(struct CGSize)arg1 allowSquareStyle:(_Bool)arg2;
