...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderVideoProducerOptions, WCFinderVideoProducerPreloadConfigs, WCMomentsPostReportSession;

@interface WCFinderVideoProducerDataManager : NSObject
{
    ...
    WCFinderVideoProducerPreloadConfigs *_preloadConfigs;
...
@property(retain, nonatomic) WCFinderVideoProducerPreloadConfigs *preloadConfigs; // @synthesize preloadConfigs=_preloadConfigs;
...
- (void)setCreateSameTemplateList:(id)arg1;
- (id)createSameTemplateList;
