...
@class MMTimer, MemoryMappedKV, NSMutableArray, NSMutableSet, NSString;

@interface MPPageRelatedInfoMgr
{
    unsigned int _refreshIntervalSec;
    unsigned int _maxRequestUrlCount;
    MemoryMappedKV *_relatedInfoSlotMMKV;
    MemoryMappedKV *_url2LastUpdateTimeSlotMMKV;
...
@property(retain, nonatomic) MemoryMappedKV *url2LastUpdateTimeSlotMMKV; // @synthesize url2LastUpdateTimeSlotMMKV=_url2LastUpdateTimeSlotMMKV;
@property(retain, nonatomic) MemoryMappedKV *relatedInfoSlotMMKV; // @synthesize relatedInfoSlotMMKV=_relatedInfoSlotMMKV;
