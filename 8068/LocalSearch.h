...
+ (_Bool)checkContactContainsOriginalText:(id)arg1 contact:(id)arg2;
+ (void)SortContactsWithOriginalTextPriority:(id)arg1 dicMatchTip:(id)arg2 dicSessionTime:(id)arg3 originalText:(id)arg4;
...
+ (id)searchFromMinimizeTaskItem:(id)arg1 allMinimizeTaskItem:(id)arg2 dicMatchTip:(id)arg3;
