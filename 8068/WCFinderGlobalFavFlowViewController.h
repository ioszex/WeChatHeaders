...
@class NSMutableSet, NSString, UILabel, UIView, WCFinderExtStatsReporter, WCFinderFeedFlowView, WCFinderGlobalFavFlowPageViewModel, WCFinderGlobalFavFlowViewModel, WCFinderRichTextView, WCSearchBar;
