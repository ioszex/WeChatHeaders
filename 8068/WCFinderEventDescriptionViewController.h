...
@class FinderEventInfo, MISSING_TYPE, MMUIButton, MMUILabel, NSString, RichTextView, UILabel, UIScrollView, UIView, WCFinderAuthInfoIconView, WCFinderHeadImageView;
