...
@class AVAsset, MMUIButton, MMUILabel, NSString, SightLocalVideoImageSlider, UIColor;
...
@interface EditVideoCropView
{
    ...
    _Bool _showCropVideoTotalTimeLabel;
    _Bool _ignoreShock;
    ...
    MMUILabel *_cropVideoDurationLable;
    struct CGPoint _sliderContentOffset;
    CDStruct_e83c9415 _timeRange;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMUILabel *cropVideoDurationLable; // @synthesize cropVideoDurationLable=_cropVideoDurationLable;
...
@property(nonatomic) _Bool showCropVideoTotalTimeLabel; // @synthesize showCropVideoTotalTimeLabel=_showCropVideoTotalTimeLabel;
...
- (void)initView;
- (void)setCropVideoDurationLableShow:(_Bool)arg1;
