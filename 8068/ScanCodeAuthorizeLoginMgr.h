...
@class GetUserGrantInfoBuffer, MMWebViewController, NSMutableArray, NSMutableDictionary, NSString, OauthScopeInfo, QRConnectAuthorizeResp, ScanCodeAuthorizeBaseViewController, SetUserGrantInfoBuffer;
