...
@interface MMLiveLikeDataMgr
{
    ...
    SafeMutableDictionary *_previousLikeCountDic;
...
@property(retain, nonatomic) SafeMutableDictionary *previousLikeCountDic; // @synthesize previousLikeCountDic=_previousLikeCountDic;
...
- (void)clearPreviousLikeCountWithTaskId:(id)arg1;
- (void)updatePreviousLikeCountWithIncreaseCount:(unsigned long long)arg1 taskId:(id)arg2;
- (unsigned long long)getPreviousLikeCountWithTaskId:(id)arg1;
...
- (void)addLiveLikePostWithTaskId:(id)arg1 isClipMode:(_Bool)arg2 isDoubleClick:(_Bool)arg3;
...
- (void)postLiveLikeWithTaskId:(id)arg1 isClipMode:(_Bool)arg2 isDoubleClicked:(_Bool)arg3;
