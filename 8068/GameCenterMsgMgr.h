...
@class GCMRedpointExposureControlModel, GCRedPointLogicTypeModel, GameCenterMessageRedPointInfo, GameCenterMsgDb, GameFindEntryRedDotInfo, GameMessageDBCleaner, GameMsgSecurityCheck, GameReddotManager, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
...
@interface GameCenterMsgMgr
{
    ...
    GameMsgSecurityCheck *_msgSecurityCheck;
...
@property(retain, nonatomic) GameMsgSecurityCheck *msgSecurityCheck; // @synthesize msgSecurityCheck=_msgSecurityCheck;
...
- (void)reportMsgVerifyFailed:(id)arg1;
- (void)handleReddotMsg:(id)arg1;
- (void)checkMsgSecurity:(id)arg1;
