...
@class MMFinderGameLiveTabPageViewModel, MMFinderLiveGameSearchViewModel, MMFinderLiveGameStartParamModel, MMFinderLiveGameUserInfo, MMLiveGameRecentlyPalyedView, MMLiveTaskId, MMTableView, MMUIActivityIndicatorView, MMUIButton, MMUISearchBar, NSIndexPath, NSMutableArray, NSMutableDictionary, NSString, UIButton, UILabel, UIView, WCFinderGameLiveListHeaderView, WCFinderLiveStarterReporter, WCFinderTabPageView, WCTimeLineFooterView;
...
@interface WCFinderGameLiveListViewController
{
    ...
    MMFinderLiveGameStartParamModel *_gameLiveVM;
...
@property(retain, nonatomic) MMFinderLiveGameStartParamModel *gameLiveVM; // @synthesize gameLiveVM=_gameLiveVM;
