...
@interface WCCanvasPageViewController
{
    ...
    _Bool _isTheFirstTimeToTwistFromShareScene;
    ...
    WCCanvasFloatConversionBarView *;
    ...
    long long _previousRandomPickCardClickedIndex;
    WCAdRandomPickCardLogic *_randomPickCardLogic;
    WCAdRandomPickCardItemInfo *_randomPickCardVanishingItemInfo;
    WCAdRandomPickCardItemInfo *_randomPickCardStayPutItemInfo;
    unsigned long long _randomPickCardPendingState;
    ...
    struct CGRect _outOriginRectInScreen;
...
@property(nonatomic) _Bool isTheFirstTimeToTwistFromShareScene; // @synthesize isTheFirstTimeToTwistFromShareScene=_isTheFirstTimeToTwistFromShareScene;
@property(nonatomic) unsigned long long randomPickCardPendingState; // @synthesize randomPickCardPendingState=_randomPickCardPendingState;
@property(retain, nonatomic) WCAdRandomPickCardItemInfo *randomPickCardStayPutItemInfo; // @synthesize randomPickCardStayPutItemInfo=_randomPickCardStayPutItemInfo;
@property(retain, nonatomic) WCAdRandomPickCardItemInfo *randomPickCardVanishingItemInfo; // @synthesize randomPickCardVanishingItemInfo=_randomPickCardVanishingItemInfo;
...
@property(nonatomic) long long previousRandomPickCardClickedIndex; // @synthesize previousRandomPickCardClickedIndex=_previousRandomPickCardClickedIndex;
...
@property(nonatomic) struct CGRect outOriginRectInScreen; // @synthesize outOriginRectInScreen=_outOriginRectInScreen;
@property(nonatomic) long long outClickedIndex; // @synthesize outClickedIndex=_outClickedIndex;
...
- (void)onRedEnvelopesRepeatPickClick;
...
- (_Bool)onRandomPickCardIsARedEnvelopReceiveCardPicked;
- (_Bool)onRandomPickCardIsARedEnvelopGiveCardPicked;
...
- (void)onRandomPickCardComponentUpdateStayPutItemWithInfo:(id)arg1;
- (void)onRandomPickCardComponentUpdateVanishingItemInfoWith:(id)arg1;
...
- (void)onRandomPickCardComponentDidClick:(id)arg1 isPicked:(_Bool)arg2 index:(unsigned long long)arg3;
...
- (void)tryToUpdateRandomPickCardSortedItemsForPageId:(id)arg1 cardId:(id)arg2;
...
- (void)onFlyingFlipAnimationStage1DoneWithFlyingView:(id)arg1 containerView:(id)arg2;
- (void)randomEncoreFireFlyingFlipAction;
- (id)flyingFlipAnimateGenerateFlipBackView;
- (void)flyingFlipAnimateAsyncShowCanvasView:(id)arg1 delay:(double)arg2;
- (void)eggFlyingFlipAnimateTransition:(id)arg1 fromVC:(id)arg2 toVC:(id)arg3 fromView:(id)arg4 toView:(id)arg5 flyingFlipInfo:(id)arg6;
...
- (long long)fetchPreviousClickedIndexForComponentItem:(id)arg1;
