...
@class CMMDB, NSArray, NSMutableArray, NSMutableDictionary, NSRecursiveLock;
...
@interface SyncCmdHandler
{
    ...
    NSArray *_arrNewInsertMsg;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *arrNewInsertMsg; // @synthesize arrNewInsertMsg=_arrNewInsertMsg;
...
- (void)handleClearHadDeleteHelloInInsertNewHelloMsg:(id)arg1 HelloUser:(id)arg2;
