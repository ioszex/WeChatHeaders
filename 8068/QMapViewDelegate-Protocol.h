...
@class NSArray, NSError, NSString, QAnnotationView, QMapView, QMarker, QOverlayView, QPoiInfo, QUserLocation, UIControl, UIView;
...
- (void)mapView:(QMapView *)arg1 markerOverlay:(QMarker *)arg2 didChangeDragState:(int)arg3 fromOldState:(int)arg4;
- (void)mapView:(QMapView *)arg1 didTapMarkerOverlayCallout:(QMarker *)arg2;
