...
@class FinderJumpInfo, MMFinderLiveGameStartParamModel, MMLiveStarterViewController, NSArray, NSMutableArray, NSString, WCFinderRedDotCtrlInfo, WCFinderRedDotTipsShowInfo;
...
- (void)onMMLiveStarterViewControllerOrientationChanged:(MMLiveStarterViewController *)arg1;
...
- (void)onMMLiveStarterViewControllerStartGameLiveWithViewModel:(MMFinderLiveGameStartParamModel *)arg1;
