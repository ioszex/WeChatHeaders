...
@class MMUINavigationController, NSArray, NSDictionary, NSMutableArray, NSString, UIView, UIViewController, WACacheVersionPreCheckerContextResult, WAContact, WAPackageConfig, WAWebViewController;

@protocol WAAppTaskLoaderContextDelegate <NSObject>
- (void)onWANavigationControllerInsertToHeadless:(UIView *)arg1;
...
- (void)onDidPushChildWebView:(WAWebViewController *)arg1 animated:(_Bool)arg2;
...
- (void)cancelLoadingAndJumpToH5:(NSString *)arg1 blockReason:(unsigned int)arg2;
@end
