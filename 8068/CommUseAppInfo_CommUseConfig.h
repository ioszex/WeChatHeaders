...
@class CommUseAppInfo_CommUseConfig_CommUseWording, NSMutableArray, NSString;
...
@property(retain, nonatomic) CommUseAppInfo_CommUseConfig_CommUseWording *commuseWording; // @dynamic commuseWording;
...
@property(nonatomic) unsigned int nextReqIntervalS; // @dynamic nextReqIntervalS;
