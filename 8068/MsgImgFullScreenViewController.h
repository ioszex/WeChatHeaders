...
- (void)handleClickMMScrollActionSheetItem:(id)arg1;
- (void)handleClickDevice:(id)arg1;
- (void)handleRemoveFromStack;
- (void)newHandleClickWeAppOpenMaterial:(id)arg1;
...
- (void)addUseOtherApp:(_Bool)arg1;
