...
@class MJCamTemplateCdnDownloadManager, MJShootComposingDraftManager, MJTemplateSessionQueue, MMContext, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, OMJMaasCore;
...
@interface MJTemplateCoreManager
{
    ...
    NSString *_coreKey;
    MJShootComposingDraftManager *_mjShootDraftManager;
    ...
    MJCamTemplateCdnDownloadManager *_cdnDownloadManager;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MJCamTemplateCdnDownloadManager *cdnDownloadManager; // @synthesize cdnDownloadManager=_cdnDownloadManager;
...
@property(readonly, nonatomic) MJShootComposingDraftManager *mjShootDraftManager; // @synthesize mjShootDraftManager=_mjShootDraftManager;
