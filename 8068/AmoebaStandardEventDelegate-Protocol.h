...
@class AmoebaSubstitutePage, NSArray, NSDictionary, NSString;

@protocol AmoebaStandardEventDelegate <NSObject>
- (void)onReset;
...
- (void)onPageOut:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2 isSubPage:(_Bool)arg3;
- (void)onPageIn:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2 isSubPage:(_Bool)arg3;
- (void)onSessionOut:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2;
- (void)onSessionIn:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2;
- (void)onBizOut:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2;
- (void)onBizIn:(unsigned long long)arg1 page:(AmoebaSubstitutePage *)arg2;
