...
- (_Bool)changeChatRoomMsgNeedPushFlag:(id)arg1 needPushFlag:(unsigned int)arg2 sync:(_Bool)arg3;
...
- (_Bool)p_ChangeChatRoomAccessType:(id)arg1 type:(unsigned int)arg2 qrCodeAccessType:(unsigned int)arg3;
- (_Bool)ChangeChatRoomAccessType:(id)arg1 type:(unsigned int)arg2 qrCodeAccessType:(unsigned int)arg3;
