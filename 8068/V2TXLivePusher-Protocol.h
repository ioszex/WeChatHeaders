...
@class NSData, NSObject, NSString, TXAudioEffectManager, TXBeautyManager, TXDeviceManager, UIImage, UIView, V2TXLiveAudioFrame, V2TXLiveAudioFrameObserverFormat, V2TXLiveLocalRecordingParams, V2TXLiveTranscodingConfig, V2TXLiveVideoEncoderParam, V2TXLiveVideoFrame;
...
- (long long)enableAudioProcessObserver:(_Bool)arg1 format:(V2TXLiveAudioFrameObserverFormat *)arg2;
