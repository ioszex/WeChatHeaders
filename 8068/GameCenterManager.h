...
@class EntranceRedDot, GameLifeFindMoreFriendEntranceInfo, GameSearchRecommendList, GetGameCenterGlobalSettingResponse, GetGameIndex4Response, GetGameIndex4TabNavResponse, JumpInfo, MMLiteAppViewController, MMWebViewController, MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WAAppIdToUsernameTransfer;
