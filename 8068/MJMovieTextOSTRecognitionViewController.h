...
@class MJActionPanelMainMenuView, MJAudioExtractor, MJPlaybackViewModel, MJSpeechCgiHelper, MJTimelineViewController, MJTimelineViewModel, MMTimer, MMUIButton, MMUIImageView, MMUILabel, MMUIView, NSString, WCProgressCircleView;
