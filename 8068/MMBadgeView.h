...
@interface MMBadgeView : UIImageView
{
    ...
    CDUnknownBlockType _shapeChangeBlock;
    UILabel *_badgeLabel;
    double _badgeFontSize;
    unsigned long long _shape;
    UIColor *_bgColor;
    struct CGSize _badgeInset;
}
...
@property(nonatomic) struct CGSize badgeInset; // @synthesize badgeInset=_badgeInset;
...
@property(copy, nonatomic) CDUnknownBlockType shapeChangeBlock; // @synthesize shapeChangeBlock=_shapeChangeBlock;
...
- (void)updateWithContentInset:(struct CGSize)arg1;
...
- (void)updateShape:(unsigned long long)arg1;
