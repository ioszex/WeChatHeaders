...
@class MMUIButton, NSIndexPath, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UIView, WCFinderCommentLikeView, WCFinderCommentTranslateView, WCFinderFeedContentTextView, WCFinderFeedSubCommentCellStyleConfig, WCFinderHeadImageView, WCFinderInteractionLabelGroupView;
