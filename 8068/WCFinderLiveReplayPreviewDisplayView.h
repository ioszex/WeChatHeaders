...
@class MISSING_TYPE, MMFinderLiveReplayGreateTimeModel, MMFinderLiveReplayPreviewResolutionRecordInfo, MMFinderLiveReplayTask, MMFinderLiveTaskId, MMLiveStorageCleanupPinningToken, MMWebImageView, NSMutableArray, NSString, WCFinderLiveReplayPreviewImgLoader, WCFinderLiveReplayPreviewPlayerControlView, WCPlayerPlaybackInfo, WCPlayerView;
...
@interface WCFinderLiveReplayPreviewDisplayView : UIView
{
    ...
    MISSING_TYPE *_currPlayerInitialPos;
