...
// Error: Property attributes should begin with the type ('T') attribute, property name: canAutoConnect
...
- (void)onMMLiveConnectMicStatisticsPanelShowReplayWithFragmentItem:(id)arg1;
