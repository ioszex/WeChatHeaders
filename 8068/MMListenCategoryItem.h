...
@class MMListenCategoryItemJumpInfo, MMListenCategoryItem_FriendSharedRadioInfo, MMListenClassicMusicAlbumInfo, MMListenCoverInfo, MMListenJumpInfo, MMListenMpCategoryinfo, MMListenMusicStory, MMListenRecommendInfo, MMListenSimplePlaylistInfo, MMListenSingerInfo, MMListenUserInfo, NSMutableArray, NSString;
