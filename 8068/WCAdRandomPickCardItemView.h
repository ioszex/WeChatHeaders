...
@interface WCAdRandomPickCardItemView
{
    ...
    long long _extAnimationStatus;
}

- (void).cxx_destruct;
@property(nonatomic) long long extAnimationStatus; // @synthesize extAnimationStatus=_extAnimationStatus;
...
- (void)showFillUp:(_Bool)arg1 duration:(double)arg2;
- (void)showQuickFillUp:(_Bool)arg1;
- (void)showNormalFillUp:(_Bool)arg1;
- (void)prepareSubviewsForFillUp:(_Bool)arg1;
- (void)updateExtAnimationsStatus:(long long)arg1 animated:(_Bool)arg2;
- (void)updateCardLayerMaskSafely:(id)arg1;
