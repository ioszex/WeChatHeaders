...
- (long long)requestMusicRecommendWithTemplateID:(id)arg1 clientRequestID:(unsigned long long)arg2 clientBuffer:(id)arg3 recommendCompletionHandler:(CDUnknownBlockType)arg4;
