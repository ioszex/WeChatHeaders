...
@class NSMutableDictionary, NSTimer, NirvanaTextInputView, UIView, UIViewController, WXFlutterTextInputViewAccessibilityHider;
...
@interface NirvanaTextInputPlugin : NSObject
{
    ...
    WXFlutterTextInputViewAccessibilityHider *_inputHider;
...
@property(retain, nonatomic) WXFlutterTextInputViewAccessibilityHider *inputHider; // @synthesize inputHider=_inputHider;
