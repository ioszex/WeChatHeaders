...
@property(nonatomic) _Bool isAvoidPageSheet; // @synthesize isAvoidPageSheet=_isAvoidPageSheet;
...
@property(nonatomic) _Bool bIsNotUseParent; // @synthesize bIsNotUseParent=_bIsNotUseParent;
...
- (void)setHalfScreenDetailViewMarginTop:(double)arg1;
