...
@interface ReaderReporter : NSObject
{
    ...
    unsigned int _isCurrentPluginReport;
    NSString *_sessionId;
...
+ (void)reportTXNewsBoxAction:(unsigned long long)arg1 withMsg:(id)arg2;
...
@property(nonatomic) unsigned int isCurrentPluginReport; // @synthesize isCurrentPluginReport=_isCurrentPluginReport;
...
- (void)reportBrandPluginTemplateMsg:(id)arg1;
...
- (void)onHideTitle:(id)arg1 Readers:(id)arg2 readerSubtype:(unsigned int)arg3;
