...
@class FinderLiveNoticeInfo, FinderLiveNoticeListInfo, MMFinderLiveReserveNoticeLogic, NSString, UIView;
...
- (void)onLiveNoticeListInfoUpdatedWithTaskId:(id)arg1 noticeListInfo:(id)arg2;
