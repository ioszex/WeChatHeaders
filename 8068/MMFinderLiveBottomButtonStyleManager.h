...
@class FinderLiveButtonInfo, MMFinderLiveBottomButtonAnimationItem, MMFinderLiveBottomButtonBackgroundColorConfig, MMFinderLiveTaskId, MMLiveResourceFetcherLegacyApiAdapter, MMTimer, NSMutableArray, NSString;
...
- (void)loadGlobalIconResource:(id)arg1;
