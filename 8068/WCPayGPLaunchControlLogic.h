...
- (void)refreshGroupPayLaunchViewAfterSelectBillsFromTransactions:(id)arg1 amount:(long long)arg2;
...
- (void)onWCPayGPLaunchVCClickImportFromTransactions;
- (void)onWCPayGPLaunchVCClickImportFromSolitaire;
- (_Bool)showImportFromTransactionsEntry;
