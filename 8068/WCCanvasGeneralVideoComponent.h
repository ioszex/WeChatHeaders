...
@interface WCCanvasGeneralVideoComponent
{
    ...
    _Bool _forbidCheckWaitPlayingState;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool forbidCheckWaitPlayingState; // @synthesize forbidCheckWaitPlayingState=_forbidCheckWaitPlayingState;
