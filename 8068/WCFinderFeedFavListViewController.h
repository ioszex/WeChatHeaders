...
@class MMUIButton, NSMutableSet, NSString, UICollectionView, UICollectionViewFlowLayout, UILabel, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderFavInfo, WCFinderFeedFavListViewModel, WCFinderMagicAnimationLogic, WCFinderRichTextView, WCFinderStreamFooterView;
...
@interface WCFinderFeedFavListViewController
{
    ...
    WCFinderRichTextView *_stateTipsLabel;
...
@property(retain, nonatomic) WCFinderRichTextView *stateTipsLabel; // @synthesize stateTipsLabel=_stateTipsLabel;
