...
+ (id)tlProfileDragHelperWithFrontContainer:(id)arg1 frontInitialTop:(double)arg2 frontTableView:(id)arg3 scene:(unsigned long long)arg4 isModeTall:(_Bool)arg5;
- (void).cxx_destruct;
...
- (void)setCurrentDragProgressOnlyHeight:(double)arg1;
- (void)refreshLayout;
