...
@interface MMWebViewPresetUI
{
    ...
    _Bool _isWebViewFakeimmersiveUIStyle;
    ...
    NSString *_navigationBarPlaceholderTitle;
...
@property(nonatomic) _Bool isWebViewFakeimmersiveUIStyle; // @synthesize isWebViewFakeimmersiveUIStyle=_isWebViewFakeimmersiveUIStyle;
...
@property(copy, nonatomic) NSString *navigationBarPlaceholderTitle; // @synthesize navigationBarPlaceholderTitle=_navigationBarPlaceholderTitle;
