...
@class IConfSDKRegisterableCallbackHolder, MMConfSDKVideoHWenc, MMOpenVoiceAudioMgr, MMOpenVoiceJoinRoomCGIImp, MMOpenVoiceMemberMgr, MMOpenVoiceNetworkMgr, MMOpenVoiceRecorder, MMOpenVoiceSessionMgr, MMOpenVoiceVideoMgr, NSObject, NSString, VoIPConfSDKNativeCallbackMgr;
...
- (void)exitFullScreenWithOpenId:(id)arg1 complete:(CDUnknownBlockType)arg2;
- (void)requestFullScreenWithOpenId:(id)arg1 direction:(int)arg2 complete:(CDUnknownBlockType)arg3;
- (void)setBackgroundEffectMode:(id)arg1 mode:(int)arg2 enable:(_Bool)arg3 complete:(CDUnknownBlockType)arg4;
- (void)stopRecordWithOpenId:(id)arg1 args:(id)arg2 complete:(CDUnknownBlockType)arg3;
- (void)startRecordWithOpenId:(id)arg1 recordMode:(long long)arg2 shouldSaveRecordFile:(long long)arg3 extraData:(id)arg4 complete:(CDUnknownBlockType)arg5;
- (void)takeSnapshotWithOpenId:(id)arg1 complete:(CDUnknownBlockType)arg2;
