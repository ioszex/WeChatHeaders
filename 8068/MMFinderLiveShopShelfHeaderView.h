...
@class MMFinderLiveShopShelfAudienceHeaderButtonGroupView, MMFinderLiveShopShelfDisplayWindowButton, MMFinderLiveShopShelfHeaderGuideBar, MMFinderLiveShopShelfHeaderSubInfosView, MMFinderLiveShopShelfHeaderViewModel, MMLiveShopShelfDragBar, MMUIButton, NSString, UIButton;
