...
@class NSArray, NSDictionary, NSMutableArray, NSString, UIView, UIViewController, WACacheVersionPreCheckerContextResult, WAContact, WACustomLoadingViewController, WAPackageConfig, WAUINavigationController, WAWebViewController;
