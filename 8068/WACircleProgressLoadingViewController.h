...
@interface WACircleProgressLoadingViewController
{
    ...
    WCTagsView *_financialLicenseImageView;
...
@property(retain, nonatomic) WCTagsView *financialLicenseImageView; // @synthesize financialLicenseImageView=_financialLicenseImageView;
