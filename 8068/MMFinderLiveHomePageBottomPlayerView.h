...
@class CAShapeLayer, MMFinderLiveHomePageBottomPlayerViewModel, MMUIButton, MMUILabel, NSString, RichTextView, UIImageView, UIPanGestureRecognizer, WCFinderAuthInfoIconView, WCFinderHeadImageView;
