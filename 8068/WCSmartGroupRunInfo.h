...
@interface WCSmartGroupRunInfo : NSObject
{
    ...
    _Bool _bRepick;
    _Bool _bNewSearchRecommendGroup;
    unsigned int _totalGroupCnt;
    unsigned int _totalMMCnt;
    unsigned int _searchRecommendGroupDiff;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int searchRecommendGroupDiff; // @synthesize searchRecommendGroupDiff=_searchRecommendGroupDiff;
@property(nonatomic) _Bool bNewSearchRecommendGroup; // @synthesize bNewSearchRecommendGroup=_bNewSearchRecommendGroup;
