...
+ (id)createWebViewController:(id)arg1 Url:(id)arg2 loadMode:(unsigned long long)arg3 preload:(_Bool)arg4 checkLimitedMode:(_Bool)arg5;
+ (id)createWebViewController:(id)arg1 Url:(id)arg2 loadMode:(unsigned long long)arg3 checkLimitedMode:(_Bool)arg4;
...
+ (id)getGameCenterWebViewController:(id)arg1 Url:(id)arg2 checkLimitedMode:(_Bool)arg3;
+ (id)getGameCenterWebViewController:(id)arg1 Url:(id)arg2;
+ (id)createPreloadHomeWebViewController:(id)arg1 Url:(id)arg2;
+ (id)getGameCenterWebViewController:(_Bool)arg1 EntryScene:(id)arg2 Url:(id)arg3 presetUI:(id)arg4 loadMode:(unsigned long long)arg5 preload:(_Bool)arg6 checkLimitedMode:(_Bool)arg7;
+ (id)getDefaultImage;
