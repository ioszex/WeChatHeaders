...
@interface MMFinderLiveMoreFunctionItem : NSObject
{
    ...
    NSString *_switchDisabledToastText;
...
@property(retain, nonatomic) NSString *switchDisabledToastText; // @synthesize switchDisabledToastText=_switchDisabledToastText;
...
@property(readonly, nonatomic) _Bool isSelectedShadow;
