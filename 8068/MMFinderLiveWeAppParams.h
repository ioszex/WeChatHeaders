...
@interface MMFinderLiveWeAppParams : NSObject
{
    ...
    _Bool _forbidAutoFullScreenWhenTap;
    ...
    CDUnknownBlockType _appTaskRunningEventHandle;
}

- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType appTaskRunningEventHandle; // @synthesize appTaskRunningEventHandle=_appTaskRunningEventHandle;
...
@property(nonatomic) _Bool forbidAutoFullScreenWhenTap; // @synthesize forbidAutoFullScreenWhenTap=_forbidAutoFullScreenWhenTap;
