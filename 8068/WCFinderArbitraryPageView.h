...
@class MMNavBarInteractiveConfig, MMUIViewController, NSArray, NSMutableDictionary, NSString, UILabel, UIScrollView, UIViewController, WCFinderAnimationLoadingView, WCFinderArbitraryPageScrollProcess, WCFinderArbitraryReuseItem, WCFinderTabSwitchView;
...
@interface WCFinderArbitraryPageView : UIView
{
    ...
    _Bool _uninstallTabSwitchView;
    _Bool _allowPreload;
    _Bool _headerPinTop;
    _Bool _hasInitialized;
    _Bool _hasInstallToWindow;
    ...
    WCFinderArbitraryReuseItem *_reuseHead;
    long long _processDequeueIndex;
...
@property(nonatomic) _Bool hasInstallToWindow; // @synthesize hasInstallToWindow=_hasInstallToWindow;
...
@property(nonatomic) long long processDequeueIndex; // @synthesize processDequeueIndex=_processDequeueIndex;
@property(retain, nonatomic) WCFinderArbitraryReuseItem *reuseHead; // @synthesize reuseHead=_reuseHead;
...
@property(retain, nonatomic) UIView *tabViewBox; // @synthesize tabViewBox=_tabViewBox;
...
- (void)setFadeNavBarOffset:(double)arg1;
- (double)fadeNavBarOffset;
@property(retain, nonatomic) UIView *headerView; // @synthesize headerView=_headerView;
@property(nonatomic) _Bool allowPreload; // @synthesize allowPreload=_allowPreload;
@property(nonatomic) _Bool uninstallTabSwitchView; // @synthesize uninstallTabSwitchView=_uninstallTabSwitchView;
