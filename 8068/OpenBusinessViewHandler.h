...
- (void)handleNativeOpenWxSearchWithAppID:(id)arg1 queryInfo:(id)arg2 extInfo:(id)arg3 jumpViewController:(id)arg4;
...
- (void)didGetLiteAppVC:(id)arg1 openInfo:(id)arg2 context:(id)arg3;
