...
- (void).cxx_destruct;
@property(nonatomic) _Bool isLimitMode; // @synthesize isLimitMode=_isLimitMode;
...
- (void)onPlayEnd;
- (void)playLive;
- (void)updateAudienceCardViewWithType:(unsigned long long)arg1 liveDataItem:(id)arg2 replayDataItem:(id)arg3 isLimitMode:(_Bool)arg4;
