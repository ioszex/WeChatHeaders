...
@class NSDictionary, NSString, WAContact;
...
@interface WAAppTaskReferrerInfo : NSObject
{
    ...
    NSDictionary *_externalFileRefs;
...
@property(retain, nonatomic) NSDictionary *externalFileRefs; // @synthesize externalFileRefs=_externalFileRefs;
