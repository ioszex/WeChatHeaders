...
@class NSArray, NSMutableArray, NSString, WAContactGetter;
...
@interface WAOpenSDKJSEventHandleLogic : NSObject
{
    ...
    NSArray *_needBusinessSelfCloseWebviewList;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *needBusinessSelfCloseWebviewList; // @synthesize needBusinessSelfCloseWebviewList=_needBusinessSelfCloseWebviewList;
...
- (void)executeQRCodeResult:(long long)arg1 respData:(id)arg2 invokeContext:(id)arg3;
