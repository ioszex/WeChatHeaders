...
@class CAAnimationGroup, CABasicAnimation, CameraScanBlurButtonWrapView, CameraScanCodesCenterDotView, CameraScanCombineContentView, CameraScannerViewWrapper, ImageFitWithBlurredBackgroundView, MMUIButton, NSMutableArray, NSString, UIImageView, UILabel, UIView;
