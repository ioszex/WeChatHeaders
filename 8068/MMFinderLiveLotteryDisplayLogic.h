...
@interface MMFinderLiveLotteryDisplayLogic : NSObject
{
    ...
    CDUnknownBlockType _updateLotteryStateBlock;
...
@property(copy, nonatomic) CDUnknownBlockType updateLotteryStateBlock; // @synthesize updateLotteryStateBlock=_updateLotteryStateBlock;
