...
@class FinderLocation, MMFinderLiveGameUserInfo, MMFinderLiveImageOcrOp, MMFinderLivePromoteManageLogic, MMFinderLiveTask, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSString, WCFinderLiveStarteGameModeCacheModel;
@protocol WCFinderStarterLiveGameViewModelDelegate;

@interface WCFinderLiveStarteGameModeViewModel
{
    _Bool _useLocalCover;
    ...
    WCFinderLiveStarteGameModeCacheModel *_gameModeCacheModel;
...
@property(nonatomic) _Bool useLocalCover; // @synthesize useLocalCover=_useLocalCover;
...
@property(retain, nonatomic) WCFinderLiveStarteGameModeCacheModel *gameModeCacheModel; // @synthesize gameModeCacheModel=_gameModeCacheModel;
...
- (void)updateLiveDescription:(id)arg1 liveDescriptionExtend:(id)arg2;
- (void)updateGameLiveCoverMediaUrlWithFinderMedia:(id)arg1;
- (_Bool)updateGameLiveDataItem;
@property(readonly, nonatomic) MMFinderLiveTask *finderLiveTask;
- (id)getLiveCoverUrl;
- (void)updateLiveCoverUrl:(id)arg1 useLocalCover:(_Bool)arg2;
- (void)fetchLocation;
...
- (void)updateLiveGameUserInfo:(id)arg1;
