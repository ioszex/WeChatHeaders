...
@class AmoebaGeneralMonitorDelegateProxy, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, UIScrollView, UIWindow;
@protocol AmoebaGeneralMonitorDelegate;

@interface AmoebaGeneralMonitor : NSObject
{
...
@property(nonatomic) __weak id <AmoebaGeneralMonitorDelegate> monitorDelegate;
- (void)initMonitor;
