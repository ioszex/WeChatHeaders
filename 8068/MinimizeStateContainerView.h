...
- (id)passiveStateCacheKey:(unsigned int)arg1 withTask:(id)arg2;
- (id)getPassiveStateView:(unsigned int)arg1 withStateTask:(id)arg2;
...
- (id)highLightedViewForTaskData:(id)arg1;
