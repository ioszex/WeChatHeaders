...
@class AmoebaSubstitutePage, AmoebaSubstitutePageStack, NSMutableArray, NSMutableDictionary, NSString, UIViewController;
@protocol AmoebaStandardEventDelegate;

@interface AmoebaEventMonitor : NSObject
{
    ...
    id <AmoebaStandardEventDelegate> _delegate;
}

+ (id)shareInstance;
- (void).cxx_destruct;
@property(retain, nonatomic) id <AmoebaStandardEventDelegate> delegate; // @synthesize delegate=_delegate;
- (void)setFinderLastestEnterMethod:(id)arg1;
...
- (void)setPageInfoWhenVcAppear:(id)arg1;
...
- (void)appBackground:(unsigned long long)arg1 outType:(unsigned long long)arg2;
- (void)appForeground:(unsigned long long)arg1 inType:(unsigned long long)arg2;
...
- (void)clearPage:(id)arg1 time:(unsigned long long)arg2;
