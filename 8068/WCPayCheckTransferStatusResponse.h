...
@class MISSING_TYPE, NSArray, NSMutableArray, NSString, NoticeItem, RecvAccountInfo, RecvCustomerInfoModule, WCPayAddressInfo, WCPayExposureInfo, WCPayTextInfo, WCPayTransferResendInfo;

@interface WCPayCheckTransferStatusResponse : NSObject
{
    MISSING_TYPE *m_uiTransferStatus;
