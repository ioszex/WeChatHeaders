...
@class GameCenterMsgBubbleInfo, GameCenterMsgMessageCenterInfo, GameCenterMsgReportInfo, GameCenterMsgTimeInfo, GameCenterMsgV2Node, GameCenterTabInfoNode, GameLifeInfo, NSString, ReddotVerifyInfo;
...
@interface GameCenterCommMsg
{
    ...
    ReddotVerifyInfo *_verifyInfo;
}

- (void).cxx_destruct;
@property(retain, nonatomic) ReddotVerifyInfo *verifyInfo; // @synthesize verifyInfo=_verifyInfo;
...
- (id)parseVerifyInfo:(struct XmlReaderNode_t *)arg1;
