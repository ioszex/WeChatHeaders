...
@class EditVideoAttr, MMAssetForPHAssetFramework, NSError, NSString, NSURL, SightDraft, VideoCompositionAttr, VideoEncodeTask, WCBgmInfo, WCMomentsPostReportSession;
...
@interface WCSightVideoCompositeTask : NSObject
{
    ...
    CDUnknownBlockType _compositeProgressCb;
    WCBgmInfo *_bgmInfo;
    NSString *_taskId;
...
@property(copy, nonatomic) CDUnknownBlockType compositeProgressCb; // @synthesize compositeProgressCb=_compositeProgressCb;
...
- (_Bool)isValid;
- (long long)taskType;
- (id)_getBgmInfoByEditAttr:(id)arg1;
