...
@class MMFinderLiveCreateLotteryOperationView, MMFinderLiveTaskId, NSArray, NSMutableArray, NSString;
...
- (void)hoverClick:(id)arg1 textItem:(id)arg2;
...
- (id)createData;
- (void)hideCreateLotteryOperationViewWithCompletion:(CDUnknownBlockType)arg1;
- (void)showCreateLotteryOperationView;
- (_Bool)needFilterLotteryDataItem:(id)arg1;
- (void)onUpdateFreeGameTeamUpLottery;
- (void)onUpdateLotteryRunning:(_Bool)arg1;
