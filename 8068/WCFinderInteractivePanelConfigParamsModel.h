...
@class FinderWindowProductInfo, NSMutableSet, NSSet, NSString, WCFinderFeedBindEventInfo, WCFinderFeedContentVM, WCFinderObjectHotTopic, WCFinderTableViewParamModel;
...
@interface WCFinderInteractivePanelConfigParamsModel : NSObject
{
    ...
    NSMutableSet *_jumpCarouselShowSet;
...
@property(retain, nonatomic) NSMutableSet *jumpCarouselShowSet; // @synthesize jumpCarouselShowSet=_jumpCarouselShowSet;
