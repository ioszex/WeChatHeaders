...
+ (struct CGSize)estimateSizeWithBulkBuy:(id)arg1 font:(id)arg2 lineHeight:(double)arg3 maxLines:(unsigned long long)arg4 tagEstimateSize:(struct CGSize)arg5 spacing:(double)arg6 inWidth:(double)arg7;
...
- (void)updateWithBulkBuy:(id)arg1 lineHeight:(double)arg2 font:(id)arg3;
