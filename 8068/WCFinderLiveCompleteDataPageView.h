...
{
    _Bool _reportBaseData;
    _Bool _reportIncomeData;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool reportIncomeData; // @synthesize reportIncomeData=_reportIncomeData;
@property(nonatomic) _Bool reportBaseData; // @synthesize reportBaseData=_reportBaseData;
