...
@interface OMCPlaybackSession : NSObject
{
    ...
    CDUnknownBlockType _firstVideoFramePresentingHandler;
...
@property(nonatomic) optional_47a848c9 windowName; // @synthesize windowName=_windowName;
...
@property(copy, nonatomic) CDUnknownBlockType firstVideoFramePresentingHandler; // @synthesize firstVideoFramePresentingHandler=_firstVideoFramePresentingHandler;
...
- (void)onFirstVideoFramePresenting:(const void *)arg1;
