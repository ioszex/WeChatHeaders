...
@interface WCCanvasHalfRandomSubCard : UIView
{
    ...
    WCCanvasComponent *_repeatPickButtonItemComponent;
...
@property(retain, nonatomic) WCCanvasComponent *repeatPickButtonItemComponent; // @synthesize repeatPickButtonItemComponent=_repeatPickButtonItemComponent;
