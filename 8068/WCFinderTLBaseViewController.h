...
@interface WCFinderTLBaseViewController
{
    ...
    WCFinderPlayRateSelectPanelView *_operationViewV3;
...
@property(retain, nonatomic) WCFinderPlayRateSelectPanelView *operationViewV3; // @synthesize operationViewV3=_operationViewV3;
...
- (void)onBulletCommentViewController:(id)arg1 didCommentWithText:(id)arg2 replyItem:(id)arg3;
