...
- (id)getNewSearchRecommendGroups:(id)arg1 restrictMemberList:(id)arg2 searchRecommendGroupDiff:(unsigned int)arg3;
- (id)getSearchRecommendGroups:(id)arg1 restrictMemberList:(id)arg2;
