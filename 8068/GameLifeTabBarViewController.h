...
@class GameCenterBaseMsg, GameCenterTabSettingControl_TabConfiguration, GameCenterTabSettingControl_TabSetting, GameIndexSettingControl, GameLifeTabBarConfig, GameLifeTabBarLogicController, JumpInfo, MMTabBar, MMUIViewController, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, PAGView, UIImageView, UIView;
...
@interface GameLifeTabBarViewController
{
    ...
    GameIndexSettingControl *_gameIndexSetting;
    ...
    NSString *_gameEntranceQuery;
    struct CGSize _bgViewSize;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *gameEntranceQuery; // @synthesize gameEntranceQuery=_gameEntranceQuery;
...
@property(nonatomic) _Bool isIndexJumpLiteapp; // @synthesize isIndexJumpLiteapp=_isIndexJumpLiteapp;
...
@property(retain, nonatomic) GameIndexSettingControl *gameIndexSetting; // @synthesize gameIndexSetting=_gameIndexSetting;
...
- (id)createSubWebViewController:(id)arg1 show:(_Bool)arg2 index:(int)arg3 forceWeb:(_Bool)arg4;
